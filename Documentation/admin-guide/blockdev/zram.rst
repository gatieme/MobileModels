...
line of text and contains the following stats separated by whitespace:
 ...
 idle_pages       the number of idle pages
 idle_fast_pages  the number of idle_fast pages
 ================ =============================================================
...
To use idle_fast page writeback, first, user need to declare zram
pages as idle_fast::

	"echo fast > /sys/block/zramX/idle"
...
User need write "idle_fast" to use idle_fast writeback::

	"echo idle_fast > /sys/block/zramX/writeback"
