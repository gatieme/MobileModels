...
export product_type := 
export chip_type := 
export CFG_PLATFORM := baltimore
export OBB_PRODUCT_NAME := baltimore
export TARGET_BOARD_PLATFORM := baltimore
VERSION = 5
PATCHLEVEL = 10
SUBLEVEL = 43
EXTRAVERSION =
...
ifeq ($(chip_type),cs2)
LINUXINCLUDE += -I$(srctree)/drivers/platform_drivers/ap/platform/$(TARGET_BOARD_PLATFORM)_cs2
else
ifeq ($(chip_type),es)
LINUXINCLUDE += -I$(srctree)/drivers/platform_drivers/ap/platform/$(TARGET_BOARD_PLATFORM)_es
else
