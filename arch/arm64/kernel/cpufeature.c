...
static bool __read_mostly allow_mismatched_32bit_el0 = true;
#else
...
#ifdef CONFIG_ARM64_BF16_OVERRIDE
...
static bool has_address_auth_cpucap(const struct arm64_cpu_capabilities *entry, int scope)
{
	 ...
	 */
#ifdef CONFIG_PAC_FEATURE_STUB
	if (entry->field_pos == ID_AA64ISAR1_APA_SHIFT)
		return true;
#endif
...
#ifdef CONFIG_HHEE
	{
		.desc = "HKIP Hypervisor Execution Environment",
