...
static const char *get_machine_name(void)
{
	...
	const char *compatible = of_get_flat_dt_prop(dt_root, "compatible", NULL);

	if (strstr(compatible, "yupik")) {
		return "SM7325";
	} else if (strstr(compatible, "diwali")) {
		return "SM7450";
	} else if (strstr(compatible, "lahaina")) {
		return "SM8350";
	} else if (strstr(compatible, "waipio")) {
		return "SM8450";
	} else if (strstr(compatible, "cape")) {
		return "SM8475";
	} else if (strstr(compatible, "kalama")) {
		return "SM8550";
	}
