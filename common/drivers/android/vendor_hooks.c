...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_find_rtg_target);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_walt_cpu_high_irqload);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_schedtune_prefer_idle);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_is_reserved);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_cpu_isolated);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_cpumask_andnot);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_capacity_curr_of);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_is_min_capacity_cpu);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_unisolated_cpu);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_remove_render_rthread);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_add_waker_to_render_rthread);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_add_render_rthread);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_stat_yield_init);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_stat_yield_update);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_drg_cpufreq_check_limit);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_corectl_notifier_chain);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_corectl_check);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_top_task_hist_size);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_top_task_stats_policy);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_set_top_task_stats_empty_window);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_cpu_util_pred_min);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_cluster_max_freq);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_get_cpu_util);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_wrq_window_start);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_wts_mark_start);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_wts_last_enqueued_ts);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_max_pred_ls);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_predict_util);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_top_task_util);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_walt_ktime_clock);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_walt_update_task_ravg);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_top_task_skip_hispeed);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_use_pelt_freq);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_sched_update_rtg_tick);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_find_cas_cpu);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_enable_rt_cas);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_hwrtg_binder_check);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_check_for_rt_migration);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_hwrtg_fork_prio);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_proc_rtg_open);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_proc_rtg_compat_ioctl);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_proc_rtg_ioctl);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_trans_rtg_sched_enqueue);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_trans_rtg_sched_dequeue);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_hwrtg_task_load);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_is_key_aux_comm);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_get_max_group_util);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_group_id_open);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_group_id_write);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ravg_sum);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_qwdt_pet_stop);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ddr_stats_get_residency);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ddr_stats_get_freq_count);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_get_gpu_power_params);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_init_new_task_load);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_rt_task_fits_capacity);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_shrink_node_memcgs);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ra_tuning_max_page);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_get_average_fps);
