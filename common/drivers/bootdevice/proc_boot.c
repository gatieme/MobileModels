...
#else
static const struct proc_ops fw_version_proc_fops = {
	.proc_open = fw_version_proc_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
#else
static const struct proc_ops hufs_dieid_proc_fops = {
	.proc_open = hufs_dieid_proc_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
