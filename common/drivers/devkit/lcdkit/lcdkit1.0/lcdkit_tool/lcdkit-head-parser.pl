...
#   ["/hwlcd/PanelEntry/LbbMaxVolt",               "-n",    "",                   '-w', 0  ],
    ...
    ["/hwlcd/PanelEntry/DelayAfVddOn",             "-n",    "",                   '-w', 0  ],
...
my @qcom_platcfg_attrs = (
    ...
    ["/hwlcd/PanelEntry/LcdVddVcc",                "-n",    "",                   '-w', 0  ],
...
my @qcom_misc_attrs = (
   ...
   #["/hwlcd/PanelEntry/ReadPowerStatus",          "-n",    "",                   '-w', 0  ],
    ...
    ["/hwlcd/PanelEntry/VddPowerCtrlMode",         "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/TxEotAppend",              "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/RxEotIgnore",              "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiRegulatorMode",        "-n",    "",                   '+w', 0  ],
    ["/hwlcd/PanelEntry/LcdResetIsNeedTpReset",        "-n",    "",                   '+w', 0  ],
    ["/hwlcd/PanelEntry/TpResetLcdResetNeedSync",        "-n",    "",                   '+w', 0  ]);
...
my @panel_info_attrs = (
    ...
    ["/hwlcd/PanelEntry/PanelCmdType",             "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PxlClkToPll0",             "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelCompatible",          "-n",    "",                   '-w', 0  ],
    ...
    ["/hwlcd/PanelEntry/PanelSensorHubAodSupport", "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelSensorHubAodYStart",  "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelSensorHubAodYEnd",    "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelSensorHubAodYEndOneBit",  "-n","",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelAodNeedReset",        "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelAodNoNeedInit",       "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiTxoffRxulpsEn",        "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelHbmSupport",          "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelEmlReadRegFlag",      "-n",    "",                   '-w', 0  ],
    ...
    ["/hwlcd/PanelEntry/PanelBlByteOrder",         "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelIovccBeforeVciFlag",  "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/PanelModel",               "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiSwitchSupport",        "-n",    "",                   '-w', 0  ],);
    ...
    if ($target_file_type eq "dto-head")
    {
        for ($count = 0; $count < @panel_info_attrs; $count++)  {
            ...
            {
                $panel_info_attrs[$count][2] = "\"/huawei,lcd_config/"."lcdkit_" . lc($panel_file_name) . "\"";
            }
        }
    }
...
my @panel_mipi_attrs = (
    ...
    ["/hwlcd/PanelEntry/MipiDataTHsPrepareAdjust", "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiDataTHsZeroAdjust",    "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiDataTlpxAdjust",       "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiRgVcmAdjust",          "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiRgLptxAdjust",         "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/MipiRgSriAdjust",          "-n",    "",                   '-w', 0  ],
    ...
    ["/hwlcd/PanelEntry/PanelEotpDisableFlag",     "-n",    "",                   '-w', 0  ]);
...
my @panel_misc_attrs = (
    ...
    ["/hwlcd/PanelEntry/BlPowerOnAfterDsiCmd",     "-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/TpRstPullHighbeforeLcdRst","-n",    "",                   '-w', 0  ],
    ["/hwlcd/PanelEntry/LcdType",           "-n",    "",                '-w', 0  ],
...
my @panel_delayctl_attrs = (
    ...
    ["/hwlcd/PanelEntry/DelayAfDsiCmd",            "-n",    "",                   '-w', 0  ]);
...
my @hisi_aod_enter_cmd_paras = ("hwlcd/PanelEntry/PanelAodEnterCommand", $panel_file_name."_aod_enter_cmds");
my @hisi_aod_exit_cmd_paras = ("hwlcd/PanelEntry/PanelAodExitCommand", $panel_file_name."_aod_exit_cmds");
my @hisi_aod_high_brightness_cmd_paras = ("hwlcd/PanelEntry/PanelAodHighBrightnessCommand", $panel_file_name."_aod_high_brightness_cmds");
my @hisi_aod_low_brightness_cmd_paras = ("hwlcd/PanelEntry/PanelAodLowBrightnessCommand", $panel_file_name."_aod_low_brightness_cmds");
my @hisi_command2_enter_cmd_paras = ("hwlcd/PanelEntry/PanelCmd2EnterCommand", $panel_file_name."_command2_enter_cmds");
my @hisi_command2_exit_cmd_paras = ("hwlcd/PanelEntry/PanelCmd2ExitCommand", $panel_file_name."_command2_exit_cmds");
my @hisi_hbm_enter_cmds = ("hwlcd/PanelEntry/PanelNewHbmEnterCommand", $panel_file_name."_hbm_enter_cmds");
my @hisi_hbm_exit_cmds = ("hwlcd/PanelEntry/PanelNewHbmExitCommand", $panel_file_name."_hbm_exit_cmds");
my @hisi_aod_hbm_enter_cmds = ("hwlcd/PanelEntry/PanelAodHbmEnterCommand", $panel_file_name."_aod_hbm_enter_cmds");
my @hisi_aod_hbm_exit_cmds = ("hwlcd/PanelEntry/PanelAodHbmExitCommand", $panel_file_name."_aod_hbm_exit_cmds");
...
#        ''                                                                                ],
        ...
        ['hisi',      \@hisi_backlight_cmd_paras,                  \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_aod_enter_cmd_paras,                  \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_aod_exit_cmd_paras,                  \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_aod_high_brightness_cmd_paras,       \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_aod_low_brightness_cmd_paras,         \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_command2_enter_cmd_paras,             \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_command2_exit_cmd_paras,              \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_hbm_enter_cmds,                       \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_hbm_exit_cmds,                        \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_aod_hbm_enter_cmds,                   \&hisi_cmd_struct_grp,
         ''                                                                                ],
        ['hisi',      \@hisi_aod_hbm_exit_cmds,                    \&hisi_cmd_struct_grp,
         ''                                                                                ]);
...
my @lcd_backlight_ic_attrs = (
    ...
    ["BacklightICMsbBeforeLsb",            "-n",    "",                   '-w', 0  ],
    ["BacklightICSecondCheck",             "-n",    "",                   '-w', 0  ],
    ...
    ["BacklightICSecondCheckCMD",          "-f",    \&parse_backlight_cmd,                   '-w', 0  ],
    ...
    ["BacklightICHiddenRegSurpport",       "-n",    "",                   '-w', 0  ],
    ["BacklightICSecurityRegEnableCMD",    "-f",    \&parse_backlight_cmd,                   '-w', 0  ],
    ["BacklightICSecurityRegDisableCMD",   "-f",    \&parse_backlight_cmd,                   '-w', 0  ],
    ["BacklightICHiddenRegCMD",            "-f",    \&parse_backlight_cmd,                   '-w', 0  ],
    ["BacklightICHiddenRegValMask",        "-n",    "",                   '-w', 0  ]
);
