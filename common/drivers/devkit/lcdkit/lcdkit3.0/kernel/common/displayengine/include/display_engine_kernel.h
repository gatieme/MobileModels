 ...
 * Description: DRM IO definitions for display engine.
 * Author: gongzheng 00389390
 * Create: 2022-04-5
 */
...
enum display_engine_module_id {
	...
	DISPLAY_ENGINE_DDIC_OD = BIT(9),
	DISPLAY_ENGINE_DDIC_IRC = BIT(10),
};
