...
static int nu2205_reg_reset(struct nu2205_device_info *di)
{
	...
	ret += nu2205_write_mask(di, NU2205_VAC_PRESENT_DET_REG,
		NU2205_EN_OTG_MASK, NU2205_EN_OTG_SHIFT, NU2205_EN_OTG_ENABLE);
	ret += nu2205_write_mask(di, NU2205_ACDRV_CTRL_REG,
		NU2205_ACDRV_EN_ACDRV1_MASK, NU2205_ACDRV_EN_ACDRV1_SHIFT, NU2205_ACDRV_EN_ACDRV1_ENABLE);
	if (ret)
		return -EIO;
