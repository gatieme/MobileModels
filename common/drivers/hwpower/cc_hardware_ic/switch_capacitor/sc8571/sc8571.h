...
#define SC8571_VAC1_INSERT_FLAG_MASK           BIT(4)
#define SC8571_VAC1_INSERT_FLAG_SHIFT          4

#define SC8571_VAC2_INSERT_FLAG_MASK           BIT(3)
#define SC8571_VAC2_INSERT_FLAG_SHIFT          3

#define SC8571_VBUS_PRESENT_FLAG_MASK          BIT(2)
#define SC8571_VBUS_PRESENT_FLAG_SHIFT         2

#define SC8571_ACRB1_CONFIG_FLAG_MASK          BIT(1)
#define SC8571_ACRB1_CONFIG_FLAG_SHIFT         1

#define SC8571_ACRB2_CONFIG_FLAG_MASK          BIT(0)
