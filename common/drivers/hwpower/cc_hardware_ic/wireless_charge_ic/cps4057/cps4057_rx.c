...
static void cps4057_rx_set_dummy_iload(struct cps4057_dev_info *di)
{
	u8 iload;
	...
	iload = di->dummy_iload * 10 / CPS4057_RX_DUMMY_ILOAD_STEP; /* 10: step need divided by 10 */
	(void)cps4057_write_byte(CPS4057_RX_DUMMY_ILOAD_ADDR, iload);
	(void)cps4057_write_byte(CPS4057_RX_DUMMY_ILOAD1_ADDR, iload);
}
