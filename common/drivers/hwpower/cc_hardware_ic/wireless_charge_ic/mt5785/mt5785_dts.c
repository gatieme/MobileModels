...
static int mt5785_parse_basic_para(struct device_node *np, struct mt5785_dev_info *di)
{
	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
		"otp_th", (u32 *)&di->otp_th,
		MT5785_RX_OTP_TH_DEFAULT);
	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
		"duty_min", (u32 *)&di->duty_min,
		MT5785_TX_PT_DUTY_MIN_DEFAULT);
	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
		"duty_max", (u32 *)&di->duty_max,
		MT5785_TX_PT_DUTY_MAX_DEFAULT);
	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
