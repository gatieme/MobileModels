...
EXPORT_SYMBOL_GPL(smart_softtimer_add);
...
EXPORT_SYMBOL_GPL(smart_softtimer_delete);
/*lint  +e826 +e64*/
/* Create a soft timer */
...
EXPORT_SYMBOL_GPL(smart_softtimer_create);
/*
 * Modify soft timer
 */
...
EXPORT_SYMBOL_GPL(smart_softtimer_modify);
/*
...
static const struct of_device_id generic_softtimer[] = {
	{ .compatible = "huawei,contexthub-softtimer" },
	{},
};
