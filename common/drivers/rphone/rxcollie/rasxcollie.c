...
#else
static void rxcollie_sub_timespec(struct timespec64 *minuend,
	struct timespec64 *subtrahend, struct timespec64 *x)
#endif
{
...
#else
static int rxcollie_clock_target_check(struct timespec64 *ts,
	struct timespec64 *cur,
	struct timespec64 *delta)
#endif
{
	struct timespec64 min = { 0, HW_SLEEP_THREASHOLD_NANOSECOND };
