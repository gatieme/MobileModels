...
static const struct block_device_operations mas_sd_fops = {
	.owner			= THIS_MODULE,
	.submit_bio     = __cfi_ufs_mq_make_request,
	.open			= sd_open,
	.release		= sd_release,
	.ioctl			= sd_ioctl,
	.getgeo			= sd_getgeo,
...
// Bug fix for disk partition drift at qcom
	...
	gd->fops = &sd_fops;
#ifdef CONFIG_MAS_BLK
	if(sdp->host->queue_quirk_flag & SHOST_QUIRK(SHOST_QUIRK_MAS_UFS_MQ))
		gd->fops = &mas_sd_fops;
#endif
