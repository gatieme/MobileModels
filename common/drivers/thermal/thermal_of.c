...
#ifdef CONFIG_HW_IPA_THERMAL
	tz->default_disable = of_property_read_bool(np, "disable-thermal-zone");
#endif
...
int __init of_parse_thermal_zones(void)
{
	...
	for_each_available_child_of_node(np, child) {
		...
		if (!of_property_read_string(child, "thermal-governor", &governor_name))
	 		strlcpy(tzp->governor_name, governor_name, THERMAL_NAME_LENGTH);
#endif
