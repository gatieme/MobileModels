							...
							struct device_node *np)
{
	...
	aw_haptic->info.is_enabled_lower_amp = of_property_read_bool(np,
		"aw8692x_is_enabled_lower_amp");
	aw_info("aw_haptic->info.is_enabled_lower_amp = %d",
		aw_haptic->info.is_enabled_lower_amp);
}
