...
static const struct proc_ops meminfo_lite_proc_fops = {
	.proc_open = meminfo_lite_proc_open,
	.proc_read = seq_read,
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5,10,0))
static const struct proc_ops meminfo_sw_fops = {
	.proc_open = meminfo_sw_proc_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
