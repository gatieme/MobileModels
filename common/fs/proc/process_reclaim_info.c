...
int process_reclaim_result_read(
...
void process_reclaim_result_write(
	struct task_struct *task, unsigned int nr_reclaimed,
	unsigned int nr_writedblock, s64 elapsed)
{
	struct reclaim_result *result = NULL;
