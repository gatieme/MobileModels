...
#define COOLINGCASE_RESET_DUTY_DELAY     10000
...
#define COOLINGCASE_DUTY_DEFAULT         0
...
struct wirelesscase_di {
	...
	struct delayed_work reset_duty_low_power;
	struct mutex lock;
	...
	unsigned int duty_orign;
	unsigned int duty_low_power;
	int retry_times;
	int wltx_pwr_src;
};
