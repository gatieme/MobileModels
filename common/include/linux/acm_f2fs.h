...
#define ACM_PKGNAME_MAX		100	/* max package name */
#define UID_BOUNDARY		10000   /* uid beyond this value isn't charged */

/* Acm monitor file operaions */
#define ACM_OP_DEL		0
#define ACM_OP_CRT		1
#define ACM_OP_MKD		2
#define ACM_OP_RNM		3
