...
#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
enum power_supply_sinksource_type {
	POWER_SUPPLY_START_SINK,
	POWER_SUPPLY_STOP_SINK,
	POWER_SUPPLY_START_SOURCE,
	POWER_SUPPLY_STOP_SOURCE,
	POWER_SUPPLY_START_SINK_WIRELESS,
	POWER_SUPPLY_STOP_SINK_WIRELESS,
	POWER_SUPPLY_MAX_CHARGER_EVENT,
};
#endif
