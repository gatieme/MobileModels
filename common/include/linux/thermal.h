...
#define CDEV_CPU_CLUSTER0_NAME "ipa-cpufreq-3"
#define CDEV_CPU_CLUSTER1_NAME "ipa-cpufreq-4"
#define CDEV_CPU_CLUSTER2_NAME "ipa-cpufreq-5"
...
extern unsigned int g_dyn_cap_item_num;

extern unsigned int g_control_optimization;
extern unsigned int g_req_power_num;
extern unsigned int g_req_power_beta;
extern unsigned int g_power_range_bucket;
extern unsigned int g_power_range_token;
extern unsigned int g_power_range_proportion;
extern u32 *g_req_power_avg;
extern bool g_req_power_avg_init;
...
int thermal_zone_cdev_get_power(const char *thermal_zone_name,
	const char *cdev_name, unsigned int *power);
