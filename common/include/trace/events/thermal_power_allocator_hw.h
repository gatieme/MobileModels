...
TRACE_EVENT(devfreq_power2state,
	TP_PROTO(unsigned long freq, u32 static_power, s32 dyn_power, unsigned long status_busy_time,
		unsigned long busy_time, unsigned long status_total_time, unsigned long total_time, s32 est_power),

	TP_ARGS(freq, static_power, dyn_power, status_busy_time, busy_time, status_total_time, total_time, est_power),
	...
	TP_STRUCT__entry(
		...
		__field(unsigned long, status_total_time)
	...
	TP_fast_assign(
		...
		__entry->status_total_time = status_total_time;
		__entry->total_time = total_time;
		__entry->est_power = est_power;
	),

	TP_printk("cur_freq=%lu,static_power=%u,dyn_power=%d,status_busy_time=%lu,busy_time=%lu,status_total_time=%lu,total_time=%lu,est_power=%d",
		__entry->freq, __entry->static_power, __entry->dyn_power, __entry->status_busy_time,
		__entry->busy_time, __entry->status_total_time, __entry->total_time, __entry->est_power)
);
