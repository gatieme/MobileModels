...
#if IS_ENABLED(CONFIG_HW_RTG) && IS_ENABLED(CONFIG_HW_RTG_PERF_CTRL)
...
#if IS_ENABLED(CONFIG_HW_RTG_NORMALIZED_UTIL) && IS_ENABLED(CONFIG_HW_RTG_PERF_CTRL)
...
#if IS_ENABLED(CONFIG_HW_ED_TASK) && IS_ENABLED(CONFIG_HW_RTG_PERF_CTRL)
...
#if IS_ENABLED(CONFIG_HW_RTG_FRAME) && IS_ENABLED(CONFIG_HW_RTG_PERF_CTRL)
