...
{
	return walt_task_struct_get(p, load_avg);
}
static inline unsigned int get_curr_load(struct task_struct *p)
{
	return walt_task_struct_get(p, curr_load);
}
static inline unsigned int get_load_sum(struct task_struct *p)
{
	return walt_task_struct_get(p, load_sum);
}
static inline u64 get_mark_start(struct task_struct *p)
{
	return walt_task_struct_get(p, mark_start);
}
static inline u64 get_window_start(struct rq *rq)
{
	return walt_rq_get(rq, window_start);
}
static inline bool get_top_task_stats_empty_window(struct rq *rq)
{
	return walt_rq_get(rq, top_task_stats_empty_window);
}
static inline unsigned int* get_top_task_load_sum_history(struct task_struct *p)
{
	return walt_task_struct_get(p, load_sum_history);
}
static inline unsigned int get_top_task_stats_policy(struct rq *rq)
{
	return walt_rq_get(rq, top_task_stats_policy);
}
static inline unsigned int get_top_task_hist_size(struct rq *rq)
{
	return walt_rq_get(rq, top_task_hist_size);
}
static inline void set_prev_load(struct task_struct *p, u32 load)
{
	walt_task_struct_set(p, prev_load, load);
}
static inline void set_curr_load(struct task_struct *p, u32 load)
{
	walt_task_struct_set(p, curr_load, load);
}
static inline void set_load_sum(struct task_struct *p, u32 load)
{
	walt_task_struct_set(p, load_sum, load);
}
static inline void set_load_avg(struct task_struct *p, u32 load)
{
	walt_task_struct_set(p, load_avg, load);
}
static inline void add_load_sum(struct task_struct *p, u32 load)
{
	walt_task_struct_add(p, load_sum, load);
}
#else
