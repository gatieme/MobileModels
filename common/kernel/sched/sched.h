...
#define UCLAMP_FLAG_IDLE 0x01
	...
	ANDROID_VENDOR_DATA_ARRAY(1, 128);
	int idle_state_idx;
#ifdef CONFIG_HUAWEI_SCHED_VIP
...
#if defined(CONFIG_CPU_IDLE) && IS_ENABLED(CONFIG_SCHED_WALT)
...
#if defined(CONFIG_HW_CPU_FREQ_GOV_SCHEDUTIL) || defined(CONFIG_HW_CPU_FREQ_GOV_SCHEDUTIL_COMMON)
extern inline unsigned long capacity_curr_of(int cpu);
#endif
#endif
