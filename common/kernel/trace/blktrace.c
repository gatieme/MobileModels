...
int mas_orig_op_fill_rwbs(char *rwbs, unsigned int op, int offset)
{
	int i = 0;
...
int mas_op_fill_rwbs(char *rwbs, unsigned int mas_op, int offset)
{
	int i = 0;
	unsigned long loop;
...
int mas_blk_fill_rwbs(char *rwbs, unsigned int op, unsigned int mas_op, int offset)
{
	int i = 0;

	i = mas_orig_op_fill_rwbs(rwbs, op, offset);
	i += mas_op_fill_rwbs(rwbs, mas_op, (offset + i));
...
#ifdef CONFIG_MAS_BLK
	i += mas_blk_fill_rwbs(rwbs, op, mas_op, i);
#endif
