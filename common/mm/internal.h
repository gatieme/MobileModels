...
extern void pch_get_ra_para(struct file_ra_state *ra, pgoff_t offset);
#else
...
static inline void pch_mmap_readextend(unsigned long vm_flags,
					struct file_ra_state *ra,
					struct file *file,pgoff_t offset) {}

static inline void pch_get_ra_para(struct file_ra_state *ra, pgoff_t offset) {}
#endif
...
#endif
extern noinline_for_stack unsigned long
shrink_inactive_list(unsigned long nr_to_scan, struct lruvec *lruvec,
        struct scan_control *sc, enum lru_list lru);
extern unsigned noinline_for_stack move_pages_to_lru(struct lruvec *lruvec,
