...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_honor_test_task_vip);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_honor_futex_vip_set);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_honor_futex_vip_unset);
#endif
