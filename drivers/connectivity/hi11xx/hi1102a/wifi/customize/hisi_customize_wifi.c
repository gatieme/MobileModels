...
int32 g_dts_params[WLAN_CFG_DTS_BUTT] = {0};        /* dts定制化参数数组 */
OAL_STATIC uint8 g_nv_params[NUM_OF_NV_MAX_TXPOWER] = {0};    /* nv定制化参数数组 */
int32 g_nvram_init_params[NVRAM_PARAMS_INDEX_BUTT] = {0}; /* ini文件中NV参数数组 */

OAL_STATIC oal_uint32 g_priv_cust_init_params[WLAN_CFG_PRIV_BUTT] = {
    0x1fff,         // cali_mask
    0x10,           // cali_data_mask
    1,              // temp_pro_en
...
OAL_STATIC int8 g_country_code[COUNTRY_CODE_LEN] = "00";
#ifndef _PRE_WLAN_EXPORT
OAL_STATIC uint8 g_wifimac[MAC_LEN] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
#endif
wlan_cus_pwr_fit_para_stru g_pro_line_params[DY_CALI_PARAMS_NUM] = {{0}};      /* 产测定制化参数数组 */
OAL_STATIC uint8 g_cust_nvram_info[WLAN_CFG_DTS_NVRAM_END][DY_CALI_PARAMS_LEN] = {{0}};  /* NVRAM数组 */
oal_bool_enum_uint8 g_en_nv_dp_init_is_null = OAL_TRUE;                               /* NVRAM中dp init置空标志 */
wlan_customize_private_stru g_priv_cust_params[WLAN_CFG_PRIV_BUTT] = {{ 0, 0 }}; /* 私有定制化参数数组 */
oal_int16 g_gs_extre_point_vals[DY_CALI_NUM_5G_BAND] = {0};
wlan_customize_power_params_stru g_cust_nv_params = {{0}}; /* 最大发送功率定制化数组 */
#ifdef _PRE_WLAN_FEATURE_NRCOEX
wlan_nrcoex_ini_stru g_st_nrcoex_ini = {0};
#endif
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
oal_uint8 g_sar_params[CUS_NUM_OF_SAR_LVL][CUS_SAR_NUM];
#endif
...
{
    g_en_fact_cali_completed = fact_cali_completed;
}
 ...
 */
OAL_STATIC regdomain_plat_tag_map_stru g_plat_tag_mapping_table[] = {
...
#endif
    {"optimize_feature_switch",         WLAN_CFG_INIT_TXOP_SWITCH},
    { OAL_PTR_NULL, 0 }
};

OAL_STATIC wlan_cfg_cmd g_nvram_config_ini[] = {
...
OAL_STATIC wlan_cfg_cmd g_wifi_config_priv[] = {
    ...
    { "chba_en",                  WLAN_CFG_PRIV_CHBA_EN },
    { "chba_init_social_channel", WLAN_CFG_PRIV_CHBA_INIT_SOCIAL_CHAN },
    { "chba_social_follow_work_disable",  WLAN_CFG_PRIV_CHBA_SOCIAL_FOLLOW_WORK },
    { "close_filter_switch",              WLAN_CFG_PRIV_CLOSE_FILTER_SWITCH},
    { OAL_PTR_NULL,               0 }
};
#ifdef CONFIG_HISI_NVE
OAL_STATIC wlan_cfg_nv_map_handler g_wifi_nvram_cfg_handler[] = {
...
{
    /* :fix Erecovery mode can scan & connect 5g ap while do not support 5g. */
    g_dts_params[WLAN_CFG_DTS_BAND_5G_ENABLE] = 1;
    ...
    /* rf register */
    g_dts_params[WLAN_CFG_DTS_RF_REG117] = WLAN_REG117_RF;
    g_dts_params[WLAN_CFG_DTS_RF_REG123] = WLAN_REG123_RF;
    g_dts_params[WLAN_CFG_DTS_RF_REG124] = WLAN_REG124_RF;
    g_dts_params[WLAN_CFG_DTS_RF_REG125] = WLAN_REG125_RF;
    g_dts_params[WLAN_CFG_DTS_RF_REG126] = WLAN_REG126_RF;
    /* bt tmp */
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND1] = WLAN_BT_CALI_TXPWR_BAND1_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND2] = WLAN_BT_CALI_TXPWR_BAND2_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND3] = WLAN_BT_CALI_TXPWR_BAND3_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND4] = WLAN_BT_CALI_TXPWR_BAND4_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND5] = WLAN_BT_CALI_TXPWR_BAND5_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND6] = WLAN_BT_CALI_TXPWR_BAND6_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND7] = WLAN_BT_CALI_TXPWR_BAND7_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND8] = WLAN_BT_CALI_TXPWR_BAND8_DPN;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_NUM] = WLAN_BT_CALI_TXPWR_NUM_VAL;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ1] = WLAN_BT_CALI_TXPWR_FRE1;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ2] = WLAN_BT_CALI_TXPWR_FRE2;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ3] = WLAN_BT_CALI_TXPWR_FRE3;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ4] = WLAN_BT_CALI_TXPWR_FRE4;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ5] = WLAN_BT_CALI_TXPWR_FRE5;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ6] = WLAN_BT_CALI_TXPWR_FRE6;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ7] = WLAN_BT_CALI_TXPWR_FRE7;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_TXPWR_FREQ8] = WLAN_BT_CALI_TXPWR_FRE8;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_INSERTION_LOSS] = WLAN_BT_CALI_LOSS_VAL;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_GM_CALI_EN] = WLAN_BT_CALI_GM_EN_VAL;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_GM0_DB10] = WLAN_BT_CALI_GM0_DB10_VAL;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_BASE_POWER] = WLAN_BT_CALI_BASE_POWER_VAL;
    g_dts_params[WLAN_CFG_DTS_BT_CALI_IS_DPN_CALC] = WLAN_BT_CALI_IS_DPN_VAL;

#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
    /* 动态校准 */
    g_dts_params[WLAN_CFG_DTS_DYN_CALI_DSCR_ITERVL] = WLAN_DYN_CALI_DSCR_ITERVL_VAL;
    /* DPN 40M 20M 11b */
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH1] = WLAN_2G_CORE0_CH1_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH2] = WLAN_2G_CORE0_CH2_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH3] = WLAN_2G_CORE0_CH3_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH4] = WLAN_2G_CORE0_CH4_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH5] = WLAN_2G_CORE0_CH5_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH6] = WLAN_2G_CORE0_CH6_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH7] = WLAN_2G_CORE0_CH7_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH8] = WLAN_2G_CORE0_CH8_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH9] = WLAN_2G_CORE0_CH9_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH10] = WLAN_2G_CORE0_CH10_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH11] = WLAN_2G_CORE0_CH11_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH12] = WLAN_2G_CORE0_CH12_DPN;
    g_dts_params[WLAN_CFG_DTS_2G_CORE0_DPN_CH13] = WLAN_2G_CORE0_CH13_DPN;
    g_dts_params[WLAN_CFG_DTS_5G_CORE0_DPN_B0] = WLAN_5G_CORE0_B0_DPN;
    g_dts_params[WLAN_CFG_DTS_5G_CORE0_DPN_B1] = WLAN_5G_CORE0_B1_DPN;
    g_dts_params[WLAN_CFG_DTS_5G_CORE0_DPN_B2] = WLAN_5G_CORE0_B2_DPN;
    g_dts_params[WLAN_CFG_DTS_5G_CORE0_DPN_B3] = WLAN_5G_CORE0_B3_DPN;
    g_dts_params[WLAN_CFG_DTS_5G_CORE0_DPN_B4] = WLAN_5G_CORE0_B4_DPN;
    g_dts_params[WLAN_CFG_DTS_DYN_CALI_OPT_SWITCH] = WLAN_DYN_CALI_OPT_SWITCH_VAL;
    g_dts_params[WLAN_CFG_DTS_DYN_CALI_GM0_DB10_AMEND] = WLAN_DYN_CALI_GM0_DB10_AMEND_VAL;
#endif
    g_dts_params[WLAN_CFG_DTS_5G_UPC_UP_LIMIT] = WLAN_5G_UPC_UP_LIMIT_VAL;
    g_dts_params[WLAN_CFG_DTS_5G_IQ_BACKOFF_POWER] = WLAN_5G_IQ_BACKOFF_POWER_VAL;
    g_dts_params[WLAN_CFG_DTS_5G_IQ_CALI_POWER] = WLAN_5G_IQ_CALI_POWER_VAL;
}

/*
 * 函 数 名  : host_params_init_first_of_rf
 * 功能描述  : 给RF前端定制化参数全局数组 g_host_init_params 附初值
 *             ini文件读取失败时用初值(降函数行数)
 */
OAL_STATIC oal_void host_params_init_first_of_rf(oal_void)
{
    /* 2G RF前端 */
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND1_MULT4] = WLAN_DB_2G_BAND1_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND1_MULT10] = WLAN_DB_2G_BAND1_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND2_MULT4] = WLAN_DB_2G_BAND2_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND2_MULT10] = WLAN_DB_2G_BAND2_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND3_MULT4] = WLAN_DB_2G_BAND3_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND3_MULT10] = WLAN_DB_2G_BAND3_MULT10;
    /* 5G RF前端 */
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND1_MULT4] = WLAN_DB_5G_BAND1_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND1_MULT10] = WLAN_DB_5G_BAND1_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND2_MULT4] = WLAN_DB_5G_BAND2_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND2_MULT10] = WLAN_DB_5G_BAND2_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND3_MULT4] = WLAN_DB_5G_BAND3_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND3_MULT10] = WLAN_DB_5G_BAND3_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND4_MULT4] = WLAN_DB_5G_BAND4_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND4_MULT10] = WLAN_DB_5G_BAND4_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND5_MULT4] = WLAN_DB_5G_BAND5_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND5_MULT10] = WLAN_DB_5G_BAND5_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND6_MULT4] = WLAN_DB_5G_BAND6_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND6_MULT10] = WLAN_DB_5G_BAND6_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND7_MULT4] = WLAN_DB_5G_BAND7_MULT4;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND7_MULT10] = WLAN_DB_5G_BAND7_MULT10;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_RX_GAIN_DB_5G] = WLAN_RF_LINE_RX_GAIN_DB_5G;
    g_host_init_params[WLAN_CFG_INIT_LNA_GAIN_DB_5G] = WLAN_LNA_GAIN_DB_5G;
    g_host_init_params[WLAN_CFG_INIT_RF_LINE_TX_GAIN_DB_5G] = WLAN_RF_LINE_TX_GAIN_DB_5G;
    g_host_init_params[WLAN_CFG_INIT_EXT_SWITCH_ISEXIST_5G] = WLAN_EXT_SWITCH_ISEXIST_5G;
    g_host_init_params[WLAN_CFG_INIT_EXT_PA_ISEXIST_5G] = WLAN_EXT_PA_ISEXIST_5G;
    g_host_init_params[WLAN_CFG_INIT_EXT_LNA_ISEXIST_5G] = WLAN_EXT_LNA_ISEXIST_5G;
    g_host_init_params[WLAN_CFG_INIT_LNA_ON2OFF_TIME_NS_5G] = WLAN_LNA_ON2OFF_TIME_NS_5G;
    g_host_init_params[WLAN_CFG_INIT_LNA_OFF2ON_TIME_NS_5G] = WLAN_LNA_OFF2ON_TIME_NS_5G;
}
 /*
...
{
    /* 绑核锁频相关 */
    g_host_init_params[WLAN_CFG_INIT_BINDCPU] = OAL_TRUE;
    g_host_init_params[WLAN_CFG_INIT_BINDCPU_MASK] = WLAN_BINDCPU_DEFAULT_MASK;
    g_host_init_params[WLAN_CFG_INIT_BINDCPU_PPSHIGH] = WLAN_BUSY_CPU_PPS_THROUGHT;
    g_host_init_params[WLAN_CFG_INIT_BINDCPU_PPSLOW] = WLAN_IDLE_CPU_PPS_THROUGHT;

    /* 性能比拼优化相关 */
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_SWITCH_STA] = WLAN_TX_OPT_SWITCH_STA;
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_SWITCH_AP] = WLAN_TX_OPT_SWITCH_AP;
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_PPS_HIGH] = WLAN_TX_OPT_TH_HIGH;
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_PPS_LOW] = WLAN_TX_OPT_TH_LOW;
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_CWMIN] = WLAN_TX_OPT_CWMIN;
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_CWMAX] = WLAN_TX_OPT_CWMAX;
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_TXOPLIMIT] = WLAN_TX_OPT_TXOPLIMIT;
    g_host_init_params[WLAN_CFG_INIT_TX_OPT_DYN_TXOPLIMIT] = WLAN_TX_OPT_DYN_TXOPLIMIT;

    g_host_init_params[WLAN_CFG_INIT_DEVICE_RX_TCP_ACK_FILTER] = OAL_FALSE;
    g_host_init_params[WLAN_CFG_INIT_DEVICE_RX_TCP_ACK_2G_TH]  = WLAN_DEVICE_RX_TCP_ACK_DEFAULT_2G_TH;
    g_host_init_params[WLAN_CFG_INIT_DEVICE_RX_TCP_ACK_5G_TH]  = WLAN_DEVICE_RX_TCP_ACK_DEFAULT_5G_TH;

    g_host_init_params[WLAN_CFG_INIT_TX_TCP_ACK_BUF] = OAL_TRUE;
    g_host_init_params[WLAN_CFG_INIT_TCP_ACK_BUF_HIGH] = WLAN_TCP_ACK_BUF_THROUGHPUT_THRESHOLD_HIGH;
    g_host_init_params[WLAN_CFG_INIT_TCP_ACK_BUF_LOW] = WLAN_TCP_ACK_BUF_THROUGHPUT_THRESHOLD_LOW;
    g_host_init_params[WLAN_CFG_INIT_TCP_ACK_BUF_HIGH_40M] = WLAN_TCP_ACK_BUF_THROUGHPUT_THRESHOLD_HIGH_40M;
    g_host_init_params[WLAN_CFG_INIT_TCP_ACK_BUF_LOW_40M] = WLAN_TCP_ACK_BUF_THROUGHPUT_THRESHOLD_LOW_40M;
    g_host_init_params[WLAN_CFG_INIT_TCP_ACK_BUF_HIGH_80M] = WLAN_TCP_ACK_BUF_THROUGHPUT_THRESHOLD_HIGH_80M;
    g_host_init_params[WLAN_CFG_INIT_TCP_ACK_BUF_LOW_80M] = WLAN_TCP_ACK_BUF_THROUGHPUT_THRESHOLD_LOW_80M;
    /* RX DYN BYPASS EXTLNA 定制化参数 */
    g_host_init_params[WLAN_CFG_INIT_RX_DYN_BYPASS_EXTLNA] = OAL_FALSE;
    g_host_init_params[WLAN_CFG_INIT_RX_DYN_BYPASS_EXTLNA_HIGH] = WLAN_DYN_BYPASS_EXTLNA_THROUGHPUT_THRESHOLD_HIGH;
    g_host_init_params[WLAN_CFG_INIT_RX_DYN_BYPASS_EXTLNA_LOW] = WLAN_DYN_BYPASS_EXTLNA_THROUGHPUT_THRESHOLD_LOW;
    /* SMALL AMSDU 定制化参数 */
    g_host_init_params[WLAN_CFG_INIT_TX_SMALL_AMSDU] = OAL_TRUE;
    g_host_init_params[WLAN_CFG_INIT_SMALL_AMSDU_HIGH] = WLAN_SMALL_AMSDU_THROUGHPUT_THRESHOLD_HIGH;
    g_host_init_params[WLAN_CFG_INIT_SMALL_AMSDU_LOW] = WLAN_SMALL_AMSDU_THROUGHPUT_THRESHOLD_LOW;
    g_host_init_params[WLAN_CFG_INIT_SMALL_AMSDU_PPS_HIGH] = WLAN_SMALL_AMSDU_PPS_THRESHOLD_HIGH;
    g_host_init_params[WLAN_CFG_INIT_SMALL_AMSDU_PPS_LOW] = WLAN_SMALL_AMSDU_PPS_THRESHOLD_LOW;

#ifdef _PRE_WLAN_FEATURE_MULTI_NETBUF_AMSDU
    g_host_init_params[WLAN_CFG_INIT_AMPDU_AMSDU_SKB] = OAL_FALSE;
    g_host_init_params[WLAN_CFG_INIT_AMSDU_AMPDU_TH_HIGH] = WLAN_AMSDU_AMPDU_THROUGHPUT_THRESHOLD_HIGH;
    g_host_init_params[WLAN_CFG_INIT_AMSDU_AMPDU_TH_LOW] = WLAN_AMSDU_AMPDU_THROUGHPUT_THRESHOLD_LOW;
    g_host_init_params[WLAN_CFG_INIT_RX_AMPDU_AMSDU_SKB] = OAL_FALSE;
#endif
#ifdef _PRE_WLAN_TCP_OPT
    g_host_init_params[WLAN_CFG_INIT_TCP_ACK_FILTER] = OAL_TRUE;
...
{
    g_host_init_params[WLAN_CFG_INIT_DELTA_CCA_ED_HIGH_20TH_2G] = 0;
    g_host_init_params[WLAN_CFG_INIT_DELTA_CCA_ED_HIGH_40TH_2G] = 0;
    g_host_init_params[WLAN_CFG_INIT_DELTA_CCA_ED_HIGH_20TH_5G] = 0;
    g_host_init_params[WLAN_CFG_INIT_DELTA_CCA_ED_HIGH_40TH_5G] = 0;
}
#ifdef _PRE_WLAN_FEATURE_NRCOEX

OAL_STATIC oal_void host_params_init_nrcoex_params(oal_void)
{
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_ENABLE] = OAL_FALSE;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_FREQ] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_40M_20M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_160M_80M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_40M_20M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_160M_80M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_40M_20M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_160M_80M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_GAP0_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_GAP1_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_GAP2_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE0_RXSLOT_RSSI] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_FREQ] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_40M_20M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_160M_80M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_40M_20M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_160M_80M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_40M_20M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_160M_80M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_GAP0_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_GAP1_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_GAP2_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE1_RXSLOT_RSSI] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_FREQ] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_40M_20M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_160M_80M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_40M_20M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_160M_80M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_40M_20M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_160M_80M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_GAP0_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_GAP1_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_GAP2_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE2_RXSLOT_RSSI] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_FREQ] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_40M_20M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_160M_80M_GAP0] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_40M_20M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_160M_80M_GAP1] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_40M_20M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_160M_80M_GAP2] = 0x0;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_GAP0_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_GAP1_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_GAP2_ACT] = 0xff;
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_RULE3_RXSLOT_RSSI] = 0x0;
}
#endif
/*
...
OAL_STATIC oal_void host_params_init_first(oal_void)
{
    ...
    /* LINKLOSS */
    g_host_init_params[WLAN_CFG_INIT_LINK_LOSS_THRESHOLD_WLAN_BT] = WLAN_LOSS_THRESHOLD_WLAN_BT;
    g_host_init_params[WLAN_CFG_INIT_LINK_LOSS_THRESHOLD_WLAN_DBAC] = WLAN_LOSS_THRESHOLD_WLAN_DBAC;
    g_host_init_params[WLAN_CFG_INIT_LINK_LOSS_THRESHOLD_WLAN_NORMAL] = WLAN_LOSS_THRESHOLD_WLAN_NORMAL;

    /* 自动调频 */
    g_host_init_params[WLAN_CFG_INIT_PPS_THRESHOLD_LEVEL_0] = PPS_VALUE_0;
    g_host_init_params[WLAN_CFG_INIT_PPS_THRESHOLD_LEVEL_1] = PPS_VALUE_1;
    g_host_init_params[WLAN_CFG_INIT_PPS_THRESHOLD_LEVEL_2] = PPS_VALUE_2;
    g_host_init_params[WLAN_CFG_INIT_PPS_THRESHOLD_LEVEL_3] = PPS_VALUE_3;
    ...
    /* 低功耗 */
    g_host_init_params[WLAN_CFG_INIT_POWERMGMT_SWITCH] = 1;
    g_host_init_params[WLAN_CFG_INIT_PS_MODE] = 1;
    /* 可维可测 日志级别 */
    ...
    /* SCAN */
    g_host_init_params[WLAN_CFG_INIT_RANDOM_MAC_ADDR_SCAN] = 0;
    /* CONNECT */
    g_host_init_params[WLAN_CFG_INIT_RANDOM_MAC_ADDR_CONNECT] = 1;
    /* TAS SWITCH */
    g_host_init_params[WLAN_CFG_INIT_TAS_ANT_SWITCH] = OAL_FALSE;
    /* 11AC2G */
    ...
    g_host_init_params[WLAN_ATCMDSRV_LTE_ISM_PRIORITY] = 0;
    g_host_init_params[WLAN_ATCMDSRV_LTE_RX_ACT] = 0;
    g_host_init_params[WLAN_ATCMDSRV_LTE_TX_ACT] = 0;
    g_host_init_params[WLAN_CFG_INIT_FAR_DIST_DSSS_SCALE_PROMOTE_SWITCH] = 1;
    host_params_init_cca();
    g_host_init_params[WLAN_CFG_INIT_DELTA_PWR_REF_2G_20M] = 0;
    g_host_init_params[WLAN_CFG_INIT_DELTA_PWR_REF_2G_40M] = 0;
    g_host_init_params[WLAN_CFG_INIT_DELTA_PWR_REF_5G_20M] = 0;
    g_host_init_params[WLAN_CFG_INIT_DELTA_PWR_REF_5G_40M] = 0;
    g_host_init_params[WLAN_CFG_INIT_DELTA_PWR_REF_5G_80M] = 0;

#ifdef _PRE_WLAN_DOWNLOAD_PM
    g_host_init_params[WLAN_CFG_INIT_DOWNLOAD_RATE_LIMIT_PPS] = 0;
#endif
    /* 跳频参数设置 */
    g_host_init_params[WLAN_CFG_INIT_NBFH_TBTT_OFFSET] = WLAN_NBFH_TBTT_OFFSET;
    g_host_init_params[WLAN_CFG_INIT_NBFH_TBTT_SYNC_TIME] = WLAN_NBFH_TBTT_SYNC_TIME;
    g_host_init_params[WLAN_CFG_INIT_NBFH_DWELL_TIME] = WLAN_NBFH_DWELL_TIME;
    g_host_init_params[WLAN_CFG_INIT_NBFH_BEACON_TIME] = WLAN_NBFH_BEACON_TIME;

    /* INTERWORKING */
    g_host_init_params[WLAN_CFG_INIT_INTERWORKING_SWITCH] = WLAN_INTERWORKING_SWITCH;
#ifdef _PRE_WLAN_FEATURE_NRCOEX
    host_params_init_nrcoex_params();
#endif
    /* 优化特性开关 */
    g_host_init_params[WLAN_CFG_INIT_TXOP_SWITCH] = WLAN_TXOP_SWITCH;
}
...
{
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK1_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK2_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK3_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK4_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK5_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK6_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK7_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_2G_0]       = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK1_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK2_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK3_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK4_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK5_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK6_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK7_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_2G_1]       = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK1_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK2_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK3_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK4_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK5_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK6_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK7_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_2G_2]       = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK1_3] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK2_3] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK3_3] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK4_3] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK5_3] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK6_3] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK7_3] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_2G_3]       = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK1_4] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK2_4] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK3_4] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK4_4] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK5_4] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK6_4] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_5G_BANK7_4] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SAR_2G_4]       = 0xFFFFFFFF;
}
/*
...
{
    /* delt power 初始化 */
    g_nvram_init_params[NVRAM_PARAMS_INDEX_0]                 = 0x14141414;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_1]                 = 0x050F1414;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_2]                 = 0x05050505;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_3]                 = 0xFB0005FB;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_4]                 = 0xF1F1FB00;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_5]                 = 0x00050500;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_6]                 = 0x0505F6F6;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_7]                 = 0xE2F1F1FB;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_8]                 = 0xF1FBFBFB;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_9]                 = 0xF100DDE7;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_10]                = 0xE7F1F1F1;
    g_nvram_init_params[NVRAM_PARAMS_INDEX_11]                = 0x0000DDDD;
    /* 2.4G窄带基础功率初始化 */
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_2P4G_NB]  = INIT_NVM_BASE_TXPWR_2G_NB;
    /* 基准功率 */
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_2P4G]     = INIT_NVM_BASE_TXPWR_2G;
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_5G_BAND1] = INIT_NVM_BASE_TXPWR_5G;
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_5G_BAND2] = INIT_NVM_BASE_TXPWR_5G;
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_5G_BAND3] = INIT_NVM_BASE_TXPWR_5G;
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_5G_BAND4] = INIT_NVM_BASE_TXPWR_5G;
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_5G_BAND5] = INIT_NVM_BASE_TXPWR_5G;
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_5G_BAND6] = INIT_NVM_BASE_TXPWR_5G;
    g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_5G_BAND7] = INIT_NVM_BASE_TXPWR_5G;
    /* 5G 高band最大发射功率 */
    g_nvram_init_params[NVRAM_PARAMS_5G_HIGH_BAND_MAX_POW] = 0xFF;
    /* SAR值 */
    host_sar_params_init();
    /* 边带信道最大功率 */
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_5G_20M_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_5G_20M_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_5G_20M_2] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_5G_40M_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_5G_40M_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_5G_80M_0] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_5G_80M_1] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_1]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_2]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_3]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_4]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_5]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_6]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_7]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_8]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_9]  = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_10] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_11] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_12] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_SIDE_BAND_TXPWR_2G_13] = 0xFFFFFFFF;
    /* FCC CE次边带功率限制默认值 */
    g_nvram_init_params[NVRAM_PARAMS_EXT_SIDE_BAND_TXPWR_5G_20M] = 0xFFFFFFFF;
    g_nvram_init_params[NVRAM_PARAMS_EXT_SIDE_BAND_TXPWR_5G_40M] = 0xFFFFFFFF;
}
...
int32 hwifi_get_plat_tag_from_country_code(const countrycode_t country_code)
{
    ...
    while ((g_plat_tag_mapping_table[table_idx].en_regdomain != REGDOMAIN_COUNT)
           && (g_plat_tag_mapping_table[table_idx].plat_tag != INI_MODU_INVALID)) {
        /* matched */
        if (en_regdomain == g_plat_tag_mapping_table[table_idx].en_regdomain) {
            return g_plat_tag_mapping_table[table_idx].plat_tag;
        }
...
{
    oal_int32 ret;
    oal_uint8 idx = WLAN_CFG_DTS_NVRAM_RATIO_PA2GCCKA0;
    oal_uint8 param_idx;
    oal_uint8 times_idx = 0;
    ...
    if (oal_any_null_ptr3(puc_buffer_cust_nvram_tmp, pl_params, puc_cust_nvram_info)) {
        oam_error_log3(0, OAM_SF_CUSTOM,
            "hwifi_custom_host_read_dyn_cali_nvram::alloc fail.cust_nvram_tmp[%x], pl_params[%x], nvram_info[%x]",
    ...
    ret = hwifi_get_init_priv_value(WLAN_CFG_PRIV_CALI_DATA_MASK, &l_priv_value);
    if (ret == OAL_SUCC) {
    ...
    /* 拟合系数 */
    for (idx = WLAN_CFG_DTS_NVRAM_RATIO_PA2GCCKA0; idx < WLAN_CFG_DTS_NVRAM_END; idx++) {
        ret = read_conf_from_nvram(puc_buffer_cust_nvram_tmp, DY_CALI_PARAMS_LEN,
                                   g_wifi_nvram_cfg_handler[idx].ul_nv_map_idx,
                                   g_wifi_nvram_cfg_handler[idx].puc_nv_name);
        if (ret != INI_SUCC) {
            memset_s(puc_cust_nvram_info + (idx * DY_CALI_PARAMS_LEN * OAL_SIZEOF(oal_uint8)),
        ...
        puc_str = OAL_STRSTR(puc_buffer_cust_nvram_tmp, g_wifi_nvram_cfg_handler[idx].puc_param_name);
        ...
        /* 获取等号后面的实际参数 */
        puc_str += (OAL_STRLEN(g_wifi_nvram_cfg_handler[idx].puc_param_name) + 1);
        ...
        ret = memcpy_s(puc_cust_nvram_info + (idx * DY_CALI_PARAMS_LEN * OAL_SIZEOF(oal_uint8)),
                       (WLAN_CFG_DTS_NVRAM_END - idx) * DY_CALI_PARAMS_LEN, pc_token, OAL_STRLEN(pc_token));
        if (ret != EOK) {
            OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_custom_host_read_dyn_cali_nvram::memcpy fail![%d]", ret);
            os_mem_kfree(puc_buffer_cust_nvram_tmp);
            os_mem_kfree(puc_cust_nvram_info);
            os_mem_kfree(pl_params);
            return INI_FILE_TIMESPEC_UNRECONFIG;
        ...
        *(puc_cust_nvram_info + (idx * DY_CALI_PARAMS_LEN * OAL_SIZEOF(oal_uint8)) + OAL_STRLEN(pc_token)) = *pc_end;

        /* 拟合系数获取检查 */
        if (idx <= WLAN_CFG_DTS_NVRAM_RATIO_PA5GA0_LOW) {
            /* 二次参数合理性检查 */
    ...
    /* 检查NVRAM是否修改 */
    if (oal_memcmp(puc_cust_nvram_info, g_cust_nvram_info, OAL_SIZEOF(g_cust_nvram_info)) == 0) {
        os_mem_kfree(puc_cust_nvram_info);
        return INI_FILE_TIMESPEC_UNRECONFIG;
    }

    ret = memcpy_s(g_cust_nvram_info, OAL_SIZEOF(g_cust_nvram_info),
                   puc_cust_nvram_info, OAL_SIZEOF(g_cust_nvram_info));
    if (ret != EOK) {
        OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_custom_host_read_dyn_cali_nvram::memcpy fail![%d]", ret);
        os_mem_kfree(puc_cust_nvram_info);
        return INI_FILE_TIMESPEC_UNRECONFIG;
...
oal_uint32 hwifi_get_nrcoex_rule_value(oal_int32 l_start_id, oal_uint8 uc_rule_index)
{
    ...
    l_cfg_id = l_start_id + (oal_int32)(uc_rule_index * HAL_NRCOEX_RULE_PARAMS_NUM);
    if (g_st_nrcoex_ini.en_wifi_nrcoex_switch == OAL_TRUE) {
        l_ret = get_cust_conf_int32(INI_MODU_WIFI, g_wifi_config_cmds[l_cfg_id].name, &ul_value);
        if (l_ret != INI_SUCC) {
            oam_warning_log2(0, 0, "hwifi_get_nrcoex_rule_value:read fail,cfg_id=%d,l_ret=%d", l_cfg_id, l_ret);
            ul_value = (oal_uint32)g_host_init_params[l_cfg_id];
        }
    } else {
        ul_value = (oal_uint32)g_host_init_params[l_cfg_id];
    }
...
oal_uint32 hwifi_config_read_nrcoex_params(oal_void)
{
    int32                  ret;
    oal_uint32             value = 0;
    oal_uint8              rule_index = 0;
    wlan_nrcoex_rule_stru *pst_nrcoex_rule = OAL_PTR_NULL;

    /* 读取nr共存开关 */
    ret = get_cust_conf_int32(INI_MODU_WIFI, g_wifi_config_cmds[WLAN_CFG_INIT_NRCOEX_ENABLE].name, &value);
    if (ret != INI_SUCC) {
        oam_warning_log0(0, 0, "hwifi_config_init_nrcoex_params:read switch fail");
        value = (oal_uint32)g_host_init_params[WLAN_CFG_INIT_NRCOEX_ENABLE];
    }
    g_st_nrcoex_ini.en_wifi_nrcoex_switch = (value == 0 ? OAL_FALSE : OAL_TRUE);
    /* 读取各组规则 */
    for (rule_index = 0; rule_index < HAL_NRCOEX_RULE_NUM; rule_index++) {
        pst_nrcoex_rule = &g_st_nrcoex_ini.ast_nrcoex_rule[rule_index];
        hwifi_set_nrcoex_rule(pst_nrcoex_rule, rule_index);
    }
    return OAL_SUCC;
}
#endif
...
OAL_STATIC oal_int32 hwifi_config_init_delt_txpower_nvram(void)
{
    ...
    int32 cfg_id;
    int32 nvram_params[NVRAM_PARAMS_INDEX_BUTT] = {0};
    int32 plat_tag;

    plat_tag = hwifi_get_plat_tag_from_country_code(hwifi_get_country_code());
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "hwifi_config_init_delt_txpower_nvram plat_tag:0x%2x!", plat_tag);

    for (cfg_id = NVRAM_PARAMS_DELT_POWER_START; cfg_id <= NVRAM_PARAMS_DELT_POWER_END; cfg_id++) {
        if (cfg_id != g_nvram_config_ini[cfg_id].case_entry) {
            oam_error_log2(0, OAM_SF_ANY, "hwifi_config_init_delt_txpower_nvram:l_cfg_id=%d,case_entry=%d",
                           cfg_id, g_nvram_config_ini[cfg_id].case_entry);
        }
        ret = get_cust_conf_int32(plat_tag, g_nvram_config_ini[cfg_id].name, &nvram_params[cfg_id]);
        if (ret == INI_FAILED) {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "hwifi_config_init_delt_txpower_nvram read %d from ini failed!", cfg_id);
            /* 读取失败就使用系统默认值 */
            nvram_params[cfg_id] = g_nvram_init_params[cfg_id];
        }
    }

    ret = memcpy_s(g_cust_nv_params.ac_delt_txpower, sizeof(g_cust_nv_params.ac_delt_txpower),
                   nvram_params, sizeof(g_cust_nv_params.ac_delt_txpower));
    if (ret != EOK) {
        OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_config_init_delt_txpower_nvram::memcpy fail![%d]", ret);
        return INI_FAILED;
    }
    return INI_SUCC;
}
...
{
    oal_uint8 sar_lvl_idx;
    oal_uint8 nvram_params[CUS_NUM_OF_SAR_ONE_PARAM_NUM];
    oal_int32 ret;

    ret = memcpy_s(nvram_params, OAL_SIZEOF(nvram_params), &ul_nvram_params, OAL_SIZEOF(ul_nvram_params));
    if (ret != EOK) {
        OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_config_init_check_sar_lvl_idx::memcpy fail![%d]", ret);
    }

    for (sar_lvl_idx = 0; sar_lvl_idx < CUS_NUM_OF_SAR_ONE_PARAM_NUM; sar_lvl_idx++) {
        /* 定制项检查 */
        if (nvram_params[sar_lvl_idx] < CUS_MIN_OF_SAR_VAL) {
            oam_warning_log2(0, OAM_SF_CUSTOM, "hwifi_config_init_check_sar_lvl_idx:uc_cfg_id[%d], sar_val=%d",
                             ul_cus_id, nvram_params[sar_lvl_idx]);
        }
        g_sar_params[sar_lvl_idx + uc_cfg_id * CUS_NUM_OF_SAR_ONE_PARAM_NUM][uc_band_id] =
            nvram_params[sar_lvl_idx];
    }
}
/*
...
OAL_STATIC oal_int32 hwifi_config_init_sar_ctrl_nvram(void)
{
    ...
    for (uc_cfg_id = 0; uc_cfg_id < CUS_NUM_OF_SAR_PER_BAND_PAR_NUM; uc_cfg_id++) {
        for (uc_band_id = 0; uc_band_id < CUS_NUM_OF_SAR_PARAMS; uc_band_id++) {
            l_ret = get_cust_conf_int32(l_plat_tag, g_nvram_config_ini[ul_cus_id].name, &ul_nvram_params);
            if (l_ret != INI_SUCC) {
                OAM_WARNING_LOG1(0, OAM_SF_CFG, "hwifi_config_init_sar_ctrl_nvram read ini failed id[%d]!", ul_cus_id);
                /* 读取失败时,使用初始值 */
                ul_nvram_params = (oal_uint32)g_nvram_init_params[ul_cus_id];
            }
...
oal_void hwifi_config_init_5g_high_band_max_pow_nvram(oal_void)
{
    ...
    l_ret = get_cust_conf_int32(l_plat_tag, g_nvram_config_ini[l_cfg_id].name, &l_val);
    if ((l_ret == INI_FAILED) || (l_val < CUS_MIN_BASE_TXPOWER_VAL)) {
        /* 读取失败就使用系统默认值 */
        uc_5g_high_band_max_pow = (oal_uint8)g_nvram_init_params[l_cfg_id];
    } else {
        uc_5g_high_band_max_pow = (oal_uint8)l_val;
    }

    g_cust_nv_params.uc_5g_high_band_max_pow = uc_5g_high_band_max_pow;
}
...
oal_void hwifi_config_hitalk_base_power(oal_int32 l_plat_tag)
{
    ...
    oal_int32 l_ret;
    l_ret = get_cust_conf_int32(l_plat_tag, g_nvram_config_ini[NVRAM_PARAMS_TX_BASE_POWER_2P4G_NB].name,
                                &l_base_power_tmp);
    if ((l_ret == INI_FAILED) || (l_base_power_tmp > MAX_TXPOWER_MAX) || (l_base_power_tmp < MAX_TXPOWER_MIN)) {
        /* 读取失败就使用系统默认值 */
        g_cust_nv_params.uc_nb_base_power = (oal_uint8)g_nvram_init_params[NVRAM_PARAMS_TX_BASE_POWER_2P4G_NB];
    } else {
        g_cust_nv_params.uc_nb_base_power = (oal_uint8)l_base_power_tmp;
    }
}
...
oal_int32 hwifi_config_init_base_power(oal_void)
{
    ...
    for (l_cfg_id = NVRAM_PARAMS_TX_BASE_POWER_START; l_cfg_id <= NVRAM_PARAMS_TX_BASE_POWER_END; l_cfg_id++) {
        l_ret = get_cust_conf_int32(l_plat_tag, g_nvram_config_ini[l_cfg_id].name, &l_base_power_tmp);
        if ((l_ret == INI_FAILED) || (l_base_power_tmp > MAX_TXPOWER_MAX) || (l_base_power_tmp < MAX_TXPOWER_MIN)) {
            /* 读取失败就使用系统默认值 */
            auc_base_power[l_base_power_idx] = (oal_uint8)g_nvram_init_params[l_cfg_id];
        } else {
            auc_base_power[l_base_power_idx] = (oal_uint8)l_base_power_tmp;
        }
        l_base_power_idx++;
    }

    l_ret = memcpy_s(g_cust_nv_params.auc_base_power, OAL_SIZEOF(g_cust_nv_params.auc_base_power),
...
oal_int32 hwifi_config_init_fcc_ce_txpwr_nvram(oal_void)
{
    ...
    for (ul_cfg_id = NVRAM_PARAMS_SIDE_BAND_TXPWR_START; ul_cfg_id <= NVRAM_PARAMS_SIDE_BAND_TXPWR_END; ul_cfg_id++) {
        l_ret = get_cust_conf_int32(l_plat_tag, g_nvram_config_ini[ul_cfg_id].name, pl_nvram_params + uc_param_idx);
        if (l_ret != INI_SUCC) {
            OAM_WARNING_LOG1(0, OAM_SF_CFG, "hwifi_config_init_fcc_ce_txpwr_nvram read ini failed id[%d]!", ul_cfg_id);
            /* 读取失败时,使用初始值 */
            pl_nvram_params[uc_param_idx] = g_nvram_init_params[ul_cfg_id];
        }
        uc_param_idx++;
    }
    memset_s(&g_cust_nv_params.st_fcc_ce_txpwer_limit, OAL_SIZEOF(wlan_fcc_ce_power_limit_stru),
             0, OAL_SIZEOF(wlan_fcc_ce_power_limit_stru));
    /* 5g */
    /* CH140/CH100/CH64/CH36 */
    l_ret = memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_5g_txpwr_20M, FCC_CE_CH_NUM_5G_20M,
                     pl_nvram_params, OAL_SIZEOF(int32));
    pl_nvram_params++;
    /* CH161/CH157/CH153/CH149 */
    l_ret += memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_5g_txpwr_20M + OAL_SIZEOF(int32),
                      FCC_CE_CH_NUM_5G_20M - OAL_SIZEOF(int32),
                      pl_nvram_params, OAL_SIZEOF(int32));
    pl_nvram_params++;
    /* CH165 */ /* 偏移已经拷贝过数据的2*4字节，剩余长度是buff总长度减去已拷贝过数据的2*4字节 */
    l_ret += memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_5g_txpwr_20M + 2 * OAL_SIZEOF(int32),
                      FCC_CE_CH_NUM_5G_20M - 2 * OAL_SIZEOF(int32),
                      pl_nvram_params, OAL_SIZEOF(oal_uint8));
    pl_nvram_params++;
    /* CH134/CH102/CH62/CH38 */
    l_ret += memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_5g_txpwr_40M, FCC_CE_CH_NUM_5G_40M,
                      pl_nvram_params, OAL_SIZEOF(int32));
    pl_nvram_params++;
    /* CH159/CH151 */ /* 只拷贝2字节数据，因为之前已经拷贝4字节，buff大小只剩6-4=2个字节 */
    l_ret += memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_5g_txpwr_40M + OAL_SIZEOF(int32),
                      FCC_CE_CH_NUM_5G_40M - OAL_SIZEOF(int32), pl_nvram_params, 2 * OAL_SIZEOF(oal_uint8));
    pl_nvram_params++;
    /* CH122/CH106/CH58/CH42 */
    l_ret += memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_5g_txpwr_80M, FCC_CE_CH_NUM_5G_80M,
                      pl_nvram_params, OAL_SIZEOF(int32));
    pl_nvram_params++;
    /* CH155 */
    l_ret += memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_5g_txpwr_80M + OAL_SIZEOF(int32),
                      FCC_CE_CH_NUM_5G_80M - OAL_SIZEOF(int32), pl_nvram_params, OAL_SIZEOF(oal_uint8));
    if (l_ret != EOK) {
    ...
    for (uc_loop = 0; uc_loop < MAC_2G_CHANNEL_NUM; uc_loop++) {
        ...
        l_ret = memcpy_s(g_cust_nv_params.st_fcc_ce_txpwer_limit.auc_2g_txpwr[uc_loop],
...
oal_int32 hwifi_config_read_ext_fcc_ce_txpwr(oal_void)
{
    ...
    l_plat_tag = hwifi_get_plat_tag_from_country_code(hwifi_get_country_code());
    l_ret = get_cust_conf_int32(l_plat_tag, g_nvram_config_ini[NVRAM_PARAMS_EXT_SIDE_BAND_TXPWR_5G_20M].name, &l_value);
    if (l_ret != INI_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CUSTOM, "hwifi_config_read_ext_fcc_ce_txpwr:get 20M ext value fail,ret=%d", l_ret);
        l_value = g_nvram_init_params[NVRAM_PARAMS_EXT_SIDE_BAND_TXPWR_5G_20M];
    }
    /* 136/104/60/40 20M */
    l_ret = memcpy_s(g_cust_nv_params.st_ext_fcc_ce_txpwer_limit.auc_5g_txpwr_20M, FCC_CE_EXT_CH_NUM_5G_20M,
                     &l_value, OAL_SIZEOF(int32));
    if (l_ret != EOK) {
        OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_config_read_ext_fcc_ce_txpwr:memcpy fail,l_ret=%d", l_ret);
        return INI_FAILED;
    }
    l_ret = get_cust_conf_int32(l_plat_tag, g_nvram_config_ini[NVRAM_PARAMS_EXT_SIDE_BAND_TXPWR_5G_40M].name, &l_value);
    if (l_ret != INI_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_CUSTOM, "hwifi_config_read_ext_fcc_ce_txpwr:get 40M ext value fail,ret=%d", l_ret);
        l_value = g_nvram_init_params[NVRAM_PARAMS_EXT_SIDE_BAND_TXPWR_5G_40M];
    }
    /* 126/110/54/46 40M */
    l_ret = memcpy_s(g_cust_nv_params.st_ext_fcc_ce_txpwer_limit.auc_5g_txpwr_40M, FCC_CE_EXT_CH_NUM_5G_40M,
                     &l_value, OAL_SIZEOF(int32));
    if (l_ret != EOK) {
        OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_config_read_ext_fcc_ce_txpwr:memcpy fail,l_ret=%d", l_ret);
        return INI_FAILED;
...
OAL_STATIC int32 hwifi_config_init_nvram(void)
{
    ...
    if (en_nvm_initialed == OAL_FALSE) {
        ...
        if (hwifi_get_regdomain_from_country_code(hwifi_get_country_code()) != REGDOMAIN_FCC) {
            l_ret = get_cust_conf_string(CUST_MODU_NVRAM, OAL_PTR_NULL, g_nv_params, sizeof(g_nv_params));
            if ((l_ret == INI_SUCC) && (g_nv_params[0] != 0)) {
                en_nvm_initialed = OAL_TRUE; /* 读取成功，将标志位置TRUE */
                return INI_SUCC;
            }
            oam_warning_log3 (0, OAM_SF_ANY,
                "hwifi_config_init_nvram read nvram fail[%d] or wrong val[first 8 values:0x%x %x], read dts instead!",
                l_ret, *((oal_uint32 *)g_nv_params),
                *((oal_uint32 *)(g_nv_params + sizeof(uint32)))); /* 打印前8字节的值 */
        } else {
    ...
    for (l_cfg_id = NVRAM_PARAMS_INDEX_0; l_cfg_id < NVRAM_PARAMS_INDEX_BUTT; l_cfg_id++) {
        if (g_nvram_config_ini[l_cfg_id].case_entry != l_cfg_id) {
            oam_error_log2(0, OAM_SF_ANY, "hwifi_config_init_nvram:g_nvram_config_ini case_entry[%d]!=l_cfg_id[%d]",
                           g_nvram_config_ini[l_cfg_id].case_entry, l_cfg_id);
        }
    }
...
OAL_STATIC oal_void hwifi_config_get_5g_curv_switch_point(const char *puc_ini_pa_params, oal_uint32 ul_cfg_id)
{
    ...
    ps_extre_point_val = g_gs_extre_point_vals;
    ...
    for (uc_param_idx = 0; uc_param_idx < us_nv_param_num; uc_param_idx++) {
        ...
        if (l_ini_params[uc_secon_ratio_idx] != l_nv_params[uc_secon_ratio_idx]) {
            oam_warning_log4(0, OAM_SF_CUSTOM,
                "hwifi_config_nvram_second_coefficient_check::nvram get mismatch val idx[%d %d] val are [%d] and [%d]!",
                uc_param_idx,
                uc_secon_ratio_idx,
        ...
        if (ul_cfg_id == WLAN_CFG_DTS_NVRAM_RATIO_PA5GA0) {
            ...
            *(ps_5g_delt_power + uc_param_idx) = hwifi_get_5g_pro_line_delt_pow_per_band(l_nv_params +
                uc_secon_ratio_idx, l_ini_params + uc_secon_ratio_idx);
...
OAL_STATIC oal_uint32 hwifi_config_init_dy_cali_custom(oal_void)
{
    ...
    for (ul_cfg_id = WLAN_CFG_DTS_NVRAM_RATIO_PA2GCCKA0; ul_cfg_id < WLAN_CFG_DTS_NVRAM_PARAMS_BUTT; ul_cfg_id++) {
        ...
        if (hwifi_config_sepa_coefficient_from_param(auc_ini_pa_params, l_params + us_param_num,
            &us_per_param_num, OAL_SIZEOF(l_params) - us_param_num) != OAL_SUCC) {
            ul_ret = OAL_FAIL;
            oam_error_log2(0, OAM_SF_CUSTOM,
    ...
    if (ul_ret == OAL_FAIL) {
        ...
        for (uc_cali_param_idx = 0; uc_cali_param_idx < DY_CALI_PARAMS_BASE_NUM; uc_cali_param_idx++) {
            ...
            g_pro_line_params[uc_cali_param_idx].l_pow_par2 = l_params[uc_idx++];
            g_pro_line_params[uc_cali_param_idx].l_pow_par1 = l_params[uc_idx++];
            g_pro_line_params[uc_cali_param_idx].l_pow_par0 = l_params[uc_idx++];
        }
        ...
        for (uc_cali_param_idx = DY_CALI_PARAMS_BASE_NUM + 1; uc_cali_param_idx < DY_CALI_PARAMS_NUM_WLAN - 1;
            ...
            cus_flush_nv_ratio_by_delt_pow(g_pro_line_params[uc_cali_param_idx].l_pow_par2,
                g_pro_line_params[uc_cali_param_idx].l_pow_par1, g_pro_line_params[uc_cali_param_idx].l_pow_par0,
        ...
        /* 5g band1 */
        g_pro_line_params[DY_2G_CALI_PARAMS_NUM].l_pow_par2 = l_params[uc_idx++];
        g_pro_line_params[DY_2G_CALI_PARAMS_NUM].l_pow_par1 = l_params[uc_idx++];
        g_pro_line_params[DY_2G_CALI_PARAMS_NUM].l_pow_par0 = l_params[uc_idx++];

        /* 2g CW */
        g_pro_line_params[DY_2G_CALI_PARAMS_NUM - 1].l_pow_par2 = l_params[uc_idx++];
        g_pro_line_params[DY_2G_CALI_PARAMS_NUM - 1].l_pow_par1 = l_params[uc_idx++];
        g_pro_line_params[DY_2G_CALI_PARAMS_NUM - 1].l_pow_par0 = l_params[uc_idx++];

        /* 5g band1 low power */
        g_pro_line_params[DY_CALI_PARAMS_BASE_NUM].l_pow_par2 = l_params[uc_idx++];
        g_pro_line_params[DY_CALI_PARAMS_BASE_NUM].l_pow_par1 = l_params[uc_idx++];
        g_pro_line_params[DY_CALI_PARAMS_BASE_NUM].l_pow_par0 = l_params[uc_idx++];

        /* 2g cw ppa */
        g_pro_line_params[DY_CALI_PARAMS_NUM_WLAN - 1].l_pow_par2 = l_params[uc_idx++];
        g_pro_line_params[DY_CALI_PARAMS_NUM_WLAN - 1].l_pow_par1 = l_params[uc_idx++];
        g_pro_line_params[DY_CALI_PARAMS_NUM_WLAN - 1].l_pow_par0 = l_params[uc_idx++];

        // BT power fit params
        g_pro_line_params[DY_CALI_PARAMS_NUM_WLAN].l_pow_par2 = l_params[uc_idx++];
        g_pro_line_params[DY_CALI_PARAMS_NUM_WLAN].l_pow_par1 = l_params[uc_idx++];
        g_pro_line_params[DY_CALI_PARAMS_NUM_WLAN].l_pow_par0 = l_params[uc_idx++];
...
oal_uint32 hwifi_config_get_bt_dpn(oal_int32 *pl_params, oal_uint16 size)
{
    ...
    for (ul_cfg_id = WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND1; ul_cfg_id <= WLAN_CFG_DTS_BT_CALI_TXPWR_DPN_BAND8;
         ul_cfg_id++) {
        if (get_cust_conf_string(INI_MODU_WIFI, g_wifi_config_dts[ul_cfg_id].name,
...
#else
        oam_info_log3(0, OAM_SF_ANY, "hwifi_config_init [cfg_id:%d]value changed from [init:%d] to [config:%d]. \n",
                        l_cfg_id, l_ori_val, pgal_params[l_cfg_id]);
#endif
    }
    return INI_SUCC;
...
OAL_STATIC int char2byte(const char *strori, char *outbuf)
{
    ...
    for (i = 0; i < l_loop_times; i++) {
        ...
        if (i % 2 == 0) {
            outbuf[i / 2] |= (unsigned int)temp << 4;
        } else {
            outbuf[i / 2] |= (unsigned int)temp;
        }
    }
...
#ifndef _PRE_WLAN_EXPORT
/*
 * 函 数 名  : set_slave_wlan_mac_address
 * 功能描述  : 获取hi1102a芯片真实mac
 * 返 回 值  : INI_SUCC 或 INI_FAILED
 */
int32 set_slave_wlan_mac_address(const u8 *mac_list, const uint32_t len)
{
    int32 ret;
    ret = memcpy_s(g_wifimac, MAC_LEN, mac_list, len);
    if (ret != EOK) {
        OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_set_slave_mac_addr::memcpy fail![%d]", ret);
        return INI_FAILED;
    }
    return INI_SUCC;
}
...
int32 hwifi_get_mac_addr(uint8 *puc_buf)
{
    ...
    if (puc_buf == NULL ||
        memset_s(puc_buf, WLAN_MAC_ADDR_LEN, 0, MAC_LEN) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "hisi_customize_wifi::buf is NULL or memset fail !");
        return INI_FAILED;
    }
    ...
    ret = strncpy_s(st_info.nv_name, OAL_SIZEOF(st_info.nv_name), "MACWLAN", sizeof("MACWLAN"));
    if (ret != EOK) {
        OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_get_mac_addr::strncpy fail![%d]", ret);
        return INI_FAILED;
    }
    ...
    if (!ether_is_all_zero(g_wifimac)) {
        ret = memcpy_s(puc_buf, MAC_LEN, g_wifimac, MAC_LEN);
        if (ret != EOK) {
            OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_get_mac_addr::memcpy fail![%d]", ret);
            return INI_FAILED;
        }
        return INI_SUCC;
    }

    ret = external_nve_direct_access_interface(&st_info);
    if (!ret) {
        sum = char2byte(st_info.nv_data, puc_buf);
        if (sum != 0) {
            ini_warning("hisi_customize_wifi get MAC from NV: mac=" MACFMT "\n", MAC2STR(puc_buf));

            ret = memcpy_s(g_wifimac, MAC_LEN, puc_buf, MAC_LEN);
            if (ret != EOK) {
                OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_get_mac_addr::memcpy fail![%d]", ret);
                return INI_FAILED;
            }
...
int8 *hwifi_get_country_code(void)
{
    ...
    if (g_country_code[0] != '0' && g_country_code[1] != '0') {
        return g_country_code;
    }

    /* 获取cust国家码 */
    ret = get_cust_conf_string(INI_MODU_WIFI, STR_COUNTRY_CODE, g_country_code, sizeof(g_country_code));
    if (ret == INI_FAILED) {
        /* 长度去掉结束符 */
        oam_warning_log0(0, OAM_SF_ANY, "hisi_customize_wifi read country code failed, check if it exists!");
        ret = strncpy_s(g_country_code, OAL_SIZEOF(g_country_code), "99", sizeof("99") - 1);
        if (ret != EOK) {
            OAM_ERROR_LOG1(0, OAM_SF_CUSTOM, "hwifi_config_init_fcc_ce_txpwr_nvram::strncpy fail![%d]", ret);
            return g_country_code;
        }
    } else {
        /* 定制化文件读取国家码成功，判断是否为99 */
        if (!OAL_MEMCMP(g_country_code, "99", sizeof("99") - 1)) { /* 长度去掉结束符 */
    ...
    g_country_code[COUNTRY_CODE_LEN - 1] = '\0'; /* 以'\0'结尾 */
...
void hwifi_set_country_code(int8 *country_code, const uint32 len)
{
    ...
    l_ret = memcpy_s(g_country_code, COUNTRY_CODE_LEN, country_code, COUNTRY_CODE_LEN);
    if (l_ret != EOK) {
...
int32 hwifi_atcmd_update_host_nv_params(void)
{
    ...
    memset_s(g_nv_params, sizeof(g_nv_params), 0x00, sizeof(g_nv_params));

    l_ret = get_cust_conf_string(CUST_MODU_NVRAM, OAL_PTR_NULL, g_nv_params, sizeof(g_nv_params));
    if ((l_ret == INI_FAILED) || !g_nv_params[0]) {
