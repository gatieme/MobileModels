...
#define PORT_NAME_CODE_LEN          6    /* 端口名位数 */
...
enum wlan_cfg_priv {
    ...
    WLAN_CFG_PRIV_CHBA_EN,
    WLAN_CFG_PRIV_CHBA_INIT_SOCIAL_CHAN,
    WLAN_CFG_PRIV_CHBA_SOCIAL_FOLLOW_WORK,
...
extern oal_uint8 hwifi_get_chba_social_channel(void);
extern oal_bool_enum_uint8 hwifi_get_chba_social_chan_cap(void);
#ifdef CONFIG_ARCH_QCOM
extern int32 set_slave_wlan_mac_address(const u8 *mac_list, const uint32_t len);
#endif
