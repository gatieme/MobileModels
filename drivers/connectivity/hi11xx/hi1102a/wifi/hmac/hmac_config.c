...
oal_uint32 g_us_efuse_mac_addr_report;
...
oal_uint32 hmac_config_start_vap(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if ((pst_mac_vap->en_vap_state == MAC_VAP_STATE_UP) ||
        ...
        /* :Hishare 时候启动p2p client 时vap state 为fake up， 属于正常，修改log 级别为warning */
...
static void hmac_config_kick_all_user(hmac_vap_stru *hmac_vap, mac_cfg_kick_user_param_stru *kick_user_param)
{
    ...
    /* , 启动发送广播去关联帧，会因为ap还没有start，没有配置帧的发送参数，造成该帧的发送通道等没有填写
        该帧容易发送失败。 对于可能直接下电再上电，需要在start_vap时候做，这类异常情况DFR已经设计
        是在hmac_config_start_vap中设计 */
...
uint32_t hmac_config_set_chan_meas(mac_vap_stru *mac_vap, uint16_t len, uint8_t *param)
{
    ...
    hmac_chan_meas_h2d_cmd(mac_vap, meas_cmd);
    return OAL_SUCC;
}
...
oal_uint32 hmac_config_mac_addr_write(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
...
oal_uint32 hmac_config_mac_addr_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
...
oal_uint32 hmac_config_pdet_val_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_PDET_VAL_READ, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_pdet_val_read::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_tsensor_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_TSENSOR_READ, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_tsensor_read::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_power_param_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_POWER_PARAM_READ, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_power_param_read::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_autorate_level_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_NB_REPORT_INFO_READ, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_autorate_level_read::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_autorate_cfg_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_AUTORATE_CFG_SET, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_autorate_cfg_set::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_autorate_param(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_AUTORATE_PARAM, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_autorate_param::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_nokey_mode_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_NOKEY_MODE_SET, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_nokey_mode_set::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_hitalk_key_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ret;
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ret = hmac_config_send_event(mac_vap, WLAN_CFGID_KEY_INFO_RPT, len, param);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{hmac_config_hitalk_key_set::send_event failed[%d].}",
                         ret);
    }
...
oal_uint32 hmac_config_hitalk_key_rpt(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    mac_cfg_key_info_stru *key_info;
    uint8_t buf[MAX_NB_ACTION_LEN] = {0};
    struct nb_msg_hdr_stru nb_hdr = {0};

    key_info = (mac_cfg_key_info_stru *)(param);

    nb_hdr.cmd = NB_KEY_REPORT;
    nb_hdr.len = OAL_STRLEN(key_info->hitalk_key);
    memcpy_s(buf, sizeof(buf), &nb_hdr, sizeof(nb_hdr));
    memcpy_s(buf + sizeof(nb_hdr), sizeof(buf) - sizeof(nb_hdr), key_info, nb_hdr.len);
    nb_netlink_send(buf, sizeof(nb_hdr) + nb_hdr.len);
    return OAL_SUCC;
}

oal_int32 nb_netlink_send(oal_uint8 *data, oal_int data_len)
{
    oal_netbuf_stru *skb;
    ...
    if (data_len < 0) {
        OAL_IO_PRINT("WIFI nb:dev error:data_len[%ld].\n", data_len);
        return -OAL_EFAIL;
    }

    len = (oal_uint)oal_nlmsg_space(((oal_uint)data_len));
    skb = alloc_skb(len, GFP_KERNEL);
    if (skb == NULL) {
        OAL_IO_PRINT("WIFI nb:dev error: allocate failed, len[%lu].\n", len);
        return -OAL_EFAIL;
    }
    nlh = oal_nlmsg_put(skb, 0, 0, 0, data_len, 0);

    OAL_IO_PRINT("WIFI nb: data[%s].\n", data);

    if (unlikely(memcpy_s(oal_nlmsg_data(nlh), data_len, data, data_len) != EOK)) {
        OAL_IO_PRINT("WIFI nb: buf data load failed.\n");
        kfree_skb(skb);
        return -OAL_EFAIL;
    }

#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 6, 34))
    oal_netlink_cb(skb).portid = 0; /* from kernel */
#elif (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 34))
    oal_netlink_cb(skb).pid = 0; /* from kernel */
#endif
    if (g_nb_handler_data.nlsk == OAL_PTR_NULL) {
        OAL_IO_PRINT("WIFI nb: NULL Pointer_sock.\n");
        kfree_skb(skb);
        return -OAL_EFAIL;
    }

    ret = oal_netlink_unicast(g_nb_handler_data.nlsk, skb, g_nb_handler_data.usepid, MSG_DONTWAIT);
    if (ret <= 0) {
        OAL_IO_PRINT("WIFI nb:send dev error netlink msg, ret = %d \n", ret);
    }
...
oal_uint32 hmac_config_autorate_level_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    ...
    if (hmac_vap == NULL) {
        OAM_ERROR_LOG0(mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_autorate_level_report::hmac_vap null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    report_to_app_info = (nb_report_info *)(param);
    oam_warning_log4(0, OAM_SF_ANY, "{hmac_config_autorate_level_report:is_connected[%d],ratelvl[%d],channel[%d],bw[%d].}",
        report_to_app_info->is_connected,
        report_to_app_info->rate_level,
        report_to_app_info->channel,
        report_to_app_info->bw);
    oam_warning_log2(0, OAM_SF_ANY, "{hmac_config_autorate_level_report:rssi[%d],succ_rate[%d].}",
        (int32_t)report_to_app_info->rssi,
        report_to_app_info->succ_rate);
    nb_hdr.cmd = NB_GET_REPORT_INFO;
    nb_hdr.len = sizeof(nb_report_info);
    memcpy_s(buf, sizeof(buf), &nb_hdr, sizeof(nb_hdr));
    memcpy_s(buf + sizeof(nb_hdr), sizeof(buf) - sizeof(nb_hdr), report_to_app_info, sizeof(nb_report_info));
    nb_netlink_send(buf, sizeof(nb_hdr) + sizeof(nb_report_info));
...
oal_uint32 hmac_config_report_mac_addr(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    hmac_vap_stru *hmac_vap;
    hmac_vap = mac_res_get_hmac_vap(mac_vap->uc_vap_id);
    if (hmac_vap == NULL) {
    ...
    g_us_efuse_mac_addr_report = *(oal_uint32 *)(param);
...
oal_uint32 hmac_config_tsensor_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    hmac_vap_stru *hmac_vap;
    oal_int16 tsensor_report = 0;
    hmac_vap = mac_res_get_hmac_vap(mac_vap->uc_vap_id);
    if (hmac_vap == NULL) {
        OAM_ERROR_LOG0(mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_tsensor_report::hmac_vap null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    tsensor_report = *(oal_int16 *)(param);

    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{hmac_config_tsensor_report:tsensor_report=%d.}", tsensor_report);

    return OAL_SUCC;
}


oal_uint32 hmac_config_power_param_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    hmac_vap_stru *hmac_vap;
    mac_pow_param_report_stru pow_param;
    hmac_vap = mac_res_get_hmac_vap(mac_vap->uc_vap_id);
    if (hmac_vap == NULL) {
        OAM_ERROR_LOG0(mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_power_param_report::hmac_vap null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    pow_param = *(mac_pow_param_report_stru *)(param);

    oam_warning_log3(0, OAM_SF_ANY, "{hmac_config_power_param_report:upc=0x%08x,lpf=0x%08x,dbb=0x%08x.}",
                                    pow_param.upc_data, pow_param.lpf_data, pow_param.dbb_data);

    return OAL_SUCC;
}


oal_uint32 hmac_config_reg_info_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    hmac_vap_stru *hmac_vap;
    oal_uint32 *reg_info_report;
    hmac_vap = mac_res_get_hmac_vap(mac_vap->uc_vap_id);
    if (hmac_vap == NULL) {
        OAM_ERROR_LOG0(mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_reg_info_report::hmac_vap null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    reg_info_report = (oal_uint32 *)(param);

    oam_warning_log2(0, OAM_SF_CFG, "{hmac_config_reg_info_report::reg_info addr=0x%08x, value=0x%08x", reg_info_report[0], reg_info_report[1]);
...
oal_uint32 hmac_config_pdet_val_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    hmac_vap_stru *hmac_vap;
    hmac_dyn_cali_vdet_val_stru vdet_val_report = {0};
    hmac_vap = mac_res_get_hmac_vap(mac_vap->uc_vap_id);
    if (hmac_vap == NULL) {
        OAM_ERROR_LOG0(mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_pdet_val_report::hmac_vap null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    vdet_val_report = *(hmac_dyn_cali_vdet_val_stru *)(param);

    oam_warning_log4(0, OAM_SF_ANY, "{hmac_config_pdet_val_report:pdet_val_i_mv=%d pdet_val_q_mv=%d \
                            pdet_val_i_db=%d pdet_val_q_db=%d.}",
                             vdet_val_report.uc_pdet_val_i_mv, vdet_val_report.uc_pdet_val_q_mv,
                             vdet_val_report.uc_pdet_val_i_db, vdet_val_report.uc_pdet_val_q_db);
...
oal_uint32 hmac_config_query_tid_queue(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
...
oal_uint32 hmac_config_device_software_version_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
    hmac_vap_stru *hmac_vap;
    oal_uint8 *device_software_version;
    hmac_vap = mac_res_get_hmac_vap(mac_vap->uc_vap_id);
    if (hmac_vap == NULL) {
        OAM_ERROR_LOG0(mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_config_device_software_version_report::hmac_vap null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    device_software_version = (param);

    OAL_IO_PRINT("wlan_device_software_version::%s\r\n", device_software_version);
...
OAL_STATIC oal_uint32 hmac_config_query_tid_queue_rsp(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param)
{
...
OAL_STATIC OAL_CONST hmac_config_syn_stru g_ast_hmac_config_syn[] = {
    ...
    { WLAN_CFGID_GET_VERSION,  { 0, 0 }, hmac_config_device_software_version_report },
#else
    ...
    { WLAN_CFGID_PDET_VAL_READ, { 0, 0 }, hmac_config_pdet_val_report },
    { WLAN_CFGID_TSENSOR_READ, { 0, 0 }, hmac_config_tsensor_report },
    { WLAN_CFGID_POWER_PARAM_READ, { 0, 0 }, hmac_config_power_param_report },
    { WLAN_CFGID_REG_INFO_REPORT, { 0, 0 }, hmac_config_reg_info_report },
#ifdef _PRE_WLAN_NARROW_BAND
    { WLAN_CFGID_NB_REPORT_INFO_READ, { 0, 0 }, hmac_config_autorate_level_report },
    { WLAN_CFGID_KEY_INFO_RPT, { 0, 0 }, hmac_config_hitalk_key_rpt },
#endif
...
uint32_t hmac_config_tsf_event_process(mac_vap_stru *mac_vap, uint8_t len, uint8_t *param)
{
    ...
    hmac_vap->sync_tsf.host_end_tsf = ktime_get_real().tv64;
#else
...
oal_module_symbol(hmac_config_mac_addr_write);
oal_module_symbol(hmac_config_mac_addr_read);
oal_module_symbol(hmac_config_pdet_val_read);
oal_module_symbol(hmac_config_tsensor_read);
oal_module_symbol(hmac_config_power_param_read);
#ifdef _PRE_WLAN_NARROW_BAND
oal_module_symbol(hmac_config_autorate_level_read);
oal_module_symbol(hmac_config_autorate_cfg_set);
oal_module_symbol(hmac_config_nokey_mode_set);
#endif
#ifdef _PRE_WLAN_FEATURE_11D
