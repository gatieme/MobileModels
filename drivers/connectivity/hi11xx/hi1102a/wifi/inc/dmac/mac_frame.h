...
typedef enum {
    ...
    MAC_EID_NOKEY                  = 207, /* Hitalk Nokey Mode IE */
    MAC_EID_KEY_INFO               = 208,
#endif
...
OAL_STATIC OAL_INLINE oal_uint16  mac_get_auth_alg(oal_uint8 *payload, oal_uint16 payload_len)
{
    ...
    us_auth_alg = payload[BIT_OFFSET_1];
    /* puc_mac_hdr[MAC_80211_FRAME_LEN + 1]高8位与puc_mac_hdr[MAC_80211_FRAME_LEN + 0]低8位拼接成16位认证状态字段 */
    us_auth_alg = (oal_uint16)((us_auth_alg << BIT_OFFSET_8) | payload[BIT_OFFSET_0]);

    return us_auth_alg;
}


OAL_STATIC OAL_INLINE oal_uint16  mac_get_auth_status(uint8_t *paylaod, uint16_t payload_len)
{
