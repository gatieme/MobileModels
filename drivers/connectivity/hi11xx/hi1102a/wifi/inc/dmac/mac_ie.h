...
typedef oal_rom_cb_result_enum_uint8 (*p_mac_ie_proc_opmode_field_cb)(mac_vap_stru *pst_mac_vap,
...
/*****************************************************************************
  11 函数声明
*****************************************************************************/
extern wlan_channel_bandwidth_enum_uint8 mac_get_bandwith_from_center_freq_seg0(oal_uint8 uc_channel,
...
extern wlan_mib_mimo_power_save_enum_uint8 mac_ie_proc_sm_power_save_field(mac_user_stru *pst_mac_user,
                                                                           oal_uint8 uc_smps);

extern oal_bool_enum_uint8 mac_ie_proc_ht_green_field(mac_user_stru *pst_mac_user_sta,
                                                      mac_vap_stru *pst_mac_vap,
                                                      oal_uint8 uc_ht_green_field,
                                                      oal_bool_enum en_prev_asoc_ht);

extern oal_bool_enum_uint8 mac_ie_proc_ht_supported_channel_width(mac_user_stru *pst_mac_user_sta,
                                                                  mac_vap_stru *pst_mac_vap,
                                                                  oal_uint8 uc_supported_channel_width,
                                                                  oal_bool_enum en_prev_asoc_ht);

extern oal_bool_enum_uint8 mac_ie_proc_lsig_txop_protection_support(mac_user_stru *pst_mac_user_sta,
                                                                    mac_vap_stru *pst_mac_vap,
...
#endif
extern oal_uint8 mac_ie_get_chan_num(oal_uint8 *puc_frame_body,
                                     oal_uint16 us_frame_len,
                                     oal_uint16 us_offset,
                                     oal_uint8 us_curr_chan);

#ifdef _PRE_WLAN_FEATURE_20_40_80_COEXIST
extern oal_uint32 mac_ie_proc_chwidth_field(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user,
                                            oal_uint8 uc_chwidth);
#endif

extern oal_uint32 mac_set_second_channel_offset_ie(wlan_channel_bandwidth_enum_uint8 en_bw,
                                                   oal_uint8 *pauc_buffer,
                                                   oal_uint8 *puc_output_len);
extern oal_uint32 mac_set_11ac_wideband_ie(oal_uint8 uc_channel,
                                           wlan_channel_bandwidth_enum_uint8 en_bw,
                                           oal_uint8 *pauc_buffer,
                                           oal_uint8 *puc_output_len);
#if _PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1102A_HOST
extern oal_bool_enum_uint8 mac_ie_check_p2p_action(oal_uint8 *payload, oal_uint16 payload_len);
#else
extern oal_bool_enum_uint8 mac_ie_check_p2p_action(oal_uint8 *payload);
#endif
extern oal_uint32 mac_ie_proc_ht_sta(mac_vap_stru *pst_mac_sta,
...
extern oal_uint32 mac_ie_proc_sec_chan_offset_2040(mac_vap_stru *pst_mac_vap,
                                                   mac_sec_ch_off_enum_uint8 en_sec_chan_offset);
extern oal_uint32 mac_proc_ht_opern_ie(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                                       mac_user_stru *pst_mac_user);
extern oal_uint32 mac_ie_proc_vht_opern_ie(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                                           mac_user_stru *pst_mac_user);
#ifdef _PRE_WLAN_FEATURE_OPMODE_NOTIFY
extern oal_uint32 mac_ie_proc_opmode_field(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user,
                                           mac_opmode_notify_stru *pst_opmode_notify);
extern oal_rom_cb_result_enum_uint8 mac_ie_proc_opmode_field_cb(mac_vap_stru *pst_mac_vap,
                                                                mac_user_stru *pst_mac_user,
                                                                mac_opmode_notify_stru *pst_opmode_notify);
#endif
extern oal_void mac_ie_modify_vht_ie_short_gi_80(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload_addr_start,
                                                 oal_uint8 *puc_payload_addr_end);
