...
OAL_STATIC int8 g_wlan_name[PORT_NAME_CODE_LEN] = "00";
OAL_STATIC int8 g_p2p_name[PORT_NAME_CODE_LEN] = "00";
#endif
...
struct kobject *g_p_sys_kobject;
#endif
...
#endif
extern oal_uint32 g_us_efuse_mac_addr_report;
#ifdef _PRE_WLAN_EXPORT
extern oal_uint8 device_mac_addr[WLAN_MAC_ADDR_LEN];
#endif
/* 静态函数声明 */
...
#ifdef _PRE_WLAN_CHBA_MGMT
OAL_STATIC uint32_t wal_hipriv_chba_chan_switch(oal_net_device_stru *pst_net_dev, int8_t *pc_param);
OAL_STATIC uint32_t wal_hipriv_chba_module_init(oal_net_device_stru *pst_net_dev, int8_t *pc_param);
OAL_STATIC uint32_t wal_hipriv_chba_set_auto_bitmap(oal_net_device_stru *pst_net_dev, int8_t *pc_param);
OAL_STATIC uint32_t wal_hipriv_chba_set_user_bitmap(oal_net_device_stru *pst_net_dev, int8_t *pc_param);
OAL_STATIC uint32_t wal_hipriv_chba_set_vap_bitmap(oal_net_device_stru *pst_net_dev, int8_t *pc_param);
static uint32_t wal_hipriv_chba_log_level(oal_net_device_stru *net_dev, int8_t *param);
OAL_STATIC uint32_t wal_hipriv_chba_set_ps_thres(oal_net_device_stru *net_dev, int8_t *param);
static uint32_t wal_hipriv_chba_island_chan_switch(oal_net_device_stru *net_dev, int8_t *param);
OAL_STATIC uint32_t wal_hipriv_set_chba_feature_switch(oal_net_device_stru *pst_net_dev, int8_t *pc_param);
static uint32_t wal_hipriv_set_chba_channel_seq(oal_net_device_stru *net_dev, int8_t *param);
static uint32_t wal_hipriv_set_chba_battery(oal_net_device_stru *net_dev, int8_t *pc_param);
static uint32_t wal_hipriv_set_coex_chan_info(oal_net_device_stru *net_dev, int8_t *pc_param);
int32_t wal_ioctl_chba_set_coex(oal_net_device_stru *net_dev, uint8_t *command);
#endif
int32_t wal_ioctl_chan_meas(oal_net_device_stru *net_dev, int8_t *param);
static uint32_t wal_hipriv_start_chan_meas(oal_net_device_stru *net_dev, int8_t *pc_param);
OAL_STATIC int wal_ioctl_get_essid(oal_net_device_stru *pst_net_dev, oal_iw_request_info_stru *pst_info,
    oal_iwreq_data_union *pst_wrqu, char *pc_param);
...
OAL_STATIC int wal_ioctl_get_iwname(oal_net_device_stru *pst_net_dev, oal_iw_request_info_stru *pst_info,
    oal_iwreq_data_union *pst_wrqu, char *pc_extra);
OAL_STATIC int wal_ioctl_get_mode(oal_net_device_stru *pst_net_dev, oal_iw_request_info_stru *pst_info,
    oal_iwreq_data_union *pst_wrqu, char *pc_param);
...
OAL_STATIC oal_uint32 wal_hipriv_mac_addr_write(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
OAL_STATIC oal_uint32 wal_hipriv_mac_addr_read(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
OAL_STATIC oal_uint32 wal_hipriv_pdet_val_read(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
OAL_STATIC oal_uint32 wal_hipriv_tsensor_read(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
OAL_STATIC oal_uint32 wal_hipriv_power_param_read(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
OAL_STATIC oal_uint32 wal_hipriv_device_software_version_read(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
#ifdef _PRE_WLAN_NARROW_BAND
OAL_STATIC oal_uint32 wal_hipriv_autorate_cfg_set(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
OAL_STATIC oal_uint32 wal_hipriv_autorate_param(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
#endif
...
oal_int32 wal_ioctl_set_wps_p2p_ie(oal_net_device_stru *pst_net_dev, oal_uint8 *puc_buf,
    oal_uint32 ul_len, en_app_ie_type_uint8 en_type);
...
OAL_STATIC oal_int32 wal_ioctl_process_nrcoex_priority(oal_net_device_stru *pst_net_dev, oal_int8 *pc_command);
OAL_STATIC oal_int32 wal_ioctl_get_nrcoex_info(oal_net_device_stru *pst_net_dev,
    oal_ifreq_stru *pst_ifr, oal_int8 *pc_command);
...
#ifdef CONFIG_ARCH_QCOM
#define CMD_SMALL_CHIP_NOT_DOWN   "CMD_SMALL_CHIP_NOT_DOWN"
#endif
...
#define CMD_GET_PHY_RATE_LEN                     (OAL_STRLEN(CMD_GET_PHY_RATE))
#define CMD_GET_SUPPORTED_BAND_LEN               (OAL_STRLEN(CMD_GET_SUPPORTED_BAND))
#define CMD_GET_CHAN_BW_LEN                      (OAL_STRLEN(CMD_GET_CHAN_BW))
#define CMD_GET_CURRENT_TSF_LEN                  (OAL_STRLEN(CMD_GET_CURRENT_TSF))
#define CMD_GET_NON_COEX_IFACE_LEN               (OAL_STRLEN(CMD_GET_NON_COEX_IFACE))
#ifdef _PRE_WLAN_CHBA_MGMT
#define CMD_GET_STA_PROXY_INFO_LEN               (OAL_STRLEN(CMD_GET_STA_PROXY_INFO))
#define CMD_GET_COEX_INFO_LEN                    (OAL_STRLEN(CMD_GET_COEX_INFO))
#define CMD_GET_MAC_CHBA_USER_INFO_LEN           (OAL_STRLEN(CMD_GET_MAC_CHBA_USER_INFO))
...
#ifdef CONFIG_ARCH_QCOM
#define CMD_SMALL_CHIP_NOT_DOWN_LEN              (OAL_STRLEN(CMD_SMALL_CHIP_NOT_DOWN))
#endif
#ifdef _PRE_WLAN_FEATURE_VOWIFI
 ...
 */
    ...
    /* 设置分片过滤调试命令 hipriv "Hisilicon0 rx_filter_frag 0|1" */
 ...
 */
    ...
    /* 读取mac地址, hipriv "wlan0 mac_read" */
    { "mac_read", wal_hipriv_mac_addr_read },
    /* 读取pdet值, hipriv "wlan0 pdet_read" */
    { "pdet_read", wal_hipriv_pdet_val_read },
    /* 读取tsensor值, hipriv "wlan0 tsensor_read" */
    { "tsensor_read", wal_hipriv_tsensor_read },
    /* 读取功率值, hipriv "wlan0 power_read" */
    { "power_read", wal_hipriv_power_param_read },
    /* 读取版本号, hipriv "wlan0 device_software_version_read" */
    { "device_software_version_read", wal_hipriv_device_software_version_read },
#ifdef _PRE_WLAN_NARROW_BAND
    /* 读取速率档位值, hipriv "wlan0 autorate_level_read" */
    { "nb_report_info", wal_hipriv_nb_report_info_read },
    /* 读取速率自适应参数值, hipriv "wlan0 autorate_cfg_set" */
    { "autorate_cfg_set", wal_hipriv_autorate_cfg_set },
    /* 下发自适应速率表参数 hipriv.sh "wlan0 autorate_param" */
    { "autorate_param", wal_hipriv_autorate_param },
    /* 设置对频模式 hipriv.sh "wlan0 no_key_mode_set 1/0" */
    { "no_key_mode_set", wal_hipriv_nokey_mode_set },
    /* 设置对频模式 hipriv.sh "wlan0 hitalk_key_set (ssid) (key)" */
    { "hitalk_key_set", wal_hipriv_hitalk_key_set },
#endif
 ...
 */
...
#endif
    /* sh hipriv.sh "chba0/wlan0 start_chan_meas  meas_type(当前只能取4) scan_chan scan_time scan_band" */
    ...
    { "set_chba_channel_seq", wal_hipriv_set_chba_channel_seq },
#endif
};
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE) && (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
/*
     不支持ethtool_ops 相关函数操作,需要显示定义空的结构体,
    否则将采用内核默认的ethtool_ops会导致空指针异常
*/
...
OAL_CONST oal_int8   *g_pauc_tx_pow_param_name[WAL_TX_POW_PARAM_BUTT] = {
    "rf_reg_ctl",
    "mag_level",
    "ctl_level",
    "show_log",
...
#ifdef _PRE_WLAN_NARROW_BAND
OAL_CONST oal_int8   *g_pauc_autorate_cfg_param_name[WAL_AUTORATE_CFG_PARAM_BUTT] = {
    "enable",
    "level",
};
#endif
...
OAL_CONST oal_int8   *g_pauc_tx_dscr_param_name[WAL_DSCR_PARAM_BUTT] = {
    "fbm",
    "pgl",
    "mtpgl",
    "sae",
...
OAL_STATIC OAL_CONST oal_int8   *g_pauc_bw_tbl[WLAN_BAND_ASSEMBLE_AUTO] = {
    "20",
    "rsv1",
    "rsv2",
    "rsv3",
...
OAL_STATIC OAL_CONST oal_int8   *g_pauc_non_ht_rate_tbl[WLAN_LEGACY_RATE_VALUE_BUTT] = {
    "1",
    "2",
    "5.5",
    "11",
...
oal_uint32 wal_alloc_cfg_event(oal_net_device_stru *pst_net_dev, frw_event_mem_stru **ppst_event_mem,
    oal_void *pst_resp_addr, wal_msg_stru **ppst_cfg_msg, oal_uint16 us_len)
{
    ...
    *ppst_event_mem = pst_event_mem; /* 出参赋值 */
    ...
    frw_event_hdr_init(&(pst_event->st_event_hdr), FRW_EVENT_TYPE_HOST_CRX, WAL_HOST_CRX_SUBTYPE_CFG,
        us_len, FRW_EVENT_PIPELINE_STAGE_0, pst_vap->uc_chip_id, pst_vap->uc_device_id, pst_vap->uc_vap_id);
...
oal_int32 wal_send_cfg_event(oal_net_device_stru *pst_net_dev, wal_msg_type_enum_uint8 en_msg_type,
    oal_uint16 us_len, oal_uint8 *puc_param, oal_bool_enum_uint8 en_need_rsp, wal_msg_stru **ppst_rsp_msg)
{
    ...
    sn = (oal_uint8)wal_get_msg_sn();
    /* 填写配置消息 */
    wal_cfg_msg_hdr_init(&(pst_cfg_msg->st_msg_hdr), en_msg_type, us_len, sn);
...
{
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
    oal_wireless_dev_stru *pst_wdev = oal_netdevice_wdev(pst_net_dev);
    ...
    ***************************************************************************/
    ...
    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_vap_h2d_stru), (oal_uint8 *)&st_write_msg,
...
oal_void hwifi_config_init_base_power_main(oal_net_device_stru *pst_net_dev)
{
    ...
    l_ret = wal_send_cfg_event(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_uint8) * CUS_BASE_POWER_NUM, (oal_uint8 *)&st_write_msg,
...
oal_void hwifi_config_init_fcc_ce_power_main(oal_net_device_stru *pst_net_dev)
{
    ...
    l_ret = wal_send_cfg_event(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(wlan_fcc_ce_power_limit_stru), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (l_ret != OAL_SUCC) {
...
{
    wlan_customize_power_params_stru *pst_nvram = hwifi_get_nvram_params();
    wal_msg_write_stru st_write_msg;
    oal_int32 l_ret;
    regdomain_enum en_regdomain;
    ...
    l_ret = wal_send_cfg_event(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(wlan_ext_fcc_ce_power_limit_stru), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (l_ret != OAL_SUCC) {
...
OAL_STATIC oal_void hwifi_config_tcp_ack_ini_param(oal_void)
{
    ...
    g_ul_2g_tx_large_pps_th = (l_val >= 0) ? (oal_uint32)l_val : WLAN_DEVICE_RX_TCP_ACK_DEFAULT_2G_TH;

    l_val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_DEVICE_RX_TCP_ACK_5G_TH);
    g_ul_5g_tx_large_pps_th = (l_val >= 0) ? (oal_uint32)l_val : WLAN_DEVICE_RX_TCP_ACK_DEFAULT_5G_TH;
}
...
OAL_STATIC oal_void hwifi_config_ddr_cpu_freq_ini_param(oal_void)
{
    ...
    g_st_thread_bindcpu.en_irq_bindcpu =
        (l_val > 0) ? ((l_val == 1) ? OAL_TRUE : WLAN_IRQ_AFFINITY_EN) : OAL_FALSE;
...
oal_void hwifi_config_host_global_ini_roam(oal_void)
{
    ...
    g_wlan_customize.uc_roam_switch = ((val == 0) || (val == 1)) ? (oal_uint8)val : g_wlan_customize.uc_roam_switch;
    g_wlan_customize.uc_roam_scan_band = (mac_get_band_5g_enabled()) ? (BIT0 | BIT1) : BIT0;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_SCAN_ORTHOGONAL);
    g_wlan_customize.uc_roam_scan_orthogonal = (val >= 1) ? (oal_uint8)val : g_wlan_customize.uc_roam_scan_orthogonal;

    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_TRIGGER_B);
    g_wlan_customize.c_roam_trigger_b = (oal_int8)val;

    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_TRIGGER_A);
    g_wlan_customize.c_roam_trigger_a = (oal_int8)val;

    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_DELTA_B);
    g_wlan_customize.c_roam_delta_b = (oal_int8)val;

    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_DELTA_A);
    g_wlan_customize.c_roam_delta_a = (oal_int8)val;
...
OAL_STATIC oal_void hwifi_config_lte_gpio_ini_param(oal_void)
{
    ...
    g_wlan_customize.ul_lte_gpio_check_switch = (oal_uint32) !!val;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_ATCMDSRV_LTE_ISM_PRIORITY);
    g_wlan_customize.ul_lte_ism_priority = (oal_uint32)val;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_ATCMDSRV_LTE_RX_ACT);
    g_wlan_customize.ul_lte_rx_act = (oal_uint32)val;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_ATCMDSRV_LTE_TX_ACT);
    g_wlan_customize.ul_lte_tx_act = (oal_uint32)val;
}
...
#ifdef _PRE_WLAN_FEATURE_MULTI_NETBUF_AMSDU
    oal_int32 val;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_AMPDU_AMSDU_SKB);
    tx_large_amsdu->uc_tx_amsdu_ampdu_en = (val > 0) ? OAL_TRUE : OAL_FALSE;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_AMSDU_AMPDU_TH_HIGH);
    tx_large_amsdu->us_amsdu_ampdu_throughput_high =
        (val > 0) ? (oal_uint16)val : WLAN_AMSDU_AMPDU_THROUGHPUT_THRESHOLD_HIGH;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_AMSDU_AMPDU_TH_LOW);
    tx_large_amsdu->us_amsdu_ampdu_throughput_low =
        (val > 0) ? (oal_uint16)val : WLAN_AMSDU_AMPDU_THROUGHPUT_THRESHOLD_LOW;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_RX_AMPDU_AMSDU_SKB);
    g_uc_host_rx_ampdu_amsdu = (val > 0) ? OAL_TRUE : OAL_FALSE;
#endif
}
...
#ifdef _PRE_WLAN_TCP_OPT
    oal_int32 val;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_TCP_ACK_FILTER);
    g_st_tcp_ack_opt_th_params.uc_tcp_ack_filter_en = (val > 0) ? OAL_TRUE : OAL_FALSE;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_TCP_ACK_FILTER_TH_HIGH);
    g_st_tcp_ack_opt_th_params.us_rx_filter_throughput_high =
        (val > 0) ? (oal_uint16)val : WLAN_TCP_ACK_FILTER_TH_HIGH;
    val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_TCP_ACK_FILTER_TH_LOW);
    g_st_tcp_ack_opt_th_params.us_rx_filter_throughput_low =
        (val > 0) ? (oal_uint16)val : WLAN_TCP_ACK_FILTER_TH_LOW;
...
OAL_STATIC oal_void hwifi_config_random_mac_addr_scan_ini_param(oal_void)
{
    ...
    g_wlan_customize.uc_random_mac_addr_scan = !!l_val;

    l_val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_RANDOM_MAC_ADDR_CONNECT);
    g_wlan_customize.en_random_mac_addr_connect = !!l_val;
}
OAL_STATIC oal_void hwifi_config_tas_switch_ini_param(oal_void)
{
    ...
    g_wlan_customize.uc_disable_capab_2ght40 = (oal_uint8) !!l_val;
}
#ifdef _PRE_WLAN_FEATURE_AUTO_FREQ
static void hwifi_speed_freq_level_copy(host_speed_freq_level_stru *host_speed_freq_level,
                                        host_speed_freq_level_stru *host_speed_freq_level_tmp,
                                        device_speed_freq_level_stru *device_speed_freq_level,
                                        device_speed_freq_level_stru *device_speed_freq_level_tmp)
{
    oal_uint8 index;

    if (memcpy_s(host_speed_freq_level, hmac_wifi_get_host_speed_freq_level_size(),
        host_speed_freq_level_tmp, hmac_wifi_get_host_speed_freq_level_size()) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{hwifi_config_host_global_ini_param::memcpy_s fail!}\r\n");
    }

    if (memcpy_s(device_speed_freq_level, hmac_wifi_get_device_speed_freq_level_size(),
        device_speed_freq_level_tmp, hmac_wifi_get_device_speed_freq_level_size()) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{hwifi_config_host_global_ini_param::memcpy_s fail!!}\r\n");
    }

    for (index = 0; index < 4; index++) { /* ast_host_speed_freq_level_tmp结构体数组长度为4 */
        oam_warning_log2(0, OAM_SF_ANY, "hwifi_config_host_global_ini_param:uc_device_type=[%d], pps_value = [%d]}",
                         device_speed_freq_level[index].uc_device_type,
                         host_speed_freq_level[index].ul_speed_level);
    }
}
#endif
...
OAL_STATIC oal_int32 hwifi_config_host_global_ini_param(oal_void)
{
    ...
    oal_int8 *pc_tmp;
    device_speed_freq_level_stru device_speed_freq_level_tmp_array[4];
    host_speed_freq_level_stru host_speed_freq_level_tmp_array[4] = {
    ...
    device_speed_freq_level_stru *device_speed_freq_level_tmp = &device_speed_freq_level_tmp_array[0];
    host_speed_freq_level_stru *host_speed_freq_level_tmp = &host_speed_freq_level_tmp_array[0];
    ...
    device_speed_freq_level_stru *device_speed_freq_level = hmac_wifi_get_device_speed_freq_level_addr();
    host_speed_freq_level_stru *host_speed_freq_level = hmac_wifi_get_host_speed_freq_level_addr();
    /******************************************** 性能 ********************************************/
    l_val = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_AMPDU_TX_MAX_NUM);
    g_wlan_customize.ul_ampdu_tx_max_num =
        ((l_val <= WLAN_AMPDU_TX_MAX_NUM) && (l_val >= 1)) ? (oal_uint32)l_val : g_wlan_customize.ul_ampdu_tx_max_num;
    OAL_IO_PRINT("hisi_customize_wifi::ampdu_tx_max_num:%d", g_wlan_customize.ul_ampdu_tx_max_num);
    ...
    for (cfg_id = WLAN_CFG_INIT_PPS_THRESHOLD_LEVEL_0; cfg_id <= WLAN_CFG_INIT_PPS_THRESHOLD_LEVEL_3; ++cfg_id) {
        ...
        if ((l_cfg_value >= PPS_VALUE_MIN) && (l_cfg_value <= PPS_VALUE_MAX)) {
            host_speed_freq_level_tmp_array[uc_index].ul_speed_level = (oal_uint32)l_cfg_value;
            uc_index++;
        } else {
            uc_flag = OAL_TRUE;
    ...
    pc_tmp = (oal_int8 *)&device_speed_freq_level_tmp_array;
    ...
    if (!uc_flag) {
        ...
        hwifi_speed_freq_level_copy(host_speed_freq_level, host_speed_freq_level_tmp,
                                    device_speed_freq_level, device_speed_freq_level_tmp);
        ...
        *((oal_int8 *)(st_write_msg.auc_value)) = OAL_TRUE;
        ...
        l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
            WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_int32), (oal_uint8 *)&st_write_msg,
            OAL_FALSE, OAL_PTR_NULL);
        if (oal_unlikely(l_ret != OAL_SUCC)) {
...
OAL_STATIC oal_void hwifi_config_init_ini_perf(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + us_len, (oal_uint8 *)&st_write_msg, OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
OAL_STATIC oal_void hwifi_config_init_ini_linkloss(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_linkloss_threshold), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
oal_void hwifi_config_init_nrcoex_params(oal_net_device_stru *pst_net_dev)
{
    ...
    l_ret = wal_send_cfg_event(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(wlan_nrcoex_ini_stru), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (l_ret != OAL_SUCC) {
...
OAL_STATIC oal_void hwifi_config_init_ini_rf(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(wlan_cfg_customize_rf), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
OAL_STATIC oal_void hwifi_config_init_ini_download_pm(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    *(oal_uint16 *)st_write_msg.auc_value = us_download_rate_limit_pps;
    ...
    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_uint16), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
OAL_STATIC oal_void hwifi_config_cali_mask_enable(oal_int32 *pl_priv_value)
{
    ...
    if (g_wlan_cal_disable_1102a == OAL_TRUE) {
...
oal_void hwifi_config_feature_temp_protect(wlan_cfg_customize_priv *pst_customize_priv)
{
    ...
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_TEMP_PRO_EN, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->st_temp_pri_custom.uc_temp_pro_enable = (oal_uint8)l_priv_value;
    }
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_TEMP_PRO_REDUCE_PWR_EN, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->st_temp_pri_custom.uc_temp_pro_reduce_pwr_enable = (oal_uint8)l_priv_value;
    }
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_TEMP_PRO_SAFE_TH, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->st_temp_pri_custom.us_temp_pro_safe_th = (oal_int16)l_priv_value;
    }
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_TEMP_PRO_OVER_TH, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->st_temp_pri_custom.us_temp_pro_over_th = (oal_int16)l_priv_value;
    }
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_TEMP_PRO_PA_OFF_TH, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->st_temp_pri_custom.us_temp_pro_pa_off_th = (oal_int16)l_priv_value;
    }
#endif
}
#ifdef _PRE_WLAN_CHBA_MGMT
oal_bool_enum_uint8 hwifi_get_chba_en(void)
{
    int32_t priv_value = 0;
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_CHBA_EN, &priv_value) == OAL_SUCC) {
        return !!((oal_uint8)priv_value);
    }
    return OAL_FALSE;
}

oal_uint8 hwifi_get_chba_social_channel(void)
{
    int32_t priv_value = 0;
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_CHBA_INIT_SOCIAL_CHAN, &priv_value) == OAL_SUCC) {
        return (oal_uint8)priv_value;
    }
    return OAL_FALSE;
}

oal_bool_enum_uint8 hwifi_get_chba_social_chan_cap(void)
{
    int32_t priv_value = 0;
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_CHBA_SOCIAL_FOLLOW_WORK, &priv_value) == OAL_SUCC) {
        return !!((oal_uint8)priv_value);
    }
    return OAL_FALSE;
}

static void hwifi_config_init_ini_priv_chba(wlan_cfg_customize_priv *pst_customize_priv)
{
    oal_int32 l_priv_value = 0;

    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_CHBA_EN, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->chba_en = !!((oal_uint8)l_priv_value);
    }
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_CHBA_INIT_SOCIAL_CHAN, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->chba_social_chan = (oal_uint8)l_priv_value;
    }
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_CHBA_SOCIAL_FOLLOW_WORK, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->chba_social_follow_work_switch = (oal_uint8)l_priv_value;
    }
}
#endif
...
oal_int32 hwifi_config_init_ini_priv(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    ret = hwifi_get_init_priv_value(WLAN_CFG_PRIV_CALI_MASK, &l_priv_value);
    /* 强制关闭校准使用，产线防止干扰 */
    ...
    ret = hwifi_get_init_priv_value(WLAN_CFG_PRIV_FAST_CHECK_CNT, &l_priv_value);
    if (ret == OAL_SUCC) {
        pst_customize_priv->uc_fast_check_cnt = (oal_uint8)l_priv_value;
        wlan_pm_set_fast_check_cnt((l_priv_value > 0) ? (oal_uint8)l_priv_value : HMAC_PSM_TIMER_MIDIUM_CNT);
    }
    ret = hwifi_get_init_priv_value(WLAN_CFG_PRIV_VOE_SWITCH, &l_priv_value);
    if (ret == OAL_SUCC) {
    ...
    ret = hwifi_get_init_priv_value(WLAN_DSSS2OFDM_DBB_PWR_BO_VAL, &l_priv_value);
    if (ret == OAL_SUCC) {
        pst_customize_priv->s_dsss2ofdm_dbb_pwr_bo_val = (oal_int16)l_priv_value;
    }
#ifdef _PRE_WLAN_FEATURE_DYN_BYPASS_EXTLNA
    ret = hwifi_get_init_priv_value(WLAN_CFG_PRIV_DYN_BYPASS_EXTLNA, &l_priv_value);
    if (ret == OAL_SUCC) {
...
#endif
    ret = hwifi_get_init_priv_value(WLAN_CFG_PRIV_HCC_FLOWCTRL_TYPE, &l_priv_value);
    if (ret == OAL_SUCC) {
    ...
    ret = hwifi_get_init_priv_value(WLAN_CFG_PRIV_5G_EXT_FEM_TYPE, &l_priv_value);
    if (ret == OAL_SUCC) {
        pst_customize_priv->uc_5g_ext_fem_type = (oal_uint8)l_priv_value;
    }
    pst_customize_priv->uc_i3c_switch = hwifi_get_gnss_scan_by_i3c();
    if (hwifi_get_init_priv_value(WLAN_CFG_PRIV_CLOSE_FILTER_SWITCH, &l_priv_value) == OAL_SUCC) {
        pst_customize_priv->close_filter_switch = (oal_uint8)l_priv_value;
    }
#ifdef _PRE_WLAN_CHBA_MGMT
    hwifi_config_init_ini_priv_chba(pst_customize_priv);
#endif
    ...
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hwifi_config_init_ini_rf::wal_send_cfg_event failed, err code [%d]", ret);
        return OAL_FAIL;
    }
    return OAL_SUCC;
}
...
oal_int32 hwifi_cfg_init_line_params(wlan_cus_dy_cali_param_stru *puc_dyn_cali_param)
{
    ...
    l_ret = memcpy_s(puc_dyn_cali_param->al_dy_cali_base_ratio_params,
                     ...
                     g_pro_line_params, OAL_SIZEOF(puc_dyn_cali_param->al_dy_cali_base_ratio_params));
    ...
    l_ret += memcpy_s(puc_dyn_cali_param->al_bt_ppavdet_fit_params,
                      ...
                      &g_pro_line_params[CUS_DY_CALI_PARAMS_NUM + 2], /* 取产测定制化参数数组14 + 2元素的地址 */
                      OAL_SIZEOF(puc_dyn_cali_param->al_bt_ppavdet_fit_params));
    return l_ret;
}
...
OAL_STATIC oal_uint32 hwifi_cfg_init_cus_dyn_cali(wlan_cus_dy_cali_param_stru *puc_dyn_cali_param)
{
    ...
    for (uc_dy_cal_param_idx = 0; uc_dy_cal_param_idx < DY_CALI_PARAMS_NUM; uc_dy_cal_param_idx++) {
        if (g_pro_line_params[uc_dy_cal_param_idx].l_pow_par2 == 0) {
    ...
    l_ret = memcpy_s(puc_dyn_cali_param->as_extre_point_val, OAL_SIZEOF(puc_dyn_cali_param->as_extre_point_val),
                     g_gs_extre_point_vals, OAL_SIZEOF(puc_dyn_cali_param->as_extre_point_val));
    ...
    for (uc_idx = 0; uc_idx < CUS_DY_CALI_NUM_5G_BAND; uc_idx++) {
        ...
        l_ret += memcpy_s(puc_dyn_cali_param->ac_dy_cali_5g_dpn_params[uc_idx],
                          WLAN_BW_CAP_160M * OAL_SIZEOF(oal_int8), &l_val, WLAN_BW_CAP_160M * OAL_SIZEOF(oal_int8));
    }
...
OAL_STATIC oal_void hwifi_config_init_cus_dyn_cali(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
        ...
        (oal_uint8 *)&st_write_msg, OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hwifi_config_init_cus_dyn_cali::wal_send_cfg_event failed, ret[%d]!}", l_ret);
        return;
    }
    return;
}
...
oal_void hwifi_config_init_dts_cali_set_bt(wlan_cus_cali_stru *pst_cus_cali)
{
    ...
    // BT base power
    pst_cus_cali->uc_bt_base_power = (oal_uint8)hwifi_get_init_value(CUS_TAG_DTS, WLAN_CFG_DTS_BT_CALI_BASE_POWER);
    // BT is DPN calculating
    pst_cus_cali->uc_bt_is_dpn_calc = (oal_uint8)hwifi_get_init_value(CUS_TAG_DTS, WLAN_CFG_DTS_BT_CALI_IS_DPN_CALC);
}
...
OAL_STATIC oal_void hwifi_config_init_txop_switch(oal_net_device_stru *pst_cfg_net_dev)
{
    wal_msg_write_stru st_write_msg;
    oal_int32 l_ret;
    oal_uint8 l_switch;
    ...
    /* 开关 */
    l_switch = (oal_uint8)hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_TXOP_SWITCH);

    wal_write_msg_hdr_init(&st_write_msg, WLAN_CFGID_TXOP_SWITCH, OAL_SIZEOF(oal_uint8));
    *((oal_uint8 *)(st_write_msg.auc_value)) = l_switch;

    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_uint8), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{hwifi_config_init_txop_switch::return err code [%d]!}\r\n", l_ret);
    }
}
...
OAL_STATIC oal_void hwifi_config_init_ini_main(oal_net_device_stru *pst_cfg_net_dev)
{
    ...
    /* txop_switch */
    hwifi_config_init_txop_switch(pst_cfg_net_dev);
}
...
oal_void hwifi_config_init_ini(oal_net_device_stru *pst_net_dev)
{
    ...
    if ((pst_wdev->iftype == NL80211_IFTYPE_STATION) ||
        ...
        if ((strcmp(wal_get_wlan_name(), pst_net_dev->name)) == 0) {
            hwifi_config_init_ini_wlan(pst_net_dev);
        }
#ifdef _PRE_WLAN_FEATURE_P2P
        else if ((strcmp(wal_get_p2p_name(), pst_net_dev->name)) == 0) {
            hwifi_config_init_ini_p2p(pst_net_dev);
        }
#endif
        else {
            oam_warning_log0(0, OAM_SF_ANY, "{hwifi_config_init_ini::net_dev is not wlanx or p2p0!}\r\n");
            return;
        }
    }
    return;
...
OAL_STATIC oal_void wal_netdev_open_flush_p2p_random_mac(oal_net_device_stru *pst_net_dev)
{
    ...
    if ((g_wlan_customize.en_random_mac_addr_connect == OAL_TRUE) &&
...
oal_int8 *wal_get_wlan_name(void)
{
    ...
    if (g_wlan_name[0] != '0' && g_wlan_name[1] != '0') {
        return g_wlan_name;
    }
    ...
    if (pst_net_dev != OAL_PTR_NULL) {
        ...
        /* 从INI文件读取端口名 */
        ret = get_cust_conf_string(INI_MODU_WIFI, STR_WLAN_NAME, g_wlan_name, sizeof(g_wlan_name));
        if (ret == INI_FAILED) {
            ret = memcpy_s(g_wlan_name, OAL_SIZEOF(g_wlan_name), "wlan2", OAL_STRLEN("wlan2"));
            OAL_IO_PRINT("%s:wlan0 is exit rename %s ret %d \r\n", __func__, g_wlan_name, ret);
        } else {
            g_wlan_name[PORT_NAME_CODE_LEN - 1] = '\0'; /* 以'\0'结尾 */
            OAL_IO_PRINT("%s:read ini g_wlan_name %s \r\n", __func__, g_wlan_name);
        }
    } else {
        ret = memcpy_s(g_wlan_name, OAL_SIZEOF(g_wlan_name), "wlan0", OAL_STRLEN("wlan0"));
        OAL_IO_PRINT("%s:wlan port default name %s ret %d \r\n", __func__, g_wlan_name, ret);
    }
...
oal_int8 *wal_get_p2p_name(void)
{
    ...
    int32 ret;
    oal_net_device_stru *pst_net_dev = OAL_PTR_NULL;
    if (g_p2p_name[0] != '0' && g_p2p_name[1] != '0') {
        return g_p2p_name;
    }
    ...
    if (pst_net_dev != OAL_PTR_NULL) {
        ...
        oal_dev_put(pst_net_dev);
        /* 从INI文件读取端口名 */
        ret = get_cust_conf_string(INI_MODU_WIFI, STR_P2P_NAME, g_p2p_name, sizeof(g_p2p_name));
        if (ret == INI_FAILED) {
            ret = memcpy_s(g_p2p_name, OAL_SIZEOF(g_p2p_name), "p2p1", OAL_STRLEN("p2p1"));
            OAL_IO_PRINT("%s:p2p0 is exit rename %s ret %d \r\n", __func__, g_p2p_name, ret);
        } else {
            g_p2p_name[PORT_NAME_CODE_LEN - 1] = '\0'; /* 以'\0'结尾 */
            OAL_IO_PRINT("%s:read ini g_wlan_name %s \r\n", __func__, g_p2p_name);
        }
    } else {
        ret = memcpy_s(g_p2p_name, OAL_SIZEOF(g_p2p_name), "p2p0", OAL_STRLEN("p2p0"));
        OAL_IO_PRINT("%s:wlan port default name %s ret %d \r\n", __func__, g_p2p_name, ret);
    }
...
OAL_STATIC oal_int32 _wal_netdev_open(oal_net_device_stru *pst_net_dev, oal_int32 pm_open_ret)
{
    ...
    oal_wireless_dev_stru *pst_wdev;
#endif
#if (defined(_PRE_PRODUCT_ID_HI110X_HOST) && (_PRE_OS_VERSION_WIN32 != _PRE_OS_VERSION) && (defined(_PRE_WLAN_ATCMD_SUPPORT)))
    ...
    if (((pst_net_dev->ieee80211_ptr->iftype == NL80211_IFTYPE_STATION) ||
        ...
        (((oal_strcmp(wal_get_wlan_name(), pst_net_dev->name)) == 0) ||
        ((oal_strcmp(wal_get_p2p_name(), pst_net_dev->name)) == 0))) {
    ...
    ***************************************************************************/
#ifdef _PRE_WLAN_NARROW_BAND
    if (g_hitalk_status & NBFH_ON_MASK) {
    ...
    if ((pst_net_dev->ieee80211_ptr->iftype == NL80211_IFTYPE_STATION)
        && ((strcmp(wal_get_wlan_name(), pst_net_dev->name)) == 0)) {
...
oal_int32 wal_netdev_open(oal_net_device_stru *pst_net_dev)
{
    ...
    /* 记录wlan0 开的时间 */
    if (oal_strncmp(wal_get_wlan_name(), pst_net_dev->name, OAL_STRLEN(wal_get_wlan_name())) == 0) {
...
#ifdef _PRE_WLAN_NARROW_BAND
    if (g_hitalk_status) {
        wal_hipriv_autorate_param(pst_net_dev, "autorate");
    }
#endif
#ifdef _PRE_WLAN_EXPORT
...
oal_int32 wal_netdev_stop_ap(oal_net_device_stru *pst_net_dev)
{
    ...
    if ((hwifi_get_chba_en() == OAL_TRUE) &&
        ...
        pst_net_dev->ieee80211_ptr->iftype = NL80211_IFTYPE_STATION;
        oal_netdevice_flags(pst_net_dev) &= ~OAL_IFF_RUNNING;
        oam_warning_log0(0, OAM_SF_CFG, "{wal_netdev_stop_ap::chba down succ!}");
        return OAL_SUCC;
    }
#endif
...
OAL_STATIC oal_int32 _wal_netdev_stop(oal_net_device_stru *pst_net_dev)
{
    ...
    ***************************************************************************/
    ...
    /* BEGIN:  1102 P2P关联成为GO时，打印错误.修改wal_net_dev_stop 为需要等待hmac 响应 */
    /* 处理返回消息 */
    ul_err_code = wal_check_and_release_msg_resp(pst_rsp_msg);
    if (ul_err_code != OAL_SUCC) {
    ...
    /* END:  1102 P2P关联成为GO时，打印错误.修改wal_net_dev_stop 为需要等待hmac 响应 */
#if defined(_PRE_PRODUCT_ID_HI110X_HOST)
...
#ifdef _PRE_WLAN_CHBA_MGMT
    if (oal_strcmp("chba0", pst_net_dev->name) == 0) {
        oam_warning_log0(0, 0, "CHBA: chba0 enter wal_netdev_stop.");
    }
#endif
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    oal_mutex_lock(&g_st_dfr_mutex);
...
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
    if (g_wlan_customize.en_random_mac_addr_connect == OAL_FALSE) {
...
#ifdef _PRE_WLAN_EXPORT
    oal_set_mac_addr(device_mac_addr, (oal_uint8 *)(pst_net_dev->dev_addr));
#endif
...
OAL_STATIC int32 wal_ioctl_judge_input_param_length(
    ...
    oal_net_device_stru *pst_net_dev, oal_int8 *pc_command, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    ...
    if (wal_ioctl_judge_input_param_length(st_priv_cmd, CMD_TX_POWER_LEN, 1) != OAL_SUCC) {
    ...
    oal_net_device_stru *pst_net_dev, oal_int8 *pc_command, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    ...
    l_ret = wal_regdomain_update(pst_net_dev, auc_country_code, 3);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
oal_int32 wal_vendor_priv_tas_cmd(oal_int8 *pc_command, oal_net_device_stru *pst_net_dev,
    ...
    mac_psm_query_type_enum_uint8 en_query_type, wal_wifi_priv_cmd_stru *priv_cmd)
{
    ...
    if (pst_mac_vap == OAL_PTR_NULL) {
        oam_warning_log0(0, OAM_SF_CFG, "{wal_ioctl_get_psm_info::pst_mac_vap get from netdev is null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
static uint32_t wal_hipriv_start_chan_meas(oal_net_device_stru *net_dev, int8_t *pc_param)
{
    if (wal_ioctl_chan_meas(net_dev, pc_param) != OAL_SUCC) {
        return OAL_FAIL;
    }
    return OAL_SUCC;
}
    ...
    wal_wifi_priv_cmd_stru *priv_cmd)
{
    ...
    oam_warning_log4(0, 0, "{wal_ioctl_get_current_tsf:host tsf0, hi[0x%x], lo[0x%x]; tsf1, hi[0x%x], lo[0x%x]}",
        (uint32_t)(host_start_tsf >> 32), (uint32_t)host_start_tsf,
        (uint32_t)(hmac_vap->sync_tsf.host_end_tsf >> 32), (uint32_t)hmac_vap->sync_tsf.host_end_tsf);
    oam_warning_log2(0, 0, "{wal_ioctl_get_current_tsf: device tsf:hi[0x%x], lo[0x%x]}",
        (uint32_t)(hmac_vap->sync_tsf.device_tsf >> 32), (uint32_t)hmac_vap->sync_tsf.device_tsf);
...
static oal_int32 wal_ioctl_get_current_tsf(oal_net_device_stru *net_dev,
    wal_wifi_priv_cmd_stru *priv_cmd)
{
    ...
    if (oal_any_null_ptr2(net_dev, priv_cmd)) {
        return -OAL_EINVAL;
    }
    ...
    i_leftime = oal_wait_event_interruptible_timeout(hmac_vap->query_wait_q,
        (OAL_TRUE == hmac_vap->tsf_info_query_completed_flag), 5 * OAL_TIME_HZ);
    if (i_leftime == 0) {
        /* 超时还没有上报扫描结束 */
        OAM_WARNING_LOG1(0, 0, "{query device tsf for %ld ms timeout}",  ((5 * OAL_TIME_HZ * 1000) / OAL_TIME_HZ));
        return -OAL_EINVAL;
    } else if (i_leftime < 0) {
        /* 定时器内部错误 */
        OAM_WARNING_LOG1(0, 0, "{query device tsf for %ld ms error}", ((5 * OAL_TIME_HZ * 1000) / OAL_TIME_HZ));
        return -OAL_EINVAL;
    } else {
...
OAL_STATIC uint32_t wal_hipriv_chba_module_init(oal_net_device_stru *net_dev, int8_t *pc_param)
{
    wal_msg_write_stru st_write_msg;
    uint32_t ret;
    int32_t l_cfg_rst;
...
static uint32_t wal_hipriv_set_coex_chan_info(oal_net_device_stru *net_dev, int8_t *pc_param)
{
    if (wal_ioctl_chba_set_coex(net_dev, pc_param) != OAL_SUCC) {
        return OAL_FAIL;
    }
    return OAL_SUCC;
}
...
OAL_STATIC uint32_t wal_hipriv_chba_set_auto_bitmap(oal_net_device_stru *net_dev, int8_t *pc_param)
{
    wal_msg_write_stru st_write_msg;
    uint32_t ret;
    int32_t l_cfg_rst;
...
/* 设置CHBA user bitmap */
OAL_STATIC uint32_t wal_hipriv_chba_set_user_bitmap(oal_net_device_stru *net_dev, int8_t *pc_param)
{
    wal_msg_write_stru st_write_msg;
    uint32_t off_set;
    int8_t ac_name[WAL_HIPRIV_CMD_NAME_MAX_LEN] = { 0 };
    ...
    */
    ...
    pc_param += off_set;
    ps_bitmap_info.ps_bitmap = (uint32_t)oal_strtol(ac_name, OAL_PTR_NULL, 0);

    oam_warning_log3(0, OAM_SF_ANY, "wal_hipriv_chba_set_user_bitmap::mac4-5[%x:%x], bitmap[0x%x].",
        ps_bitmap_info.auc_mac_addr[4], ps_bitmap_info.auc_mac_addr[5], ps_bitmap_info.ps_bitmap);
...
/* 设置CHBA vap bitmap */
OAL_STATIC uint32_t wal_hipriv_chba_set_vap_bitmap(oal_net_device_stru *net_dev, int8_t *pc_param)
{
    wal_msg_write_stru st_write_msg;
    uint32_t off_set;
    int8_t ac_name[WAL_HIPRIV_CMD_NAME_MAX_LEN] = { 0 };
    ...
    */
    ...
    vap_bitmap = (uint32_t)oal_strtol(ac_name, OAL_PTR_NULL, 0);
...
/* 解析chba特性开关命令 */
static uint32_t wal_hipriv_analyze_chba_feature_switch_params(int8_t *pc_param,
    mac_chba_feature_switch_stru *cfg_params)
{
    int8_t name[WAL_HIPRIV_CMD_NAME_MAX_LEN] = {0};
    int8_t value[WAL_HIPRIV_CMD_VALUE_MAX_LEN] = {0};
    uint8_t status;
    uint32_t off_set = 0;
    ...
    do {
        ret = wal_get_cmd_one_arg(pc_param, name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
        if ((ret != OAL_SUCC) && (off_set != 0)) {
            OAM_WARNING_LOG1(0, 0, "{wal_hipriv_set_chba_feature_switch::cmd format err, ret:%d!}", ret);
            return ret;
        }
        pc_param += off_set;
        ...
        ret = wal_get_cmd_one_arg(pc_param, value, WAL_HIPRIV_CMD_VALUE_MAX_LEN, &off_set);
        if ((ret != OAL_SUCC) || (!isdigit(value[0]))) {
...
/* 设置chba特性开关 */
static uint32_t wal_hipriv_set_chba_feature_switch(oal_net_device_stru *pst_net_dev, int8_t *pc_param)
{
    wal_msg_write_stru st_write_msg;
    mac_chba_feature_switch_stru cfg_params;
    int32_t l_ret;
...
static uint32_t wal_hipriv_set_chba_channel_seq(oal_net_device_stru *net_dev, int8_t *param)
{
    ...
    uint32_t get_cmd_ret;
    int8_t cmd[WAL_HIPRIV_CMD_NAME_MAX_LEN] = { 0 };
    chba_channel_sequence_params_stru *chan_seq_params = NULL;

    /* sh hipriv.sh "chba0 set_chba_channel_seq [channel_seq_level] [first_work_channel] [second_work_channel]"
     * [channel_seq_level]  信道序列等级 取值范围0-3
     * [first_work_channel] 第一work_channel主20MHz信道号 取值范围36~165
     * [second_work_channel] 第二work_channel主20MHz信道号 取值范围36~165
     */
    wal_write_msg_hdr_init(&st_write_msg, WLAN_CFGID_CHBA_SET_CHANNEL_SEQ_PARAMS,
        sizeof(chba_channel_sequence_params_stru));
    chan_seq_params = (chba_channel_sequence_params_stru *)st_write_msg.auc_value;

    get_cmd_ret = wal_get_cmd_one_arg(param, cmd, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
    if (get_cmd_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_hipriv_set_chba_channel_seq:get channel_seq_level return err_code [%d]!}", get_cmd_ret);
        return get_cmd_ret;
    }
    chan_seq_params->channel_seq_level = (uint8_t)oal_atoi(cmd);

    param = param + off_set;
    get_cmd_ret = wal_get_cmd_one_arg(param, cmd, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
    if (get_cmd_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_hipriv_set_chba_channel_seq:get first_work_channel return err_code [%d]!}", get_cmd_ret);
        return get_cmd_ret;
    }
    chan_seq_params->first_work_channel = (uint8_t)oal_atoi(cmd);

    param = param + off_set;
    get_cmd_ret = wal_get_cmd_one_arg(param, cmd, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
    if (get_cmd_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY,
            "{wal_hipriv_set_chba_channel_seq:get second_work_channel return err_code [%d]!}", get_cmd_ret);
        return get_cmd_ret;
    }
    chan_seq_params->sec_work_channel = (uint8_t)oal_atoi(cmd);
    /***************************************************************************
                              抛事件到wal层处理
    ***************************************************************************/
    send_cfg_ret = wal_send_cfg_event(net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + sizeof(chba_channel_sequence_params_stru),
        (uint8_t *)&st_write_msg, OAL_FALSE, NULL);
    if (send_cfg_ret != OAL_SUCC) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_chba_channel_seq:return err code [%d]!}", send_cfg_ret);
        return (uint32_t)send_cfg_ret;
    }
    return OAL_SUCC;
}
    ...
    wal_wifi_priv_cmd_stru priv_cmd)
{
    ...
    if (ret != OAL_SUCC) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_vendor_priv_cmd::CMD_CHBA_MODULE_INIT cmd len err.}");
        return -OAL_EFAIL;
    }
    ...
    wal_wifi_priv_cmd_stru priv_cmd)
{
    ...
    if (ret != OAL_SUCC) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_vendor_priv_cmd::CMD_SET_BATTERY_LEVEL cmd len err.}");
        return -OAL_EFAIL;
    }

    /* 获取电量等级 */
    battery_level = *(command + CMD_SET_BATTERY_LEVEL_LEN + 1);
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_vendor_priv_cmd::CMD_SET_BATTERY_LEVEL battery[%d].}", battery_level);
    ...
    wal_wifi_priv_cmd_stru priv_cmd)
{
    ...
    ret = wal_ioctl_judge_input_param_length(priv_cmd, CMD_SET_CHAN_ADJUST_LEN, OAL_SIZEOF(chan_adjust_info));
    if (ret != OAL_SUCC) {
        return -OAL_EFAIL;
    }
    ret = memcpy_s(&chan_adjust_info, OAL_SIZEOF(mac_chba_adjust_chan_info),
        command + CMD_SET_CHAN_ADJUST_LEN + 1, OAL_SIZEOF(mac_chba_adjust_chan_info));
    if (ret != EOK) {
        return -OAL_EFAIL;
    }
    ...
    wal_wifi_priv_cmd_stru priv_cmd)
{
    ...
    if (ret != OAL_SUCC) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_vendor_priv_cmd::CMD_SET_SUPP_COEX_CHAN_LIST_LEN cmd len err.");
        return -OAL_EFAIL;
    }
    /* 数据拷贝 */
    ret = memcpy_s(&cfg_coex_chan_info, sizeof(mac_chba_set_coex_chan_info),
        command + CMD_SET_SUPP_COEX_CHAN_LIST_LEN + 1, sizeof(mac_chba_set_coex_chan_info));
    if (ret != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{set_supp_coex_chan_list:memcpy fail!}");
        return -OAL_EFAIL;
    }
    /* 消息类型、信道列表个数校验 */
    if (wal_ioctl_chba_set_coex_cmd_para_check(&cfg_coex_chan_info) != OAL_SUCC) {
...
int32_t wal_vendor_priv_cmd_chba_protocol(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *p_ifr,
    int8_t *pc_cmd, wal_wifi_priv_cmd_stru st_priv_cmd)
{
    int32_t ret = OAL_SUCC;

    if (oal_strncmp(pc_cmd, CMD_CHBA_MODULE_INIT, CMD_CHBA_MODULE_INIT_LEN) == 0) {
        return wal_ioctl_chba_module_init(pst_net_dev, pc_cmd, st_priv_cmd);
    } else if (oal_strncmp(pc_cmd, CMD_SET_BATTERY_LEVEL, CMD_SET_BATTERY_LEVEL_LEN) == 0) {
        return wal_ioctl_set_battery_level(pst_net_dev, pc_cmd, st_priv_cmd);
    } else if (oal_strncmp(pc_cmd, CMD_SET_CHAN_ADJUST, CMD_SET_CHAN_ADJUST_LEN) == 0) {
        return wal_ioctl_chba_channel_adjust(pst_net_dev, pc_cmd, st_priv_cmd);
    } else if (oal_strncmp(pc_cmd, CMD_SET_SUPP_COEX_CHAN_LIST, CMD_SET_SUPP_COEX_CHAN_LIST_LEN) == 0) {
        return wal_ioctl_chba_set_supp_coex_chan_list(pst_net_dev, pc_cmd, st_priv_cmd);
    }
    return ret;
}
#endif
static oal_bool_enum_uint8 wal_ioctl_chan_meas_chan_is_valid(mac_vap_stru *mac_vap,
    mac_cfg_link_meas_stru *meas_cmd)
{
    hmac_chan_stru *candidate_list = NULL;
    uint8_t max_chan_cnt;
    if (meas_cmd->scan_band == WLAN_BAND_5G) {
        candidate_list = g_aus_channel_candidate_list_5g;
        max_chan_cnt = HMAC_CHANNEL_NUM_5G;
    } else if (meas_cmd->scan_band == WLAN_BAND_2G) {
        candidate_list = g_aus_channel_candidate_list_2g;
        max_chan_cnt = HMAC_CHANNEL_NUM_2G;
    } else {
        OAM_ERROR_LOG1(mac_vap->uc_vap_id, 0,
            "wal_ioctl_chan_meas_chan_is_valid::band[%d] invalid!", meas_cmd->scan_band);
        return OAL_FALSE;
    }
    ...
    if (mac_is_channel_num_valid(meas_cmd->scan_band,
        candidate_list[meas_cmd->scan_chan].uc_chan_number) != OAL_SUCC) {
...
static int32_t wal_ioctl_chan_meas_cfg_send_event(oal_net_device_stru *net_dev,
    wal_msg_write_stru *write_msg, mac_cfg_link_meas_stru *meas_cmd)
{
    mac_vap_stru *mac_vap = oal_net_dev_priv(net_dev);

#ifdef _PRE_WLAN_CHBA_MGMT
    if (mac_is_chba_mode(mac_vap) && meas_cmd->scan_band != WLAN_BAND_5G) {
        OAM_ERROR_LOG1(mac_vap->uc_vap_id, 0,
            "wal_ioctl_chan_meas_cfg_send_event::para[%d] invalid, chba only support scan 5G!", meas_cmd->scan_band);
        return OAL_FAIL;
    }
#endif
    if (!wal_ioctl_chan_meas_chan_is_valid(mac_vap, meas_cmd)) {
        return OAL_FAIL;
    }

    // 如果命令下发扫描时间大于15ms直接取15ms
    if (meas_cmd->meas_time > WAL_CHAN_MEAS_MAX_TIME_MS) {
        meas_cmd->meas_time = WAL_CHAN_MEAS_MAX_TIME_MS + WAL_CHAN_MEAS_SCAN_TIME_OFFSET;
    } else {
        meas_cmd->meas_time = meas_cmd->meas_time + WAL_CHAN_MEAS_SCAN_TIME_OFFSET;
    }
    /* 抛事件到wal层处理 */
    wal_write_msg_hdr_init(write_msg, WLAN_CFGID_SET_CHAN_MEAS, sizeof(mac_cfg_link_meas_stru));

    /* 设置配置命令参数 */
    if (memcpy_s(write_msg->auc_value, sizeof(write_msg->auc_value),
        (const void *)meas_cmd, sizeof(mac_cfg_link_meas_stru)) != EOK) {
        return OAL_FAIL;
    }

    return wal_send_cfg_event(net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + sizeof(mac_cfg_link_meas_stru), (uint8_t *)write_msg, OAL_FALSE, NULL);
}
/* 信道测量命令下发时需要判断当前是否已存在测量扫描，必须等待扫描完成才允许下发下一次扫描 */
static oal_bool_enum_uint8 wal_ioctl_chan_meas_start_check(mac_vap_stru *mac_vap)
{
    ...
    if (hmac_device->st_scan_mgmt.en_is_scanning &&
        hmac_device->st_scan_mgmt.st_scan_record_mgmt.en_scan_mode == WLAN_SCAN_MODE_CHAN_MEAS_SCAN) {
        oam_warning_log0(mac_vap->uc_vap_id, 0,
            "wal_ioctl_chan_meas_start_check::chan meas scan is running, return.");
        return OAL_TRUE;
    }
...
#ifdef _PRE_WLAN_CHBA_MGMT
    if ((mac_is_chba_mode(mac_vap)) && (hmac_chba_get_sync_state() <= CHBA_NON_SYNC)) {
        oam_warning_log0(mac_vap->uc_vap_id, 0,
            "wal_ioctl_chan_meas_start_check:chba is non sync or init state, chan meas refused!");
        return OAL_TRUE;
    }
    if ((mac_is_chba_mode(mac_vap)) && (chba_mgmt_info->chan_switch_info.in_island_chan_switch ||
...
int32_t wal_ioctl_chan_meas(oal_net_device_stru *net_dev, int8_t *param)
{
    ...
    param += off_set;
    meas_cmd.link_meas_cmd_type = (uint8_t)oal_atoi(name);
    if (meas_cmd.link_meas_cmd_type != WAL_CHAN_MEAS_START_BY_CHAN) {
        return OAL_FAIL;
    }
    /* 获取scan chan */
    ret = wal_get_cmd_one_arg(param, name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
    ...
    param += off_set;
    meas_cmd.scan_chan = (uint8_t)oal_atoi(name);
    /* 获取scan interval */
    ret = wal_get_cmd_one_arg(param, name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
    if (ret != OAL_SUCC) {
        return OAL_FAIL;
    ...
    param += off_set;
    meas_cmd.scan_interval = (uint8_t)oal_atoi(name);
    /* 获取scan time */
    ret = wal_get_cmd_one_arg(param, name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
    if (ret != OAL_SUCC) {
        return OAL_FAIL;
    ...
    param += off_set;
    meas_cmd.meas_time = (uint16_t)oal_atoi(name);
    /* 获取scan band */
    ret = wal_get_cmd_one_arg(param, name, WAL_HIPRIV_CMD_NAME_MAX_LEN, &off_set);
    if (ret != OAL_SUCC) {
        return OAL_FAIL;
    ...
    param += off_set;
    meas_cmd.scan_band = (uint8_t)oal_atoi(name);
    return wal_ioctl_chan_meas_cfg_send_event(net_dev, &write_msg, &meas_cmd);
}

#define WAL_IOCTL_LINK_MEAS_CMD 10
int32_t wal_ioctl_start_chan_meas(oal_net_device_stru *net_dev, oal_ifreq_stru *ifr, uint8_t *cmd)
{
    ...
    if (wal_get_cmd_one_arg(cmd, cmd_type_str, WAL_HIPRIV_CMD_VALUE_MAX_LEN, &offset) != OAL_SUCC) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_ioctl_chba_start_rrm::invalid cmd}");
        return OAL_FAIL;
    }
    cmd_type = (int32_t)oal_atoi(cmd_type_str);
    if (cmd_type != WAL_IOCTL_LINK_MEAS_CMD) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_ioctl_chba_start_rrm::invalid cmd type}");
        return OAL_FAIL;
    }
    cmd += offset;

    return wal_ioctl_chan_meas(net_dev, cmd);
}

#ifdef CONFIG_ARCH_QCOM
oal_int32 wal_ioctl_set_chip_not_down(oal_net_device_stru *net_dev, uint8_t *cmd, wal_wifi_priv_cmd_stru priv_cmd)
{
    int32_t ret;

    ret = wal_ioctl_judge_input_param_length(priv_cmd, CMD_SMALL_CHIP_NOT_DOWN_LEN, 1);
    if (ret != OAL_SUCC) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_ioctl_set_chip_not_down::CMD_SMALL_CHIP_NOT_DOWN cmd len err.}");
        return -OAL_EFAIL;
    }

    /* wifi开关打开，小芯片不下电 */
    g_small_chip_not_down_flag = *(cmd + CMD_SMALL_CHIP_NOT_DOWN_LEN + 1) - '0';
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_ioctl_set_chip_not_down::small_chip_not_down=[%d]}",
        g_small_chip_not_down_flag);

    return OAL_SUCC;
}
#endif

oal_int32 wal_ioctl_set_sae_pwe(oal_net_device_stru *net_dev, oal_uint8 sae_pwe)
{
    oal_int32 ret;
    wal_msg_write_stru wal_write_msg;
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_ioctl_set_sae_pwe:: sae_pwe [%d]!}", sae_pwe);

    wal_write_msg_hdr_init(&wal_write_msg, WLAN_CFGID_SET_SAE_PWE, OAL_SIZEOF(oal_uint8));
    wal_write_msg.auc_value[0] = sae_pwe;

    ret = wal_send_cfg_event(net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_uint8),
        (oal_uint8 *)&wal_write_msg, OAL_FALSE, NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
...
OAL_STATIC oal_int32 wal_vendor_set_sae_pwe(oal_net_device_stru *net_dev, oal_int8 *command,
    wal_wifi_priv_cmd_stru wal_priv_cmd)
{
    oal_uint32 skip = CMD_SET_SAE_PWE_LEN + 1;
    oal_uint8 sae_pwe;
    oal_int32 ret;

    ret = wal_ioctl_judge_input_param_length(wal_priv_cmd, CMD_SET_SAE_PWE_LEN, 1);
    if (ret != OAL_SUCC) {
    ...
    sae_pwe = (oal_uint8)oal_atoi(command + skip);
...
OAL_STATIC oal_int32 wal_vendor_priv_append_cmd(oal_net_device_stru *pst_net_dev,
    oal_int8 *pc_command, wal_wifi_priv_cmd_stru *priv_cmd, oal_ifreq_stru *pst_ifr)
{
...
#endif
    if (oal_strncasecmp(pc_command, CMD_GET_BEACON_CNT, CMD_GET_BEACON_CNT_LEN) == 0) {
        l_ret = wal_ioctl_get_psm_info(pst_net_dev, MAC_PSM_QUERY_BEACON_CNT, priv_cmd);
    } else if (oal_strncasecmp(pc_command, CMD_GET_APF_PKTS_CNT, CMD_GET_APF_PKTS_CNT_LEN) == 0) {
        l_ret = wal_ioctl_get_psm_info(pst_net_dev, MAC_PSM_QUERY_FLT_STAT, priv_cmd);
    } else if (oal_strncasecmp(pc_command, CMD_TAS_GET_ANT, CMD_TAS_GET_ANT_LEN) == 0) {
        l_ret = wal_vendor_priv_tas_cmd(pc_command, pst_net_dev, *priv_cmd);
    } else if (oal_strncasecmp(pc_command, CMD_HID2D_PARAMS, CMD_HID2D_PARAMS_LEN) == 0) {
        l_ret = wal_ioctl_start_chan_meas(pst_net_dev, pst_ifr, pc_command);
#ifdef CONFIG_ARCH_QCOM
    } else if (oal_strncasecmp(pc_command, CMD_SMALL_CHIP_NOT_DOWN, CMD_SMALL_CHIP_NOT_DOWN_LEN) == 0) {
        l_ret = wal_ioctl_set_chip_not_down(pst_net_dev, pc_command, *priv_cmd);
#endif
    } else if (oal_strncasecmp(pc_command, CMD_SET_SAE_PWE, CMD_SET_SAE_PWE_LEN) == 0) {
        l_ret = wal_vendor_set_sae_pwe(pst_net_dev, pc_command, *priv_cmd);
    } else if (oal_strncasecmp(pc_command, CMD_GET_CURRENT_TSF, CMD_GET_CURRENT_TSF_LEN) == 0) {
        l_ret = wal_ioctl_get_current_tsf(pst_net_dev, priv_cmd);
    } else {
#ifdef _PRE_WLAN_CHBA_MGMT
        l_ret = wal_vendor_priv_cmd_chba_protocol(pst_net_dev, pst_ifr, pc_command, *priv_cmd);
#endif
    }
    return l_ret;
}

oal_int32 wal_vendor_get_priv_feature_cap(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr,
    oal_int8 *pc_command, wal_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    *pl_value = l_value;
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "wal_vendor_get_priv_feature_cap::CMD_GET_WIFI_PRVI_FEATURE_CAPABILITY = [%x]!",
                     l_value);
    if (oal_copy_to_user(pst_priv_cmd->puc_buf, pc_command,
                                              ...
                                              oal_int8 *pc_command, wal_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    pl_value = (oal_int32 *)pc_command;
    *pl_value = l_value;
    if (oal_copy_to_user(pst_priv_cmd->puc_buf,
...
oal_int32 wal_vendor_priv_cmd(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr, oal_int32 ul_cmd)
{
    ...
    l_ret = (oal_int32)oal_copy_from_user(pc_command, st_priv_cmd.puc_buf, (oal_uint32)(st_priv_cmd.ul_total_len));
    if (l_ret != 0) {
    ...
    if (oal_strncmp(pc_command, CMD_SET_HITALK_STR, OAL_STRLEN(CMD_SET_HITALK_STR)) == 0) {
        if (wlan_pm_is_poweron()) {
            ...
            g_hitalk_status = NARROW_BAND_ON_MASK | NBFH_ON_MASK;
        ...
        if (oal_strncmp(pc_command, CMD_SET_AP_WPS_P2P_IE, CMD_SET_AP_WPS_P2P_IE_LEN) == 0) {
            ...
            if (wal_ioctl_judge_input_param_length(st_priv_cmd, CMD_P2P_SET_NOA_LEN, OAL_SIZEOF(st_p2p_noa_param)) !=
                OAL_SUCC) {
            ...
            if (wal_ioctl_judge_input_param_length(st_priv_cmd, CMD_P2P_SET_PS_LEN, OAL_SIZEOF(st_p2p_ops_param)) !=
                OAL_SUCC) {
            ...
            if (wal_ioctl_judge_input_param_length(st_priv_cmd, CMD_SET_STA_PM_ON_LEN, 1) != OAL_SUCC) {
            ...
            if (wal_ioctl_judge_input_param_length(st_priv_cmd, CMD_SET_QOS_MAP_LEN, OAL_SIZEOF(st_qos_map_param)) !=
                OAL_SUCC) {
            ...
            hwifi_config_init_force();
            /* 赋值ht40禁止位 */
            *pc_command = g_wlan_customize.uc_disable_capab_2ght40;
            if (oal_copy_to_user(st_priv_cmd.puc_buf,
            ...
            if (wal_ioctl_judge_input_param_length(st_priv_cmd, CMD_SETSUSPENDMODE_LEN, 1) != OAL_SUCC) {
            ...
            if (oal_copy_to_user(st_priv_cmd.puc_buf, pc_command,
                                 CMD_VOWIFI_IS_SUPPORT_REPLY_LEN)) {
...
OAL_STATIC oal_uint32 wal_hipriv_set_tx_ba_policy(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    *((oal_uint32 *)(st_write_msg.auc_value)) = ul_tx_ba_policy;
    ...
    /* 发送消息 */
    l_ret = wal_send_cfg_event(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_uint32), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
oal_uint32 wal_linux_update_wiphy_channel_list_num(oal_net_device_stru *pst_net_dev, oal_wiphy_stru *pst_wiphy)
{
    ...
    g_hi1151_band_2ghz.n_channels = st_channel_list.uc_channel_num_2g;
...
oal_int32 wal_regdomain_update(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country, oal_uint8 len)
{
    oal_uint8 uc_dev_id;
    ...
    ***************************************************************************/
    ...
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        ...
        /* :同步1103修改，命令下发成功，在HMAC释放内存；否则在WAL释放内存 */
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 3, 0))
        /* :Linux 内核4.4 版本增加10MHz 带宽, 将channel 12 添加到US 信道列表，使得工作信道错误
...
oal_uint32 wal_regdomain_update_sta(oal_uint8 uc_vap_id)
{
    ...
    if (us_updata_rd_by_ie_switch == OAL_TRUE) {
        ...
        l_ret = wal_regdomain_update(pst_net_dev, pc_desired_country, 3);
        if (l_ret != OAL_SUCC) {
...
oal_int32 wal_regdomain_update_country_code(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country)
{
    ...
    l_ret = wal_regdomain_update(pst_net_dev, pc_country, 3);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
oal_uint32 wal_hipriv_setcountry(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    puc_para = &ac_arg[0];
    l_ret = wal_regdomain_update(pst_net_dev, puc_para, 3);
    if (l_ret != OAL_SUCC) {
...
OAL_STATIC oal_uint32 wal_hipriv_getcountry(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    l_ret = snprintf_s(ac_tmp_buff, sizeof(ac_tmp_buff), sizeof(ac_tmp_buff) - 1, "getcountry code is : %c%c.\n",
        pst_query_rsp_msg->auc_value[0],
        pst_query_rsp_msg->auc_value[1]);

    oam_warning_log4(0, OAM_SF_CFG, "{wal_hipriv_getcountry:: %c, %c, len %d, ret[%d]}",
        pst_query_rsp_msg->auc_value[0], pst_query_rsp_msg->auc_value[1],
        pst_query_rsp_msg->us_len, l_ret);
...
OAL_STATIC oal_int32 wal_sta_info_seq_show(struct seq_file *f, void *v)
{
    ...
    oal_dlist_search_for_each_safe(pst_entry, pst_dlist_tmp, &(pst_mac_vap->st_mac_user_list_head))
    {
        ...
        l_ret = oal_wait_event_interruptible_timeout(pst_hmac_vap->query_wait_q,
                                                     ...
                                                     5 * OAL_TIME_HZ); /* 5 * HZ, 超时时间为5000ms */
        /*lint +e730*/
        if (l_ret <= 0) {
...
*****************************************************************************/
OAL_STATIC OAL_CONST struct seq_operations g_wal_sta_info_seq_ops = {
...
OAL_STATIC oal_int32 wal_sta_info_seq_open(struct inode *inode, struct file *filp)
{
    ...
    l_ret = seq_open(filp, &g_wal_sta_info_seq_ops);
    if (l_ret == OAL_SUCC) {
...
/*****************************************************************************
    g_st_sta_info_proc_fops: 定义sta info proc fops
*****************************************************************************/
OAL_STATIC OAL_CONST struct file_operations g_st_sta_info_proc_fops = {
    .owner = THIS_MODULE,
...
OAL_STATIC oal_void wal_add_vap_proc_file(mac_vap_stru *pst_mac_vap, oal_int8 *pc_name, oal_uint32 name_len)
{
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION) && (LINUX_VERSION_CODE <= KERNEL_VERSION(2, 6, 34))
    hmac_vap_stru *pst_hmac_vap;
    ...
    pst_hmac_vap = mac_res_get_hmac_vap(pst_mac_vap->uc_vap_id);
    if (pst_hmac_vap == OAL_PTR_NULL || name_len > WAL_HIPRIV_CMD_NAME_MAX_LEN) {
    ...
    pst_proc_stainfo->proc_fops = &g_st_sta_info_proc_fops;
...
oal_uint32 wal_hipriv_add_vap(oal_net_device_stru *pst_cfg_net_dev, oal_int8 *pc_param)
{
    ...
    pst_wdev =
        (oal_wireless_dev_stru *)oal_mem_alloc_m(OAL_MEM_POOL_ID_LOCAL, OAL_SIZEOF(oal_wireless_dev_stru), OAL_FALSE);
    ...
    /* 创建VAP对应的proc文件 */
    wal_add_vap_proc_file(pst_mac_vap, ac_name, WAL_HIPRIV_CMD_NAME_MAX_LEN);
...
oal_uint32 wal_hipriv_del_vap(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    oal_mem_free_m(oal_netdevice_wdev(pst_net_dev), OAL_TRUE);
...
OAL_STATIC oal_uint32 wal_hipriv_user_info(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    oal_uint8 auc_mac_addr[WLAN_MAC_ADDR_LEN] = { 0 }; /* 临时保存获取的use的mac地址信息 */
    ...
    ***************************************************************************/
    ...
    l_ret = (oal_int32)mac_vap_find_user_by_macaddr(pst_mac_vap, auc_mac_addr, WLAN_MAC_ADDR_LEN, &us_user_idx);
    if (l_ret != OAL_SUCC) {
...
oal_uint32 wal_hipriv_set_rate(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    for (en_rate_index = 0; en_rate_index < WLAN_LEGACY_RATE_VALUE_BUTT; en_rate_index++) {
        if (!strcmp(g_pauc_non_ht_rate_tbl[en_rate_index], ac_arg)) {
            break;
        }
    }
...
oal_uint32 wal_hipriv_set_bw(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    for (en_bw_index = 0; en_bw_index < WLAN_BAND_ASSEMBLE_AUTO; en_bw_index++) {
        if (!strcmp(g_pauc_bw_tbl[en_bw_index], ac_arg)) {
            break;
        }
    }
...
OAL_STATIC oal_uint32 wal_hipriv_rx_filter_frag(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg(pc_param, ac_arg, OAL_SIZEOF(ac_arg), &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_rx_filter_frag:wal_get_cmd_one_arg return err_code [%d]}", ul_ret);
        return ul_ret;
    }
...
oal_int32 wal_hipriv_proc_write(oal_file_stru *pst_file, const oal_int8 *pc_buffer, oal_uint32 ul_len, oal_void *p_data)
{
    ...
    if ((ul_len > WAL_HIPRIV_CMD_MAX_LEN) || (ul_len == 0)) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_hipriv_proc_write::ul_len [%d]!}", ul_len);
        return -OAL_EINVAL;
    }
 ...
 */
    ...
    /* hi1102-cb add sys for 51/02 */
#ifdef _PRE_CONFIG_CONN_HISI_SYSFS_SUPPORT
    g_p_sys_kobject = oal_get_sysfs_root_object();
    if (g_p_sys_kobject == NULL) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_hipriv_create_proc::get sysfs root object failed!}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    ul_ret = (oal_uint32)oal_debug_sysfs_create_group(g_p_sys_kobject, &g_hipriv_attribute_group);
    if (ul_ret) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_hipriv_create_proc::g_hipriv_attribute_group create failed!}");
...
#ifdef _PRE_CONFIG_CONN_HISI_SYSFS_SUPPORT
    if (g_p_sys_kobject != NULL) {
        oal_debug_sysfs_remove_group(g_p_sys_kobject, &g_hipriv_attribute_group);
        g_p_sys_kobject = NULL;
    }
#endif
...
OAL_STATIC oal_uint32 wal_hipriv_mac_addr_write(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint16 len;
    ...
    /***************************************************************************
                              抛事件到wal层处理
    ***************************************************************************/
    if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), param, OAL_STRLEN(param)) != EOK) {
...
OAL_STATIC oal_uint32 wal_hipriv_mac_addr_read(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    ...
    ***************************************************************************/
    ...
    leftime = oal_wait_event_interruptible_timeout(hmac_vap->query_wait_q,
                                             (oal_uint32)(hmac_vap->uc_efuse_mac_addr_flag ==
    ...
    if (leftime == 0) {
        ...
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_mac_addr_read::mac_addr: [0x%06X]!}", g_us_efuse_mac_addr_report);
#ifdef _PRE_WLAN_EXPORT
        printk("%06x", g_us_efuse_mac_addr_report);
        if (oal_memcmp(auc_mac_addr, oal_netdevice_mac_addr(net_dev), WLAN_MAC_ADDR_LEN) != 0) {
            return OAL_SUCC;
        }
        if (g_us_efuse_mac_addr_report != 0) {
            for (loop = 0; loop < WLAN_MAC_ADDR_LEN / 2; loop++) {
                device_mac_addr[WLAN_MAC_ADDR_LEN - loop - 1] = (g_us_efuse_mac_addr_report >> (loop * 8)) & 0xFF;
            }
            oal_set_mac_addr((oal_uint8 *)oal_netdevice_mac_addr(net_dev), device_mac_addr);
        } else {
            oal_random_ether_addr(auc_mac_addr);
            for (loop = 0; loop < WLAN_MAC_ADDR_LEN; loop++) {
                device_mac_addr[loop] = auc_mac_addr[loop];
            }
            oal_set_mac_addr((oal_uint8 *)oal_netdevice_mac_addr(net_dev), device_mac_addr);
        }
        for (loop = 0; loop < WLAN_MAC_ADDR_LEN; loop++) {
            id_param.auc_station_id[loop] = device_mac_addr[loop];
        }
        if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), &id_param, OAL_SIZEOF(id_param)) != EOK) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_mac_addr_read::memcpy fail!");
            return OAL_FAIL;
        }

        write_msg.auc_value[OAL_SIZEOF(id_param)] = '\0';

        len = (oal_uint16)(OAL_SIZEOF(id_param) + 1);

        wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_STATION_ID, len);
...
OAL_STATIC oal_uint32 wal_hipriv_pdet_val_read(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint16 len;
    ...
    ***************************************************************************/
    if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), param, OAL_STRLEN(param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_pdet_val_read::memcpy fail!");
        return OAL_FAIL;
    }
    ...
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_PDET_VAL_READ, len);
    ...
    ret = wal_send_cfg_event(net_dev,
                               ...
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_pdet_val_read::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_tsensor_read(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint16 len;
    ...
    ***************************************************************************/
    if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), param, OAL_STRLEN(param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_tsensor_read::memcpy fail!");
        return OAL_FAIL;
    }
    ...
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_TSENSOR_READ, len);
    ...
    ret = wal_send_cfg_event(net_dev,
                               ...
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_tsensor_read::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_power_param_read(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint16 len;
    ...
    ***************************************************************************/
    if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), param, OAL_STRLEN(param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_power_param_read::memcpy fail!");
        return OAL_FAIL;
    }
    ...
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_POWER_PARAM_READ, len);
    ...
    ret = wal_send_cfg_event(net_dev,
                               ...
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_power_param_read::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_device_software_version_read(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint16 len;
    ...
    ***************************************************************************/
    if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), param, OAL_STRLEN(param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_device_software_version_read::memcpy fail!");
        return OAL_FAIL;
    }
    ...
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_GET_VERSION, len);
    ...
    ret = wal_send_cfg_event(net_dev,
                               ...
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_device_software_version_read::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
oal_uint32 wal_hipriv_nb_report_info_read(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint16 len;
    ...
    ***************************************************************************/
    if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), param, OAL_STRLEN(param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_nb_report_info_read::memcpy fail!");
        return OAL_FAIL;
    }
    ...
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_NB_REPORT_INFO_READ, len);
    ...
    ret = wal_send_cfg_event(net_dev,
                               ...
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_nb_report_info_read::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_autorate_param(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    mac_cfg_set_autorate_param *set_autorate_cfg_param = OAL_PTR_NULL;
    mac_cfg_set_autorate_param autorate_param =
    {
        ...
        0, /* 当前档位 */
        7,
        {{85, -90, NARROW_BW_5M, 111, 3, 170, {0, 0}, WLAN_AUTORATE_RATELV_6M},  /* 5G 0档位参数5M-6m */
        {85, -85, NARROW_BW_10M, 111, 3, 170, {0, 0}, WLAN_AUTORATE_RATELV_6M},  /* 5G 1档位参数10M-6m */
        {85, -80, NARROW_BW_10M, 111, 3, 170, {0, 0}, WLAN_AUTORATE_RATELV_9M},  /* 5G 2档位参数10M-9m */
        {85, -75, NARROW_BW_10M, 111, 2, 170, {0, 0}, WLAN_AUTORATE_RATELV_18M}, /* 5G 3档位参数10M-18m */
        {85, -70, NARROW_BW_10M, 111, 2, 150, {0, 0}, WLAN_AUTORATE_RATELV_24M},  /* 5G 4档位参数10M-24m */
        {85, -60, NARROW_BW_10M, 111, 0, 90, {0, 0}, WLAN_AUTORATE_RATELV_48M},  /* 5G 5档位参数10M-48m */
        {85, -90, NARROW_BW_5M, 111, 2, 170, {0, 0}, WLAN_AUTORATE_RATELV_6M },  /* 2G 0档位参数5M-6m */
        {85, -85, NARROW_BW_10M, 111, 2, 170, {0, 0}, WLAN_AUTORATE_RATELV_6M },  /* 2G 1档位参数10M-6m */
        {85, -80, NARROW_BW_10M, 111, 2, 170, {0, 0}, WLAN_AUTORATE_RATELV_9M},  /* 2G 2档位参数10M-9m */
        {85, -75, NARROW_BW_10M, 111, 2, 170, {0, 0}, WLAN_AUTORATE_RATELV_18M}, /* 2G 3档位参数10M-18m */
        {85, -70, NARROW_BW_10M, 111, 2, 150, {0, 0}, WLAN_AUTORATE_RATELV_24M},  /* 2G 4档位参数10M-24m */
        {85, -60, NARROW_BW_10M, 111, 2, 90, {0, 0}, WLAN_AUTORATE_RATELV_48M }}  /* 2G 5档位参数10M-48m */
    };
    oal_int32 ret;
    ...
    /***************************************************************************
                              抛事件到wal层处理
    ***************************************************************************/
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_AUTORATE_PARAM, OAL_SIZEOF(mac_cfg_set_autorate_param));

    /* 解析并设置配置命令参数 */
    set_autorate_cfg_param = (mac_cfg_set_autorate_param *)(write_msg.auc_value);
    memcpy_s(set_autorate_cfg_param, sizeof(mac_cfg_set_autorate_param), &autorate_param, sizeof(mac_cfg_set_autorate_param));
    ret = wal_send_cfg_event(net_dev,
                               WAL_MSG_TYPE_WRITE,
                               WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_set_autorate_param),
                               (oal_uint8 *)&write_msg,
                               OAL_FALSE,
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
...
OAL_STATIC oal_uint32 wal_hipriv_autorate_cfg_set(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    mac_cfg_set_autorate_cfg_stru *set_autorate_cfg_param = OAL_PTR_NULL;
    oal_int32 ret;
    oal_uint32 offset;
    wal_autorate_cfg_enum_uint8 param_index;
    oal_int8 ac_arg[WAL_HIPRIV_CMD_NAME_MAX_LEN];

    /***************************************************************************
                              抛事件到wal层处理
    ***************************************************************************/
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_AUTORATE_CFG_SET, OAL_SIZEOF(mac_cfg_set_autorate_cfg_stru));

    /* 解析并设置配置命令参数 */
    set_autorate_cfg_param = (mac_cfg_set_autorate_cfg_stru *)(write_msg.auc_value);

    ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &offset);
    if (ret != OAL_SUCC) {
    ...
    for (param_index = 0; param_index < WAL_AUTORATE_CFG_PARAM_BUTT; param_index++) {
        if (!strcmp(g_pauc_autorate_cfg_param_name[param_index], ac_arg)) {
            break;
        }
    }
    ...
    set_autorate_cfg_param->val = (oal_uint32)oal_atoi(ac_arg);

    ret = wal_send_cfg_event(net_dev,
                               WAL_MSG_TYPE_WRITE,
                               WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_set_autorate_cfg_stru),
                               (oal_uint8 *)&write_msg,
                               OAL_FALSE,
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
...
oal_uint32 wal_hipriv_nokey_mode_set(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint32 offset;
    mac_cfg_set_nokey_mode_stru *nokey_mode_enable;
    oal_int8 ac_arg[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    ...
    ***************************************************************************/
    if (memcpy_s(write_msg.auc_value, OAL_SIZEOF(write_msg.auc_value), param, OAL_STRLEN(param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_nokey_mode_set::memcpy fail!");
        return OAL_FAIL;
    }

    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_NOKEY_MODE_SET, sizeof(mac_cfg_set_nokey_mode_stru));

    nokey_mode_enable = (mac_cfg_set_nokey_mode_stru *)(write_msg.auc_value);

    ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &offset);
    if (ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_nokey_mode_set::wal_get_cmd_one_arg fail err_code [%d]!}", ret);
        return ret;
    }

    nokey_mode_enable->nokey_mode_en = (oal_uint8)oal_atoi(ac_arg);

    ret = wal_send_cfg_event(net_dev,
                               WAL_MSG_TYPE_WRITE,
                               WAL_MSG_WRITE_MSG_HDR_LENGTH + sizeof(mac_cfg_set_nokey_mode_stru),
                               (oal_uint8 *)&write_msg,
                               OAL_FALSE,
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_nokey_mode_set::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
oal_uint32 wal_hipriv_hitalk_key_set(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint32 offset;
    mac_cfg_key_info_stru *key_info;
    oal_int8 ac_arg[DMAC_HITALK_KEY_LEN];

    /***************************************************************************
                              抛事件到wal层处理
    ***************************************************************************/
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_KEY_INFO_RPT, sizeof(mac_cfg_key_info_stru));

    key_info = (mac_cfg_key_info_stru *)(write_msg.auc_value);

    memset_s(key_info, OAL_SIZEOF(mac_cfg_key_info_stru), 0, OAL_SIZEOF(mac_cfg_key_info_stru));

    ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &offset);
    if (ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_hitalk_key_set::wal_get_cmd_one_arg fail err_code [%d]!}", ret);
        return ret;
    }
    memcpy_s(key_info->hitalk_key, DMAC_HITALK_KEY_LEN, ac_arg, offset);
    key_info->hitalk_key[offset] = '\0';

    ret = wal_send_cfg_event(net_dev,
                               WAL_MSG_TYPE_WRITE,
                               WAL_MSG_WRITE_MSG_HDR_LENGTH + sizeof(mac_cfg_key_info_stru),
                               (oal_uint8 *)&write_msg,
                               OAL_FALSE,
                               NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_hitalk_key_set::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
oal_int32 wal_ioctl_nl80211_priv_connect(oal_net_device_stru *pst_net_dev, oal_net_dev_ioctl_data_stru *pst_ioctl_data)
{
    ...
    if (pst_ioctl_data->pri_data.cfg80211_connect_params.en_privacy != 0) {
        if ((pst_ioctl_data->pri_data.cfg80211_connect_params.uc_wep_key_len != 0) &&
            ...
            /*  同步02修改以支持sta WPS ,如果使能了WPS，则继续处理(不返回失败) */
...
oal_uint8 *wal_get_reduce_sar_ctrl_params(oal_uint8 uc_tx_power_lvl)
{
    ...
    if (memcpy_s(pst_cust_nv_params->auc_sar_ctrl_params, CUS_SAR_NUM, g_sar_params[uc_tx_power_lvl],
...
OAL_STATIC oal_void wal_config_mac_filter(oal_net_device_stru *pst_net_dev, oal_int8 *pc_command)
{
    ...
    for (ul_i = 0; ul_i < ul_mac_cnt; ul_i++) {
        ...
        ***************************************************************************/
        memset_s((oal_uint8 *)&st_write_msg, OAL_SIZEOF(st_write_msg), 0, OAL_SIZEOF(st_write_msg));
        oal_strtoaddr(ac_parsed_command, sizeof(ac_parsed_command),
    ...
    /* Begin::o版本先设置黑白名单，再启动aput，该配置信息不能删除 */
                                       ...
                                       oal_iwreq_data_union *pst_wrqu, char *pc_extra)
{
    ...
    if (oal_unlikely((pst_net_dev == OAL_PTR_NULL) || (pst_wrqu == OAL_PTR_NULL))) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_ioctl_set_ap_config:input params null.}");
        return -OAL_EFAIL;
    }
...
oal_int32 wal_set_nbfh(oal_net_device_stru *pst_net_dev)
{
    ...
    value = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_NBFH_TBTT_OFFSET);
    pst_nbfh_param->ul_nbfh_tbtt_offset = (oal_uint32)value;
    value = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_NBFH_TBTT_SYNC_TIME);
    pst_nbfh_param->ul_nbfh_tbtt_sync_time = (oal_uint32)value;
    value = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_NBFH_DWELL_TIME);
    pst_nbfh_param->ul_nbfh_dwell_time = (oal_uint32)value;
    value = hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_NBFH_BEACON_TIME);
    pst_nbfh_param->ul_nbfh_beacon_time = (oal_uint32)value;
#endif
    ...
    ***************************************************************************/
    ...
    /* 发送消息 */
    l_ret = wal_send_cfg_event(pst_net_dev, WAL_MSG_TYPE_WRITE,
        WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_nbfh_param_stru), (oal_uint8 *)&st_write_msg,
        OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
int32_t wal_setup_chba(oal_net_device_stru *net_dev)
{
    ...
    if (l_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_setup_chba::wal_host_dev_init failed [%d].}\r\n", l_ret);
        return -OAL_EFAIL;
    }
    mac_vap = oal_net_dev_priv(net_dev);
    if (mac_vap) {
...
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
    hwifi_config_init_ini(net_dev);
#endif
    oam_warning_log0(0, OAM_SF_ANY, "{wal_setup_chba:: add chba vap}");
    return OAL_SUCC;
}
#endif
...
oal_int32 wal_init_wlan_vap(oal_net_device_stru *pst_net_dev)
{
    ...
    if ((pst_wdev->iftype == NL80211_IFTYPE_STATION) || (pst_wdev->iftype == NL80211_IFTYPE_P2P_DEVICE)) {
        if ((strcmp(wal_get_wlan_name(), pst_net_dev->name)) == 0) {
            ...
            oam_warning_log0(0, OAM_SF_ANY, "{wal_init_wlan_vap::net_dev is not wlanx or p2p0!}\r\n");
            return OAL_SUCC;
        }
    ...
    ***************************************************************************/
    ...
    if ((hwifi_get_chba_en() == OAL_TRUE) &&
        (oal_strcmp("chba0", pst_net_dev->name) == 0)) {
        ((mac_cfg_add_vap_param_stru *)st_write_msg.auc_value)->chba_mode = CHBA_MODE;
    }
#endif
    /* 发送消息 */
    l_ret = wal_send_cfg_event(pst_cfg_net_dev, WAL_MSG_TYPE_WRITE,
...
oal_int32 wal_deinit_wlan_vap(oal_net_device_stru *pst_net_dev)
{
    ...
    if (((strcmp(wal_get_wlan_name(), pst_net_dev->name)) != 0) &&
#ifdef _PRE_WLAN_CHBA_MGMT
        ((strcmp("chba0", pst_net_dev->name)) != 0) &&
#endif
        ((strcmp(wal_get_p2p_name(), pst_net_dev->name)) != 0)) {
        oam_warning_log0(pst_mac_vap->uc_vap_id, OAM_SF_ANY,
            "{wal_deinit_wlan_vap::net_dev is not wlan0 or p2p0 or chba0!}");
        return OAL_SUCC;
    }

#ifdef _PRE_WLAN_FEATURE_P2P
    if (strcmp(wal_get_p2p_name(), pst_net_dev->name) == 0) {
        en_p2p_mode = WLAN_P2P_DEV_MODE;
    }
#endif
...
oal_void wal_set_mac_addr(oal_net_device_stru *pst_net_dev)
{
    ...
    if (oal_unlikely(pst_mac_device->st_p2p_info.pst_primary_net_device == OAL_PTR_NULL)) {
        ...
        auc_primary_mac_addr[0] &= (~0x02); /*  wlan0 MAC[0] bit1 需要设置为0 */
...
static void wal_set_chba_mac_addr(oal_net_device_stru *net_dev)
{
    ...
    primary_mac_addr[0] &= (~0x02); /*  wlan0 MAC[0] bit1 需要设置为0 */
    primary_mac_addr[1] = 0x11; /* MAC[1] */
    primary_mac_addr[2] = 0x05; /* MAC[2] */
...
static void wal_chba_netdev_set(oal_net_device_stru *net_dev, oal_wireless_dev_stru *wdev, oal_wiphy_stru *wiphy)
{
 ...
 /* 对netdevice进行赋值 */
    ...
    net_dev_priv->uc_napi_enable     = OAL_FALSE;
    net_dev_priv->uc_gro_enable      = OAL_FALSE;
#else
    net_dev_priv->uc_napi_enable = OAL_TRUE;
    net_dev_priv->uc_gro_enable = OAL_TRUE;
#endif
    net_dev_priv->uc_napi_weight = NAPI_POLL_WEIGHT_LEV1;
    net_dev_priv->ul_queue_len_max = NAPI_NETDEV_PRIV_QUEUE_LEN_MAX;
    net_dev_priv->uc_state = 0;
    net_dev_priv->ul_period_pkts = 0;
    net_dev_priv->ul_period_start = 0;
...
int32_t wal_init_chba_netdev(oal_wiphy_stru *wiphy, const char *dev_name)
{
    ...
    if (wiphy_priv->pst_mac_device == NULL) {
    ...
    net_dev = oal_net_alloc_netdev_mqs(sizeof(oal_netdev_priv_stru),
        (oal_int8 *)dev_name, oal_ether_setup, WLAN_NET_QUEUE_BUTT, 1);
...
oal_int32 wal_init_wlan_netdev(oal_wiphy_stru *pst_wiphy, char *dev_name)
{
    ...
    if ((strcmp(wal_get_wlan_name(), dev_name)) == 0) {
        en_type = NL80211_IFTYPE_STATION;
    } else if ((strcmp(wal_get_p2p_name(), dev_name)) == 0) {
        en_type = NL80211_IFTYPE_P2P_DEVICE;
    } else {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_init_wlan_netdev::dev name is not wlanx or p2p0}\r\n");
        return OAL_SUCC;
    }
    OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_init_wlan_netdev::en_type is %d, [2:wlanx;10:p2p0]}\r\n", en_type);
...
{
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    if (register_inetaddr_notifier(&g_wal_hipriv_notifier) == 0) {
        return OAL_SUCC;
    }
...
{
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    if (unregister_inetaddr_notifier(&g_wal_hipriv_notifier) == 0) {
        return OAL_SUCC;
    }
...
{
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    if (register_inet6addr_notifier(&g_wal_hipriv_notifier_ipv6) == 0) {
        return OAL_SUCC;
    }
...
{
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    if (unregister_inet6addr_notifier(&g_wal_hipriv_notifier_ipv6) == 0) {
        return OAL_SUCC;
    }
...
#if _PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE
#ifdef CONFIG_ARCH_QCOM
            wlan_pm_set_timeout(WLAN_SLEEP_FAST_CHECK_CNT);
#else
...
oal_int32 wal_set_ip_filter_enable(oal_int32 l_on)
{
    ...
    if (pst_net_dev == OAL_PTR_NULL) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_set_ip_filter_enable::wlanx not exist!}");
        return -OAL_EINVAL;
    }
    /* 调用oal_dev_get_by_name后，必须调用oal_dev_put使net_dev的引用计数减一 */
    oal_dev_put(pst_net_dev);
...
oal_int32 wal_set_assigned_filter_enable(oal_int32 l_filter_id, oal_int32 l_switch)
{
    ...
    pst_net_dev = oal_dev_get_by_name(wal_get_wlan_name());
    if (pst_net_dev == OAL_PTR_NULL) {
        oam_warning_log0(0, OAM_SF_CFG, "{wal_set_assigned_filter_enable::wlanx not exist!}");
        return -OAL_EINVAL;
    }
...
oal_int32 wal_add_ip_filter_items(wal_hw_wifi_filter_item *pst_items, oal_int32 l_count)
{
    ...
    pst_net_dev = oal_dev_get_by_name(wal_get_wlan_name());
    if (pst_net_dev == OAL_PTR_NULL) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_add_ip_filter_items::wlanx not exist!}");
        return -OAL_EINVAL;
    }
    /* 调用oal_dev_get_by_name后，必须调用oal_dev_put使net_dev的引用计数减一 */
    oal_dev_put(pst_net_dev);
    ...
    st_ip_filter_cmd.uc_item_count =
        oal_min((MAC_MAX_IP_FILTER_BTABLE_SIZE / OAL_SIZEOF(mac_ip_filter_item_stru)), (oal_uint8)l_count);
...
oal_int32 wal_clear_ip_filter()
{
    ...
    pst_net_dev = oal_dev_get_by_name(wal_get_wlan_name());
    if (pst_net_dev == OAL_PTR_NULL) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_clear_ip_filter::wlanx not exist!}");
        return -OAL_EINVAL;
    }
...
#if defined(_PRE_WLAN_FEATURE_APF) || defined(_PRE_PM_DYN_SET_TBTT_OFFSET)
    oal_uint8 uc_switch;
#endif
...
OAL_STATIC oal_uint32 wal_hipriv_set_tx_pow_param(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    for (en_param_index = 0; en_param_index < WAL_TX_POW_PARAM_BUTT; en_param_index++) {
        if (!strcmp(g_pauc_tx_pow_param_name[en_param_index], ac_arg)) {
            break;
        }
    }
                                                       ...
                                                       oal_int8 *pc_command)
{
    ...
    en_priority = (hal_nrcoex_priority_enum_uint8)oal_atoi(pc_command + CMD_SET_NRCOEX_PRIOR_LEN + 1);
                                               ...
                                               oal_int8 *pc_command)
{
    ...
    l_ret = oal_wait_event_interruptible_timeout(pst_nrcoex_query->st_wait_queue,
                                                 ...
                                                 5 * OAL_TIME_HZ); /* 5 * OAL_TIME_HZ,超时时间5000ms */
    /*lint +e774*/
    /* 等待超时或异常则返回 */
    if (l_ret <= 0) {
