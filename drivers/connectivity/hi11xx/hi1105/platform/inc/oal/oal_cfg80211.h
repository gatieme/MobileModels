 ...
 *
 * Description: oal_cfg80211.c header file
 * Author: @CompanyNameTag
 */

#ifndef OAL_CFG80211_H
#define OAL_CFG80211_H
...
/* 函数声明 */
extern void oal_cfg80211_put_bss(oal_wiphy_stru *pst_wiphy, oal_cfg80211_bss_stru *pst_cfg80211_bss);
...
extern oal_cfg80211_bss_stru *oal_cfg80211_inform_bss_frame(oal_wiphy_stru *pst_wiphy,
                                                            oal_ieee80211_channel_stru *pst_ieee80211_channel,
                                                            oal_ieee80211_mgmt_stru *pst_mgmt,
                                                            uint32_t ul_len,
                                                            int32_t l_signal,
                                                            oal_gfp_enum_uint8 en_ftp);
extern void oal_cfg80211_scan_done(oal_cfg80211_scan_request_stru *pst_cfg80211_scan_request,
                                   int8_t c_aborted);
extern void oal_cfg80211_sched_scan_result(oal_wiphy_stru *pst_wiphy);
#ifdef _PRE_WLAN_CHBA_MGMT
extern uint32_t oal_cfg80211_connect_ready_report(oal_net_device_stru *pst_net_device,
                                                  const uint8_t *puc_mac_addr, uint8_t ntf_id,
                                                  uint16_t us_status, oal_gfp_enum_uint8 en_gfp);
#endif
extern uint32_t oal_cfg80211_connect_result(oal_net_device_stru *pst_net_device,
...
extern uint32_t oal_cfg80211_disconnected(oal_net_device_stru *pst_net_device,
                                          uint16_t us_reason,
                                          uint8_t *puc_ie,
                                          uint32_t ul_ie_len,
                                          oal_gfp_enum_uint8 en_gfp);
extern uint32_t oal_cfg80211_new_sta(oal_net_device_stru *pst_net_device,
                                     const uint8_t *puc_mac_addr,
                                     oal_station_info_stru *pst_station_info,
                                     oal_gfp_enum_uint8 en_gfp);
extern void oal_cfg80211_mic_failure(oal_net_device_stru *pst_net_device,
                                     const uint8_t *puc_mac_addr,
                                     enum nl80211_key_type key_type,
                                     int32_t key_id,
                                     const uint8_t *tsc,
                                     oal_gfp_enum_uint8 en_gfp);
extern int32_t oal_cfg80211_del_sta(oal_net_device_stru *pst_net_device,
                                    const uint8_t *puc_mac_addr, uint8_t len,
                                    oal_gfp_enum_uint8 en_gfp);
extern uint32_t oal_cfg80211_rx_mgmt(oal_net_device_stru *pst_dev,
                                     int32_t l_freq,
                                     uint8_t uc_rssi,
                                     const uint8_t *puc_buf,
                                     uint32_t ul_len,
                                     oal_gfp_enum_uint8 en_gfp);
extern void oal_cfg80211_ready_on_channel(oal_wireless_dev_stru *pst_wdev,
                                          uint64_t ull_cookie,
                                          oal_ieee80211_channel_stru *pst_chan,
                                          uint32_t ul_duration,
                                          oal_gfp_enum_uint8 en_gfp);
extern void oal_cfg80211_vowifi_report(oal_net_device_stru *pst_netdev,
                                       oal_gfp_enum_uint8 en_gfp);
extern void oal_cfg80211_remain_on_channel_expired(oal_wireless_dev_stru *pst_wdev,
                                                   uint64_t ull_cookie,
                                                   oal_ieee80211_channel_stru *pst_listen_channel,
                                                   oal_gfp_enum_uint8 en_gfp);

extern void oal_cfg80211_mgmt_tx_status(struct wireless_dev *wdev, uint64_t cookie,
                                        const uint8_t *buf, size_t len,
                                        oal_bool_enum_uint8 ack,
                                        oal_gfp_enum_uint8 gfp);
extern uint32_t oal_cfg80211_roamed(oal_net_device_stru *pst_net_device,
                                    ...
                                    uint32_t ul_resp_ie_len,
                                    oal_gfp_enum_uint8 en_gfp);
extern uint32_t oal_cfg80211_ft_event(oal_net_device_stru *pst_net_device,
                                      oal_cfg80211_ft_event_stru *pst_ft_event);
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
extern void oal_kobject_uevent_env_sta_join(oal_net_device_stru *pst_net_device,
                                            const uint8_t *puc_mac_addr);
extern void oal_kobject_uevent_env_sta_leave(oal_net_device_stru *pst_net_device,
                                             const uint8_t *puc_mac_addr);
#endif

extern uint32_t oal_cfg80211_rx_exception(oal_net_device_stru *pst_netdev,
                                          uint8_t *puc_data,
...
extern void oal_cfg80211_m2s_status_report(oal_net_device_stru *pst_netdev,
                                           oal_gfp_enum_uint8 en_gfp, uint8_t *puc_buf, uint32_t ul_len);
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
extern void oal_cfg80211_tas_rssi_access_report(oal_net_device_stru *pst_netdev, oal_gfp_enum_uint8 en_gfp,
                                                uint8_t *puc_buf, uint32_t ul_len);
#endif
extern int oal_cfg80211_external_auth_request(oal_net_device_stru *pst_netdev,
                                              oal_cfg80211_external_auth_stru *pst_params,
                                              oal_gfp_enum_uint8 en_gfp);
extern void oal_cfg80211_ch_switch_notify(oal_net_device_stru *pst_netdev,
...
extern void oal_cfg80211_hid2d_acs_report(oal_net_device_stru *netdev, oal_gfp_enum_uint8 gfp,
    uint8_t *buf, uint32_t len);
#endif
#ifdef _PRE_WLAN_CHBA_MGMT
extern void oal_cfg80211_chba_report(uint8_t *buf, uint32_t len);
#endif
...
#endif
extern uint32_t oal_cfg80211_init(void);
extern void oal_cfg80211_exit(void);
