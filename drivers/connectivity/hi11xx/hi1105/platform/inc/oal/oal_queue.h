 ...
 *             p_element: 元素指针
 */
OAL_STATIC OAL_INLINE uint32_t oal_queue_enqueue(oal_queue_stru *pst_queue, void *p_element)
{
...
OAL_STATIC OAL_INLINE uint32_t oal_queue_enqueue_16(oal_queue_stru_16 *pst_queue, void *p_element)
{
