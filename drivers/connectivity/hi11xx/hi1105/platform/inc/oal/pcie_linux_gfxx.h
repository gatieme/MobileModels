 ...
 *
 * Description:oal_pcie_linux.c header file
 * Author: @CompanyNameTag
 */

#ifndef PCIE_LINUX_GFXX_H
#define PCIE_LINUX_GFXX_H
...
#define  PCIE_HISI_DEVICE_ID_MP13      (0x1103)
#define  PCIE_HISI_DEVICE_ID_MP15      (0x1105)
#define  PCIE_HISI_DEVICE_ID_MP16FPGA (0x1106)
#define  PCIE_HISI_DEVICE_ID_MP16     (0x0006)
#define  PCIE_HISI_DEVICE_ID_MP16C     (0xb001)
#define  PCIE_HISI_DEVICE_ID_GF61      (0xb003)
...
typedef struct _pcie_chip_pm_cb_ {
    ...
    int32_t (*pcie_device_auxclk_switch)(oal_pcie_linux_res *pst_pci_res, aux_clk_mode clk_mode);
...
typedef struct _pcie_chip_cb_ {
    ...
    int32_t (*pcie_config_slave)(oal_pcie_linux_res *, oal_pci_slave_config_type slave_type);
...
typedef struct _oal_pcie_ep_res_ {
    ...
    oal_mutex_stru st_rx_cnt_res_lock;
...
uint32_t oal_pcie_get_link_state(uint32_t dev_id);
...
extern int32_t g_pcie_aspm_enable;
extern int32_t g_pcie_performance_mode;
#endif
