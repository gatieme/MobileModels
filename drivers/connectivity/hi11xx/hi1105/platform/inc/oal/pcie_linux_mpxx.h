...
#ifndef PCIE_LINUX_110X_H
#define PCIE_LINUX_110X_H
...
/* 支持PCIE驱动加载之前调用，所以需要用chip_type区分芯片类型 */
int32_t pcie_linkup_prepare_fixup(int32_t ep_idx); // pcie ep解复位后， 建链之前的fixup操作
int32_t pcie_linkup_fail_fixup(int32_t ep_idx); // pcie ep 建链失败后的fixup操作
