...
bfgx-objs := bfgx_data_parse.o bfgx_platform_msg_handle.o bfgx_dev.o bfgx_core.o bfgx_gnss.o bfgx_sle.o bfgx_user_ctrl.o \
...
board-common-objs := board.o ssi_common.o ssi_spmi.o ssi_dbg_cmd.o board_gpio.o board_dts.o board_bfgx.o
...
KBUILD_CFLAGS += -D_PRE_CONFIG_GPIO_TO_SSI_DEBUG
...
KBUILD_CFLAGS += -DMPXX_OS_BUILD_VARIANT_ROOT=1
KBUILD_CFLAGS += -DMPXX_OS_BUILD_VARIANT_USER=2
ifneq ($(TARGET_BUILD_VARIANT),user)
KBUILD_CFLAGS += -DOS_MPXX_BUILD_VERSION=MPXX_OS_BUILD_VARIANT_ROOT
else
KBUILD_CFLAGS += -DOS_MPXX_BUILD_VERSION=MPXX_OS_BUILD_VARIANT_USER
endif
...
KBUILD_CFLAGS += -DMPXX_DRV_VERSION=$(HI110X_VERSION)
#endif
endif
...
ifeq ($(CONFIG_ARM64_PTR_AUTH_FWD_CFI),y)
FWD_CFI_PLUGIN = -fpass-plugin=$(pac_path)/lib/libPacFecfiPass.so
EXTRA_CFLAGS := $(filter-out $(FWD_CFI_PLUGIN), $(EXTRA_CFLAGS))
endif

ifeq ($(CONFIG_ARM64_PTR_AUTH_DATA_PTR),y)
DATA_PTR_PLUGIN = -fpass-plugin=$(pac_path)/lib/libPacDfiPass.so
EXTRA_CFLAGS := $(filter-out $(DATA_PTR_PLUGIN), $(EXTRA_CFLAGS))
endif

ifeq ($(CONFIG_ARM64_PTR_AUTH_DATA_FIELD),y)
DATA_FIELD_PLUGIN = -fpass-plugin=$(pac_path)/lib/libPacDfiPass.so
EXTRA_CFLAGS := $(filter-out $(DATA_FIELD_PLUGIN), $(EXTRA_CFLAGS))
endif

ifeq ($(CONFIG_ARM64_PTR_AUTH_BACK_CFI),y)
BACK_CFI_PLUGIN = -fpass-plugin=$(pac_path)/lib/libPacRetPass.so
EXTRA_CFLAGS := $(filter-out $(BACK_CFI_PLUGIN), $(EXTRA_CFLAGS))
endif
