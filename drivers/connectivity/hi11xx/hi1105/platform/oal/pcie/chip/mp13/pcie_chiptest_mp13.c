...
#define GLB_CTL_BASE_ADDR pst_glb_ctrl

#define PMU_CMU_BASE pst_pmu_cmu_ctrl

#define PMU2_CMU_IR_BASE pst_pmu2_cmu_ir_ctrl

#define PMU2_CMU_IR_PMU_LNALDO0_EN_DELAY_STS_OFFSET 1
#define PMU2_CMU_IR_PMU_LNALDO0_EN_STS_OFFSET       0
#define PMU2_CMU_IR_PMU_LNALDO0_EN_DELAY_STS_MSK ((0x1UL) << PMU2_CMU_IR_PMU_LNALDO0_EN_DELAY_STS_OFFSET)
#define PMU2_CMU_IR_PMU_LNALDO0_EN_STS_MSK       ((0x1UL) << PMU2_CMU_IR_PMU_LNALDO0_EN_STS_OFFSET)

#define PMU2_CMU_IR_FBDIV_FRAC_SLP_STS_LEN    1
#define PMU2_CMU_IR_FBDIV_FRAC_SLP_STS_OFFSET 0
#define PMU2_CMU_IR_FBDIV_FRAC_WKUP_MSK       ((0x1UL) << PMU2_CMU_IR_FBDIV_FRAC_WKUP_OFFSET)
#define PMU2_CMU_IR_FBDIV_FRAC_SLP_STS_MSK    ((0x1UL) << PMU2_CMU_IR_FBDIV_FRAC_SLP_STS_OFFSET)

#define PMU2_CMU_IR_PMU2_CMU_ABB_MAN_SEL_W_2_REG   (PMU2_CMU_IR_BASE + 0x148) /* PMU2_CMU_ABB 手动选择 */
#define PMU2_CMU_IR_PMU_RFLDO3_EN_MAN_W_SEL_OFFSET 6

#define PMU2_CMU_IR_PMU2_CMU_ABB_STS_2_REG (PMU2_CMU_IR_BASE + 0x15C) /* PMU2_CMU_ABB 实际状态 */

#define PMU2_CMU_IR_PMU2_CMU_ABB_MAN_SEL_W_3_REG   (PMU2_CMU_IR_BASE + 0x168) /* PMU2_CMU_ABB 手动选择 */
#define PMU2_CMU_IR_PMU_RFLDO6_EN_MAN_W_SEL_OFFSET 4

#define PMU2_CMU_IR_PMU2_CMU_ABB_STS_3_REG (PMU2_CMU_IR_BASE + 0x17C) /* PMU2_CMU_ABB 实际状态 */

#define PMU2_CMU_IR_PMU2_CMU_ABB_MAN_SEL_W_6_REG (PMU2_CMU_IR_BASE + 0x1C8) /* PMU2_CMU_ABB 手动选择 */
#define PMU2_CMU_IR_PMU_XLDO_EN_MAN_W_SEL_OFFSET 0

#define PMU2_CMU_IR_PMU2_CMU_ABB_STS_6_REG (PMU2_CMU_IR_BASE + 0x1DC) /* PMU2_CMU_ABB 实际状态 */

#define PMU2_CMU_IR_PMU2_CMU_ABB_MAN_SEL_W_8_REG (PMU2_CMU_IR_BASE + 0x208) /* PMU2_CMU_ABB 手动选择 */
#define PMU2_CMU_IR_PMU2_CMU_ABB_MAN_STS_8_REG   (PMU2_CMU_IR_BASE + 0x210) /* PMU2_CMU_ABB 手动状态 */
#define PMU2_CMU_IR_PMU2_CMU_ABB_DBG_SEL_8_REG   (PMU2_CMU_IR_BASE + 0x218) /* PMU2_CMU_ABB 调试选择 */

#define PMU2_CMU_IR_REFDIV_REG    (PMU2_CMU_IR_BASE + 0x300) /* CMU 分频比配置 */
#define PMU2_CMU_IR_FBDIV_REG     (PMU2_CMU_IR_BASE + 0x304) /* CMU 分频比配置 */
#define PMU2_CMU_IR_FRAC_L_REG    (PMU2_CMU_IR_BASE + 0x308) /* CMU 分频比配置 */
#define PMU2_CMU_IR_FRAC_H_REG    (PMU2_CMU_IR_BASE + 0x30C) /* CMU 分频比配置 */
#define PMU2_CMU_IR_POSTDIV_REG   (PMU2_CMU_IR_BASE + 0x310) /* CMU 分频比配置 */
#define PMU2_CMU_IR_CMU_PD_REG    (PMU2_CMU_IR_BASE + 0x314) /* CMU PD 控制 */
#define PMU2_CMU_IR_CMU_GT_W_REG  (PMU2_CMU_IR_BASE + 0x318) /* CMU GT 控制 */
#define PMU2_CMU_IR_TCXO_GT_W_REG (PMU2_CMU_IR_BASE + 0x31C) /* TCXO GT 控制 */

#define PMU2_CMU_IR_AON_DIV_1_REG    (PMU2_CMU_IR_BASE + 0x418)
#define PMU2_CMU_IR_AON_CRG_CKEN_REG (PMU2_CMU_IR_BASE + 0x420)
#define PMU2_CMU_IR_CLK_SEL_REG      (PMU2_CMU_IR_BASE + 0x430)

#define PMU2_CMU_IR_FBDIV_FRAC_SLP_REG     (PMU2_CMU_IR_BASE + 0x370) /* CMU 分频比控制 */
#define PMU2_CMU_IR_FBDIV_FRAC_WKUP_OFFSET 1

#define PMU2_CMU_IR_CMU_STATUS_GRM_REG (PMU2_CMU_IR_BASE + 0x890) /* CMU状态查询 */

#define W_CTL_BASE                   pst_wctrl
#define W_CTL_WTOPCRG_SOFT_CLKEN_REG (W_CTL_BASE + 0x40)
#define W_CTL_W_TCXO_SEL_REG         (W_CTL_BASE + 0x80) /* WLAN TCXO/PLL时钟模式选择寄存器 */
#define W_CTL_CLKMUX_STS_REG         (W_CTL_BASE + 0x88)
...
/* mp15 */
OAL_STATIC uintptr_t g_mp15_asic_wmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x00040000, 0x000BFFFF }, /* itcm ram */
    { 0x20020000, 0x2007FFFF }, /* dtcm */
    { 0x60000000, 0x600FFFFF }, /* share mem */
};

OAL_STATIC uintptr_t g_mp15_fpga_wmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
...
OAL_STATIC uintptr_t g_mp15_asic_bmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x80040000, 0x8014FFFF }, /* itcm */
    { 0x80200000, 0x8030FFFF }, /* dtcm */
};

/* mp16 */
OAL_STATIC uintptr_t g_mp16_asic_wmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x00040000, 0x001A7FFF }, /* wram */      // 1affff
    { 0x02000000, 0x02087FFF }, /* share mem */
    { 0x020A0000, 0x020A1FFF }, /* share mem */
};

OAL_STATIC uintptr_t g_mp16_asic_bmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x44002000, 0x44121FFF }, /* itcm */
    { 0x44200000, 0x4427FFFF }, /* dtcm */
};

OAL_STATIC uintptr_t g_mp16_asic_gmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x44400000, 0x4446FFFF }, /* itcm */
    { 0x44500000, 0x4454FFFF }, /* dtcm */
};

/* mp16c */
OAL_STATIC uintptr_t g_mp16c_asic_wmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x00090000, 0x000DFFFF }, /* itcm */
    { 0x20002000, 0x2007FFFF }, /* dtcm, 前8k stack */
    { 0x02000000, 0x0207FFFF }, /* share mem */
};

OAL_STATIC uintptr_t g_mp16c_asic_bmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x44680000, 0x446CFFFF }, /* itcm */
    { 0x44702000, 0x44733FFF }, /* dtcm，前8k stack */
};

OAL_STATIC uintptr_t g_mp16c_asic_gmem_scan_array[][PCIE_MEM_MSG_SIZE] = {
    { 0x44463000, 0x444DFFFF }, /* sle_ram，前12k stack */
    { 0x44050000, 0x440B7FFF }, /* gf_itcm */
    { 0x44100000, 0x441C7FFF }, /* gf_dtcm */
};
                                       ...
                                       uint32_t mask, unsigned long timeout)
{
    ...
    oal_print_mpxx_log(MPXX_LOG_WARN, "%p expect 0x%x , read 0x%x, mask 0x%x, timeout=%lu ms",
                                               ...
                                               void *pst_pmu2_cmu_ir_ctrl, void *pst_wctrl)
{
    ...
    oal_setl_bits(PMU2_CMU_IR_REFDIV_REG, 0, 6, 0x1); // 6bits [0-5] to 0x1
    oal_writel(0x19, PMU2_CMU_IR_FBDIV_REG);
    oal_writel(0x0, PMU2_CMU_IR_FRAC_H_REG);
    oal_writel(0x0, PMU2_CMU_IR_FRAC_L_REG);
    oal_writel(0x11, PMU2_CMU_IR_POSTDIV_REG);
    ...
    oal_clearl_mask(PMU2_CMU_IR_CMU_PD_REG, (BIT4 | BIT3 | BIT1));
    oal_readl(PMU2_CMU_IR_CMU_PD_REG);
    oal_msleep(1); // sched sleep 1ms

    oal_pcie_device_read32_timeout(pst_pmu2_cmu_ir_ctrl + 0x880, 0x0, 0x1, PCIE_DEV_FREQ_CTIMEOUT);

    oal_clearl_mask(PMU2_CMU_IR_CMU_GT_W_REG, (BIT2 | BIT5));

    oal_clearl_mask(PMU2_CMU_IR_CMU_GT_W_REG, (BIT3 | BIT0));

    oal_clearl_bit(PMU2_CMU_IR_TCXO_GT_W_REG, 4); // bit4

    oal_setl_mask(W_CTL_WTOPCRG_SOFT_CLKEN_REG, (BIT8));

    oal_print_mpxx_log(MPXX_LOG_INFO, "change 640M set");
    oal_setl_bit(W_CTL_W_TCXO_SEL_REG, 0); // bit0

    oal_print_mpxx_log(MPXX_LOG_INFO, "change 640M wait start");
    oal_msleep(10); /* 防止这里高频切出问题，下面只回读一次, delay 10ms */
    value = oal_readl(W_CTL_CLKMUX_STS_REG);
    if ((value & 0x2) != 0x2) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "change 640M wait failed, clkmux=0x%x", value);
        ssi_dump_device_regs(SSI_MODULE_MASK_COMM);
    } else {
        oal_print_mpxx_log(MPXX_LOG_INFO, "change 640M wait ok, clkmux=0x%x", value);
    }
}
                                                ...
                                                uintptr_t *pst_wctrl)
{
    ...
    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, PA_GLB_CTL_BASE_ADDR, &addr_map);
    if (oal_unlikely(ret != OAL_SUCC)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "can not found mem map for dev cpu address 0x%x\n",
                           PA_GLB_CTL_BASE_ADDR);
        return -OAL_EFAIL;
    }

    *pst_glb_ctrl = addr_map.va;

    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, PA_PMU_CMU_CTL_BASE, &addr_map);
    if (oal_unlikely(ret != OAL_SUCC)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "can not found mem map for dev cpu address 0x%x\n",
                           PA_PMU_CMU_CTL_BASE);
        return -OAL_EFAIL;
    ...
    *pst_pmu_cmu_ctrl = addr_map.va;
    ...
    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, PA_PMU2_CMU_IR_BASE, &addr_map);
    if (oal_unlikely(ret != OAL_SUCC)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "can not found mem map for dev cpu address 0x%x\n",
                           PA_PMU2_CMU_IR_BASE);
        return -OAL_EFAIL;
    ...
    *pst_pmu2_cmu_ir_ctrl = addr_map.va;
    ...
    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, PA_W_CTL_BASE, &addr_map);
    if (oal_unlikely(ret != OAL_SUCC)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "can not found mem map for dev cpu address 0x%x\n", PA_W_CTL_BASE);
        return -OAL_EFAIL;
    }
...
int32_t oal_pcie_device_changeto_high_cpufreq(oal_pcie_res *pst_pci_res)
{
    ...
    if (g_ft_pcie_wcpu_max_freq_bypass) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie_wcpu_max_freq_bypass");
        return OAL_SUCC;
    }
    ...
    if (oal_unlikely(ret != OAL_SUCC)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "get soc regs failed, ret=%d", ret);
        return -OAL_EFAIL;
    }

    oal_print_mpxx_log(MPXX_LOG_INFO, "pst_pci_res->revision %u", pst_pci_res->revision);

    if (pst_pci_res->revision == PCIE_REVISION_4_70A) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie 4.70a mpw2 freq");
        return -OAL_ENODEV;
    } else if (pst_pci_res->revision == PCIE_REVISION_5_00A) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie 5.00a pilot freq from 76.8M");
        /* tcxo to 38.4M */
        oal_print_mpxx_log(MPXX_LOG_INFO, "tcxo div=0x%x", oal_readl(pst_pmu2_cmu_ir_ctrl + 0x338));
        oal_pcie_change_highfreq_regconfig(pst_glb_ctrl, pst_pmu_cmu_ctrl, pst_pmu2_cmu_ir_ctrl, pst_wctrl);
    } else {
        oal_print_mpxx_log(MPXX_LOG_ERR, "unsupport revision: %u", pst_pci_res->revision);
        return -OAL_ENODEV;
    }
...
int32_t oal_pcie_get_gen_mode(oal_pcie_res *pst_pci_res)
{
    ...
    value = ((value >> 9) & 0x1); /* 第9位0->gen1, 1->gen2 */
    if (value == 0) {
        return PCIE_GEN1;
    } else {
        return PCIE_GEN2;
...
void oal_pcie_set_voltage_bias_param(int32_t phy_0v9_bias, int32_t phy_1v8_bias)
{
    ...
    oal_print_mpxx_log(MPXX_LOG_INFO, "param 0v9=%d 1v8=%d", phy_0v9_bias, phy_1v8_bias);
}
...
void oal_pcie_voltage_bias_param_init(void)
{
    ...
    int32_t param[10];   /* pcie vol bias 参数个数最大为10 */
    uint32_t param_nums;
    ...
    forever_loop() {
        ...
        param[param_nums++] = simple_strtol(token, NULL, 10); /* 10进制 */
        pci_print_log(PCI_LOG_INFO, "bias param %u , value is %d", param_nums, param[param_nums - 1]);
    }
                                                   ...
                                                   uint32_t nums, uint32_t *pst_value)
{
    ...
    for (i = 0; i < (int32_t)nums; i++) {
        pst_tmp = pst_reg_bits + i;
        if (target_value == pst_tmp->flag) {
            *pst_value = pst_tmp->value;
            oal_print_mpxx_log(MPXX_LOG_INFO, "flag:%u matched value:0x%x , [%s]",
...
int32_t oal_pcie_get_vol_reg_1v8_value(int32_t request_vol, uint32_t *pst_value)
{
    ...
    if (ret != OAL_SUCC) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "invalid pcie ldo bias phy 1v8 param =%d mV", request_vol);
        return -OAL_EINVAL;
    }
    return OAL_SUCC;
}
int32_t oal_pcie_get_vol_reg_0v9_value(int32_t request_vol, uint32_t *pst_value)
{
    ...
    if (ret != OAL_SUCC) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "invalid pcie ldo bias phy 0v9 param =%d mV", request_vol);
        return -OAL_EINVAL;
    }
    return OAL_SUCC;
}
...
int32_t oal_pcie_voltage_bias_init_mp13(oal_pcie_res *pst_pci_res)
{
    ...
    if (g_pcie_ldo_phy_0v9_param == 0 ||
        ...
        oal_print_mpxx_log(MPXX_LOG_INFO, "phy 0v9=%u mV, 1v8=%u mV invaild, pcie vol bias bypass",
    ...
    if (ret != OAL_SUCC) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "invalid pcie ldo bias phy 0v9 param =%d mV", g_pcie_ldo_phy_0v9_param);
        return -OAL_EINVAL;
    }
    ...
    if (ret != OAL_SUCC) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "invalid pcie ldo bias phy 1v8 param =%d mV", g_pcie_ldo_phy_1v8_param);
        return -OAL_EINVAL;
    }
    ...
    value |= (phy_0v9_bias << 8); // 8, bit pos
    value |= (phy_0v9_bias << 12); // 12, bit pos
    oal_writel(value, (pst_pmu_cmu_ctrl + 0x0128));

    /* PCIELDO1V8_CFG0 */
    value = oal_readl(pst_pmu2_cmu_ir_ctrl + 0x0268);
    value &= ~(0xf << 8); // 8, bit pos
    value |= (phy_1v8_bias << 8); // 8, bit pos
    oal_writel(value, (pst_pmu2_cmu_ir_ctrl + 0x0268));

    oal_print_mpxx_log(MPXX_LOG_INFO, "pcieldo0v9 reg=0x%x, pcieldo1v8 reg=0x%x",
...
OAL_STATIC int32_t oal_pcie_print_device_aer_cap_reg(oal_pcie_res *pst_pci_res)
{
    ...
    if (oal_pci_read_config_dword(pst_pci_dev, pos_cap_aer + PCI_ERR_UNCOR_STATUS, &uncor)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "PCI_ERR_UNCOR_STATUS: read fail");
        return -OAL_EFAIL;
    }
    oal_print_mpxx_log(MPXX_LOG_INFO, "PCI_ERR_UNCOR_STATUS: 0x%x", uncor);

    if (oal_pci_read_config_dword(pst_pci_dev, pos_cap_aer + PCI_ERR_COR_STATUS, &cor)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "PCI_ERR_COR_STATUS: read fail");
        return -OAL_EFAIL;
    }
    oal_print_mpxx_log(MPXX_LOG_INFO, "PCI_ERR_COR_STATUS: 0x%x", cor);
...
int32_t oal_pcie_unmask_device_link_erros(oal_pcie_res *pst_pci_res)
{
    ...
    if (oal_pci_read_config_dword(pst_pci_dev, pos_cap_aer + PCI_ERR_UNCOR_MASK, &ucor_mask)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "PCI_ERR_UNCOR_MASK: read fail");
        return -OAL_EFAIL;
    }

    oal_print_mpxx_log(MPXX_LOG_INFO, "PCI_ERR_UNCOR_MASK: 0x%x", ucor_mask);
                                                   ...
                                                   uintptr_t start, unsigned long length, uint8_t test_value)
{
    ...
    if ((length & 0x7) || (start & 0x7)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "length %lu, cpu address 0x%lx is invalid", length, start);
        return -OAL_EFAUL;
    }

    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, start + length - 1, &addr_map);
    if (ret) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "cpu address start:0x%lx + length:0x%lx -1 invalid", start, length);
        return ret;
    }

    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, start, &addr_map);
    if (ret) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "cpu address start:0x%lx", start);
        return ret;
    }

    pst_ddr_buf = oal_memalloc(burst_size);
    if (pst_ddr_buf == NULL) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "alloc mem %u bytes failed", burst_size);
        return -OAL_ENOMEM;
    }
    ...
    offset = 0;
    total_size = 0;
    /* 左移8, 16, 24位组成uint32_t用于后面与uint32_t的值检查比较 */
    ...
    if (total_size != length) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "wrong total_size=%lu ,length=%lu", total_size, length);
        oal_free(pst_ddr_buf);
        return -OAL_EFAIL;
    }
                                                  ...
                                                  uintptr_t start, unsigned long length, uint8_t test_value)
{
    ...
    /* 左移8, 16, 24位组成uint32_t */
    verify = (test_value | (test_value << 8) | (test_value << 16) | (test_value << 24));

    for (i = 0; i < (uint32_t)length; i += sizeof(uint32_t)) { /* 每次偏移4字节 */
        oal_writel(verify, (void *)(uintptr_t)(addr_map.va + i));
        value = oal_readl((void *)(uintptr_t)(addr_map.va + i));
        if (oal_unlikely(verify != value)) {
            oal_print_mpxx_log(MPXX_LOG_ERR, "cpu addr:0x%lx check failed, read=0x%x write=0x%x",
                               (uintptr_t)(start + i), value, verify);
            return -OAL_EFAIL;
        }
    }
    ...
    oal_print_mpxx_log(MPXX_LOG_INFO, "memcheck_byword 0x%lx length %lu, cost %llu us",
...
OAL_STATIC int32_t oal_pcie_device_mem_check(oal_pcie_res *pst_pci_res, uintptr_t start, unsigned long length)
{
    ...
    if (g_ft_pcie_wcpu_mem_check_burst_check) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie_wcpu_mem_check_burst_check_bypass");
    } else {
    ...
    if (g_ft_pcie_wcpu_mem_check_byword_bypass) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie_wcpu_mem_check_byword_bypass");
    } else {
        for (i = 0; i < g_ft_pcie_wcpu_mem_check_times; i++) {
    ...
    oal_print_mpxx_log(MPXX_LOG_INFO, "mem check address: 0x%lx , length: 0x%lx  pass!", start, length);
...
{
    int32_t ret;
    unsigned long i, remain_size, offset, copy_size;
    void *pst_ddr_buf = NULL;
    ...
    if (pst_ddr_buf == NULL) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "alloc mem %lu failed", PAGE_SIZE);
        return -OAL_ENOMEM;
    }
    ...
    oal_print_mpxx_log(MPXX_LOG_INFO, "device_mem_write_address_onetime start:0x%lx length:%lu", start, length);
                                                            ...
                                                            unsigned long length)
{
    ...
    oal_print_mpxx_log(MPXX_LOG_INFO, "device_mem_read_address_onetime start:0x%lx length:%lu", start, length);
                                               ...
                                               unsigned long runtime)
{
    ...
    if (g_ft_pcie_perf_wr_bypass) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie_perf_wr_bypass");
    } else {
        oal_get_time_cost_start(cost);
                                                   ...
                                                   unsigned long length, unsigned long runtime)
{
    ...
    if ((length & 0x7) || (start & 0x7)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "start: %lu , length %lu is invalid", start, length);
        return -OAL_EFAUL;
    }
    ...
    if (pst_buf == NULL) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "alloc perf mem %lu bytes failed", burst_size);
        return -OAL_ENOMEM;
    }
    ...
    ret = oal_pcie_device_check_alive(pst_pci_res);
    if (ret) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "performance write failed!");
        oal_free(pst_buf);
        return ret;
    }

    oal_print_mpxx_log(MPXX_LOG_INFO, "mem performance done");
                                                      ...
                                                      uint32_t *pst_scan_nums)
{
    ...
    *pst_scan_nums = 0;
    if (get_mpxx_subchip_type() == BOARD_VERSION_MP15) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "mp15 %s wmem scan", mpxx_is_asic() ? "asic" : "fpga");
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp15_asic_wmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp15_asic_wmem_scan_array[0][0]));
            *pst_scan_base = g_mp15_asic_wmem_scan_array;
        } else {
            *pst_scan_nums = sizeof(g_mp15_fpga_wmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp15_fpga_wmem_scan_array[0][0]));
            *pst_scan_base = g_mp15_fpga_wmem_scan_array;
        }
    } else if (get_mpxx_subchip_type() == BOARD_VERSION_MP16) {
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp16_asic_wmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp16_asic_wmem_scan_array[0][0]));
            *pst_scan_base = g_mp16_asic_wmem_scan_array;
        }
    } else if (get_mpxx_subchip_type() == BOARD_VERSION_MP16C) {
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp16c_asic_wmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp16c_asic_wmem_scan_array[0][0]));
            *pst_scan_base = g_mp16c_asic_wmem_scan_array;
        }
    } else {
        if (pst_pci_res->revision == PCIE_REVISION_4_70A) {
            ...
            *pst_scan_base = g_pilot_wmem_scan_array;
            ...
            oal_print_mpxx_log(MPXX_LOG_ERR, "unkown pcie ip revision :0x%x", pst_pci_res->revision);
            return -OAL_ENODEV;
        }
    }
...
OAL_STATIC int32_t oal_pcie_device_memcheck_default(oal_pcie_res *pst_pci_res)
{
    ...
    uint32_t scan_nums = 0;
    uintptr_t(*pst_scan_base)[PCIE_MEM_MSG_SIZE] = NULL;
    ...
    for (i = 0; i < scan_nums; i++) {
        oal_print_mpxx_log(MPXX_LOG_DBG, "i:%u, %pK", i, pst_scan_base + i);
        cpu_start = pst_scan_base[i][0];
        cpu_end = pst_scan_base[i][1];
        if (cpu_end <= cpu_start) {
            oal_print_mpxx_log(MPXX_LOG_ERR, "invalid mem region, start=0x%lx, end=0x%lx, i:%d",
                               cpu_start, cpu_end, i);
            return -OAL_EFAUL;
        }
    ...
    oal_get_time_cost_end(cost);
    oal_calc_time_cost_sub(cost);
    oal_print_mpxx_log(MPXX_LOG_INFO, "device wmem done cost %llu us, regions :%u",
...
OAL_STATIC int32_t oal_pcie_device_memcheck_by_address(oal_pcie_res *pst_pci_res)
{
    ...
    if (g_ft_pcie_write_address_bypass) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "wmem write_address_bypass");
    } else {
        oal_get_time_cost_start(cost);
        ...
        oal_get_time_cost_end(cost);
        oal_calc_time_cost_sub(cost);
        oal_print_mpxx_log(MPXX_LOG_INFO, "wmem address check done cost %llu us", time_cost_var_sub(cost));
    }
...
OAL_STATIC int32_t oal_pcie_device_memcheck_perf(oal_pcie_res *pst_pci_res)
{
    ...
    if (g_ft_pcie_perf_wr_bypass) {
        ...
        oal_get_time_cost_end(cost);
        oal_calc_time_cost_sub(cost);
        oal_print_mpxx_log(MPXX_LOG_INFO, "mem performance done cost %llu us", time_cost_var_sub(cost));
    }
...
OAL_STATIC int32_t oal_pcie_device_dereset_bcpu(oal_pcie_res *pst_pci_res)
{
    ...
    if (get_mpxx_subchip_type() == BOARD_VERSION_MP16) {
        bcpu_rst_offset = 0x98;
    } else if (get_mpxx_subchip_type() == BOARD_VERSION_MP16C) {
        bcpu_rst_offset = 0x70;
    }
    oal_writel(0x1, pst_glb_ctrl + bcpu_rst_offset);
    oal_print_mpxx_log(MPXX_LOG_INFO, "bcpu dereset, reg=0x%x", oal_readl(pst_glb_ctrl + bcpu_rst_offset));

    /* bcpu mem解复位需要时间, mp13 32K计数, 230us */
    oal_msleep(sleep_time_ms);

    return OAL_SUCC;
}

OAL_STATIC int32_t oal_pcie_device_dereset_gcpu(oal_pcie_res *pst_pci_res)
{
    int32_t ret;
    pci_addr_map addr_map;
    uint32_t bcpu_rst_offset = 0x9C;
    void *pst_glb_ctrl = NULL; /* 0x50000000 */
    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, 0x40000000, &addr_map);
    if (oal_unlikely(ret != OAL_SUCC)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "can not found mem map for dev cpu address 0x%x\n", 0x40000000);
    ...
    oal_writel(0x1, pst_glb_ctrl + bcpu_rst_offset);
    oal_print_mpxx_log(MPXX_LOG_INFO, "gcpu dereset, reg=0x%x", oal_readl(pst_glb_ctrl + bcpu_rst_offset));

    /* gcpu mem解复位需要时间, MP13 32K计数, 230us */
    oal_msleep(0x2);

    return OAL_SUCC;
}

OAL_STATIC int32_t oal_pcie_device_dereset_gle_gfcpu(oal_pcie_res *pst_pci_res)
{
    int32_t ret;
    pci_addr_map addr_map;
    uint32_t glecpu_rst_offset = 0x78;
    uint32_t gfcpu_rst_offset = 0x74;
    void *pst_glb_ctrl = NULL; /* 0x40000000 */
    ret = oal_pcie_inbound_ca_to_va(pst_pci_res, 0x40000000, &addr_map);
    if (oal_unlikely(ret != OAL_SUCC)) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "can not found mem map for dev cpu address 0x%x\n", 0x40000000);
        return -OAL_EFAIL;
    ...
    oal_writel(0x1, pst_glb_ctrl + glecpu_rst_offset);
    oal_writel(0x1, pst_glb_ctrl + gfcpu_rst_offset);
    oal_print_mpxx_log(MPXX_LOG_INFO, "glecpu dereset, reg=0x%x", oal_readl(pst_glb_ctrl + glecpu_rst_offset));
    oal_print_mpxx_log(MPXX_LOG_INFO, "gfcpu dereset, reg=0x%x", oal_readl(pst_glb_ctrl + gfcpu_rst_offset));
                                                      ...
                                                      uint32_t *pst_scan_nums)
{
    ...
    *pst_scan_nums = 0;
    if (get_mpxx_subchip_type() == BOARD_VERSION_MP15) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "mp15 %s bmem scan", mpxx_is_asic() ? "asic" : "fpga");
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp15_asic_bmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp15_asic_bmem_scan_array[0][0]));
            *pst_scan_base = g_mp15_asic_bmem_scan_array;
        } else {
            oal_print_mpxx_log(MPXX_LOG_INFO, "skip mp15 fpga bmem scan");
            return -OAL_ENOMEM;
        }
    } else if (get_mpxx_subchip_type() == BOARD_VERSION_MP16) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "mp16 %s bmem scan", mpxx_is_asic() ? "asic" : "fpga");
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp16_asic_bmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp16_asic_bmem_scan_array[0][0]));
            *pst_scan_base = g_mp16_asic_bmem_scan_array;
        } else {
            oal_print_mpxx_log(MPXX_LOG_INFO, "skip mp16 fpga bmem scan");
            return -OAL_ENOMEM;
        }
    } else if (get_mpxx_subchip_type() == BOARD_VERSION_MP16C) {
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp16c_asic_bmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp16c_asic_bmem_scan_array[0][0]));
            *pst_scan_base = g_mp16c_asic_bmem_scan_array;
        }
    } else {
        if (pst_pci_res->revision == PCIE_REVISION_4_70A) {
...
OAL_STATIC int32_t oal_pcie_device_get_scan_gmem_info(oal_pcie_res *pst_pci_res, uintptr_t (**pst_scan_base)[],
                                                      uint32_t *pst_scan_nums)
{
    if (get_mpxx_subchip_type() == BOARD_VERSION_MP16) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "mp16 %s gmem scan", mpxx_is_asic() ? "asic" : "fpga");
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp16_asic_gmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp16_asic_gmem_scan_array[0][0]));
            *pst_scan_base = g_mp16_asic_gmem_scan_array;
        } else {
            oal_print_mpxx_log(MPXX_LOG_INFO, "skip mp16 fpga bmem scan");
            return -OAL_ENOMEM;
        }
        ...
        if (mpxx_is_asic()) {
            *pst_scan_nums = sizeof(g_mp16c_asic_gmem_scan_array) /
                             (PCIE_MEM_MSG_SIZE * sizeof(g_mp16c_asic_gmem_scan_array[0][0]));
            *pst_scan_base = g_mp16c_asic_gmem_scan_array;
        }
    } else {
        if (pst_pci_res->revision == PCIE_REVISION_4_70A) {
            *pst_scan_nums = sizeof(g_mpw2_bmem_scan_array) /
...
OAL_STATIC int32_t oal_pcie_device_scan_bmem(oal_pcie_res *pst_pci_res)
{
    ...
    for (i = 0; i < scan_nums; i++) {
        if (pst_scan_base[i][1] <= pst_scan_base[i][0]) {
            oal_print_mpxx_log(MPXX_LOG_ERR, "invalid mem region, start=0x%lx, end=0x%lx, i:%d",
                               pst_scan_base[i][0], pst_scan_base[i][1], i);
            return -OAL_EFAUL;
        }

        mem_len = pst_scan_base[i][1] - pst_scan_base[i][0] + 1;
        ret = oal_pcie_device_mem_check(pst_pci_res, pst_scan_base[i][0], mem_len);
        if (ret) {
            return ret;
        }
    }
    ...
    if (g_ft_pcie_write_address_bypass) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "bmem write_address_bypass");
    } else {
        /* 连续写，连续读，Soc要求写入当前地址的值 */
        for (i = 0; i < scan_nums; i++) {
            mem_len = pst_scan_base[i][1] - pst_scan_base[i][0] + 1;
            ret = oal_pcie_device_mem_write_address_onetime(pst_pci_res, pst_scan_base[i][0], mem_len);
            if (ret) {
                return ret;
            }
        }
        ...
        for (i = 0; i < scan_nums; i++) {
            mem_len = pst_scan_base[i][1] - pst_scan_base[i][0] + 1;
            ret = oal_pcie_device_mem_read_address_onetime(pst_pci_res, pst_scan_base[i][0], mem_len);
            if (ret) {
                return ret;
            }
        }
    ...
    oal_get_time_cost_end(cost);
    oal_calc_time_cost_sub(cost);
    oal_print_mpxx_log(MPXX_LOG_INFO, "bmem done cost %llu us, regions :%u", time_cost_var_sub(cost), scan_nums);

    return OAL_SUCC;
}

OAL_STATIC int32_t oal_pcie_device_scan_gmem(oal_pcie_res *pst_pci_res)
{
    uint32_t i, mem_len;
    uint32_t scan_nums = 0;
    int32_t ret;
    ...
    if (oal_pcie_device_get_scan_gmem_info(pst_pci_res, &pst_scan_base, &scan_nums) != OAL_SUCC) {
        /* bypass */
        return OAL_SUCC;
    }
    ...
    if (get_mpxx_subchip_type() == BOARD_VERSION_MP16C) {
        if (oal_pcie_device_dereset_gle_gfcpu(pst_pci_res) != OAL_SUCC) {
            return -OAL_EFAIL;
        }
    } else {
        if (oal_pcie_device_dereset_gcpu(pst_pci_res) != OAL_SUCC) {
            return -OAL_EFAIL;
        }
    }
    ...
    if (g_ft_pcie_write_address_bypass) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "gmem write_address_bypass");
    } else {
        /* 连续写，连续读，Soc要求写入当前地址的值 */
        for (i = 0; i < scan_nums; i++) {
            mem_len = pst_scan_base[i][1] - pst_scan_base[i][0] + 1;
    ...
    oal_get_time_cost_end(cost);
    oal_calc_time_cost_sub(cost);
    oal_print_mpxx_log(MPXX_LOG_INFO, "gmem done cost %llu us, regions :%u", time_cost_var_sub(cost), scan_nums);
...
int32_t oal_pcie_device_mem_scanall(oal_pcie_res *pst_pci_res)
{
    ...
    oal_print_mpxx_log(MPXX_LOG_INFO, "start scan wmem..");
    ret = oal_pcie_device_scan_wmem(pst_pci_res);
    if (ret) {
        return ret;
    }

    oal_print_mpxx_log(MPXX_LOG_INFO, "start scan bmem..");
    ...
    if (get_mpxx_subchip_type() == BOARD_VERSION_MP16 || get_mpxx_subchip_type() == BOARD_VERSION_MP16C) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "start scan gmem..");
        ret = oal_pcie_device_scan_gmem(pst_pci_res);
        if (ret) {
            return ret;
        }
    }
    oal_print_mpxx_log(MPXX_LOG_INFO, "device_mem_scanall pass");
    return OAL_SUCC;
}
                                           ...
                                           uint32_t data_size)
{
    ...
    if (oal_unlikely(((uintptr_t)ddr_address & 0x3) || (data_size & 0x3))) {
        oal_print_mpxx_log(MPXX_LOG_ERR, "ddr address %lu, length 0x%lx is invalid",
    ...
    for (i = 0; i < (uint32_t)length; i += sizeof(uint32_t)) { /* 每次偏移4字节 */
        value = oal_readl((void *)(uintptr_t)(addr_map.va + i));
        oal_writel(value, (uintptr_t)(ddr_address + i));
    }
...
int32_t oal_pcie_ip_l1pm_check(oal_pcie_linux_res *pst_pci_lres)
{
    ...
    oal_msleep(20); /* wait 20ms, pcie enter L1.2 */

    if (g_ft_pcie_aspm_check_bypass) {
        oal_print_mpxx_log(MPXX_LOG_INFO, "l1pm_check bypass");
        return OAL_SUCC;
    } else {
#ifdef CONFIG_ARCH_KIRIN_PCIE
#if defined(CONFIG_KIRIN_PCIE_HI3660)
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie960 leacy");
        return -OAL_ENODEV;

#elif defined(CONFIG_KIRIN_PCIE_KIRIN970)
        oal_print_mpxx_log(MPXX_LOG_INFO, "pcie970 not implemented");
        return -OAL_ENODEV;
#else
        ...
        if (value == 0xC000) {
            ...
            oal_print_mpxx_log(MPXX_LOG_ERR, "L1.2 check failed");
            return -OAL_EFAIL;
        }
#endif
#else
        oal_print_mpxx_log(MPXX_LOG_ERR, "to be implemented");
        return -OAL_ENODEV;
#endif
    }
}

static int32_t oal_pcie_gen_mode_check(oal_pcie_linux_res *pst_pci_lres)
{
    /* 根据实际产品来判断当前链路状态是否正常 */
...
int32_t oal_pcie_check_device_link_errors(oal_pcie_res *pst_pci_res)
{
    ...
    if (msg_intr_status.bits.soc_pcie_send_f_err_status) {
        /* 链路信号极差 */
        oal_print_mpxx_log(MPXX_LOG_ERR, "f_err found, intr_status=0x%8x", msg_intr_status.as_dword);
        ...
        if (g_ft_pcie_link_err_bypass) {
            oal_print_mpxx_log(MPXX_LOG_INFO, "pcie_link_err_bypass");
            return OAL_SUCC;
        } else {
            return -OAL_EFAIL;
        }
    ...
    if (msg_intr_status.bits.soc_pcie_send_nf_err_status) {
        /* 链路信号差 */
        oal_print_mpxx_log(MPXX_LOG_ERR, "nf_err found, intr_status=0x%8x", msg_intr_status.as_dword);
        oal_pcie_print_device_aer_cap_reg(pst_pci_res);
        /* Clear the int */
        oal_writel(msg_intr_status.as_dword, (pst_pci_res->pst_pci_ctrl_base + PCIE_MSG_INTR_CLR_OFF));
    ...
    if (msg_intr_status.bits.soc_pcie_send_cor_err_status) {
        /* 可忽略的错误 */
        oal_print_mpxx_log(MPXX_LOG_WARN, "cor_err found, intr_status=0x%8x", msg_intr_status.as_dword);
        oal_pcie_print_device_aer_cap_reg(pst_pci_res);
...
int32_t oal_pcie_ip_factory_test_mp13(hcc_bus *pst_bus, int32_t test_count)
{
    int32_t i;
    int32_t ret;
    ...
    oal_msleep(5); /* wait 5ms, pcie enter L1.2 */
...
int32_t oal_pcie_chiptest_init_mp13(oal_pcie_res *pst_pci_res, int32_t device_id)
{
    pst_pci_res->chip_info.cb.pcie_ip_factory_test = oal_pcie_ip_factory_test_mp13;
    return OAL_SUCC;
}
