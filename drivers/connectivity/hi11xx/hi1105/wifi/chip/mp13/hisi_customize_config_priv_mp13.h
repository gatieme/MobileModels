...
#ifndef HISI_CUSTOMIZE_CONFIG_PRIV_MP13_H
#define HISI_CUSTOMIZE_CONFIG_PRIV_MP13_H
...
typedef enum {
    ...
    WLAN_CFG_PRIV_CHBA_DBAC_CHAN_FOLLOW_SWITCH,
    WLAN_CFG_PRIV_5G_FEM_MODE,
    WLAN_CFG_PRIV_BUTT,
} wlan_cfg_priv;
...
#endif  // hisi_customize_config_priv_mp13.h
