    ...
    hmac_asoc_rsp_stru *asoc_rsp)
{
    ...
    memcpy_s(asoc_req_ie_buff, hmac_user->assoc_req_ie_len, (uint8_t *)hmac_user->puc_assoc_req_ie_buff,
...
static uint32_t hmac_handle_copy_asoc_rsp_ie_buff(hmac_vap_stru *hmac_vap, hmac_asoc_rsp_stru *asoc_rsp)
{
    ...
    memcpy_s(assoc_rsp_ie_buff, asoc_rsp->asoc_rsp_ie_len, (uint8_t *)asoc_rsp->puc_asoc_rsp_ie_buff,
    ...
    if (asoc_rsp->asoc_req_ie_len != 0 && asoc_rsp->puc_asoc_req_ie_buff != NULL) {
        ...
        memcpy_s(assoc_req_ie_buff, asoc_rsp->asoc_req_ie_len, (uint8_t *)asoc_rsp->puc_asoc_req_ie_buff,
            asoc_rsp->asoc_req_ie_len);
