...
* 创建日期 : 2020年4月15日
*/
#ifndef MAC_DEVICE_COMMON_H
#define MAC_DEVICE_COMMON_H
...
#define mac_ba_seqno_add(_seq1, _seq2) (((_seq1) + (_seq2)) & DMAC_BA_SEQNO_MASK)
#define mac_ba_seqno_sub(_seq1, _seq2) (((_seq1) - (_seq2)) & DMAC_BA_SEQNO_MASK)
...
OAL_STATIC OAL_INLINE uint8_t wlan_get_center_freq_idx(const mac_channel_stru *pst_channel_info)
{
