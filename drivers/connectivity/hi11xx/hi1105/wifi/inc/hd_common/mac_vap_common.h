 ...
 * 功能说明 : MAC VAP HOST DEVICE事件传递公共部分
 * 作    者 :
 * 创建日期 : 2020年4月15日
 */
#ifndef MAC_VAP_COMMON_H
#define MAC_VAP_COMMON_H
...
typedef uint8_t mac_rate_info_flags_enum_uint8;
...
typedef enum {
    ...
    MAC_LOG_DELAY_RPT,
    MAC_LOG_DEVICE_MEMORY,
} mac_debug_log_type_enum;
typedef enum {
    MAC_TRX_TX_RING_SWITCH,
    MAC_TRX_RING_SWITCH_INDEPENDENT,
    MAC_TRX_HOST_UPDATE_WPTR,
    MAC_TRX_SOFT_IRQ_SCHED,
    MAC_TRX_DEVICE_LOOP_SCHED
} mac_trx_debug_type_enum;
...
typedef enum {
    ...
    ROAM_MAIN_STATE_WAIT_PRK_KEY = 5,
#endif
