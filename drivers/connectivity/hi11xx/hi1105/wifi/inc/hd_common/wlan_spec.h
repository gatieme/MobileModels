...
#include "mp13/wlan_spec_mp13.h"

#include "mp15/wlan_spec_mp15.h"

#include "mp16/wlan_spec_mp16.h"

#include "mp16c_gf61/wlan_spec_mp16c.h"
...
/* 内存 spec 放入平台 */
/* 1.4.7 用户内存池 */
/* 1.4.8 MIB内存池   :最终个子池的空间大小及个数需要重新考虑 */
/* 内存 spec 放入平台 */
/* 1.4.9 netbuf内存池   :最终个子池的空间大小及个数需要重新考虑 */
/* 内存 spec 放入平台 */
...
#define WLAN_AMPDU_RX_BA_LUT_WSIZE   64  /* AMPDU接收端用于填写BA RX LUT表的win size, 大于等于WLAN_AMPDU_RX_BUFFER_SIZE */

#define WLAN_AMPDU_TX_MAX_NUM 64 /* 通用非规格: AMPDU发送端最大聚合子MPDU个数 */
/* MAC RX BA_LUT表共32行 */
...
#define WLAN_FEATURE_UAPSD_ENABLE_CAP       OAL_FALSE
...
/* mib初始化 */
#define HE_BFEE_NTX_SUPP_STS_CAP_EIGHT 8 /* mp15表示最大接收NDP Nsts个数 */
#define HE_BFEE_NTX_SUPP_STS_CAP_FOUR  4 /* mp13表示最大接收NDP Nsts个数 */
...
#define CALI_MP16_MIMO_MASK   (BIT15 | BIT13 | BIT9)
...
#define BIT_OFFSET_56 56
#define BIT_OFFSET_63 63
