 ...
 * 功能说明 : Linux cfgvendor attributes头文件
 * 作    者 : wifi1
 * 创建日期 : 2020年10月16日
 */

#ifndef WAL_LINUX_CFGVENDOR_ATTRIBUTES_H
#define WAL_LINUX_CFGVENDOR_ATTRIBUTES_H
...
enum wal_nan_attributes {
...
#endif
    NAN_ATTRIBUTE_DURATION_CONFIGURE,
    ...
    /* keep last */
    NAN_ATTRIBUTE_LAST,
    NAN_ATTRIBUTE_MAX = NAN_ATTRIBUTE_LAST - 1,
};
#endif
...
enum wal_rtt_attributes {
    ...
    /* keep last */
    RTT_ATTRIBUTE_LAST,
    RTT_ATTRIBUTE_MAX = RTT_ATTRIBUTE_LAST - 1,
};
#endif
...
enum wal_ft_attributes {
    FT_ATTRIBUTE_STATUS_CODE = 1,
    /* keep last */
    FT_ATTRIBUTE_LAST,
    FT_ATTRIBUTE_MAX = FT_ATTRIBUTE_LAST - 1,
};

enum wal_roam_trigger_attributes {
    ROAM_ATTRIBUTE_TRIGGER_TYPE = 1,
    /* keep last */
    ROAM_ATTRIBUTE_LAST,
    ROAM_ATTRIBUTE_MAX = ROAM_ATTRIBUTE_LAST - 1,
};
#endif
