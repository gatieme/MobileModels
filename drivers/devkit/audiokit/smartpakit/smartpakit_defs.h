...
enum smartpakit_soc_platform {
	SMARTPAKIT_SOC_PLATFORM_H = 0, /* self_dev chip */
...
struct smartpakit_info {
	...
	struct self_dev_smartpa_coeff otp[SMARTPAKIT_PA_ID_MAX];
};
