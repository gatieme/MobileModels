...
#if defined(CONFIG_LCD_KIT_FASTBOOT) || defined(MTK_LCD_KIT_SUPPORT)
#ifndef MTK_LCD_KIT_LK2_SUPPORT
#include <types.h>
#endif
#endif
...
enum LCDKIT_GPIO_MODE {
	LCDKIT_GPIO_MODE_GPIO = 0,
	LCDKIT_GPIO_MODE_00 = 0,
	LCDKIT_GPIO_MODE_01 = 1,
	LCDKIT_GPIO_MODE_02 = 2,
	LCDKIT_GPIO_MODE_03 = 3,
	LCDKIT_GPIO_MODE_04 = 4,
	LCDKIT_GPIO_MODE_05 = 5,
	LCDKIT_GPIO_MODE_06 = 6,
	LCDKIT_GPIO_MODE_07 = 7
};

enum LCDKIT_GPIO_DIR {
	LCDKIT_GPIO_DIR_IN = 0,
	LCDKIT_GPIO_DIR_OUT = 1
};

enum LCDKIT_GPIO_PULL_EN {
	LCDKIT_GPIO_PULL_DISABLE = 0,
	LCDKIT_GPIO_PULL_ENABLE = 1,
};

enum LCDKIT_GPIO_PULL_SEL {
	LCDKIT_GPIO_PULL_DOWN = 0,
	LCDKIT_GPIO_PULL_UP = 1,
	LCDKIT_GPIO_NO_PULL = 2
};

enum LCDKIT_GPIO_VAL {
	LCDKIT_GPIO_VAL_ERROR = -1,
	LCDKIT_GPIO_VAL_LOW = 0,
	LCDKIT_GPIO_VAL_HIGH = 1
};
...
struct lcd_kit_power_seq_desc {
	...
	/* lk early(before mipi e.g.) power on sequence */
	struct lcd_kit_arrays_data lk_power_on_early_seq;
};
