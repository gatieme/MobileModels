...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(aw99703_i2c.id, aw99703_i2c.addr, data_buffer, len, len, NULL);
#else
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(aw99703_i2c.id, aw99703_i2c.addr, write_data, len, NULL);
#else
	aw99703_i2c.mode = ST_MODE;
	aw99703_i2c.speed = AW99703_I2C_SPEED;
...
static int aw99703_device_verify(void)
{
	...
	if (aw99703_bl_info.aw99703_hw_en) {
		lcdkit_gpio_set_mode(aw99703_bl_info.aw99703_hw_en_gpio,
			LCDKIT_GPIO_MODE_00);
		lcdkit_gpio_set_dir(aw99703_bl_info.aw99703_hw_en_gpio,
			LCDKIT_GPIO_DIR_OUT);
		lcdkit_gpio_set_out(aw99703_bl_info.aw99703_hw_en_gpio,
...
int aw99703_init(struct mtk_panel_info *pinfo)
{
	...
	if (aw99703_bl_info.aw99703_hw_en) {
		ret = lcd_kit_parse_get_u32_default(DTS_COMP_AW99703,
			AW99703_HW_EN_GPIO,
			(u32 *)&aw99703_bl_info.aw99703_hw_en_gpio, 0);
		if (ret < 0) {
