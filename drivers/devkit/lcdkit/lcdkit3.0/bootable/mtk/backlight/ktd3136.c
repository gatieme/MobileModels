...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(ktd3136_i2c.id, ktd3136_i2c.addr, data_buffer, len, len, NULL);
#else
...
static int ktd3136_i2c_write_u8(unsigned char addr, unsigned char value)
{
	...
	ktd3136_i2c.addr = KTD3136_SLAV_ADDR;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(ktd3136_i2c.id, ktd3136_i2c.addr, write_data, len, NULL);
#else
	ktd3136_i2c.mode = ST_MODE;
	ktd3136_i2c.speed = KTD3136_I2C_SPEED;
...
static int ktd3136_device_verify(void)
{
	...
	if (ktd3136_bl_info.ktd3136_hw_en) {
		lcdkit_gpio_set_mode(ktd3136_bl_info.ktd3136_hw_en_gpio,
			LCDKIT_GPIO_MODE_00);
		lcdkit_gpio_set_dir(ktd3136_bl_info.ktd3136_hw_en_gpio,
			LCDKIT_GPIO_DIR_OUT);
		lcdkit_gpio_set_out(ktd3136_bl_info.ktd3136_hw_en_gpio,
...
int ktd3136_init(struct mtk_panel_info *pinfo)
{
	...
	if (ktd3136_bl_info.ktd3136_hw_en) {
		ret = lcd_kit_parse_get_u32_default(DTS_COMP_KTD3136,
			KTD3136_HW_EN_GPIO,
			(u32 *)&ktd3136_bl_info.ktd3136_hw_en_gpio, 0);
		if (ret < 0) {
