...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(lm36923_i2c.id, lm36923_i2c.addr, data_buffer, len, len, NULL);
#else
...
static int lm36923_i2c_write_u8(unsigned char addr, unsigned char value)
{
	...
	lm36923_i2c.addr = LM36923_SLAV_ADDR;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(lm36923_i2c.id, lm36923_i2c.addr, write_data, len, NULL);
#else
	lm36923_i2c.mode = ST_MODE;
	lm36923_i2c.speed = LM36923_I2C_SPEED;
...
static void lm36923_enable(void)
{
	...
	if (lm36923_bl_info.lm36923_hw_en) {
		lcdkit_gpio_set_mode(lm36923_bl_info.lm36923_hw_en_gpio,
			LCDKIT_GPIO_MODE_00);
		lcdkit_gpio_set_dir(lm36923_bl_info.lm36923_hw_en_gpio,
			LCDKIT_GPIO_DIR_OUT);
		lcdkit_gpio_set_out(lm36923_bl_info.lm36923_hw_en_gpio,
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
void lm36923_set_backlight_status(void *fdt)
#else
...
int lm36923_init(void)
{
	...
	if (lm36923_bl_info.lm36923_hw_en) {
		ret = lcd_kit_parse_get_u32_default(DTS_COMP_LM36923,
			LM36923_HW_EN_GPIO,
			(u32 *)&lm36923_bl_info.lm36923_hw_en_gpio, 0);
		if (ret < 0) {
