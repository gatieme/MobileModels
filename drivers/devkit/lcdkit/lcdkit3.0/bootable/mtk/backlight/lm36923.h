...
#define LM36923_SLAV_ADDR 0x36
#define LM36923_I2C_SPEED 100
...
#define LM36923_REG_LEDS_CONFIG_MASK 0x10
#define LM36923_REG_LEDS_CONFIG_DEFAULT 0x00
...
int lm36923_set_backlight_init(unsigned int bl_level);
#ifdef MTK_LCD_KIT_LK2_SUPPORT
