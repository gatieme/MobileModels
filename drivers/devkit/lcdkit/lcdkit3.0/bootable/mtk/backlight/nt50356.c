...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(nt50356_i2c.id, nt50356_i2c.addr, data_buffer, len, len, NULL);
#else
...
static int nt50356_i2c_write_u8(u8 chip_no, unsigned char addr, unsigned char value)
{
	...
	nt50356_i2c.addr = chip_no;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(nt50356_i2c.id, nt50356_i2c.addr, write_data, len, NULL);
#else
	nt50356_i2c.mode = ST_MODE;
	nt50356_i2c.speed = NT50356_I2C_SPEED;
...
static int nt50356_device_verify(void)
{
	...
	if (nt50356_bl_info.nt50356_hw_en) {
		lcdkit_gpio_set_mode(nt50356_bl_info.nt50356_hw_en_gpio,
			LCDKIT_GPIO_MODE_00);
		lcdkit_gpio_set_dir(nt50356_bl_info.nt50356_hw_en_gpio,
			LCDKIT_GPIO_DIR_OUT);
		lcdkit_gpio_set_out(nt50356_bl_info.nt50356_hw_en_gpio,
...
int nt50356_init(struct mtk_panel_info *pinfo)
{
	...
	if (nt50356_bl_info.nt50356_hw_en) {
		ret = lcd_kit_get_dts_u32_default(nt50356_bl_info.pfdt,
			...
			(u32 *)&nt50356_bl_info.nt50356_hw_en_gpio, 0);
		if (ret < 0) {
