...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(sgm37603a_i2c.id, sgm37603a_i2c.addr, data_buffer, len, len, NULL);
#else
...
static int sgm37603a_i2c_write_u8(unsigned char addr, unsigned char value)
{
	...
	sgm37603a_i2c.addr = SGM37603A_SLAV_ADDR;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(sgm37603a_i2c.id, sgm37603a_i2c.addr, write_data, len, NULL);
#else
	sgm37603a_i2c.mode = ST_MODE;
	sgm37603a_i2c.speed = SGM37603A_I2C_SPEED;
...
static void sgm37603a_enable(void)
{
	...
	if (sgm37603a_bl_info.sgm37603a_hw_en) {
		lcdkit_gpio_set_mode(sgm37603a_bl_info.sgm37603a_hw_en_gpio,
			LCDKIT_GPIO_MODE_00);
		lcdkit_gpio_set_dir(sgm37603a_bl_info.sgm37603a_hw_en_gpio,
			LCDKIT_GPIO_DIR_OUT);
		lcdkit_gpio_set_out(sgm37603a_bl_info.sgm37603a_hw_en_gpio,
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
void sgm37603a_set_backlight_status(void *fdt)
#else
