...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(sm5350_i2c.id, sm5350_i2c.addr, data_buffer, len, len, NULL);
#else
...
static int sm5350_i2c_write_u8(unsigned char addr, unsigned char value)
{
	...
	sm5350_i2c.addr = SM5350_SLAV_ADDR;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(sm5350_i2c.id, sm5350_i2c.addr, write_data, len, NULL);
#else
	sm5350_i2c.mode = ST_MODE;
	sm5350_i2c.speed = SM5350_I2C_SPEED;
...
static int sm5350_device_verify(void)
{
	...
	if (sm5350_bl_info.sm5350_hw_en) {
		lcdkit_gpio_set_mode(sm5350_bl_info.sm5350_hw_en_gpio,
			LCDKIT_GPIO_MODE_00);
		lcdkit_gpio_set_dir(sm5350_bl_info.sm5350_hw_en_gpio,
			LCDKIT_GPIO_DIR_OUT);
		lcdkit_gpio_set_out(sm5350_bl_info.sm5350_hw_en_gpio,
