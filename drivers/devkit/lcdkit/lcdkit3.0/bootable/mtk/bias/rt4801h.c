...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(rt4801h_i2c.id, rt4801h_i2c.addr,
		databuffer, len, len, NULL);
#else
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(rt4801h_i2c.id, rt4801h_i2c.addr,
		write_data, len, NULL);
#else
	rt4801h_i2c.mode = ST_MODE;
	rt4801h_i2c.speed = RT4801H_I2C_SPEED;
