...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(sm5109_i2c.id, sm5109_i2c.addr, databuffer,
		SM5109_CMD_LEN_ONE, SM5109_CMD_LEN_ONE, NULL);
#else
...
static int sm5109_i2c_write_u8(unsigned char addr, unsigned char value)
{
	...
	sm5109_i2c.addr = SM5109_SLAV_ADDR;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(sm5109_i2c.id, sm5109_i2c.addr, write_data, SM5109_CMD_LEN_TWO, NULL);
#else
	sm5109_i2c.mode = ST_MODE;
	sm5109_i2c.speed = SM5109_I2C_SPEED;
