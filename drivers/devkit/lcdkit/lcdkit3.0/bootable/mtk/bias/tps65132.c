...
static int tps65132_i2c_read_u8(unsigned char addr, unsigned char *dataBuffer)
{
	...
	*dataBuffer = addr;
	...
	len = 1;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(tps65132_i2c.id, tps65132_i2c.addr, dataBuffer, len, len, NULL);
#else
...
static int tps65132_i2c_write_u8(unsigned char addr, unsigned char value)
{
	...
	len = 2;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(tps65132_i2c.id, tps65132_i2c.addr, write_data, len, NULL);
#else
	tps65132_i2c.mode = ST_MODE;
	tps65132_i2c.speed = 100;
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
void tps65132_set_bias_status(void *fdt)
#else
...
int tps65132_init(void)
{
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_TPS65132, "ocp2138_support",
		&is_ocp2138_support, 0);
	if ((ret >= 0) && is_ocp2138_support)
		LCD_KIT_INFO("ocp2138 is support!\n");
