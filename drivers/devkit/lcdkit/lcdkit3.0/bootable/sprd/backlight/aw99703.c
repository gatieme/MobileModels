...
static int aw99703_i2c_read_u8(unsigned char addr, unsigned char *data_buffer)
{
	...
	i2c_set_bus_num(aw99703_bl_info.aw99703_i2c_bus_id);
	i2c_init(AW99703_I2C_SPEED, AW99703_SLAV_ADDR);

	ret = i2c_reg_read(AW99703_SLAV_ADDR, addr);
	if (ret < 0) {
...
static int aw99703_i2c_write_u8(unsigned char addr, unsigned char value)
{
	i2c_set_bus_num(aw99703_bl_info.aw99703_i2c_bus_id);
	i2c_init(AW99703_I2C_SPEED, AW99703_SLAV_ADDR);
	i2c_reg_write(AW99703_SLAV_ADDR, addr, value);
...
static int aw99703_device_verify(void)
{
	...
	if (aw99703_bl_info.aw99703_hw_en) {
		sprd_gpio_request(NULL, aw99703_bl_info.aw99703_hw_en_gpio);
		sprd_gpio_direction_output(NULL, aw99703_bl_info.aw99703_hw_en_gpio,
			GPIO_OUT_ONE);
