...
#define AW99703_SLAV_ADDR 0x36
#define AW99703_I2C_SPEED 100000
...
#define AW99703_HW_EN_DELAY "bl_on_lk_mdelay"
#define AW99703_BL_LEVEL "bl_level"
#define AW99703_MODE "aw99703_reg_mode"

#define AW99703_WRITE_LEN 2
#define AW99703_BL_DEFAULT_LEVEL 255
#define AW99703_BL_MAX 2047

/* base reg */
#define AW99703_REG_DEV_ID 0x00
#define AW99703_REG_SW_RESET 0x01
...
#define AW99703_RW_REG_MAX 19
#define AW99703_REG_MODE_DELAY 7

#define AW99703_CHIP_ID 0x03

/* backlight */
#define AW99703_BL_LSB_MASK 0x07
#define AW99703_BL_MSB_MASK 0xFF
#define AW99703_BL_LSB_LEN 3


struct aw99703_backlight_information {
	/* whether support aw99703 or not */
	unsigned int aw99703_support;
	/* which i2c bus controller aw99703 mount */
	unsigned int aw99703_i2c_bus_id;
	unsigned int aw99703_hw_en;
	/* aw99703 hw_en gpio */
	unsigned int aw99703_hw_en_gpio;
	unsigned int aw99703_reg[AW99703_RW_REG_MAX];
	unsigned int bl_on_lk_mdelay;
	unsigned int bl_level;
};
void aw99703_set_backlight_status(void *fdt);
int aw99703_init(struct sprd_panel_info *pinfo);
#endif
