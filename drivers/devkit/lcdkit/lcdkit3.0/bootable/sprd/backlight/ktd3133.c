...
#define KTD3133_I2C_SPEED 100000
...
static int ktd3133_i2c_read_u8(unsigned char addr, unsigned char *dataBuffer)
{
	...
	i2c_set_bus_num(ktd3133_bl_info.ktd3133_i2c_bus_id);
	i2c_init(KTD3133_I2C_SPEED, KTD3133_SLAV_ADDR);

	ret = i2c_reg_read(KTD3133_SLAV_ADDR, addr);
	if (ret < 0) {
...
static int ktd3133_i2c_write_u8(unsigned char addr, unsigned char value)
{
	i2c_set_bus_num(ktd3133_bl_info.ktd3133_i2c_bus_id);
	i2c_init(KTD3133_I2C_SPEED, KTD3133_SLAV_ADDR);
	i2c_reg_write(KTD3133_SLAV_ADDR, addr, value);
...
static void ktd3133_enable(void)
{
	...
	if (ktd3133_bl_info.ktd3133_hw_en) {
		sprd_gpio_request(NULL, ktd3133_bl_info.ktd3133_hw_en_gpio);
		sprd_gpio_direction_output(NULL, ktd3133_bl_info.ktd3133_hw_en_gpio,
			GPIO_OUT_ONE);
