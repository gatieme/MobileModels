...
static int lm36923_i2c_read_u8(unsigned char addr, unsigned char *data_buffer)
{
	...
	i2c_set_bus_num(lm36923_bl_info.lm36923_i2c_bus_id);
	i2c_init(LM36923_I2C_SPEED, LM36923_SLAV_ADDR);
	ret = i2c_reg_read(LM36923_SLAV_ADDR, addr);
	if (ret < 0) {
...
static int lm36923_i2c_write_u8(unsigned char addr, unsigned char value)
{
	i2c_set_bus_num(lm36923_bl_info.lm36923_i2c_bus_id);
	i2c_init(LM36923_I2C_SPEED, LM36923_SLAV_ADDR);
	i2c_reg_write(LM36923_SLAV_ADDR, addr, value);
...
static void lm36923_enable(void)
{
	...
	if (lm36923_bl_info.lm36923_hw_en) {
		sprd_gpio_request(NULL, lm36923_bl_info.lm36923_hw_en_gpio);
		sprd_gpio_direction_output(NULL, lm36923_bl_info.lm36923_hw_en_gpio,
			GPIO_OUT_ONE);
