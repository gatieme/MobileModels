...
static int lm3697_i2c_read_u8(unsigned char addr, unsigned char *dataBuffer)
{
	...
	i2c_set_bus_num(lm3697_bl_info.lm3697_i2c_bus_id);
	i2c_init(LM3697_I2C_SPEED, LM3697_SLAV_ADDR);

	ret = i2c_reg_read(LM3697_SLAV_ADDR, addr);
	if (ret < 0) {
...
static int lm3697_i2c_write_u8(unsigned char addr, unsigned char value)
{
	i2c_set_bus_num(lm3697_bl_info.lm3697_i2c_bus_id);
	i2c_init(LM3697_I2C_SPEED, LM3697_SLAV_ADDR);
	i2c_reg_write(LM3697_SLAV_ADDR, addr, value);
...
static void lm3697_enable(void)
{
	...
	if (lm3697_bl_info.lm3697_hw_en) {
		sprd_gpio_request(NULL, lm3697_bl_info.lm3697_hw_en_gpio);
		sprd_gpio_direction_output(NULL, lm3697_bl_info.lm3697_hw_en_gpio,
			GPIO_OUT_ONE);
