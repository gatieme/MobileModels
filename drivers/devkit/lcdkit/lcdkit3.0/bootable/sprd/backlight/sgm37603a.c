...
static int sgm37603a_i2c_read_u8(unsigned char addr, unsigned char *data_buffer)
{
	...
	i2c_set_bus_num(sgm37603a_bl_info.sgm37603a_i2c_bus_id);
	i2c_init(SGM37603A_I2C_SPEED, SGM37603A_SLAV_ADDR);
	ret = i2c_reg_read(SGM37603A_SLAV_ADDR, addr);
	if (ret < 0) {
...
static int sgm37603a_i2c_write_u8(unsigned char addr, unsigned char value)
{
	i2c_set_bus_num(sgm37603a_bl_info.sgm37603a_i2c_bus_id);
	i2c_init(SGM37603A_I2C_SPEED, SGM37603A_SLAV_ADDR);
	i2c_reg_write(SGM37603A_SLAV_ADDR, addr, value);
...
static void sgm37603a_enable(void)
{
	...
	if (sgm37603a_bl_info.sgm37603a_hw_en) {
		sprd_gpio_request(NULL, sgm37603a_bl_info.sgm37603a_hw_en_gpio);
		sprd_gpio_direction_output(NULL, sgm37603a_bl_info.sgm37603a_hw_en_gpio,
			GPIO_OUT_ONE);
