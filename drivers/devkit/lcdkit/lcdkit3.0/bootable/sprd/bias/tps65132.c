...
#define TPS65132_I2C_SPEED 100000
...
static int tps65132_i2c_read_u8(unsigned char addr, unsigned char *dataBuffer)
{
	...
	i2c_init(TPS65132_I2C_SPEED, TPS65132_SLAV_ADDR);

	ret = i2c_reg_read(TPS65132_SLAV_ADDR, addr);
	if (ret < 0) {
...
static int tps65132_i2c_write_u8(unsigned char addr, unsigned char value)
{
	i2c_set_bus_num(i2c_bus_id);
	i2c_init(TPS65132_I2C_SPEED, TPS65132_SLAV_ADDR);
	i2c_reg_write(TPS65132_SLAV_ADDR, addr, value);
