...
extern void ud_fp_display_register(struct ud_fp_display_ops *fp_display_ops);
extern void ud_fp_dispaly_unregister(void);
extern void ud_fp_notify_lhbm_interrupted_by_power(void);
...
void display_engine_brightness_set_alpha_bypass(bool is_bypass, uint32_t panel_id);
int display_engine_brightness_get_mapped_level(int in_level, uint32_t panel_id);
int display_engine_brightness_get_mapped_alpha(uint32_t panel_id);
/* Handle vblank interrupt */
void display_engine_brightness_handle_vblank(ktime_t te_timestamp, uint32_t panel_id);
void display_engine_brightness_handle_mode_change(uint32_t panel_id);
...
uint32_t display_engine_brightness_get_mipi_level(uint32_t panel_id);
uint32_t display_engine_brightness_get_mode_in_use(uint32_t panel_id);
