...
struct lcd_kit_esd {
	...
	u32 gpio_detect_num2;
	u32 gpio_normal_value2;
};
...
struct lcd_kit_panel_on_dual_dsi {
	u32 support;
	struct lcd_kit_dsi_panel_cmds dsi1_cmds;
	struct lcd_kit_dsi_panel_cmds dsi2_cmds;
};
...
struct lcd_kit_common_info {
	...
	/* Main&Duty dsi1&dsi2 IC*/
	struct lcd_kit_panel_on_dual_dsi panel_on_dual_dsi;
	/* end */
};
...
struct lcd_kit_power_desc {
	...
	struct lcd_kit_array_data lcd_bridge_rst;
	struct lcd_kit_array_data lcd_bridge_vdd;
};
