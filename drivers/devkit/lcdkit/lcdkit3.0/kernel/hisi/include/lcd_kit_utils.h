...
#define MAX_MIPI_ERR_READ_COUNT   20
#define PANEL_DIEID_DATA_SIZE_MAX 500

#ifdef CONFIG_DPU_FB_V346
#define DTS_HIM_PATH "/reserved-memory/him-mem"
static u32 g_reserved_him_base;
static u32 g_reserved_him_size;
#endif
...
struct lcd_kit_fps {
	...
	struct lcd_kit_dsi_panel_cmds fps_to_1_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_10_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_15_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_18_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_20_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_24_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_30_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_40_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_45_cmds_90hz;
	struct lcd_kit_dsi_panel_cmds fps_to_60_cmds_90hz;
...
struct lcd_kit_alpm {
	...
	struct lcd_kit_dsi_panel_cmds close_te_cmds;
	struct lcd_kit_dsi_panel_cmds open_te_cmds;
};
...
struct dbv_stat_desc {
	...
	struct timespec64 last_time[REGION_MAX];
	struct timespec64 pwon_last_time[REGION_MAX];
	struct timespec64 hbm_last_time[REGION_MAX];
	struct timespec64 hbmon_last_time[REGION_MAX];
};
...
struct local_hbm_enable_alpha_dbv {
	uint32_t enable;
	uint32_t alpha;
	uint32_t dbv;
};
...
struct local_hbm {
	...
	union {
		...
		struct local_hbm_enable_alpha_dbv enable_alpha_dbv;
	};
};
...
struct lcd_kit_transmission  {
	u32 separate_support;
	/* separate transmission status flag */
	u32 separate_status_flag;
};
