...
if(scalar @ARGV < ($xml_file_num + $paranum))
{
    ...
    error_print("1-chip platform(honor or qcom)\n");
...
my @panel_info_attrs = (
    ...
    ["/hwlcd/PanelEntry/PanelIfbcVesa3xSet",       "-n",    "",                   '-w', 0  ],
    ["panel_name",                                 "-n",
     "\"/"."lcdkit_" . lc($panel_file_name) . "\"",                               '-w', '' ],
    ...
    ["/hwlcd/PanelEntry/BlWorkDelayFrame",         "-n",    "",                   '-w', 0  ]);

    if ($target_file_type eq "dto-head")
    {
        for ($count = 0; $count < @panel_info_attrs; $count++)  {
            if ($panel_info_attrs[$count][0] eq "panel_name")
            {
                $panel_info_attrs[$count][2] = "\"/honor,lcd_config/"."lcdkit_" . lc($panel_file_name) . "\"";
            }
        }
    }
...
my @honor_on_cmd_paras = ("hwlcd/PanelEntry/PanelOnCommand", $panel_file_name."_on_cmds");
my @honor_on_second_cmd_paras = ("hwlcd/PanelEntry/PanelOnSecondCommand", $panel_file_name."_on_second_cmds");
my @honor_display_on_in_backlight_cmd_paras = ("hwlcd/PanelEntry/PanelDisplayOnCommand", $panel_file_name."_display_on_in_backlight_cmds");
my @honor_off_cmd_paras = ("hwlcd/PanelEntry/PanelOffCommand", $panel_file_name."_off_cmds");
my @honor_off_second_cmd_paras = ("hwlcd/PanelEntry/PanelOffSecondCommand", $panel_file_name."_off_second_cmds");
my @honor_tp_color_cmd_paras = ("hwlcd/PanelEntry/PanelTpColorCommand", $panel_file_name."_tp_color_cmds");
my @honor_lcd_protectoffpagea_cmd_paras = ("hwlcd/PanelEntry/PanelOemProtectOffPageACommand", $panel_file_name."_lcd_oemprotectoffpagea_cmds");
my @honor_lcd_oemreadfirstpart_paras = ("hwlcd/PanelEntry/PanelOemReadFirstPartCommand", $panel_file_name."_lcd_oemreadfirstpart_cmds");
my @honor_lcd_protectoffpageb_cmd_paras = ("hwlcd/PanelEntry/PanelOemProtectOffPageBCommand", $panel_file_name."_lcd_oemprotectoffpageb_cmds");
my @honor_lcd_oemreadsecondpart_paras = ("hwlcd/PanelEntry/PanelOemReadSecondPartCommand", $panel_file_name."_lcd_oemreadsecondpart_cmds");
my @honor_lcd_backtousercmd_paras = ("hwlcd/PanelEntry/PanelOemBackToUserCommand", $panel_file_name."_lcd_oembacktouser_cmds");
my @honor_id_pin_check_cmd_paras = ("hwlcd/PanelEntry/PanelIdPinCheckCommand", $panel_file_name."_id_pin_check_cmds");
my @honor_display_on_effect_cmd_paras = ("hwlcd/PanelEntry/PanelDisplayOnEffectCommand", $panel_file_name."_display_on_effect_cmds");
my @honor_color_coordinate_enter_cmd_paras = ("hwlcd/PanelEntry/PanelColorCoordinateEnterCommand", $panel_file_name."_color_coordinate_enter_cmds");
my @honor_color_coordinat_cmd_paras = ("hwlcd/PanelEntry/PanelColorCoordinateCommand", $panel_file_name."_color_coordinate_cmds");
my @honor_color_coordinat_exit_cmd_paras = ("hwlcd/PanelEntry/PanelColorCoordinateExitCommand", $panel_file_name."_color_coordinate_exit_cmds");
my @honor_panel_info_consistency_enter_cmd_paras = ("hwlcd/PanelEntry/PanelConsistencyInfoEnterCommand", $panel_file_name."_panel_info_consistency_enter_cmds");
my @honor_panel_info_consistency_cmd_paras = ("hwlcd/PanelEntry/PanelConsistencyInfoCommand", $panel_file_name."_panel_info_consistency_cmds");
my @honor_panel_info_consistency_exit_cmd_paras = ("hwlcd/PanelEntry/PanelConsistencyInfoExitCommand", $panel_file_name."_panel_info_consistency_exit_cmds");
my @honor_backlight_cmd_paras = ("hwlcd/PanelEntry/PanelBacklightCommand", $panel_file_name."_backlight_cmds");
...
#        ''                                                                                ],
        ...
        ['honor',      "Panel Information",                  \&hfile_section_header,
         ''                                                                                ],
        ['honor',      \@panel_info_attrs,                   \&create_data_struct,
         'static struct lcdkit_panel_info ' . $panel_file_name. '_panel_info '             ],
        ['honor',      "Ldi Information",                    \&hfile_section_header,
         ''                                                                                ],
        ['honor',      \@panel_ldi_attrs,                    \&create_data_struct,
         'static struct lcdkit_panel_ldi ' . $panel_file_name. '_panel_ldi '               ],
        ['honor',      "Mipi Information",                   \&hfile_section_header,
         ''                                                                                ],
        ['honor',      \@panel_mipi_attrs,                   \&create_data_struct,
         'static struct lcdkit_panel_mipi ' . $panel_file_name. '_panel_mipi '             ],
        ['honor',      "platform Config",                    \&hfile_section_header,
         ''                                                                                ],
        ['honor',      \@panel_platcfg_attrs,                \&create_data_struct,
         'static struct lcdkit_platform_config ' . $panel_file_name. '_panel_platform_config '    ],
        ['honor',      "misc Information",                   \&hfile_section_header,
         ''                                                                                ],
        ['honor',      \@panel_misc_attrs,                   \&create_data_struct,
         'static struct lcdkit_misc_info ' . $panel_file_name. '_panel_misc_info '         ],

        ['honor',      "delay ctrl",                         \&hfile_section_header,
         ''                                                                                ],
        ['honor',      \@panel_delayctl_attrs,               \&create_data_struct,
         'static struct lcdkit_delay_ctrl ' . $panel_file_name. '_panel_delay_ctrl '       ],
        ['honor',      "on/off cmd information",             \&hfile_section_header,
         ''                                                                                ],
        ['honor',      \@honor_on_cmd_paras,                  \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_on_second_cmd_paras,                  \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_display_on_in_backlight_cmd_paras,    \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_display_on_effect_cmd_paras,    \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_off_cmd_paras,                 \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_off_second_cmd_paras,          \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_tp_color_cmd_paras,            \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_lcd_protectoffpagea_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_lcd_oemreadfirstpart_paras,    \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_lcd_protectoffpageb_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_lcd_oemreadsecondpart_paras,    \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_lcd_backtousercmd_paras,         \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_id_pin_check_cmd_paras,        \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_color_coordinate_enter_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_color_coordinat_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_color_coordinat_exit_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_panel_info_consistency_enter_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_panel_info_consistency_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_panel_info_consistency_exit_cmd_paras, \&honor_cmd_struct_grp,
         ''                                                                                ],
        ['honor',      \@honor_backlight_cmd_paras,                  \&honor_cmd_struct_grp,
         ''                                                                                ]);
