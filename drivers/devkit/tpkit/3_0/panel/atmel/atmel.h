...
#define RETRY_TEST_TIME 3
#define ATMEL_VENDER_NAME		 "atmel"
#define MAX_TIMEOUT_TIMES 50
#define MAX_BUF_SIZE 50
#define MXT_CACHE_READ_LEN	2
#define MXT_XFER_TWO_MSG	2
#define MXT_BOOTLOADER_CMD_LEN		2
#define MXT_RETRY_ROICMD_TIME	5
#define MXT_OBJ_BUF_SIZE 		256
#define MXT_GET_ONE_PARA	1
#define MXT_CRCPOLY 		0x80001B
#define MXT_CRC_CHECK 		0x1000000
#define MXT_WRITE_BIT_LEN	8
#define MXT_FAMILY_ID		0xa2
#define MXT_MXT224_FAMILY_ID	0x80
#define MXT_VALID_DEVICE_CTRL	2
#define MXT_T19_BASE_VALUE 		7
#define MXT_T19_THIRD_VALUE		60
#define MXT_MIN_CODEID			32
#define MXT_MAX_CODEID			126
#define MXT_MAX_FRAMESIZE		65535
...
#define MXT_POWER_CFG_DOZE			2
#define MAX_FILE_NAME_LENGTH 128
#define MAX_RAWDATA_SIZE 1024

#define LCD_PANEL_INFO_MAX_LEN  128
#define LCD_PANEL_TYPE_DEVICE_NODE_NAME     "honor,lcd_panel_type"
...
/* Define for MXT_SELF_TEST_COMMAND_T25 */
#define MXT_SELF_TEST_RUN_NONE		0x00
#define MXT_SELF_TEST_AVDD_POWER	0x01
#define MXT_SELF_TEST_PIN_FAULT		0x12
#define MXT_SELF_TEST_SINGAL_LIMIT	0x17
#define MXT_SELF_TEST_RUN_ALL		0x25

/* Define for MXT_PROCI_TOUCHSUPPRESSION_T42 */
#define MXT_T42_MSG_TCHSUP	(1 << 0)

/* Define for MXT_T46 */
#define MXT_T46_CONTROL_BIT		0

/* Define for MXT_NORMAL_REF_MODE */
#define MXT_NORMAL_REF_MODE		8
...
#define MXT_T100_GAIN		28

#define MXT_T100_XSIZE		9
#define MXT_T100_YSIZE		20
#define MXT_T100_XORIGIN		8
#define MXT_T100_YORIGIN		19
#define MXT_T100_NORMAL_GAIN_VALUE		12
...
#define MXT_T100_TCHAUX_EDGE			(1 << 6)
...
extern int atmel_gMxtT6Cmd58Flag;
#endif
...
struct mxt_data {
	struct device *dev;
	struct platform_device *atmel_dev;
	...
	int sleep_mode;
	int *rawdata_up_limit_buf;
	int *rawdata_low_limit_buf;
	int *rawdata_tx2tx_up_limit_buf;
	int *rawdata_tx2tx_low_limit_buf;
	int *rawdata_rx2rx_up_limit_buf;
	int *rawdata_rx2rx_low_limit_buf;
	int *noise_up_limit_buf;
...
int __atmel_write_reg(struct mxt_data *data, u16 reg, u16 len,
			   const void *val);
...
int atmel_update_file_name(struct mxt_data *data, char **file_name);
...
int atmel_t6_command(struct mxt_data *data, u16 cmd_offset, u8 value,
			  bool wait);
int atmel_probe_info_block(struct mxt_data *data);
int atmel_bootloader_read(struct mxt_data *data, u8 *val,
			       unsigned int count);
...
int atmel_get_deltas_data_test(struct mxt_data *data, int data_uplimit,
				int data_lowlimit);
int atmel_get_refs_data_test(struct mxt_data *data, int data_uplimit,
			      int data_lowlimit);
