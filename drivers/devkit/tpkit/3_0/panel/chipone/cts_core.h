...
enum cts_device_fw_reg {
	...
	CTS_DEVICE_FW_REG_NOI_DATA = 0x1080,
...
enum cts_firmware_cmd {
	...
	CTS_CMD_ENABLE_NOI = 0x92,
	CTS_CMD_DISABLE_NOI = 0x93,
...
struct chipone_ts_data {
	...
	bool test_compensate_cap;
	int  comp_cap_test_result;
	int  compensate_cap_test_min;
	int  compensate_cap_test_max;
