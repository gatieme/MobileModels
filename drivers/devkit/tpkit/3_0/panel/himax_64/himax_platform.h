...
void himax_nc_register_read(uint8_t *read_addr,
	int read_length, uint8_t *read_data);
void himax_flash_write_burst(uint8_t *reg_byte,
	uint8_t *write_data, size_t cnta, size_t cntb);
void himax_burst_enable(uint8_t auto_add_4_byte);
int himax_nc_write_read_reg(uint8_t *tmp_addr,
	uint8_t *tmp_data, uint8_t hb, uint8_t lb);
int i2c_himax_nc_read(uint8_t command, uint8_t *data,
	uint16_t length, uint16_t limit_len, uint8_t toRetry);
int i2c_himax_nc_write(uint8_t command, uint8_t *data,
	uint16_t length, uint16_t limit_len, uint8_t toRetry);
#endif
