...
#define ILITEK_MAX_STR_HEX_LEN 1024
...
#define ILI9881N_CHIP 0x988117
#define ILI9881O_CHIP 0x988118
#define ILI7807Q_CHIP 0x78071A
#define ILI7807S_CHIP 0x78071C
...
int ili_reset_ctrl_test(int low, int high);
