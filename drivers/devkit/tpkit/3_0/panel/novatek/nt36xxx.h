...
#define NOVATEK_TAG ((sizeof(__func__) > sizeof("novatek")) ? \
	(__func__ + sizeof("novatek")) : \
	__func__)

#define NVT_TAG ((sizeof(__func__) > sizeof("nvt")) ? \
	(__func__ + sizeof("nvt")) : \
	__func__)
...
#define NVT_TANSFER_LEN_64KB		(PAGE_SIZE << 4)
...
#define NVT_DOZE_MODE_CMD 0x7B
#define NVT_GAME_MODE_CMD 0x7C
