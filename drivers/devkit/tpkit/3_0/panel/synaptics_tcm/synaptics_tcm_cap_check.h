...
#define CSV_SELF_CAP_RAW_DATA_COL_MIN_ARRAY "threshold,self_cap_raw_data_col_min_array"
#define CSV_SELF_CAP_RAW_DATA_COL_MAX_ARRAY "threshold,self_cap_raw_data_col_max_array"
#define CSV_SELF_CAP_RAW_DATA_ROW_MIN_ARRAY "threshold,self_cap_raw_data_row_min_array"
#define CSV_SELF_CAP_RAW_DATA_ROW_MAX_ARRAY "threshold,self_cap_raw_data_row_max_array"
...
#define CSV_RAW_DATA_ROW_DELTA_MAX_ARRAY "threshold,raw_data_row_delta_max_array"
#define CSV_RAW_DATA_COL_DELTA_MAX_ARRAY "threshold,raw_data_col_delta_max_array"
...
struct syna_tcm_test_threshold {
	...
	int32_t self_cap_raw_data_col_min_limits[TX_NUM_MAX];
	int32_t self_cap_raw_data_col_max_limits[TX_NUM_MAX];
	int32_t self_cap_raw_data_row_min_limits[RX_NUM_MAX];
	int32_t self_cap_raw_data_row_max_limits[RX_NUM_MAX];
	...
	int32_t raw_data_row_delta_max_limits[TX_NUM_MAX * RX_NUM_MAX];
	int32_t raw_data_col_delta_max_limits[TX_NUM_MAX * RX_NUM_MAX];
