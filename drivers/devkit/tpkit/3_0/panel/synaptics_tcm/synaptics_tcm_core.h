...
#define RD_CHUNK_SIZE_SPI 0 /* read length limit in bytes, 0 = unlimited */
...
#define UBOOT_LEN 6
#define IDENTIFY_INFO_LEN 30
#define TMP_BUFFER_LEN 64
#define FIXED_READ_LENGTH 350
...
enum cmd_c7_sub_cmd {
	C7_SUB_CMD_HBP_FP_EVENT_SWITCH = 0x4c,
};
...
struct syna_tcm_hcd {
	...
	unsigned int syna_lowpower_mode;
