...
/*
 * parse honor_bootmode cmdline which is passed from lk
 * Format :  androidboot.honor_bootmode = recovery
 */
...
early_param("androidboot.honor_bootmode", early_parse_enterrecovery_cmdline);
#endif*/
...
/*
 * parse honor_chrager cmdline which is passed from lk
