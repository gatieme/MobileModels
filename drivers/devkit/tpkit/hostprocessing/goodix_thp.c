...
static void touch_driver_set_stylus3_link_info(bool delay_enable,
	bool link_enable, u8 **connect_cmd, u8 *connect_value)
{
	if (delay_enable)
	...
	bool delay_enable)
{
	...
	touch_driver_set_stylus3_link_info(delay_enable, scan_status,
