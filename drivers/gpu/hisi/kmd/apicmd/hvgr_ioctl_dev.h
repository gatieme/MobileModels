...
#define HVGR_IOCTL_CMD_GET_INFO        0
#define HVGR_IOCTL_CMD_DRV_CFG         1
#define HVGR_IOCTL_CMD_CREATE_SOFTQ    2
#define HVGR_IOCTL_CMD_SOFTQ_ENQUEUE   3
#define HVGR_IOCTL_CMD_GET_TIMESTAMP   4
#define HVGR_IOCTL_CMD_DRV_DECFG       5
#define HVGR_IOCTL_CMD_GET_MSB         6
