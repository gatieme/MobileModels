...
#define HVGR_PM       ((uint32_t)1 << 0)
#define HVGR_DM       ((uint32_t)1 << 1)
#define HVGR_MEM      ((uint32_t)1 << 2)
#define HVGR_CQ       ((uint32_t)1 << 3)
#define HVGR_DATAN    ((uint32_t)1 << 4)
#define HVGR_SCH      ((uint32_t)1 << 5)
#define HVGR_SYNC     ((uint32_t)1 << 6)
#if defined(HVGR_SUPPORT_SPEC_LOW) && HVGR_SUPPORT_SPEC_LOW != 0
#define HVGR_SPEC_LOW ((uint32_t)1 << 7)
#endif
#define HVGR_FENCE    ((uint32_t)1 << 8)
