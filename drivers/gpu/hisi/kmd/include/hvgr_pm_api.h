...
#define HVGR_THRO_HIGH     (0) /* Queue is run in high freq. */
#define HVGR_THRO_MEDIUM   (1) /* Queue is run in med freq: auto dvfs freq. */
#define HVGR_THRO_LOW      (2) /* Queue is run in low freq. */
#define HVGR_THRO_NORMAL   (3) /* Queue is not cl job. */
#define HVGR_THRO_EMPTY    (4) /* Queue is empty, but not unbind. */
#define HVGR_THRO_IDLE     (5) /* Queue is idle, unbinded. */
 ...
 *
 * @param gdev - The gdev object pointer.
 * @term_step - Term step, For details see hvgr_pm_term_step.
 *
 * @date - 2021-02-03
 */
