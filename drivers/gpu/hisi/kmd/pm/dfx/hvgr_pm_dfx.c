...
ssize_t hvgr_pm_show_statistics(void *data, char * const buf)
{
	...
	ret += scnprintf(buf + ret, PAGE_SIZE - ret,
		...
		avage_buck_on_time / 1000, avage_buck_off_time / 1000,
		pm_dfx->pm_buck_on_max_time / 1000,
		pm_dfx->pm_buck_off_max_time / 1000,
		pm_dfx->pm_buck_on_min_time / 1000,
		pm_dfx->pm_buck_off_min_time / 1000);

	ret += scnprintf(buf + ret, PAGE_SIZE - ret,
		"core:\t %8d   %8d           %8lu            %8lu         %8lu          %8lu         %8lu          %8lu\n",
		pm_dfx->pm_core_on_times, pm_dfx->pm_core_off_times,
		avage_core_on_time / 1000, avage_core_off_time / 1000,
		pm_dfx->pm_core_on_max_time / 1000,
		pm_dfx->pm_core_off_max_time / 1000,
		pm_dfx->pm_core_on_min_time / 1000,
		pm_dfx->pm_core_off_min_time / 1000);

	ret += scnprintf(buf + ret, PAGE_SIZE - ret,
		"gpu:\t %8d   %8d           %8lu            %8lu         %8lu          %8lu         %8lu          %8lu\n",
		pm_dfx->pm_gpu_on_times, pm_dfx->pm_gpu_off_times,
		avage_gpu_on_time / 1000, avage_gpu_off_time / 1000,
		pm_dfx->pm_gpu_on_max_time / 1000,
		pm_dfx->pm_gpu_off_max_time / 1000,
		pm_dfx->pm_gpu_on_min_time / 1000,
		pm_dfx->pm_gpu_off_min_time / 1000);
