...
als_para_normal_table ltr2568_als_para_diff_tp_color_table[] = {
	...
	{ TETON, V3, TS_PANEL_UNKNOWN, LTR2568_PARA_SIZE,
	  { 280, 100, 2500, 3050, 2850, 0, 2917, 2639, 4000, 250 }
	},
};
...
als_para_normal_table ltr311_als_para[] = {
	...
	{ LNA, V3, TS_PANEL_UNKNOWN, LTR311_PARA_SIZE,
	  { 20, 800, 1400, 187, 153, 106, 20, 31967, 117, 4000, 250, 0, 0 }
	},
	{ BLK, V3, BOE_TPLCD, LTR311_PARA_SIZE,
	  { 31, 41, 100, 210, 208, 198, 173, 28105, 108, 4000, 250, 0, 0 }
	},
	{ BLK, V3, VISI_TPLCD, LTR311_PARA_SIZE,
	  { 21, 45, 75, 210, 200, 207, 185, 28105, 108, 4000, 250, 0, 0 }
	},
	{ BLK, V3, CSOT_TPLCD, LTR311_PARA_SIZE,
	  { 20, 45, 73, 269, 266, 250, 215, 28105, 108, 4000, 250, 0, 0 }
	},
	{ BLK, V3, TS_PANEL_UNKNOWN, LTR311_PARA_SIZE,
	  { 20, 45, 80, 299, 276, 260, 225, 28105, 108, 4000, 250, 0, 0 }
	},
	{ ADA, V3, BOE_TPLCD, LTR311_PARA_SIZE,
	  { 20, 45, 85, 371, 359, 328, 291, 20830, 90, 4000, 250, 0, 0 }
	},
	{ ADA, V3, CSOT_TPLCD, LTR311_PARA_SIZE,
	  { 20, 45, 80, 285, 287, 272, 249, 20830, 90, 4000, 250, 0, 0 }
	},
	{ ADA, V3, TS_PANEL_UNKNOWN, LTR311_PARA_SIZE,
	  { 20, 45, 80, 368, 366, 350, 319, 20830, 90, 4000, 250, 0, 0 }
	},
	{ ADL, V3, TS_PANEL_UNKNOWN, LTR311_PARA_SIZE,
	  { 11, 30, 50, 435, 411, 373, 339, 16182, 48, 4000, 250, 0, 0 }
	},
	{ BLS, V3, BOE_TPLCD, LTR311_PARA_SIZE,
	  { 31, 41, 100, 210, 208, 198, 173, 28105, 108, 4000, 250, 0, 0 }
	},
	{ BLS, V3, VISI_TPLCD, LTR311_PARA_SIZE,
	  { 21, 45, 75, 210, 200, 207, 185, 28105, 108, 4000, 250, 0, 0 }
	},
	{ BLS, V3, CSOT_TPLCD, LTR311_PARA_SIZE,
	  { 23, 31, 57, 220, 213, 197, 183, 28105, 108, 4000, 250, 0, 0 }
	},
	{ BLS, V3, TS_PANEL_UNKNOWN, LTR311_PARA_SIZE,
	  { 20, 45, 80, 299, 276, 260, 225, 28105, 108, 4000, 250, 0, 0 }
	},
	{ MIS, V3, BOE_TPLCD, LTR311_PARA_SIZE,
	  { 18, 31, 58, 293, 283, 259, 237, 20830, 90, 4000, 250, 0, 0 }
	},
	{ MIS, V3, CSOT_TPLCD, LTR311_PARA_SIZE,
	  { 20, 45, 80, 285, 287, 272, 249, 20830, 90, 4000, 250, 0, 0 }
	},
	{ MIS, V3, TS_PANEL_UNKNOWN, LTR311_PARA_SIZE,
	  { 20, 45, 80, 368, 366, 350, 319, 20830, 90, 4000, 250, 0, 0 }
	},
};
