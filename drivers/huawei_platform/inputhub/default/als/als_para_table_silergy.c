...
als_para_normal_table syh399_als_para[] = {
	...
	{ BLK, V3, CSOT_TPLCD, SYH399_PARA_SIZE,
	  {220, 310, 350, 2000, 1246, 1295, 1360, 1423, 16560, 1882, 4000, 250, 0, 0, 0, 0}
	},

	{ BLK, V3, BOE_TPLCD, SYH399_PARA_SIZE,
	...
	{ ADA, V3, CSOT_TPLCD, SYH399_PARA_SIZE,
	  {190, 270, 450, 2000, 2068, 2161, 2295, 2348, 9930, 1020, 4000, 250, 0, 0, 0, 0}
	},

	{ ADA, V3, BOE_TPLCD, SYH399_PARA_SIZE,
	...
	{ BLS, V3, VISI_TPLCD, SYH399_PARA_SIZE,
	  {210, 300, 440, 2000, 1200, 1190, 1240, 1100, 16560, 1882, 4000, 250, 0, 0, 0, 0}
	},

	{ BLS, V3, CSOT_TPLCD, SYH399_PARA_SIZE,
	  {190, 300, 440, 2000, 1121, 1156, 1217, 1155, 16560, 1882, 4000, 250, 0, 0, 0, 0}
	},

	{ BLS, V3, BOE_TPLCD, SYH399_PARA_SIZE,
	  {190, 300, 440, 2000, 941, 977, 1082, 1087, 16560, 1882, 4000, 250, 0, 0, 0, 0}
	},

	{ BLS, V3, TS_PANEL_UNKNOWN, SYH399_PARA_SIZE,
	  {210, 300, 440, 2000, 1335, 1406, 1482, 1536, 16560, 1882, 4000, 250, 0, 0, 0, 0}
	},
	{ MIS, V3, CSOT_TPLCD, SYH399_PARA_SIZE,
	  {195, 300, 430, 2000, 2152, 2007, 1975, 2064, 9930, 1020, 4000, 250, 0, 0, 0, 0}
	},
	{ MIS, V3, BOE_TPLCD, SYH399_PARA_SIZE,
	  {210, 300, 480, 2000, 1887, 1984, 2085, 2035, 9930, 1020, 4000, 250, 0, 0, 0, 0}
	},
	{ MIS, V3, TS_PANEL_UNKNOWN, SYH399_PARA_SIZE,
	  {210, 300, 480, 2000, 1887, 1984, 2085, 2035, 9930, 1020, 4000, 250, 0, 0, 0, 0}
	},
};
