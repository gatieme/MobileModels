...
#define NFC_OK 0
#define ESE_BL_ERROR 0x01
#define ESE_RESET_ERROR 0x02
#define ESE_CLOSE_STATE_VEN_ERROR 0x03
#define ESE_CORE_RESET_ERROR 0x12
#define ESE_OPEN_STATE_VEN_ERROR 0x13
#define NFC_NO_DO_RECOVER 0x20
#define ESE_RECOVER_MAX_CNT 1000
#define NFC_CLOSE_STATUS 1
#define NFC_OPEN_STATUS 0
#define ESE_DO_RECOVER 1
#define NFC_NEED_RESET 3
#define NFC_NONEED_RESET 4
...
#define FOUR_BYTE_UID 4
#define SEVEN_BYTE_UID 7
#define TEN_BYTE_UID 10
#define UID_CHAR_OFFSET_5 4
#define UID_CHAR_OFFSET_6 5
#define UID_CHAR_OFFSET_7 6
#define UID_CHAR_OFFSET_8 7
#define TAG_UID '4'
...
extern int tms_nfc_record_dmd_info(long dmd_no, const char *dmd_info);
 ...
 * NFC_ON_BY_REGULATOR_BULK: a gpio used when thn31 chip which can
 ...
 * NFC_ESE_P61: use TMS thd89 as eSE
