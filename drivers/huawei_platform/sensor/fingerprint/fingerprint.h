...
#define  FP_IOC_CMD_SEND_SCREEN_NAME      _IO(FP_IOC_MAGIC, 29)
#define FP_IOC_CMD_WAIT_BACKLIGHT_STATUS      _IO(FP_IOC_MAGIC, 30)
#define FP_IOC_CMD_MMI_TEST_STATUS      _IO(FP_IOC_MAGIC, 31)
#define FP_IOC_CMD_GET_S4_STATUS      _IO(FP_IOC_MAGIC, 33)
...
struct fp_data {
	...
	char screen_name[MAX_SCREEN_NAME_LEN];
	bool irq_enabled;
	...
	wait_queue_head_t backlight_queue;
#if defined(CONFIG_FB)
