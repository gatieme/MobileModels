...
#if defined(CONFIG_HIBERNATION) && defined(CONFIG_PM_SLEEP) && defined(CONFIG_TCPC_RT1715)
...
bool g_et7303_vid_flag = false;
bool g_husb311_vid_flag = false;
#endif
...
#ifdef CONFIG_HUAWEI_TCPC_HUSB311
static bool enable_husb311_cc_open_delay = false;

HNT_REG_DECL(TCPC_V10_REG_VID, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_PID, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_DID, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_TYPEC_REV, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_PD_REV, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_PDIF_REV, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_ALERT, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_ALERT_MASK, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_POWER_STATUS_MASK, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_FAULT_STATUS_MASK, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_TCPC_CTRL, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_ROLE_CTRL, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_FAULT_CTRL, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_POWER_CTRL, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_CC_STATUS, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_POWER_STATUS, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_FAULT_STATUS, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_COMMAND, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_MSG_HDR_INFO, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_RX_DETECT, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_RX_BYTE_CNT, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_RX_BUF_FRAME_TYPE, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_RX_HDR, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_RX_DATA, 28, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_TRANSMIT, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_TX_BYTE_CNT, 1, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_TX_HDR, 2, RT_VOLATILE, {});
HNT_REG_DECL(TCPC_V10_REG_TX_DATA, 28, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_CONFIG_GPIO0, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_PHY_CTRL1, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_CLK_CTRL2, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_CLK_CTRL3, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_PRL_FSM_RESET, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_BMC_CTRL, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_BMCIO_RXDZSEL, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_RT_STATUS, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_RT_INT, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_RT_MASK, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_IDLE_CTRL, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_I2CRST_CTRL, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_SWRESET, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_TTCPC_FILTER, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_DRP_TOGGLE_CYCLE, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_DRP_DUTY_CTRL, 2, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_BMCIO_RXDZEN, 1, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_UNLOCK_PW_2, 2, RT_VOLATILE, {});
HNT_REG_DECL(RT1711H_REG_EFUSE5, 1, RT_VOLATILE, {});

static const rt_register_map_t husb311_chip_regmap[] = {
	HNT_REG(TCPC_V10_REG_VID),
	HNT_REG(TCPC_V10_REG_PID),
	HNT_REG(TCPC_V10_REG_DID),
	HNT_REG(TCPC_V10_REG_TYPEC_REV),
	HNT_REG(TCPC_V10_REG_PD_REV),
	HNT_REG(TCPC_V10_REG_PDIF_REV),
	HNT_REG(TCPC_V10_REG_ALERT),
	HNT_REG(TCPC_V10_REG_ALERT_MASK),
	HNT_REG(TCPC_V10_REG_POWER_STATUS_MASK),
	HNT_REG(TCPC_V10_REG_FAULT_STATUS_MASK),
	HNT_REG(TCPC_V10_REG_TCPC_CTRL),
	HNT_REG(TCPC_V10_REG_ROLE_CTRL),
	HNT_REG(TCPC_V10_REG_FAULT_CTRL),
	HNT_REG(TCPC_V10_REG_POWER_CTRL),
	HNT_REG(TCPC_V10_REG_CC_STATUS),
	HNT_REG(TCPC_V10_REG_POWER_STATUS),
	HNT_REG(TCPC_V10_REG_FAULT_STATUS),
	HNT_REG(TCPC_V10_REG_COMMAND),
	HNT_REG(TCPC_V10_REG_MSG_HDR_INFO),
	HNT_REG(TCPC_V10_REG_RX_DETECT),
	HNT_REG(TCPC_V10_REG_RX_BYTE_CNT),
	HNT_REG(TCPC_V10_REG_RX_BUF_FRAME_TYPE),
	HNT_REG(TCPC_V10_REG_RX_HDR),
	HNT_REG(TCPC_V10_REG_RX_DATA),
	HNT_REG(TCPC_V10_REG_TRANSMIT),
	HNT_REG(TCPC_V10_REG_TX_BYTE_CNT),
	HNT_REG(TCPC_V10_REG_TX_HDR),
	HNT_REG(TCPC_V10_REG_TX_DATA),
	HNT_REG(RT1711H_REG_CONFIG_GPIO0),
	HNT_REG(RT1711H_REG_PHY_CTRL1),
	HNT_REG(RT1711H_REG_CLK_CTRL2),
	HNT_REG(RT1711H_REG_CLK_CTRL3),
	HNT_REG(RT1711H_REG_PRL_FSM_RESET),
	HNT_REG(RT1711H_REG_BMC_CTRL),
	HNT_REG(RT1711H_REG_BMCIO_RXDZSEL),
	HNT_REG(RT1711H_REG_RT_STATUS),
	HNT_REG(RT1711H_REG_RT_INT),
	HNT_REG(RT1711H_REG_RT_MASK),
	HNT_REG(RT1711H_REG_IDLE_CTRL),
	HNT_REG(RT1711H_REG_I2CRST_CTRL),
	HNT_REG(RT1711H_REG_SWRESET),
	HNT_REG(RT1711H_REG_TTCPC_FILTER),
	HNT_REG(RT1711H_REG_DRP_TOGGLE_CYCLE),
	HNT_REG(RT1711H_REG_DRP_DUTY_CTRL),
	HNT_REG(RT1711H_REG_BMCIO_RXDZEN),
	HNT_REG(RT1711H_REG_UNLOCK_PW_2),
	HNT_REG(RT1711H_REG_EFUSE5),
};
...
#ifdef CONFIG_HUAWEI_TCPC_HUSB311
bool chip_id_is_husb311_did(void)
{
...
#ifdef CONFIG_TCPC_RT1715
int rt1711_get_cc_status(struct tcpc_device *tcpc)
{
	int cc_status = rt1711_i2c_read8(tcpc, TCPC_V10_REG_CC_STATUS);
	if (cc_status < 0)
		pr_info("%s: cc_status is invaild\n", __func__);
	return cc_status;
}

void rt1711_set_cc_mode(int mode)
{
	struct tcpc_device *tcpc = NULL;

	if (!g_chip_for_reg_read || !g_chip_for_reg_read->tcpc) {
		pr_info("g_chip_for_reg_read or tcpc is NULL!\n");
		return;
	}

	tcpc = g_chip_for_reg_read->tcpc;
	TYPEC_INFO("%s: mode = %d\n", __func__, mode);
...
#ifdef CONFIG_HUAWEI_TCPC_HUSB311
bool hnt_get_husb311_vid_flag(void)
{
	return g_husb311_vid_flag;
}
#endif /* CONFIG_HUAWEI_TCPC_HUSB311 */
...
#ifdef CONFIG_TCPC_RT1715
bool et7303_get_vbus_reg_status(struct tcpc_device *tcpc)
{
	uint16_t ret;

	if (!g_et7303_vid_flag)
		return false;

	ret = rt1711_i2c_read8(tcpc, ETK_POWER_REG);
	pr_info("%s : 0x1e -> %x\n", __func__, (uint16_t)ret);
	if (ret == ETK_VBUS_ENABLE)
		return true;
...
{
#if defined(CONFIG_RT_REGMAP) || defined(CONFIG_HUAWEI_TCPC_HUSB311)
	struct rt1711_chip *chip = tcpc_get_dev_data(tcpc);
#endif /* defined(CONFIG_RT_REGMAP) || defined(CONFIG_HUAWEI_TCPC_HUSB311) */
...
#ifdef CONFIG_HUAWEI_TCPC_HUSB311
	if (chip->chip_id == HUSB311_DID) {
		/* fix husb311 can not enter poweroff charging */
		if (enable_husb311_cc_open_delay) {
			rt1711_set_cc(tcpc, TYPEC_CC_DRP);
			rt1711_set_cc(tcpc, TYPEC_CC_OPEN);
			usleep_range(500000, 500000);
		}

		tcpci_alert_status_clear(tcpc, 0xffffff);

		rt1711_write_word(chip->client, TCPC_V10_REG_ALERT_MASK, 0x0);
		rt1711_i2c_write8(tcpc, TCPC_V10_REG_POWER_STATUS_MASK, 0x0);
		rt1711_i2c_write8(tcpc, RT1711H_REG_RT_MASK, 0x0);
		rt1711_i2c_write8(tcpc, RT1711H_REG_BMC_CTRL, 0x0);
	} else {
#endif /* CONFIG_HUAWEI_TCPC_HUSB311 */
		rt1711_i2c_write8(tcpc,
			RT1711H_REG_I2CRST_CTRL,
...
static int rt1711_tcpcdev_init(struct rt1711_chip *chip, struct device *dev)
{
...
#ifdef CONFIG_HUAWEI_TCPC_HUSB311
	enable_husb311_cc_open_delay =
		of_property_read_bool(np, "rt1711pd,enable_husb311_cc_open_delay");
	dev_info(dev, "%s enable_husb311_cc_open_delay:%d\n", __func__,
		enable_husb311_cc_open_delay);
#endif	/* CONFIG_HUAWEI_TCPC_HUSB311 */
	...
	tcpc->disable_pe = of_property_read_bool(np, "rt-tcpc,disable_pe");
...
#ifdef CONFIG_TCPC_RT1715
	if (of_property_read_bool(np, "rt1711pd,pd_disable"))
		tcpc->pd_disable = true;
	pr_info("%s pd_disable %d\n", __func__, tcpc->pd_disable);
#endif
...
static int check_vid_pid(u16 vid, u16 pid)
{
	if (vid == RICHTEK_1711_VID) {
		...
		g_et7303_vid_flag = true;
	} else if (vid == HYNETEK_HUSB311_VID) {
		if (pid != HYNETEK_HUSB311_PID) {
			pr_info("%s failed, VID=0x%04x PID=0x%04x\n", __func__, vid, pid);
			return -ENODEV;
		}
		g_husb311_vid_flag = true;
	} else {
				...
				const struct i2c_device_id *id)
{
	...
	chip->chip_id = chip_id & DID_MASK;
	chip->vendor_id = (chip_id >> SHIFT_16) & VID_MASK;
	...
	if (chip->chip_id == HUSB311_DID) {
		...
		if (version & HUSB311_GET_VERSION_MASK) {
	...
	if (ret) {
		pr_err("cc_check_ops register failed\n");
		goto err_irq_init;
	}
#endif
...
#if defined(CONFIG_HIBERNATION) && defined(CONFIG_PM_SLEEP) && defined(CONFIG_TCPC_RT1715)
static inline bool rt1711_i2c_check_reset(struct rt1711_chip *chip)
{
	int ret;
	...
	ret = rt1711_i2c_read16(chip->tcpc, RT1711H_REG_DRP_DUTY_CTRL);

	return (ret < 0) ? false : ((ret & 0x3FF) != TCPC_NORMAL_RP_DUTY);
}

void rt1711_vbus_detection_enable(struct rt1711_chip *chip, bool enable)
{
	int val = 0;

	if (!chip || !chip->client || !chip->tcpc)
		return;

	pr_info("%s:%d", __func__, enable);
	val = rt1711_reg_read(chip->client, RT1711H_REG_BMC_CTRL);
	if (enable)
		val |= RT1711H_REG_VBUS_DET_EN;
	else
		val &= ~RT1711H_REG_VBUS_DET_EN;
	rt1711_i2c_write8(chip->tcpc, RT1711H_REG_BMC_CTRL, val);
}

static int rt1711_i2c_restore(struct device *dev)
{
	struct rt1711_chip *chip;
	...
	if (rt1711_i2c_check_reset(chip)) {
		tcpci_lock_typec(chip->tcpc);
		rt1711_tcpc_init(chip->tcpc, true);
		/*
		 * HUSB311 no vbus irq when plug in cable exit s4.
		 * Vbus irq trigger when 1E bit2 change.
		 * Disable vbus detect for clear 1E register bit 2.
		 */
		if (chip->chip_id == HUSB311_DID)
			rt1711_vbus_detection_enable(chip, false);
		tcpc_typec_error_recovery(chip->tcpc);
		if (chip->chip_id == HUSB311_DID)
			rt1711_vbus_detection_enable(chip, true);
		tcpci_unlock_typec(chip->tcpc);
	}
	rt1711_i2c_resume(dev);
	dev_info(dev, "%s end\n", __func__);
...
static const struct dev_pm_ops rt1711_pm_ops = {
	...
	.freeze = rt1711_i2c_suspend,
	.thaw = rt1711_i2c_resume,
	.poweroff = rt1711_i2c_suspend,
	.restore = rt1711_i2c_restore,
#else
