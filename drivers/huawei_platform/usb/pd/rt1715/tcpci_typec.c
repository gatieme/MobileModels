...
#undef RICHTEK_PD_COMPLIANCE_FAKE_AUDIO_ACC	/* For Rp3A */
#undef RICHTEK_PD_COMPLIANCE_FAKE_EMARK_ONLY	/* For Rp3A */
#undef RICHTEK_PD_COMPLIANCE_FAKE_RA_DETACH	/* For Rp-DFT */
...
#if defined(RICHTEK_PD_COMPLIANCE_FAKE_AUDIO_ACC) ||\
			defined(RICHTEK_PD_COMPLIANCE_FAKE_EMARK_ONLY)
...
#ifdef RICHTEK_PD_COMPLIANCE_FAKE_EMARK_ONLY
			if (typec_is_fake_ra_rp30(tcpc)) {
