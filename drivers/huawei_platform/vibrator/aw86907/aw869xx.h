...
#define AW869XX_FORMATS                         (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S32_LE)
...
#define MAX_HAPTIC_STOP_CNT                     40
#define AW869XX_EFFECT_ID_MAX                   100
#define AW869XX_MAX_SHORT_VIB_ID                10
#define AW869XX_SHORT_VIB_AVAIABLE              3
#define AW869XX_MAX_LONG_VIB_ID                 20
#define AW869XX_LONG_VIB_EFFECT_ID              21
#define MAX_RAM_LOAD_COUNT                      1
#define AW869XX_LONG_VIB_BOOST_OFF_ID           4
#define AW869XX_SEL_BOOST_CFG_ON                1

#define AW869XX_F0_CALI_THER_H                  (1700 + 150)
#define AW869XX_F0_CALI_THER_L                  (1700 - 150)
#define AW869xx_DRV_WAV                         20
#define AW869xx_BRK_WAV                         21
#define AW869xx_LONG_WAV_1_CYL                  22
#define AW869xx_LONG_WAV_2_CYL                  23
#define AW869xx_LONG_WAV_4_CYL                  24
#define AW869xx_LONG_WAV_8_CYL                  25
#define AW869xx_LONG_SEQ_MAX_TIME               90 //6 seqs * 15 times
#define AW869xx_MAX_PLAY_TIME                   14
#define AW869XX_BREAK_EN                        0
/*********************************************************
 *
 * Enum Define
 *
...
struct aw869xx {
	...
	unsigned char rtp_src_sel;
	unsigned char rtp_d2s_gain;
	unsigned char rtp_brk_gain;
	unsigned char rtp_brk_time;
	unsigned char ram_short_d2s_gain;
	unsigned char ram_short_brk_gain;
	unsigned char ram_short_brk_time;
	unsigned char ram_long_d2s_gain;
	unsigned char ram_long_brk_gain;
	unsigned char ram_long_brk_time;
#ifdef AAC_RICHTAP_SUPPORT
	uint8_t *rtp_ptr;
