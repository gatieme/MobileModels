...
#define AW_RAMDATA_RD_BUFFER_SIZE		(10)
#define AW_RAMDATA_WR_BUFFER_SIZE		(10)
...
#define AW_F0_CALI_THER_H			(1700 + 150)
#define AW_F0_CALI_THER_L			(1700 - 150)
...
struct aw_haptic_func {
	...
	void (*enable_gain)(struct aw_haptic *, bool);
 ...
 *
 *********************************************************/
extern char *aw8692x_ram_name;
extern char aw_rtp_name[][AW_RTP_NAME_MAX];

#ifdef AW869X_DRIVER_ENABLE
struct aw_haptic_func *aw869x_func(void);
#endif

#ifdef AW869XX_DRIVER_ENABLE
struct aw_haptic_func *aw869xx_func(void);
#endif

#ifdef AW8671X_DRIVER_ENABLE
struct aw_haptic_func *aw8671x_func(void);
#endif
