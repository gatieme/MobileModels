...
struct dl_info *get_download_monitor(struct sk_buff *skb, unsigned int uid, const char *url);
char *get_report_msg(unsigned int dlid, unsigned int uid, const char *data, char *ip);
