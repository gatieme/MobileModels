...
{
	if (ip_addr != INADDR_LOOPBACK && ip_addr != (u32)INADDR_ANY &&
		ip_addr != (u32)INADDR_BROADCAST &&
...
static unsigned char s_validate_state[] = {
	TCP_ESTABLISHED, TCP_SYN_SENT, TCP_SYN_RECV, TCP_LISTEN};
