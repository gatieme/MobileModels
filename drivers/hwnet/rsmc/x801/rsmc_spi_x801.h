...
struct smc_gpios {
	...
	u32 tx_ant_gpio;
	u32 rx_ant_gpio;
	u32 tx_ant_default_value;
	u32 rx_ant_default_value;
	u32 pa_pwr_gpio;
	u32 sp4t_pwr_gpio;
	u32 cs_gpio;
	u32 irq_gpio;
...
struct pa_power_supply {
	u32 pa_vcc_type;
	u32 pa_pwr_i2c_index;
	u32 pa_pwr_i2c_on_volt;
	u32 pa_pwr_i2c_off_volt;
};
...
struct smc_core_data {
	...
	struct pa_power_supply pa_powers;
};
