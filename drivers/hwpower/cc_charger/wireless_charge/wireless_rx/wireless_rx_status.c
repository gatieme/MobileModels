...
static int g_wireless_screen_state;
...
int wlrx_get_screen_stop_charging_state(void)
{
	return g_wireless_screen_state;
}

void wlrx_set_screen_stop_charging_state(int state)
{
	g_wireless_screen_state = state;
	hwlog_info("[set_screen_stop_charging_state] %d\n", state);
}
