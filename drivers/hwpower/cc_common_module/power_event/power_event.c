...
static const char * const g_power_event_ne_table[POWER_NE_END] = {
	...
	[POWER_NE_WIRELESS_AUX_TX_START] = "wireless_aux_tx_start",
	[POWER_NE_WIRELESS_AUX_TX_STOP] = "wireless_aux_tx_stop",
	...
	[POWER_NE_FCP_CHARGING_START] = "fcp_charging_start",
	...
	[POWER_NE_OTG_INSERT] = "otg_insert",
	[POWER_NE_OTG_REMOVE] = "otg_remove",
	...
	[POWER_NE_WLTX_SUPPORT_SLE] = "wltx_tx_support_sle",
	[POWER_NE_WLTX_RX_SS] = "wltx_tx_rx_ss",
	[POWER_NE_WLTX_RX_QI_ID] = "wltx_tx_rx_qi_id",
	[POWER_NE_WLTX_ASK_RX_PRODUCT_ID] = "wltx_ask_rx_product_id",
	[POWER_NE_WLTX_START_PREVFOD_CHK] = "wltx_tx_start_prevfod_chk",
	...
	[POWER_NE_HW_PD_CC_PROTECT] = "hw_pd_cc_protect",
	[POWER_NE_HW_PD_IS_DIRECT_CHARGE_CABLE] = "hw_pd_is_dc_cable",
	[POWER_NE_HW_PD_SET_EMARK_CURRENT] = "hw_pd_set_emark_current",
	[POWER_NE_HW_PD_SET_GLINK_STATUS] = "hw_pd_set_glink_status",
	[POWER_NE_HW_PD_BC12_RESULT] = "hw_pd_bc12_result",
	[POWER_NE_HW_PD_TYPEC_NONE] = "hw_pd_typec_none",
	/* section: for usb */
	[POWER_NE_HW_USB_SPEED] = "hw_usb_speed",
	[POWER_NE_HW_DP_STATE] = "hw_dp_state",
	[POWER_NE_HW_USB_HEADPHONE] = "hw_usb_headphone",
	[POWER_NE_HW_USB_HEADPHONE_OUT] = "hw_usb_headphone_out",
	/* section: for battery */
	...
	[POWER_NE_PANEL_BLANK] = "panel_blank",
	[POWER_NE_PANEL_UNBLANK] = "panel_unblank",
	/* section: for phone fold/unfold */
	[POWER_NE_SCREEN_FOLD] = "screen_fold",
	[POWER_NE_SCREEN_UNFOLD] = "screen_unfold",
	[POWER_NE_REVERSE_CHARGE_CAP] = "send_rchg_cap",
...
void power_event_report_str_uevent(const char *event)
{
...
EXPORT_SYMBOL_GPL(power_event_bnc_register);
...
int power_event_bnc_unregister(unsigned int type, struct notifier_block *nb)
{
	...
	hwlog_info("power_event_bnc_unregister type=%u\n", type);

	return blocking_notifier_chain_unregister(&g_power_event_bnh[type], nb);
}
EXPORT_SYMBOL_GPL(power_event_bnc_unregister);
...
EXPORT_SYMBOL_GPL(power_event_bnc_notify);
...
int power_event_anc_unregister(unsigned int type, struct notifier_block *nb)
{
	...
	hwlog_info("power_event_anc_unregister type=%u\n", type);
