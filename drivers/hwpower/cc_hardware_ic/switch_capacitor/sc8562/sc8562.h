...
#define SC8562_DEVICE_ID_GET_RETRY                3
#define SC8562_ERROR_DELTA_IBUS                   300
...
#define SC8565_PMID2OUT_UVP_DISABLE               1
...
#define SC8562_PMID2OUT_UVP_DEFAULT               0x1 /* -50mv */
#define SC8562_PMID2OUT_UVP_R12                   0x7 /* -450mv */
...
#define SC8562_SW_FREQ_600KHZ                     600
...
#define SC8562_CHG_R12SC_MODE                     5
#define SC8562_CHG_R14SC_MODE                     4
...
#define SC8562_VBUS_PRESENT_STAT_UVP_MODE         1
...
#define SC8565_IBUS_RCP_DISABLE                   1
#define SC8565_IBUS_RCP_ENABLE                    0
...
#define SC8565_VUSB_REMOVE_MASK_ENABLE            1
