...
struct cps4057_rx_cm_cfg {
	u8 l_volt;
	u8 h_volt;
	u8 fac_h_volt;
};

struct cps4057_rx_polar_cfg {
	u8 l_volt;
	u8 h_volt;
	u8 fac_h_volt;
};
...
struct cps4057_rx_mod_cfg {
	struct cps4057_rx_cm_cfg cm;
	struct cps4057_rx_polar_cfg polar;
};
...
struct cps4057_rx_ldo_opp_vbst {
	u32 vbst;
	u32 iout_lth;
	u32 iout_hth;
};
...
struct cps4057_dev_info {
	...
	struct cps4057_rx_dummy_iload dummy_load;
	struct cps4057_mtp_check_delay mtp_check_delay;
	struct cps4057_rx_ldo_opp_vbst ldo_opp_vbst;
	...
	u32 tx_min_duty;
	u32 tx_ping_bridge_ctrl;
	u16 chip_id;
	u32 tx_fod_fmt;
	u32 min_fop;
	u32 fodchk_dummy_iload;
	u32 tx_ping_ocp;
	u32 fodchk_ask_cap;
};
...
void cps4057_enable_irq_wake(struct cps4057_dev_info *di);
void cps4057_disable_irq_wake(struct cps4057_dev_info *di);
...
/* cps4057 hw_test */
int cps4057_hw_test_ops_register(struct cps4057_dev_info *di);
