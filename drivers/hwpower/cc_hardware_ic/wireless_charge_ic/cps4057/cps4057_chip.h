...
#define CPS4057_RX_IRQ_MLDO_OPP               BIT(10)
...
#define CPS4057_RX_CMALL_EN_VAL               0x7 /* b3:CMA b4:CMB b5:CMC */
#define CPS4057_RX_CMA_EN_VAL                 0x1
...
#define CPS4057_RX_FASTRPP_EN_MASK            BIT(11)
#define CPS4057_RX_FASTRPP_EN_SHIFT           11
#define CPS4057_RX_LIMRPP_DIS_MASK            BIT(12)
#define CPS4057_RX_LIMRPP_DIS_SHIFT           12
/* rx_fc_volt register */
...
#define CPS4057_RX_DROP_MIN_ADDR              0x1F58
#define CPS4057_RX_DROP_MIN_LEN               2
#define CPS4057_RX_DROP_MAX_ADDR              0x1F5A
#define CPS4057_RX_DROP_MAX_LEN               2
/* rx_rp_type */
...
/* system in light load and Vrect>15V, the size of the dummy load in non-ASK modulation */
#define CPS4057_RX_HV_DUMMY_ILOAD_ADDR        0x1F66
#define CPS4057_RX_HV_DUMMY_ILOAD_LEN         1
#define CPS4057_RX_HV_DUMMY_ILOAD_DEFAULT     50 /* 50ma */
#define CPS4057_RX_DUMMY_ILOAD_STEP           125 /* 12.5ma */
/* system in light load and Vrect>15V, the size of the dummy load in ASK modulation */
#define CPS4057_RX_HV_DUMMY_ILOAD1_ADDR       0x1F67
#define CPS4057_RX_HV_DUMMY_ILOAD1_LEN        1
#define CPS4057_RX_HV_DUMMY_ILOAD1_DEFAULT    75 /* 75ma */
/* system in light load and Vrect<11V, the size of the dummy load in non-ASK modulation */
#define CPS4057_RX_LV_DUMMY_ILOAD_ADDR        0x1F68
#define CPS4057_RX_LV_DUMMY_ILOAD_LEN         1
#define CPS4057_RX_LV_DUMMY_ILOAD_DEFAULT     50 /* 50ma */
/* system in light load and Vrect<11V, the size of the dummy load in ASK modulation */
#define CPS4057_RX_LV_DUMMY_ILOAD1_ADDR       0x1F69
#define CPS4057_RX_LV_DUMMY_ILOAD1_LEN        1
#define CPS4057_RX_LV_DUMMY_ILOAD1_DEFAULT    75 /* 75ma */
/* rx_ldo_opp_vbst, in mV */
#define CPS4057_RX_LDO_OPP_VBST_ADDR          0x1F70
#define CPS4057_RX_LDO_OPP_VBST_LEN           2
#define CPS4057_RX_LDO_OPP_VBST_DFLT          0
/* rx_ldo_opp_cur_th, in mA */
#define CPS4057_RX_LDO_OPP_ITHH_ADDR          0x1F72
#define CPS4057_RX_LDO_OPP_ITHH_LEN           2
#define CPS4057_RX_LDO_OPP_ITHH_DFLT          2000
#define CPS4057_RX_LDO_OPP_ITHL_ADDR          0x1F74
#define CPS4057_RX_LDO_OPP_ITHL_LEN           2
#define CPS4057_RX_LDO_OPP_ITHL_DFLT          1000
...
#define CPS4057_RX_FOD_C0_ADDR                0x1F0D /* offset, ith: 0-250mA */
#define CPS4057_RX_FOD_C1_ADDR                0x1F0F /* offset, ith: 250-500mA */
...
#define CPS4057_TX_IRQ_FSK_ACK                BIT(12)
/* tx_irq_clr register */
...
/* tx_pmax register */
#define CPS4057_TX_PMAX_ADDR                  0x1E02
#define CPS4057_TX_PMAX_LEN                   1
#define CPS4057_TX_RPP_VAL_UNIT               2 /* in 0.5Watt units */
/* tx pt duty */
#define CPS4057_TX_PT_MIN_DUTY_ADDR           0x1E04
#define CPS4057_TX_PT_MIN_DUTY_LEN            2
#define CPS4057_TX_PT_MAX_DUTY_ADDR           0x1E06
#define CPS4057_TX_PT_MAX_DUTY_LEN            2
#define CPS4057_TX_PT_DUTY_MAX                50
#define CPS4057_TX_PT_DUTY_MIN                10
#define CPS4057_TX_PT_DUTY_MAX_PREVFOD        25
#define CPS4057_TX_PT_DUTY_MIN_PREVFOD        25
#define CPS4057_TX_PT_DUTY_STEP               50
...
#define CPS4057_TX_OVP_TH                     20000
/* tx_min_fop, in kHz */
#define CPS4057_TX_MIN_FOP_ADDR               0x1E48
#define CPS4057_TX_MIN_FOP_LEN                1
#define CPS4057_TX_MIN_FOP_DFLT               113
#define CPS4057_TX_MIN_FOP                    100
#define CPS4057_TX_MIN_FOP_PREVFOD            145
/* tx_max_fop, in kHz */
#define CPS4057_TX_MAX_FOP_ADDR               0x1E49
#define CPS4057_TX_MAX_FOP_LEN                1
#define CPS4057_TX_MAX_FOP                    145
#define CPS4057_TX_MAX_FOP_PREVFOD            145
/* tx_ping_freq, in kHz */
...
#define CPS4057_TX_PING_FREQ_MAX              180
/* tx_ping_duty, in kHz */
#define CPS4057_TX_PING_DUTY_ADDR             0x1E4B
#define CPS4057_TX_PING_DUTY_LEN              1
#define CPS4057_TX_PING_DUTY_MIN              10
#define CPS4057_TX_PING_DUTY_MAX              50
/* tx_ping_ocp, in mA */
...
#define CPS4057_TX_LP_PLOSS_TH_ADDR           0x1E58
#define CPS4057_TX_LP_PLOSS_TH_LEN            6
#define CPS4057_TX_FOD_LEN                    18
/* func_en register */
...
#define CPS4057_TX_24BITRPP_EN_MASK           BIT(3)
#define CPS4057_TX_24BITRPP_EN_SHIFT          3
#define CPS4057_TX_Q_EN_MASK                  BIT(4)
#define CPS4057_TX_Q_EN_SHIFT                 4
#define CPS4057_PING_BRIDGE_CTRL_MASK         BIT(5)
#define CPS4057_PING_BRIDGE_CTRL_SHIFT        5
#define CPS4057_PING_BRIDGE_CTRL_DIS          0
#define CPS4057_TX_PA_MODE_MASK               BIT(6)
#define CPS4057_TX_PA_MODE_SHIFT              6
#define CPS4057_TX_SR_DEATH_TIME_MASK         BIT(7)
#define CPS4057_TX_SR_DEATH_TIME_SHIFT        7
/* tx_ilimit register */
#define CPS4057_TX_ILIM_ADDR                  0x1E60
#define CPS4057_TX_ILIM_LEN                   2
#define CPS4057_TX_ILIM_MIN                   100
#define CPS4057_TX_ILIM_MAX                   2000
/* tx_h2f_inc_freq register, increased freq */
#define CPS4057_TX_H2F_INC_FREQ_ADDR          0x1E62
#define CPS4057_TX_H2F_INC_FREQ_VAL           50
#define CPS4057_TX_H2F_INC_FREQ_LEN           1
/* tx_h2f_dec_max_duty_register, decreased max_duty */
#define CPS4057_TX_H2F_DEC_DUTY_ADDR          0x1E64
#define CPS4057_TX_H2F_DEC_DUTY_VAL           30
#define CPS4057_TX_H2F_DEC_DUTY_LEN           1
/* tx_hp_fod_ploss_thres register, in mW */
#define CPS4057_TX_HP_PLOSS_TH0_ADDR          0x1E68
#define CPS4057_TX_HP_PLOSS_TH0_VAL           10000
#define CPS4057_TX_HP_PLOSS_TH0_LEN           2
#define CPS4057_TX_HP_PLOSS_TH1_ADDR          0x1E6A
#define CPS4057_TX_HP_PLOSS_TH1_VAL           10000
#define CPS4057_TX_HP_PLOSS_TH1_LEN           2
#define CPS4057_TX_HP_PLOSS_TH2_ADDR          0x1E6C
#define CPS4057_TX_HP_PLOSS_TH2_VAL           10000
#define CPS4057_TX_HP_PLOSS_TH2_LEN           2
#define CPS4057_TX_HP_PLOSS_TH3_ADDR          0x1E7A
#define CPS4057_TX_HP_PLOSS_TH3_VAL           10000
#define CPS4057_TX_HP_PLOSS_TH3_LEN           2
#define CPS4057_TX_HP_FOD_CUR_TH0_ADDR        0x1E70
#define CPS4057_TX_HP_FOD_CUR_TH0_VAL         1200
#define CPS4057_TX_HP_FOD_CUR_TH0_LEN         2
#define CPS4057_TX_HP_FOD_CUR_TH1_ADDR        0x1E72
#define CPS4057_TX_HP_FOD_CUR_TH1_VAL         3000
#define CPS4057_TX_HP_FOD_CUR_TH1_LEN         2
#define CPS4057_TX_HP_FOD_CUR_TH2_ADDR        0x1E78
#define CPS4057_TX_HP_FOD_CUR_TH2_VAL         900
#define CPS4057_TX_HP_FOD_CUR_TH2_LEN         2
#define CPS4057_TX_HP_PLOSS_TH_ADDR           0x1E68
#define CPS4057_TX_HP_PLOSS_TH_LEN            10
/* tx_q_fod_only_coil_th */
#define CPS4057_TX_Q_ONLY_COIL_ADDR           0x1E74
#define CPS4057_TX_Q_ONLY_COIL_TH             140
/* tx_q_fod_only_coil_th */
#define CPS4057_TX_Q_TH_ADDR                  0x1E76
#define CPS4057_TX_Q_TH                       110
/* tx timer_cc_en, enable for tx_iin adjustment */
#define CPS4057_TX_TIMER_CC_EN_ADDR           0x1E7C
#define CPS4057_TX_TIMER_EN_MASK              BIT(0)
#define CPS4057_TX_TIMER_EN_SHIFT             0
#define CPS4057_TX_TIMER_CC_EN_DFLT           0
/* tx timer_cc_ctrl_interval, tx_iin adjustment interval */
#define CPS4057_TX_TIMER_CC_CTRL_ADDR         0x1E7E
#define CPS4057_TX_TIMER_CC_CTRL_LEN          1
#define CPS4057_TX_TIMER_CC_CTRL_DFLT         0 /* unit: ms */
...
#define CPS4057_TX_CEP_ADDR                   0x1E8D
#define CPS4057_TX_CEP_LEN                    1
...
#define CPS4057_TX_EPT_SRC_Q_FOD              BIT(12) /* stop */
/* tx_pwm_duty register */
#define CPS4057_TX_PWM_DUTY_ADDR              0x1E92
#define CPS4057_TX_PWM_DUTY_LEN               2
#define CPS4057_TX_PWM_DUTY_UNIT              50
...
#define CPS4057_TX_PRX_ADDR                   0x1E98
#define CPS4057_TX_PRX_LEN                    2
/* tx_power value register, in mw */
#define CPS4057_TX_PTX_ADDR                   0x1E9A
#define CPS4057_TX_PTX_LEN                    2
/* tx_ploss value register, in mw */
#define CPS4057_TX_PLOSS_ADDR                 0x1E9C
#define CPS4057_TX_PLOSS_LEN                  2
/* tx_ploss threshold register, in mw */
#define CPS4057_TX_PTX_TH_ADDR                0x1E9E
#define CPS4057_TX_PTX_TH_LEN                 2
/* tx_fod_th_id register */
#define CPS4057_TX_FOD_TH_ID_ADDR             0x1EA1
#define CPS4057_TX_FOD_TH_ID_LEN              1
/* tx_q_val register */
#define CPS4057_TX_Q_VAL_ADDR                 0x1EA2
/* tx_curfod ping iin */
#define CPS4067_TX_CURFOD_IIN_ADDR            0x1EA4
#define CPS4067_TX_CURFOD_IIN_LEN             2
