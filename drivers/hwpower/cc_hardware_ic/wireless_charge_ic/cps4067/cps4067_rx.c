...
static int cps4067_rx_set_vfc(int vfc, void *dev_data)
{
	...
	if (vfc >= WLRX_IC_HIGH_VOUT2)
		...
		ret = cps4067_rx_enable_boost_mode(di);
...
static int cps4067_rx_fodchk_chip_init(struct cps4067_dev_info *di)
{
	...
	ret = cps4067_write_byte(di, CPS4067_RX_DUMMY_LOAD_NO_MOD_ADDR, 0);
	ret += cps4067_write_byte(di, CPS4067_RX_DUMMY_LOAD_MOD_ADDR, 0);
