...
struct mt5735_dev_info {
	...
	struct mt5735_rx_dummy_iload dummy_load;
	struct mt5735_fw_mtp_info fw_mtp;
	struct mt5735_mtp_check_delay mtp_check_delay;
	struct mt5735_rx_ldo_opp_vbst ldo_opp_vbst;
...
void mt5735_enable_irq_wake(struct mt5735_dev_info *di);
void mt5735_disable_irq_wake(struct mt5735_dev_info *di);
...
/* mt5735 hw_test */
int mt5735_hw_test_ops_register(struct mt5735_dev_info *di);
