...
struct mt5785_dev_info {
	...
	struct mt5785_rx_cm_intfr_cfg *cm_intfr_cfg;
	...
	struct mt5785_rx_ldo_opp_vbst ldo_opp_vbst;
...
struct device_node *mt5785_dts_dev_node(void *dev_data);
