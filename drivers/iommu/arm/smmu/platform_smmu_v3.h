...
#define CTXDESC_CD_1_HAD0		(1UL << 1)
#define CTXDESC_CD_1_PBHA		(0xFUL << 60)
...
/* TCU DBG */
#define TCU_DBG_INV_BRC_DEST_SHIFT	32
#define TCU_DBG_SYNC_BRC_DEST_MASK	0xffffffff
#define TCU_DBG_INV_BRC_ACK_SHIFT	14
#define TCU_DBG_INV_BRC_REQ_SHIFT	0
#define TCU_DBG_SYNC_BRC_ACK_SHIFT	14
#define TCU_DBG_SYNC_BRC_REQ_SHIFT	0
#define TCU_DBG_INV_SYNC_BRC_REQ_ACK_MASK	0x3fff
/* TBU */
#define SMMU_TBU_CRACK_OFFSET	0x04
#define TBU_DBG_OUT_DATA_SHIFT	32
#define TBU_DBG_OUT_DATA_MASK	0xffffffff
#define TBU_DBG_CFG_RD_SHIFT	16
#define TBU_DBG_CFG_RD_ENABLE	1
#define TBU_DBG_CFG_ADDR_BIT8_MASK	0x3
#define TBU_DBG_CFG_ADDR_BIT0_MASK	0xff
#define TBU_DBG_CFG_ADDR_BIT8_SHIFT	8
#define TBU_DBG_CFG_ADDR_BIT0_SHIFT	0
#define TBU_DBG_CFG_ADDR_BIT0_CMD0	0
#define TBU_DBG_CFG_ADDR_BIT0_CMD1	10
#define TBU_DBG_CFG_ADDR_BIT8_CMD0	0
#define TBU_DBG_CFG_ADDR_BIT8_CMD1	1
#define TBU_DBG_CFG_ADDR_BIT8_CMD2	2
#define TBU_DBG_CFG_ADDR_BIT8_CMD3	3
#define TBU_DBG_CFG_CMD_MAX	32
/* MEDIA1_CTL_CRG */
#define MEDIA1_CTRL_MSK2_OFFSET	0x408
#define MEDIA1_CTRL_P1_0_OFFSET 0x40C
#define MEDIA1_STAT_P2_0_OFFSET 0x800
#define MEDIA1_STAT_P2_1_OFFSET 0x804
#define MEDIA1_STAT_P2_2_OFFSET 0x808
#define MEDIA1_STAT_P2_6_OFFSET 0x818
#define MEDIA1_STAT_P2_7_OFFSET 0x81C
#define MEDIA1_STAT_P2_9_OFFSET 0x820
#endif

#define CMDQ_MAX_INDEX			0xFF
#define CMD_NUMBER_NEED_READ	1
...
#define MAX_MEDIA_TBU_NUM 10
#define MAX_MEDIA_TBU_NAME_LEN  20
...
struct arm_smmu_tbu_info {
	u32 tbu_nums;
	const char *tbu_name[MAX_MEDIA_TBU_NUM];
	u32 *tbu_base;
	void **vbase;
};
...
#define ARM_SMMU_OPT_PAGE0_REGS_ONLY	(1 << 1)
	...
	struct arm_smmu_tbu_info    tbu_info;
