...
#define SDHCI_ADMA2_64_DESC_SZ(host)	16
#else
...
#define ZODIAC_SD_SWITCH_VOLTAGE 11
/*
...
#define SDHCI_QUIRK2_USE_1_8_V_VMMC			(1<<19)
/* zodiac controller fpga */
#define SDHCI_QUIRK2_ZODIAC_FPGA			(1UL<<21)
/* use zodiac combo phy testchip */
#define SDHCI_QUIRK2_ZODIAC_COMBO_PHY_TC		(1UL<<22)
/* zodiac controller emu */
#define SDHCI_QUIRK2_ZODIAC_SBC				(1UL<<20)
	...
	void __iomem *actrl;
	void __iomem *qicmmc;
	void __iomem *rd_liteddr;
	void __iomem *wr_liteddr;
	void __iomem *rd_ddrqic;
	void __iomem *wr_ddrqic;
...
extern struct sdhci_host *sdhci_alloc_host(struct device *dev, size_t priv_size);
