...
#define DDR_IMAGE_SIZE (0x4FF000)
...
#define DDR_F2L_END_AP (DDR_F2L_CONFIG_ADDR_AP + DDR_F2L_CONFIG_SIZE)
#define DDR_CODE_BASE_AP DDR_F2L_END_AP
#define DDR_CODE_SIZE (0x300000)
