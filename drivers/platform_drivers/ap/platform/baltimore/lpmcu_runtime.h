...
#define ONSYS_SWITCH ((u8)BIT(ONSYS_AVS_OFFSET))
enum {
 GPU_LOG_EN_OFFSET = 0,
 GPU_LINK_OFFSET,
 GPU_DEBUG_MAX = 7
...
#define GPU_LINK_ENABLE ((u8)BIT(GPU_LINK_OFFSET))
enum {
...
#define PERIMEM_DVS_ENABLE ((u8)BIT(PERIMEM_DVS))
#define ONSYS_AVS_DT_SW_ENABLE ((u8)BIT(ONSYS_AVS_DT_SW))
...
#define RUNTIME_CPU_PERI_LIMIT_ADDR(n) (RUNTIME_VAR_BASE + 0x23 + ((n) * 4))
...
#define CPU_MEMVOTE(n) (BYTE_REF(RUNTIME_CPU_MEMVOTE_ADDR(n)))
...
#define RUNTIME_GPUTOP_MAX_ADDR (RUNTIME_VAR_BASE + 0x49)
#define GPUTOP_MAX (BYTE_REF(RUNTIME_GPUTOP_MAX_ADDR))
...
#define RUNTIME_GPU_CTRL_ADDR (RUNTIME_VAR_BASE + 0x4B)
...
#define RUNTIME_GPU_PLL_ADDR (RUNTIME_VAR_BASE + 0x51)
#define GPU_PLL (BYTE_REF(RUNTIME_GPU_PLL_ADDR))
#define RUNTIME_GPUTOP_CURRENT_ADDR (RUNTIME_VAR_BASE + 0x52)
#define GPUTOP_CURRENT (BYTE_REF(RUNTIME_GPUTOP_CURRENT_ADDR))
#define RUNTIME_GPUTOP_TARGET_ADDR (RUNTIME_VAR_BASE + 0x53)
#define GPUTOP_TARGET (BYTE_REF(RUNTIME_GPUTOP_TARGET_ADDR))
#define RUNTIME_HIFI_IPC_FNSH_TIME_ADDR (RUNTIME_VAR_BASE + 0x54)
#define HIFI_IPC_FNSH_TIME (WORD_REF(RUNTIME_HIFI_IPC_FNSH_TIME_ADDR))
#define RUNTIME_GPU_VAR_END (RUNTIME_HIFI_IPC_FNSH_TIME_ADDR)
...
#endif
#define RUNTIME_PARA_INIT_SIZE (RUNTIME_TMP_VAR_ADDR + RUNTIME_TMP_VAR_SIZE - RUNTIME_VAR_BASE)
...
#define GENERAL_SEE_SHARE_DATA (WORD_REF(RUNTIME_GENERAL_SEE_DATA_ADDR))
#define RUNTIME_LPMCU_UTIL_ADDR (RUNTIME_VAR_BASE + 0x94)
#define LPMCU_UTIL (HALFWORD_REF(RUNTIME_LPMCU_UTIL_ADDR))
#define RUNTIME_LPMCU_UTIL_MAX_ADDR (RUNTIME_VAR_BASE + 0x96)
#define LPMCU_UTIL_MAX (HALFWORD_REF(RUNTIME_LPMCU_UTIL_MAX_ADDR))
#define RUNTIME_GEN_VAR_END (RUNTIME_LPMCU_UTIL_MAX_ADDR)
...
#define RUNTIME_PERIL_DVFS_ADDR(n) (RUNTIME_VAR_BASE + 0xA0 + (n) * 2)
#define PERIL_DVFS_BIAS(n) (HALFWORD_REF(RUNTIME_PERIL_DVFS_ADDR(n)))
#define RUNTIME_PERIL_VOLT_LVL_ADDR (RUNTIME_VAR_BASE + 0xA8)
#define PERIL_VOL_LVL (BYTE_REF(RUNTIME_PERIL_VOLT_LVL_ADDR))
#define RUNTIME_PERIL_VOLT_CUR_ADDR (RUNTIME_VAR_BASE + 0xA9)
#define PERIL_VOL_CUR (BYTE_REF(RUNTIME_PERIL_VOLT_CUR_ADDR))
#define RUNTIME_PERIL_VOLT_STATUS_ADDR (RUNTIME_VAR_BASE + 0xAA)
#define PERIL_VOL_STAT (HALFWORD_REF(RUNTIME_PERIL_VOLT_STATUS_ADDR))
#define RUNTIME_PERIL_MEM_DVS_VOTE (RUNTIME_VAR_BASE + 0xAC)
#define PERIL_MEM_DVS_VOTE (WORD_REF(RUNTIME_PERIL_MEM_DVS_VOTE))
#define RUNTIME_LAST_AO_SUSPEND_VOLT_ADDR (RUNTIME_VAR_BASE + 0xB0)
#define PERIL_LAST_AO_SUSPEND_VOLT (BYTE_REF(RUNTIME_LAST_AO_SUSPEND_VOLT_ADDR))
#define RUNTIME_AO_SUSPEND_VOLT_BIAS_ADDR (RUNTIME_VAR_BASE + 0xB1)
#define AO_SUSPEND_VOLT_BIAS (BYTE_REF(RUNTIME_AO_SUSPEND_VOLT_BIAS_ADDR))
#define RUNTIME_CPU_LOWTEMP_VOLT_BIAS_ADDR(n) (RUNTIME_VAR_BASE + 0xB2 + (n) * 1)
#define CPU_LOWTEMP_VOLT_BIAS(n) (BYTE_REF(RUNTIME_CPU_LOWTEMP_VOLT_BIAS_ADDR(n)))
#define RUNTIME_PRODUCT_FUNC_STATUS_ADDR (RUNTIME_VAR_BASE + 0xB6)
#define PRODUCT_FUNC_STATUS (BYTE_REF(RUNTIME_PRODUCT_FUNC_STATUS_ADDR))
#define RUNTIME_PERIL_VAR_END (RUNTIME_PRODUCT_FUNC_STATUS_ADDR)
...
#define RUNTIME_SLEEP_FAIL_ITEM_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x018)
#define SLEEP_FAIL_ITEM (WORD_REF(RUNTIME_SLEEP_FAIL_ITEM_ADDR))
#define RUNTIME_SLEEP_FAIL_ITEM_VALUE_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x01C)
#define SLEEP_FAIL_ITEM_VALUE (WORD_REF(RUNTIME_SLEEP_FAIL_ITEM_VALUE_ADDR))
#define RUNTIME_AP_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x020)
#define AP_WAKE_CNT (WORD_REF(RUNTIME_AP_WAKE_CNT_ADDR))
#define RUNTIME_HIFI_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x024)
#define HIFI_WAKE_CNT (WORD_REF(RUNTIME_HIFI_WAKE_CNT_ADDR))
#define RUNTIME_MODEM_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x028)
#define MODEM_WAKE_CNT (WORD_REF(RUNTIME_MODEM_WAKE_CNT_ADDR))
#define RUNTIME_IOMCU_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x02C)
#define IOM3_WAKE_CNT (WORD_REF(RUNTIME_IOMCU_WAKE_CNT_ADDR))
#define RUNTIME_LPMCU_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x030)
#define LPM3_WAKE_CNT (WORD_REF(RUNTIME_LPMCU_WAKE_CNT_ADDR))
#define RUNTIME_GENERAL_SEE_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x034)
#define GENERAL_SEE_WAKE_CNT (WORD_REF(RUNTIME_GENERAL_SEE_WAKE_CNT_ADDR))
#define RUNTIME_AP_SUSPEND_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x038)
#define AP_SUSPEND_CNT (WORD_REF(RUNTIME_AP_SUSPEND_CNT_ADDR))
#define RUNTIME_AP_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x03C)
#define AP_RESUME_CNT (WORD_REF(RUNTIME_AP_RESUME_CNT_ADDR))
#define RUNTIME_MODEM_SUSPEND_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x040)
#define MODEM_SUSPEND_CNT (WORD_REF(RUNTIME_MODEM_SUSPEND_CNT_ADDR))
#define RUNTIME_MODEM_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x044)
#define MODEM_RESUME_CNT (WORD_REF(RUNTIME_MODEM_RESUME_CNT_ADDR))
#define RUNTIME_HIFI_SUSPEND_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x048)
#define HIFI_SUSPEND_CNT (WORD_REF(RUNTIME_HIFI_SUSPEND_CNT_ADDR))
#define RUNTIME_HIFI_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x04C)
#define HIFI_RESUME_CNT (WORD_REF(RUNTIME_HIFI_RESUME_CNT_ADDR))
#define RUNTIME_IOMCU_SUSPEND_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x050)
#define IOM3_SUSPEND_CNT (WORD_REF(RUNTIME_IOMCU_SUSPEND_CNT_ADDR))
#define RUNTIME_IOMCU_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x054)
#define IOM3_RESUME_CNT (WORD_REF(RUNTIME_IOMCU_RESUME_CNT_ADDR))
#define RUNTIME_GENERAL_SEE_SUSPEND_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x058)
#define GENERAL_SEE_SUSPEND_CNT (WORD_REF(RUNTIME_GENERAL_SEE_SUSPEND_CNT_ADDR))
#define RUNTIME_GENERAL_SEE_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x05C)
#define GENERAL_SEE_RESUME_CNT (WORD_REF(RUNTIME_GENERAL_SEE_RESUME_CNT_ADDR))
#define RUNTIME_LIGHTSLEEP_WAKE_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x060)
#define LIGHTSLEEP_WAKE_IRQ (WORD_REF(RUNTIME_LIGHTSLEEP_WAKE_IRQ_ADDR))
#define RUNTIME_LIGHTSLEEP_WAKE_IRQ1_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x064)
#define LIGHTSLEEP_WAKE_IRQ1 (WORD_REF(RUNTIME_LIGHTSLEEP_WAKE_IRQ1_ADDR))
#define RUNTIME_SLEEP_WAKE_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x068)
#define SLEEP_WAKE_IRQ (WORD_REF(RUNTIME_SLEEP_WAKE_IRQ_ADDR))
#define RUNTIME_SLEEP_WAKE_IRQ1_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x06C)
#define SLEEP_WAKE_IRQ1 (WORD_REF(RUNTIME_SLEEP_WAKE_IRQ1_ADDR))
#define RUNTIME_WAKE_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x070)
#define WAKE_IRQ (WORD_REF(RUNTIME_WAKE_IRQ_ADDR))
#define RUNTIME_WAKE_IRQ1_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x074)
#define WAKE_IRQ1 (WORD_REF(RUNTIME_WAKE_IRQ1_ADDR))
#define RUNTIME_WAKE_IRQ2_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x078)
#define WAKE_IRQ2 (WORD_REF(RUNTIME_WAKE_IRQ2_ADDR))
#define RUNTIME_WAKE_IRQ3_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x07C)
#define WAKE_IRQ3 (WORD_REF(RUNTIME_WAKE_IRQ3_ADDR))
#define RUNTIME_AP_WAKE_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x080)
#define AP_WAKE_IRQ (WORD_REF(RUNTIME_AP_WAKE_IRQ_ADDR))
#define RUNTIME_MODEM_WAKE_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x084)
#define MODEM_WAKE_IRQ (WORD_REF(RUNTIME_MODEM_WAKE_IRQ_ADDR))
#define RUNTIME_HIFI_WAKE_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x088)
#define HIFI_WAKE_IRQ (WORD_REF(RUNTIME_HIFI_WAKE_IRQ_ADDR))
#define RUNTIME_AP_NSIPC_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x08C)
#define AP_NSIPC_IRQ (WORD_REF(RUNTIME_AP_NSIPC_IRQ_ADDR))
#define RUNTIME_AP_AO_NSIPC_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x090)
#define AP_AO_NSIPC_IRQ (WORD_REF(RUNTIME_AP_AO_NSIPC_IRQ_ADDR))
#define RUNTIME_GIC_OUT_IRQ_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x094)
...
#define RUNTIME_CPU_MEMORY_STEP0_VOLT_BIAS_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0x9C)
#define CPU_MEMVOLT_STEP0_BIAS (WORD_REF(RUNTIME_CPU_MEMORY_STEP0_VOLT_BIAS_ADDR))
#define RUNTIME_CPU_MEMORY_STEP1_VOLT_BIAS_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xA0)
#define CPU_MEMVOLT_STEP1_BIAS (WORD_REF(RUNTIME_CPU_MEMORY_STEP1_VOLT_BIAS_ADDR))
#define RUNTIME_CPU_MEMORY_STEP2_VOLT_BIAS_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xA4)
#define CPU_MEMVOLT_STEP2_BIAS (WORD_REF(RUNTIME_CPU_MEMORY_STEP2_VOLT_BIAS_ADDR))
#define RUNTIME_SLEEP_TIME_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xA8)
#define SYS_SLEEP_TIME (WORD_REF(RUNTIME_SLEEP_TIME_ADDR))
#define RUNTIME_SLEEP_CAN_ENTER_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xAC)
#define SYS_SLEEP_CAN_ENTER_CNT (WORD_REF(RUNTIME_SLEEP_CAN_ENTER_CNT_ADDR))
#define RUNTIME_CCPUNR_SUSPEND_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xB0)
#define CCPUNR_SUSPEND_CNT (WORD_REF(RUNTIME_CCPUNR_SUSPEND_CNT_ADDR))
#define RUNTIME_CCPUNR_RESUME_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xB4)
#define CCPUNR_RESUME_CNT (WORD_REF(RUNTIME_CCPUNR_RESUME_CNT_ADDR))
#define RUNTIME_AP_WAKE_IRQ_PIE_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xB8)
#define AP_WAKE_IRQ_PIE (WORD_REF(RUNTIME_AP_WAKE_IRQ_PIE_ADDR))
#define RUNTIME_MODEM_NR_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xBC)
#define MODEM_NR_WAKE_CNT (WORD_REF(RUNTIME_MODEM_NR_WAKE_CNT_ADDR))
#define RUNTIME_OTHER_WAKE_CNT_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xC0)
#define OTHER_WAKE_CNT (WORD_REF(RUNTIME_OTHER_WAKE_CNT_ADDR))
#define RUNTIME_CLENT_VOTE_TIME_ADDR(n) (RUNTIME_SR_VAR_BASE_ADDR + 0xC4 + (n) * 4)
#define CLENT_VOTE_TIME(n) (WORD_REF(RUNTIME_CLENT_VOTE_TIME_ADDR(n)))
#define RUNTIME_ONSYS_AVS_PARA_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xE8)
#define RUNTIME_ONSYS_AVS_PARA (WORD_REF(RUNTIME_SR_VAR_BASE_ADDR))
#define RUNTIME_ARMPC_SR_PARAMETER_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xEC)
#define ARMPC_SR_PARAMETER (WORD_REF(RUNTIME_ARMPC_SR_PARAMETER_ADDR))
#define RUNTIME_SPACE_ADDR_END (RUNTIME_ONSYS_AVS_PARA_ADDR)
...
#define SLEEP_FAIL_ITEM_OFFSET (RUNTIME_SLEEP_FAIL_ITEM_ADDR - RUNTIME_VAR_BASE)
#define SLEEP_FAIL_ITEM_VALUE_OFFSET (RUNTIME_SLEEP_FAIL_ITEM_VALUE_ADDR - RUNTIME_VAR_BASE)
...
#define FCM_OFF_CNT_OFFSET (RUNTIME_FCM_CNT_ADDR(0) - RUNTIME_VAR_BASE)
#define FCM_ON_CNT_OFFSET (RUNTIME_FCM_CNT_ADDR(1) - RUNTIME_VAR_BASE)
...
typedef enum MODULE_FUNC {
 ...
 LP_LPM3_PERI_MEM = (LP_LPM3 << 16) | 0x0019,
} MODULE_FUNC_T;
