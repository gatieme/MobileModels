...
#define LPMCU_FIRMWARE_PACK_BACKUP_SIZE (440 * 1024)
 ...
 #define LPMCU_FIRMWARE_PACK_BACKUP_USED_SIZE \
  (M3_AO_TCP_ADDR + M3_AO_TCP_ADDR_SIZE - LPMCU_FIRMWARE_PACK_BACKUP_ADDR)
...
#define M3_DDR_SHARE_MEM_SIZE 0x3A000
 ...
 #define M3_DDR_STORAGE_MEM_DDR_MPU_ADDR \
  (M3_DDR_INIT_XLOADER_TO_FASTBOOT_BASE + M3_DDR_INIT_XLOADER_TO_FASTBOOT_SIZE)
 #define M3_DDR_STORAGE_MEM_DDR_MPU_SIZE 0x400
 #define M3_DDR_STORAGE_MEM_DDR_SECURITY_ADDR \
  (M3_DDR_STORAGE_MEM_DDR_MPU_ADDR + M3_DDR_STORAGE_MEM_DDR_MPU_SIZE)
 #define M3_DDR_STORAGE_MEM_DDR_SECURITY_SIZE 0x3800
 #define UCE_FIRMWARE_BACKUP_ADDR \
  (M3_DDR_STORAGE_MEM_DDR_SECURITY_ADDR + M3_DDR_STORAGE_MEM_DDR_SECURITY_SIZE)
 ...
 #error m3_share_memory_addr(M3_DDR_SHARE_MEM_RESERVED_ADDR) \
  used beyond (M3_DDR_SHARE_MEM_ADDR + M3_DDR_SHARE_MEM_SIZE)
#endif
#define M3_DDR_MEM_RESERVED_ADDR (M3_DDR_SHARE_MEM_ADDR + M3_DDR_SHARE_MEM_SIZE)
 ...
 #error m3_memory_addr(M3_DDR_MEM_RESERVED_ADDR) \
  used beyond (LPMCU_SECURE_DDR_BASE_ADDR + LPMCU_SECURE_DDR_BASE_SIZE)
#endif
