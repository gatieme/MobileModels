...
#define SOC_ACPU_LP_RAM_BASE_ADDR 0xFFF50000
 ...
 defined(CONFIG_BL31_LOAD_LPMCU) || defined(CONFIG_DDR_BOOT)
...
#define LPMCU_GEN_MNTN_SIZE 0xC00
 ...
 #define INT_LONG_TIME_TRACK_BASE (PLL_MNTN_BASE + PLL_MNTN_SIZE)
...
#define LPMCU_DDR_MNTN_SIZE 0x1400
 ...
 #define DDRC_SAVE_DMC_RINT_SIZE 0x28
 ...
 #define DDRC_INIT_MNTN_BASE (DDRC_SAVE_BASE + DDRC_SAVE_SIZE)
 #define DDRC_INIT_MNTN_SIZE 0x20
#if ((DDRC_INIT_MNTN_BASE + DDRC_INIT_MNTN_SIZE) > (LPMCU_DDR_MNTN_BASE + LPMCU_DDR_MNTN_SIZE))
 #pragma message(PRINT_MACRO(DDRC_INIT_MNTN_BASE + DDRC_INIT_MNTN_SIZE))
