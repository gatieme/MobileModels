...
__LPM3_EXC_SUBTYPE_MAP(LPM3_S_EXCEPTION,LPM3EXCEPTION,PCSI_PERIMEM_ERR)
__LPM3_EXC_SUBTYPE_MAP(LPM3_S_EXCEPTION,LPM3EXCEPTION,PSCI_CPUSVFD_ERR)
...
__GENERAL_SEE_EXC_SUBTYPE_MAP(GENERAL_SEE_S_EXCEPTION, GENERAL_SEE_CRASH, EXC_RAM)
__GENERAL_SEE_EXC_SUBTYPE_MAP(GENERAL_SEE_S_EXCEPTION, GENERAL_SEE_CRASH, EXC_SECBOOT)
__GENERAL_SEE_EXC_SUBTYPE_MAP(GENERAL_SEE_S_EXCEPTION, GENERAL_SEE_CRASH, EXC_SECFLASH)
