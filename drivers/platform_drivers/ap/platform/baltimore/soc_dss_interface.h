...
#define SOC_ACPU_BLPWM_BASE_ADDR (SOC_ACPU_PWM_BASE_ADDR)
...
#define DBUF0_DEPTH (4416)
#define DBUF1_DEPTH (512)
#define DBUF_WIDTH_BIT (120)
...
enum dss_dfc_format {
    DFC_PIXEL_FORMAT_RGB_565 = 0x0,
    DFC_PIXEL_FORMAT_XRGB_4444 = 0x1,
    DFC_PIXEL_FORMAT_ARGB_4444 = 0x2,
    DFC_PIXEL_FORMAT_XRGB_5551 = 0x3,
    DFC_PIXEL_FORMAT_ARGB_5551 = 0x4,
    DFC_PIXEL_FORMAT_XRGB_8888 = 0x5,
    DFC_PIXEL_FORMAT_ARGB_8888 = 0x6,
    DFC_PIXEL_FORMAT_BGR_565 = 0x7,
    DFC_PIXEL_FORMAT_XBGR_4444 = 0x8,
    DFC_PIXEL_FORMAT_ABGR_4444 = 0x9,
    DFC_PIXEL_FORMAT_XBGR_5551 = 0xA,
    DFC_PIXEL_FORMAT_ABGR_5551 = 0xB,
    DFC_PIXEL_FORMAT_XBGR_8888 = 0xC,
    DFC_PIXEL_FORMAT_ABGR_8888 = 0xD,
    DFC_PIXEL_FORMAT_YUV444 = 0xE,
    DFC_PIXEL_FORMAT_YVU444 = 0xF,
    DFC_PIXEL_FORMAT_YUYV422 = 0x10,
    DFC_PIXEL_FORMAT_YVYU422 = 0x11,
    DFC_PIXEL_FORMAT_VYUY422 = 0x12,
    DFC_PIXEL_FORMAT_UYVY422 = 0x13,
    DFC_PIXEL_FORMAT_BGRA_1010102 = 0x14,
    DFC_PIXEL_FORMAT_YUVA_1010102 = 0x15,
    DFC_PIXEL_FORMAT_UYVA_1010102 = 0x16,
    DFC_PIXEL_FORMAT_VUYA_1010102 = 0x17,
    DFC_PIXEL_FORMAT_YUYV_10 = 0x18,
    DFC_PIXEL_FORMAT_UYVY_10 = 0x19,
    DFC_PIXEL_FORMAT_UYVY_Y8 = 0x1A,
};
enum dss_dma_format {
    DMA_PIXEL_FORMAT_RGB_565 = 0x0,
    DMA_PIXEL_FORMAT_ARGB_4444 = 0x1,
    DMA_PIXEL_FORMAT_XRGB_4444 = 0x2,
    DMA_PIXEL_FORMAT_ARGB_5551 = 0x3,
    DMA_PIXEL_FORMAT_XRGB_5551 = 0x4,
    DMA_PIXEL_FORMAT_ARGB_8888 = 0x5,
    DMA_PIXEL_FORMAT_XRGB_8888 = 0x6,
    DMA_PIXEL_FORMAT_RESERVED0 = 0x7,
    DMA_PIXEL_FORMAT_YUYV_422_Pkg = 0x8,
    DMA_PIXEL_FORMAT_YUV_420_SP_HP = 0x9,
    DMA_PIXEL_FORMAT_YUV_420_P_HP = 0xA,
    DMA_PIXEL_FORMAT_YUV_422_SP_HP = 0xB,
    DMA_PIXEL_FORMAT_YUV_422_P_HP = 0xC,
    DMA_PIXEL_FORMAT_AYUV_4444 = 0xD,
    DMA_PIXEL_FORMAT_RESERVED1 = 0xE,
    DMA_PIXEL_FORMAT_RESERVED2 = 0xF,
    DMA_PIXEL_FORMAT_RGBA_1010102 = 0x10,
    DMA_PIXEL_FORMAT_Y410_10BIT = 0x11,
    DMA_PIXEL_FORMAT_YUV422_10BIT = 0x12,
    DMA_PIXEL_FORMAT_YUV420_SP_10BIT = 0x13,
    DMA_PIXEL_FORMAT_YUV422_SP_10BIT = 0x14,
    DMA_PIXEL_FORMAT_YUV420_P_10BIT = 0x15,
    DMA_PIXEL_FORMAT_YUV422_P_10BIT = 0x16,
};
enum dss_buf_format {
    DSS_BUF_LINEAR = 0,
    DSS_BUF_TILE,
...
enum dss_axi_idx {
    ...
    AXI_RT_CHN1 = 2,
    AXI_SRT_CHN1 = 3,
    AXI_CHN0 = AXI_RT_CHN0,
    AXI_CHN1 = AXI_SRT_CHN0,
    AXI_CHN2 = AXI_RT_CHN1,
    AXI_CHN3 = AXI_SRT_CHN1,
    AXI_CHN_MAX,
};
...
#define MEDIA_CRG_BASE (0xE8001000)
#define MEDIA1_TCU_BASE (0xE8003000)
#define ACTRL_BASE (0xFA894000)
#define CLK_DIV0 (0x060)
#define CLK_DIV2 (0x068)
#define PMU_SSI0_BASE (0xFFF34000)
#define LDO4_ONOFF_ECO (0x062)
#define LDO4_VSET (0x063)
#define LDO17_ONOFF_ECO (0x07A)
#define LDO17_VSET (0x07B)
#define LDO23_ONOFF_ECO (0x084)
#define LDO23_VSET (0x085)
#define PEREN0 (0x000)
...
#define PEREN7 (0x420)
#define PERDIS7 (0x424)
#define NOC_POWER_IDLEREQ (0x398)
#define NOC_POWER_IDLEACK (0x39c)
#define NOC_POWER_IDLE (0x374)
#define PERI_INT1_MASK (0x3A8)
#define PERI_INT1_STAT (0x3AC)
...
#define PERI_STAT29 (0x100)
#define PERI_STAT53 (0x160)
#define PERI_STAT55 (0x168)
#define PERI_STAT58 (0x174)
#define PERI_STAT63 (0x188)
#define SMMU_TCU_CTRL_SCR (0x30090)
#define ISO_EN_GROUP1_PERI (0x004)
#define MTCMOS_EN_GROUP0_PERI (0x010)
#define BISR_REPAIR_ACK_STATUS0 (0x058)
...
#define MEDIA_PERRSTSTAT0 (0x038)
#define MEDIA_PERRSTEN1 (0x03C)
#define MEDIA_PERRSTDIS1 (0x040)
#define MEDIA_CLKDIV1 (0x064)
#define MEDIA_CLKDIV2 (0x068)
#define MEDIA_CLKDIV7 (0x07C)
#define MEDIA_CLKDIV8 (0x080)
#define MEDIA_CLKDIV9 (0x084)
#define MEDIA_PEREN1 (0x010)
#define MEDIA_PEREN2 (0x020)
#define MEDIA_PERRSTDIS_ISP_SEC (0x804)
#define PERRSTEN_GENERAL_SEC (0xA00)
#define PERRSTDIS_GENERAL_SEC (0xA04)
#define MEDIA_PEREN0_GENERAL_SEC (0xA30)
#define MEDIA_PERDIS0_GENERAL_SEC (0xA34)
#define PMCTRL_PERI_CTRL4 (0x350)
#define PMCTRL_PERI_CTRL5 (0x354)
...
#define PCTRL_RESOURCE3_LOCK (0x424)
#define PCTRL_RESOURCE3_UNLOCK (0x428)
#define PCTRL_RESOURCE3_LOCK_STATUS (0x42C)
...
#define BIT_DSS_WB_ERR_INT BIT(29)
#define BIT_DP_DSS_GLB_INTS BIT(29)
#define BIT_DP_MMU_IRPT_S BIT(28)
#define BIT_DP_MMU_IRPT_NS BIT(27)
#define BIT_DP_DBG_MCTL_INTS BIT(26)
#define BIT_DP_DBG_WCH1_INTS BIT(25)
#define BIT_DP_DBG_WCH0_INTS BIT(24)
#define BIT_DP_DBG_RCH7_INTS BIT(23)
#define BIT_DP_DBG_RCH6_INTS BIT(22)
#define BIT_DP_DBG_RCH5_INTS BIT(21)
#define BIT_DP_DBG_RCH4_INTS BIT(20)
#define BIT_DP_DBG_RCH3_INTS BIT(19)
#define BIT_DP_DBG_RCH2_INTS BIT(18)
#define BIT_DP_DBG_RCH1_INTS BIT(17)
#define BIT_DP_DBG_RCH0_INTS BIT(16)
#define BIT_DP_ITF2_INTS BIT(15)
#define BIT_DP_CMDLIST13 BIT(14)
#define BIT_DP_CMDLIST12 BIT(13)
#define BIT_DP_CMDLIST11 BIT(12)
#define BIT_DP_CMDLIST10 BIT(11)
#define BIT_DP_CMDLIST9 BIT(10)
#define BIT_DP_CMDLIST8 BIT(9)
#define BIT_DP_CMDLIST7 BIT(8)
#define BIT_DP_CMDLIST6 BIT(7)
#define BIT_DP_CMDLIST5 BIT(6)
#define BIT_DP_CMDLIST4 BIT(5)
#define BIT_DP_CMDLIST3 BIT(4)
#define BIT_DP_SDP_CMDLIST2 BIT(3)
#define BIT_DP_CMDLIST1 BIT(2)
#define BIT_DP_CMDLIST0 BIT(1)
#define BIT_DP_RCH_CE_INTS BIT(0)
...
#define BIT_HALF_FRM BIT(16)
#define BIT_QUARTER_FRM BIT(15)
...
#define BIT_WB_ONLINE_ERR_INTS BIT(0)
#define BIT_WB_ONLINE_ERR_INT_MSK BIT(0)
...
#define DSS_SMMU1_OFFSET (0x84000)
...
#define DSS_RCH_TV0_OFFSET (0x5B000)
#define DSS_RCH_TV1_OFFSET (0x61800)
#define RCH_TV_CLK_SEL (0x00028)
...
#define DSS_WCH0_POST_CLIP_OFFSET (0x5A480)
...
#define DSS_WCH1_GMP_OFFSET (0x5CB00)
#define DSS_WCH1_GMP_LUT_OFFSET (0x5A000)
#define WCH1_GMP_EN (0x000)
#define WCH1_GMP_MEM_CTRL (0x004)
#define WCH1_GMP_LUT_SEL (0x008)
#define WCH1_GMP_DBG_W0 (0x010)
#define WCH1_GMP_DBG_R0 (0x014)
#define WCH1_GMP_DBG_R1 (0x018)
#define WCH1_GMP_DBG_R2 (0x01C)
#define WCH1_GMP_DBG_R3 (0x020)
#define DSS_OVL0_OFFSET (0x60000)
#define DSS_OVL1_OFFSET (0x60400)
#define DSS_OVL2_OFFSET (0x60800)
#define DSS_OVL3_OFFSET (0x60C00)
#define DSS_DBUF0_OFFSET (0x6E000)
#define DSS_DBUF1_OFFSET (0xCE000)
#define DSS_HI_ACE_OFFSET (0x6F000)
#define DSS_DISP_GLB_OFFSET (0xA1000)
#define DSS_DISP_GLB_REG_DEFAULT (0x114)
#define DSS_DISP_CH0_OFFSET (0x62000)
#define DSS_WB_UNPACK_OFFSET (DSS_DISP_CH0_OFFSET + 0x300)
#define DSS_DISP_CH1_OFFSET (0xA2000)
#define DSS_DISP_CH2_OFFSET (0xC2000)
#define DSS_DPP_OFFSET (0x70000)
#define DSS_TOP_OFFSET (0x70000)
#define DSS_DPP_COLORBAR_OFFSET (0x70100)
#define DSS_DPP_CLIP_OFFSET (0x63600)
#define DSS_DPP_DITHER_OFFSET (0x63500)
#define DSS_DPP_CSC_RGB2YUV10B_OFFSET (0x70300)
#define DSS_DPP_CSC_YUV2RGB10B_OFFSET (0x70400)
#define DSS_DPP_PCSC_OFFSET (0x62900)
#define DSS_DISP_CH0_CSC (0x62A00)
#define DSS_DPP_GAMA_OFFSET (0x70600)
#define DSS_DPP_ACM_OFFSET (0x70700)
#define DSS_DPP_XCC_PRE_OFFSET (0x70800)
...
#define DSS_DPP_GMP_LUT_OFFSET (0xDE000)
#define DSS_DPP_GAMA_PRE_LUT_OFFSET (0x75000)
#define DSS_DPP_DEGAMMA_LUT_OFFSET (0x72000)
#define DSS_DPP_ARSR_POST_LUT_OFFSET (0x7B000)
#define DSS_DPP1_OFFSET (0xB0000)
#define DSS_DPP1_GAMA_OFFSET (0xB0600)
#define DSS_DPP1_XCC_OFFSET (0xB0900)
#define DSS_DPP1_DEGAMMA_OFFSET (0xB0950)
#define DSS_DPP1_GMP_OFFSET (0xB09A0)
#define DSS_HDR_OFFSET (0xD5000)
#define DSS_HDR_RD_SHADOW (0x0)
#define DSS_HDR_REG_DEFAULT (0x4)
#define DSS_HDR_MEM_READ (0x8)
#define DSS_HDR_MEM_CTRL (0xC)
#define DSS_HDR_CLK_SEL (0x10)
#define DSS_HDR_CLK_EN (0x14)
#define DSS_HDR_CTROL (0x18)
#define DSS_HDR_ROI_WIN1_STA (0x1C)
#define DSS_HDR_ROI_WIN1_END (0x20)
#define DSS_HDR_ROI_WIN2_STA (0x24)
#define DSS_HDR_ROI_WIN2_END (0x28)
#define DSS_HDR_STAT_WIN1_STA (0x2C)
#define DSS_HDR_STAT_WIN1_END (0x30)
#define DSS_HDR_STAT_WIN2_STA (0x34)
#define DSS_HDR_STAT_WIN2_END (0x38)
#define DSS_HDR_INV_SIZE (0x3C)
#define DSS_HDR_STAT_WIN1_INV_SIZE (0x40)
#define DSS_HDR_STAT_WIN2_INV_SIZE (0x44)
#define DSS_LTM_CTROL (0x100)
#define DSS_LTM_IQTM_CFG0 (0x104)
#define DSS_LTM_IQTM_CFG1 (0x108)
#define DSS_LTM_ROI (0x10C)
#define DSS_LTM_RGB2YUV_CSC_IDC0 (0x110)
#define DSS_LTM_RGB2YUV_CSC_IDC2 (0x114)
#define DSS_LTM_RGB2YUV_CSC_ODC0 (0x118)
#define DSS_LTM_RGB2YUV_CSC_ODC2 (0x11C)
#define DSS_LTM_RGB2YUV_CSC_P00 (0x120)
#define DSS_LTM_RGB2YUV_CSC_P01 (0x124)
#define DSS_LTM_RGB2YUV_CSC_P02 (0x128)
#define DSS_LTM_RGB2YUV_CSC_P10 (0x12C)
#define DSS_LTM_RGB2YUV_CSC_P11 (0x130)
#define DSS_LTM_RGB2YUV_CSC_P12 (0x134)
#define DSS_LTM_RGB2YUV_CSC_P20 (0x138)
#define DSS_LTM_RGB2YUV_CSC_P21 (0x13C)
#define DSS_LTM_RGB2YUV_CSC_P22 (0x140)
#define DSS_LTM_YUV2RGB_CSC_IDC0 (0x144)
#define DSS_LTM_YUV2RGB_CSC_IDC2 (0x148)
#define DSS_LTM_YUV2RGB_CSC_ODC0 (0x14C)
#define DSS_LTM_YUV2RGB_CSC_ODC2 (0x150)
#define DSS_LTM_YUV2RGB_CSC_P00 (0x154)
#define DSS_LTM_YUV2RGB_CSC_P01 (0x158)
#define DSS_LTM_YUV2RGB_CSC_P02 (0x15C)
#define DSS_LTM_YUV2RGB_CSC_P10 (0x160)
#define DSS_LTM_YUV2RGB_CSC_P11 (0x164)
#define DSS_LTM_YUV2RGB_CSC_P12 (0x168)
#define DSS_LTM_YUV2RGB_CSC_P20 (0x16C)
#define DSS_LTM_YUV2RGB_CSC_P21 (0x170)
#define DSS_LTM_YUV2RGB_CSC_P22 (0x174)
#define DSS_LTM_MEAN_STT (0x178)
#define DSS_LTM_MEAN_STAT1 (0x17C)
#define DSS_LTM_MEAN_STAT2 (0x180)
#define DSS_ITM_SLF_CTRL (0x200)
#define DSS_ITM_ROI (0x204)
#define DSS_ITM_SLF_DEGAMMA_STEP1 (0x208)
#define DSS_ITM_SLF_DEGAMMA_STEP2 (0x20C)
#define DSS_ITM_SLF_DEGAMMA_POS1 (0x210)
#define DSS_ITM_SLF_DEGAMMA_POS2 (0x214)
#define DSS_ITM_SLF_DEGAMMA_POS3 (0x218)
#define DSS_ITM_SLF_DEGAMMA_POS4 (0x21C)
#define DSS_ITM_SLF_DEGAMMA_NUM1 (0x220)
#define DSS_ITM_SLF_DEGAMMA_NUM2 (0x224)
#define DSS_ITM_SLF_GAMUT_COEF00_0 (0x228)
#define DSS_ITM_SLF_GAMUT_COEF01_0 (0x22C)
#define DSS_ITM_SLF_GAMUT_COEF02_0 (0x230)
#define DSS_ITM_SLF_GAMUT_COEF10_0 (0x234)
#define DSS_ITM_SLF_GAMUT_COEF11_0 (0x238)
#define DSS_ITM_SLF_GAMUT_COEF12_0 (0x23C)
#define DSS_ITM_SLF_GAMUT_COEF20_0 (0x240)
#define DSS_ITM_SLF_GAMUT_COEF21_0 (0x244)
#define DSS_ITM_SLF_GAMUT_COEF22_0 (0x248)
#define DSS_ITM_SLF_GAMUT_SCALE (0x24C)
#define DSS_ITM_SLF_GAMUT_CLIP_MAX (0x250)
#define DSS_ITM_SLF_GAMUT_COEF00_1 (0x254)
#define DSS_ITM_SLF_GAMUT_COEF01_1 (0x258)
#define DSS_ITM_SLF_GAMUT_COEF02_1 (0x25C)
#define DSS_ITM_SLF_GAMUT_COEF10_1 (0x260)
#define DSS_ITM_SLF_GAMUT_COEF11_1 (0x264)
#define DSS_ITM_SLF_GAMUT_COEF12_1 (0x268)
#define DSS_ITM_SLF_GAMUT_COEF20_1 (0x26C)
#define DSS_ITM_SLF_GAMUT_COEF21_1 (0x270)
#define DSS_ITM_SLF_GAMUT_COEF22_1 (0x274)
#define DSS_ITM_SLF_GAMMA_STEP1 (0x278)
#define DSS_ITM_SLF_GAMMA_STEP2 (0x27C)
#define DSS_ITM_SLF_GAMMA_POS1 (0x280)
#define DSS_ITM_SLF_GAMMA_POS2 (0x284)
#define DSS_ITM_SLF_GAMMA_POS3 (0x288)
#define DSS_ITM_SLF_GAMMA_POS4 (0x28C)
#define DSS_ITM_SLF_GAMMA_POS5 (0x290)
#define DSS_ITM_SLF_GAMMA_POS6 (0x294)
#define DSS_ITM_SLF_GAMMA_POS7 (0x298)
#define DSS_ITM_SLF_GAMMA_POS8 (0x29C)
#define DSS_ITM_SLF_GAMMA_NUM1 (0x2a0)
#define DSS_ITM_SLF_GAMMA_NUM2 (0x2a4)
#define DSS_ITM_SLF_LCPROC_MIN_E (0x2a8)
#define DSS_ITM_SLF_LCPROC_CLIP (0x2ac)
#define DSS_ITM_SLF_LCPROC_SCALE (0x2b0)
#define DSS_ITM_SLF_LCPROC_THRESHOLD (0x2b4)
#define DSS_ITM_SLF_LCPROC_Y_TRANSFM0 (0x2b8)
#define DSS_ITM_SLF_LCPROC_Y_TRANSFM1 (0x2bc)
#define DSS_ITM_SLF_LCPROC_OUT_BIT (0x2c0)
#define DSS_ITM_SLF_LCPROC_CRATIOCLIP (0x2c4)
#define DSS_GTM_SLF_CTRL (0x700)
#define DSS_GTM_ROI (0x704)
#define DSS_GTM_SLF_LCPROC_MIN_E (0x708)
#define DSS_GTM_SLF_LCPROC_CLIP (0x70C)
#define DSS_GTM_SLF_LCPROC_SCALE (0x710)
#define DSS_GTM_SLF_LCPROC_THRESHOLD (0x714)
#define DSS_GTM_SLF_LCPROC_Y_TRANSFM0 (0x718)
#define DSS_GTM_SLF_LCPROC_Y_TRANSFM1 (0x71C)
#define DSS_GTM_SLF_LCPROC_OUT_BIT (0x720)
#define DSS_GTM_SLF_LCPROC_CRATIOCLIP (0x724)
#define DSS_GTM_SLF_PQ2SLF_STEP1 (0x728)
#define DSS_GTM_SLF_PQ2SLF_STEP2 (0x72C)
#define DSS_GTM_SLF_PQ2SLF_POS1 (0x730)
#define DSS_GTM_SLF_PQ2SLF_POS2 (0x734)
#define DSS_GTM_SLF_PQ2SLF_POS3 (0x738)
#define DSS_GTM_SLF_PQ2SLF_POS4 (0x73C)
#define DSS_GTM_SLF_PQ2SLF_POS5 (0x740)
#define DSS_GTM_SLF_PQ2SLF_POS6 (0x744)
#define DSS_GTM_SLF_PQ2SLF_POS7 (0x748)
#define DSS_GTM_SLF_PQ2SLF_POS8 (0x74C)
#define DSS_GTM_SLF_PQ2SLF_NUM1 (0x750)
#define DSS_GTM_SLF_PQ2SLF_NUM2 (0x754)
#define DSS_ITM_LUT_DEGAMMA (0x2C00)
#define DSS_ITM_LUT_GAMMA (0x2D00)
#define DSS_ITM_LUT_LUMA (0x2E00)
#define DSS_ITM_LUT_CHROMA (0x3000)
#define DSS_ITM_LUT_CHROMA0 (0x3200)
#define DSS_ITM_LUT_CHROMA1 (0x3400)
#define DSS_ITM_LUT_CHROMA2 (0x3600)
#define DSS_ITM_LUT_LUMALUT0 (0x3800)
#define DSS_ITM_LUT_CHROMALUT0 (0x3880)
#define DSS_U_HDR_GTM_LUT_0 (0x3D80)
#define DSS_U_HDR_GTM_LUT_1 (0x3E00)
#define DSS_U_HDR_GTM_LUT_2 (0x4000)
#define DSS_U_HDR_GTM_LUT_3 (0x4200)
#define DSS_U_HDR_GTM_LUT_4 (0x4400)
#define DSS_U_HDR_GTM_LUT_5 (0x4600)
#define DSS_U_HDR_GTM_LUT_6 (0x4800)
#define DSS_U_HDR_GTM_LUT_7 (0x4880)
#define ACE_HIST0 (0x000)
#define ACE_HIST1 (0x400)
#define ACE_LUT0 (0x800)
#define ACE_LUT1 (0xA00)
#define DSS_POST_SCF_OFFSET (DSS_DISP_CH0_OFFSET + 0x800)
...
#define DSS_DSC_OFFSET_1 (0xDDC00)
#define DSS_LDI1_OFFSET (0xBD000)
#define DSS_LDI_DP_OFFSET (0x7E000)
#define DSS_LDI_DP1_OFFSET (0x7F000)
#define DSS_PIPE_SW_DSI0_OFFSET (0xBE000)
#define DSS_PIPE_SW_DSI1_OFFSET (0xBE040)
#define DSS_PIPE_SW_DP_OFFSET (0xBE080)
#define DSS_PIPE_SW3_OFFSET (0xBE0C0)
#define DSS_PIPE_SW_WB_OFFSET (0xBE100)
#define DSS_WB_OFFSET (0xA0000)
#define DSS_DPP_CH0_GAMA_OFFSET (0x70600)
#define DSS_DPP_CH1_GAMA_OFFSET (0xB0600)
#define DSS_DPP_CH0_XCC_OFFSET (0x70900)
#define DSS_DPP_CH1_XCC_OFFSET (0xB0900)
#define DSS_DPP_CH0_DEGAMMA_OFFSET (0x70950)
#define DSS_DPP_CH1_DEGAMMA_OFFSET (0xB0950)
#define DSS_DPP_CH0_GMP_OFFSET (0x709A0)
#define DSS_DPP_CH1_GMP_OFFSET (0xB09A0)
#define DSS_DPP_CH0_GAMA_LUT_OFFSET (0x71000)
#define DSS_DPP_CH1_GAMA_LUT_OFFSET (0xB1000)
#define DSS_DPP_CH0_DEGAMMA_LUT_OFFSET (0x72000)
#define DSS_DPP_CH1_DEGAMMA_LUT_OFFSET (0xB2000)
#define DSS_DPP_CH0_GMP_LUT_OFFSET (0xDE000)
#define DSS_DPP_CH1_GMP_LUT_OFFSET (0xEE000)
#define DSS_DPP_POST_XCC_OFFSET (0x63700)
#define DPPSW_SIG_CTRL (0x000)
#define DPPSW_DAT_CTRL (0x004)
#define IFBCSW_SIG_CTRL (0x008)
#define IFBCSW_DAT_CTRL (0x00C)
#define ROI1_TOP_LEFT (0x010)
#define ROI1_BOTTOM_RIGHT (0x014)
#define ROI2_TOP_LEFT (0x018)
#define ROI2_BOTTOM_RIGHT (0x01C)
#define DYN_SW_DEFAULT (0x020)
#define HDRSW_SIG_CTRL (0x220)
#define HDRSW_DAT_CTRL (0x224)
#define RGB_HIST_EN (0x0044)
#define R0_HIST (0x0050)
#define G0_HIST (0x0090)
#define B0_HIST (0x00D0)
...
#define CMD_SYNC_MODE (0x074C)
#define CMD_CFG_FLAG (0x0750)
#define DPU_MIN_ROT_AFBCE_BLOCK_SIZE (256)
#define DPU_MAX_ROT_AFBCE_BLOCK_SIZE (480)
...
#define AIF0_MONITOR_OS_R0 (DSS_VBIF0_AIF + 0x8D0)
#define AIF0_MONITOR_OS_R1 (DSS_VBIF0_AIF + 0x08E0)
#define AIF0_MONITOR_OS_R2 (DSS_VBIF0_AIF + 0x08E4)
#define AIF0_MONITOR_OS_R3 (DSS_VBIF0_AIF + 0x08E8)
#define AIF0_MONITOR_OS_R4 (DSS_VBIF0_AIF + 0x08EC)
#define AIF_CH_CTL (0x0000)
#define AIF_CH_HS (0x0004)
#define AIF_CH_LS (0x0008)
#define ARCACH0_ADDR_THRH (0x018C)
#define ARCACH0_ADDR_THRL (0x0190)
#define ARCACH0_VALUE0 (0x0194)
#define ARCACH0_VALUE1 (0x0198)
#define ARCACH1_ADDR_THRH (0x019C)
#define ARCACH1_ADDR_THRL (0x01A0)
#define ARCACH1_VALUE0 (0x01A4)
#define ARCACH1_VALUE1 (0x01A8)
#define AWCACH0_ADDR_THRH (0x01AC)
#define AWCACH0_ADDR_THRL (0x01B0)
#define AWCACH0_VALUE0 (0x01B4)
#define AWCACH0_VALUE1 (0x01B8)
#define ARCACH2_ADDR_THRH (0x0240)
#define ARCACH2_ADDR_THRL (0x0244)
#define ARCACH2_VALUE0 (0x0248)
#define ARCACH2_VALUE1 (0x024C)
#define AWCACH2_ADDR_THRH (0x0250)
#define AWCACH2_ADDR_THRL (0x0254)
#define AWCACH2_VALUE0 (0x0258)
#define AWCACH2_VALUE1 (0x025C)
#define ARCACH3_ADDR_THRH (0x0260)
#define ARCACH3_ADDR_THRL (0x0264)
#define ARCACH3_VALUE0 (0x0268)
#define ARCACH3_VALUE1 (0x026C)
#define AIF_CH_MID_0 (0x0400)
#define AIF_CH_MID_1 (0x0404)
#define AIF_CH_MID_2 (0x0408)
#define AIF_CH_MID_3 (0x040c)
#define AIF_CH_MID_4 (0x0410)
#define AIF_CH_MID_5 (0x0414)
#define AIF_CH_MID_6 (0x0418)
#define AIF_CH_MID_7 (0x041c)
#define AIF_CH_MID_8 (0x0420)
#define AIF_CH_MID_9 (0x0424)
#define AIF_CH_MID_10 (0x0428)
#define AIF_CH_MID_11 (0x042c)
#define AIF_CH_MID_12 (0x0430)
#define AIF_CH_MID_CMD (0x0434)
#define DSS0_MID (0x0438)
#define DSS1_MID (0x043c)
#define DSS2_MID (0x0440)
#define DSS3_MID (0x0444)
#define MMU_ID_ATTR_0 (0x0500)
#define MMU_ID_ATTR_1 (0x0504)
#define MMU_ID_ATTR_2 (0x0508)
#define MMU_ID_ATTR_3 (0x050c)
#define MMU_ID_ATTR_4 (0x0510)
#define MMU_ID_ATTR_5 (0x0514)
#define MMU_ID_ATTR_6 (0x0518)
#define MMU_ID_ATTR_7 (0x051c)
#define MMU_ID_ATTR_8 (0x0520)
#define MMU_ID_ATTR_9 (0x0524)
#define MMU_ID_ATTR_10 (0x0528)
#define MMU_ID_ATTR_11 (0x052c)
#define MMU_ID_ATTR_12 (0x0530)
#define MMU_ID_ATTR_13 (0x0534)
#define MMU_ID_ATTR_NS_0 (0x0580)
#define MMU_ID_ATTR_NS_1 (0x0584)
#define MMU_ID_ATTR_NS_2 (0x0588)
#define MMU_ID_ATTR_NS_3 (0x058c)
#define MMU_ID_ATTR_NS_4 (0x0590)
#define MMU_ID_ATTR_NS_5 (0x0594)
#define MMU_ID_ATTR_NS_6 (0x0598)
#define MMU_ID_ATTR_NS_7 (0x059c)
#define MMU_ID_ATTR_NS_8 (0x05a0)
#define MMU_ID_ATTR_NS_9 (0x05a4)
#define MMU_ID_ATTR_NS_10 (0x05a8)
#define MMU_ID_ATTR_NS_11 (0x05ac)
#define MMU_ID_ATTR_NS_12 (0x05b0)
#define MMU_ID_ATTR_NS_13 (0x05b4)
#define AXI2_RID_MSK0 (0x0720)
#define AXI2_RID_MSK1 (0x0724)
#define AXI2_WID_MSK (0x0728)
#define AXI2_R_QOS_MAP (0x072c)
#define AXI3_RID_MSK0 (0x0730)
#define AXI3_RID_MSK1 (0x0734)
#define AXI3_WID_MSK (0x0738)
#define AXI3_R_QOS_MAP (0x073c)
...
#define MIF_CLK_CTL (0x0000)
#define MIF_ENABLE (MIF_CLK_CTL)
#define MIF_MEM_CTRL (0x0004)
#define MIF_SHADOW_READ (0x0008)
...
#define MIF_CH8_OFFSET (DSS_MIF_OFFSET + MIF_CTRL_OFFSET*10)
#define MIF_CH9_OFFSET (DSS_MIF_OFFSET + MIF_CTRL_OFFSET*11)
#define MIF_CH10_OFFSET (DSS_MIF_OFFSET + MIF_CTRL_OFFSET*9)
...
#define CLD_OFFSET (DSS_RCH_D2_DMA_OFFSET)
#define CLD_EN (0x0B00)
#define CLD_SIZE_VRT (0x0B04)
#define CLD_SIZE_HRZ (0x0B08)
#define CLD_RGB (0x0B0C)
struct dss_cld {
    uint32_t cld_en;
    uint32_t size_vrt;
    uint32_t size_hrz;
    uint32_t cld_rgb;
    uint32_t cld_clk_en;
    uint32_t cld_clk_sel;
};
#define ALSC_OFFSET (DSS_DISP_CH0_OFFSET)
...
#define ARSR2P_SHARP_CFG3 (0x058)
#define ARSR2P_SHARP_CFG4 (0x05C)
#define ARSR2P_SHARP_CFG5 (0x060)
#define ARSR2P_SHARP_CFG6 (0x064)
#define ARSR2P_SHARP_CFG7 (0x068)
#define ARSR2P_SHARP_CFG8 (0x06C)
#define ARSR2P_SHARP_LEVEL (0x070)
#define ARSR2P_SHARP_GAIN_LOW (0x074)
#define ARSR2P_SHARP_GAIN_MID (0x078)
#define ARSR2P_SHARP_GAIN_HIGH (0x07C)
#define ARSR2P_SHARP_GAINCTRLSLOPH_MF (0x080)
#define ARSR2P_SHARP_GAINCTRLSLOPL_MF (0x084)
#define ARSR2P_SHARP_GAINCTRLSLOPH_HF (0x088)
#define ARSR2P_SHARP_GAINCTRLSLOPL_HF (0x08C)
#define ARSR2P_SHARP_MF_LMT (0x090)
#define ARSR2P_SHARP_GAIN_MF (0x094)
#define ARSR2P_SHARP_MF_B (0x098)
#define ARSR2P_SHARP_HF_LMT (0x09C)
#define ARSR2P_SHARP_GAIN_HF (0x0A0)
#define ARSR2P_SHARP_HF_B (0x0A4)
#define ARSR2P_SHARP_LF_CTRL (0x0A8)
#define ARSR2P_SHARP_LF_VAR (0x0AC)
#define ARSR2P_SHARP_LF_CTRL_SLOP (0x0B0)
#define ARSR2P_SHARP_HF_SELECT (0x0B4)
#define ARSR2P_SHARP_CFG2_H (0x0B8)
#define ARSR2P_SHARP_CFG2_L (0x0BC)
...
#define HEBCE_SPBLOCK_MODE (0x978)
...
#define HEBCD_MEM_CTRL (0x9F0)
#define HEBCE_MEM_CTRL (0x9AC)
#define HEBC_MMBUF_BLOCK0_RGB_LINE_NUM (4)
#define HEBC_MMBUF_BLOCK0_Y8_LINE_NUM (8)
#define HEBC_MMBUF_BLOCK0_C8_LINE_NUM (8)
#define HEBC_MMBUF_BLOCK1_RGB_LINE_NUM (8)
#define HEBC_MMBUF_BLOCK1_Y8_LINE_NUM (16)
#define HEBC_MMBUF_BLOCK1_C8_LINE_NUM (16)
#define HEBC_HEADER_ADDR_ALIGN (4)
#define HEBC_HEADER_STRIDE_ALIGN (32)
#define HEBC_HEADER_STRIDE_BLOCK (4)
#define HEBC_BLOCK0_RGB_WIDTH_ALIGN (32)
#define HEBC_BLOCK0_RGB_HEIGHT_ALIGN (4)
#define HEBC_BLOCK0_YUV_WIDTH_ALIGN (64)
#define HEBC_BLOCK0_YUV_HEIGHT_ALIGN (16)
#define HEBC_BLOCK1_RGB_WIDTH_ALIGN (16)
#define HEBC_BLOCK1_RGB_HEIGHT_ALIGN (8)
#define HEBC_BLOCK1_YUV_WIDTH_ALIGN (32)
#define HEBC_BLOCK1_YUV_HEIGHT_ALIGN (32)
#define HEBC_BLOCK0_YUV_HEIGHT0_ALIGN (16)
#define HEBC_BLOCK1_YUV_HEIGHT1_ALIGN (16)
#define HEBC_RGB_WIDTH_MIN (32)
#define HEBC_YUV_WIDTH_MIN (64)
#define HEBC_RGB_WIDTH_MAX (512)
#define HEBC_YUV_WIDTH_MAX (1024)
#define HEBC_RGB_WIDTH_ROT_MIN (8)
#define HEBC_YUV_WIDTH_ROT_MIN (32)
#define HEBC_RGB_WIDTH_ROT_MAX (512)
#define HEBC_YUV_WIDTH_ROT_MAX (512)
#define HEBC_RGB_HEIGHT_MIN (4)
#define HEBC_YUV_HEIGHT_MIN (16)
#define HEBC_RGB_HEIGHT_MAX (8192)
#define HEBC_YUV_HEIGHT_MAX (8192)
#define HEBC_RGB_HEIGHT_ROT_MIN (16)
#define HEBC_YUV_HEIGHT_ROT_MIN (32)
#define HEBC_RGB_HEIGHT_ROT_MAX (8192)
#define HEBC_YUV_HEIGHT_ROT_MAX (8192)
#define HEBC_PAYLOAD_512B_ALIGN (512)
#define HEBC_PAYLOAD_256B_ALIGN (256)
#define HEBC_MMBUF_ADDR_ALIGN (128)
#define HEBC_BLOCK0_RGB_CROP_MAX (3)
#define HEBC_BLOCK0_YUV_CROP_MAX (15)
#define HEBC_BLOCK1_RGB_CROP_MAX (7)
#define HEBC_BLOCK1_YUV_CROP_MAX (31)
...
typedef struct dss_rdma {
    ...
    uint32_t hfbcd_payload_pointer;
    ...
    uint32_t hebcd_hreg_hdr_ptr_l0;
    uint32_t hebcd_hreg_pic_width;
    uint32_t hebcd_hreg_pic_height;
    uint32_t hebcd_hreg_format;
    uint32_t hebcd_str;
    uint32_t hebcd_line_crop;
    uint32_t hebcd_input_header_stride0;
    uint32_t hebcd_payload_stride0;
    uint32_t hebcd_payload_pointer;
    uint32_t hebcd_height_bf_str;
    uint32_t hebcd_scramble_mode;
    uint32_t hebcd_creg_fbcd_ctrl_mode;
    uint32_t hebcd_hreg_hdr_ptr_l1;
    uint32_t hebcd_hreg_pld_ptr_l1;
    uint32_t hebcd_header_stride1;
    uint32_t hebcd_payload_stride1;
    uint32_t hebcd_block_type;
    uint32_t hebcd_mm_base0_y8;
    uint32_t hebcd_mm_base1_c8;
    uint8_t vpp_used;
    uint8_t afbc_used;
    uint8_t hfbcd_used;
    uint8_t hebcd_used;
...
typedef struct dss_wdma {
    ...
    uint32_t hebce_hreg_pic_blks;
    uint32_t hebce_hreg_format;
    uint32_t hebce_hreg_hdr_ptr_l0;
    uint32_t hebce_hreg_pld_ptr_l0;
    uint32_t hebce_picture_size;
    uint32_t hebce_scramble_mode;
    uint32_t hebce_header_stride0;
    uint32_t hebce_payload_stride0;
    uint32_t hebce_header_pointer_offset;
    uint32_t hebce_hreg_hdr_ptr_l1;
    uint32_t hebce_hreg_pld_ptr_l1;
    uint32_t hebce_header_stride1;
    uint32_t hebce_payload_stride1;
    uint32_t hebce_spblock_mode;
    uint8_t afbc_used;
    uint8_t hfbce_used;
    uint8_t hebce_used;
    uint8_t rot_used;
...
#define DBUF_THD_RQOS_IDLE (0x00B0)
#define DBUF_DFS_OK_MASK (0x00B4)
#define DBUF_POST_CLIP_DISP_SIZE (0x0100)
#define DBUF_POST_CLIP_CTL_HRZ (0x0104)
#define DBUF_WB_UNPACK_EN (0x0108)
#define DBUF_WB_UNPACK_SIZE (0x010C)
#define DBUF_UNPACK_IMG_FMT (0x0110)
...
#define IMG_SIZE_BEF_SR (0x000)
#define IMG_SIZE_AFT_SR (0x004)
#define IMG_SIZE_AFT_IFBCSW (0x008)
#define DISP_CH_CRC_CFG_EN (0x030)
#define DISP_CH_CRC_FRM_CNT (0x034)
#define DISP_CH_CRC_RESUL (0x038)
...
#define DPP_INTS (0x00C)
#define DPP_INT_MSK (0x010)
#define DUAL_LCD_TOP_LEFT (0x048)
#define DUAL_LCD_BOT_RIGHT (0x04C)
#define DPP_DBG_CNT DPP_DBG1_CNT
#define DPP_CLRBAR_CTRL (0x1C)
#define DPP_CLRBAR_1ST_CLR (0x20)
#define DPP_CLRBAR_2ND_CLR (0x24)
#define DPP_CLRBAR_3RD_CLR (0x28)
...
#define CSC10B_IDC2 (0x004)
#define CSC10B_ODC0 (0x008)
#define CSC10B_ODC1 (0x010)
#define CSC10B_ODC2 (0x00C)
#define CSC10B_P00 (0x010)
#define CSC10B_P01 (0x014)
#define CSC10B_P02 (0x018)
#define CSC10B_P10 (0x01C)
#define CSC10B_P11 (0x020)
#define CSC10B_P12 (0x024)
#define CSC10B_P20 (0x028)
#define CSC10B_P21 (0x02C)
#define CSC10B_P22 (0x030)
#define CSC10B_MODULE_EN (0x034)
#define CSC10B_MPREC (0x038)
...
#define XCC_EN (0x034)
#define POST_XCC_EN (0x030)
#define POST_XCC_COEF_00 (0x000)
#define POST_XCC_COEF_01 (0x004)
#define POST_XCC_COEF_02 (0x008)
#define POST_XCC_COEF_03 (0x00C)
#define POST_XCC_COEF_10 (0x010)
#define POST_XCC_COEF_11 (0x014)
#define POST_XCC_COEF_12 (0x018)
#define POST_XCC_COEF_13 (0x01C)
#define POST_XCC_COEF_20 (0x020)
#define POST_XCC_COEF_21 (0x024)
#define POST_XCC_COEF_22 (0x028)
#define POST_XCC_COEF_23 (0x02C)
...
#define ARSR_POST_SRC_MIN_WIDTH 16
#define ARSR_POST_SRC_MIN_HEIGHT 16
#define ARSR_POST_SRC_MAX_WIDTH 4096
#define ARSR_POST_SRC_MAX_HEIGHT 8192
#define ARSR_POST_DST_MAX_WIDTH 8192
#define ARSR_POST_DST_MAX_HEIGHT 8192
#define OVERLAP_H16 16
#define SHIFT_16BIT 16
#define ARSR_POST_IHLEFT (0x008)
#define ARSR_POST_IHLEFT1 (0x00C)
#define ARSR_POST_IHRIGHT (0x010)
#define ARSR_POST_IHRIGHT1 (0x014)
#define ARSR_POST_IVTOP (0x018)
#define ARSR_POST_IVBOTTOM (0x01C)
#define ARSR_POST_IVBOTTOM1 (0x020)
#define ARSR_POST_IHINC (0x024)
#define ARSR_POST_IVINC (0x028)
#define ARSR_POST_UV_OFFSET (0x02C)
#define ARSR_POST_MODE (0x030)
#define ARSR_POST_SKIN_THRES_Y (0x034)
#define ARSR_POST_SKIN_THRES_U (0x038)
#define ARSR_POST_SKIN_THRES_V (0x03C)
#define ARSR_POST_SKIN_CFG0 (0x040)
#define ARSR_POST_SKIN_CFG1 (0x044)
#define ARSR_POST_SKIN_CFG2 (0x048)
#define ARSR_POST_SHOOT_CFG1 (0x04C)
#define ARSR_POST_SHOOT_CFG2 (0x050)
#define ARSR_POST_SHOOT_CFG3 (0x054)
#define ARSR_POST_SHARP_CFG3 (0x058)
#define ARSR_POST_SHARP_CFG4 (0x05C)
#define ARSR_POST_SHARP_CFG5 (0x060)
#define ARSR_POST_SHARP_CFG6 (0x064)
#define ARSR_POST_SHARP_CFG7 (0x068)
#define ARSR_POST_SHARP_CFG8 (0x06C)
#define ARSR_POST_SHARP_LEVEL (0x070)
#define ARSR_POST_SHARP_GAIN_LOW (0x074)
#define ARSR_POST_SHARP_GAIN_MID (0x078)
#define ARSR_POST_SHARP_GAIN_HIGH (0x07C)
#define ARSR_POST_SHARP_GAINCTRLSLOPH_MF (0x080)
#define ARSR_POST_SHARP_GAINCTRLSLOPL_MF (0x084)
#define ARSR_POST_SHARP_GAINCTRLSLOPH_HF (0x088)
#define ARSR_POST_SHARP_GAINCTRLSLOPL_HF (0x08C)
#define ARSR_POST_SHARP_MF_LMT (0x090)
#define ARSR_POST_SHARP_GAIN_MF (0x094)
#define ARSR_POST_SHARP_MF_B (0x098)
#define ARSR_POST_SHARP_HF_LMT (0x09C)
#define ARSR_POST_SHARP_GAIN_HF (0x0A0)
#define ARSR_POST_SHARP_HF_B (0x0A4)
#define ARSR_POST_SHARP_LF_CTRL (0x0A8)
#define ARSR_POST_SHARP_LF_VAR (0x0AC)
#define ARSR_POST_SHARP_LF_CTRL_SLOP (0x0B0)
#define ARSR_POST_SHARP_HF_SELECT (0x0B4)
#define ARSR_POST_SHARP_CFG2_H (0x0B8)
#define ARSR_POST_SHARP_CFG2_L (0x0BC)
#define ARSR_POST_TEXTURE_ANALYSIS (0x0D0)
#define ARSR_POST_INTPLSHOOTCTRL (0x0D4)
...
#define ARSR1P_LSC_GAIN_ES (0x084)
#define ARSR1P_COEFF_H_Y0_ES (0x0F0)
#define ARSR1P_COEFF_H_Y1_ES (0x114)
#define ARSR1P_COEFF_V_Y0_ES (0x138)
#define ARSR1P_COEFF_V_Y1_ES (0x15C)
#define ARSR1P_COEFF_H_UV0_ES (0x180)
#define ARSR1P_COEFF_H_UV1_ES (0x1A4)
#define ARSR1P_COEFF_V_UV0_ES (0x1C8)
#define ARSR1P_COEFF_V_UV1_ES (0x1EC)
#define ARSR_POST_COEFF_H_Y0 (0x0F0)
#define ARSR_POST_COEFF_H_Y1 (0x114)
#define ARSR_POST_COEFF_V_Y0 (0x138)
#define ARSR_POST_COEFF_V_Y1 (0x15C)
#define ARSR_POST_COEFF_H_UV0 (0x180)
#define ARSR_POST_COEFF_H_UV1 (0x1A4)
#define ARSR_POST_COEFF_V_UV0 (0x1C8)
#define ARSR_POST_COEFF_V_UV1 (0x1EC)
#define ARSR_POST_LUT_OFFSET (0x64000)
...
#define HIACE_DETAIL_WEIGHT (0x66500)
#define HIACE_LOG_LUM (0x66600)
#define HIACE_LUMA_GAMMA (0x66700)
#define HIACE_SKIN_COUNT (0x66b00)
#define DUAL_MIPI_HSIZE (0x0024)
#define DUAL_MIPI_SWAP (0x0028)
#define DSS_DFS_OK_MASK (0x002C)
#define MODULE_CORE_CLK_SEL (0x0034)
#define DISP_CH_CLK_SEL (0x0014)
#define DISP_CH_DBG_CNT (0x002C)
#define DISP_CH_ARSR2P_LB_MEM_CTRL (0x08E8)
#define DISP_CH_ARSR2P_COEF_MEM_CTRL (0x08EC)
#define DISP_CH_DITHER_MEM_CTRL (0x15BC)
#define HDR_MEM_CTRL (0x0174)
...
#define DPE_HDR10_EN (0x0230)
#define DPE_LOGLUM_MAX (0x0234)
#define DPE_HIST_MODEV (0x0238)
#define DPE_END_POINT (0x023c)
#define HIACE_V3_HIGHLIGHT (0x1800)
#define HIACE_V3_HL_HUE_GAIN0 (0x1804)
#define HIACE_V3_HL_HUE_GAIN1 (0x1808)
#define HIACE_V3_HL_HUE_GAIN2 (0x180C)
#define HIACE_V3_HL_HUE_GAIN3 (0x1810)
#define HIACE_V3_HL_HUE_GAIN4 (0x1814)
#define HIACE_V3_HL_HUE_GAIN5 (0x1818)
#define HIACE_V3_HL_SAT (0x181C)
#define HIACE_V3_HL_YOUT_MAXTH (0x1820)
#define HIACE_V3_HL_YOUT (0x1824)
#define HIACE_V3_HL_DIFF (0x1828)
#define HIACE_V3_SKIN_COUNT (0x182C)
#define HIACE_V3_LRE_SAT (0x1830)
#define HIACE_V3_LOCAL_REFRESH_H (0x1834)
#define HIACE_V3_LOCAL_REFRESH_V (0x1838)
#define HIACE_V3_GLOBAL_HIST_EN (0x183C)
#define HIACE_V3_GLOBAL_HIST_START (0x1840)
#define HIACE_V3_GLOBAL_HIST_SIZE (0x1844)
#define HIACE_V3_SCREEN_MODE (0x1848)
#define HIACE_V3_SEPARATOR (0x184C)
#define HIACE_V3_WEIGHT_MIN_MAX (0x1850)
#define HIACE_V3_FNA_EN (0x1854)
#define HIACE_V3_DBUG_HIACE (0x1858)
...
#define MIPI_LDI_VINACT_CNT (0x1DC)
...
#define MIPIDSI_DPHYTX_STOPSNT_OFFSET (0x0224)
#define MIPIDSI_DPHYTX_CTRL_OFFSET (0x0228)
#define MIPIDSI_DPHYTX_TRSTOP_FLAG_OFFSET (0x022c)
...
#define DSI_DBG_CRC_CTRL (0x01A4)
#define DSI_DBG_CRC_VAL (0x01A8)
#define DSI_CMD_MOD_CTRL (0x01C0)
#define MIPI_LDI_DPI0_HRZ_CTRL2 (0x01EC)
#define MIPI_LDI_VRT_CTRL2 (0x01F0)
#define MIPIDSI_LDI_CTRL (0x1B8)
#define MIPIDSI_LDI_FRM_MSK_UP (0x238)
...
#define MEDIA_COMMON_BASE (0xE8800000)
...
#define RCH_ID_ATTR_NS_0 (0x0450)
#define WCH_ID_ATTR_NS_0 (0x0454)
#define RCH_ID_ATTR_NS_1 (0x0458)
#define WCH_ID_ATTR_NS_1 (0x045c)
...
#define NXT_SW_NO_PR (0x020)
#define PIPE_SW_CLK_SEL (0x024)
#define PIPE_IFBC_SEL (0x028)
#define WB_CTRL (0x00)
#define WB_IMG_HSIZE (0x04)
#define WB_IMG_VSIZE (0x08)
#define WB_WORK_MODE (0x0C)
#define WB_PAD_NUM (0x10)
#define WB_CLK_SEL (0x18)
#define WB_REG_DEFAULT (0x20)
#define WB_ONLINE_ERR_INTS (0x24)
#define WB_ONLINE_ERR_INT_MASK (0x28)
#define SPR_OFFSET (0x79C00)
#define SPR_CTRL (0x000)
#define SPR_PATTERNGEN_POSITION (0x004)
#define SPR_PATTERNGEN_POSITION1 (0x008)
#define SPR_PATTERNGEN_PIX0 (0x00C)
#define SPR_PATTERNGEN_PIX1 (0x010)
#define SPR_PIX_EVEN_COEF_SEL (0x014)
#define SPR_PIX_ODD_COEF_SEL (0x018)
#define SPR_PIX_PANEL_ARRANGE_SEL (0x01C)
#define SPR_COEFF_OFFSET (0x020)
#define SPR_BORDERLR_REG (0X0B0)
#define SPR_PIXGAIN_REG (0x0C8)
#define SPR_PIXGAIN_REG1 (0x0CC)
#define SPR_BORDER_POSITION0 (0x0D0)
#define SPR_R_DIFF_REG (0x0E0)
#define SPR_R_WEIGHT_REG0 (0x0E4)
#define SPR_R_WEIGHT_REG1 (0x0E8)
#define SPR_CSC_COEFF0 (0x104)
#define SPR_CSC_COEFF1 (0x108)
#define SPR_CSC_OFFSET0 (0x10C)
#define SPR_CSC_OFFSET1 (0x110)
#define SPR_LUT_RD (0x114)
#define SPR_LUT_DATA (0x118)
#define SPR_LUT_WR_DATA (0x11C)
#define SPR_RESO (0x120)
#define SPR_CLK_SEL (0X124)
#define SPR_MEM_CTRL (0x12C)
#define SPR_GAMMA_LUT_R (0x200)
#define SPR_GAMMA_LUT_G (0x290)
#define SPR_GAMMA_LUT_B (0x320)
#define SPR_DEGAMMA_LUT_R (0x400)
#define SPR_DEGAMMA_LUT_G (0x490)
#define SPR_DEGAMMA_LUT_B (0x520)
#define SOC_ACPU_I2C4_BASE_ADDR (0xFA04D000)
#define SOC_ACPU_I2C3_BASE_ADDR (0xFA04C000)
#define REG_BASE_I2C_BIAS SOC_ACPU_I2C4_BASE_ADDR
#endif
