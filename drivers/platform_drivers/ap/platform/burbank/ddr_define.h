...
#endif
#define DDR_TYPE_EMPTY 0xFFFFFFFF
#define DDR_TYPE_LPDDR3 0
#define DDR_TYPE_LPDDR4 8
#define DDR_TYPE_LPDDR5 9
#define DDR_PMU_TYPE_V510 5
#define DDR_PMU_TYPE_V600 1
...
#define DDR_CORE_VOL_HIGH_0 700
#define DDR_CORE_VOL_HIGH_1 730
#define DDR_CORE_VOL_HIGH_2 760
#define DDR_CORE_VOL_HIGH_3 805
#define DDR_CORE_VOL_HIGH_4 845
#define DDR_CORE_VOL_HIGH_5 830
#define DDR_CORE_VOL_HIGH_6 840
#define DDR_CORE_VOL_HIGH_7 875
#define DDR_CORE_VOL_NORMAL_0 680
#define DDR_CORE_VOL_NORMAL_1 710
#define DDR_CORE_VOL_NORMAL_2 740
#define DDR_CORE_VOL_NORMAL_3 780
#define DDR_CORE_VOL_NORMAL_4 820
#define DDR_CORE_VOL_NORMAL_5 810
#define DDR_CORE_VOL_NORMAL_6 820
#define DDR_CORE_VOL_NORMAL_7 850
#define DDR_CORE_VOL_LOW_0 660
#define DDR_CORE_VOL_LOW_1 690
#define DDR_CORE_VOL_LOW_2 720
#define DDR_CORE_VOL_LOW_3 755
#define DDR_CORE_VOL_LOW_4 795
...
#define DDR_VDD1_VOL_NORMAL 1805
#define DDR_VDD1_VOL_LOW 1760
#define DDR_PHYPLL_VOL_HIGH 1240
#define DDR_PHYPLL_VOL_NORMAL 1200
#define DDR_PHYPLL_VOL_LOW 1160
...
#define DDR_AVS_PA_MARGIN_HIGH 0
#define DDR_AVS_STABLE_MARGIN_HIGH 0
#define DDR_CORE_VOL_HIGH_0 715
#define DDR_CORE_VOL_HIGH_1 745
#define DDR_CORE_VOL_HIGH_2 775
#define DDR_CORE_VOL_HIGH_3 820
#define DDR_CORE_VOL_HIGH_4 860
...
#define DDR_CORE_VOL_NORMAL_6 820
#define DDR_CORE_VOL_NORMAL_7 850
#define DDR_CORE_VOL_LOW_0 645
#define DDR_CORE_VOL_LOW_1 675
#define DDR_CORE_VOL_LOW_2 705
#define DDR_CORE_VOL_LOW_3 740
...
#if defined (__SLT_FEATURE__)
#define DDR_VDD1_VOL_HIGH 1835
#else
#define DDR_VDD1_VOL_HIGH 1895
#endif
#define DDR_VDD1_VOL_NORMAL 1805
#define DDR_VDD1_VOL_LOW 1715
...
#define DDR_SPLL_FREQ 1622
#define DDR_PLL1_FREQ 2133
#define DDR_PLL2_FREQ 1920
typedef enum {
 DDR_CORE_VOL = 0,
 DDR_VDDQ_VOL,
 DDR_VDD2H_VOL,
...
#define LPM3_ADDR_TO_ACORE_ADDR_IN_LPRAM(addr) ((((uintptr_t)(addr)) > (SOC_LPMCU_AO_LPRAM_BASE_ADDR)) ? (((unsigned long)(addr) - SOC_LPMCU_AO_LPRAM_BASE_ADDR) + SOC_ACPU_AO_LPRAM_BASE_ADDR) : (SOC_ACPU_AO_LPRAM_BASE_ADDR))
...
#define XLOADRE_ADDR_TO_FASTBOOT_ADDR(addr) (((uintptr_t)(addr) > (SOC_LPMCU_AO_LPRAM_BASE_ADDR + SOC_LPMCU_LP_RAM_BASE_SIZE)) ? LPM3_ADDR_TO_ACORE_ADDR_IN_MMBUF(addr) : LPM3_ADDR_TO_ACORE_ADDR_IN_LPRAM(addr))
#define DDR_PARAM_PACK(a,b,c,d) ((((u32)(a)) << 24) | (((u32)(b)) << 16) | (((u32)(c)) << 8) | (d))
#define ATF_ALIGN_LENGTH 8
#define FASTBOOT_SEC_DATA_ADDR ATF_BL2_DDR_SHMEM_ADDR
#define FASTBOOT_SEC_DATA_SIZE DDR_ADDR_ALIGN(sizeof(struct seccfg_info), ATF_ALIGN_LENGTH)
#define FASTBOOT_INFO_DATA_ADDR (FASTBOOT_SEC_DATA_ADDR + FASTBOOT_SEC_DATA_SIZE)
#define FASTBOOT_INFO_DATA_SIZE (ATF_BL2_DDR_SHMEM_SIZE - (FASTBOOT_INFO_DATA_ADDR - FASTBOOT_SEC_DATA_ADDR))
#ifndef DDR_EDA
...
#define DDR_SEC_CFG_MODEM_MASK 0x1021U
#define DDR_SEC_CFG_MODEM_MASK_WITHOUT_ASI5 0x1001U
...
#define DRAM_MR1_OP_BL_LPDDR4_START 0
#define DRAM_MR1_OP_BL_LPDDR4_END 1
#define DRAM_MR1_OP_WR_PRE_LPDDR4_START 2
#define DRAM_MR1_OP_WR_PRE_LPDDR4_END 2
#define DRAM_MR1_OP_RD_PRE_LPDDR4_START 3
#define DRAM_MR1_OP_RD_PRE_LPDDR4_END 3
#define DRAM_MR1_OP_NWR_LPDDR4_START 4
#define DRAM_MR1_OP_NWR_LPDDR4_END 6
#define DRAM_MR1_OP_RPST_LPDDR4_START 7
#define DRAM_MR1_OP_RPST_LPDDR4_END 7
#define DRAM_MR2_OP_RL_LPDDR4_START 0
#define DRAM_MR2_OP_RL_LPDDR4_END 2
#define DRAM_MR2_OP_WL_LPDDR4_START 3
#define DRAM_MR2_OP_WL_LPDDR4_END 5
#define DRAM_MR2_OP_WLS_LPDDR4_START 6
#define DRAM_MR2_OP_WLS_LPDDR4_END 6
#define DRAM_MR2_OP_WR_LEV_LPDDR4_START 7
#define DRAM_MR2_OP_WR_LEV_LPDDR4_END 7
