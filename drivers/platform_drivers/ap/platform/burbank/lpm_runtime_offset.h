...
#define RUNTIME_SR_VAR_SIZE (0x160)
#define RUNTIME_SR_VAR_END_ADDR (RUNTIME_CLENT_VOTE_TIME_ADDR(9))
#if (RUNTIME_SR_VAR_END_ADDR >= (RUNTIME_SR_VAR_BASE_ADDR + RUNTIME_SR_VAR_SIZE))
        #error "runtime sr memory overflow!!!"
#endif
#define RUNTIME_CPU_MEMORY_BIAS_VAR_BASE_ADDR (RUNTIME_SR_VAR_BASE_ADDR + RUNTIME_SR_VAR_SIZE)
#define RUNTIME_CPU_MEMORY_STEP3_VOLT_BIAS_ADDR (RUNTIME_CPU_MEMORY_BIAS_VAR_BASE_ADDR + 0x000)
#define CPU_MEMVOLT_STEP3_BIAS (WORD_REF(RUNTIME_CPU_MEMORY_STEP3_VOLT_BIAS_ADDR))
#define RUNTIME_FCM_MEMORY_STEP0_VOLT_BIAS_ADDR (RUNTIME_CPU_MEMORY_BIAS_VAR_BASE_ADDR + 0x004)
#define FCM_MEMVOLT_STEP0_BIAS (WORD_REF(RUNTIME_FCM_MEMORY_STEP0_VOLT_BIAS_ADDR))
#define RUNTIME_FCM_MEMORY_STEP1_VOLT_BIAS_ADDR (RUNTIME_CPU_MEMORY_BIAS_VAR_BASE_ADDR + 0x008)
#define FCM_MEMVOLT_STEP1_BIAS (WORD_REF(RUNTIME_FCM_MEMORY_STEP1_VOLT_BIAS_ADDR))
#define RUNTIME_SPACE_ADDR_END (RUNTIME_FCM_MEMORY_STEP1_VOLT_BIAS_ADDR)
...
#else
#define INT_LONG_TIME_TRACK_OFFSET 0x9b4
#define IRQ_MASK_LONG_TIME_TRACK_OFFSET 0xa14
#define STACK_BACKUP_SRAM_OFFSET 0x450
#endif
#endif
