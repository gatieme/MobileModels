...
#define CPU_RSV(n) (BYTE_REF(RUNTIME_CPU_RSV_ADDR(n)))
...
#define RUNTIME_TMP_HISTORY_ADDR(n) (RUNTIME_VAR_BASE + 0x77 + n)
...
#define VOL_DROP_EN_DATA (BYTE_REF(RUNTIME_VOL_DROP_EN_ADDR))
#define RUNTIME_GEN_VAR_END (RUNTIME_VOL_DROP_EN_ADDR)
