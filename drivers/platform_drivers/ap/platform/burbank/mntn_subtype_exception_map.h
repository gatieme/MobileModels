...
#endif
__AP_DDRC_SEC_SUBTYPE_MAP(AP_S_DDRC_SEC, PANIC, DMSS_UNKNOW_MASTER)
...
__AP_PANIC_SUBTYPE_MAP(AP_S_PANIC,PANIC,HI_APPANIC_MODEM)
...
__LPM3_EXC_SUBTYPE_MAP(LPM3_S_EXCEPTION,HARDWARE_FAULT,PSCI_SYSPMU_RAMP_PANIC)
...
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, OCP_LDO50)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, OCP_LDO49)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, OCP_LDO48)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, OCP_LDO47)
...
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, SCP_LDO)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, OVP_BUCK4)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, CUR_BUCK4)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK7_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK5_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK4_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK0_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO47_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO44_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO40_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO6_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO0_CHG)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK7_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK5_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK4_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_BUCK0_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO47_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO44_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO40_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO6_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_PMU, HARDWARE_FAULT, RAMP_LDO0_ABRON)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_OCP_BUCK0)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_OCP_BUCK1)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_OCP_BUCK2)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_OCP_BUCK3)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_SCP_BUCK0)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_SCP_BUCK1)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_SCP_BUCK2)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_SCP_BUCK3)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_OVP_BUCK01)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_OVP_BUCK2)
__PMU_EXC_SUBTYPE_MAP(AP_S_SUBPMU, HARDWARE_FAULT, SUBPMU_OVP_BUCK3)
...
__GENERAL_SEE_EXC_SUBTYPE_MAP(GENERAL_SEE_S_EXCEPTION, GENERAL_SEE_CRASH, EXC_TIMER)
...
__GENERAL_SEE_EXC_SUBTYPE_MAP(GENERAL_SEE_S_EXCEPTION, GENERAL_SEE_CRASH, SIMULATE_EXC_PD_SWIPE)
