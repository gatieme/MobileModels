...
#define SOC_ASP_DMMU_FAMA_REMAP_SRC0_ADDR(base) ((base) + (0x800UL))
#define SOC_ASP_DMMU_FAMA_REMAP_SRC1_ADDR(base) ((base) + (0x804UL))
#define SOC_ASP_DMMU_FAMA_REMAP_SRC2_ADDR(base) ((base) + (0x808UL))
#define SOC_ASP_DMMU_FAMA_REMAP_SRC3_ADDR(base) ((base) + (0x80CUL))
#define SOC_ASP_DMMU_FAMA_REMAP_SRC4_ADDR(base) ((base) + (0x810UL))
#define SOC_ASP_DMMU_FAMA_REMAP_SRC5_ADDR(base) ((base) + (0x814UL))
#define SOC_ASP_DMMU_FAMA_REMAP_SRC6_ADDR(base) ((base) + (0x818UL))
#define SOC_ASP_DMMU_FAMA_REMAP_SRC7_ADDR(base) ((base) + (0x81CUL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN0_ADDR(base) ((base) + (0x820UL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN1_ADDR(base) ((base) + (0x824UL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN2_ADDR(base) ((base) + (0x828UL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN3_ADDR(base) ((base) + (0x82CUL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN4_ADDR(base) ((base) + (0x830UL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN5_ADDR(base) ((base) + (0x834UL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN6_ADDR(base) ((base) + (0x838UL))
#define SOC_ASP_DMMU_FAMA_REMAP_LEN7_ADDR(base) ((base) + (0x83CUL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST0_ADDR(base) ((base) + (0x840UL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST1_ADDR(base) ((base) + (0x844UL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST2_ADDR(base) ((base) + (0x848UL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST3_ADDR(base) ((base) + (0x84CUL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST4_ADDR(base) ((base) + (0x850UL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST5_ADDR(base) ((base) + (0x854UL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST6_ADDR(base) ((base) + (0x858UL))
#define SOC_ASP_DMMU_FAMA_REMAP_DST7_ADDR(base) ((base) + (0x85CUL))
#define SOC_ASP_DMMU_FAMA_REMAP_ADDR_DEFAULT_ADDR(base) ((base) + (0x860UL))
#else
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST0_icfg_addr_dst0_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST1_icfg_addr_dst1_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST2_icfg_addr_dst2_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST3_icfg_addr_dst3_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST4_icfg_addr_dst4_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST5_icfg_addr_dst5_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST6_icfg_addr_dst6_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_DST7_icfg_addr_dst7_END (27)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_DMMU_FAMA_REMAP_ADDR_DEFAULT_icfg_addr_default_END (7)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
