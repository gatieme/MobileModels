...
#define SOC_ASP_DSD_DSD_VERSION_ADDR(base) ((base) + (0x00UL))
#define SOC_ASP_DSD_DSD_DATA_FORMAT_ADDR(base) ((base) + (0x04UL))
#define SOC_ASP_DSD_DSD_INTMASK_ADDR(base) ((base) + (0x08UL))
#define SOC_ASP_DSD_DSD_INTSTATUS_ADDR(base) ((base) + (0x0CUL))
#define SOC_ASP_DSD_DSD_INTCLR_ADDR(base) ((base) + (0x010UL))
#define SOC_ASP_DSD_DSD_CT_SET_ADDR(base) ((base) + (0x01CUL))
#define SOC_ASP_DSD_DSD_CT_CLR_ADDR(base) ((base) + (0x020UL))
#define SOC_ASP_DSD_DSD_TX_STA_ADDR(base) ((base) + (0x024UL))
#define SOC_ASP_DSD_DSD_FIFO_AFULL_TH_ADDR(base) ((base) + (0x028UL))
#define SOC_ASP_DSD_DSD_FIFO_RD_DATA_EMP_ADDR(base) ((base) + (0x02CUL))
#define SOC_ASP_DSD_DSD_LEFT_TX_ADDR(base) ((base) + (0x080UL))
#define SOC_ASP_DSD_DSD_RIGHT_TX_ADDR(base) ((base) + (0x090UL))
#else
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int tx_fifo_threshold : 6;
...
#define SOC_ASP_DSD_DSD_CT_SET_tx_fifo_threshold_END (6)
#define SOC_ASP_DSD_DSD_CT_SET_intr_en_START (7)
#define SOC_ASP_DSD_DSD_CT_SET_intr_en_END (7)
#define SOC_ASP_DSD_DSD_CT_SET_fifo_clr_en_START (8)
#define SOC_ASP_DSD_DSD_CT_SET_fifo_clr_en_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int tx_fifo_threshold_clr : 6;
...
#define SOC_ASP_DSD_DSD_CT_CLR_tx_fifo_threshold_clr_END (6)
#define SOC_ASP_DSD_DSD_CT_CLR_intr_mask_START (7)
#define SOC_ASP_DSD_DSD_CT_CLR_intr_mask_END (7)
#define SOC_ASP_DSD_DSD_CT_CLR_fifo_clr_disable_START (8)
#define SOC_ASP_DSD_DSD_CT_CLR_fifo_clr_disable_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int right_fifo_afull_th : 6;
        unsigned int left_fifo_afull_th : 6;
        unsigned int reserved : 20;
    } reg;
} SOC_ASP_DSD_DSD_FIFO_AFULL_TH_UNION;
#endif
#define SOC_ASP_DSD_DSD_FIFO_AFULL_TH_right_fifo_afull_th_START (0)
#define SOC_ASP_DSD_DSD_FIFO_AFULL_TH_right_fifo_afull_th_END (5)
#define SOC_ASP_DSD_DSD_FIFO_AFULL_TH_left_fifo_afull_th_START (6)
#define SOC_ASP_DSD_DSD_FIFO_AFULL_TH_left_fifo_afull_th_END (11)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
