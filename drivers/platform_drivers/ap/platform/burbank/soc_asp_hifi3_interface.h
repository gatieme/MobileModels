...
#define SOC_ASP_HIFI3_TRAXID_ADDR(base) ((base) + (0x0000UL))
#define SOC_ASP_HIFI3_TRAXCTRL_ADDR(base) ((base) + (0x0004UL))
#define SOC_ASP_HIFI3_TRAXSTAT_ADDR(base) ((base) + (0x0008UL))
#define SOC_ASP_HIFI3_TRAXDATA_ADDR(base) ((base) + (0x000CUL))
#define SOC_ASP_HIFI3_TRAXADDR_ADDR(base) ((base) + (0x0010UL))
#define SOC_ASP_HIFI3_TRIGGERPC_ADDR(base) ((base) + (0x0014UL))
#define SOC_ASP_HIFI3_PCMATCHCTRL_ADDR(base) ((base) + (0x0018UL))
#define SOC_ASP_HIFI3_DELAYCNT_ADDR(base) ((base) + (0x001CUL))
#define SOC_ASP_HIFI3_MEMADDRSTART_ADDR(base) ((base) + (0x0020UL))
#define SOC_ASP_HIFI3_MEMADDREND_ADDR(base) ((base) + (0x0024UL))
#define SOC_ASP_HIFI3_compressparams_ADDR(base) ((base) + (0x006CUL))
#define SOC_ASP_HIFI3_PMG_ADDR(base) ((base) + (0x1000UL))
#define SOC_ASP_HIFI3_INTPC_ADDR(base) ((base) + (0x1010UL))
#define SOC_ASP_HIFI3_perfcounter0_ADDR(base) ((base) + (0x1080UL))
#define SOC_ASP_HIFI3_perfcounter1_ADDR(base) ((base) + (0x1084UL))
#define SOC_ASP_HIFI3_perfcounter2_ADDR(base) ((base) + (0x1088UL))
#define SOC_ASP_HIFI3_perfcounter3_ADDR(base) ((base) + (0x108CUL))
#define SOC_ASP_HIFI3_PMCTRL0_ADDR(base) ((base) + (0x1100UL))
#define SOC_ASP_HIFI3_PMCTRL1_ADDR(base) ((base) + (0x1104UL))
#define SOC_ASP_HIFI3_PMCTRL2_ADDR(base) ((base) + (0x1108UL))
#define SOC_ASP_HIFI3_PMCTRL3_ADDR(base) ((base) + (0x110CUL))
#define SOC_ASP_HIFI3_PMSTA0_ADDR(base) ((base) + (0x1180UL))
#define SOC_ASP_HIFI3_PMSTA1_ADDR(base) ((base) + (0x1184UL))
#define SOC_ASP_HIFI3_PMSTA2_ADDR(base) ((base) + (0x1188UL))
#define SOC_ASP_HIFI3_PMSTA3_ADDR(base) ((base) + (0x118CUL))
#define SOC_ASP_HIFI3_OCDID_ADDR(base) ((base) + (0x2000UL))
#define SOC_ASP_HIFI3_DCRCLR_ADDR(base) ((base) + (0x2008UL))
#define SOC_ASP_HIFI3_DCRSET_ADDR(base) ((base) + (0x200CUL))
#define SOC_ASP_HIFI3_DSR_ADDR(base) ((base) + (0x2010UL))
#define SOC_ASP_HIFI3_DDR_ADDR(base) ((base) + (0x2014UL))
#define SOC_ASP_HIFI3_DDREXEC_ADDR(base) ((base) + (0x2018UL))
#define SOC_ASP_HIFI3_DIR0EXEC_ADDR(base) ((base) + (0x201CUL))
#define SOC_ASP_HIFI3_denugInst0_ADDR(base) ((base) + (0x2020UL))
#define SOC_ASP_HIFI3_debugInst1_ADDR(base) ((base) + (0x2024UL))
#define SOC_ASP_HIFI3_PWRCTL_ADDR(base) ((base) + (0x3020UL))
#define SOC_ASP_HIFI3_PWRSTAT_ADDR(base) ((base) + (0x3024UL))
#define SOC_ASP_HIFI3_ERISTAT_ADDR(base) ((base) + (0x3028UL))
#define SOC_ASP_HIFI3_undoRegThID1_ADDR(base) ((base) + (0x3034UL))
#define SOC_ASP_HIFI3_undocRegBuild_ADDR(base) ((base) + (0x3038UL))
#define SOC_ASP_HIFI3_undocRegBcid_ADDR(base) ((base) + (0x303CUL))
#define SOC_ASP_HIFI3_itCtrl_ADDR(base) ((base) + (0x3F00UL))
#define SOC_ASP_HIFI3_claimSet_ADDR(base) ((base) + (0x3FA0UL))
#define SOC_ASP_HIFI3_claimClear_ADDR(base) ((base) + (0x3FA4UL))
#define SOC_ASP_HIFI3_devId_ADDR(base) ((base) + (0x3FC8UL))
#define SOC_ASP_HIFI3_devType_ADDR(base) ((base) + (0x3FCCUL))
#define SOC_ASP_HIFI3_peripheralId4_ADDR(base) ((base) + (0x3FD0UL))
#define SOC_ASP_HIFI3_peripheralId5_ADDR(base) ((base) + (0x3FD4UL))
#define SOC_ASP_HIFI3_peripheralId6_ADDR(base) ((base) + (0x3FD8UL))
#define SOC_ASP_HIFI3_peripheralId7_ADDR(base) ((base) + (0x3FDCUL))
#define SOC_ASP_HIFI3_peripheralId0_ADDR(base) ((base) + (0x3FE0UL))
#define SOC_ASP_HIFI3_peripheralId1_ADDR(base) ((base) + (0x3FE4UL))
#define SOC_ASP_HIFI3_peripheralId2_ADDR(base) ((base) + (0x3FE8UL))
#define SOC_ASP_HIFI3_peripheralId3_ADDR(base) ((base) + (0x3FECUL))
#define SOC_ASP_HIFI3_componentId0_ADDR(base) ((base) + (0x3FF0UL))
#define SOC_ASP_HIFI3_componentId1_ADDR(base) ((base) + (0x3FF4UL))
#define SOC_ASP_HIFI3_componentId2_ADDR(base) ((base) + (0x3FF8UL))
#define SOC_ASP_HIFI3_componentId3_ADDR(base) ((base) + (0x3FFCUL))
#else
