...
#define SOC_ASP_IPC_NS_MBX_SOURCE_ADDR(base,i) ((base) + (0x000+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_DSET_ADDR(base,i) ((base) + (0x004+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_DCLEAR_ADDR(base,i) ((base) + (0x008+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_DSTATUS_ADDR(base,i) ((base) + (0x00C+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_MODE_ADDR(base,i) ((base) + (0x010+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_IMASK_ADDR(base,i) ((base) + (0x014+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_ICLR_ADDR(base,i) ((base) + (0x018+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_SEND_ADDR(base,i) ((base) + (0x01C+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_DATA0_ADDR(base,i) ((base) + (0x020+(i)*64UL))
#define SOC_ASP_IPC_NS_MBX_DATA1_ADDR(base,i) ((base) + (0x024+(i)*64UL))
#define SOC_ASP_IPC_NS_CPU_IMST_ADDR(base,j) ((base) + (0x800+(j)*8UL))
#define SOC_ASP_IPC_NS_CPU_IRST_ADDR(base,j) ((base) + (0x804+(j)*8UL))
#define SOC_ASP_IPC_NS_IPC_MBX_ACTIVE_ADDR(base) ((base) + (0x900UL))
#define SOC_ASP_IPC_NS_IPC_LOCK_ADDR(base) ((base) + (0xA00UL))
#else
...
#define SOC_ASP_IPC_NS_MBX_SOURCE_source_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_DSET_dset_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_DCLEAR_dclear_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_DSTATUS_dstatus_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_IMASK_int_mask_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_ICLR_int_clear_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ASP_IPC_NS_MBX_SEND_send_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
