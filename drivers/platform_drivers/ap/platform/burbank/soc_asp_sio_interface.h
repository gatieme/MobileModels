...
#define SOC_ASP_SIO_SIO_VERSION_ADDR(base) ((base) + (0x03CUL))
#define SOC_ASP_SIO_SIO_MODE_ADDR(base) ((base) + (0x040UL))
#define SOC_ASP_SIO_SIO_INTSTATUS_ADDR(base) ((base) + (0x044UL))
#define SOC_ASP_SIO_SIO_INTCLR_ADDR(base) ((base) + (0x048UL))
#define SOC_ASP_SIO_SIO_I2S_LEFT_XD_ADDR(base) ((base) + (0x04CUL))
#define SOC_ASP_SIO_SIO_I2S_RIGHT_XD_ADDR(base) ((base) + (0x050UL))
#define SOC_ASP_SIO_SIO_I2S_LEFT_RD_ADDR(base) ((base) + (0x054UL))
#define SOC_ASP_SIO_SIO_I2S_RIGHT_RD_ADDR(base) ((base) + (0x058UL))
#define SOC_ASP_SIO_SIO_CT_SET_ADDR(base) ((base) + (0x05CUL))
#define SOC_ASP_SIO_SIO_CT_CLR_ADDR(base) ((base) + (0x060UL))
#define SOC_ASP_SIO_SIO_RX_STA_ADDR(base) ((base) + (0x068UL))
#define SOC_ASP_SIO_SIO_TX_STA_ADDR(base) ((base) + (0x06CUL))
#define SOC_ASP_SIO_SIO_DATA_WIDTH_SET_ADDR(base) ((base) + (0x078UL))
#define SOC_ASP_SIO_SIO_I2S_START_POS_ADDR(base) ((base) + (0x07CUL))
#define SOC_ASP_SIO_I2S_POS_FLAG_ADDR(base) ((base) + (0x080UL))
#define SOC_ASP_SIO_SIO_SIGNED_EXT_ADDR(base) ((base) + (0x084UL))
#define SOC_ASP_SIO_SIO_I2S_POS_MERGE_EN_ADDR(base) ((base) + (0x088UL))
#define SOC_ASP_SIO_SIO_INTMASK_ADDR(base) ((base) + (0x08CUL))
#define SOC_ASP_SIO_SIO_I2S_DUAL_RX_CHN_ADDR(base) ((base) + (0x0A0UL))
#define SOC_ASP_SIO_SIO_I2S_DUAL_TX_CHN_ADDR(base) ((base) + (0x0C0UL))
#else
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int rx_fifo_threshold : 6;
...
#define SOC_ASP_SIO_SIO_I2S_POS_MERGE_EN_rx_fifo_threshold_START (1)
#define SOC_ASP_SIO_SIO_I2S_POS_MERGE_EN_rx_fifo_threshold_END (6)
#define SOC_ASP_SIO_SIO_I2S_POS_MERGE_EN_tx_fifo_threshold_START (7)
#define SOC_ASP_SIO_SIO_I2S_POS_MERGE_EN_tx_fifo_threshold_END (12)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
