...
#define SOC_BLPWM_IN_NUM_ADDR(base) ((base) + (0x008UL))
#define SOC_BLPWM_IN_NUM_BAK_ADDR(base) ((base) + (0x00CUL))
#define SOC_BLPWM_CNT_MAX_ADDR(base) ((base) + (0x010UL))
#define SOC_BLPWM_INTR_DIFF_ADDR(base) ((base) + (0x014UL))
#define SOC_BLPWM_INTR_CTRL_ADDR(base) ((base) + (0x018UL))
#define SOC_BLPWM_IN_INTR_ADDR(base) ((base) + (0x01CUL))
#define SOC_BLPWM_INTR_CLEAR_ADDR(base) ((base) + (0x020UL))
...
#define SOC_BLPWM_GROUP0_CFG_ADDR(base) ((base) + (0x10CUL))
#define SOC_BLPWM_GROUP1_CFG_ADDR(base) ((base) + (0x110UL))
#define SOC_BLPWM_GROUP2_CFG_ADDR(base) ((base) + (0x114UL))
#define SOC_BLPWM_GROUP3_CFG_ADDR(base) ((base) + (0x118UL))
#define SOC_BLPWM_GROUP4_CFG_ADDR(base) ((base) + (0x11CUL))
#define SOC_BLPWM_GROUP5_CFG_ADDR(base) ((base) + (0x120UL))
#define SOC_BLPWM_GROUP6_CFG_ADDR(base) ((base) + (0x124UL))
#define SOC_BLPWM_GROUP7_CFG_ADDR(base) ((base) + (0x128UL))
#define SOC_BLPWM_OUT_STATUS_ADDR(base) ((base) + (0x130UL))
#define SOC_BLPWM_GROUP_STATUS_ADDR(base) ((base) + (0x134UL))
#else
