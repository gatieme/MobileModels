...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int sel_monitor_clk : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int svfd_d_rate1_big0 : 2;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int svfd_off_time_step_big0 : 7;
...
typedef union
{
    ...
    struct
    {
        unsigned int sw_svfd_freq_down_en_big0 : 1;
        unsigned int sel_svfd_freq_down_en_big0 : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int svfd_d_rate1_middle0 : 2;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int svfd_off_time_step_middle0 : 7;
        unsigned int reserved_1 : 5;
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int sw_svfd_freq_down_en_middle0 : 1;
        unsigned int sel_svfd_freq_down_en_middle0 : 1;
        unsigned int reserved : 30;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int apll3_ssc_bypass_ssmod_dynammic : 1;
        unsigned int reserved : 21;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int apll5_ssc_bypass_ssmod_dynammic : 1;
        unsigned int reserved : 21;
    } reg;
