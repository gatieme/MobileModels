...
#define SOC_CS_AP_ETF_ETF_RSZ_ADDR(base) ((base) + (0x004UL))
#define SOC_CS_AP_ETF_ETF_STS_ADDR(base) ((base) + (0x00CUL))
#define SOC_CS_AP_ETF_ETF_RRD_ADDR(base) ((base) + (0x010UL))
#define SOC_CS_AP_ETF_ETF_RRP_ADDR(base) ((base) + (0x014UL))
#define SOC_CS_AP_ETF_ETF_RWP_ADDR(base) ((base) + (0x018UL))
#define SOC_CS_AP_ETF_ETF_TRG_ADDR(base) ((base) + (0x01CUL))
#define SOC_CS_AP_ETF_ETF_CTL_ADDR(base) ((base) + (0x020UL))
#define SOC_CS_AP_ETF_ETF_RWD_ADDR(base) ((base) + (0x024UL))
#define SOC_CS_AP_ETF_ETF_MODE_ADDR(base) ((base) + (0x028UL))
#define SOC_CS_AP_ETF_ETF_LBUFLEVEL_ADDR(base) ((base) + (0x02CUL))
#define SOC_CS_AP_ETF_ETF_CBUFLEVEL_ADDR(base) ((base) + (0x030UL))
#define SOC_CS_AP_ETF_ETF_BUFWM_ADDR(base) ((base) + (0x034UL))
#define SOC_CS_AP_ETF_ETF_FFSR_ADDR(base) ((base) + (0x300UL))
#define SOC_CS_AP_ETF_ETF_FFCR_ADDR(base) ((base) + (0x304UL))
#define SOC_CS_AP_ETF_ETF_FSCR_ADDR(base) ((base) + (0x308UL))
#define SOC_CS_AP_ETF_ETF_LAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_AP_ETF_ETF_LSR_ADDR(base) ((base) + (0xFB4UL))
#else
