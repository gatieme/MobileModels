...
#define SOC_CS_AP_ETM_ETM_TRCPRGCTLR_ADDR(base) ((base) + (0x004UL))
#define SOC_CS_AP_ETM_ETM_TRCSTATR_ADDR(base) ((base) + (0x00CUL))
#define SOC_CS_AP_ETM_ETM_TRCCONFIGR_ADDR(base) ((base) + (0x010UL))
#define SOC_CS_AP_ETM_ETM_TRCAUXCTLR_ADDR(base) ((base) + (0x018UL))
#define SOC_CS_AP_ETM_ETM_TRCEVENTCTL0R_ADDR(base) ((base) + (0x020UL))
#define SOC_CS_AP_ETM_ETM_TRCEVENTCTL1R_ADDR(base) ((base) + (0x024UL))
#define SOC_CS_AP_ETM_ETM_TRCSTALLCTLR_ADDR(base) ((base) + (0x02CUL))
#define SOC_CS_AP_ETM_ETM_TRCTSCTLR_ADDR(base) ((base) + (0x030UL))
#define SOC_CS_AP_ETM_ETM_TRCSYNCPR_ADDR(base) ((base) + (0x034UL))
#define SOC_CS_AP_ETM_ETM_TRCCCCTLR_ADDR(base) ((base) + (0x038UL))
#define SOC_CS_AP_ETM_ETM_TRCBBCTLR_ADDR(base) ((base) + (0x03CUL))
#define SOC_CS_AP_ETM_ETM_TRCTRACEIDR_ADDR(base) ((base) + (0x040UL))
#define SOC_CS_AP_ETM_ETM_TRCVICTLR_ADDR(base) ((base) + (0x080UL))
#define SOC_CS_AP_ETM_ETM_TRCVIIECTLR_ADDR(base) ((base) + (0x084UL))
#define SOC_CS_AP_ETM_ETM_TRCVISSCTLR_ADDR(base) ((base) + (0x088UL))
#define SOC_CS_AP_ETM_ETM_TRCSEQEVR0_ADDR(base) ((base) + (0x100UL))
#define SOC_CS_AP_ETM_ETM_TRCSEQEVR1_ADDR(base) ((base) + (0x104UL))
#define SOC_CS_AP_ETM_ETM_TRCSEQEVR2_ADDR(base) ((base) + (0x108UL))
#define SOC_CS_AP_ETM_ETM_TRCSEQRSTEVR_ADDR(base) ((base) + (0x118UL))
#define SOC_CS_AP_ETM_ETM_TRCSEQSTR_ADDR(base) ((base) + (0x11CUL))
#define SOC_CS_AP_ETM_ETM_TRCEXTINSELR_ADDR(base) ((base) + (0x120UL))
#define SOC_CS_AP_ETM_ETM_TRCCNTRLDVR0_ADDR(base) ((base) + (0x140UL))
#define SOC_CS_AP_ETM_ETM_TRCCNTRLDVR1_ADDR(base) ((base) + (0x144UL))
#define SOC_CS_AP_ETM_ETM_TRCCNTCTLR0_ADDR(base) ((base) + (0x150UL))
#define SOC_CS_AP_ETM_ETM_TRCCNTCTLR1_ADDR(base) ((base) + (0x154UL))
#define SOC_CS_AP_ETM_ETM_TRCCNTVR0_ADDR(base) ((base) + (0x160UL))
#define SOC_CS_AP_ETM_ETM_TRCCNTVR1_ADDR(base) ((base) + (0x164UL))
#define SOC_CS_AP_ETM_ETM_TRCRSCTLRn_ADDR(base,n) ((base) + (0x200+(4*(n))))
#define SOC_CS_AP_ETM_ETM_TRCSSCCR0_ADDR(base) ((base) + (0x280UL))
#define SOC_CS_AP_ETM_ETM_TRCSSCSR0_ADDR(base) ((base) + (0x2A0UL))
#define SOC_CS_AP_ETM_ETM_TRCOSLAR_ADDR(base) ((base) + (0x300UL))
#define SOC_CS_AP_ETM_ETM_TRCOSLSR_ADDR(base) ((base) + (0x304UL))
#define SOC_CS_AP_ETM_ETM_TRCPDCR_ADDR(base) ((base) + (0x310UL))
#define SOC_CS_AP_ETM_ETM_TRCPDSR_ADDR(base) ((base) + (0x314UL))
...
#define SOC_CS_AP_ETM_ETM_TRCCIDCVR0_ADDR(base) ((base) + (0x600UL))
#define SOC_CS_AP_ETM_ETM_TRCVMIDCVR0_ADDR(base) ((base) + (0x640UL))
#define SOC_CS_AP_ETM_ETM_TRCCIDCCTLR0_ADDR(base) ((base) + (0x680UL))
#define SOC_CS_AP_ETM_ETM_TRCLAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_AP_ETM_ETM_TRCLSR_ADDR(base) ((base) + (0xFB4UL))
#define SOC_CS_AP_ETM_ETM_TRCAUTHSTATUS_ADDR(base) ((base) + (0xFB8UL))
#else
