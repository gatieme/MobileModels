...
#define SOC_CS_AP_FUNNEL_FUNNEL_CTRL_REG_ADDR(base) ((base) + (0x000UL))
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_ADDR(base) ((base) + (0x004UL))
#define SOC_CS_AP_FUNNEL_FUNNEL_LAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_AP_FUNNEL_FUNNEL_LSR_ADDR(base) ((base) + (0xFB4UL))
#else
...
#define SOC_CS_AP_FUNNEL_FUNNEL_CTRL_REG_enable_END (7)
...
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport4_START (12)
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport4_END (14)
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport5_START (15)
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport5_END (17)
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport6_START (18)
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport6_END (20)
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport7_START (21)
#define SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_priport7_END (23)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
