...
#define SOC_CS_CTI_CTI_CONTROL_ADDR(base) ((base) + (0x000UL))
#define SOC_CS_CTI_CTI_INTACK_ADDR(base) ((base) + (0x010UL))
#define SOC_CS_CTI_CTI_APPSET_ADDR(base) ((base) + (0x014UL))
#define SOC_CS_CTI_CTI_APPCLEAR_ADDR(base) ((base) + (0x018UL))
#define SOC_CS_CTI_CTI_APPPULSE_ADDR(base) ((base) + (0x01CUL))
#define SOC_CS_CTI_CTI_INEN0_ADDR(base) ((base) + (0x020UL))
#define SOC_CS_CTI_CTI_INEN1_ADDR(base) ((base) + (0x024UL))
#define SOC_CS_CTI_CTI_INEN2_ADDR(base) ((base) + (0x028UL))
#define SOC_CS_CTI_CTI_INEN3_ADDR(base) ((base) + (0x02CUL))
#define SOC_CS_CTI_CTI_INEN4_ADDR(base) ((base) + (0x030UL))
#define SOC_CS_CTI_CTI_INEN5_ADDR(base) ((base) + (0x034UL))
#define SOC_CS_CTI_CTI_INEN6_ADDR(base) ((base) + (0x038UL))
#define SOC_CS_CTI_CTI_INEN7_ADDR(base) ((base) + (0x03CUL))
#define SOC_CS_CTI_CTI_OUTEN0_ADDR(base) ((base) + (0x0A0UL))
#define SOC_CS_CTI_CTI_OUTEN1_ADDR(base) ((base) + (0x0A4UL))
#define SOC_CS_CTI_CTI_OUTEN2_ADDR(base) ((base) + (0x0A8UL))
#define SOC_CS_CTI_CTI_OUTEN3_ADDR(base) ((base) + (0x0ACUL))
#define SOC_CS_CTI_CTI_OUTEN4_ADDR(base) ((base) + (0x0B0UL))
#define SOC_CS_CTI_CTI_OUTEN5_ADDR(base) ((base) + (0x0B4UL))
#define SOC_CS_CTI_CTI_OUTEN6_ADDR(base) ((base) + (0x0B8UL))
#define SOC_CS_CTI_CTI_OUTEN7_ADDR(base) ((base) + (0x0BCUL))
#define SOC_CS_CTI_CTI_TRIGINSTATUS_ADDR(base) ((base) + (0x130UL))
#define SOC_CS_CTI_CTI_TRIGOUTSTATUS_ADDR(base) ((base) + (0x134UL))
#define SOC_CS_CTI_CTI_CHINSTATUS_ADDR(base) ((base) + (0x138UL))
#define SOC_CS_CTI_CTI_CHOUTSTATUS_ADDR(base) ((base) + (0x13CUL))
#define SOC_CS_CTI_CTI_GATE_ADDR(base) ((base) + (0x140UL))
#define SOC_CS_CTI_CTI_LAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_CTI_CTI_LSR_ADDR(base) ((base) + (0xFB4UL))
#define SOC_CS_CTI_CTI_AUTHSTATUS_ADDR(base) ((base) + (0xFB8UL))
#else
