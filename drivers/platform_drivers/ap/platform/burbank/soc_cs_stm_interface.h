...
#define SOC_CS_STM_STM_DMASTARTR_ADDR(base) ((base) + (0xC04UL))
#define SOC_CS_STM_STM_DMASTOPR_ADDR(base) ((base) + (0xC08UL))
#define SOC_CS_STM_STM_DMASTATR_ADDR(base) ((base) + (0xC0CUL))
#define SOC_CS_STM_STM_DMACTLR_ADDR(base) ((base) + (0xC10UL))
#define SOC_CS_STM_STM_HEER_ADDR(base) ((base) + (0xD00UL))
#define SOC_CS_STM_STM_HETER_ADDR(base) ((base) + (0xD20UL))
#define SOC_CS_STM_STM_HEBSR_ADDR(base) ((base) + (0xD60UL))
#define SOC_CS_STM_STM_HEMCR_ADDR(base) ((base) + (0xD64UL))
#define SOC_CS_STM_STM_HEEXTMUXR_ADDR(base) ((base) + (0xD68UL))
#define SOC_CS_STM_STM_HEMASTR_ADDR(base) ((base) + (0xDF4UL))
#define SOC_CS_STM_STM_HEFEAT1R_ADDR(base) ((base) + (0xDF8UL))
#define SOC_CS_STM_STM_HEIDR_ADDR(base) ((base) + (0xDFCUL))
#define SOC_CS_STM_STM_SPER_ADDR(base) ((base) + (0xE00UL))
#define SOC_CS_STM_STM_SPTER_ADDR(base) ((base) + (0xE20UL))
#define SOC_CS_STM_STM_SPSCR_ADDR(base) ((base) + (0xE60UL))
#define SOC_CS_STM_STM_SPMSCR_ADDR(base) ((base) + (0xE64UL))
#define SOC_CS_STM_STM_SPOVERRIDER_ADDR(base) ((base) + (0xE68UL))
#define SOC_CS_STM_STM_SPMOVERRIDER_ADDR(base) ((base) + (0xE6CUL))
#define SOC_CS_STM_STM_SPTRIGCSR_ADDR(base) ((base) + (0xE70UL))
#define SOC_CS_STM_STM_TCSR_ADDR(base) ((base) + (0xE80UL))
#define SOC_CS_STM_STM_TSSTIMR_ADDR(base) ((base) + (0xE84UL))
#define SOC_CS_STM_STM_TSFREQR_ADDR(base) ((base) + (0xE8CUL))
#define SOC_CS_STM_STM_SYNCR_ADDR(base) ((base) + (0xE90UL))
#define SOC_CS_STM_STM_AUXCR_ADDR(base) ((base) + (0xE94UL))
#define SOC_CS_STM_STM_LAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_STM_STM_LSR_ADDR(base) ((base) + (0xFB4UL))
#define SOC_CS_STM_STM_AUTHSTATUS_ADDR(base) ((base) + (0xFB8UL))
#else
