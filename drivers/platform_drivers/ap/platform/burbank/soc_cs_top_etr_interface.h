...
#define SOC_CS_TOP_ETR_ETR_RSZ_ADDR(base) ((base) + (0x004UL))
#define SOC_CS_TOP_ETR_ETR_STS_ADDR(base) ((base) + (0x00CUL))
#define SOC_CS_TOP_ETR_ETR_RRD_ADDR(base) ((base) + (0x010UL))
#define SOC_CS_TOP_ETR_ETR_RRP_ADDR(base) ((base) + (0x014UL))
#define SOC_CS_TOP_ETR_ETR_RWP_ADDR(base) ((base) + (0x018UL))
#define SOC_CS_TOP_ETR_ETR_TRG_ADDR(base) ((base) + (0x01CUL))
#define SOC_CS_TOP_ETR_ETR_CTL_ADDR(base) ((base) + (0x020UL))
#define SOC_CS_TOP_ETR_ETR_RWD_ADDR(base) ((base) + (0x024UL))
#define SOC_CS_TOP_ETR_ETR_MODE_ADDR(base) ((base) + (0x028UL))
#define SOC_CS_TOP_ETR_ETR_LBUFLEVEL_ADDR(base) ((base) + (0x02CUL))
#define SOC_CS_TOP_ETR_ETR_CBUFLEVEL_ADDR(base) ((base) + (0x030UL))
#define SOC_CS_TOP_ETR_ETR_BUFWM_ADDR(base) ((base) + (0x034UL))
#define SOC_CS_TOP_ETR_ETR_RRPHI_ADDR(base) ((base) + (0x038UL))
#define SOC_CS_TOP_ETR_ETR_RWPHI_ADDR(base) ((base) + (0x03CUL))
#define SOC_CS_TOP_ETR_ETR_AXICTL_ADDR(base) ((base) + (0x110UL))
#define SOC_CS_TOP_ETR_ETR_DBALO_ADDR(base) ((base) + (0x118UL))
#define SOC_CS_TOP_ETR_ETR_DBAHO_ADDR(base) ((base) + (0x11CUL))
#define SOC_CS_TOP_ETR_ETR_FFSR_ADDR(base) ((base) + (0x300UL))
#define SOC_CS_TOP_ETR_ETR_FFCR_ADDR(base) ((base) + (0x304UL))
#define SOC_CS_TOP_ETR_ETR_FSCR_ADDR(base) ((base) + (0x308UL))
#define SOC_CS_TOP_ETR_ETR_LAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_TOP_ETR_ETR_LSR_ADDR(base) ((base) + (0xFB4UL))
#define SOC_CS_TOP_ETR_ETR_AUTHSTATUS_ADDR(base) ((base) + (0xFB8UL))
#else
