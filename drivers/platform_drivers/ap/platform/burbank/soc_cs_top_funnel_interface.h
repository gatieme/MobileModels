...
#define SOC_CS_TOP_FUNNEL_FUNNEL_CTRL_REG_ADDR(base) ((base) + (0x000UL))
#define SOC_CS_TOP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_ADDR(base) ((base) + (0x004UL))
#define SOC_CS_TOP_FUNNEL_FUNNEL_LAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_TOP_FUNNEL_FUNNEL_LSR_ADDR(base) ((base) + (0xFB4UL))
#else
...
#define SOC_CS_TOP_FUNNEL_FUNNEL_CTRL_REG_enable_END (7)
