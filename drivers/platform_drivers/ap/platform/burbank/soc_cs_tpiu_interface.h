...
#define SOC_CS_TPIU_TPIU_SUPPORTED_PORT_SIZES_ADDR(base) ((base) + (0x000UL))
#define SOC_CS_TPIU_TPIU_CURRENT_PORT_SIZES_ADDR(base) ((base) + (0x004UL))
#define SOC_CS_TPIU_TPIU_SUPPORTED_TRIGGER_MODES_ADDR(base) ((base) + (0x100UL))
#define SOC_CS_TPIU_TPIU_TRIGGER_COUNTER_VALUE_ADDR(base) ((base) + (0x104UL))
#define SOC_CS_TPIU_TPIU_TRIGGER_MULTIPLIER_ADDR(base) ((base) + (0x108UL))
#define SOC_CS_TPIU_TPIU_SUPPORTED_TEST_PATTERN_MODE_ADDR(base) ((base) + (0x200UL))
#define SOC_CS_TPIU_TPIU_CURRENT_TEST_PATTERN_MODE_ADDR(base) ((base) + (0x204UL))
#define SOC_CS_TPIU_TPIU_TPRCR_ADDR(base) ((base) + (0x208UL))
#define SOC_CS_TPIU_TPIU_FFSR_ADDR(base) ((base) + (0x300UL))
#define SOC_CS_TPIU_TPIU_FFCR_ADDR(base) ((base) + (0x304UL))
#define SOC_CS_TPIU_TPIU_FSCR_ADDR(base) ((base) + (0x308UL))
#define SOC_CS_TPIU_TPIU_EXTCTL_IN_PORT_ADDR(base) ((base) + (0x400UL))
#define SOC_CS_TPIU_TPIU_EXTCTL_OUT_PORT_ADDR(base) ((base) + (0x404UL))
#define SOC_CS_TPIU_TPIU_LAR_ADDR(base) ((base) + (0xFB0UL))
#define SOC_CS_TPIU_TPIU_LSR_ADDR(base) ((base) + (0xFB4UL))
#else
