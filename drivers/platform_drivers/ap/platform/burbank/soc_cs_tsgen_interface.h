...
#define SOC_CS_TSGEN_TS_CNTCR_ADDR(base) ((base) + (0x0000UL))
#define SOC_CS_TSGEN_TS_CNTSR_ADDR(base) ((base) + (0x0004UL))
#define SOC_CS_TSGEN_TS_CNTCVLW_ADDR(base) ((base) + (0x0008UL))
#define SOC_CS_TSGEN_TS_CNTCVUP_ADDR(base) ((base) + (0x000CUL))
#define SOC_CS_TSGEN_TS_CNTFID0_ADDR(base) ((base) + (0x0020UL))
#define SOC_CS_TSGEN_TSCNTCVLW_RO_ADDR(base) ((base) + (0x1000UL))
#define SOC_CS_TSGEN_TSCNTCVUP_RO_ADDR(base) ((base) + (0x1004UL))
#else
