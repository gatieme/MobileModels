...
#define SOC_CTF_VSCAN_ADDR(base) ((base) + (0x000UL))
#define SOC_CTF_PTN0_ADDR(base) ((base) + (0x010UL))
#define SOC_CTF_PTN1_ADDR(base) ((base) + (0x014UL))
#define SOC_CTF_PTN2_ADDR(base) ((base) + (0x018UL))
#define SOC_CTF_PTN3_ADDR(base) ((base) + (0x01CUL))
#define SOC_CTF_PTN4_ADDR(base) ((base) + (0x020UL))
#define SOC_CTF_PTN5_ADDR(base) ((base) + (0x024UL))
#define SOC_CTF_PTN6_ADDR(base) ((base) + (0x028UL))
#define SOC_CTF_PTN7_ADDR(base) ((base) + (0x02CUL))
#define SOC_CTF_SGIMASK_ADDR(base) ((base) + (0x040UL))
#define SOC_CTF_PPIMASK_ADDR(base) ((base) + (0x044UL))
#define SOC_CTF_SPIMASK_ADDR(base) ((base) + (0x048UL))
#define SOC_CTF_SGIGROUP_ADDR(base) ((base) + (0x04CUL))
#define SOC_CTF_PPIGROUP_ADDR(base) ((base) + (0x050UL))
#define SOC_CTF_SPIGROUP_ADDR(base) ((base) + (0x054UL))
#define SOC_CTF_APB_WR_ERR_ADDR(base) ((base) + (0x058UL))
#define SOC_CTF_SPI_INT_EN_ADDR(base) ((base) + (0x060UL))
#define SOC_CTF_SPI_INT_CLR_ADDR(base) ((base) + (0x064UL))
#define SOC_CTF_SPI_RAWSTAT_ADDR(base) ((base) + (0x068UL))
#define SOC_CTF_SPITARG0_ADDR(base) ((base) + (0x070UL))
#define SOC_CTF_SPITARG1_ADDR(base) ((base) + (0x0074UL))
#define SOC_CTF_SPITARG2_ADDR(base) ((base) + (0x078UL))
#define SOC_CTF_SPITARG3_ADDR(base) ((base) + (0x07CUL))
