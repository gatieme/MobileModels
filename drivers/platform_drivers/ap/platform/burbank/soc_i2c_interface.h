...
#define SOC_I2C_IC_CON_ADDR(base) ((base) + (0x000UL))
#define SOC_I2C_IC_TAR_ADDR(base) ((base) + (0x004UL))
#define SOC_I2C_IC_SAR_ADDR(base) ((base) + (0x0008UL))
#define SOC_I2C_IC_HS_MADDR_ADDR(base) ((base) + (0x00CUL))
#define SOC_I2C_IC_DATA_CMD_ADDR(base) ((base) + (0x010UL))
#define SOC_I2C_IC_SS_SCL_HCNT_ADDR(base) ((base) + (0x014UL))
#define SOC_I2C_IC_SS_SCL_LCNT_ADDR(base) ((base) + (0x018UL))
#define SOC_I2C_IC_FS_SCL_HCNT_ADDR(base) ((base) + (0x01CUL))
#define SOC_I2C_IC_FS_SCL_LCNT_ADDR(base) ((base) + (0x020UL))
#define SOC_I2C_IC_HS_SCL_HCNT_ADDR(base) ((base) + (0x024UL))
#define SOC_I2C_IC_HS_SCL_LCNT_ADDR(base) ((base) + (0x028UL))
#define SOC_I2C_IC_INTR_STAT_ADDR(base) ((base) + (0x02CUL))
#define SOC_I2C_IC_INTR_MASK_ADDR(base) ((base) + (0x030UL))
#define SOC_I2C_IC_RAW_INTR_STAT_ADDR(base) ((base) + (0x034UL))
#define SOC_I2C_IC_RX_TL_ADDR(base) ((base) + (0x038UL))
#define SOC_I2C_IC_TX_TL_ADDR(base) ((base) + (0x03CUL))
#define SOC_I2C_IC_CLR_INTR_ADDR(base) ((base) + (0x040UL))
#define SOC_I2C_IC_CLR_RX_UNDER_ADDR(base) ((base) + (0x044UL))
#define SOC_I2C_IC_CLR_RX_OVER_ADDR(base) ((base) + (0x048UL))
#define SOC_I2C_IC_CLR_TX_OVER_ADDR(base) ((base) + (0x04CUL))
#define SOC_I2C_CLR_RD_REQ_ADDR(base) ((base) + (0x050UL))
#define SOC_I2C_IC_CLR_TX_ABRT_ADDR(base) ((base) + (0x054UL))
#define SOC_I2C_CLR_RX_DONE_ADDR(base) ((base) + (0x058UL))
#define SOC_I2C_IC_CLR_ACTIVITY_ADDR(base) ((base) + (0x5CUL))
#define SOC_I2C_IC_CLR_STOP_DET_ADDR(base) ((base) + (0x060UL))
#define SOC_I2C_IC_CLR_SART_DET_ADDR(base) ((base) + (0x064UL))
#define SOC_I2C_IC_CLR_GEN_CALL_ADDR(base) ((base) + (0x068UL))
#define SOC_I2C_IC_ENABLE_ADDR(base) ((base) + (0x06CUL))
#define SOC_I2C_IC_STATUS_ADDR(base) ((base) + (0x070UL))
#define SOC_I2C_IC_TXFLR_ADDR(base) ((base) + (0x074UL))
#define SOC_I2C_IC_RXFLR_ADDR(base) ((base) + (0x078UL))
#define SOC_I2C_IC_SDA_HOLD_ADDR(base) ((base) + (0x07CUL))
#define SOC_I2C_IC_TX_ABRT_SOURCE_ADDR(base) ((base) + (0x080UL))
#define SOC_I2C_SLV_DATA_NACK_ONLY_ADDR(base) ((base) + (0x084UL))
#define SOC_I2C_IC_DMA_CR_ADDR(base) ((base) + (0x088UL))
#define SOC_I2C_IC_DMA_TDLR_ADDR(base) ((base) + (0x08CUL))
#define SOC_I2C_IC_DMA_RDLR_ADDR(base) ((base) + (0x090UL))
#define SOC_I2C_IC_SDA_SETUP_ADDR(base) ((base) + (0x094UL))
#define SOC_I2C_IC_ACK_GENERAL_CALL_ADDR(base) ((base) + (0x098UL))
#define SOC_I2C_IC_ENABLE_STATUS_ADDR(base) ((base) + (0x09CUL))
#define SOC_I2C_IC_FS_SPKLEN_ADDR(base) ((base) + (0x00A0UL))
#define SOC_I2C_IC_HS_SPKLEN_ADDR(base) ((base) + (0x00A4UL))
#define SOC_I2C_CLR_RESTART_DET_ADDR(base) ((base) + (0x00A8UL))
#define SOC_I2C_IC_COMP_PARAM_1_ADDR(base) ((base) + (0x00F4UL))
#define SOC_I2C_IC_COMP_VERSION_ADDR(base) ((base) + (0x00F8UL))
#define SOC_I2C_IC_COMP_TYPE_ADDR(base) ((base) + (0x00FCUL))
#else
