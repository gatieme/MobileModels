...
#define SOC_IOC_MMC1_IOMG_000_ADDR(base) ((base) + (0x000UL))
#define SOC_IOC_MMC1_IOMG_001_ADDR(base) ((base) + (0x004UL))
#define SOC_IOC_MMC1_IOMG_002_ADDR(base) ((base) + (0x008UL))
#define SOC_IOC_MMC1_IOMG_003_ADDR(base) ((base) + (0x00CUL))
#define SOC_IOC_MMC1_IOMG_004_ADDR(base) ((base) + (0x010UL))
#define SOC_IOC_MMC1_IOMG_005_ADDR(base) ((base) + (0x014UL))
#define SOC_IOC_MMC1_IOCG_000_ADDR(base) ((base) + (0x800UL))
#define SOC_IOC_MMC1_IOCG_001_ADDR(base) ((base) + (0x804UL))
#define SOC_IOC_MMC1_IOCG_002_ADDR(base) ((base) + (0x808UL))
#define SOC_IOC_MMC1_IOCG_003_ADDR(base) ((base) + (0x80CUL))
#define SOC_IOC_MMC1_IOCG_004_ADDR(base) ((base) + (0x810UL))
#define SOC_IOC_MMC1_IOCG_005_ADDR(base) ((base) + (0x814UL))
#else
...
#define SOC_IOC_MMC1_IOMG_000_iomg_000_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOC_MMC1_IOCG_000_iocg_000_st_START (3)
#define SOC_IOC_MMC1_IOCG_000_iocg_000_st_END (3)
...
#define SOC_IOC_MMC1_IOCG_000_iocg_000_sl_START (7)
#define SOC_IOC_MMC1_IOCG_000_iocg_000_sl_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOC_MMC1_IOCG_001_iocg_001_st_START (3)
#define SOC_IOC_MMC1_IOCG_001_iocg_001_st_END (3)
...
#define SOC_IOC_MMC1_IOCG_001_iocg_001_sl_START (7)
#define SOC_IOC_MMC1_IOCG_001_iocg_001_sl_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOC_MMC1_IOCG_002_iocg_002_st_START (3)
#define SOC_IOC_MMC1_IOCG_002_iocg_002_st_END (3)
...
#define SOC_IOC_MMC1_IOCG_002_iocg_002_sl_START (7)
#define SOC_IOC_MMC1_IOCG_002_iocg_002_sl_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOC_MMC1_IOCG_003_iocg_003_st_START (3)
#define SOC_IOC_MMC1_IOCG_003_iocg_003_st_END (3)
...
#define SOC_IOC_MMC1_IOCG_003_iocg_003_sl_START (7)
#define SOC_IOC_MMC1_IOCG_003_iocg_003_sl_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOC_MMC1_IOCG_004_iocg_004_st_START (3)
#define SOC_IOC_MMC1_IOCG_004_iocg_004_st_END (3)
...
#define SOC_IOC_MMC1_IOCG_004_iocg_004_sl_START (7)
#define SOC_IOC_MMC1_IOCG_004_iocg_004_sl_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOC_MMC1_IOCG_005_iocg_005_st_START (3)
#define SOC_IOC_MMC1_IOCG_005_iocg_005_st_END (3)
...
#define SOC_IOC_MMC1_IOCG_005_iocg_005_sl_START (7)
#define SOC_IOC_MMC1_IOCG_005_iocg_005_sl_END (7)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
