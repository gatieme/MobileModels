...
#define SOC_MMBUF_SMC_LOCK_ADDR(base) ((base) + (0x0000UL))
#define SOC_MMBUF_SMC_MEM_LP_ADDR(base) ((base) + (0x0004UL))
#define SOC_MMBUF_GCLK_CS_ADDR(base) ((base) + (0x000CUL))
#define SOC_MMBUF_SMC_QOS_BACKDOOR_ADDR(base) ((base) + (0x0010UL))
#define SOC_MMBUF_SMC_DFX_WCMD_CNT_1ST_ADDR(base) ((base) + (0x0014UL))
#define SOC_MMBUF_SMC_DFX_WCMD_CNT_2ND_ADDR(base) ((base) + (0x0018UL))
#define SOC_MMBUF_SMC_DFX_WCMD_CNT_3RD_ADDR(base) ((base) + (0x001CUL))
#define SOC_MMBUF_SMC_DFX_WCMD_CNT_4TH_ADDR(base) ((base) + (0x0020UL))
#define SOC_MMBUF_SMC_DFX_RCMD_CNT_1ST_ADDR(base) ((base) + (0x0024UL))
#define SOC_MMBUF_SMC_DFX_RCMD_CNT_2ND_ADDR(base) ((base) + (0x0028UL))
#define SOC_MMBUF_SMC_DFX_RCMD_CNT_3RD_ADDR(base) ((base) + (0x002CUL))
#define SOC_MMBUF_SMC_DFX_RCMD_CNT_4TH_ADDR(base) ((base) + (0x0030UL))
#define SOC_MMBUF_SMC_CS_IDLE_ADDR(base) ((base) + (0x0034UL))
#define SOC_MMBUF_SMC_DFX_BFIFO_CNT0_ADDR(base) ((base) + (0x0038UL))
#define SOC_MMBUF_SMC_DFX_RDFIFO_CNT1_ADDR(base) ((base) + (0x003CUL))
#define SOC_MMBUF_SP_SRAM_STATE0_ADDR(base) ((base) + (0x0040UL))
#define SOC_MMBUF_SP_SRAM_STATE1_ADDR(base) ((base) + (0x0044UL))
#else
