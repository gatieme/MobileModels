...
#define SOC_NPU_AICORE_PMU_MIN_OV_CNT_ADDR(base) ((base) + (0x000000258UL))
...
#define SOC_NPU_AICORE_BLK_TIMEOUT_ADDR(base) ((base) + (0x00000E00UL))
#else
...
#define SOC_NPU_AICORE_PMU_MIN_OV_CNT_ADDR(base) ((base) + (0x000000258))
...
#define SOC_NPU_AICORE_BLK_TIMEOUT_ADDR(base) ((base) + (0x00000E00))
#endif
#ifndef __SOC_H_FOR_ASM__
#define SOC_NPU_AICORE_BIU_STATUS2_ADDR(base) ((base) + (0xD28UL))
#define SOC_NPU_AICORE_BIU_STATUS3_ADDR(base) ((base) + (0xD30UL))
#define SOC_NPU_AICORE_BIU_STATUS4_ADDR(base) ((base) + (0xD38UL))
#define SOC_NPU_AICORE_L2_REMAP_PADDR_BASE_ADDR(base) ((base) + (0xD50UL))
#define SOC_NPU_AICORE_L2_PAGE_SIZE_ADDR(base) ((base) + (0xD58UL))
#define SOC_NPU_AICORE_L2_SIZE_ADDR(base) ((base) + (0xD60UL))
#define SOC_NPU_AICORE_BIU_CTRL3_ADDR(base) ((base) + (0xD80UL))
#define SOC_NPU_AICORE_BIU_CTRL4_ADDR(base) ((base) + (0xD88UL))
#define SOC_NPU_AICORE_BIU_CTRL5_ADDR(base) ((base) + (0xD90UL))
#define SOC_NPU_AICORE_BIU_STATUS6_ADDR(base) ((base) + (0xD98UL))
#define SOC_NPU_AICORE_BIU_STATUS7_ADDR(base) ((base) + (0xDA0UL))
#else
#define SOC_NPU_AICORE_BIU_STATUS2_ADDR(base) ((base) + (0xD28))
#define SOC_NPU_AICORE_BIU_STATUS3_ADDR(base) ((base) + (0xD30))
#define SOC_NPU_AICORE_BIU_STATUS4_ADDR(base) ((base) + (0xD38))
#define SOC_NPU_AICORE_L2_REMAP_PADDR_BASE_ADDR(base) ((base) + (0xD50))
#define SOC_NPU_AICORE_L2_PAGE_SIZE_ADDR(base) ((base) + (0xD58))
#define SOC_NPU_AICORE_L2_SIZE_ADDR(base) ((base) + (0xD60))
#define SOC_NPU_AICORE_BIU_CTRL3_ADDR(base) ((base) + (0xD80))
#define SOC_NPU_AICORE_BIU_CTRL4_ADDR(base) ((base) + (0xD88))
#define SOC_NPU_AICORE_BIU_CTRL5_ADDR(base) ((base) + (0xD90))
#define SOC_NPU_AICORE_BIU_STATUS6_ADDR(base) ((base) + (0xD98))
#define SOC_NPU_AICORE_BIU_STATUS7_ADDR(base) ((base) + (0xDA0))
#endif
#ifndef __SOC_H_FOR_ASM__
typedef union
{
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long long dbg_ctrl_reserved : 58;
    } reg;
...
#define SOC_NPU_AICORE_DBG_CTRL_dbg_ctrl_reserved_START (6)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long long reserved_1 : 49;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long long reserved_3 : 39;
...
#define SOC_NPU_AICORE_CLK_GATE_MASK_clk_ccu_l0a_en_mask_START (2)
#define SOC_NPU_AICORE_CLK_GATE_MASK_clk_ccu_l0a_en_mask_END (2)
#define SOC_NPU_AICORE_CLK_GATE_MASK_clk_ccu_l0b_en_mask_START (3)
#define SOC_NPU_AICORE_CLK_GATE_MASK_clk_ccu_l0b_en_mask_END (3)
#define SOC_NPU_AICORE_CLK_GATE_MASK_clk_ccu_l0c_en_mask_START (4)
#define SOC_NPU_AICORE_CLK_GATE_MASK_clk_ccu_l0c_en_mask_END (4)
...
#define SOC_NPU_AICORE_PC_START_ifu_preload_cnt_START (60)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long long ifu_reserved_reg : 61;
    } reg;
...
#define SOC_NPU_AICORE_IFU_CTRL_ifu_reserved_reg_START (3)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long long ccu_reserved_reg : 56;
    } reg;
...
#define SOC_NPU_AICORE_CCU_CTRL_ccu_reserved_reg_START (8)
...
#define SOC_NPU_AICORE_BIU_L2_SIZE_biu_l2_size_END (2)
...
#define SOC_NPU_AICORE_BIU_L2_PAGE_SIZE_biu_l2_page_size_END (2)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
...
#define SOC_NPU_AICORE_BIU_ERR_INFO_biu_err_addr_END (24)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
...
#define SOC_NPU_AICORE_MTE_ERR_INFO_mte_err_type_END (26)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
...
#define SOC_NPU_AICORE_MTE_ECC_1BIT_ERR_mte_warn_rob_ecc_1bit_addr_END (25)
...
#endif
#define SOC_NPU_AICORE_SC_RESERVED_REG00_ec_ver_START (0)
#define SOC_NPU_AICORE_SC_RESERVED_REG00_ec_ver_END (3)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long long sc_reserved_reg01 : 22;
    } reg;
...
#define SOC_NPU_AICORE_SC_RESERVED_REG01_sc_reserved_reg01_START (42)
...
} SOC_NPU_AICORE_BLK_TIMEOUT_UNION;
#endif
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned long long stat_cycle : 32;
        unsigned long long reserved : 32;
    } reg;
} SOC_NPU_AICORE_BIU_STATUS2_UNION;
#endif
#define SOC_NPU_AICORE_BIU_STATUS2_stat_cycle_START (0)
#define SOC_NPU_AICORE_BIU_STATUS2_stat_cycle_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long stat_rcmd_num : 32;
        unsigned long long stat_wcmd_num : 32;
    } reg;
} SOC_NPU_AICORE_BIU_STATUS3_UNION;
#endif
#define SOC_NPU_AICORE_BIU_STATUS3_stat_rcmd_num_START (0)
#define SOC_NPU_AICORE_BIU_STATUS3_stat_rcmd_num_END (31)
#define SOC_NPU_AICORE_BIU_STATUS3_stat_wcmd_num_START (32)
#define SOC_NPU_AICORE_BIU_STATUS3_stat_wcmd_num_END (63)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long stat_rlat_raw : 32;
        unsigned long long stat_wlat_raw : 32;
    } reg;
} SOC_NPU_AICORE_BIU_STATUS4_UNION;
#endif
#define SOC_NPU_AICORE_BIU_STATUS4_stat_rlat_raw_START (0)
#define SOC_NPU_AICORE_BIU_STATUS4_stat_rlat_raw_END (31)
#define SOC_NPU_AICORE_BIU_STATUS4_stat_wlat_raw_START (32)
#define SOC_NPU_AICORE_BIU_STATUS4_stat_wlat_raw_END (63)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long l2_paddr_base : 64;
    } reg;
} SOC_NPU_AICORE_L2_REMAP_PADDR_BASE_UNION;
#endif
#define SOC_NPU_AICORE_L2_REMAP_PADDR_BASE_l2_paddr_base_START (0)
#define SOC_NPU_AICORE_L2_REMAP_PADDR_BASE_l2_paddr_base_END (63)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long page_size : 3;
        unsigned long long reserved : 61;
    } reg;
} SOC_NPU_AICORE_L2_PAGE_SIZE_UNION;
#endif
#define SOC_NPU_AICORE_L2_PAGE_SIZE_page_size_START (0)
#define SOC_NPU_AICORE_L2_PAGE_SIZE_page_size_END (2)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long l2_size : 3;
        unsigned long long reserved : 61;
    } reg;
} SOC_NPU_AICORE_L2_SIZE_UNION;
#endif
#define SOC_NPU_AICORE_L2_SIZE_l2_size_START (0)
#define SOC_NPU_AICORE_L2_SIZE_l2_size_END (2)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long mon_en : 1;
        unsigned long long mon_axi_sel : 1;
        unsigned long long aif_clk_en : 1;
        unsigned long long aif_clk_sel : 1;
        unsigned long long addr_protect_en : 1;
        unsigned long long reserved_0 : 3;
        unsigned long long rosd_cfg : 6;
        unsigned long long wosd_cfg : 5;
        unsigned long long reserved_1 : 13;
        unsigned long long r_credit_en_dynam : 1;
        unsigned long long w_credit_en_dynam : 1;
        unsigned long long credit_mode_dynam : 2;
        unsigned long long r_max_cont_dynam : 6;
        unsigned long long r_osd_th_dynam : 6;
        unsigned long long w_max_cont_dynam : 5;
        unsigned long long w_osd_th_dynam : 5;
        unsigned long long reserved_2 : 6;
    } reg;
} SOC_NPU_AICORE_BIU_CTRL3_UNION;
#endif
#define SOC_NPU_AICORE_BIU_CTRL3_mon_en_START (0)
#define SOC_NPU_AICORE_BIU_CTRL3_mon_en_END (0)
#define SOC_NPU_AICORE_BIU_CTRL3_mon_axi_sel_START (1)
#define SOC_NPU_AICORE_BIU_CTRL3_mon_axi_sel_END (1)
#define SOC_NPU_AICORE_BIU_CTRL3_aif_clk_en_START (2)
#define SOC_NPU_AICORE_BIU_CTRL3_aif_clk_en_END (2)
#define SOC_NPU_AICORE_BIU_CTRL3_aif_clk_sel_START (3)
#define SOC_NPU_AICORE_BIU_CTRL3_aif_clk_sel_END (3)
#define SOC_NPU_AICORE_BIU_CTRL3_addr_protect_en_START (4)
#define SOC_NPU_AICORE_BIU_CTRL3_addr_protect_en_END (4)
#define SOC_NPU_AICORE_BIU_CTRL3_rosd_cfg_START (8)
#define SOC_NPU_AICORE_BIU_CTRL3_rosd_cfg_END (13)
#define SOC_NPU_AICORE_BIU_CTRL3_wosd_cfg_START (14)
#define SOC_NPU_AICORE_BIU_CTRL3_wosd_cfg_END (18)
#define SOC_NPU_AICORE_BIU_CTRL3_r_credit_en_dynam_START (32)
#define SOC_NPU_AICORE_BIU_CTRL3_r_credit_en_dynam_END (32)
#define SOC_NPU_AICORE_BIU_CTRL3_w_credit_en_dynam_START (33)
#define SOC_NPU_AICORE_BIU_CTRL3_w_credit_en_dynam_END (33)
#define SOC_NPU_AICORE_BIU_CTRL3_credit_mode_dynam_START (34)
#define SOC_NPU_AICORE_BIU_CTRL3_credit_mode_dynam_END (35)
#define SOC_NPU_AICORE_BIU_CTRL3_r_max_cont_dynam_START (36)
#define SOC_NPU_AICORE_BIU_CTRL3_r_max_cont_dynam_END (41)
#define SOC_NPU_AICORE_BIU_CTRL3_r_osd_th_dynam_START (42)
#define SOC_NPU_AICORE_BIU_CTRL3_r_osd_th_dynam_END (47)
#define SOC_NPU_AICORE_BIU_CTRL3_w_max_cont_dynam_START (48)
#define SOC_NPU_AICORE_BIU_CTRL3_w_max_cont_dynam_END (52)
#define SOC_NPU_AICORE_BIU_CTRL3_w_osd_th_dynam_START (53)
#define SOC_NPU_AICORE_BIU_CTRL3_w_osd_th_dynam_END (57)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long r_credit_en : 1;
        unsigned long long r_credit_mode : 3;
        unsigned long long r_credit_step : 7;
        unsigned long long reserved_0 : 1;
        unsigned long long r_credit_uth : 9;
        unsigned long long r_credit_lth : 9;
        unsigned long long r_max_cont : 6;
        unsigned long long r_credit_step_dynam : 7;
        unsigned long long reserved_1 : 3;
        unsigned long long r_credit_uth_dynam : 9;
        unsigned long long r_credit_lth_dynam : 9;
    } reg;
} SOC_NPU_AICORE_BIU_CTRL4_UNION;
#endif
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_en_START (0)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_en_END (0)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_mode_START (1)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_mode_END (3)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_step_START (4)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_step_END (10)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_uth_START (12)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_uth_END (20)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_lth_START (21)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_lth_END (29)
#define SOC_NPU_AICORE_BIU_CTRL4_r_max_cont_START (30)
#define SOC_NPU_AICORE_BIU_CTRL4_r_max_cont_END (35)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_step_dynam_START (36)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_step_dynam_END (42)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_uth_dynam_START (46)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_uth_dynam_END (54)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_lth_dynam_START (55)
#define SOC_NPU_AICORE_BIU_CTRL4_r_credit_lth_dynam_END (63)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long w_credit_en : 1;
        unsigned long long w_credit_mode : 3;
        unsigned long long w_credit_step : 7;
        unsigned long long reserved_0 : 1;
        unsigned long long w_credit_uth : 9;
        unsigned long long w_credit_lth : 9;
        unsigned long long w_max_cont : 6;
        unsigned long long w_credit_step_dynam : 7;
        unsigned long long reserved_1 : 3;
        unsigned long long w_credit_uth_dynam : 9;
        unsigned long long w_credit_lth_dynam : 9;
    } reg;
} SOC_NPU_AICORE_BIU_CTRL5_UNION;
#endif
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_en_START (0)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_en_END (0)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_mode_START (1)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_mode_END (3)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_step_START (4)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_step_END (10)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_uth_START (12)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_uth_END (20)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_lth_START (21)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_lth_END (29)
#define SOC_NPU_AICORE_BIU_CTRL5_w_max_cont_START (30)
#define SOC_NPU_AICORE_BIU_CTRL5_w_max_cont_END (35)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_step_dynam_START (36)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_step_dynam_END (42)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_uth_dynam_START (46)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_uth_dynam_END (54)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_lth_dynam_START (55)
#define SOC_NPU_AICORE_BIU_CTRL5_w_credit_lth_dynam_END (63)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long stat_flux_rd : 32;
        unsigned long long stat_flux_wr : 32;
    } reg;
} SOC_NPU_AICORE_BIU_STATUS6_UNION;
#endif
#define SOC_NPU_AICORE_BIU_STATUS6_stat_flux_rd_START (0)
#define SOC_NPU_AICORE_BIU_STATUS6_stat_flux_rd_END (31)
#define SOC_NPU_AICORE_BIU_STATUS6_stat_flux_wr_START (32)
#define SOC_NPU_AICORE_BIU_STATUS6_stat_flux_wr_END (63)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned long long value;
    struct
    {
        unsigned long long axi0_rosd : 8;
        unsigned long long axi0_wosd : 8;
        unsigned long long axi1_rosd : 8;
        unsigned long long axi1_wosd : 8;
        unsigned long long axi0_wstrob : 16;
        unsigned long long axi1_wstrob : 16;
    } reg;
} SOC_NPU_AICORE_BIU_STATUS7_UNION;
#endif
#define SOC_NPU_AICORE_BIU_STATUS7_axi0_rosd_START (0)
#define SOC_NPU_AICORE_BIU_STATUS7_axi0_rosd_END (7)
#define SOC_NPU_AICORE_BIU_STATUS7_axi0_wosd_START (8)
#define SOC_NPU_AICORE_BIU_STATUS7_axi0_wosd_END (15)
#define SOC_NPU_AICORE_BIU_STATUS7_axi1_rosd_START (16)
#define SOC_NPU_AICORE_BIU_STATUS7_axi1_rosd_END (23)
#define SOC_NPU_AICORE_BIU_STATUS7_axi1_wosd_START (24)
#define SOC_NPU_AICORE_BIU_STATUS7_axi1_wosd_END (31)
#define SOC_NPU_AICORE_BIU_STATUS7_axi0_wstrob_START (32)
#define SOC_NPU_AICORE_BIU_STATUS7_axi0_wstrob_END (47)
#define SOC_NPU_AICORE_BIU_STATUS7_axi1_wstrob_START (48)
#define SOC_NPU_AICORE_BIU_STATUS7_axi1_wstrob_END (63)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
