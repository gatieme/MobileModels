...
#endif
#define SOC_PCR_CTRL_svfd_select_START (0)
#define SOC_PCR_CTRL_svfd_select_END (0)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int acc_period : 4;
        unsigned int svfd_delay_period : 5;
        unsigned int svfd_delay_en : 1;
...
#define SOC_PCR_CFG_PERIOD0_acc_period_START (20)
#define SOC_PCR_CFG_PERIOD0_acc_period_END (23)
#define SOC_PCR_CFG_PERIOD0_svfd_delay_period_START (24)
#define SOC_PCR_CFG_PERIOD0_svfd_delay_period_END (28)
#define SOC_PCR_CFG_PERIOD0_svfd_delay_en_START (29)
#define SOC_PCR_CFG_PERIOD0_svfd_delay_en_END (29)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
