...
#define SOC_SD_SDIO_CTRL_ADDR(base) ((base) + (0x000UL))
#define SOC_SD_SDIO_CLKDIV_ADDR(base) ((base) + (0x008UL))
#define SOC_SD_SDIO_CLKENA_ADDR(base) ((base) + (0x010UL))
#define SOC_SD_SDIO_TMOUT_ADDR(base) ((base) + (0x014UL))
#define SOC_SD_SDIO_CTYPE_ADDR(base) ((base) + (0x018UL))
#define SOC_SD_SDIO_BLKSIZ_ADDR(base) ((base) + (0x01CUL))
#define SOC_SD_SDIO_BYTCNT_ADDR(base) ((base) + (0x020UL))
#define SOC_SD_SDIO_INTMASK_ADDR(base) ((base) + (0x024UL))
#define SOC_SD_SDIO_CMDARG_ADDR(base) ((base) + (0x028UL))
#define SOC_SD_SDIO_CMD_ADDR(base) ((base) + (0x02CUL))
#define SOC_SD_SDIO_RESP0_ADDR(base) ((base) + (0x030UL))
#define SOC_SD_SDIO_RESP1_ADDR(base) ((base) + (0x034UL))
#define SOC_SD_SDIO_RESP2_ADDR(base) ((base) + (0x038UL))
#define SOC_SD_SDIO_RESP3_ADDR(base) ((base) + (0x03CUL))
#define SOC_SD_SDIO_MINTSTS_ADDR(base) ((base) + (0x040UL))
#define SOC_SD_SDIO_RINTSTS_ADDR(base) ((base) + (0x044UL))
#define SOC_SD_SDIO_STATUS_ADDR(base) ((base) + (0x048UL))
#define SOC_SD_SDIO_FIFOTH_ADDR(base) ((base) + (0x04CUL))
#define SOC_SD_SDIO_GPIO_ADDR(base) ((base) + (0x058UL))
#define SOC_SD_SDIO_TCBCNT_ADDR(base) ((base) + (0x05CUL))
#define SOC_SD_SDIO_TTBCNT_ADDR(base) ((base) + (0x060UL))
#define SOC_SD_SDIO_USRID_ADDR(base) ((base) + (0x068UL))
#define SOC_SD_SDIO_VERID_ADDR(base) ((base) + (0x06CUL))
#define SOC_SD_SDIO_HCON_ADDR(base) ((base) + (0x070UL))
#define SOC_SD_SDIO_UHS_REG_ADDR(base) ((base) + (0x074UL))
#define SOC_SD_SDIO_BMOD_ADDR(base) ((base) + (0x080UL))
#define SOC_SD_SDIO_PLDMND_ADDR(base) ((base) + (0x084UL))
#define SOC_SD_SDIO_DBADDRL_ADDR(base) ((base) + (0x088UL))
#define SOC_SD_SDIO_DBADDRU_ADDR(base) ((base) + (0x08CUL))
#define SOC_SD_SDIO_IDSTS_ADDR(base) ((base) + (0x090UL))
#define SOC_SD_SDIO_IDINTEN_ADDR(base) ((base) + (0x094UL))
#define SOC_SD_SDIO_DSCADDRL_ADDR(base) ((base) + (0x098UL))
#define SOC_SD_SDIO_DSCADDRU_ADDR(base) ((base) + (0x09CUL))
#define SOC_SD_SDIO_BUFADDRL_ADDR(base) ((base) + (0x0A0UL))
#define SOC_SD_SDIO_BUFADDRU_ADDR(base) ((base) + (0x0A4UL))
#define SOC_SD_SDIO_CARDTHRCTL_ADDR(base) ((base) + (0x100UL))
#define SOC_SD_SDIO_UHS_REG_EXT_ADDR(base) ((base) + (0x108UL))
#define SOC_SD_SDIO_EMMC_DDR_REG_ADDR(base) ((base) + (0x10CUL))
#define SOC_SD_SDIO_ENABLE_SHIFT_ADDR(base) ((base) + (0x110UL))
#else
...
#define SOC_SD_SDIO_DBADDRL_ADDR(base) ((base) + (0x088))
#define SOC_SD_SDIO_DBADDRU_ADDR(base) ((base) + (0x08C))
#define SOC_SD_SDIO_IDSTS_ADDR(base) ((base) + (0x090))
#define SOC_SD_SDIO_IDINTEN_ADDR(base) ((base) + (0x094))
#define SOC_SD_SDIO_DSCADDRL_ADDR(base) ((base) + (0x098))
#define SOC_SD_SDIO_DSCADDRU_ADDR(base) ((base) + (0x09C))
#define SOC_SD_SDIO_BUFADDRL_ADDR(base) ((base) + (0x0A0))
#define SOC_SD_SDIO_BUFADDRU_ADDR(base) ((base) + (0x0A4))
...
typedef union
{
    ...
    struct
    {
        unsigned int sdll : 32;
    } reg;
} SOC_SD_SDIO_DBADDRL_UNION;
#endif
#define SOC_SD_SDIO_DBADDRL_sdll_START (0)
#define SOC_SD_SDIO_DBADDRL_sdll_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int sdlu : 32;
    } reg;
} SOC_SD_SDIO_DBADDRU_UNION;
#endif
#define SOC_SD_SDIO_DBADDRU_sdlu_START (0)
#define SOC_SD_SDIO_DBADDRU_sdlu_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int hdal : 32;
    } reg;
} SOC_SD_SDIO_DSCADDRL_UNION;
#endif
#define SOC_SD_SDIO_DSCADDRL_hdal_START (0)
#define SOC_SD_SDIO_DSCADDRL_hdal_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int hdau : 32;
    } reg;
} SOC_SD_SDIO_DSCADDRU_UNION;
#endif
#define SOC_SD_SDIO_DSCADDRU_hdau_START (0)
#define SOC_SD_SDIO_DSCADDRU_hdau_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int hbal : 32;
    } reg;
} SOC_SD_SDIO_BUFADDRL_UNION;
#endif
#define SOC_SD_SDIO_BUFADDRL_hbal_START (0)
#define SOC_SD_SDIO_BUFADDRL_hbal_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int hbau : 32;
    } reg;
} SOC_SD_SDIO_BUFADDRU_UNION;
#endif
#define SOC_SD_SDIO_BUFADDRU_hbau_START (0)
#define SOC_SD_SDIO_BUFADDRU_hbau_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_SD_SDIO_EMMC_DDR_REG_half_start_bit_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
