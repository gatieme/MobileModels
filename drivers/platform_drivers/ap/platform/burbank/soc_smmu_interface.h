...
#define SOC_SMMU_SCR_ADDR(base) ((base) + (0x0000UL))
#define SOC_SMMU_MEMCTRL_ADDR(base) ((base) + (0x0004UL))
#define SOC_SMMU_LP_CTRL_ADDR(base) ((base) + (0x0008UL))
#define SOC_SMMU_INTMASK_NS_ADDR(base) ((base) + (0x0010UL))
#define SOC_SMMU_INTRAW_NS_ADDR(base) ((base) + (0x0014UL))
#define SOC_SMMU_INTSTAT_NS_ADDR(base) ((base) + (0x0018UL))
#define SOC_SMMU_INTCLR_NS_ADDR(base) ((base) + (0x001CUL))
#define SOC_SMMU_SMRX_NS_ADDR(base,n) ((base) + (0x0020+(n)*0x4UL))
#define SOC_SMMU_RLD_EN0_NS_ADDR(base) ((base) + (0x01F0UL))
#define SOC_SMMU_RLD_EN1_NS_ADDR(base) ((base) + (0x01F4UL))
#define SOC_SMMU_RLD_EN2_NS_ADDR(base) ((base) + (0x01F8UL))
#define SOC_SMMU_GLB_ALLOC_ST_ADDR(base) ((base) + (0x01FCUL))
#define SOC_SMMU_CB_SCTRL_ADDR(base) ((base) + (0x0200UL))
#define SOC_SMMU_CB_TTBR0_ADDR(base) ((base) + (0x0204UL))
#define SOC_SMMU_CB_TTBR1_ADDR(base) ((base) + (0x0208UL))
#define SOC_SMMU_CB_TTBCR_ADDR(base) ((base) + (0x020CUL))
#define SOC_SMMU_SCACHEI_ALL_ADDR(base) ((base) + (0x0214UL))
#define SOC_SMMU_SCACHEI_L1_ADDR(base) ((base) + (0x0218UL))
#define SOC_SMMU_SCACHEI_L2_ADDR(base) ((base) + (0x021CUL))
#define SOC_SMMU_CB_PA_MSB_ADDR(base) ((base) + (0x0220UL))
#define SOC_SMMU_CB_TTBR_MSB_ADDR(base) ((base) + (0x0224UL))
#define SOC_SMMU_MAIR_NS_ADDR(base) ((base) + (0x0228UL))
#define SOC_SMMU_ERR_ADDR_MSB_NS_ADDR(base) ((base) + (0x0300UL))
#define SOC_SMMU_ERR_RDADDR_NS_ADDR(base) ((base) + (0x0304UL))
#define SOC_SMMU_ERR_WRADDR_NS_ADDR(base) ((base) + (0x0308UL))
#define SOC_SMMU_FAULT_ADDR_TCU_ADDR(base) ((base) + (0x0310UL))
#define SOC_SMMU_FAULT_ID_TCU_ADDR(base) ((base) + (0x0314UL))
#define SOC_SMMU_FAULT_ADDR_TBUX_ADDR(base,f) ((base) + (0x0320+(f)*0x10UL))
#define SOC_SMMU_FAULT_ID_TBUX_ADDR(base,f) ((base) + (0x0324+(f)*0x10UL))
#define SOC_SMMU_FAULT_INFOX_ADDR(base,f) ((base) + (0x0328+(f)*0x10UL))
#define SOC_SMMU_SMRX_S_ADDR(base,n) ((base) + (0x0500+(n)*0x4UL))
#define SOC_SMMU_RLD_EN0_S_ADDR(base) ((base) + (0x06F0UL))
#define SOC_SMMU_RLD_EN1_S_ADDR(base) ((base) + (0x06F4UL))
#define SOC_SMMU_RLD_EN2_S_ADDR(base) ((base) + (0x06F8UL))
#define SOC_SMMU_INTMAS_S_ADDR(base) ((base) + (0x0700UL))
#define SOC_SMMU_INTRAW_S_ADDR(base) ((base) + (0x0704UL))
#define SOC_SMMU_INTSTAT_S_ADDR(base) ((base) + (0x0708UL))
#define SOC_SMMU_INTCLR_S_ADDR(base) ((base) + (0x070CUL))
#define SOC_SMMU_SCR_S_ADDR(base) ((base) + (0x0710UL))
#define SOC_SMMU_SCB_SCTRL_ADDR(base) ((base) + (0x0714UL))
#define SOC_SMMU_SCB_TTBR_ADDR(base) ((base) + (0x0718UL))
#define SOC_SMMU_SCB_TTBCR_ADDR(base) ((base) + (0x071CUL))
#define SOC_SMMU_SCB_PA_MSB_ADDR(base) ((base) + (0x0724UL))
#define SOC_SMMU_SCB_TTBR_MSB_ADDR(base) ((base) + (0x0728UL))
#define SOC_SMMU_ERR_ADDR_MSB_S_ADDR(base) ((base) + (0x072CUL))
#define SOC_SMMU_ERR_RDADDR_S_ADDR(base) ((base) + (0x0730UL))
#define SOC_SMMU_ERR_WRADDR_S_ADDR(base) ((base) + (0x0734UL))
#define SOC_SMMU_MAIR_S_ADDR(base) ((base) + (0x0738UL))
#define SOC_SMMU_SMRX_S1_ADDR(base,n) ((base) + ((n)*0x4+0x740UL))
#define SOC_SMMU_SMRX_P_ADDR(base,n) ((base) + (0x10000+(n)*0x4UL))
#define SOC_SMMU_RLD_EN0_P_ADDR(base) ((base) + (0x101F0UL))
#define SOC_SMMU_RLD_EN1_P_ADDR(base) ((base) + (0x101F4UL))
#define SOC_SMMU_RLD_EN2_P_ADDR(base) ((base) + (0x101F8UL))
#define SOC_SMMU_INTMAS_P_ADDR(base) ((base) + (0x10200UL))
#define SOC_SMMU_INTRAW_P_ADDR(base) ((base) + (0x10204UL))
#define SOC_SMMU_INTSTAT_P_ADDR(base) ((base) + (0x10208UL))
#define SOC_SMMU_INTCLR_P_ADDR(base) ((base) + (0x1020CUL))
#define SOC_SMMU_SCR_P_ADDR(base) ((base) + (0x10210UL))
#define SOC_SMMU_PCB_SCTRL_ADDR(base) ((base) + (0x10214UL))
#define SOC_SMMU_PCB_TTBR_ADDR(base) ((base) + (0x10218UL))
#define SOC_SMMU_PCB_TTBCR_ADDR(base) ((base) + (0x1021CUL))
#define SOC_SMMU_PCB_PA_MSB_ADDR(base) ((base) + (0x10224UL))
#define SOC_SMMU_PCB_TTBR_MSB_ADDR(base) ((base) + (0x10228UL))
#define SOC_SMMU_MAIR_P_ADDR(base) ((base) + (0x1022CUL))
#define SOC_SMMU_ERR_ADDR_MSB_P_ADDR(base) ((base) + (0x10230UL))
#define SOC_SMMU_ERR_RDADDR_P_ADDR(base) ((base) + (0x10234UL))
#define SOC_SMMU_ERR_WRADDR_P_ADDR(base) ((base) + (0x10238UL))
#else
...
#define SOC_SMMU_SCACHEI_L2_ADDR(base) ((base) + (0x021C))
#define SOC_SMMU_CB_PA_MSB_ADDR(base) ((base) + (0x0220))
#define SOC_SMMU_CB_TTBR_MSB_ADDR(base) ((base) + (0x0224))
#define SOC_SMMU_MAIR_NS_ADDR(base) ((base) + (0x0228))
#define SOC_SMMU_ERR_ADDR_MSB_NS_ADDR(base) ((base) + (0x0300))
#define SOC_SMMU_ERR_RDADDR_NS_ADDR(base) ((base) + (0x0304))
#define SOC_SMMU_ERR_WRADDR_NS_ADDR(base) ((base) + (0x0308))
...
#define SOC_SMMU_SCB_PA_MSB_ADDR(base) ((base) + (0x0724))
#define SOC_SMMU_SCB_TTBR_MSB_ADDR(base) ((base) + (0x0728))
#define SOC_SMMU_ERR_ADDR_MSB_S_ADDR(base) ((base) + (0x072C))
#define SOC_SMMU_ERR_RDADDR_S_ADDR(base) ((base) + (0x0730))
#define SOC_SMMU_ERR_WRADDR_S_ADDR(base) ((base) + (0x0734))
...
#define SOC_SMMU_PCB_PA_MSB_ADDR(base) ((base) + (0x10224))
#define SOC_SMMU_PCB_TTBR_MSB_ADDR(base) ((base) + (0x10228))
#define SOC_SMMU_MAIR_P_ADDR(base) ((base) + (0x1022C))
#define SOC_SMMU_ERR_ADDR_MSB_P_ADDR(base) ((base) + (0x10230))
#define SOC_SMMU_ERR_RDADDR_P_ADDR(base) ((base) + (0x10234))
#define SOC_SMMU_ERR_WRADDR_P_ADDR(base) ((base) + (0x10238))
#endif
#ifndef __SOC_H_FOR_ASM__
typedef union
{
...
#define SOC_SMMU_SMRX_NS_tbu_rptl_as_ful_ns_START (10)
#define SOC_SMMU_SMRX_NS_tbu_rptl_as_ful_ns_END (10)
#define SOC_SMMU_SMRX_NS_tbu_wptl_as_ful_ns_START (11)
#define SOC_SMMU_SMRX_NS_tbu_wptl_as_ful_ns_END (11)
#define SOC_SMMU_SMRX_NS_smr_pa_msb_ns_START (12)
#define SOC_SMMU_SMRX_NS_smr_pa_msb_ns_END (27)
#define SOC_SMMU_SMRX_NS_smr_pa_msb_en_ns_START (28)
#define SOC_SMMU_SMRX_NS_smr_pa_msb_en_ns_END (29)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_SCACHEI_L2_UNION;
#endif
#define SOC_SMMU_SCACHEI_L2_cache_l2_invalid_START (0)
#define SOC_SMMU_SCACHEI_L2_cache_l2_invalid_END (0)
#define SOC_SMMU_SCACHEI_L2_cache_l2_strmid_START (1)
#define SOC_SMMU_SCACHEI_L2_cache_l2_strmid_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_CB_PA_MSB_UNION;
#endif
#define SOC_SMMU_CB_PA_MSB_cb_pa_msb_START (0)
#define SOC_SMMU_CB_PA_MSB_cb_pa_msb_END (15)
#define SOC_SMMU_CB_PA_MSB_cb_pa_msb_en_START (16)
#define SOC_SMMU_CB_PA_MSB_cb_pa_msb_en_END (16)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_CB_TTBR_MSB_UNION;
#endif
#define SOC_SMMU_CB_TTBR_MSB_cb_ttbr_msb_START (0)
#define SOC_SMMU_CB_TTBR_MSB_cb_ttbr_msb_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_ERR_ADDR_MSB_NS_UNION;
#endif
#define SOC_SMMU_ERR_ADDR_MSB_NS_err_rd_addr_msb_ns_START (0)
#define SOC_SMMU_ERR_ADDR_MSB_NS_err_rd_addr_msb_ns_END (15)
#define SOC_SMMU_ERR_ADDR_MSB_NS_err_wr_addr_msb_ns_START (16)
#define SOC_SMMU_ERR_ADDR_MSB_NS_err_wr_addr_msb_ns_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int err_rd_addr_lsb_ns : 32;
    } reg;
} SOC_SMMU_ERR_RDADDR_NS_UNION;
#endif
#define SOC_SMMU_ERR_RDADDR_NS_err_rd_addr_lsb_ns_START (0)
#define SOC_SMMU_ERR_RDADDR_NS_err_rd_addr_lsb_ns_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int err_wr_addr_lsb_ns : 32;
    } reg;
} SOC_SMMU_ERR_WRADDR_NS_UNION;
#endif
#define SOC_SMMU_ERR_WRADDR_NS_err_wr_addr_lsb_ns_START (0)
#define SOC_SMMU_ERR_WRADDR_NS_err_wr_addr_lsb_ns_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_SMMU_FAULT_ID_TCU_fault_strm_id_tcu_END (27)
#define SOC_SMMU_FAULT_ID_TCU_fault_addr_tcu_msb_START (28)
#define SOC_SMMU_FAULT_ID_TCU_fault_addr_tcu_msb_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_SMMU_FAULT_ID_TBUX_fault_strm_id_tbu_END (27)
#define SOC_SMMU_FAULT_ID_TBUX_fault_addr_tbu_msb_START (28)
#define SOC_SMMU_FAULT_ID_TBUX_fault_addr_tbu_msb_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_SMMU_SMRX_S_smr_pa_msb_s_START (12)
#define SOC_SMMU_SMRX_S_smr_pa_msb_s_END (27)
#define SOC_SMMU_SMRX_S_smr_pa_msb_en_s_START (28)
#define SOC_SMMU_SMRX_S_smr_pa_msb_en_s_END (29)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_SCB_PA_MSB_UNION;
#endif
#define SOC_SMMU_SCB_PA_MSB_scb_pa_msb_START (0)
#define SOC_SMMU_SCB_PA_MSB_scb_pa_msb_END (15)
#define SOC_SMMU_SCB_PA_MSB_scb_pa_msb_en_START (16)
#define SOC_SMMU_SCB_PA_MSB_scb_pa_msb_en_END (16)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_SCB_TTBR_MSB_UNION;
#endif
#define SOC_SMMU_SCB_TTBR_MSB_scb_ttbr_msb_START (0)
#define SOC_SMMU_SCB_TTBR_MSB_scb_ttbr_msb_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_ERR_ADDR_MSB_S_UNION;
#endif
#define SOC_SMMU_ERR_ADDR_MSB_S_err_rd_addr_msb_s_START (0)
#define SOC_SMMU_ERR_ADDR_MSB_S_err_rd_addr_msb_s_END (15)
#define SOC_SMMU_ERR_ADDR_MSB_S_err_wr_addr_msb_s_START (16)
#define SOC_SMMU_ERR_ADDR_MSB_S_err_wr_addr_msb_s_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int err_rd_addr_lsb_s : 32;
    } reg;
} SOC_SMMU_ERR_RDADDR_S_UNION;
#endif
#define SOC_SMMU_ERR_RDADDR_S_err_rd_addr_lsb_s_START (0)
#define SOC_SMMU_ERR_RDADDR_S_err_rd_addr_lsb_s_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int err_wr_addr_lsb_s : 32;
    } reg;
} SOC_SMMU_ERR_WRADDR_S_UNION;
#endif
#define SOC_SMMU_ERR_WRADDR_S_err_wr_addr_lsb_s_START (0)
#define SOC_SMMU_ERR_WRADDR_S_err_wr_addr_lsb_s_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_SMMU_SMRX_S1_tbu_rptl_as_ful_s_START (10)
#define SOC_SMMU_SMRX_S1_tbu_rptl_as_ful_s_END (10)
#define SOC_SMMU_SMRX_S1_tbu_wptl_as_ful_s_START (11)
#define SOC_SMMU_SMRX_S1_tbu_wptl_as_ful_s_END (11)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_SMMU_SMRX_P_tbu_rptl_as_ful_p_START (10)
#define SOC_SMMU_SMRX_P_tbu_rptl_as_ful_p_END (10)
#define SOC_SMMU_SMRX_P_tbu_wptl_as_ful_p_START (11)
#define SOC_SMMU_SMRX_P_tbu_wptl_as_ful_p_END (11)
#define SOC_SMMU_SMRX_P_smr_pa_msb_p_START (12)
#define SOC_SMMU_SMRX_P_smr_pa_msb_p_END (27)
#define SOC_SMMU_SMRX_P_smr_pa_msb_en_p_START (28)
#define SOC_SMMU_SMRX_P_smr_pa_msb_en_p_END (29)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_PCB_PA_MSB_UNION;
#endif
#define SOC_SMMU_PCB_PA_MSB_pcb_pa_msb_START (0)
#define SOC_SMMU_PCB_PA_MSB_pcb_pa_msb_END (15)
#define SOC_SMMU_PCB_PA_MSB_pcb_pa_msb_en_START (16)
#define SOC_SMMU_PCB_PA_MSB_pcb_pa_msb_en_END (16)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_PCB_TTBR_MSB_UNION;
#endif
#define SOC_SMMU_PCB_TTBR_MSB_pcb_ttbr_msb_START (0)
#define SOC_SMMU_PCB_TTBR_MSB_pcb_ttbr_msb_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_SMMU_ERR_ADDR_MSB_P_UNION;
#endif
#define SOC_SMMU_ERR_ADDR_MSB_P_err_rd_addr_msb_p_START (0)
#define SOC_SMMU_ERR_ADDR_MSB_P_err_rd_addr_msb_p_END (15)
#define SOC_SMMU_ERR_ADDR_MSB_P_err_wr_addr_msb_p_START (16)
#define SOC_SMMU_ERR_ADDR_MSB_P_err_wr_addr_msb_p_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int err_rd_addr_lsb_p : 32;
    } reg;
} SOC_SMMU_ERR_RDADDR_P_UNION;
#endif
#define SOC_SMMU_ERR_RDADDR_P_err_rd_addr_lsb_p_START (0)
#define SOC_SMMU_ERR_RDADDR_P_err_rd_addr_lsb_p_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int err_wr_addr_lsb_p : 32;
    } reg;
} SOC_SMMU_ERR_WRADDR_P_UNION;
#endif
#define SOC_SMMU_ERR_WRADDR_P_err_wr_addr_lsb_p_START (0)
#define SOC_SMMU_ERR_WRADDR_P_err_wr_addr_lsb_p_END (31)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
