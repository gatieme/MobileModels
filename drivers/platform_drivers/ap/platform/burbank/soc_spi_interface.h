...
#define SOC_SPI_SPICR0_ADDR(base) ((base) + (0x000UL))
#define SOC_SPI_SPICR1_ADDR(base) ((base) + (0x004UL))
#define SOC_SPI_SPIDR_ADDR(base) ((base) + (0x008UL))
#define SOC_SPI_SPISR_ADDR(base) ((base) + (0x00CUL))
#define SOC_SPI_SPICPSR_ADDR(base) ((base) + (0x010UL))
#define SOC_SPI_SPIIMSC_ADDR(base) ((base) + (0x014UL))
#define SOC_SPI_SPIRIS_ADDR(base) ((base) + (0x018UL))
#define SOC_SPI_SPIMIS_ADDR(base) ((base) + (0x01CUL))
#define SOC_SPI_SPIICR_ADDR(base) ((base) + (0x020UL))
#define SOC_SPI_SPIDMACR_ADDR(base) ((base) + (0x024UL))
#define SOC_SPI_SPITXFIFOCR_ADDR(base) ((base) + (0x028UL))
#define SOC_SPI_SPIRXFIFOCR_ADDR(base) ((base) + (0x02CUL))
#else
