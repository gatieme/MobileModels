...
#define SOC_SPMIMST_CLK_CONFIG_ADDR(base) ((base) + (0x0000UL))
#define SOC_SPMIMST_INT_EN_ADDR(base) ((base) + (0x0004UL))
#define SOC_SPMIMST_AVS_PRI_ADDR(base) ((base) + (0x0010UL))
#define SOC_SPMIMST_AVS0_DBG_ADDR(base) ((base) + (0x0014UL))
#define SOC_SPMIMST_AVS1_DBG_ADDR(base) ((base) + (0x0018UL))
#define SOC_SPMIMST_AVS2_DBG_ADDR(base) ((base) + (0x001CUL))
#define SOC_SPMIMST_AVS3_DBG_ADDR(base) ((base) + (0x0020UL))
#define SOC_SPMIMST_AVS4_DBG_ADDR(base) ((base) + (0x0024UL))
#define SOC_SPMIMST_AVS5_DBG_ADDR(base) ((base) + (0x0028UL))
#define SOC_SPMIMST_AVS6_DBG_ADDR(base) ((base) + (0x002CUL))
#define SOC_SPMIMST_AVS7_DBG_ADDR(base) ((base) + (0x0030UL))
#define SOC_SPMIMST_AVS8_DBG_ADDR(base) ((base) + (0x0034UL))
#define SOC_SPMIMST_AVS9_DBG_ADDR(base) ((base) + (0x0038UL))
#define SOC_SPMIMST_AVS10_DBG_ADDR(base) ((base) + (0x003CUL))
#define SOC_SPMIMST_AVS11_DBG_ADDR(base) ((base) + (0x0040UL))
#define SOC_SPMIMST_AVS_STATUS_ADDR(base) ((base) + (0x0044UL))
#define SOC_SPMIMST_VIC_SPMI_CMD_ADDR(base) ((base) + (0x0050UL))
#define SOC_SPMIMST_VIC_WDATA0_ADDR(base) ((base) + (0x0054UL))
#define SOC_SPMIMST_VIC_WDATA1_ADDR(base) ((base) + (0x0058UL))
#define SOC_SPMIMST_VIC_WDATA2_ADDR(base) ((base) + (0x005CUL))
#define SOC_SPMIMST_VIC_WDATA3_ADDR(base) ((base) + (0x0060UL))
#define SOC_SPMIMST_VIC_STATUS_ADDR(base) ((base) + (0x0064UL))
#define SOC_SPMIMST_VIC_RDATA0_ADDR(base) ((base) + (0x0068UL))
#define SOC_SPMIMST_VIC_RDATA1_ADDR(base) ((base) + (0x006CUL))
#define SOC_SPMIMST_VIC_RDATA2_ADDR(base) ((base) + (0x0070UL))
#define SOC_SPMIMST_VIC_RDATA3_ADDR(base) ((base) + (0x0074UL))
