...
__REBOOT_REASON_MAP(AP_S_SUBPMU, SUBTYPE)
...
__REBOOT_REASON_MAP(LPCPU_S_EXCEPTION, SUBTYPE)
__REBOOT_REASON_MAP(LPGPU_S_EXCEPTION, SUBTYPE)
...
__REBOOT_REASON_MAP(GENERAL_SEE_S_EXCEPTION, SUBTYPE)
...
__REBOOT_REASON_MAP(XLOADER_STOR_INIT_ERR, HARDWARE_FAULT)
...
__REBOOT_REASON_MAP(FASTBOOT_LOADIOMCU_FAIL, BOOTLOADER_CRASH)
...
__REBOOT_REASON_MAP(FASTBOOT_TEE_S_EXCEPTION, BOOTLOADER_CRASH)
