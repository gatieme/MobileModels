...
ifeq ($(strip $(CFG_CHR_V100)),YES)
ifeq ($(strip $(CFG_CONFIG_CHR_FS)),YES)
drv-y           += chr/chr_v100/chr_report.o
drv-y           += chr/chr_v100/chr_core.o
drv-y           += chr/chr_v100/chr_blocklist.o
drv-y           += chr/chr_v100/chr_priority.o
drv-y           += chr/chr_v100/chr_period.o
else
drv-y           += chr/chr_v100/chr_stub.o
endif
else
ifeq ($(strip $(CFG_CONFIG_CHR_FS)),YES)
...
ifeq ($(strip $(CFG_CONFIG_UART_RELAY)),YES)
drv-y += vdev_relay/relay_uart.o
endif
