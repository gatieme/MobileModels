...
#include <uapi/linux/msm_mdp.h>
	...
	#include <drivers/video/honor/hi3630/honor_dss.h>
#elif defined(CONFIG_FB_3650) || defined(CONFIG_FB_6250)
	#include <drivers/video/honor/hi3650/honor_dss.h>
#else
	#if LINUX_VERSION_CODE <= KERNEL_VERSION(4, 0, 0)
		#include <drivers/video/honor/dss/honor_dss.h>
	#else
		#include <drivers/video/fbdev/honor/dss/honor_dss.h>
	#endif
#endif
#endif
...
static int should_delay_checkcmd(unsigned int cmd)
{
	...
	#else
	case HONORFB_OV_ONLINE_PLAY:
	case HONORFB_OV_OFFLINE_PLAY:
	#endif
		return 1;
	default:
		break;
