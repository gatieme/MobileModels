...
#if (!defined(CONFIG_MTK_PLATFORM) && !defined(CONFIG_RPHONE_MTK))
...
#else
rasprobe_entry_define(honor_powerkey_down_hdl);/*chipset_hang*/
rasprobe_entry_define(honor_powerkey_up_hdl);/*chipset_hang*/
rasprobe_entry_define(honor_powerkey_1s_hdl);/*chipset_hang*/
rasprobe_entry_define(honor_powerkey_6s_hdl);/*chipset_hang*/
rasprobe_entry_define(honor_powerkey_8s_hdl);/*chipset_hang*/
rasprobe_entry_define(honor_powerkey_10s_hdl);/*chipset_hang*/
#endif
...
static struct rasprobe *probes[] = {
	...
	#else
	&rasprobe_name(honor_powerkey_down_hdl),
	&rasprobe_name(honor_powerkey_up_hdl),
	&rasprobe_name(honor_powerkey_1s_hdl),
	&rasprobe_name(honor_powerkey_6s_hdl),
	&rasprobe_name(honor_powerkey_8s_hdl),
	&rasprobe_name(honor_powerkey_10s_hdl)
	#endif
};
...
static int tool_init(void)
{
	...
	#endif
	return 0;
#if (!defined(CONFIG_MTK_PLATFORM) && !defined(CONFIG_RPHONE_MTK)) || LINUX_VERSION_CODE < KERNEL_VERSION(4, 9, 0)
out_proc:
