...
#ifdef CONFIG_HONOR_THERMAL_PERIPHERAL
#include "drivers/thermal/honor/honor_peripheral_tm.h"
static int rasprobe_handler(honor_peripheral_ntc_2_temp) (
...
#ifdef CONFIG_HONOR_THERMAL_TSENSOR
...
static int rasprobe_handler(honor_battery_temperature) (struct rasprobe_instance
						       *ri,
						       struct pt_regs *regs) {
...
#ifdef CONFIG_HONOR_IPA_THERMAL
...
#if IS_ENABLED(CONFIG_HONOR_COUL)
rasprobe_define(honor_battery_temperature);
#endif
...
#endif
#ifdef CONFIG_HONOR_THERMAL_PERIPHERAL
rasprobe_define(honor_peripheral_ntc_2_temp);
#endif
...
#ifdef CONFIG_HONOR_THERMAL_PERIPHERAL
	&rasprobe_name(honor_peripheral_ntc_2_temp),
#endif
#ifdef CONFIG_HONOR_THERMAL_TSENSOR
...
#if IS_ENABLED(CONFIG_HONOR_COUL)
	&rasprobe_name(honor_battery_temperature),
#endif
#ifdef CONFIG_HONOR_IPA_THERMAL
