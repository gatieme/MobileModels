...
#include "ufshci.h"
#include "platform_include/basicplatform/linux/ufs/ufs_fault_inject.h"
...
/* Auto Hibern8 Timer, opt: 3ms */
#define UFS_AHIT_AUTOH8_OPT_TIMER 0x0C03
...
struct ufs_hba_variant_ops {
	...
	void (*dbg_gic_dump)(struct ufs_hba *);
#ifdef CONFIG_DEBUG_FS
	...
	void (*set_buck_voltage)(struct ufs_hba *hba);
	void (*mphy_config_update)(struct ufs_hba *hba);
#ifdef CONFIG_DEBUG_FS
...
struct ufs_gear_type {
	struct device_attribute gear_type;
};
#endif
...
#ifdef CONFIG_SCSI_UFS_GEAR_CTRL
	struct ufs_gear_type gear_type;
#endif
...
#define UFSHCD_CAP_AUTO_HIBERN8 (1UL << 31)
	...
	bool is_samsung_v6;
	struct list_head samsung_v6_whitelist;
	u32 mphy_tx_rt;
...
static inline void ufshcd_vops_mphy_config_update(struct ufs_hba *hba)
{
	if (hba->vops && hba->vops->mphy_config_update)
		hba->vops->mphy_config_update(hba);
}
...
int ufshcd_transfer_rsp_status(struct ufs_hba *hba, struct ufshcd_lrb *lrbp, bool in_irq);
