...
#endif
#define ION_FLAG_BACKGROUND_SHRINK_BUFFER (0x1 << 11)
#ifdef CONFIG_MM_LB
#define ION_FLAG_MM_LB_PLC_S    (0x1UL << 12)
#define ION_FLAG_MM_LB_PLC_E    (0x1UL << 19)
#define ION_FLAG_MM_LB_SHIFT    12
#define ION_FLAG_MM_LB_MASK     (0xffUL << 12)

#define ION_FLAG_2_PLC_ID(flags) \
	((flags & ION_FLAG_MM_LB_MASK) >> ION_FLAG_MM_LB_SHIFT)
#endif
