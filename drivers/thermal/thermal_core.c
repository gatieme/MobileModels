...
#ifdef CONFIG_HUAWEI_PERF
#include <../perf/perf/perf_lpm_limit_freq.h>
#endif
...
#ifdef CONFIG_IPA_THERMAL
extern struct mutex thermal_boost_lock;
...
#ifdef CONFIG_HUAWEI_PERF
	perf_set_thermal_zone_device(type, tz);
#endif
