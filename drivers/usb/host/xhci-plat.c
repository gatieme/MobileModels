...
#include "../../../platform_source/basicplatform/drivers/usb/host/xhci-debug-event.h"
...
static int xhci_plat_probe(struct platform_device *pdev)
{
	...
	for (tmpdev = &pdev->dev; tmpdev; tmpdev = tmpdev->parent) {
		...
		if (tmpdev->parent && (of_device_is_compatible(tmpdev->parent->of_node,
					"snps,dwc3") > 0)) {
			struct device *parent = tmpdev->parent;
			...
			dev_err(tmpdev, "no parent or not match \"snps,dwc3\"\n");
