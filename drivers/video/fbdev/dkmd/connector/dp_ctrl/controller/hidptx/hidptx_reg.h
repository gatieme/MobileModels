...
// cpro add reg start
// iso enable reg
#define HSDT1_EDPTX0_PHY_ISO_EN 0x0334
#define HSDT1_EDPTX1_PHY_ISO_EN 0x0338
#define HSDT1_USBDP0_PHY_ISO_EN 0x033C
#define HSDT1_USBDP1_PHY_ISO_EN 0x0340
#define HSDT1_USBDP2_PHY_ISO_EN 0x0344
#define HSDT1_USBDP3_PHY_ISO_EN 0x0348

#define CLKDIV_OFFSET_DP    0x0BC
#define CLKDIV_OFFSET_DP1   0x0C0
#define CLKDIV_OFFSET_DP2   0x0C4
#define CLKDIV_OFFSET_DP3   0x0D4
#define CLKDIV_OFFSET_EDP   0x0D8
#define CLKDIV_OFFSET_EDP1  0x0DC
...
// dpc_pll config
#define DPC_PLL0_CTRL0 0xC38
#define DPC_PLL0_CTRL1 0xC3C

#define DPC_PLL1_CTRL0 0xC40
#define DPC_PLL1_CTRL1 0xC44

#define DPC_PLL2_CTRL0 0xC48
#define DPC_PLL2_CTRL1 0xC4C

#define DPC_PLL_LOCK_MASK           BIT(26)
#define DPC_PLL_FREQ_DEVIDER_MASK   GENMASK(25, 2)
#define DPC_PLL_FRAC_MODE_MASK      GENMASK(25, 0)

#define HSDT1_SUB_HARDEN_PEREN0_OFFSET    0x0

// cpro add reg done

#define HSDT1_PEREN3 0x30
#define GT_CLK_HIDPTX1_PIXEL BIT(7)
#define GT_CLK_HIDPTX0_PIXEL BIT(8)
#define GT_PCLK_HIDPTX1_CTRL BIT(12)
#define GT_PCLK_HIDPTX0_CTRL BIT(13)

#define HSDT1_PERDIS3 0x34

#define HSDT1_PERRSTEN3 0x80

#define DPTX_APB_RESET_OFFSET 0x80
#define DPTX1_APB_RESET_BIT BIT(7)
#define DPTX_APB_RESET_BIT BIT(8)

#define DPTX_APB_DIS_RESET_OFFSET 0x84
#define DPTX1_DPC_DIS_RESET_BIT BIT(2)
#define DPTX_DPC_DIS_RESET_BIT BIT(3)
#define DPTX1_APB_DIS_RESET_BIT BIT(7)
#define DPTX_APB_DIS_RESET_BIT BIT(8)
...
#define DPTX_AUX_CMD_REQ_LEN_SHIFT 4
#define DPTX_AUX_CMD_I2C_ADDR_ONLY BIT(28)
#define DPTX_AUX_CMD_ADDR_SHIFT 8
#define DPTX_AUX_CMD_TYPE_SHIFT 0
...
#define DPTX_CFG_AUX_SYNC_LEN_SEL BIT(1)
#define DPTX_CFG_AUX_MIN_PULSE_NUM_MASK GENMASK(13, 9)
#define DPTX_CFG_AUX_RXTIMEOUT_SEL_MASK GENMASK(20, 19)
#define DPTX_CFG_AUX_MIN_PULSE_NUM_SHIFT 0x9
...
#define DPTX_VIDEO_RGB_SAMPLE_EN BIT(1)
...
#define DPTX_VIDEO_PACKET_TU_SYNC_CALIB_MASK GENMASK(31, 20)
#define DPTX_VIDEO_PACKET_TU_SYNC_CALIB_SHIFT 20
...
#define CFG_STREAM_SLICES_NUM GENMASK(18, 16)
...
#define dptx_timing_gen_config0_stream(n) (0x26c + 0x200 * (n))
#define DPTX_TIMING_GEN_HACTIVE_SHIFT 16

#define dptx_timing_gen_config1_stream(n) (0x270 + 0x200 * (n))
#define DPTX_TIMING_GEN_HFP_SHIFT 16 /* h_front_porch */

#define dptx_timing_gen_config2_stream(n) (0x274 + 0x200 * (n))
#define DPTX_TIMING_GEN_VACTIVE_SHIFT 16 /* vactive */

#define dptx_timing_gen_config3_stream(n) (0x278 + 0x200 * (n))
#define DPTX_TIMING_GEN_VFP_SHIFT 16 /* v_front_porch */
...
#define DPTX_GLOBAL_RST_N BIT(6)
#define DPTX_GLOBAL_RST_N_MASK GENMASK(8, 0)
...
#define DPTX_CFG_DUAL_DP_ENABLE BIT(4)
#define DPTX_CFG_HIDIF_ENABLE_BIT BIT(6)
#define DPTX_CFG_MODE_SELECT_MASK GENMASK(6, 4)
#define DPTX_HPD_POLARITY_SEL BIT(9)
#define DPTX_CFG_TIMING_GEN_ENABLE BIT(10)
/* v740 add for mst */
#define DPTX_CFG_SST1_TIMING_GEN_ENABLE BIT(16)
#define DPTX_CFG_SDP_ENABLE BIT(11)
#define DPTX_CFG_TIMING_GEN_MODE_SEL GENMASK(15, 13)
#define DPTX_CFG_TIMING_GEN_MODE_SEL_OFFSET 13
#define DPTX_HSYNC_VSYNC_HSYNC_FOLLOW_MODE 1
#define DPTX_HSYNC_VSYNC_FOLLOW_MODE 2

#define DPTX_DEBUG_ENABLE 0x710
#define DPTX_CFG_PSR_ML_OFF_NO_LT BIT(2)

#define DPTX_INTR_ENABLE 0x720
#define DPTX_INTR_MASKED_STATUS 0x724
...
#define DPTX_SU_UPDATE BIT(16)
#define DPTX_CFG_ALPM_ENTRY BIT(17)
#define DPTX_CFG_ALPM_EXIT BIT(18)
#define DPTX_PSR2_VACTIVE_START BIT(26)
...
#define DPTX_SDP_INTR_MASKED_STATUS 0x734
#define DPTX_SDP_INTR_ORIGINAL_STATUS 0x738

#define DPTX_ACTIVE_CNT_NUM_CFG 0x748
#define DPTX_ACTIVE0_NUM_MASK GENMASK(12, 0)
#define DPTX_ACTIVE1_NUM_MASK GENMASK(28, 16)
#define DPTX_ACTIVE1_NUM_SHIFT 16

#define DPTX_TIMING_MODE1_CTRL 0x884
#define DPTX_CFG_PIXEL_NUM_TIMING_MODE_SEL1 GENMASK(31, 16)
#define DPTX_CFG_PIXEL_NUM_TIMING_MODE_SEL1_OFFSET 16
#define DPTX_CFG_RX2TX_DELAY GENMASK(15, 8)
#define DPTX_CFG_RX2TX_DELAY_OFFSET 8
#define DPTX_CFG_FRM_START_DELAY GENMASK(7, 0)
#define DPTX_CFG_FRM_START_DELAY_OFFSET 0
#define FRM_START_LINE_NUM_VAL 3

#define DPTX_INTR_ACPU_TIMING_GEN_ENABLE 0x74C
#define DPTX_INTR_ACPU_TIMING_GEN_MASKED_STATUS 0x750
#define DPTX_INTR_ACPU_TIMING_GEN_ORIGINAL_STATUS 0x754
#define DPTX_IRQ_VSYNC BIT(0)
#define DPTX_IRQ_VBP_END BIT(1)
#define DPTX_IRQ_STREAM0_UNDERFLOW BIT(2)
#define DPTX_IRQ_STREAM1_UNDERFLOW BIT(3)
#define DPTX_IRQ_VFP_END BIT(4)
#define DPTX_IRQ_VACTIVE0 BIT(5)
#define DPTX_IRQ_VACTIVE1 BIT(6)
#define DPTX_IRQ_HPRI_SDP BIT(7)
#define DPTX_IRQ_LPRI_SDP BIT(8)
#define DPTX_IRQ_ALL_TIMING_GEN_INTR GENMASK(8, 0)
#define DPTX_PSR_ACTIVE_SDP_INTR BIT(10)
#define DPTX_PSR_INACTIVE_SDP_INTR BIT(11)
#define DPTX_PSR_UPDATE_INTR BIT(12)
#define DPTX_PSR_ENTRY_INTR BIT(13)
#define DPTX_PSR_EXIT_INTR BIT(14)
#define DPTX_IRQ_ALL_PSR_INTR GENMASK(14, 10)

#define DPTX_SU_COO_TL                       0x850

#define DPTX_SU_COO_BR                       0x854
#define DPTX_CFG_SU_COO_BR_X_MASK            GENMASK(12, 0)
#define DPTX_CFG_SU_COO_BR_Y_MASK            GENMASK(28, 16)

#define DPTX_ALPM_ENABLE 0x858
#define DPTX_ALPM_PHY_POWER_MODE_SHIFT 2
#define DPTX_ALPM_PHY_POWER_MODE_MASK GENMASK(3, 2)
#define DPTX_CFG_ALPM_EXIT_LINE_NUM_MASK GENMASK(10, 5)
#define DPTX_CFG_FRM_START_LINE_NUM_MASK GENMASK(20, 11)
#define DPTX_CFG_ALPM_PHY_PWD_DELAY GENMASK(28, 21)
#define DPTX_CFG_ALPM_EXIT_LINE_NUM_SHIFT 5
#define DPTX_CFG_FRM_START_LINE_NUM_SHIFT 11
#define DPTX_CFG_ALPM_PHY_PWD_DELAY_SHIFT 21
#define DPTX_CFG_ALPM_3A_ENABLE BIT(1)
#define DPTX_CFG_ALPM_2A_ENABLE BIT(0)
#define DPTX_CFG_ALPM_PHY_STATUS_TIMEOUT_ENABLE BIT(4)

#define DTPX_ALPM_TIMEOUT 0x85C
#define DPTX_CFG_PHY_POWER_OFF_TIMEOUT_LINK_NUM_SHIFT 16

#define DPTX_GTC_CONTROL1 0x860
#define DPTX_CFG_GTC_ENABLE BIT(0)
#define DPTX_CFG_AUX_FRAME_SYNC_ENABLE BIT(17)
#define DPTX_CFG_GTC_LINE_CNT_MODE_SEL BIT(18)
#define DPTX_CFG_NO_AUX_FRAME_SYNC_ENABLE BIT(19)

#define DPTX_GTC_CONTROL2 0x864
#define DPTX_CFG_GTC_LINE_LEN_DIV_MASK GENMASK(3, 0)

#define DPTX_PSR_CTRL 0x918
#define DPTX_CFG_PSR_ENABLE BIT(0)
#define DPTX_CFG_PSR_ENTRY BIT(1)
#define DPTX_CFG_PSR_EXIT BIT(2)
#define DPTX_CFG_PSR_CRC_SDP_TX_ENABLE BIT(3)
#define DPTX_CFG_PSR_UPDATE_ENABLE BIT(5)
#define DPTX_CFG_FRAME_CAPTURE_IND BIT(6)
#define DPTX_CFG_PSR_ACTIVE_ML_OFF BIT(8)
#define DPTX_CFG_PSR2_ENABLE BIT(17)
#define DPTX_CFG_SU_UPDATE_ENABLE BIT(18)
#define DPTX_CFG_PSR2_TIMING_GEN_OFF BIT(19)
#define DPTX_CFG_SU_REGION_SCAN_LINE_CAPTURE_IND BIT(20)
#define DPTX_CFG_SU_Y_COO_VALID BIT(21)
#define DPTX_CFG_PSR_SDP_HB2_MASK GENMASK(26, 22)
#define DPTX_CFG_PSR_SDP_HB3_MASK GENMASK(31, 27)
#define DPTX_CFG_PSR_SDP_HB2_SHIFT 22
#define DPTX_CFG_PSR_SDP_HB3_SHIFT 27
#define DPTX_PSR_SDP_HB2_VALUE 0x2
#define DPTX_PSR_SDP_HB3_VALUE 0x8
#define DPTX_PSR2_YVAL_SDP_HB2_VALUE 0x4
#define DPTX_PSR2_YVAL_SDP_HB3_VALUE 0xE
#define DPTX_PSR2_SDP_HB2_VALUE 0x3
#define DPTX_PSR2_SDP_HB3_VALUE 0xC
...
#define DPTX_AUDIO_VERSION_NUM_MASK GENMASK(23, 18)
#define DPTX_AUDIO_VERSION_NUM_SHIFT 18
#define DPTX_AUDIO_HB0_MASK GENMASK(17, 10)
#define DPTX_AUDIO_HB0_SHIFT 10
#define DPTX_AUDIO_MUTE_EN BIT(9)
#define DPTX_AUDIO_CH_NUM_MASK GENMASK(8, 6)
#define DPTX_AUDIO_CH_NUM_SHIFT 6
#define DPTX_AUDIO_HBR_MODE_EN BIT(5)
#define DPTX_AUDIO_DATA_WIDTH_SHIFT 4
...
/* PHY offset */
#define DPTX_PHY_MODE 0x14
#define DP_NORNAL_MODE 0x1
#define DP_FLIP_MODE 0x9

#define DPTX_PHY_DP_AUX_CTRL 0x20

#define DPTX_PHY_TRIM_BANDGAP0_RESULT 0x4890
#define DPTX_PHY_TRIM_BANKGAP0_DP0_MASK 0xFF0000
#define DPTX_PHY_TRIM_BANKGAP0_DP1_MASK 0xFF000000
#define DPTX_PHY_TRIM_BANKGAP0_DP0_SHIFT 16
#define DPTX_PHY_TRIM_BANKGAP0_DP1_SHIFT 24
