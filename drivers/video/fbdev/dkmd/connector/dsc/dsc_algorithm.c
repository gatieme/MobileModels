...
static struct rc_table_param g_rc_v11_range_params_8bpc_8bpp_rgb_default[DSC_RC_RANGE_LENGTH] = {
	...
	{5, 11, -10}, {5, 12, -12}, {5, 13, -12}, {7, 13, -12}, {13, 15, -12},
};

static struct rc_table_param g_rc_v11_range_params_10bpc_10bpp_rgb_default[DSC_RC_RANGE_LENGTH] = {
	{0, 7, 2}, {4, 8, 0}, {5, 9, 0}, {6, 10, -2}, {7, 11, -4},
	{7, 11, -6}, {7, 11, -8}, {7, 12, -8}, {7, 13, -8}, {7, 13, -10},
	{9, 14, -10}, {9, 15, -10}, {9, 16, -12}, {11, 17, -12}, {17, 19, -12},
};

static struct rc_table_param g_rc_v11_range_params_8bpc_12bpp_rgb_default[DSC_RC_RANGE_LENGTH] = {
	{0, 2, 2}, {0, 4, 0}, {1, 5, 0}, {1, 6, -2}, {3, 7, -4},
	{3, 7, -6}, {3, 7, -8}, {3, 8, -8}, {3, 9, -8}, {3, 10, -10},
	{5, 11, -10}, {5, 12, -12}, {5, 13, -12}, {7, 13, -12}, {13, 15, -12},
};

static struct rc_table_param g_rc_v11_range_params_10bpc_8bpp_rgb_default[DSC_RC_RANGE_LENGTH] = {
	{0, 8, 2}, {4, 8, 0}, {5, 9, 0}, {5, 10, -2}, {7, 11, -4},
	{7, 11, -6}, {7, 11, -8}, {7, 12, -8}, {7, 13, -8}, {7, 14, -10},
	{9, 15, -10}, {9, 16, -12}, {9, 17, -12}, {11, 17, -12}, {17, 19, -12},
};

static struct rc_table_param g_rc_v11_range_params_10bpc_8bpp_rgb[DSC_RC_RANGE_LENGTH] = {
	{ 0, 8, 2 }, { 4, 8, 0 }, { 5, 9, 0 }, { 5, 10, 62 }, { 7, 11, 60 },
	{ 7, 11, 58 }, { 7, 11, 56 }, { 7, 12, 56 }, { 7, 13, 56 }, { 8, 14, 54 },
	{ 9, 14, 54 }, { 9, 15, 54 }, { 9, 15, 52 }, { 12, 16, 52 }, { 16, 17, 52 },
};

/* used by BA */
static struct rc_table_param g_rc_v11_range_params_8bpc_8bpp_rgb[DSC_RC_RANGE_LENGTH] = {
	{ 0, 4, 2 }, { 0, 4, 0 }, { 1, 5, 0 }, { 1, 6, 62 }, { 3, 7, 60 },
	{ 3, 7, 58 }, { 3, 7, 56 }, { 3, 8, 56 }, { 3, 9, 56 }, { 4, 10, 54 },
	{ 5, 10, 54 }, { 5, 11, 54 }, { 5, 11, 52 }, { 8, 12, 52 }, { 12, 13, 52 },
};
/* ------ end of dsc ver1.1 rc tables ------ */

/* ------ start of dsc ver1.2 rc tables ------ */

/* used by pad and syno/dpu dp */
static struct rc_table_param g_rc_v12_range_params_8bpc_8bpp_rgb_default[DSC_RC_RANGE_LENGTH] = {
	{ 0, 4, 2 }, { 0, 4, 0 }, { 1, 5, 0 }, { 1, 6, -2 }, { 3, 7, -4 },
	{ 3, 7, -6 }, { 3, 7, -8 }, { 3, 8, -8 }, { 3, 9, -8 }, { 3, 10, -10 },
...
/* used by 36870 panel */
static struct rc_table_param g_rc_v12_range_params_10bpc_10bpp_rgb_default[DSC_RC_RANGE_LENGTH] = {
	{ 0, 7, 2 }, { 4, 8, 0 }, { 5, 9, 0 }, { 6, 10, -2 }, { 7, 11, -4 },
	{ 7, 11, -6 }, { 7, 11, -8 }, { 7, 12, -8 }, { 7, 13, -8 }, { 7, 13, -10 },
	{ 9, 14, -10 }, { 9, 15, -10 }, { 9, 16, -12 }, { 11, 17, -12 }, { 17, 19, -12 },
};

static struct rc_table_param g_rc_v12_range_params_10bpc_16bpp_yuv422_default[DSC_RC_RANGE_LENGTH] = {
	{ 0, 2, 2 }, { 2, 5, 0 }, { 3, 7, 0 }, { 4, 8, -2 }, { 6, 9, -4 },
	{ 7, 10, -6 }, { 7, 11, -8 }, { 7, 12, -8 }, { 7, 12, -8 }, { 7, 13, -10 },
	{ 9, 13, -10 }, { 9, 13, -12 }, { 9, 13, -12 }, { 11, 14, -12 }, { 14, 15, -12 },
};

/* used by dpu dp */
static struct rc_table_param g_rc_v12_range_params_8bpc_12bpp_rgb[DSC_RC_RANGE_LENGTH] = {
	{ 0, 2, 2 }, { 0, 3, 0 }, { 1, 4, 0 }, { 1, 5, -2 }, { 3, 6, -4 },
	{ 3, 6, -6 }, { 3, 7, -8 }, { 3, 8, -8 }, { 3, 8, -8 }, { 3, 9, -10 },
	{ 5, 9, -10 }, { 5, 9, -10 }, { 5, 9, -12 }, { 7, 10, -12 }, { 10, 11, -12 },
};

static struct rc_table_param g_rc_v12_range_params_8bpc_8bpp_rgb[DSC_RC_RANGE_LENGTH] = {
	{ 0, 4, 2 }, { 0, 4, 0 }, { 1, 5, 0 }, { 1, 6, -2 }, { 3, 7, -4 },
	{ 3, 7, -6 }, { 3, 7, -8 }, { 3, 8, -8 }, { 3, 9, -8 }, { 4, 10, -10 },
	{ 5, 10, -10 }, { 5, 11, -10 }, { 5, 11, -12 }, { 8, 12, -12 }, { 12, 13, -12 },
};

static struct rc_table_param g_rc_v12_range_params_10bpc_8bpp_rgb[DSC_RC_RANGE_LENGTH] = {
	{ 0, 8, 2 }, { 4, 8, 0 }, { 5, 9, 0 }, { 5, 10, -2 }, { 7, 11, -4 },
	{ 7, 11, -6 }, { 7, 11, -8 }, { 7, 12, -8 }, { 7, 13, -8 }, { 8, 14, -10 },
	{ 9, 14, -10 }, { 9, 15, -10 }, { 9, 15, -12 }, { 12, 16, -12 }, { 16, 17, -12 },
};

static struct rc_table_param g_rc_v12_range_params_10bpc_10bpp_rgb[DSC_RC_RANGE_LENGTH] = {
...
static struct rc_table_param g_rc_v12_range_params_8bpc_12bpp_yuv422_default[DSC_RC_RANGE_LENGTH] = {
	{0, 4, 2}, {0, 4, 0}, {1, 5, 0}, {1, 6, -2}, {3, 7, -4},
	{3, 7, -6}, {3, 7, -8}, {3, 8, -8}, {3, 9, -8}, {3, 10, -10},
	{5, 10, -10}, {5, 11, -12}, {5, 11, -12}, {9, 12, -12}, {12, 13, -12},
};
...
static struct rc_table_param g_rc_v12_range_params_8bpc_16bpp_yuv422_default[DSC_RC_RANGE_LENGTH] = {
	{0, 2, 2}, {0, 4, 0}, {1, 5, 0}, {1, 6, -2}, {3, 7, -4},
	{3, 7, -6}, {3, 7, -8}, {3, 8, -8}, {3, 8, -8}, {3, 9, -10},
	{5, 9, -10}, {5, 9, -12}, {5, 9, -12}, {7, 10, -12}, {10, 11, -12},
};

static struct rc_table_param g_rc_v12_range_params_8bpc_12bpp_yuv422[DSC_RC_RANGE_LENGTH] = {
	{ 0, 4, 2 }, { 0, 4, 0 }, { 1, 5, 0 }, { 2, 6, -2 }, { 3, 7, -4 },
	{ 3, 7, -6 }, { 3, 7, -8 }, { 3, 8, -8 }, { 3, 9, -8 }, { 3, 10, -10 },
	{ 5, 10, -10 }, { 5, 11, -12 }, { 5, 11, -12 }, { 8, 12, -12 }, { 12, 13, -12 },
};

static struct rc_table_param g_rc_v12_range_params_8bpc_14bpp_yuv422[DSC_RC_RANGE_LENGTH] = {
	{ 0, 3, 2 }, { 0, 4, 0 }, { 1, 5, 0 }, { 2, 6, -2 }, { 3, 7, -4 },
	{ 3, 7, -6 }, { 3, 7, -8 }, { 3, 8, -8 }, { 3, 9, -8 }, { 3, 9, -10 },
	{ 5, 10, -10 }, { 5, 10, -10 }, { 5, 11, -12 }, { 7, 11, -12 }, { 11, 12, -12 },
};

static struct rc_table_param g_rc_v12_range_params_8bpc_16bpp_yuv422[DSC_RC_RANGE_LENGTH] = {
	{ 0, 2, 2 }, { 0, 4, 0 }, { 1, 5, 0 }, { 2, 6, -2 }, { 3, 7, -4 },
	{ 3, 7, -6 }, { 3, 7, -8 }, { 3, 8, -8 }, { 3, 8, -8 }, { 3, 9, -10 },
	{ 5, 9, -10 }, { 5, 9, -10 }, { 5, 9, -12 }, { 7, 10, -12 }, { 10, 11, -12 },
};

static struct rc_table_param g_rc_v12_range_params_10bpc_16bpp_yuv422[DSC_RC_RANGE_LENGTH] = {
	{ 0, 4, 2 }, { 2, 6, 0 }, { 3, 7, 0 }, { 5, 9, -2 }, { 5, 10, -4 },
	{ 6, 11, -6 }, { 6, 11, -8 }, { 7, 12, -8 }, { 7, 12, -8 }, { 7, 13, -10 },
	{ 8, 13, -10 }, { 8, 13, -10 }, { 9, 13, -12 }, { 11, 14, -12 }, { 14, 15, -12 },
};

/* ------ end of dsc ver1.2 rc tables ------ */
...
static void dsc_calc_chunk_size(struct dsc_info *dsc_info)
{
	...
	dpu_pr_info("[DSC]PPS chunk_size=%u", dsc_info->chunk_size);
}
...
static void dsc_calc_groups_per_line(struct dsc_info *dsc_info)
{
	...
	dpu_pr_info("[DSC]PPS groups_per_line=%u", dsc_info->groups_per_line);
}

static void dsc_calc_first_line_bpg_offset(struct dsc_info *dsc_info)
{
	uint8_t first_line_bpg_offset;
	uint16_t slice_height = 0;
	uint32_t uncompressed_bpg_rate;

	dpu_check_and_no_retval(!dsc_info, err, "NULL POINTER");
	slice_height = dsc_info->slice_height;
	dpu_pr_info("[DSC]PPS slice_height=%u", slice_height);
	...
	dpu_pr_info("[DSC]PPS uncompressed_bpg_rate=%u", uncompressed_bpg_rate);
	if (slice_height >= 8)
		first_line_bpg_offset = 12 + ((9 * min(34, slice_height - 8)) / 100);
	else
		first_line_bpg_offset = 2 * (slice_height - 1);
	first_line_bpg_offset = range_clamp(first_line_bpg_offset, 0,
...
static void dsc_calc_initial_scale_value(struct dsc_info *dsc_info)
{
	 ...
	 * Those magic numbers were assigned by the DSC protocol.
	 */
	if (unlikely(dsc_info->rc_model_size == dsc_info->initial_offset)) {
		dpu_pr_err("rc_model_size - nitial_offset is zero\n");
		return;
	}
...
static void dsc_calc_rc_model_size(struct dsc_info *dsc_info)
{
	...
	if (dsc_info->gen_rc_params == DSC_NOT_GENERATE_RC_PARAMETERS) {
		for (i = 0; i < RC_MODEL_GEN_RC_COUNT; ++i) {
			if (dsc_info->format == rc_model_gen_rc[i].format && dsc_info->dsc_bpp == rc_model_gen_rc[i].dsc_dpp) {
				dpu_pr_info("[DSC] PPS format=%d, dsc_bpp=%d", dsc_info->format, dsc_info->dsc_bpp);
	...
	dpu_pr_info("[DSC] PPS DSC initial_delay is %u", dsc_info->initial_xmit_delay);
}
...
static void dsc_calc_initial_dec_delay(struct dsc_info *dsc_info)
{
	...
	dpu_pr_info("[DSC]PPS hrddelay=%u", hrddelay);
	dpu_pr_info("[DSC] PPS DSC min_rate_buffer_size is %u", min_rate_buffer_size);
	dpu_pr_info("[DSC]PPS initial_dec_delay=%u", dsc_info->initial_dec_delay);
}
...
static void dsc_calc_nfl_bpg_offset(struct dsc_info *dsc_info)
{
	...
	if (dsc_info->nfl_bpg_offset > 65535)
		dpu_pr_err("nfl_bpg_offset is too large for this slice height");

	dpu_pr_info("[DSC]PPS nfl_bpg_offset=%u", dsc_info->nfl_bpg_offset);
}
...
static void dsc_calc_final_offset(struct dsc_info *dsc_info)
{
	...
	dpu_pr_info("[DSC]PPS slice_bits=%u", slice_bits);
	dpu_pr_info("[DSC]PPS final_offset=%u", dsc_info->final_offset);
	dpu_pr_info("[DSC]PPS num_extra_mux_bits=%u", num_extra_mux_bits);
}
...
static void dsc_calc_slice_bpg_offset(struct dsc_info *dsc_info)
{
	...
	dpu_pr_info("[DSC]PPS groups_total=%u", groups_total);
	...
	dpu_pr_info("[DSC]PPS slice_bpg_offset=%u", dsc_info->slice_bpg_offset);
}
...
static void dsc_calc_scale_increment_interval(struct dsc_info *dsc_info)
{
	...
	dpu_check_and_no_retval(!dsc_info, err, "NULL POINTER");
	dpu_check_and_no_retval((dsc_info->rc_model_size == dsc_info->final_offset), err, "zero devider");

	final_scale_value = 8 * dsc_info->rc_model_size / (dsc_info->rc_model_size - dsc_info->final_offset);
	dpu_pr_info("[DSC]PPS final_scale_value=%d", final_scale_value);
	 ...
	 * those magic numbers were assigned by the DSC protocol.
	 */
	dpu_check_and_no_retval((dsc_info->nfl_bpg_offset + dsc_info->slice_bpg_offset == 0), err, "zero devider");
	...
	dpu_pr_info("[DSC]PPS scale_increment_interval=%u", dsc_info->scale_increment_interval);
	if (dsc_info->scale_increment_interval > 65535)
		dpu_pr_info("[DSC] Scale increment interval exceeds 65535");
}
...
static void dsc_calc_flatness_qp(struct dsc_info *dsc_info)
{
	...
	if (dsc_info->dsc_bpc == DSC_8BPC) {
		...
		dpu_pr_err("[DSC] dsc_calc_flatness_qp error");
	}

	range_check("flatness_min_qp", dsc_info->flatness_min_qp, 0, 31);
	range_check("flatness_max_qp", dsc_info->flatness_max_qp, 0, 31);
	dpu_pr_info("[DSC]PPS flatness_min_qp=%u", dsc_info->flatness_min_qp);
	dpu_pr_info("[DSC]PPS flatness_max_qp=%u", dsc_info->flatness_max_qp);
}
...
static struct rc_range_set rc_range_array[] = {
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_8BPC, DSC_8BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_1, g_rc_v11_range_params_8bpc_8bpp_rgb_default},
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_10BPC, DSC_10BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_1, g_rc_v11_range_params_10bpc_10bpp_rgb_default},
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_8BPC, DSC_12BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_1, g_rc_v11_range_params_8bpc_12bpp_rgb_default},
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_10BPC, DSC_8BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_1, g_rc_v11_range_params_10bpc_8bpp_rgb_default},
	{DSC_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_10BPC, DSC_8BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_1, g_rc_v11_range_params_10bpc_8bpp_rgb},
	{DSC_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_8BPC, DSC_8BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_1, g_rc_v11_range_params_8bpc_8bpp_rgb},
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_8BPC, DSC_8BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_8bpc_8bpp_rgb_default},
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_10BPC, DSC_10BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_10bpc_10bpp_rgb_default},
	{DSC_GENERATE_RC_PARAMETERS, DSC_RGB,
		DSC_8BPC, DSC_8BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_8bpc_8bpp_rgb},
	{DSC_GENERATE_RC_PARAMETERS, DSC_RGB,
	...
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_YUV422,
		DSC_8BPC, DSC_12BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_8bpc_12bpp_yuv422_default},
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_YUV422,
		DSC_8BPC, DSC_16BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_8bpc_16bpp_yuv422_default},
	{DSC_GENERATE_RC_PARAMETERS, DSC_YUV422,
		DSC_8BPC, DSC_12BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_8bpc_12bpp_yuv422},
	{DSC_GENERATE_RC_PARAMETERS, DSC_YUV422,
		DSC_8BPC, DSC_14BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_8bpc_14bpp_yuv422},
	{DSC_GENERATE_RC_PARAMETERS, DSC_YUV422,
		DSC_8BPC, DSC_16BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_8bpc_16bpp_yuv422},
	{DSC_GENERATE_RC_PARAMETERS, DSC_YUV422,
		DSC_10BPC, DSC_16BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_10bpc_16bpp_yuv422},
	{DSC_NOT_GENERATE_RC_PARAMETERS, DSC_YUV422,
		DSC_10BPC, DSC_16BPP, DSC_RC_RANGE_LENGTH, DSC_VERSION_V_1_2, g_rc_v12_range_params_10bpc_16bpp_yuv422_default},
};
...
static void dsc_calc_rc_range(struct dsc_info *dsc_info)
{
	...
	if (dsc_info->dsc_version_major == 1 && dsc_info->dsc_version_minor == 1)
		dsc_version = DSC_VERSION_V_1_1;
	else
		dsc_version = DSC_VERSION_V_1_2;

	for (; i < DSC_THRESH_LENGTH; ++i)
		dsc_info->rc_buf_thresh[i] = (g_rc_buf_threshold[i] >> 6);

	for (i = 0; i < ARRAY_SIZE(rc_range_array); ++i) {
		if (rc_range_array[i].gen_rc == dsc_info->gen_rc_params &&
			...
			rc_range_array[i].dsc_version == dsc_version) {
			dpu_pr_info("[DSC]PPS rc_range gen_rc:%d, format:%d, dsc_bpc:%d, dsc_bpp:%d, dsc_version:%d",
				dsc_info->gen_rc_params, dsc_info->format, dsc_info->dsc_bpc, dsc_info->dsc_bpp, dsc_version);
...
static void dsc_config_rc_table(struct dsc_info *dsc_info, struct rc_table_param *user_rc_table, uint32_t rc_table_len)
{
	dpu_check_and_no_retval((user_rc_table == NULL), err, "user_rc_table is NULL");
	dpu_check_and_no_retval((rc_table_len != sizeof(struct rc_table_param) * DSC_RC_RANGE_LENGTH), err,
		"rc_table_len error");

	memcpy(dsc_info->rc_range, user_rc_table, rc_table_len);
}
...
static void dsc_calc_rc_range_params(struct dsc_info *dsc_info)
{
	...
	dpu_pr_info("[DSC]PPS RC_QUANT_INCR_LIMIT0=%u", dsc_info->rc_quant_incr_limit0);
	dpu_pr_info("[DSC]PPS RC_QUANT_INCR_LIMIT1=%u", dsc_info->rc_quant_incr_limit1);
}
...
static void vesa_dsc_init(struct dsc_info *dsc_info)
{
	...
	if (dsc_info->format == DSC_RGB) {
		if (dsc_info->dsc_bpp == DSC_8BPP) { // used by syno/dpu dp 8bpc_8bpp
			...
			dpu_pr_err("[DSC] dsc_calc_rc_model_size error");
		}
	} else if (dsc_info->format == DSC_YUV422) {
		...
		} else if (dsc_info->dsc_bpp == DSC_16BPP) {
...
{
	dpu_pr_info("[DSC] +!");
	dpu_check_and_no_retval(!output_para, err, "NULL POINTER");

	if (exist_para != NULL && input_para == NULL) {
		if (memcpy_s(output_para, sizeof(struct dsc_info), exist_para, sizeof(struct dsc_info)) != EOK) {
			dpu_pr_err("memcpy exist_para error!");
			return;
		}
	} else {
...
{
	dpu_check_and_no_retval(!p, err, "NULL POINTER");

	p->vesa_dsc_info_calc = vesa_dsc_info_calc;
	p->dsc_config_rc_table = dsc_config_rc_table;
}
