...
#define VCO_MIN_FREQ_OUPUT         800000 /* dssv501: 800 * 1000 */
#define SYS_FREQ   38400 /* dssv501: 38.4 * 1000 */
...
#define VCO_MIN_FREQ_OUPUT         1000000 /* dpuv410: 1000 * 1000 */
#define SYS_FREQ   19200 /* dpuv410: 19.2f * 1000 */
...
int dpu_dp_hpd_register(struct dpu_fb_data_type *dpufd);
void dpu_dp_hpd_unregister(struct dpu_fb_data_type *dpufd);
