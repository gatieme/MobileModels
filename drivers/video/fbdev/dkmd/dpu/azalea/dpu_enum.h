...
#define DPUFB_LCD_DIRTY_REGION_INFO_GET _IOW(DPUFB_IOCTL_MAGIC, 801, struct lcd_dirty_region_info)
#define DPUFB_PLATFORM_TYPE_GET _IOW(DPUFB_IOCTL_MAGIC, 802, int)
#define DPUFB_MDC_CHANNEL_INFO_REQUEST _IOW(DPUFB_IOCTL_MAGIC, 803, struct mdc_ch_info)
#define DPUFB_MDC_CHANNEL_INFO_RELEASE _IOW(DPUFB_IOCTL_MAGIC, 804, struct mdc_ch_info)
#define DPUFB_MDC_POWER_DOWNUP_CTRL _IOW(DPUFB_IOCTL_MAGIC, 805, int)
#define DPUFB_GRALLOC_GET_PHYS _IOW(DPUFB_IOCTL_MAGIC, 806, struct ion_phys_data)
...
#define DPUFB_ALSC_ENABLE_INFO_GET _IOW(DPUFB_IOCTL_MAGIC, 809, struct alsc_enable_info)
...
#define DPUFB_VIDEO_IDLE_CTRL _IOW(DPUFB_IOCTL_MAGIC, 0x07, int)
...
#define DPUFB_SAFE_FRM_RATE _IOW(DPUFB_IOCTL_MAGIC, 0x1A, int)

#define DPUFB_ONLINE_PLAY_BYPASS _IOW(DPUFB_IOCTL_MAGIC, 0x20, int)
#define DPUFB_OV_ONLINE_PLAY _IOW(DPUFB_IOCTL_MAGIC, 0x21, struct dss_overlay)
...
#define DPUFB_DISPLAY_ENGINE_INIT _IOW(DPUFB_IOCTL_MAGIC, 0x70, struct display_engine)
#define DPUFB_DISPLAY_ENGINE_DEINIT _IOW(DPUFB_IOCTL_MAGIC, 0x71, struct display_engine)
#define DPUFB_DISPLAY_ENGINE_PARAM_GET _IOW(DPUFB_IOCTL_MAGIC, 0x72, struct display_engine_param)
...
#define DPUFB_DPTX_GET_SOURCE_MODE _IOW(DPUFB_IOCTL_MAGIC, 0x81, int)
...
#define BUILT_IN_PANEL_INDEX 4
#define IS_BUILTIN_PANEL (dpufd->index == PRIMARY_PANEL_IDX || dpufd->index == BUILT_IN_PANEL_INDEX)
...
typedef struct timeval timeval_compatible;
#else
