...
#define SUPPORT_SPR_1_0
#endif

#if defined(CONFIG_DPU_FB_V360)
#define SUPPORT_SPR_2_0
#endif

#if defined(SUPPORT_SPR_1_0) || defined(SUPPORT_SPR_2_0)
#define SUPPORT_SPR
#endif

#if defined(CONFIG_DPU_FB_V510) || defined(CONFIG_DPU_FB_V346)
...
#if defined(CONFIG_DPU_FB_V330) || defined(CONFIG_DPU_FB_V350) || \
...
#define SUPPORT_FPGA_SUSPEND_RESUME
	...
	defined(CONFIG_DPU_FB_V510) || defined(CONFIG_DPU_FB_V346) || \
	defined(CONFIG_DPU_FB_V600) || defined(CONFIG_DPU_FB_V350)
#define LOW_TEMP_VOLTAGE_LIMIT
#endif

#if defined(CONFIG_DPU_FB_V600) || defined(CONFIG_DPU_FB_V350) || \
	defined(CONFIG_DPU_FB_V345) || defined(CONFIG_DPU_FB_V346) || \
...
#if defined(CONFIG_DPU_FB_V350) || defined(CONFIG_DPU_FB_V345) || \
	defined(CONFIG_DPU_FB_V346) || defined(CONFIG_DPU_FB_V360)
...
#define SUPPORT_COPYBIT_WCH_SCL
	...
	defined(CONFIG_DPU_FB_V600) || defined(CONFIG_DPU_FB_V345) || \
	defined(CONFIG_DPU_FB_V346) || defined(CONFIG_DPU_FB_V360)
...
#define SUPPORT_DSS_BUS_IDLE_CTRL
	...
	defined(CONFIG_DPU_FB_V510) || defined(CONFIG_DPU_FB_V350) || \
	defined(CONFIG_DPU_FB_V600) || defined(CONFIG_DPU_FB_V345) || \
	defined(CONFIG_DPU_FB_V346) || defined(CONFIG_DPU_FB_V360)
...
#if defined(CONFIG_DPU_FB_V320) || defined(CONFIG_DPU_FB_V330) || \
	defined(CONFIG_DPU_FB_V410) || defined(CONFIG_DPU_FB_V501)
...
#if defined(CONFIG_DPU_FB_V600) || defined(CONFIG_DPU_FB_V346)
