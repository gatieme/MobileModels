...
#include "dpu_dpe_pipe_clk_utils.h"
#elif defined(CONFIG_DPU_FB_V410)
...
#include "dpu_dpp_cmdlist_utils.h"
#endif

#ifdef CONFIG_DPU_FB_MEDIACOMMON
#include "mediacommon/dpu_mdc_dev.h"
#endif
 ...
 */
	...
	defined(CONFIG_DPU_FB_V501) || defined(CONFIG_DPU_FB_V330) || \
	defined(CONFIG_DPU_FB_V510) || defined(CONFIG_DPU_FB_V600) || \
	defined(CONFIG_DPU_FB_V350) || defined(CONFIG_DPU_FB_V360)
#define V_FRONT_PORCH_MAX 1023
#else
#define V_FRONT_PORCH_MAX 1048575
#endif
