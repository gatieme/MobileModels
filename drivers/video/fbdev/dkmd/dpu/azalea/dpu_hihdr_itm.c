...
static void dpu_hihdr_itm_gamma_init(struct dpu_fb_data_type *dpufd, char __iomem *hdr_base)
{
	...
	/* step map */
	step1 = (g_itm_gamma_step_map[3] << 24) | (g_itm_gamma_step_map[2] << 16) |
		(g_itm_gamma_step_map[1] << 8) | g_itm_gamma_step_map[0];
	step2 = (g_itm_gamma_step_map[7] << 24) | (g_itm_gamma_step_map[6] << 16) |
		(g_itm_gamma_step_map[5] << 8) | g_itm_gamma_step_map[4];

	/* num map */
	num1 =  (g_itm_gamma_num_map[3] << 24) | (g_itm_gamma_num_map[2] << 16) |
		(g_itm_gamma_num_map[1] << 8) | g_itm_gamma_num_map[0];
	num2 =  (g_itm_gamma_num_map[7] << 24) | (g_itm_gamma_num_map[6] << 16) |
...
static void dpu_hihdr_itm_degamma_init(struct dpu_fb_data_type *dpufd, char __iomem *hdr_base)
{
	...
	/* step map */
	step1 =  (g_itm_degamma_step_map[3] << 24) | (g_itm_degamma_step_map[2] << 16) |
		(g_itm_degamma_step_map[1] << 8) | g_itm_degamma_step_map[0];
	step2 =  (g_itm_degamma_step_map[7] << 24) | (g_itm_degamma_step_map[6] << 16) |
		(g_itm_degamma_step_map[5] << 8) | g_itm_degamma_step_map[4];

	/* num map */
	num1 =  (g_itm_degamma_num_map[3] << 24) | (g_itm_degamma_num_map[2] << 16) |
		(g_itm_degamma_num_map[1] << 8) | g_itm_degamma_num_map[0];
	num2 =  (g_itm_degamma_num_map[7] << 24) | (g_itm_degamma_num_map[6] << 16) |
