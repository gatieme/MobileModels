...
struct noc_err_para_s dss_noc_para[] = {
	{
		.masterid = (u32)SOC_DSS_CMD_DBG_MID,
...
static void dss_to_power_up(struct dpu_fb_data_type *dpufd)
{
	...
	/* step 2: module clk enable */
	outp32(dpufd->media_crg_base + MEDIA_CLKDIV9, 0xC280C280);
