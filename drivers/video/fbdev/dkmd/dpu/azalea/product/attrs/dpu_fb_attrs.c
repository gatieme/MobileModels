	...
	struct device_attribute *attr, char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "lcd_fps = %u\n",
...
static ssize_t dpu_alpm_function_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
...
static ssize_t dpu_alpm_function_show(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	ssize_t ret;
#if defined(CONFIG_DPU_FB_AOD) || defined(CONFIG_DPU_FB_AP_AOD)
...
static ssize_t dpu_alpm_setting_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	struct fb_info *fbi = NULL;
	struct dpu_fb_data_type *dpufd = NULL;
...
static DEVICE_ATTR(alpm_function, 0644, dpu_alpm_function_show,
	dpu_alpm_function_store);
static DEVICE_ATTR(alpm_setting, 0644, NULL, dpu_alpm_setting_store);
/*lint +e665, +e514, +e84, +e866, +e886, +e846, +e778*/
