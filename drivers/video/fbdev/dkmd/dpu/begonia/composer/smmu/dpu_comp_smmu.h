...
typedef union {
	...
	struct {
		...
		unsigned int ch_secsid       : 1;  /* bit[8] */
		unsigned int reserved0       : 2;  /* bit[10:9]  */
		unsigned int reserved1       : 5;  /* bit[16:11] */
		unsigned int ch_ssidv        : 1;  /* bit[17] */
		unsigned int ch_sc_hint      : 4;  /* bit[21:18] */
		unsigned int ch_gid          : 6;  /* bit[27:22] */
		unsigned int ch_gid_en       : 1;  /* bit[28] */
		unsigned int ch_ptl_as_ful   : 2;  /* bit[29] */
		unsigned int reserved3       : 2;  /* bit[31:30] */
	} reg;
} soc_dss_mmu0_id_attr;
typedef union {
	unsigned int value;
	struct {
		unsigned int mpam            : 4;  /* bit[3:0]  */
		unsigned int ch_ssid         : 12;  /* bit[15:4] */
		unsigned int axi_domain      : 2;  /* bit[17:16]  */
		unsigned int reserved0       : 14;  /* bit[31:18] */
	} reg;
} soc_dss_mmu1_id_attr;
