...
static struct dpu_to_soc_pixel_format g_dpu_fmt_map[] = {
	...
	{DPU_FMT_BGR_565,           SDMA_FMT_BGR_565,            WDMA_FMT_RGB_565,         DFC_STATIC_FMT_BGR_565,       DFC_DYNAMIC_FMT_BGR_565},
	...
	{DPU_FMT_UYVY_422_PKG,      SDMA_FMT_UYVY_422_8BIT_PKG,  WDMA_FMT_YUYV_422_PKG,    DFC_STATIC_FMT_UYVY422,       DFC_DYNAMIC_FMT_UYVY422},
	...
	{DPU_FMT_BGRA_1010102,      SDMA_FMT_BGRA_1010102,       WDMA_FMT_RGBA_1010102,    DFC_STATIC_FMT_BGRA_1010102,  DFC_DYNAMIC_FMT_BGRA_1010102},
	{DPU_FMT_ARGB_10101010,     SDMA_FMT_ARGB_10101010,      -1,                       DFC_STATIC_FMT_ARGB_10101010, DFC_DYNAMIC_FMT_ARGB_10101010},
	{DPU_FMT_XRGB_10101010,     SDMA_FMT_XRGB_10101010,      -1,                       DFC_STATIC_FMT_XRGB_10101010, DFC_DYNAMIC_FMT_XRGB_10101010},
	{DPU_FMT_AYUV_10101010,     SDMA_FMT_AYUV_10101010,      -1,                       DFC_STATIC_FMT_VUYA_1010102,  DFC_DYNAMIC_FMT_VUYA_1010102},
...
int dpu_fmt_to_wdma(int format)
{
	...
	for (i = 0; i < (uint32_t)ARRAY_SIZE(g_dpu_fmt_map); ++i) {
		if (format == g_dpu_fmt_map[i].dpu_format)
...
int32_t sdma_fmt_to_dpu_fmt(int32_t format)
{
	...
	for (i = 0; i < ARRAY_SIZE(g_dpu_fmt_map); ++i) {
		if (format == g_dpu_fmt_map[i].sdma_format)
			return g_dpu_fmt_map[i].dpu_format;
	}
