...
static int dsm_f2fs_show(struct seq_file *s, void *v)
{
	f2fs_set_need_fsck_report();
	seq_printf(s, "DSM_F2FS_NEED_FSCK:928005001\n");
	return 0;
}
DEFINE_SHOW_ATTRIBUTE(dsm_f2fs);
#endif
...
#ifdef CONFIG_HONOR_F2FS_DSM
	debugfs_create_file("dsm_f2fs", S_IRUGO, f2fs_debugfs_root, NULL,
			&dsm_f2fs_fops);
#endif
