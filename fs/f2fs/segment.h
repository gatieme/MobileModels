...
#define SSR_LOWER_LIMIT_BLK		(16<<18)	/* 16GB(16<<18 blocks) */
#endif
...
struct seg_entry {
	...
	unsigned int frag_score;	/* estimate extent of fragmentation for this seg */
#endif
	/*
...
#define BLKFRAG_UNWRITABLE_WEIGHT 2
#define DELTA_ADJACENT 2
#define MAPLINE_BUFSIZE 80
#define MAP_ROW_LIMIT 8
#define MAP_COL_LIMIT 8
#define MAP_COL_WIDTH 8
#define MAP_COL_DELIM 9
#endif
