...
#include "../../kernel/sched/honor_rtg_sched/include/rtg_sched.h"
#endif

#ifdef CONFIG_HONOR_RTG_FRAME
#include <linux/sched/honor_rtg_sched/iaware_rtg.h>
#endif
 ...
 */
#ifdef CONFIG_HONOR_RTG_FRAME
void honor_pid_update_inode(struct dentry *dentry, struct task_struct *task,
		struct inode *inode)
{
...
static int pid_revalidate(struct dentry *dentry, unsigned int flags)
{
	...
	if (task) {
#ifdef CONFIG_HONOR_RTG_FRAME
		honor_pid_update_inode(dentry, task, inode);
#else
...
#endif
#ifdef CONFIG_HN_DIE_CATCH
	REG("unexpected_die_catch", S_IRUGO|S_IWUSR|S_IWOTH, proc_unexpected_die_catch_operations),
#endif
...
#endif
#ifdef CONFIG_FD_IDENTITY
	REG("fdidentity", S_IRUSR|S_IXUSR, proc_fdidentity_file_operations),
#endif
};
