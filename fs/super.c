...
#ifdef CONFIG_SHRINKER_OPT
#define SUPER_CACHE_MAX_SKIP_CNT 10
unsigned long super_cache_skip_cnt = 0;
#endif
...
#ifdef CONFIG_SHRINKER_OPT
		if (!current_is_kswapd() || (super_cache_skip_cnt < SUPER_CACHE_MAX_SKIP_CNT)) {
			super_cache_skip_cnt++;
			return SHRINK_EMPTY;
		}
		super_cache_skip_cnt = 0;
#endif
...
#ifdef CONFIG_HONOR_RPHONE_DEBUG
