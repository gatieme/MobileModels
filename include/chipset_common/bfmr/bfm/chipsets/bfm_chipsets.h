...
/* this struct is defined for HONOR currently */
...
struct bfm_param {
	...
	/*
	 * 1 - save bottom layer bootfail log, just for HONOR now, 0 - save upper
	 * layer bootfail log
	 */
	int save_bottom_layer_bootfail_log;

	/*
	 * 1 - process boot fail in chipsets, just for HONOR currently, 0 - for
	 * non-HONOR platform, this field is 0
	 */
 ...
 *
 * @note: HONOR must realize this function in detail, the other platform can
