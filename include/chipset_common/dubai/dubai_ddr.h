...
typedef int32_t (*dubai_ddr_get_vote_info_fn_t)(struct dubai_ddr_ss_vote_info *ss_vote_info);
...
struct dubai_ddr_stats_ops {
	...
	dubai_ddr_get_vote_info_fn_t get_vote_info;
};
