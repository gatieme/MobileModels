...
#define WLAN0_RATIO 0
#define CELL0_RATIO  1
#define WLAN1_RATIO 2
#define CELL1_RATIO  3

#define EMCOM_DEFAULT_WLAN0_IFNAME "wlan0"
#define EMCOM_DEFAULT_WLAN1_IFNAME "wlan1"
