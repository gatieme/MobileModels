...
#define GET_SHUT_STAGE _IOR(BOOT_DETECTOR_IOCTL_BASE, 105, int)
#define SET_SHUT_STAGE _IOW(BOOT_DETECTOR_IOCTL_BASE, 106, int)
#define PROCESS_SHUTFAIL _IOW(BOOT_DETECTOR_IOCTL_BASE, 107, struct shutfail_proc_param)
#define GET_SFI_DEV_PATH _IOR(BOOT_DETECTOR_IOCTL_BASE, 108, struct bfi_dev_path)
#define SET_REBOOT _IOW(BOOT_DETECTOR_IOCTL_BASE, 109, int)
#define GET_SFI_DEV_OFFSET _IOR(BOOT_DETECTOR_IOCTL_BASE, 110, int)
#endif
#ifdef CONFIG_BOOT_DETECTOR_SINGLE_FRAME
#define KERNEL_BBOX_NOTIFY _IOW(BOOT_DETECTOR_IOCTL_BASE, 106, int)
#endif
