...
#define SCP_PROTOCOL_ADP_TYPE0_IGNORE_CABLE  BIT(6)
...
#define SCP_PROTOCOL_HSC_VOLTAGE_TH          15000
...
#define SCP_PROTOCOL_VENDOR_ID_HONOR        0x00B4
...
/* Honor adatper value starts from 0x80** */
#define SCP_PROTOCOL_VENDOR_ID_IWATT         0x80A2
#define SCP_PROTOCOL_VENDOR_ID_WELTREND      0x80B2
#define SCP_PROTOCOL_VENDOR_ID_ROCKCHIP      0x80C2
#define SCP_PROTOCOL_VENDOR_ID_CHIPOWN       0xA001
...
/* Huangpu River 2.0 three port adaptor typeC1+typeA1+typeA2 */
#define SCP_PROTOCOL_ADP_B_TYPE1_66W_DL      0x1D
...
#define SCP_PROTOCOL_ADP_B_TYPE1_40W_DL      0X25
#define SCP_PROTOCOL_ADP_B_TYPE1_66W_OB      0x29
#define SCP_PROTOCOL_ADP_B_TYPE1_100W_DL     0x2A /* 20v5a, lvc+sc+hsc */
#define SCP_PROTOCOL_ADP_B_TYPE1_135W        0x26 /* 20v6.75a, lvc+sc+hsc */
#define SCP_PROTOCOL_ADP_B_TYPE1_65W_PC      0xC0 /* 20v3.25a, lvc+sc */
#define SCP_PROTOCOL_ADP_B_TYPE1_100W_WT     0XC1 /* 20v5a, lvc+sc+hsc */
#define SCP_PROTOCOL_ADP_B_TYPE1_66W_DL      0x1D /* 11v3a, lvc+sc */
/* Honor adatper value starts from 0x80 */
#define SCP_PROTOCOL_ADP_B_TYPE1_100W        0X80 /* 20v5a, sc+hsc */
#define SCP_PROTOCOL_ADP_B_TYPE1_66W_CP      0X81 /* 11v6a, sc+lvc */
#define SCP_PROTOCOL_ADP_B_TYPE1_35W_A       0X82 /* 11v3.2a, sc */
#define SCP_PROTOCOL_ADP_B_TYPE1_35W_B       0X83 /* 11v3.2a, sc */
/* Jialing River PC adaptor only typec no typeA */
#define SCP_PROTOCOL_ADP_B_TYPE1_135W_RT     0x26 /* 20v6.75a, sc+hsc */
...
struct scp_protocol_ops {
	...
	void *dev_data;
	int (*reg_read)(int, int *, int, void *);
	int (*reg_write)(int, const int *, int, void *);
	int (*reg_multi_read)(u8, u8 *, u8, void *);
...
#if IS_ENABLED(CONFIG_ADAPTER_PROTOCOL_SCP)
