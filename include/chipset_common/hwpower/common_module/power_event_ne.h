...
enum power_event_blocking_notifier_type {
	...
	POWER_BNT_LOW_POWER,
	POWER_BNT_BMS_AUTH,
	POWER_BNT_REVERSE_CHARGE,
	POWER_BNT_BYPASSBOOST,
	POWER_BNT_REVERSE_SC,
	POWER_BNT_HALL_EVENT,
	POWER_BNT_END,
};
...
enum power_event_notifier_list {
	...
	POWER_NE_SCREEN_FOLD,
	POWER_NE_SCREEN_UNFOLD,
	/* section: for low power */
	POWER_NE_BAT_ECM_TRIGGER_STATUS,
	/* section: for battery ocv */
	POWER_NE_BATTERY_OCV_CHANGE,
	/* section: for bms auth service */
	POWER_NE_BMS_AUTH_START,
	POWER_NE_BMS_AUTH_STOP,
	POWER_NE_BMS_AUTH_START_FORCE,
	/* section: for wired reverse charge */
	POWER_NE_REVERSE_CHARGE_CAP,
	/* section for bypass boost device*/
	POWER_NE_BYPASSBOOST_FAULT,
	POWER_NE_BYPASSBOOST_RECOVERY,
	/* section: for reverse charge */
	POWER_NE_RVS_CHG_RESET_PROTOCOL,
	POWER_NE_RVS_CHG_PROTOCOL_FAIL,
	POWER_NE_BMS_REVERSE_AUTH_START,
	POWER_NE_BMS_REVERSE_AUTH_IGNORE_WORK,
	POWER_NE_END,
};
