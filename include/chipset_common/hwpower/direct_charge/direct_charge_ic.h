...
#define VBAT_MAIN_AUX_SC_DIFF   200 /* mV */
...
bool dc_ic_get_larger_vbat_from_ic(void);
...
static inline bool dc_ic_get_larger_vbat_from_ic(void)
{
	return false;
}
...
static inline const char *dc_ic_get_ic_battery_gauge_name(int mode, unsigned int path)
{
	return NULL;
}
