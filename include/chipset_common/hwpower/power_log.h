...
#define POWER_LOG_TITLE_SIZE                 64
...
enum power_log_device_id {
	...
	POWER_LOG_DEVICE_ID_RT9426A_AUX,
	POWER_LOG_DEVICE_ID_CW2217, /* for cw2217 */
	POWER_LOG_DEVICE_ID_FUSION_COUL, /* fusion coul */
	POWER_LOG_DEVICE_ID_AW3200, /* buck charger aw3200 */
	POWER_LOG_DEVICE_ID_ET9562, /* buck charger et9562 */
	POWER_LOG_DEVICE_ID_SC8562, /* for sc8562 */
	POWER_LOG_DEVICE_ID_SC8562_AUX, /* for sc8562_aux */
	POWER_LOG_DEVICE_ID_ADSP, /* for adsp charge */
	...
	POWER_LOG_DEVICE_ID_SC8546,
	POWER_LOG_DEVICE_ID_RT9756A,
	POWER_LOG_DEVICE_ID_SGM41600A,
...
enum power_log_value_type {
	POWER_LOG_VAL_TYPE_U8,
	POWER_LOG_VAL_TYPE_U8_HEX,
	POWER_LOG_VAL_TYPE_U16,
	POWER_LOG_VAL_TYPE_U16_HEX,
	POWER_LOG_VAL_TYPE_U32,
	POWER_LOG_VAL_TYPE_U32_HEX,
	POWER_LOG_VAL_TYPE_INT32,
	POWER_LOG_VAL_TYPE_STRING,
};

struct power_log_format {
	char *title;
	int placehold;
	enum power_log_value_type value_type;
};

void power_log_construct_head(struct power_log_format *format_tbl, int tbl_num, char *head);
void power_log_construct_content(struct power_log_format *format_tbl, int tbl_num,
	void *data[], int data_num, char *content);
