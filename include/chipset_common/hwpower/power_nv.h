...
extern int power_nv_write(enum power_nv_type type, const void *data, uint32_t data_len);
extern int power_nv_read(enum power_nv_type type, void *data, uint32_t data_len);
