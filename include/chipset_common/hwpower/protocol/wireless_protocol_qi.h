...
#define HWQI_CMD_SET_TX_VPA_LIM                     0x8d
...
/* cmd 0x8d */
#define HWQI_PARA_SET_TX_VPA_LIM_LEN                4
#define HWQI_PARA_TX_VPA_LIM_TYPE                   0
#define HWQI_PARA_TX_VPA_LIM_LTH                    1
#define HWQI_PARA_TX_VPA_LIM_HTH                    2
