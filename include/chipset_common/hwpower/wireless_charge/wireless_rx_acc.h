...
#define WLRX_ACC_TX_PWR_RATIO_DFLT         75
#define WLRX_ACC_TX_PWR_RATIO_SCX          81
#define WLRX_ACC_TX_PWR_RATIO_OVER_SCX     85
#define WLRX_ACC_TX_PWR_SCX_TH             80000000  /* 80W */
#define WLRX_ACC_TX_PWR_OVER_SCX_TH        100000000 /* 100W */
...
static inline bool wlrx_is_sc_err_tx(unsigned int drv_type)
{
	return false;
}

static inline bool wlrx_is_low_vpa_car_tx(unsigned int drv_type)
{
	return false;
}
...
static inline int wlrx_acc_get_tx_imax(unsigned int drv_type,
...
static inline int wlrx_acc_get_tx_fixed_fop(unsigned int drv_type)
{
	return -EINVAL;
}

static inline bool wlrx_can_enter_scx(unsigned int drv_type, unsigned int path_ratio)
{
	return false;
}
