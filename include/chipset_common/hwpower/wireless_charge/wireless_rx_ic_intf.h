...
#define WLRX_IC_PWR_ON_GOOD           1
#define WLRX_IC_PWR_ON_NOT_GOOD       0
#define WLRX_IC_DFLT_VOUT             5000
#define WLRX_IC_HIGH_VOUT1            7000
#define WLRX_IC_HIGH_VOUT2            12000

/* for chip_init */
#define WLRX_IC_DFLT_CHIP_INIT        0
#define WLRX_IC_SC_CHIP_INIT          1
#define WLRX_IC_5VBUCK_CHIP_INIT      5000
#define WLRX_IC_9VBUCK_CHIP_INIT      9000
...
struct wlrx_ic_ops {
	...
	int (*enable_ldo_opp_vbst)(bool vbst_en, void *dev_data);
	...
	int (*set_cm)(int cm_type, void *dev_data);
...
int wlrx_ic_enable_ldo_opp_vbst(bool vbst_en, unsigned int type);
...
int wlrx_ic_set_cm(unsigned int type, int cm_type);
...
static inline int wlrx_ic_enable_ldo_opp_vbst(bool vbst_en, unsigned int type)
{
	return -EPERM;
}
...
static inline int wlrx_ic_set_cm(unsigned int type, int cm_type)
{
	return -EPERM;
}
