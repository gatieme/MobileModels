...
static inline int wlrx_pmode_select_vid(unsigned int drv_type, int vtx)
{
	return 0;
}

static inline void wlrx_pmode_set_vid(unsigned int drv_type, int vtx)
{
}

static inline int wlrx_pmode_get_vid(unsigned int drv_type)
{
	return 0;
}

static inline int wlrx_pmode_get_vtx_by_id(unsigned int drv_type, int id)
{
	return 0;
}
