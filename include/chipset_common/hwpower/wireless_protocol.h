...
/* tx alarm */
#define WIRELESS_TX_ALARM_CLEAR         0
#define WIRELESS_TX_ALARM_BACK_COUNT    3
...
enum wireless_protocol_device_id {
	...
	WIRELESS_DEVICE_ID_CPS4035,
	WIRELESS_DEVICE_ID_MT5728,
	WIRELESS_DEVICE_ID_CPS4067,
	WIRELESS_DEVICE_ID_MT5785,
	WIRELESS_DEVICE_ID_CPS4047,
	WIRELESS_DEVICE_ID_MT5729,
...
enum wireless_protocol_tx_type {
	...
	WIRELESS_TX_TYPE_CP60_1,
	WIRELESS_TX_TYPE_CP60_2,
	WIRELESS_TX_TYPE_CP62_1,
	WIRELESS_TX_TYPE_CP62_2,
	WIRELESS_TX_TYPE_CP62R,
	WIRELESS_TX_TYPE_CK030_1,
	WIRELESS_TX_TYPE_CK030_2,
	WIRELESS_TX_TYPE_AP62L,
	WIRELESS_TX_TYPE_AP62C,
	WIRELESS_TX_TYPE_AP82L,
};
...
struct wireless_protocol_tx_cap {
	...
	bool support_motor_move;
	int support_extend_voltage;
};
...
struct wireless_protocol_ops {
	...
	/* motor position */
	int (*set_motor_position)(u8);
	int (*send_rx_coil_type)(u8);
	int (*get_qval_limit)(u8 *);
};
...
#if IS_ENABLED(CONFIG_WIRELESS_PROTOCOL)
...
int wireless_send_charge_event(int prot, u8 evt);
...
int wireless_send_tx_alarm(int prot, u8 *alarm, int len);
...
int wlc_set_motor_position(int prot, u8 position);
int wireless_send_rx_coil_type(int prot, u8 type);
int wireless_get_qval_limit(int prot, u8 *qval_limit);
...
static inline int wireless_send_charge_event(int prot, u8 evt)
{
	return -1;
}
...
static inline int wireless_send_tx_alarm(int prot, u8 *alarm, int len)
{
	return -1;
}
...
static inline int wireless_send_rx_coil_type(int prot, u8 type)
{
	return -1;
}
...
static inline int wlc_set_motor_position(int prot, u8 position)
{
	return -1;
}
