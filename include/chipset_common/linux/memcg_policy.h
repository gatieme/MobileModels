 ...
 * memcg_policy.h
 *
 * Copyright(C) 2020 Honor Technologies Co., Ltd. All rights reserved.
 *
...
extern unsigned int get_zswapd_pause_interval(void);
extern unsigned int get_zswapd_pause_stat(void);
extern void set_zswapd_pause_stat(unsigned int value);
#else
...
static inline unsigned int get_zswapd_pause_interval(void);
{
	return 0;
}

static inline unsigned int get_zswapd_pause_stat(void);
{
	return 0;
}

static inline void set_zswapd_pause_stat(unsigned int value);
{
}
#endif
