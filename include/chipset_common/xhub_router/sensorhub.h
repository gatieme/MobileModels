 ...
 *  Sensor Hub driver
 *
 * Copyright (C) 2012 honor, Inc.
 * Author: qindiwen <qindiwen@honor.com>
 *
 */

#ifndef __LINUX_XHUB_H__
#define __LINUX_XHUB_H__
...
enum {
	...
	SENSORHUB_TYPE_THERMOMETER,
	SENSORHUB_TYPE_LIGHT2,
	SENSORHUB_TYPE_HINGE,
