...
static inline int power_platform_is_smart_battery(void)
{
	return coul_drv_is_smart_battery();
}

static inline int power_platform_get_desired_charging_current(void)
{
	return coul_drv_get_desired_charging_current();
}
...
{
		return  pd_dpm_notify_direct_charge_status(dc);
}
