...
#define WLDC_WDT_TIMEOUT                  2000 /* ms */

#define WLDC_PMODE_CFG_ROW                3
#define WLDC_PMODE_CFG_COL                12 /* default */
...
/*
 * hth/lth: 2:1 ibus configured default, when use it, we should convert it
