...
#define WLTX_ABNORMAL_IBAT_2             10000
#define WLTX_BP2CP_ABNORMAL_IBAT         8000
#define WLTX_RVS4_ILIM_TIMEOUT           3000 /* 3s */
...
#define WL_TX_PING_DELATY_1              150 /* ms */
#define WL_TX_PING_DELATY_2              1500 /* ms */
...
#define WL_TX_IIN_LOW_TIME               1800000 /* 30min: 30*60*1000 */
#define WL_TX_PTRX_LOW_TIME              15000 /* 15s: 15*1000 */
...
#define WLTX_COOLINGCASE_CLOSE_DEALY     150000 /* 2.5min */
#define WLTX_COOLINGCASE_OPEN_DEALY      1800000 /* 30min */

#define WLTX_SS_LOW_MAX_CNT              10
...
enum wireless_tx_status_type {
	...
	WL_TX_STATUS_COOLINGCASE_TIMEOUT,     /* user open tx with coolingcase */
	/* tx error status */
...
struct wltx_dev_info {
	...
	struct delayed_work coolingcase_timeout_work;
	struct delayed_work coolingcase_timeout1_work;
	struct work_struct ask_set_vtx_work;
	struct wltx_logic_ops *logic_ops;
	struct wltx_vset_para tx_vset;
	struct wltx_vset_para dts_vset;
	struct wltx_vset_para sc14_dts_vset;
	struct wltx_vout_para tx_vout;
	struct wltx_get_rx_private_data rx_data;
	struct wltx_monitor_info power_info;
	struct wltx_cc_cfg cc_cfg;
	struct wltx_protect_cfg protect_cfg;
	struct wltx_fod_cfg fod_cfg;
	struct wltx_prevfod_cfg prevfod_cfg1;
	struct wltx_prevfod_cfg prevfod_cfg2;
	...
	unsigned int tx_pwr_low_cnt;
	unsigned long hs_time_out; /* hs: handshake */
	unsigned long rvs4_ilim_timeout;
	...
	unsigned int tx_timeout_cfg;
	unsigned int tx_rp_demodule_timeout;
...
static inline int wireless_tx_get_tx_status(void)
{
	return 0;
}
...
static inline void wltx_cancel_work_handler(void) {}
