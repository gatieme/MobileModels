...
extern void pd_notify_tcp_event_buf_reset_ex(
		struct pd_port *pd_port, uint8_t reason);
extern void pd_notify_tcp_event_1st_result_ex(struct pd_port *pd_port, int ret);
extern void pd_notify_tcp_event_2nd_result_ex(struct pd_port *pd_port, int ret);
