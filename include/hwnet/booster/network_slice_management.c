...
void slice_ip_para_report(struct sk_buff *skb, unsigned short family)
{
	...
	if (family == AF_INET)
		...
		hilog_info("%s:sk_family not AF_INET and AF_INET6\n", __func__);
