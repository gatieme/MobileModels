...
#define _ANDROID_KABI_RESERVE_ORG(n)		u64 android_kabi_reserved##n
#else
...
#define ANDROID_KABI_RESERVE_ORG(number)	_ANDROID_KABI_RESERVE_ORG(number)
#else
...
#define ANDROID_KABI_USE_ORG(number, _new)		\
		_ANDROID_KABI_REPLACE(_ANDROID_KABI_RESERVE_ORG(number), _new)
#else
#define ANDROID_KABI_USE(number, _new)		\
