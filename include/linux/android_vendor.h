...
#define ANDROID_VENDOR_DATA_ORG(n)		u64 android_vendor_data##n
#define ANDROID_VENDOR_DATA_ARRAY_ORG(n, s)	u64 android_vendor_data##n[s]
#else
...
#define ANDROID_OEM_DATA_ORG(n)			u64 android_oem_data##n
#define ANDROID_OEM_DATA_ARRAY_ORG(n, s)	u64 android_oem_data##n[s]
#define ANDROID_BACKPORT_RESERVED_ORG(n)	_ANDROID_BACKPORT_RESERVED(n)
#else
