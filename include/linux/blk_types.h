...
enum req_process_stage_enum {
	...
	REQ_PROC_STAGE_VIRTIO_BLK_ZEROES,
	REQ_PROC_STAGE_VIRTIO_BLK_NOTSUPP,
	REQ_PROC_STAGE_VIRTIO_BLK_ENOSPC,
	REQ_PROC_STAGE_VIRTIO_BLK_ENOMEM,
	REQ_PROC_STAGE_VIRTIO_BLK_ERROR,
	REQ_PROC_STAGE_VIRTIO_BLK_DONE,
#endif
...
#define MAS_IO_IN_FG_COUNT_SET	(1 << 5)
	...
	*/
	...
	struct __kernel_timespec submit_tp;
#else
...
#define MAS_BLK_SPECI		((__force blk_status_t)17)
#endif
...
struct bio {
...
#ifdef CONFIG_HUAWEI_STORAGE_ROFA_EXTEND
	struct gendisk		*dm_disk; /* record device-mapper gendisk */
#endif
	...
	u8			bi_orig_partno; /* record partno for DRX partition */
#endif
...
#define MAS_REQ_CPPLUS		(1ULL << __MAS_REQ_CPPLUS)
