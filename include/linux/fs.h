...
struct address_space_operations {
	...
	int (*mas_readahead)(struct file *filp, struct address_space *mapping,
			struct list_head *pages, unsigned nr_pages,
...
#ifdef CONFIG_PROTECT_LRU_DEBUG
	atomic_t nr_protect_pages;
#endif
...
#define SB_DELAY_SHRINK (1<<24) /* Do not shrink super_block cache until memory pressure is high */
#endif
