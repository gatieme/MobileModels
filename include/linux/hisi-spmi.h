...
#ifndef __LINUX_SPMI_MASTER_H__
#define __LINUX_SPMI_MASTER_H__
 ...
 */
extern int vendor_spmi_driver_register(struct spmi_driver *drv);
#else
...
struct spmi_driver {
	...
	void				(*remove)(struct spmi_device *dev);
...
#define SPMI_FN_MAIN_ID          0xc3000800u
 ...
 */
extern int vendor_spmi_register_read(struct spmi_controller *ctrl,
					u8 sid, u8 ad, u8 *buf);
 ...
 * Slave device.
 */
extern int vendor_spmi_ext_register_read(struct spmi_controller *ctrl,
 ...
 */
extern int vendor_spmi_ext_register_readl(struct spmi_controller *ctrl,
 ...
 */
extern int vendor_spmi_register_write(struct spmi_controller *ctrl,
					u8 sid, u8 ad, u8 *buf);
 ...
 * Slave device.
 */
extern int vendor_spmi_ext_register_write(struct spmi_controller *ctrl,
					u8 sid, u8 ad, u8 *buf, int len);
 ...
 * Slave device using 16-bit address.
 */
extern int vendor_spmi_ext_register_writel(struct spmi_controller *ctrl,
					u8 sid, u16 ad, u8 *buf, int len);

/* vendor spmi module init */
int spmi_bus_init(void);

/* vendor spmi module exit */
