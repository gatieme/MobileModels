...
static inline hiusb_client_valid_type(u8 type)
{
...
/* API of hiusb client */
struct hiusb_client *hiusb_client_create(struct device *,
					 const struct hiusb_client_desc *,
					 const struct hiusb_client_ops *);
void hiusb_client_destroy(struct hiusb_client *);
void hiusb_client_lock_port(struct hiusb_client *);
void hiusb_client_unlock_port(struct hiusb_client *);
 ...
 */
int hiusb_client_init_usb2(struct hiusb_client *);
int hiusb_client_deinit_usb2(struct hiusb_client *, unsigned int keep_power);
int hiusb_client_init_usb3(struct hiusb_client *);
int hiusb_client_deinit_usb3(struct hiusb_client *);
