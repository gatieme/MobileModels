...
static inline void task_enter_mmap_lock(struct mm_struct *mm)
{
	current->in_mmap_lock = 1;
}

static inline void task_leave_mmap_lock(struct mm_struct *mm)
{
	current->in_mmap_lock = 0;
}
#endif
