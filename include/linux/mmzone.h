...
#ifdef CONFIG_MM_VIP
	int vip_count;		/* number of pages in the vip list */
#endif
...
#ifdef CONFIG_MM_VIP
	struct list_head lists[MIGRATE_PCPTYPES + VIP_LIST_EXT];
#else
...
{
	return &lruvec_pgdat(lruvec)->__lruvec;
}
