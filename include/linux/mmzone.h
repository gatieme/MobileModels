...
enum node_stat_item {
	...
	NR_KERNEL_DMA_BUF_RECLAIMABLE,	/* dma-buf cache meminfo */
#endif
#ifdef CONFIG_KGSL_PAGE_ALLOC_INFO
	NR_KGSL_PAGES,	/* kgsl page alloc */
#endif
...
#ifdef CONFIG_HONOR_ZONE_ISOLATE
struct zone_isolate_info {
    unsigned long end_pfn;
    unsigned long mid_pfn;
};
#endif
...
#ifdef CONFIG_HONOR_ZONE_ISOLATE
	struct zone_isolate_info zi_info[ZONE_ISOLATE_COUNT];
	struct free_area	free_area[ZONE_ISOLATE_COUNT][MAX_ORDER];
#else
...
int extra_watermark_scale_factor_sysctl_handler(struct ctl_table *, int, void *,
		size_t *, loff_t *);
#endif
