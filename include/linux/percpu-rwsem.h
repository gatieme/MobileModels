...
extern void cgroup_threadgroup_rwsem_boost_enter(struct percpu_rw_semaphore *sem);
extern void cgroup_threadgroup_rwsem_boost_exit(struct percpu_rw_semaphore *sem);
#endif
...
static inline void percpu_down_read(struct percpu_rw_semaphore *sem)
{
	...
	preempt_disable();
#ifdef CONFIG_CGROUP_THDGROUP_RWSEM_OPT
	cgroup_threadgroup_rwsem_boost_enter(sem);
#endif
	/*
...
#ifdef CONFIG_CGROUP_THDGROUP_RWSEM_OPT
	cgroup_threadgroup_rwsem_boost_exit(sem);
#endif
	preempt_enable();
}
