...
#endif
#ifdef CONFIG_TASK_PRI_PROMOTE_FOR_MMAPLOCK
	unsigned			in_mmap_lock:1;
#endif
...
# endif
	...
	int rtg_depth;
	unsigned int add_rtg_from_cgroup;
#endif

#ifdef CONFIG_HN_QOS_THREAD
	struct set_qos *proc_qos;
	struct set_qos thread_qos;
	...
	bool need_next_recovery;
#endif

#ifdef CONFIG_OPT_KERNEL_MEMORY_USAGE
	ANDROID_VENDOR_DATA_ARRAY_ORG(1, 64);
	ANDROID_OEM_DATA_ARRAY_ORG(1, 6);
#else
...
#define  NR_LRUS     5
	atomic_long_t page_stat[NR_LRUS];
#endif
...
#define PFA_HYPERHOLD_IDLE_RECLAIM	8
#endif
