...
extern unsigned int sysctl_sched_smt_expeller_util_ratio;
...
extern unsigned int sysctl_offline_last_compat_core_enabled;
#endif
#ifdef CONFIG_FUTEX_OPTIMISTIC_SPIN
extern unsigned int sysctl_futex_opt_spin_enable;
extern unsigned int sysctl_futex_opt_spin_timeout;
#endif

#ifdef CONFIG_HUAWEI_PERFD
extern unsigned int sysctl_perflogd_ex_report;
#endif
...
int sysctl_sched_fair_group_share_bypass_handler(struct ctl_table *table, int write, void *buffer,
		size_t *lenp, loff_t *ppos);
#endif
