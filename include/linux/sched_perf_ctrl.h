...
#if (defined(CONFIG_HONOR_SCHED_VIP) || defined(CONFIG_HN_VIP_THREAD_BUILDIN)) && defined(CONFIG_SCHED_PERF_CTRL)
...
#if (defined(CONFIG_HW_FAVOR_SMALL_CAP) || defined(CONFIG_HW_EAS_SCHED)) && defined(CONFIG_SCHED_PERF_CTRL)
...
#if defined(CONFIG_HONOR_SCHED_STAT_YIELD) && defined(CONFIG_SCHED_PERF_CTRL)
