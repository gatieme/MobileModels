 ...
 */
extern long ksys_unlink(const char __user *pathname);

extern long ksys_rmdir(const char __user *pathname);

extern long ksys_mkdir(const char __user *pathname, umode_t mode);
...
extern long ksys_access(const char __user *filename, int mode);
...
long ksys_rename(const char __user *oldname, const char __user *newname);
