...
/* Events for usb transfer failed */
#define USB_SET_ADDRESS_ERR		0x01
#define USB_GET_DESCRIPTOR_ERR		0x02
#define USB_ENUM_UNKNOWN_ERR		0x03
#define USB_TRANSFER_ERR		0x04
#ifdef CONFIG_USB_DWC3_CHIP
extern void usb_fault_register_notify(struct notifier_block *nb);
extern void usb_fault_unregister_notify(struct notifier_block *nb);
#else
static inline void usb_fault_register_notify(struct notifier_block *nb) { };
static inline void usb_fault_unregister_notify(struct notifier_block *nb) { };
#endif
