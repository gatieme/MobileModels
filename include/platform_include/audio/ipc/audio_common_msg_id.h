...
enum AUDIO_COMMON_MSG_ENUM {
    ...
    ID_AP_NOTIFY_HIFI_SPATIAL_AUDIO_STREAM_TYPE = 0xDD32,
    ID_AUDIO_UPDATE_DSP_LOOP_IN_BUFF    = 0xDD33,
    ID_AUDIO_UPDATE_DSP_LOOP_OUT_BUFF   = 0xDD34,
    ...
    ID_AP_AUDIO_CMD_SET_LATENCY_MEASURE_CMD      = 0xDD9E,
    ...
    ID_DSP_HOOK_RECV_DATA_CMD             = 0xDDAF,
    ID_DSP_HOOK_SEND_DATA_CMD             = 0xDDB0,
    ID_AUDIO_SEND_IMU_PROCESS_CMD         = 0xDDB1,

    ID_AUDIO_UPDATE_BBIC_PLAY_BUFF_CMD    = 0xDDB2,
    ID_AUDIO_UPDATE_BBIC_CAPTURE_BUFF_CMD = 0xDDB3,
    ID_AUDIO_UPDATE_BBIC_TX_BUFF_CMD      = 0xDDB4,
    ID_AUDIO_UPDATE_BBIC_RX_BUFF_CMD      = 0xDDB5,

    ID_AUDIO_SEND_IMU_RESTART_CMD         = 0xDDB6,
    ID_AUDIO_SEND_ACL_INFO_CMD             = 0xDDB7,
    ID_AUDIO_SEND_ADJUST_MTU_CMD           = 0xDDB8,
    ID_AUDIO_SEND_DELAY_CLEAR_USB_EP_CMD   = 0xDDB9,
    ...
    ID_DSP_AP_GET_TIME_STAMP_CMD      = 0xDDD2,
    ID_DSP_AP_REPORT_HIEVENT_CMD      = 0xDDD3,
    ...
    /* chime module message ID between A core and HiFI */
    ID_AP_HIFI_CHIME_START_CMD          = 0xDE00, /* The AP to start HiFi chime request command */
    ID_HIFI_AP_CHIME_START_CNF_CMD      = 0xDE01, /* dsp start up chime call back AP confirm */
    ID_AP_HIFI_CHIME_UPDATE_BUF_CMD     = 0xDE02, /* The AP notifies the HiFi of a new data block update command */
    ID_HIFI_AP_CHIME_ELAPSED_CMD        = 0xDE03, /* dsp send to AP request new data block */
    ID_AP_HIFI_CHIME_EFFECT_CFG_CMD     = 0xDE04, /* The AP set effect cfg to HiFi */
    ID_HIFI_AP_CHIME_PLAY_END_CMD       = 0xDE05, /* dsp notifies AP chime stop */

    /* chime module RT Pid to Normal Pid message ID */
    ID_AUDIO_UPDATE_CHIME_BUF_CMD       = 0xDE20,

    /* VM reset message ID to clear NRDA domain services */
    ID_AP_HIFI_CLEAN_NRDA_STREAM        = 0xDE30,
    ...
    ID_AP_AUDIO_CMD_SET_CODEC_PACKET_INFO   = 0xDF13,
    ...
    ID_AP_DSP_SPATIAL_AUDIO_INIT_REQ    = 0xDF6A,
    ID_DSP_AP_SPATIAL_AUDIO_INIT_CNF    = 0xDF6B,
    ID_AP_DSP_SPATIAL_AUDIO_DEINIT_REQ  = 0xDF6C,
    ID_DSP_AP_SPATIAL_AUDIO_DEINIT_CNF  = 0xDF6D,
    ...
    ID_AP_HIFI_SOUNDTRIGGER_MIC_STATE_GET_REQ = 0xDF74,
    ID_AP_HIFI_SOUNDTRIGGER_MIC_STATE_GET_CNF = 0xDF75,

    ID_AP_DSP_SET_BBIC_CMD = 0xDF76,

    ID_DSP_SYSCACHE_LOAD_DATA_REQ = 0xDF77,
    ID_AP_HIFI_CCPU_SUSPEND_IND = 0xDF78, /* modem单独复位流程，AP在modem响应nmi中断后，通知HIFI modem挂起 */
    ...
    /* HIFI <--> HIFI */
    ID_WAKEUP_SED_DECODE                = 0xFD29,

    /* WAKEUP_MSG_ENUM */
    ID_HIFI_WAKEUP_SET_MUTE             = 0xFD30,       /* dsp->acpu */

    /* HIFI <--> AP */
    ID_HIFI_WAKEUP_ELAPSED_TIMEOUT_ACK = 0xFD31,
    ID_AP_WAKEUP_LP_STATUS_GET         = 0xFD32,
    ID_HIFI_WAKEUP_LP_STATUS_GET_ACK   = 0xFD33,

    ID_HIFI_ULTRASONIC_IN_PROCESS       = 0xFD43,

    ID_DSP_AP_NN_ROUTE_WRITE_COMPLETE   = 0xFD50,    /* dsp->acpu */
    ID_AP_DSP_NN_ROUTE_WRITE_COMPLETE   = 0xFD51,    /* acpu->dsp */

    ID_AP_DSP_SYSCACHE_QUOTA_ACK     = 0xFD52,    /* acpu->dsp */
    ...
    ID_DSP_AUDIO_VOIP_LOW_UL = 0xFF12,   /* for voip */
    ID_DSP_AUDIO_VOIP_LOW_DL = 0xFF13,   /* for voip */
};
