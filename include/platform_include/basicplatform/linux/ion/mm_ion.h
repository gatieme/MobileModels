...
#ifndef _LINUX_MM_ION_H
#define _LINUX_MM_ION_H
...
#define MM_ION_NAME_LEN 16

struct ion_heap_info_data {
	char name[MM_ION_NAME_LEN];
...
enum ION_MM_CUSTOM_CMD {
	ION_MM_CUSTOM_PHYS,
	ION_MM_CLEAN_CACHES,
	ION_MM_INV_CACHES,
	ION_MM_CLEAN_INV_CACHES,
	ION_MM_CUSTOM_GET_KERN_VA,
	ION_MM_CUSTOM_FREE_KERN_VA,
	ION_MM_CUSTOM_ISSUPPORT_IOMMU,
	ION_MM_CUSTOM_GET_MEDIA_HEAP_MODE,
	ION_MM_CUSTOM_SET_FLAG,
	ION_MM_CUSTOM_SET_SMART_POOL_INFO,
};

enum ION_MM_HEAP_MODE {
