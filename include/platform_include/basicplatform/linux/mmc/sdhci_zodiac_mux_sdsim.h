...
#ifndef _SDHCI_ZODIAC_MUX_SD_SIM_
#define _SDHCI_ZODIAC_MUX_SD_SIM_
...
#define SD_CLK_DRIVER_DEFAULT 0x80
#define SD_CMD_DRIVER_DEFAULT 0x60
#define SD_DATA_DRIVER_DEFAULT 0x60
...
#define GPIO_DEFAULT_NUMBER_FOR_SD_CLK      320
#define GPIO_DEFAULT_NUMBER_FOR_SD_CMD      321
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA0    322
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA1    323
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA2    324
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA3    325

#define IOMG_BASE_GPIO_128 0xEFB03000
#define IOMG_BASE_GPIO_PD_128 0xEFB04000
#define IOCG_BASE_GPIO_128 0xEFB04800

/* zodiac iomux xml and pinctrl framework can't support such SD-SIM-IO-MUX case,wo need config different five modes here manully in code */
