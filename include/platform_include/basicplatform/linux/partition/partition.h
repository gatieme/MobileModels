...
#elif defined(CONFIG_PRODUCT_CDC_ACE)
#include <cdc_ace_plat_partition.h>
...
#elif defined(CONFIG_PARTITION_TARGET_OHOS)
#include <plat_partition_ohos.h>
#elif defined(CONFIG_PLAT_PARTITION_CSV2) /* for clt 121 */
#include <plat_csv2_partition.h>
#else
