...
#else
static inline int flash_find_ptn_s(const char* ptn_name, char* bdev_path, unsigned int pblkname_length)
{ return -1; }
static inline int flash_find_ptn(const char* ptn_name, char* bdev_path)
{ return -1; }
