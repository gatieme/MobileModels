...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_RESERVED,            836 * 1024,    39 * 1024, UFS_PART_3}, /* reserved            55MB p55 */
    ...
    {PART_PREAS,              1252 * 1024,   368 * 1024, UFS_PART_3}, /* preas              368MB p82 */
    {PART_PREAVS,             1620 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              1652 * 1024,  9656 * 1024, UFS_PART_3}, /* super             9656MB p84 */
    {PART_VERSION,           11308 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           11884 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p86 */
    {PART_HIBENCH_IMG,       13284 * 1024,   128 * 1024, UFS_PART_3}, /* hibench_img        128MB p87 */
    {PART_HIBENCH_DATA,      13412 * 1024,   512 * 1024, UFS_PART_3}, /* hibench_data       512MB p88 */
    {PART_FLASH_AGEING,      13924 * 1024,   512 * 1024, UFS_PART_3}, /* flash_ageing       512MB p89 */
    {PART_HIBENCH_LOG,       14436 * 1024,    32 * 1024, UFS_PART_3}, /* hibench_log         32MB p90 */
    {PART_USERDATA,          14468 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p91 */
#elif defined CONFIG_MARKET_INTERNAL
#ifdef CONFIG_USE_EROFS
    {PART_PREAS,              1252 * 1024,   296 * 1024, UFS_PART_3}, /* preas              296MB p82 */
    {PART_PREAVS,             1548 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              1580 * 1024,  8322 * 1024, UFS_PART_3}, /* super             8322MB p84 */
    {PART_VERSION,            9902 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           10478 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p86 */
    {PART_USERDATA,          11878 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#else
    {PART_PREAS,              1252 * 1024,   368 * 1024, UFS_PART_3}, /* preas              368MB p82 */
    {PART_PREAVS,             1620 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              1652 * 1024, 10208 * 1024, UFS_PART_3}, /* super             10208MB p84 */
    {PART_VERSION,           11860 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           12436 * 1024,  1144 * 1024, UFS_PART_3}, /* preload           1144MB p86 */
    {PART_USERDATA,          13580 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#endif
#elif defined CONFIG_MARKET_OVERSEA
#ifdef CONFIG_USE_EROFS
    {PART_PREAS,              1252 * 1024,  1024 * 1024, UFS_PART_3}, /* preas             1024 * 1024KB p82 */
    {PART_PREAVS,             2276 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              2308 * 1024,  8282 * 1024, UFS_PART_3}, /* super             8282MB p84 */
    {PART_VERSION,           10590 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           11166 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p86 */
    {PART_USERDATA,          12566 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#else /* end erofs */
    {PART_PREAS,              1252 * 1024,  1280 * 1024, UFS_PART_3}, /* preas             1280MB p82 */
    {PART_PREAVS,             2532 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              2564 * 1024, 10688 * 1024, UFS_PART_3}, /* super             10688MB p84 */
    {PART_VERSION,           13252 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           13828 * 1024,  1144 * 1024, UFS_PART_3}, /* preload           1144MB p86 */
    {PART_USERDATA,          14972 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#endif
#elif defined CONFIG_GCOV_PARTITION_SUPPORT_ENABLE
    {PART_PREAS,              1252 * 1024,    32 * 1024, UFS_PART_3}, /* preas               32MB p82 */
    {PART_PREAVS,             1284 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              1316 * 1024, 10688 * 1024, UFS_PART_3}, /* super             10688MB p84 */
    {PART_VERSION,           12004 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           12580 * 1024,  1144 * 1024, UFS_PART_3}, /* preload           1144MB p86 */
    {PART_USERDATA,          13724 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#else
    {PART_PREAS,              1252 * 1024,  1280 * 1024, UFS_PART_3}, /* preas             1280MB p82 */
    {PART_PREAVS,             2532 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              2564 * 1024, 10688 * 1024, UFS_PART_3}, /* super             10688MB p84 */
    ...
    {PART_FTTEST,            14972 * 1024,   192 * 1024, UFS_PART_3}, /* fttest             192MB p87 */
    {PART_DDRTEST,           15164 * 1024,    48 * 1024, UFS_PART_3}, /* ddrtest             48MB p88 */
    {PART_HITEST_GPU,        15212 * 1024,   512 * 1024, UFS_PART_3}, /* hitest_gpu         512MB p89 */
    {PART_HITEST_ASP_DHRYSTONE, 15724 * 1024,    20 * 1024, UFS_PART_3}, /* hitest_asp_dhrystone  20MB p90 */
    {PART_HITEST_ASP_TEST,   15744 * 1024,   300 * 1024, UFS_PART_3}, /* hitest_asp_test    300MB p91 */
    {PART_HITEST_SENSORHUB,  16044 * 1024,     6 * 1024, UFS_PART_3}, /* hitest_sensorhub     6MB p92 */
    {PART_HITEST_ISP,        16050 * 1024,    25 * 1024, UFS_PART_3}, /* hitest_isp          25MB p93 */
    {PART_HITEST_ISP_AVS,    16075 * 1024,    25 * 1024, UFS_PART_3}, /* hitest_isp_avs      25MB p94 */
    {PART_HITEST_NPU,        16100 * 1024,    80 * 1024, UFS_PART_3}, /* hitest_npu          80MB p95 */
    {PART_HITEST_DSS,        16180 * 1024,    18 * 1024, UFS_PART_3}, /* hitest_dss          18MB p96 */
    {PART_DSS_DISP_BUF,      16198 * 1024,    64 * 1024, UFS_PART_3}, /* dss_disp_buf        64MB p97 */
    {PART_HITEST_JPEGENC,    16262 * 1024,   200 * 1024, UFS_PART_3}, /* hitest_jpegenc     200MB p98 */
    {PART_HITEST_HIPP,       16462 * 1024,   100 * 1024, UFS_PART_3}, /* hitest_hipp        100MB p99 */
    {PART_HITEST_LPM3,       16562 * 1024,     2 * 1024, UFS_PART_3}, /* hitest_lpm3          2MB p100 */
    {PART_JPEG_DEC_TEST_SRC, 16564 * 1024,    20 * 1024, UFS_PART_3}, /* jpeg_dec_test_src   20MB p101 */
    {PART_JPEG_DEC_TEST_DEST, 16584 * 1024,    80 * 1024, UFS_PART_3}, /* jpeg_dec_test_dest  80MB p102 */
    {PART_VCODE_DATA,        16664 * 1024,   130 * 1024, UFS_PART_3}, /* vcode_data         130MB p103 */
    {PART_VCODE_MAX_DATA,    16794 * 1024,   140 * 1024, UFS_PART_3}, /* vcode_max_data     140MB p104 */
    {PART_MODEM_TSP_TEST,    16934 * 1024,    79 * 1024, UFS_PART_3}, /* modem_tsp_test      79MB p105 */
    {PART_MODEM_TSP_DT,      17013 * 1024,     1 * 1024, UFS_PART_3}, /* modem_tsp_dt      1024KB p106 */
    {PART_MODEM_TSP_AVS,     17014 * 1024,    80 * 1024, UFS_PART_3}, /* modem_tsp_avs       80MB p107 */
    {PART_MODEM_PDE_TEST,    17094 * 1024,     4 * 1024, UFS_PART_3}, /* modem_pde_test       4MB p108 */
    {PART_USERDATA,          17098 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p109 */
#else
    {PART_USERDATA,          14972 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#endif
#endif
