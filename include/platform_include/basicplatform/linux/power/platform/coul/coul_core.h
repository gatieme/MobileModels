...
#define FCC_UPPER_LIMIT_PERCENT 102
...
#define NO_BASP_POLICY_CYCLE 	100
#define NONDC_VOLT_DEC_MAX	400
#define NONDC_VOLT_DEC_MIN	0
#define FCC_DECRE_MAX_LIMIT	2
#define INVALID_FCC_CYCLE 	50
