...
#define	DSM_UFS_MPHY_CALIBRATION_INFO		925205510
...
#define	DSM_UFS_HARDWARE_RESET			928008014
#define	DSM_UFS_MEDIUM_ERR			928008015
...
#define	DSM_UFS_DEVICE_FATAL_ERROR		928008022
#ifdef CONFIG_SCSI_UFS_GEAR_CTRL
#define	DSM_UFS_DYNAMIC_SWITCH_SPEED_ERR	928008028
#endif
...
#define	UFS_HARDWARE_RESET		14
#define	UFS_MEDIUM_ERR			15
...
#define	UFS_MPHY_CALIBRATION_INFO	23
#define	UFS_DEVICE_FATAL_ERR		24
#ifdef CONFIG_SCSI_UFS_GEAR_CTRL
#define	UFS_DYNAMIC_SWITCH_SPEED_ERR	28
#endif
	...
	int temperature;
#ifdef CONFIG_SCSI_UFS_GEAR_CTRL
#define UFS_DSS_MAGIC			0x00555500
	u32 ufs_dss_magic;
#define UFS_DSS_SWITCH_ERR 		0
#define UFS_DSS_RESET 			1
#define UFS_DSS_FEATURE_CLOSE		2
#define UFS_DSS_INFO_SET_HIGH		3
#define UFS_DSS_INFO_SET_LOW		4
	u32 ufs_dss_sub_err;
	u32 ufs_dss_set;
	u32 ufs_dss_type;
	u32 ufs_dss_count;
...
struct ufs_reset_info {
	...
	bool full_reset_flag;
};

struct ufs_dsm_log {
	char dsm_log[UFS_DSM_BUFFER_SIZE];
	struct mutex lock; /* mutex */
	struct ufs_reset_info *ufs_reset_dmd;
};
...
#ifdef CONFIG_SCSI_UFS_GEAR_CTRL
#define DSM_UFS_DSS_SCHEDUAL 1
#define DSM_UFS_DSS_NOSCHEDUAL 0
