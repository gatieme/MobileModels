...
void v300_gears_config(struct ufs_hba *hba, u32 gear);
...
#define DFA_HCI_CFG_OFFSET 0x1000
#else
#define DFA_HCI_CFG_OFFSET 0x0
#endif
/* HUFS HCI */
...
#define UFS_CFG_RAM_CTRL (DFA_HCI_CFG_OFFSET + 0x039C)
#define UFS_CFG_RAM_STATUS (DFA_HCI_CFG_OFFSET + 0x03A0)
/*
...
/* HH 3DV7 SPECIAL CONFIG */
#define DEV_TMT_VAL_HH_V7 0x0
#define UFS_MODEL_HHV7_256GB "HN8T15DEHKX075"
#define UFS_MODEL_HHV7_512GB "HN8T25DEHKX077"
#define UFS_MODEL_HHV7_1TB "HN8T35DZHKX079"
#define UFS_MODEL_HH_PTN_LEN 14
...
#define IP_ARST_UFS2QIC_ABRG 13
...
#define ACLK_UFS2QIC_ABRG_MASK		1
#define CLK_UFS_TBU_MASK			9
#define CLK_UFS_TBU2TCU_ABRG_M		6
#define IP_RST_UFS_TBU				8
#define UFS_SC_PSW_MEM_SDO			16
#define UFS_MEM_SP_SDO				26
#define PDC_UFS_SYSPDC_PWRD_MASK	(1 << 4)
...
/* For backward compatible between HUFS and SPEC UFS */
...
#define R_DIVISOR 9
#define R_DIVISOR_SMSV6 7
#define HALF_R_DIVISOR (R_DIVISOR / 2)
#define TX_DIVISOR 9
#define RX_DIVISOR 74
#define TX_HALF_DIVISOR (TX_DIVISOR / 2)
#define RX_HALF_DIVISOR (RX_DIVISOR / 2)
#define TX_MULTIPLIER 10
#define RX_MULTIPLIER 100
#define RX_LEVEL 9
...
#define MPHY_VCO_CNT_VALUE_I 0xBE
#define MPHY_VCO_CNT_VALUE_II 0xBF
...
#define CDR_KOS_MANUL BIT(3)
#define CDR_AUTO_SET BIT(4)

#define TX_TRAILING_CLOCKS_REG 0x1564
#define TX_TRAILING_CLK_NUMS 0xFA

#define TX_ANA_CONTROL_I 0x50
#define AFE_CONFIG_VIII 0x56
#define TX_AFE_CONFIG_VI 0x57

#define TX_AFE_CONFIG_III 0x7C
#define TX_VCM_VREF_237 0xF
...
/* UFS VCO PMU registers */
#ifdef CONFIG_SCSI_UFS_SCORPIO
#define VP_VSET 0x74
#define VPH_VEST 0x79
#elif defined(CONFIG_SCSI_UFS_SGR)
#define VP_VSET 0x87
#define VPH_VEST 0x8D
#endif
...
int hufs_set_each_cfg_attr(struct ufs_hba *hba, const struct ufs_attr_cfg *cfg,
			   int cfg_array_size);
...
#ifdef CONFIG_SCSI_UFS_AQUILA
#define INTR_HUB_UFS_GROUP 3
#define INTR_MPHY_GIC_BIT 3
#define INTR_UNIPRO_GIC_BIT 2
#define INTR_UFSHC_GIC_BIT 1
#else
