...
typedef enum _tag_hwsensor_position_kind
{
	...
	HWSENSOR_POSITION_REAR               =    0, // back main
	HWSENSOR_POSITION_FORE               =    1, // front main
	HWSENSOR_POSITION_SUBREAR            =    2,
	HWSENSOR_POSITION_SUBFORE            =    3, /* legacy */
	HWSENSOR_POSITION_REAR_THIRD         =    4, // tele
	HWSENSOR_POSITION_REAR_SECOND        =    5, // sub
	HWSENSOR_POSITION_REAR_FORTH         =    6,
	HWSENSOR_POSITION_FORE_SECOND        =    7, // front sub
	...
	HWSENSOR_POSITION_IGS                =    20, // front swing
	HWSENSOR_POSITION_IGS_TOF            =    21, // front tof swing
	HWSENSOR_POSITION_IGS_REAR           =    22, // back swing
	HWSENSOR_POSITION_IGS_FORE_SECOND    =    23, // front sub swing
	HWSENSOR_POSITION_ALS_FORE_SECOND    =    24, // front sub ALS
	HWSENSOR_POSITION_IGS_FOLDED         =    25, // front swing in folded mode
...
enum sensor_config_type
{
	...
	SEN_CONFIG_STREAM_ON,
	SEN_CONFIG_STREAM_OFF,
	SEN_CONFIG_USECASE_CONFIG,
	SEN_CONFIG_GET_UDS,
	SEN_CONFIG_GET_EFUSE_ID,
	SEN_CONFIG_EXT_VCM_POWER_ON,
	SEN_CONFIG_EXT_VCM_POWER_OFF,
...
struct sensor_stream_cfg {
	uint32_t width;
	uint32_t height;
};

struct sensor_des_port_cfg {
	uint32_t num;
	uint32_t port[DES_PORT_NUM];
};

struct sensor_uds_info {
	uint32_t uds_value;
	struct sensor_des_port_cfg des_ports;
};
...
struct sensor_cfg_data {
    ...
    union {
		...
		struct sensor_stream_cfg stream_cfg;
		struct sensor_des_port_cfg des_ports;
		struct sensor_uds_info uds_info;
