...
#include <soc_dp_monitor_interface.h>
#endif
...
enum powerstate_mode {
	WORK_TOTAL_ENERGY_MODE = 0,
	WORK_DYN_ENERGY_MODE,
	FIT_TOTAL_ENERGY_MODE,
	FIT_DYN_ENERGY_MODE,
	FIT_ICG_CNT_MODE,
	FIT_PMU_CNT_MODE,
	PWR_MODE_MAX,
...
#else
	unsigned int dpm_power_len;
	unsigned long long *total_power_table;
	int (*hi_dpm_update_power)(void);
#ifdef CONFIG_DPM_HWMON_DEBUG
	unsigned long long *dpm_counter_table;
	unsigned int dpm_cnt_len;
	unsigned long long *dyn_power_table;
#endif
#endif
#endif
#ifdef CONFIG_DPM_HWMON_DEBUG
