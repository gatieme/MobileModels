...
#ifdef CONFIG_NPU_PLATFORM_DRIVER
...
extern int cpufreq_update_policies(bool updatepolicy);
extern int gpufreq_update_policies(bool updatepolicy);
...
static inline int thermal_zone_cdev_get_power(const char *thermal_zone_name,
