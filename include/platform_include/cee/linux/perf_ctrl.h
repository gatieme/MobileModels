...
#include <platform_include/cee/linux/cpu_hwp_api.h>
...
#define PERF_CTRL_GET_TID_NAME \
	_IOR(PERF_CTRL_MAGIC, GET_TID_NAME, struct sched_tid_info)
#define PERF_CTRL_GET_CGRP_NAME \
	_IOR(PERF_CTRL_MAGIC, GET_CGRP_NAME, struct sched_tid_info)
#define PERF_CTRL_INIT_RENDER_GLO \
	_IOW(PERF_CTRL_MAGIC, INIT_RENDER_TID_GLO, struct render_init_paras_glo)
#define PERF_CTRL_GET_RENDER_RT_GLO \
	_IOWR(PERF_CTRL_MAGIC, GET_RENDER_RT_GLO, struct render_rt_glo)
#define PERF_CTRL_DESTROY_RENDER_RT_GLO \
	_IOWR(PERF_CTRL_MAGIC, DESTROY_RENDER_RT_GLO, pid_t)

#define PERF_CTRL_SET_VIP_PRIO \
	_IOW(PERF_CTRL_MAGIC, SET_VIP_PRIO, struct task_config)
#define PERF_CTRL_SET_FRAME_VIP_PRIO \
	_IOW(PERF_CTRL_MAGIC, SET_FRAME_VIP_PRIO, struct task_config)
...
#define PERF_CTRL_GET_TASK_PID \
	_IOWR(PERF_CTRL_MAGIC, GET_TASK_PID, struct task_config)
...
#define PERF_CTRL_SET_TASK_L3C_PART \
	_IOW(PERF_CTRL_MAGIC, SET_TASK_L3C_PART, struct task_config)

#define PERF_CTRL_SET_TASK_CPU_HWP \
	_IOW(PERF_CTRL_MAGIC, SET_TASK_CPU_HWP, struct cpu_hwp_cfg)

#define PERF_CTRL_GET_HVGR_GPU_FENCE \
	_IOWR(PERF_CTRL_MAGIC, GET_HVGR_GPU_FENCE, struct kmd_fence_info)
#define PERF_CTRL_GET_HVGR_GPU_BUFFER_SIZE \
	_IOR(PERF_CTRL_MAGIC, GET_HVGR_GPU_BUFFER_SIZE, unsigned int)

#define PERF_CTRL_SET_TASK_NO_SMT \
	_IOW(PERF_CTRL_MAGIC, SET_TASK_NO_SMT, struct task_config)
