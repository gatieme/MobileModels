...
#define EFUSE_KERNEL_UAPP_CONSISTENCY       0x0003001Du
#define EFUSE_KERNEL_GJROTPK_HASH           0x0003001Eu
#define EFUSE_KERNEL_GMROTPK_HASH           0x0003001Fu
#define EFUSE_KERNEL_ROTPK_HASH0            0x00030020u /* only for cc */
#define EFUSE_KERNEL_ROTPK_HASH1            0x00030021u /* only for cc */
#define EFUSE_KERNEL_PHY_CALI               0x00030022u
#define EFUSE_KERNEL_HDMI_EQ                0x00030023u
#define EFUSE_KERNEL_HDMI_RTERM             0x00030024u
#define EFUSE_KERNEL_COMBO2PCIEEDPPHY_CALI  0x00030025u
#define EFUSE_KERNEL_RXCPHY_MASK            0x00030026u
