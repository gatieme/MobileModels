...
#define MAX_GYRO_CALIBRATE_DATA_LENGTH       96
...
// num(4) + 14 samples(x,y,z,tmp) + k(x,y,z)
#define MAX_GYRO_2_0_TEMP_DATA_LENGTH       (4 + 14 * 4 * 4 + 3 * 4)
...
#define GYRO_CALIBRATE_DATA_LENGTH       24
#define PS_CALIBRATE_DATA_LENGTH         13
#define ALS_CALIBRATE_DATA_LENGTH        7
#define MAX_ACC_CALIBRATE_DATA_LENGTH    60
...
#define ACC2_CALIBRATE_DATA_LENGTH       60
#define ACC2_OFFSET_DATA_LENGTH          15
#define GYRO2_CALIBRATE_DATA_LENGTH      18
#define MAX_GYRO2_CALIBRATE_DATA_LENGTH  72

/* sensorHub send data to hal length */
#define SHB_TO_HAL_MAX_LEN 5
...
typedef enum {
	...
	DUBAI_EVENT_STS_NORMAL_TIME = 16,
	DUBAI_EVENT_AOD_INFO = 17,
	DUBAI_EVENT_ACTIVITY_RECORD = 18,
	DUBAI_EVENT_AOD_BL_INFO = 19,
	DUBAI_EVENT_POSTURE_TIME = 20,
	DUBAI_EVENT_END
} dubai_event_type_t;
...
typedef enum {
	...
	BIG_DATA_EVENT_CARCRASH_HAPPENED = 936005012,
	BIG_DATA_EVENT_CARCRASH_SUSPECTED = 936005013,
} big_data_event_id_t;
...
typedef struct {
	struct pkt_header hd;
	unsigned int subcmd;
	char calibrate_data[MAX_ACC_CALIBRATE_DATA_LENGTH];
} pkt_acc_calibrate_data_req_t;

typedef struct {
	struct pkt_header hd;
	unsigned int subcmd;
	char calibrate_data[ACC1_CALIBRATE_DATA_LENGTH];
} pkt_acc1_calibrate_data_req_t;

typedef struct {
	struct pkt_header hd;
	unsigned int subcmd;
	char calibrate_data[ACC2_CALIBRATE_DATA_LENGTH];
} pkt_acc2_calibrate_data_req_t;
...
typedef struct {
	struct pkt_header hd;
	unsigned int subcmd;
	char calibrate_data[MAX_GYRO2_CALIBRATE_DATA_LENGTH];
} pkt_gyro2_calibrate_data_req_t;
...
typedef struct {
	struct pkt_header hd;
	unsigned int sub_cmd;
	char gyro_2_0_gyro_data[MAX_GYRO_2_0_TEMP_DATA_LENGTH];
} pkt_gyro_2_0_gyro_data_req_t;
...
typedef enum {
	...
	MOTION_TYPE_POSTURE,
	MOTION_TYPE_WAVE = 22,
	MOTION_TYPE_POSTURE_IDLE,
	MOTION_TYPE_SCREEN_DOWN,
	MOTION_TYPE_BT_RANGE,
