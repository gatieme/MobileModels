...
enum obj_sub_cmd {
	...
	SUB_CMD_SHMEM_REQ,
	SUB_CMD_ENABLE_SDC_REQ, /* 16 */
	SUB_CMD_SDC_FAC_DISABLE_REQ, /* 17 */
	SUB_CMD_AG_2_0_SAVE_TEMP_DATA_REQ, // 18
	...
	SUB_CMD_MOTION_RCV_STATUS_REQ = 0x24,
	...
	SUB_CMD_RPC_GET_SLEEP_MODE_REQ,
	...
	SUB_CMD_IGS_FUSION_EN,
	SUB_CMD_IGS_FUSION_SET,
	SUB_CMD_IGS_FUSION_UPLOAD,
	SUB_CMD_IGS_FUSION_GETS,
	SUB_CMD_IGS_FUSION_SETS,
	SUB_CMD_IGS_SENSOR_SETS,
	...
	SUB_CMD_SWING_CAM_RELEASE = 0x26,
	SUB_CMD_SWING_SET_CAM_ALS,
	SUB_CMD_SWING_SET_OTP,
	...
	SUB_CMD_POSTURE_CHANGE_INTERVAL_REQ,
	SUB_CMD_POSTURE_GET_POWER_SUPPLY_TYPE,
	...
	SUB_CMD_PS_NEED_FLAG_REQ,
	SUB_CMD_PS_FULL_SCREEN_AOD,
	SUB_CMD_PS_TP_EVENT_REQ,
	...
	/* B2 */
	SUB_CMD_BLPWM_FACTORY_AT1 = 0x20,
	SUB_CMD_BLPWM_FACTORY_AT2,
	SUB_CMD_BLPWM_FACTORY_AT3,
	SUB_CMD_BLPWM_FACTORY_AT4,
	SUB_CMD_BLPWM_FACTORY_RESET,
	SUB_CMD_BLPWM_PWM,
	SUB_CMD_BLPWM_USAGE,
	SUB_CMD_BLPWM_USAGE_STOP,
	SUB_CMD_BLPWM_ADC,
	SUB_CMD_BLPWM_DARK,
	SUB_CMD_BLPWM_PSHELL,
	SUB_CMD_BLPWM_ADC_V2,
	SUB_CMD_BLPWM_GESTURE_OPEN,
	SUB_CMD_BLPWM_GESTURE_CLOSE,

	/* profile */
	SUB_CMD_PROFILE_SET_CONFIG  = 0x20,

	/* MLPS */
	SUB_CMD_MLPS_CONFIG_REQ = 0x20,

	/* CARCRASH */
	SUB_CMD_CARCRASH_CONFIG_REQ = 0x20,

	/* ORIENTATION */
	SUB_CMD_ORIENTATION_CONFIG_REQ = 0x20,
	SUB_CMD_BC_SWITCH_REQ,
