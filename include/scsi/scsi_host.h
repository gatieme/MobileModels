...
struct scsi_host_template_gear_ctrl_ops {
	int (*read_lrb_use_rate)(struct scsi_device *dev, unsigned long *lrb_use_rate);
	int (*gear_ctrl)(struct scsi_device *dev, u32 set_gear);
	int (*gear_level_get)(struct scsi_device *sdev, u32 *get_gear);
	int (*gear_level_cap_get)(struct scsi_device *sdev, u32 *min_gear, u32 *max_gear);
...
struct scsi_host_template {
...
#endif
#ifdef CONFIG_SCSI_UFS_GEAR_CTRL
	struct scsi_host_template_gear_ctrl_ops *gear_ctrl_ops;
#endif
	...
	int (*dev_data_remap)(struct scsi_device *dev,
	...
	int (*dev_slc_mode_error_inject)(struct scsi_device *dev,
...
#define SCSI_FIRMWARE_RESET	2
	...
	int (*send_request_sense_directly)(struct scsi_device *, unsigned int, bool);
#endif
#endif
