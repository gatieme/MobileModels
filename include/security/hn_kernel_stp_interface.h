 ...
 * Description: the hn_kernel_stp_interface.h for using kernel stp interface.
 * Author: jiayunlong <jiayunlong@hihonor.com>
 * Create: 2021-08-30
 */

#ifndef _HN_KERNEL_STP_INTERFACE_H_
#define _HN_KERNEL_STP_INTERFACE_H_
...
#if IS_ENABLED(CONFIG_HN_KERNEL_STP)
/*
...
#endif /* _HN_KERNEL_STP_INTERFACE_H_*/
