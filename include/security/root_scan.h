...
#else
static inline void root_scan_kcode_modify(void)
{
	return;
}
#endif
...
#else
static inline void root_scan_kcode_modify_finished(void)
{
	return;
}
#endif
...
#ifdef CONFIG_HN_ROOT_SCAN_RODATA_MEASUREMENT_API
