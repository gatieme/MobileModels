...
#include <platform_include/see/cfi_harden.h>
...
#endif
#ifdef CONFIG_DFX_BB
extern int rdr_ap_early_init(void);
#ifdef CONFIG_DFX_BB_DEBUG
extern u32 dfx_mntn_test_startkernel_panic(void);
#endif
#endif /* CONFIG_DFX_BB */
...
asmlinkage __visible void __init __no_sanitize_address start_kernel(void)
{
...
#ifdef CONFIG_DFX_BB
	(void)rdr_ap_early_init();
#ifdef CONFIG_DFX_BB_DEBUG
	(void)dfx_mntn_test_startkernel_panic();
#endif
#endif
	...
	sfi_init_late();
	kcsan_init();
	hkip_init_task_pidhash(&init_task);
...
extern void hck_dfx_kdump_register(void);
static int __ref kernel_init(void *unused)
{
	int ret;

	hck_dfx_kdump_register();
	...
	set_boot_time_keypoint(MAP_KERNEL_STAGE, END_BOOT_TIME, dfx_getcurtime() / MS_TO_NS, 0);
	set_boot_time_keypoint(MAP_ANDROID_STAGE, START_BOOT_TIME, dfx_getcurtime() / MS_TO_NS, 0);
