...
#if defined(CONFIG_HONOR_RTG) && defined(CONFIG_HONOR_RTG_PERF_CTRL)
...
#if defined(CONFIG_HONOR_RTG_NORMALIZED_UTIL) && defined(CONFIG_HONOR_RTG_PERF_CTRL)
...
#if defined(CONFIG_CLUSTER_NORMALIZED_UTIL) && defined(CONFIG_HONOR_RTG_PERF_CTRL)
int perf_ctrl_set_cluster_freq(void __user *uarg);
#else
static inline int perf_ctrl_set_cluster_freq(void __user *uarg)
{
	return -EFAULT;
}
#endif

#if defined(CONFIG_HONOR_ED_TASK) && defined(CONFIG_HONOR_RTG_PERF_CTRL)
...
#if defined(CONFIG_HONOR_RTG_FRAME) && defined(CONFIG_HONOR_RTG_PERF_CTRL)
