...
struct task_group {
	...
	ANDROID_VENDOR_DATA_ARRAY_ORG(1, 4);
#else
...
#define UCLAMP_FLAG_IDLE 0x01
	...
	/* walt_find_energy_efficient_cpu() task placement stats */
	unsigned int		tp_prev;
	unsigned int		tp_fastpath;
	unsigned int		tp_em;
	unsigned int		tp_other;
#endif
#endif
...
#ifdef CONFIG_OPT_KERNEL_MEMORY_USAGE
	ANDROID_VENDOR_DATA_ARRAY_ORG(1, 96);
	ANDROID_OEM_DATA_ARRAY_ORG(1, 16);
#else
