...
#if defined(CONFIG_HONOR_SCHED_VIP) || defined(CONFIG_HN_VIP_THREAD_BUILDIN) || \
	defined(CONFIG_SCHED_TASK_UTIL_CLAMP) || defined(CONFIG_HONOR_SCHED_STAT_YIELD) || \
	defined(CONFIG_HW_FAVOR_SMALL_CAP) || defined(CONFIG_HW_EAS_SCHED)
...
#else
#ifdef CONFIG_HN_VIP_THREAD_BUILDIN
	trace_android_rvh_honor_static_vip_set(p, cfg.value, &ret);
#endif
#endif
...
#if defined(CONFIG_HW_EAS_SCHED) || defined(CONFIG_HW_FAVOR_SMALL_CAP)
...
#ifdef CONFIG_HONOR_SCHED_STAT_YIELD
