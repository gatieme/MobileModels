...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_honor_check_task_static_vip);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_honor_static_vip_set);
#endif

#ifdef CONFIG_HN_VIP_TO_TA_BUILDIN
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_honor_check_vip_status);
#endif

#ifdef CONFIG_HN_QOS_THREAD
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_get_group_id);
#endif

#ifdef CONFIG_HONOR_RT_ACTIVE_LB
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_honor_capacity_curr_of);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_honor_capacity_of);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_honor_uclamp_task_util);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_honor_task_fits_capacity);
#endif

#ifdef CONFIG_HONOR_RTG
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_set_group_id);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_get_rtg_group_thread_num);
#ifdef CONFIG_HONOR_RTG_DEBUG
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_get_rtg_group_debug_info);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sched_get_all_rtg_groups_info);
#endif
#endif
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_hn_get_task_tags);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_hn_get_task_rsum);
#endif

#ifdef CONFIG_HONOR_RTG_KEY_LIST
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_honor_task_rename);
#endif
