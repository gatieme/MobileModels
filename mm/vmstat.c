...
const char * const vmstat_text[] = {
	...
	"kswapd_low_wmark_hit_quickly_4",
	"kswapd_low_wmark_hit_quickly_5",
	"kswapd_low_wmark_hit_quickly_6",
	"kswapd_low_wmark_hit_quickly_7",
	"kswapd_low_wmark_hit_quickly_8",
	"kswapd_low_wmark_hit_quickly_9",
	"kswapd_low_wmark_hit_quickly_10",
#endif
	...
	"kswapd_high_wmark_hit_quickly_4",
	"kswapd_high_wmark_hit_quickly_5",
	"kswapd_high_wmark_hit_quickly_6",
	"kswapd_high_wmark_hit_quickly_7",
	"kswapd_high_wmark_hit_quickly_8",
	"kswapd_high_wmark_hit_quickly_9",
	"kswapd_high_wmark_hit_quickly_10",
#endif
	"pageoutrun",
	...
	"kshrinkd_low",
	"kshrinkd_retry",
	"kshrinkd_reclaimed_anon",
	"kshrinkd_reclaimed_file",
	"kshrinkd_scan_anon",
	"kshrinkd_scan_file",
#endif
	...
	"freeze_reclaimed",
	"shrink_sys_anon",
	"shrink_sys_anon_pages",
#endif
	"mm_vip_buddy_alloc_num",
	"mm_vip_buddy_alloc_fail_num",
