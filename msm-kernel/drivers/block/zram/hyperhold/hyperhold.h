...
extern void hyperhold_decomp_fail_record(u32 index, int ext_id,
...
extern ssize_t hyperhold_enable_show(struct device *dev,
	struct device_attribute *attr, char *buf);
extern ssize_t hyperhold_key_store(struct device *dev,
	struct device_attribute *attr, const char *buf, size_t len);
extern ssize_t hyperhold_key_show(struct device *dev,
	struct device_attribute *attr, char *buf);
...
static inline void hyperhold_decomp_fail_record(u32 index, int ext_id,
					unsigned char *task_comm) {}
...
static inline ssize_t hyperhold_key_store(struct device *dev,
	struct device_attribute *attr, const char *buf, size_t len)
{
	return len;
}
static inline ssize_t hyperhold_key_show(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	return 0;
}
