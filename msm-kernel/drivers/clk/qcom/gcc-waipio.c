...
static const struct clk_parent_data gcc_parent_data_5[] = {
	{ .fw_name = "pcie_1_phy_aux_clk", .name = "pcie_1_phy_aux_clk" },
	{ .fw_name = "bi_tcxo", .name = "bi_tcxo" },
};
...
static const struct clk_parent_data gcc_parent_data_8[] = {
	{ .fw_name = "ufs_phy_rx_symbol_0_clk", .name = "ufs_phy_rx_symbol_0_clk" },
	{ .fw_name = "bi_tcxo", .name = "bi_tcxo" },
};
...
static const struct clk_parent_data gcc_parent_data_9[] = {
	{ .fw_name = "ufs_phy_rx_symbol_1_clk", .name = "ufs_phy_rx_symbol_1_clk" },
	{ .fw_name = "bi_tcxo", .name = "bi_tcxo" },
};
...
static const struct clk_parent_data gcc_parent_data_10[] = {
	{ .fw_name = "ufs_phy_tx_symbol_0_clk", .name = "ufs_phy_tx_symbol_0_clk" },
	{ .fw_name = "bi_tcxo", .name = "bi_tcxo" },
};
...
static struct clk_dummy pcie_0_pipe_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_dummy pcie_1_phy_aux_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_dummy pcie_1_pipe_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_dummy ufs_phy_rx_symbol_0_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_dummy ufs_phy_rx_symbol_1_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_dummy ufs_phy_tx_symbol_0_clk = {
	.rrate = 1000,
	.hw.init = &(struct clk_init_data){
...
static struct clk_rcg2 gcc_pcie_0_aux_clk_src = {
	...
	.clkr.vdd_data = {
		.vdd_classes = gcc_waipio_regulators,
...
static const struct freq_tbl ftbl_gcc_sdcc2_apps_clk_src_cape[] = {
	...
	F(50000000, P_GCC_GPLL0_OUT_EVEN, 6, 0, 0),
	F(100000000, P_GCC_GPLL0_OUT_EVEN, 3, 0, 0),
#if IS_ENABLED(CONFIG_FACTORY_MODE)
	F(169142857, P_GCC_GPLL9_OUT_MAIN, 3.5, 0, 0),
#else
...
static struct clk_hw *gcc_waipio_hws[] = {
	[PCIE_0_PIPE_CLK] = &pcie_0_pipe_clk.hw,
	[PCIE_1_PHY_AUX_CLK] = &pcie_1_phy_aux_clk.hw,
	...
	[USB3_PHY_WRAPPER_GCC_USB30_PIPE_CLK] = &usb3_phy_wrapper_gcc_usb30_pipe_clk.hw,
};
...
static const struct regmap_config gcc_waipio_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_waipio_desc = {
	...
	.resets = gcc_waipio_resets,
	.num_resets = ARRAY_SIZE(gcc_waipio_resets),
	.clk_regulators = gcc_waipio_regulators,
...
#if IS_ENABLED(CONFIG_FACTORY_MODE)
	gcc_sdcc2_apps_clk_src.clkr.vdd_data.rate_max[VDD_LOW_L1] = 169142857;
#else
...
static int gcc_waipio_probe(struct platform_device *pdev)
{
	...
	regmap = qcom_cc_map(pdev, &gcc_waipio_desc);
	if (IS_ERR(regmap))
...
static void gcc_waipio_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &gcc_waipio_desc);
}

static struct platform_driver gcc_waipio_driver = {
	.probe = gcc_waipio_probe,
	.driver = {
		.name = "gcc-waipio",
...
static int __init gcc_waipio_init(void)
{
	return platform_driver_register(&gcc_waipio_driver);
}
subsys_initcall(gcc_waipio_init);

static void __exit gcc_waipio_exit(void)
{
	platform_driver_unregister(&gcc_waipio_driver);
}
module_exit(gcc_waipio_exit);

MODULE_DESCRIPTION("QTI GCC WAIPIO Driver");
