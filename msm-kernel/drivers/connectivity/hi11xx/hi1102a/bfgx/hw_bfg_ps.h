...
#define UART_DMD_MAX_PKT_ERR_CNT 100

/* 02a Orlando timesync event will use it */
#define TIMESYNC_PACKET_SYS_MSG_TYPE       0xff
#define SYS_VARIABLE_LENGTH_PACKET_MAX_LEN 128
#define SYS_VARIABLE_LENGTH_PACKET_MIN_LEN 9
#define SYS_VARIABLE_PACKET_MSG_HEAD_LEN   4
...
struct ps_pm_s {
    ...
    int32 (*change_baud_rate)(uint64 baud_rate, uint8 enable_flowctl);
