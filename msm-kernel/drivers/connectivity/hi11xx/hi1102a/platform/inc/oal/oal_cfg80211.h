...
extern oal_cfg80211_bss_stru *oal_cfg80211_get_bss(oal_wiphy_stru *pst_wiphy,
                                                   oal_ieee80211_channel_stru *pst_channel,
                                                   oal_uint8 *puc_bssid,
                                                   oal_uint8 *puc_ssid,
                                                   oal_uint32 ul_ssid_len);
extern oal_void oal_cfg80211_unlink_bss(oal_wiphy_stru *pst_wiphy, oal_cfg80211_bss_stru *pst_cfg80211_bss);
...
extern oal_void oal_cfg80211_scan_done(oal_cfg80211_scan_request_stru *pst_cfg80211_scan_request, oal_int8 c_aborted);
...
#endif
extern void oal_cfg80211_link_meas_res_report(oal_net_device_stru *netdev, oal_gfp_enum_uint8 gfp,
    uint8_t *buf, uint32_t len);
extern oal_uint32 oal_cfg80211_connect_result(oal_net_device_stru *pst_net_device,
...
extern oal_uint32 oal_cfg80211_notify_cac_event(oal_net_device_stru *pst_net_device,
                                                oal_uint32 ul_freq,
                                                enum PRIV_NL80211_CHAN_WIDTH en_chan_width,
                                                enum PRIV_NL80211_RADAR_EVENT en_event,
                                                oal_gfp_enum_uint8 en_gfp);
#endif
extern oal_uint32 oal_cfg80211_disconnected(oal_net_device_stru *pst_net_device,
                                            oal_uint16 us_reason,
                                            oal_uint8 *puc_ie,
                                            oal_uint32 ul_ie_len,
                                            oal_gfp_enum_uint8 en_gfp);
extern oal_uint32 oal_cfg80211_new_sta(oal_net_device_stru *pst_net_device,
...
extern oal_void oal_cfg80211_mic_failure(oal_net_device_stru *pst_net_device,
                                         ...
                                         const oal_uint8 *tsc,
                                         oal_gfp_enum_uint8 en_gfp);
extern oal_int32 oal_cfg80211_del_sta(oal_net_device_stru *pst_net_device,
                                      const oal_uint8 *puc_mac_addr,
                                      oal_uint32 addr_len,
                                      oal_gfp_enum_uint8 en_gfp);
extern oal_uint32 oal_cfg80211_rx_mgmt(oal_net_device_stru *pst_dev,
                                       oal_int32 l_freq,
                                       oal_uint8 uc_rssi,
...
extern oal_uint32 oal_cfg80211_roamed(oal_net_device_stru *pst_net_device, struct ieee80211_channel *pst_channel,
                                      const oal_uint8 *puc_bssid,
                                      const oal_uint8 *puc_req_ie,
                                      oal_uint32 ul_req_ie_len,
                                      const oal_uint8 *puc_resp_ie,
