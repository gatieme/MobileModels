...
typedef struct _hcc_tx_assem_info_ {
    ...
    oal_uint64 pkt_cnt; /* pps count for switch */
...
typedef oal_int32 (*hcc_rx_pre_do)(struct hcc_handler *hcc, oal_uint8 stype,
                                   hcc_netbuf_stru *pst_netbuf, oal_uint8 **pre_do_context);
typedef oal_int32 (*hcc_rx_post_do)(struct hcc_handler *hcc, oal_uint8 stype,
                                    hcc_netbuf_stru *pst_netbuf, oal_uint8 *pre_do_context);
...
extern oal_int32 hcc_rx_register(struct hcc_handler *hcc, oal_uint8 mtype,
                                 hcc_rx_post_do post_do, hcc_rx_pre_do pre_do);
extern oal_int32 hcc_rx_unregister(struct hcc_handler *hcc, oal_uint8 mtype);
extern oal_void hcc_tx_wlan_queue_map_set(struct hcc_handler *hcc, hcc_queue_type hcc_queue_id,
                                          wlan_net_queue_type wlan_queue_id);
...
OAL_STATIC OAL_INLINE oal_void hi_wlan_power_set(oal_int32 on)
{
    /*
