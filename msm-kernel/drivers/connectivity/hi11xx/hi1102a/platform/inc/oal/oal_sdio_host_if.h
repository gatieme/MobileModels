...
extern struct mmc_host *g_sdio_host;
...
extern oal_void oal_sdio_get_dev_pm_state(struct oal_sdio *hi_sdio, oal_uint *pst_ul_f1, oal_uint *pst_ul_f2,
...
#else
void mmc_power_up(struct mmc_host *host, oal_uint32 ocr);
void mmc_power_off(struct mmc_host *host);
...
OAL_STATIC OAL_INLINE oal_int32 oal_mmc_power_on(struct oal_sdio *hi_sdio)
{
    ...
    oal_print_hi11xx_log(HI11XX_LOG_ERR, "no mmc_power_save_host in linux5.4");
    return -OAL_EFAIL;
#else
