...
#define OAL_UINT8_MAX 0xff
#define OAL_UINT16_MAX 0xffff
#define OAL_UINT32_MAX 0xffffffff
...
typedef enum {
    ...
    OAL_ERR_CODE_VOWIFI_SET_INVALID = (OAL_ERR_CODE_VOWIFI_BASE + 0), /* 配置参数动作无效   */
    ...
    OAL_ERR_CODE_DFS_CHAN_BLOCK_DUE_TO_RADAR = (OAL_ERR_CODE_DFS_BASE + 0), /* 信道因为检测到雷达处于不可用状态 */
...
typedef enum {
    ...
    OAL_TX_MGMT_BUTT
} oal_tx_mgmt_status_enum;
typedef oal_uint8 oal_tx_mgmt_status_enum_uint8;
