...
#define oal_all_null_ptr2(_ptr1, _ptr2)                      (((_ptr1) == NULL) && ((_ptr2) == NULL))
...
OAL_STATIC OAL_INLINE oal_void oal_del_lut_index(oal_uint8 *puc_lut_index_table, oal_uint8 uc_idx)
{
    ...
    puc_lut_index_table[uc_byte] &= (oal_uint8)(~(oal_uint8)(1 << uc_bit));
}
                                                          ...
                                                          oal_uint8 uc_idx)
{
    ...
    puc_lut_idx_status_table[uc_byte] &= (oal_uint8)(~(oal_uint8)(1 << uc_bit));
}
