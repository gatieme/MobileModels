...
typedef struct {
    ...
    oam_80211_frame_ctx_stru ast_80211_ucast_mgmt_ctx[WLAN_USER_MAX_USER_LIMIT][OAM_OTA_FRAME_DIRECTION_TYPE_BUTT]; /* 单播帧开关，不同用户开关可以不同 */
    oam_80211_frame_ctx_stru ast_80211_ucast_data_ctx[WLAN_USER_MAX_USER_LIMIT][OAM_OTA_FRAME_DIRECTION_TYPE_BUTT]; /* 单播帧开关，不同用户开关可以不同 */
...
extern oal_uint32 oam_log_set_ratelimit_param(oam_ratelimit_type_enum_uint8 en_ratelimit_type,
...
/* EVENT模块对外接口 */
extern oal_uint32 oam_event_set_switch(oal_uint8 uc_vap_id,
                                       oal_switch_enum_uint8 en_switch_type);
extern oal_uint32 oam_event_get_switch(oal_uint8 uc_vap_id,
                                       oal_switch_enum_uint8 *pen_switch_type);
extern oal_uint32 oam_event_report(oal_uint8 *puc_user_macaddr,
                                   oal_uint8 uc_vap_id,
...
extern oal_uint32 oam_report_eth_frame(oal_uint8 *puc_user_mac_addr, uint8_t mac_addr_len,
...
extern oal_uint32 oam_report_80211_frame(oal_uint8 *puc_user_macaddr, uint8_t user_macaddr_len,
...
extern oal_uint32 oam_event_set_specific_type_switch(oal_uint8 uc_vap_id,
                                                     oal_switch_enum_uint8 en_switch_type,
                                                     oam_event_type_enum_uint16 en_event_type);
