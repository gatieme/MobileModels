...
static inline int32 hisi_conn_rdr_system_error(uint32 modid, uint32 arg1, uint32 arg2)
{
    return 0;
};
...
static inline int32 hisi_conn_save_stat_info(char *buf, int32 index, int32 limit)
{
    return index;
};
