...
typedef enum {
    ...
    /* begin:CHBA */
    OAM_FILE_ID_HMAC_CHBA_COMMON_FUNCTION_C = 1237,
    OAM_FILE_ID_HMAC_CHBA_COMMON_FUNCTION_H = 1238,
    OAM_FILE_ID_HMAC_CHBA_MGMT_C = 1239,
    OAM_FILE_ID_HMAC_CHBA_MGMT_H = 1240,
    OAM_FILE_ID_HMAC_CHBA_PS_C = 1241,
    OAM_FILE_ID_HMAC_CHBA_PS_H = 1242,
    OAM_FILE_ID_HMAC_CHBA_SYNC_C = 1243,
    OAM_FILE_ID_HMAC_CHBA_SYNC_H = 1244,
    OAM_FILE_ID_HMAC_CHBA_CHAN_SWITCH_C = 1245,
    OAM_FILE_ID_HMAC_CHBA_CHAN_SWITCH_H = 1246,
    OAM_FILE_ID_HMAC_CHBA_COEX_C = 1247,
    OAM_FILE_ID_HMAC_CHBA_COEX_H = 1248,
    OAM_FILE_ID_HMAC_CHBA_USER_C = 1249,
    OAM_FILE_ID_HMAC_CHBA_USER_H = 1250,
    OAM_FILE_ID_HMAC_CHBA_FRAME_C = 1251,
    OAM_FILE_ID_HMAC_CHBA_FRAME_H = 1252,
    OAM_FILE_ID_HMAC_CHBA_INTERFACE_C = 1253,
    OAM_FILE_ID_HMAC_CHBA_INTERFACE_H = 1254,
    OAM_FILE_ID_HMAC_CHBA_FUNCTION_C = 1255,
    OAM_FILE_ID_HMAC_CHBA_FUNCTION_H = 1256,
    OAM_FILE_ID_HMAC_CHBA_FSM_C = 1257,
    OAM_FILE_ID_MAC_CHBA_COMMON_H = 1258,
    OAM_FILE_ID_HMAC_CHBA_CHANNEL_SEQUENCE_C = 1259,
    /* end:CHBA */
    ...
    OAM_FILE_ID_HMAC_CHAN_MEAS_C = 1398,
    OAM_FILE_ID_HMAC_CHAN_MEAS_H = 1399,
    ...
    OAM_FILE_ID_HMAC_DSCR_TH_OPT_C     = 1420,
    OAM_FILE_ID_HMAC_DSCR_TH_OPT_H     = 1421,
    OAM_FILE_ID_HMAC_TCP_ACK_FILTER_C  = 1422,
    OAM_FILE_ID_HMAC_TCP_ACK_FILTER_H  = 1423,

    OAM_FILE_ID_HMAC_AUTO_DDR_FREQ_C   = 1424,
    OAM_FILE_ID_HMAC_AUTO_DDR_FREQ_H   = 1425,

    OAM_FILE_ID_HMAC_TX_OPT_C          = 1426,
    OAM_FILE_ID_HMAC_TX_OPT_H          = 1427,

    OAM_FILE_ID_HMAC_SUPPORT_PMF_C          = 1428,
    OAM_FILE_ID_HMAC_SUPPORT_PMF_H          = 1429,

    OAM_FILE_ID_HMAC_WPA_WPA2_C          = 1430,
    OAM_FILE_ID_HMAC_WPA_WPA2_H          = 1431,

    OAM_FILE_ID_MAC_11KVR_C          = 1432,
    OAM_FILE_ID_MAC_11KVR_H          = 1433,

    OAM_FILE_ID_HMAC_204080_COEXIST_C          = 1434,
    OAM_FILE_ID_HMAC_204080_COEXIST_H          = 1435,

    OAM_FILE_ID_HMAC_LOCATION_RAM_C          = 1436,
    OAM_FILE_ID_HMAC_LOCATION_RAM_H          = 1437,

    OAM_FILE_ID_HMAC_SAE_C          = 1438,
    OAM_FILE_ID_HMAC_SAE_H          = 1439,
    ...
    OAM_FILE_ID_DMAC_DDC_C = 2036,
    OAM_FILE_ID_DMAC_DDC_H = 2037,
    ...
    OAM_FILE_ID_HAL_HI1102A_ATE_TEST_C = 2127,
    OAM_FILE_ID_HAL_HI1102A_ATE_TEST_H = 2128,

    /* plat */
    OAM_FILE_ID_PLAT_PM_WLAN_C = 2500,

    OAM_FILE_ID_MAC_STATISTIC_DATA_FLOW_C = 2501,
    ...
    OAM_FILE_ID_PLATFORM_COMMON_CLK_C = 2506,

    OAM_FILE_ID_PLATFORM_ONEIMAGE_DEFINE_H = 2507,

    OAM_FILE_ID_HISI_INI_C = 2508,
    ...
    OAM_FILE_ID_MAC_RESOURCE_RAM_C = 2782,
    OAM_FILE_ID_MAC_DEVICE_RAM_C = 2783,
    OAM_FILE_ID_MAC_VAP_RAM_C = 2784,
    OAM_FILE_ID_MAC_USER_RAM_C = 2785,
    OAM_FILE_ID_MAC_IE_RAM_C = 2786,
    OAM_FILE_ID_MAC_FRAME_RAM_C = 2787,
    OAM_FILE_ID_MAC_REGDOMAIN_RAM_C = 2788,

    OAM_FILE_ID_DMAC_11I_RAM_C = 2789,
    OAM_FILE_ID_DMAC_11K_RAM_C = 2790,
    OAM_FILE_ID_DMAC_11W_RAM_C = 2791,
    OAM_FILE_ID_DMAC_ACS_RAM_C = 2792,
    OAM_FILE_ID_DMAC_ALG_RAM_C = 2793,
    OAM_FILE_ID_DMAC_ARP_OFFLOAD_RAM_C = 2794,
    OAM_FILE_ID_DMAC_AUTO_ADJUST_FREQ_RAM_C = 2795,
    OAM_FILE_ID_DMAC_AUTO_CALI_RAM_C = 2796,
    OAM_FILE_ID_DMAC_BEACON_RAM_C = 2797,
    OAM_FILE_ID_DMAC_BLOCKACK_RAM_C = 2798,
    OAM_FILE_ID_DMAC_BTCOEX_RAM_C = 2799,

    OAM_FILE_ID_DMAC_CHAN_MGMT_RAM_C = 2800,
    OAM_FILE_ID_DMAC_CONFIG_DEBUG_RAM_C = 2801,
    OAM_FILE_ID_DMAC_CONFIG_RAM_C = 2802,
    OAM_FILE_ID_DMAC_DATA_ACQ_RAM_C = 2803,
    OAM_FILE_ID_DMAC_DEVICE_RAM_C = 2804,
    OAM_FILE_ID_DMAC_DFT_RAM_C = 2805,
    OAM_FILE_ID_DMAC_DFX_RAM_C = 2806,
    OAM_FILE_ID_DMAC_HCC_ADAPT_RAM_C = 2807,
    OAM_FILE_ID_DMAC_MAIN_RAM_C = 2808,

    OAM_FILE_ID_DMAC_MGMT_AP_RAM_C = 2809,
    OAM_FILE_ID_DMAC_MGMT_BSS_COMM_RAM_C = 2810,
    OAM_FILE_ID_DMAC_MGMT_STA_RAM_C = 2811,
    OAM_FILE_ID_DMAC_MGMT_CLASSIFIER_RAM_C = 2812,
    OAM_FILE_ID_DMAC_P2P_RAM_C = 2813,
    OAM_FILE_ID_DMAC_PM_STA_RAM_C = 2814,
    OAM_FILE_ID_DMAC_PSM_AP_RAM_C = 2815,
    OAM_FILE_ID_DMAC_PSM_STA_RAM_C = 2816,
    OAM_FILE_ID_DMAC_RESET_RAM_C = 2817,
    OAM_FILE_ID_DMAC_RESOURCE_RAM_C = 2818,

    OAM_FILE_ID_DMAC_RX_DATA_RAM_C = 2819,
    OAM_FILE_ID_DMAC_RX_FILTER_RAM_C = 2820,
    OAM_FILE_ID_DMAC_SCAN_RAM_C = 2821,
    OAM_FILE_ID_DMAC_STA_PM_RAM_C = 2822,
    OAM_FILE_ID_DMAC_STAT_RAM_C = 2823,
    OAM_FILE_ID_DMAC_TID_RAM_C = 2824,
    OAM_FILE_ID_DMAC_TX_BSS_COMM_RAM_C = 2825,
    OAM_FILE_ID_DMAC_TX_COMPLETE_RAM_C = 2826,
    OAM_FILE_ID_DMAC_TXOPPS_RAM_C = 2827,
    OAM_FILE_ID_DMAC_UAPSD_RAM_C = 2828,

    OAM_FILE_ID_DMAC_UAPSD_STA_RAM_C = 2829,
    OAM_FILE_ID_DMAC_USER_RAM_C = 2830,
    OAM_FILE_ID_DMAC_USER_TRACK_RAM_C = 2831,
    OAM_FILE_ID_DMAC_VAP_RAM_C = 2832,
    OAM_FILE_ID_DMAC_WEP_RAM_C = 2833,
    OAM_FILE_ID_HAL_CHIP_RAM_C = 2834,
    OAM_FILE_ID_HAL_DEVICE_RAM_C = 2835,
    OAM_FILE_ID_HAL_MAIN_RAM_C = 2836,
    OAM_FILE_ID_HAL_TO_DMAC_IF_RAM_C = 2837,
    OAM_FILE_ID_HAL_HI1102_CALI_RAM_C = 2838,

    OAM_FILE_ID_HAL_HI1102_COEX_REG_RAM_C = 2839,
    OAM_FILE_ID_HI1102_RF_CORIDC_RAM_C = 2840,
    OAM_FILE_ID_HAL_HI1102_DSCR_RAM_C = 2841,
    OAM_FILE_ID_HAL_HI1102_IRQ_RAM_C = 2842,
    OAM_FILE_ID_HAL_HI1102_MAC_RAM_C = 2843,
    OAM_FILE_ID_HAL_HI1102_PHY_RAM_C = 2844,
    OAM_FILE_ID_HAL_HI1102_PM_RAM_C = 2845,
    OAM_FILE_ID_HAL_HI1102_RESET_RAM_C = 2846,
    OAM_FILE_ID_HI1102_RF_BT_CALI_RAM_C = 2847,
    OAM_FILE_ID_HAL_HI1102_RF_RAM_C = 2848,

    OAM_FILE_ID_ALG_AUTORATE_RAM_C = 2849,
    OAM_FILE_ID_ALG_DBAC_RAM_C = 2850,
    OAM_FILE_ID_ALG_MAIN_RAM_C = 2851,
    OAM_FILE_ID_ALG_SCHEDULE_RAM_C = 2852,
    OAM_FILE_ID_ALG_SMARTANT_RAM_C = 2853,
    OAM_FILE_ID_ALG_TPC_RAM_C = 2854,
    OAM_FILE_ID_ALG_TXBF_RAM_C = 2855,
    OAM_FILE_ID_ALG_ANTI_INTERFERENCE_RAM_C = 2856,
    OAM_FILE_ID_ALG_AUTORATE_LOG_RAM_C = 2857,
    OAM_FILE_ID_ALG_CCA_OPTIMIZE_RAM_C = 2858,

    OAM_FILE_ID_ALG_EDCA_OPT_RAM_C = 2859,
    OAM_FILE_ID_ALG_MWO_DETECTION_RAM_C = 2860,
    OAM_FILE_ID_ALG_SCHEDULE_LOG_RAM_C = 2861,
    OAM_FILE_ID_ALG_TPC_LOG_RAM_C = 2862,
    OAM_FILE_ID_ALG_CCA_OPT_LOG_RAM_C = 2863,
    OAM_FILE_ID_ALG_SCHEDULE_TRAFFIC_CTL_RAM_C = 2864,

    OAM_FILE_ID_DMAC_FTM_RAM_C = 2865,
    OAM_FILE_ID_HAL_HI1102A_POWER_C = 2866,
    OAM_FILE_ID_HAL_HI1102A_POWER_H = 2867,
    OAM_FILE_ID_HAL_POWER_RAM_C = 2868,
    OAM_FILE_ID_HMAC_CUSTOMIZE = 2869,
    OAM_FILE_ID_HMAC_CUSTOM_SECURITY_C = 2870,
    OAM_FILE_ID_DMAC_APF_RAM_C = 2873,

    OAM_FILE_ID_DMAC_VOWIFI_KEEPALIVE_C = 2874,
    OAM_FILE_ID_DMAC_VOWIFI_KEEPALIVE_RAM_C = 2875,
    OAM_FILE_ID_DMAC_VOWIFI_KEEPALIVE_H = 2876,

    /* alg rom */
    OAM_FILE_ID_ALG_MAIN_ROM_C = 2900,
    OAM_FILE_ID_ALG_AUTORATE_LOG_ROM_C = 2901,
    OAM_FILE_ID_ALG_AUTORATE_ROM_C = 2902,

#ifdef _PRE_WLAN_FEATURE_QOS_ENHANCE
    OAM_FILE_ID_DMAC_TX_QOS_ENHANCE_C = 2903,
    OAM_FILE_ID_DMAC_TX_QOS_ENHANCE_H = 2904,
#endif
#ifdef _PRE_WLAN_FEATURE_APF
    OAM_FILE_ID_DMAC_APF_C = 2905,
    OAM_FILE_ID_DMAC_APF_H = 2906,
#endif
    OAM_FILE_ID_HMAC_CALI_DPD_C = 2907,
    OAM_FILE_ID_HMAC_CALI_DPD_H = 2908,
    OAM_FILE_ID_OAML_QUEUE_H = 2909,

    OAM_FILE_ID_MAC_VAP_EC_C = 2910,
    OAM_FILE_ID_MAC_IE_EC_C = 2911,
    OAM_FILE_ID_MAC_FRAME_EC_C = 2912,
    OAM_FILE_ID_COMMON_CHR_DEVS_C = 2913,
    OAM_FILE_ID_DMAC_TAS_MEASURE_RAM_C = 2914,

    OAM_FILE_ID_HMAC_FTM_C = 2915,
    OAM_FILE_ID_HMAC_FTM_H = 2916,

    OAM_FILE_ID_HMAC_MGMT_JOIN_C = 2917,
    OAM_FILE_ID_HMAC_MGMT_JOIN_H = 2918,
