...
extern oal_int32 oam_cfg_get_one_item(oal_int8 *pc_cfg_data_buf,
                                      oal_int8 *pc_section,
                                      oal_int8 *pc_key,
                                      oal_int32 *pl_val);

extern oal_int32 oam_cfg_read_file_to_buf(oal_int8 *pc_cfg_data_buf,
                                          oal_uint32 ul_file_size);

extern oal_uint32 oam_cfg_decrypt_all_item(oal_aes_key_stru *pst_aes_key,
