                                             ...
                                             oal_uint8 *output_data, oal_uint32 data_len)
{
    ...
    if (memcpy_s((oal_void *)st_event.auc_event_info, sizeof(st_event.auc_event_info),
                 (const oal_void *)output_data, data_len) != EOK) {
    ...
    if (memcpy_s((oal_void *)oal_netbuf_data(pst_netbuf), pst_netbuf->len,
                 (const oal_void *)&st_event, OAM_EVENT_STRU_SIZE) != EOK) {
        OAL_IO_PRINT("oam_event_print_to_sdt::memcpy_s failed\n");
 ...
 */
oal_uint32 oam_ota_report_to_std(oal_uint8 *puc_param_one_addr,
    ...
    switch (en_ota_type) {
        ...
        case OAM_OTA_TYPE_MEMBLOCK:
            ...
            if (memcpy_s((oal_void *)pst_ota_data->auc_ota_data,
                         (oal_uint32)(us_param_one_len + us_param_two_len),
                         (const oal_void *)puc_param_one_addr,
                         (oal_uint32)us_param_one_len) != EOK) {
                oal_mem_sdt_netbuf_free(pst_netbuf, OAL_TRUE);
                OAL_IO_PRINT("oam_ota_report_to_sdt_etc::memcpy_s failed.\n");
                return OAL_FAIL;
            }
            ...
            if (puc_param_two_addr != NULL) {
                if (memcpy_s((oal_void *)(pst_ota_data->auc_ota_data + us_param_one_len),
                    (oal_uint32)(us_param_two_len),
                    (const oal_void *)puc_param_two_addr,
                    (oal_uint32)us_param_two_len) != EOK) {
                    oal_mem_sdt_netbuf_free(pst_netbuf, OAL_TRUE);
                    OAL_IO_PRINT("oam_ota_report_to_sdt_etc::memcpy_s failed.\n");
                    return OAL_FAIL;
                }
                                                    ...
                                                    oam_ota_frame_direction_type_enum_uint8 en_frame_direction)
{
    ...
    if (memcpy_s((oal_void *)pst_ota_data->auc_ota_data,
                 ...
                 (oal_uint32)uc_mac_hdr_len) != EOK) {
        goto copy_frame_fail;
    }
    ...
    if (memcpy_s((oal_void *)(pst_ota_data->auc_ota_data + uc_mac_hdr_len),
                 ...
                 (oal_uint32)(us_mac_frame_len - uc_mac_hdr_len)) != EOK) {
        goto copy_frame_fail;
    }
 ...
 *             en_frame_direction:mac方向(tx流程还是rx流程)
 */
oal_uint32 oam_report_80211_frame(oal_uint8 *puc_user_macaddr, uint8_t user_macaddr_len,
                                  oal_uint8 *puc_mac_hdr_addr,
                                  oal_uint8 uc_mac_hdr_len,
                                  oal_uint8 *puc_mac_body_addr,
                                  oal_uint16 us_mac_frame_len,
                                             ...
                                             oam_ota_type_enum_uint8 en_ota_type)
{
    ...
    /* 复制数据,填写ota数据 */
    if (memcpy_s((oal_void *)pst_ota_data->auc_ota_data, (oal_uint32)us_dscr_len,
                 (const oal_void *)puc_dscr_addr, (oal_uint32)us_dscr_len) != EOK) {
        oal_mem_sdt_netbuf_free(pst_netbuf, OAL_TRUE);
                                               ...
                                               oam_ota_frame_direction_type_enum_uint8 en_beacon_direction)
{
    ...
    if (memcpy_s((oal_void *)pst_ota_data->auc_ota_data,
        ...
        (oal_uint32)uc_beacon_hdr_len) != EOK) {
        goto fail_beacon_copy;
    }

    if (memcpy_s((oal_void *)(pst_ota_data->auc_ota_data + uc_beacon_hdr_len),
        (oal_uint32)(us_beacon_len - uc_beacon_hdr_len),
        (const oal_void *)puc_beacon_body_addr,
        (oal_uint32)(us_beacon_len - uc_beacon_hdr_len)) != EOK) {
        goto fail_beacon_copy;
    }
                                                  ...
                                                  oam_ota_frame_direction_type_enum_uint8 en_eth_frame_direction)
{
    ...
    /* 复制数据,填写ota数据 */
    if (memcpy_s((oal_void *)pst_ota_data->auc_ota_data, (oal_uint32)us_eth_frame_len,
                 (const oal_void *)puc_eth_frame_hdr_addr, (oal_uint32)us_eth_frame_len) != EOK) {
        oal_mem_sdt_netbuf_free(pst_netbuf, OAL_TRUE);
 ...
 *             en_eth_frame_direction :来自以太网(tx流程)还是发往以太网(rx流程)
 */
oal_uint32 oam_report_eth_frame(oal_uint8 *puc_user_mac_addr, uint8_t mac_addr_len,
                                oal_uint8 *puc_eth_frame_hdr_addr,
                                oal_uint16 us_eth_frame_len,
                                oam_ota_frame_direction_type_enum_uint8 en_eth_frame_direction)
{
                                                 ...
                                                 oam_report_mpdu_num_stru *pst_mpdu_num)
{
    ...
    /* 复制数据,填写ota数据 */
    if (memcpy_s((oal_void *)pst_ota_data->auc_ota_data, OAL_SIZEOF(oam_report_mpdu_num_stru),
                 (const oal_void *)pst_mpdu_num, OAL_SIZEOF(oam_report_mpdu_num_stru)) != EOK) {
        oal_mem_sdt_netbuf_free(pst_netbuf, OAL_TRUE);
                                        ...
                                        oam_ota_type_enum_uint8 en_type)
{
    ...
    /* 复制数据,填写ota数据 */
    if (memcpy_s((oal_void *)pst_ota_data->auc_ota_data, (oal_uint32)us_param_len,
                 (const oal_void *)puc_param, (oal_uint32)us_param_len) != EOK) {
        oal_mem_sdt_netbuf_free(pst_netbuf, OAL_TRUE);
