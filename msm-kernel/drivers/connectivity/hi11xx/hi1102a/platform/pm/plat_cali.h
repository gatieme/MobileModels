...
#else
    oal_txdc_comp_val_stru txdc_cmp_val;
#endif
...
typedef struct {
    oal_uint8 rc_cmp_code;
    oal_uint8 r_cmp_code;
    oal_uint8 c_cmp_code;
    oal_bool_enum_uint8 en_save_all;
    oal_uint8 uc_chip_type_code;
    oal_bool_enum_uint8 en_cali_data_received;
    oal_uint8 resv[2];
...
typedef enum {
    ...
    BFGX_CFG_INI_BT_FRAME_END_DETECTION_SWITCH,
...
extern oal_int32 bfgx_nv_data_init(void);
