...
struct hmac_neighbor_bss_info {
    ...
    oal_uint8 uc_valid_candidate_bss;          /* 无效候选BSS */
    oal_uint8 uc_resv;
...
extern hmac_neighbor_bss_info_stru *hmac_get_target_bss_from_neighbor_list(mac_user_stru *pst_mac_user,
                                                                           oal_uint8 *puc_data,
                                                                           oal_uint16 us_len,
                                                                           oal_uint8 *puc_bss_num);
/* STA 处理AP发送的bss transition request frame */
extern oal_uint32 hmac_rx_bsst_req_action(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
