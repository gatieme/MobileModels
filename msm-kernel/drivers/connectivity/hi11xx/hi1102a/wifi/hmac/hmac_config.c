...
/*
 * 函 数 名  : hmac_vap_clear_timer
 * 功能描述  : add vap时先destroy hmac下所有存在的timer，防止timer list broken
 * 修改历史  :
 * 1.日    期  : 2019年5月27日
 *   作    者  : h00368777
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_del_vap_destroy_timer
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2019年12月11日
 *   作    者  : y00452465
 *   修改内容  : 封装函数, 添加清理ftm定时器
 */
...
/*
 * 函 数 名  : hmac_config_set_2040_coext_switch
 * 功能描述  : 0表示不允许2040M带宽切换，1表示允许
 * 修改历史  :
 * 1.日    期  : 2015年1月23日
 *   作    者  : x00456388
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_set_vowifi_nat_keep_alive_params
 * 功能描述  : 设置随机mac oui
 * 修改历史  :
 * 1.日    期  : 2016年9月7日
 *   作    者  : s00404525
...
/*
 * 函 数 名  : hmac_config_set_power_rf_ctl
 * 功能描述  : 设置功率控制模式是否为RF控
 * 修改历史  :
 * 1.日    期  : 2018年9月12日
 *   作    者  : r00356856
...
static void hmac_config_kick_all_user(hmac_vap_stru *hmac_vap, mac_cfg_kick_user_param_stru *kick_user_param)
{
    ...
    /* DTS2017021301337, 启动发送广播去关联帧，会因为ap还没有start，没有配置帧的发送参数，造成该帧的发送通道等没有填写
...
/*
 * 函 数 名  : hmac_config_always_tx_num
 * 功能描述  : 发送设置常发数目命令到dmac
 * 修改历史  :
 * 1.日    期  : 2018年8月14日
 *   作    者  : w00434750
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_rx_filter_frag
 * 功能描述  : 设置分片过滤调试命令。
 * 修改历史  :
 * 1.日    期  : 2016年2月27日
 *   作    者  : h00212953
...
/*
 * 函 数 名 : hmac_config_send_check_data
 * 功能描述 : hmac发特定广播帧
 * 修改历史 :
 * 1.日 期  : 2019年9月17日
 * 作    者   : b00484323
...
oal_void hmac_free_connect_param_resource(mac_cfg80211_connect_param_stru *pst_conn_param)
{
 ...
 /*
 * 函 数 名 : hmac_roam_start_reconnect
 * 功能描述 : 要重关联还是漫游
 * 修改历史 :
 * 1.日 期  : 2019年7月20日
 * 作    者   : b00484323
...
#endif
/*
 * 函 数 名  : hmac_connect_set_security
 * 功能描述  : hmac连接
 * 修改历史  :
 * 1.日    期  : 2015年5月5日
 *   作    者  : g00260350
                                         ...
                                         en_app_ie_type_uint8 en_type)
{
    ...
    /* DTS2018050403353  对比标杆默认不携带该IE 修改通过判断MIB值过滤掉EID 59 */
...
/*
 * 函 数 名  : hmac_config_dscr_th_opt
 * 功能描述  : 设置host侧rx描述符添加逻辑
 * 修改历史  :
 * 1.日    期  : 2019年2月16日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_tcp_ack_filter
...
/*
 * 函 数 名  : hmac_config_set_btcoex_params
 * 功能描述  : 配置共存的相关信息
 * 修改历史  :
 * 1.日    期  : 2018年11月2日
 *   作    者  : r00356856
...
oal_uint32 hmac_config_scan_abort(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (pst_hmac_vap->st_vap_base_info.en_vap_mode == WLAN_VAP_MODE_BSS_STA) {
        if (pst_hmac_vap->st_vap_base_info.en_vap_state == MAC_VAP_STATE_STA_WAIT_SCAN) {
            ...
            /* DTS2019032200540 如果处于监听状态，也需要提前置为恢复到scan comp状态，依赖dmac abort重新上报恢复vap状态会太晚，这里提前置状态保证入网 */
...
/*
 * 函数名:hmac_config_nrcoex_info_syn
 * 功能:处理device侧同步上来的nrcoex信息
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
 *   修改历史:新生成函数
...
/*
 * 函 数 名  : hmac_config_query_sta_mgmt_send_state_rsp
...
/*
 * 函 数 名  : hmac_config_query_rssi_etc
 * 功能描述  : 查询低功耗帧过滤统计
 * 修改历史  :
 * 1.日    期  : 2019年3月19日
 *   作    者  : d00469925
...
/*
 * 函 数 名  : hmac_config_query_psm_flt_stat
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2019年3月19日
 *   作    者  : d00469925
...
/*
 * 函 数 名  : hmac_config_mcs_set_check_enable
 * 功能描述  : 11n速率集check测试命令
 * 修改历史  :
 * 1.日    期  : 2018年8月3日
 *   作    者  : l00453963
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_interworking_switch
 * 功能描述  : 设置interworking开关
 * 修改历史  :
 * 1.日    期  : 2019年04月13日
 *   作    者  : y00452465
 *   修改内容  : 新生成函数
...
#endif  // _PRE_WLAN_FEATURE_HS20
/*
 * 函 数 名  : hmac_config_filter_11v_bsstreq_switch
 * 功能描述  : 设置11v bsstreq过滤开关
 * 修改历史  :
 * 1.日    期  : 2019年4月20日
 *   作    者  : l00422505
 *   修改内容  : 新生成函数
...
#endif
/*
 * 函 数 名  : hmac_config_fft_window_offset
 * 功能描述  : 配置fft window开窗位置
 * 修改历史  :
 * 1.日    期  : 2019年4月20日
 *   作    者  : l00422505
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_wfd_aggr_limit
 * 功能描述  : 同步wfd和wfd场景下聚合数量限制信息
 * 修改历史  :
 * 1.日    期  : 2019年10月30日
 *   作    者  : b00484323
 *   修改内容  : 新生成函数
...
#endif  // _PRE_WLAN_FEATURE_11R
/*
 * 函 数 名  : hmac_config_set_device_freq_enable
 * 功能描述  : 设置自动调频使能
 * 修改历史  :
 * 1.日    期  : 2015年9月16日
 *   作    者  : z00185449
...
/*
 * 函 数 名  : hmac_config_set_device_freq_value
...
/*
 * 函 数 名  : hmac_config_init_hcc_flowctrl
 * 功能描述  : 初始化hcc GPIO流控, 包括申请管脚、注册中断等
 * 修改历史  :
 * 1.日    期  : 2018年10月18日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_set_cus_priv
 * 功能描述  : 下发私有定制化
 * 修改历史  :
 * 1.日    期  : 2018年5月5日
 *   作    者  : h00368777
...
/*
 * 函 数 名  : hmac_config_set_5g_high_band_max_pow_params
 * 功能描述  : 设置5G 高band最大发送功率
 * 修改历史  :
 * 1.日    期  : 2019年3月14日
 *   作    者  : k00347307
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_set_cus_base_power_params
 * 功能描述  : 设置发送功率参数到device
 * 修改历史  :
 * 1.日    期  : 2018年8月26日
 *   作    者  : duankaiyong
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_config_set_cus_tx_power_params
 * 功能描述  : 设置发送功率参数到device
 * 修改历史  :
 * 1.日    期  : 2018年8月26日
 *   作    者  : duankaiyong
...
/*
 * 函 数 名  : hmac_set_apf_switch_by_pps
 * 功能描述  : 根据流量pps控制apf过滤是否开启
 * 修改历史  :
 * 1.日    期  : 2019年4月15日
 *   作    者  : x00456388
 *   修改内容  : 新生成函数
...
oal_uint32 hmac_config_protocol_debug_switch(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    if (pst_protocol_debug->ul_cmd_bit_map & BIT0) {
        ...
        if (en_new_40m_bandwidth == WLAN_BAND_WIDTH_20M) {
            ...
            /* DTS2017113006018: 适配配置命令，切带宽时设置shortgi能力 */
            mac_mib_set_ShortGIOptionInFortyImplemented(pst_mac_vap, OAL_FALSE);
        } else {
            ...
            /* DTS2018041610313:AP起20M，强切40M时，要使能该MIB值 */
...
/*
 * 函 数 名  : hmac_config_force_pass_filter
 * 功能描述  : 设置帧过滤开关全局变量
 * 修改历史  :
 * 1.日    期  : 2017年2月13日
 *   作    者  : wwx408792
...
/*
 * 函 数 名  : hmac_config_set_tx_ba_policy
 * 功能描述  : 配置建立聚合的条件
 * 修改历史  :
 * 1.日    期  : 2018年10月18日
 *   作    者  : r00356856
...
#ifdef _PRE_WLAN_FEATURE_NRCOEX
/*
 * 函数名:hmac_config_set_nrcoex_params
 * 功能:传递定制化下发的NRCOEX参数
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函数名:hmac_config_set_wifi_priority
 * 功能:配置WiFi优先级
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函数名:hmac_config_set_nrcoex_cmd
 * 功能:调试NRCOEX功能的命令通道
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函数名:hmac_config_get_nrcoex_info
 * 功能:获取NRCOEX相关的信息
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函 数 名  : hmac_config_set_txop_switch
 * 功能描述  : 输入参数  :
 * 修改历史  :
 * 1.日    期  : 2022年5月6日
 *   作    者  : p00562874
