                                        ...
                                        oal_uint32 ul_max_tx_unit)
{
    ...
    do {
        ...
        pst_netbuf = oal_netbuf_alloc(ul_frag_size + MAC_80211_QOS_HTC_4ADDR_FRAME_LEN,
                                      MAC_80211_QOS_HTC_4ADDR_FRAME_LEN, 4); /* 需要4字节对齐 */
...
static void hmac_defrag_get_dev_fail(hmac_user_stru *hmac_user)
{
    oam_error_log4(hmac_user->st_user_base_info.uc_vap_id, OAM_SF_ANY,
                   ...
                   hmac_user->st_user_base_info.auc_user_mac_addr[3], /* auc_user_mac_addr第3byte输出打印 */
                   hmac_user->st_user_base_info.auc_user_mac_addr[4], /* auc_user_mac_addr第4byte输出打印 */
                   hmac_user->st_user_base_info.auc_user_mac_addr[5]); /* auc_user_mac_addr第5byte输出打印 */
}
