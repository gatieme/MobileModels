...
extern oal_uint32 hmac_p2p_get_home_channel(mac_vap_stru *pst_mac_vap, oal_uint32 *pul_home_channel,
...
extern oal_uint32 hmac_config_set_p2p_miracast_status(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_uint32 hmac_check_p2p_vap_num(
    mac_device_stru *pst_mac_device, wlan_p2p_mode_enum_uint8 en_p2p_mode)
{
    return OAL_TRUE;
}
...
OAL_STATIC OAL_INLINE oal_uint32 hmac_p2p_get_home_channel(mac_vap_stru *pst_mac_vap, oal_uint32 *pul_home_channel,
                                                           wlan_channel_bandwidth_enum_uint8 *pen_home_channel_type)
{
    return OAL_SUCC;
}
