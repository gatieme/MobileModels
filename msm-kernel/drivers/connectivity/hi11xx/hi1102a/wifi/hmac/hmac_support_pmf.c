                                ...
                                oal_bool_enum_uint8 en_is_protected)
{
    ...
    mac_vap_find_user_by_macaddr(pst_mac_vap,
        ((mac_ieee80211_frame_stru *)pst_hdr)->auc_address2, WLAN_MAC_ADDR_LEN, &us_user_idx);
...
/*
 * 函 数 名 : hmac_sta_roam_update_pmf
 * 功能描述 : 漫游时根据扫描到的对端pmf能力更新本地pmf能力
 * 修改历史 :
 *  1.日    期 : 2019年4月19日
 *    作    者 : g00428180
 *    修改内容 : 新生成函数
...
/*
 * 函 数 名  : hmac_check_sa_query_trigger
 * 功能描述  : 是否符合触发SA query流程的条件
 * 修改历史  :
 * 1.日    期  : 2013年7月2日
 *   作    者  : chenwenfeng
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名 : hmac_device_pmf_find_black_list
 * 功能描述 : 在黑名单列表中查找指定的mac地址
 * 修改历史 :
 * 1.日    期 : 2019.9.16
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_device_pmf_add_black_list
 * 功能描述 : 向黑名单列表添加指定的mac地址
 * 修改历史 :
 * 1.日    期 : 2019.9.16
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_pmf_update_pmf_black_list
 * 功能描述 : 根据上层下发的连接参数判断是否需要添加pmf黑名单
 * 修改历史 :
 * 1.日    期 : 2019.9.16
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_config_set_pmf_cap
 * 功能描述 : 设置vap pmf能力并同步至device
 * 修改历史 :
 *  1.日    期 : 2019年4月19日
 *    作    者 : g00428180
 *    修改内容 : 新生成函数
