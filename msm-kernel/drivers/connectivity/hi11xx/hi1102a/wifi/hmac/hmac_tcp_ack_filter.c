 ...
 * 功能说明 : Device Tcp Ack过滤功能Host侧模块
 * 作    者 : g00428180
 * 创建日期 : 2019年3月25日
 */
...
*****************************************************************************/
/*
 * 函 数 名 : hmac_set_filter_switch_cnt
 * 功能描述 : 设置g_uc_filter_switch_cnt, 供其他模块使用
 * 修改历史 :
 * 1.日    期 : 2019年10月12日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名  : hmac_rx_tcp_ack_update_pkt
 * 功能描述  : 根据tcp ack info同步事件中的小包个数信息更新各用户的rx小包个数
 * 修改历史  :
 * 1.日    期  : 2019年3月2日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_rx_tcp_ack_update_ba
 * 功能描述  : 根据tcp ack info同步事件中的ba信息更新各用户tid的ba状态
 * 修改历史  :
 * 1.日    期  : 2019年3月2日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_tcp_ack_record_get
 * 功能描述  : 获取netbuf末尾的tcp ack record
 * 修改历史  :
 * 1.日    期  : 2019年3月22日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_rx_process_tcp_ack_record
 * 功能描述  : 处理tcp ack info同步事件, 更新host侧信息
 * 修改历史  :
 * 1.日    期  : 2019年3月2日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_sync_tcp_ack_filter_switch
 * 功能描述  : 下发tcp ack过滤功能开关
 * 修改历史  :
 * 1.日    期  : 2019年3月26日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名 : hmac_get_tcp_ack_filter_status_pps
 * 功能描述 : 判断当前pps是否满足tcp ack filter开启要求
 * 修改历史 :
 * 1.日    期 : 2020年1月7日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_get_tcp_ack_filter_status_sta
 * 功能描述 : 获取当前tcp ack filter状态
 * 修改历史 :
 * 1.日    期 : 2019年10月10日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_get_tcp_ack_filter_status_ap
 * 功能描述 : 获取当前tcp ack filter状态
 * 修改历史 :
 * 1.日    期 : 2019年12月16日
 *   作    者 : g00428180
...
/*
 * 函 数 名  : hmac_tcp_ack_filter_enable
 * 功能描述  : 根据流量信息判断当前跑流场景是否为tcp tx
 * 修改历史  :
 * 1.日    期  : 2019年3月26日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名 : hmac_tcp_ack_filter_change_state
 * 功能描述 : 判断TCP Ack过滤功能是否需要更新开关状态
 * 修改历史 :
 * 1.日    期 : 2019年9月27日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名  : hmac_rx_tcp_ack_filter_switch
 * 功能描述  : 根据当前跑流场景判断是否打开tcp ack过滤功能
 * 修改历史  :
 * 1.日    期  : 2019年3月26日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
