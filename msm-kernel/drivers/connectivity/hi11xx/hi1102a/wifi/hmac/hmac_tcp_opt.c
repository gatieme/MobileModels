...
/*
 * 函 数 名  : hmac_tcp_opt_judge_is_same_tcp_flow_info
 * 功能描述  : 此函数是判断TCP ACK帧是否是重复帧的第一步操作
 * 修改历史  :
 * 1.日    期  : 2018年10月29日
 *   作    者  : x00456388
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_tcp_opt_add_new_node
 * 功能描述  : 没有匹配到相同信息流，则需要新建节点.
 * 修改历史  :
 * 1.日    期  : 2018年10月31日
 *   作    者  : x00456388
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hmac_tcp_opt_tx_get_tcp_ack_type_index
 * 功能描述  : get tcp ack from the skb data
 * 修改历史  :
 * 1.日    期  : 2015年5月12日
 *   作    者  : z00185449
...
/*
 * 函 数 名  : hmac_tcp_ack_opt_switch_ctrol
 * 功能描述  : 根据流量Mbps 来控制 启动/关闭 TCP_ACK filter优化功能.统计时间周期100ms
 * 修改历史  :
 * 1.日    期  : 2018年7月3日
 *   作    者  : duankaiyong
 *   修改内容  : 新生成函数
