...
/* 3 函数实现 */
/*
 * 函 数 名 : hmac_set_tx_opt_switch_cnt
 * 功能描述 : 设置g_uc_opt_switch_cnt, 供其他模块使用
 * 修改历史 :
 * 1.日    期 : 2019年10月12日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_set_tx_opt_sta
 * 功能描述 : 设置AP下发至device的tx opt参数
 * 修改历史 :
 * 1.日    期 : 2020年1月2日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_set_tx_opt
 * 功能描述 : 设置下发至device的tx opt参数
 * 修改历史 :
 * 1.日    期 : 2020年1月2日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_tx_opt_change_state
 * 功能描述 : 发送性能优化状态是否改变
 * 修改历史 :
 * 1.日    期 : 2019年7月22日
 *   作    者 : g00428180
...
/*
 * 函 数 名 : hmac_tx_opt_allowed_ap
 * 功能描述 : 是否允许AP txopt相关优化
 * 修改历史 :
 * 1.日    期 : 2020年1月2日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_tx_opt_allowed_sta
 * 功能描述 : 是否允许STA txopt相关优化
 * 修改历史 :
 * 1.日    期 : 2020年1月2日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
...
/*
 * 函 数 名 : hmac_tx_opt_allowed
 * 功能描述 : 定制化是否允许txopt相关优化
 * 修改历史 :
 * 1.日    期 : 2019年7月22日
 *   作    者 : g00428180
 *   修改内容 : 新生成函数
