    ...
    oal_uint32 ul_msg_len, hmac_user_stru *pst_hmac_user_sta)
{
    ...
    if (us_info_elem_offset < ul_msg_len) {
        ...
        if (puc_ie != OAL_PTR_NULL) {
            ...
            /* DTS2017082600989:支持ht能力，但是空间流速率集为0，要置对端user为不支持ht能力，从而以11a或者11g速率关联 */
    ...
    oal_uint32 ul_msg_len, hmac_user_stru *pst_hmac_user_sta)
{
    ...
    /** DTS2018040909577 APUT根据epigram VENDOR OUI 适配2G 11AC */
...
#ifdef _PRE_WLAN_FEATURE_ROAM
/*
 * 函 数 名  : hmac_vap_check_signal_bridge
