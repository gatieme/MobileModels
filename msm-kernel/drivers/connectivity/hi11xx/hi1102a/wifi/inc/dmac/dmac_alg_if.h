...
#define DMAC_ALG_IS_DEV_INIT_DONE(_ul_chip_num, _ul_dev_num, _pst_mac_board) \
    (_pst_mac_board->ast_chip[_ul_chip_num].ast_device[_ul_dev_num].en_device_state == OAL_TRUE)
...
typedef oal_uint32 (*p_alg_cfg_channel_notify_func)(
    mac_vap_stru *pst_vap, dmac_alg_channel_bw_chg_type_uint8 en_type);
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
typedef oal_uint32 (*p_alg_cfg_start_connect_notify_func)(mac_vap_stru *pst_vap, oal_int c_rssi);
#ifdef _PRE_WLAN_FEATURE_BTCOEX
typedef oal_void (*p_alg_cfg_btcoex_state_notify_func)(
    mac_device_stru *pst_device, hal_btcoex_aggr_time_type_uint8 en_type);
#endif
#endif /* _PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE */
typedef oal_uint32 (*p_alg_cfg_bandwidth_notify_func)(
    mac_vap_stru *pst_vap, dmac_alg_channel_bw_chg_type_uint8 en_type);
...
typedef oal_uint32 (*p_alg_cfg_cca_intf_mode_notify_func)(mac_device_stru *pst_device, oal_uint8 uc_intf_mode_old,
                                                          oal_uint8 uc_intf_mode_new, oal_int8 c_cca_opt_avg_rssi_20,
                                                          oal_int8 c_cca_opt_avg_rssi_40,
                                                          oal_int8 c_cca_opt_avg_rssi_80);
#endif
...
typedef oal_uint32 (*p_alg_txmgmt_notify_func)(
    mac_vap_stru *pst_vap, mac_user_stru *pst_user, oal_netbuf_stru *pst_buf);
;
...
typedef oal_uint32 (*p_alg_nbfh_start_notify_func)(mac_vap_stru *pst_vap);
typedef oal_uint32 (*p_alg_nbfh_stop_notify_func)(mac_vap_stru *pst_vap);
typedef oal_uint32 (*p_alg_nbfh_sync_notify_func)(mac_vap_stru *pst_vap, oal_netbuf_stru *pst_netbuf);
#endif
typedef oal_uint32 (*p_alg_noa_para_change_notify_func)(dmac_vap_stru *pst_vap);
/* 调度相关回调 */
typedef oal_uint32 (*p_alg_tx_schedule_func)(
    mac_device_stru *pst_device, oal_uint8 uc_ac_num, mac_tid_schedule_output_stru *pst_sch_output);
...
/* txbf/抗干扰处理接收管理帧回调 */
typedef oal_uint32 (*p_alg_rx_mgmt_notify_func)(
    mac_vap_stru *pst_vap, mac_user_stru *pst_user, oal_netbuf_stru *pst_buf);

/* txbf处理接收控制帧回调 */
typedef oal_uint32 (*p_alg_txbf_rx_cntl_notify_func)(
    mac_vap_stru *pst_vap, mac_user_stru *pst_user, oal_netbuf_stru *pst_buf);
...
typedef oal_uint32 (*p_alg_get_rate_func)(
    mac_user_stru *pst_mac_user, oal_uint32 *pul_tx_rate, oal_uint32 *pul_rx_rate);
...
typedef oal_uint32 (*p_alg_get_best_rate_func)(
    mac_user_stru *pst_mac_user, dmac_best_rate_stat_info_stru *pst_best_rate_info);
typedef oal_uint32 (*p_alg_stop_stat_best_rate_func)(mac_user_stru *pst_mac_user);
#endif
typedef oal_uint32 (*p_alg_get_rate_by_table_func)(
    mac_user_stru *pst_mac_user, hal_rx_statistic_stru *pst_rx_stats, oal_uint32 *pul_rate_kbps);
typedef oal_uint32 (*p_alg_get_tx_best_rate_func)(
    mac_user_stru *pst_mac_user, wlan_wme_ac_type_enum_uint8 en_traffic_type, oal_uint32 *pul_rate_kbps);
...
typedef oal_uint32 (*p_alg_get_mgmt_tx_pow_notify_func)(
    mac_user_stru *pst_user, wlan_channel_band_enum_uint8 en_freq_band,
    oal_uint16 *pus_tx_pow, oal_bool_enum_uint8 en_is_presicion_shift);
...
typedef enum {
    DMAC_ALG_TX_MGMT_START = 0,
    DMAC_ALG_TX_MGMT_TXOP_OPT,
    DMAC_ALG_TX_MGMT_NOTIFY_BUTT,
} dmac_alg_txmgmt_notify_enum;
...
typedef enum {
    ...
    DMAC_ALG_NBFH_START_BUTT
} dmac_alg_nbfh_start_notify_enum;
typedef oal_uint8 dmac_alg_nbfh_start_notify_enum_uint8;

typedef enum {
    DMAC_ALG_NBFH_STOP = 0,
    DMAC_ALG_NBFH_STOP_BUTT
...
typedef enum {
    ...
    DMAC_ALG_NBFH_SYNC_BUTT
} dmac_alg_nbfh_sync_notify_enum;
...
extern oal_uint32 dmac_alg_is_registered(dmac_alg_id_enum_uint32 en_alg_id,
                                         oal_bool_enum_uint8 *pen_is_registered);
...
extern oal_uint32 dmac_alg_register_tx_complete_notify_func(
    dmac_alg_tx_complete_notify_enum_uint8 en_notify_sub_type, p_alg_tx_complete_notify_func p_func);
...
extern oal_uint32 dmac_alg_register_cfg_channel_notify_func(
    dmac_alg_cfg_channel_notify_enum_uint8 en_notify_sub_type, p_alg_cfg_channel_notify_func p_func);
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
extern oal_uint32 dmac_alg_register_cfg_start_connect_notify_func(
    dmac_alg_cfg_start_connect_notify_enum_uint8 en_notify_sub_type, p_alg_cfg_start_connect_notify_func p_func);
extern oal_uint32 dmac_alg_unregister_cfg_start_connect_notify_func(
    dmac_alg_cfg_channel_notify_enum_uint8 en_notify_sub_type);
#endif /* _PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE */
extern oal_uint32 dmac_alg_register_cfg_bandwidth_notify_func(
    dmac_alg_cfg_bandwidth_notify_enum_uint8 en_notify_sub_type, p_alg_cfg_bandwidth_notify_func p_func);
extern oal_uint32 dmac_alg_register_cfg_user_bandwidth_notify_func(
    dmac_alg_cfg_user_bandwidth_notify_enum_uint8 en_notify_sub_type, p_alg_cfg_user_bandwidth_notify_func p_func);
...
extern oal_uint32 dmac_alg_register_cfg_user_protocol_notify_func(
    dmac_alg_cfg_user_protocol_notify_enum_uint8 en_notify_sub_type, p_alg_cfg_user_protocol_notify_func p_func);
...
#ifdef _PRE_WLAN_FEATURE_DBAC
extern oal_uint32 dmac_alg_register_enqueue_tid_notify_func(
    dmac_alg_enqueue_tid_notify_enum_uint8 en_notify_sub_type, p_alg_enqueue_tid_notify_func p_func);
extern oal_uint32 dmac_alg_register_dmac_misc_event(hal_dmac_misc_sub_type_enum en_event_type,
...
extern oal_uint32 dmac_alg_register_rx_mgmt_notify_func(dmac_alg_rx_mgmt_notify_enum_uint8 en_notify_sub_type,
                                                        p_alg_rx_mgmt_notify_func p_func);
...
extern oal_uint32 dmac_alg_unregister_tx_complete_notify_func(
    dmac_alg_tx_complete_notify_enum_uint8 en_notify_sub_type);
...
extern oal_uint32 dmac_alg_unregister_cfg_channel_notify_func(
    dmac_alg_cfg_channel_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32 dmac_alg_unregister_cfg_bandwidth_notify_func(
    dmac_alg_cfg_bandwidth_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32 dmac_alg_unregister_cfg_user_spatial_stream_notify_func(
    dmac_alg_cfg_user_spatial_stream_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32 dmac_alg_unregister_cfg_user_bandwidth_notify_func(
    dmac_alg_cfg_user_bandwidth_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32 dmac_alg_unregister_cfg_user_ant_changed_notify_func(
    dmac_alg_cfg_user_ant_changed_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32 dmac_alg_unregister_cfg_user_protocol_notify_func(
    dmac_alg_cfg_user_protocol_notify_enum_uint8 en_notify_sub_type);
...
extern oal_uint32 dmac_alg_register_config_notify_func(dmac_alg_config_id_enum_uint8 en_notify_sub_type,
...
#ifdef _PRE_WLAN_FEATURE_CCA_OPT
extern oal_uint32 dmac_alg_register_cfg_cca_intf_mode_notify_func(
    dmac_alg_cfg_cca_intf_mode_notify_enum_uint8 en_notify_sub_type, p_alg_cfg_cca_intf_mode_notify_func p_func);
extern oal_uint32 dmac_alg_unregister_cfg_cca_intf_mode_notify_func(
    dmac_alg_cfg_cca_intf_mode_notify_enum_uint8 en_notify_sub_type);
...
#endif
#ifdef _PRE_WLAN_FEATURE_DBAC
extern oal_uint32 dmac_alg_unregister_enqueue_tid_notify_func(
    dmac_alg_enqueue_tid_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32 dmac_alg_unregister_dmac_misc_event(hal_dmac_misc_sub_type_enum en_event_type);
extern oal_uint32 dmac_alg_register_probe_req_rx_notify_func(
    dmac_alg_probe_req_rx_notify_enum_uint8 en_notify_sub_type, p_alg_probe_req_rx_notify_func p_func);
...
extern oal_uint32 dmac_user_get_tid_by_num(mac_user_stru *pst_mac_user, oal_uint8 uc_tid_num,
                                           dmac_tid_stru **ppst_tid_queue);
...
extern oal_uint32 dmac_user_set_vip_flag(mac_user_stru *pst_user,
...
extern oal_uint32 dmac_tid_get_mpdu_by_index(dmac_tid_stru *pst_tid_queue,
                                             oal_uint16 us_mpdu_index,
                                             oal_netbuf_stru **ppst_netbuf_stru);
extern oal_uint32 dmac_tid_get_min_max_mpdu_length(mac_user_stru *pst_mac_user,
...
extern oal_uint32 dmac_tid_get_normal_rate_stats(mac_user_stru *pst_mac_user,
                                                 oal_uint8 uc_tid_id,
                                                 dmac_tx_normal_rate_stats_stru **ppst_rate_stats_info);
extern oal_uint32 dmac_tid_set_normal_rate_stats(mac_user_stru *pst_mac_user,
                                                 oal_uint8 uc_tid_id,
                                                 dmac_tx_normal_rate_stats_stru *pst_rate_stats_info);
extern oal_uint32 dmac_alg_set_qap_wme_info(mac_vap_stru *pst_vap,
                                            wlan_wme_ac_type_enum_uint8 en_wme_type,
                                            mac_wme_param_stru *pst_wme_info);
extern oal_uint32 dmac_alg_get_qap_wme_info(mac_vap_stru *pst_vap,
                                            wlan_wme_ac_type_enum_uint8 en_wme_type,
                                            mac_wme_param_stru *pst_wme_info);

extern oal_uint32 dmac_alg_set_qap_msdu_lifetime(mac_vap_stru *pst_vap,
                                                 wlan_wme_ac_type_enum_uint8 en_wme_type,
...
extern oal_uint32 dmac_mgmt_switch_channel(mac_device_stru *pst_mac_device, mac_channel_stru *pst_channel,
                                           oal_uint8 en_clear_fifo);
...
extern oal_uint32 dmac_alg_register_start_stat_best_rate_notify(p_alg_start_stat_best_rate_func p_func);
...
extern oal_uint32 dmac_alg_register_stop_stat_best_rate_notify(p_alg_stop_stat_best_rate_func p_func);
...
extern oal_uint32 dmac_alg_get_best_rate(mac_user_stru *pst_mac_user,
...
typedef oal_uint32 (*p_alg_edca_stat_event_notify_func)(oal_uint8 uc_device_id, oal_uint8 uc_vap_id,
    oal_uint8 (*ppuc_traffic_num)[ALG_TXRX_DATA_BUTT]);
...
extern oal_uint32 dmac_alg_register_dbac_pause_notify(p_alg_dbac_pause_func p_func);
extern oal_uint32 dmac_alg_register_dbac_resume_notify(p_alg_dbac_pause_func p_func);
extern oal_uint32 dmac_alg_register_dbac_is_pause(p_alg_dbac_is_pause p_func);
...
extern oal_uint32 dmac_alg_distance_notify_hook(mac_user_stru *pst_user,
                                                dmac_alg_distance_notify_info_stru *pst_distance_info);
extern oal_uint32 dmac_alg_co_intf_notify_hook(mac_device_stru *pst_device, oal_bool_enum_uint8 en_intf_state_cur,
                                               oal_bool_enum_uint8 en_intf_state_old);
extern oal_uint32 dmac_alg_cca_intf_notify_hook(mac_device_stru *pst_device, oal_uint8 uc_intf_mode_old,
                                                oal_uint8 uc_intf_mode_new, oal_int8 c_cca_opt_avg_rssi_20,
                                                oal_int8 c_cca_opt_avg_rssi_40,
                                                oal_int8 c_cca_opt_avg_rssi_80);

extern oal_uint32 dmac_alg_dbac_noa_para_change_notify(dmac_vap_stru *pst_dmac_vap);
extern oal_uint32 dmac_alg_unregister_dbac_noa_para_change_notify(oal_void);
extern oal_uint32 dmac_alg_register_dbac_noa_para_change_notify(p_alg_noa_para_change_notify_func p_func);
...
#endif
extern oal_uint32 dmac_alg_get_user_index(mac_user_stru *pst_mac_user, oal_uint32 *pul_user_index,
                                          dmac_alg_id_enum_uint32 en_user_stru_type);
