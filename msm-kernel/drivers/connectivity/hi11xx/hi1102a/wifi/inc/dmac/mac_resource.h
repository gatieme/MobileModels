...
{
    return (oal_uint16)(g_us_max_asoc_user * MAC_RES_MAX_DEV_NUM + WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE *
            MAC_RES_MAX_DEV_NUM);
}
...
extern wlan_mib_ieee802dot11_stru *mac_res_get_mib_info(oal_uint8 uc_vap_id);
