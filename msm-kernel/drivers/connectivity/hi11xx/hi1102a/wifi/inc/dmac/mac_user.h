...
typedef struct {
    oal_uint32 bit_spectrum_mgmt : 1,    /* 频谱管理: 0=不支持, 1=支持 */
               ...
               /* 自动节能: 0=不支持, 1=支持 */
               /* 目前bit_apsd只有写没有读，wifi联盟已自己定义了WMM节能IE代替cap */
               /* apsd功能 ,此处预留为后续可能出的兼容性问题提供接口 */
               bit_apsd : 1,
...
typedef struct {
    ...
    oal_uint16 bit_ldpc_coding_cap : 1,  /* LDPC 编码 capability */
               ...
               bit_resv : 1,
               /* Indicates whether APs receiving this information or reports of this informa-tion are required
                * to prohibit 40 MHz transmissions
                */
    ...
    oal_uint32 bit_imbf_receive_cap : 1,         /* 隐式TxBf接收能力 */
               ...
               /* CSI反馈时，bfee最多支持的beamformer天线数，0=1Tx天线探测，1=2Tx天线探测，2=3Tx天线探测，3=4Tx天线探测 */
               bit_csi_bfer_ant_number : 2,
               /* 非压缩矩阵反馈时，bfee最多支持的beamformer天线数，0=1Tx天线探测，1=2Tx天线探测，2=3Tx天线探测，3=4Tx天线探测 */
               bit_noncomp_bfer_ant_number : 2,
               /* 压缩矩阵反馈时，bfee最多支持的beamformer天线数，0=1Tx天线探测，1=2Tx天线探测，2=3Tx天线探测，3=4Tx天线探测 */
...
#define MAC_11I_IS_PTK(en_macaddr_is_zero, en_pairwise) ((en_macaddr_is_zero != OAL_TRUE) && (en_pairwise == OAL_TRUE))

typedef oal_rom_cb_result_enum_uint8 (*mac_user_init_rom_cb)(mac_user_stru *pst_mac_user, oal_uint32 *pul_cb_ret);

typedef struct {
    mac_user_init_rom_cb p_user_init_cb;
} mac_user_rom_stru;
/*****************************************************************************
...
extern oal_uint32 mac_user_init(mac_user_stru *pst_mac_user,
                                oal_uint16 us_user_idx,
                                oal_uint8 *puc_mac_addr,
                                oal_uint8 uc_chip_id,
                                oal_uint8 uc_device_id,
                                oal_uint8 uc_vap_id);
extern oal_uint8 mac_user_get_ra_lut_index(oal_uint8 *puc_index_table, oal_uint16 us_start, oal_uint16 us_stop);
extern oal_uint32 mac_user_set_port(mac_user_stru *pst_mac_user, oal_bool_enum_uint8 en_port_valid);
extern oal_bool_enum_uint8 mac_user_get_port(mac_user_stru *mac_user);
...
extern oal_void mac_user_get_sta_cap_bandwidth(mac_user_stru *pst_mac_user,
                                               wlan_bw_cap_enum_uint8 *pen_bandwidth_cap);
extern oal_void mac_user_get_ap_opern_bandwidth(mac_user_stru *pst_mac_user,
                                                wlan_bw_cap_enum_uint8 *pen_bandwidth_cap);
extern oal_uint32 mac_user_update_bandwidth(mac_user_stru *pst_mac_user, wlan_bw_cap_enum_uint8 en_bwcap);

#ifdef _PRE_DEBUG_MODE_USER_TRACK
extern oal_uint32 mac_user_change_info_event(oal_uint8 auc_user_macaddr[],
                                             oal_uint8 uc_vap_id,
...
extern oal_void mac_user_set_avail_protocol_mode(mac_user_stru *pst_mac_user,
                                                 wlan_protocol_enum_uint8 en_avail_protocol_mode);
extern oal_void mac_user_set_cur_protocol_mode(mac_user_stru *pst_mac_user,
...
extern oal_void mac_user_set_avail_op_rates(mac_user_stru *pst_mac_user, oal_uint8 uc_rs_nrates,
                                            oal_uint8 *puc_rs_rates);
...
extern oal_void mac_user_set_barker_preamble_mode(mac_user_stru *pst_mac_user,
...
extern oal_void hmac_user_init_key(mac_user_stru *pst_mac_user);
extern oal_uint32 mac_user_init_key(mac_user_stru *pst_mac_user);

extern oal_void hmac_user_set_key(mac_user_stru *pst_multiuser,
...
extern oal_bool_enum_uint8 mac_addr_is_zero(oal_uint8 *puc_mac, oal_uint8 len);
#else
extern oal_bool_enum_uint8 mac_addr_is_zero(oal_uint8 *puc_mac);
#endif
extern oal_void *mac_res_get_mac_user(oal_uint16 us_idx);
extern oal_rom_cb_result_enum_uint8 mac_user_init_cb(mac_user_stru *pst_mac_user, oal_uint32 *pul_cb_ret);
