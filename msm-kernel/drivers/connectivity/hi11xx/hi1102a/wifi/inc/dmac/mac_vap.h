...
#ifdef _PRE_WLAN_FEATURE_11K
/*
 * 函 数 名  : mac_mib_set_ExplicitCSITransmitBeamformingOptionImplemented
 * 功能描述  : Indicates if this STA can apply transmit beamforming using explicit compressed beamforming feedback matrix
 * 修改历史  :
 * 1.日    期  : 2016年8月28日
 *   作    者  : lingxuemeng
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : mac_mib_get_MgmtOptionBSSTransitionActivated
 * 功能描述  : 获取MIB项 dot11MgmtOptionBSSTransitionActivated 的值
 * 修改历史  :
 * 1.日    期  : 2017年3月8日
 *   作    者  : shichongfu
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : mac_mib_set_MgmtOptionBSSTransitionActivated
 * 功能描述  : 设置MIB项 dot11MgmtOptionBSSTransitionActivated 的值
 * 修改历史  :
 * 1.日    期  : 2017年3月8日
 *   作    者  : shichongfu
 *   修改内容  : 新生成函数
