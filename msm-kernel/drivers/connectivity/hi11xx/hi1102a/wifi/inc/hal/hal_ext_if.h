...
#define HAL_CCA_OPT_GET_DEFAULT_ED_20TH(_band, _cust) \
    (((_band) == WLAN_BAND_2G) ? ((_cust)->c_delta_cca_ed_high_20th_2g + HAL_CCA_OPT_ED_HIGH_20TH_DEF) : \
    ((_cust)->c_delta_cca_ed_high_20th_5g + HAL_CCA_OPT_ED_HIGH_20TH_DEF))
#define HAL_CCA_OPT_GET_DEFAULT_ED_40TH(_band, _cust) \
    (((_band) == WLAN_BAND_2G) ? ((_cust)->c_delta_cca_ed_high_40th_2g + HAL_CCA_OPT_ED_HIGH_40TH_DEF) : \
    ((_cust)->c_delta_cca_ed_high_40th_5g + HAL_CCA_OPT_ED_HIGH_40TH_DEF))
#endif

#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
#define GET_HAL_DYN_CALI_DISABLE(_pst_handler) ((_pst_handler)->pst_hal_dev_rom->st_hal_dmac_dyn_cali.st_dyn_cali_val.aus_cali_en_interval[(_pst_handler)->st_wifi_channel_status.uc_band] == 0) /* 获取动态校准是否未使能 */
#endif
#define GET_HAL_DEVICE_WORK_STATUS(_pst_handler) ((_pst_handler)->pst_hal_dev_rom->st_hal_dev_cb.p_mac_get_work_status(_pst_handler) == OAL_TRUE) /* 获取是否工作状态 */
#define GET_HAL_DEVICE_SCAN_STATUS(_pst_handler) ((_pst_handler)->pst_hal_dev_rom->st_hal_dev_cb.p_mac_get_scan_status(_pst_handler) == OAL_TRUE) /* 获取是否工作状态 */
...
#define HAL_BTCOEX_CHECK_SW_PREEMPT_ON(_pst_handler) \
    ((((*(oal_uint8 *)&((_pst_handler)->st_btcoex_sw_preempt.st_sw_preempt_mode)) & BIT0) != 0) ? OAL_TRUE : OAL_FALSE)
#define HAL_BTCOEX_CHECK_SW_PREEMPT_DELBA_ON(_pst_handler) \
    ((((*(oal_uint8 *)&((_pst_handler)->st_btcoex_sw_preempt.st_sw_preempt_mode)) & BIT1) != 0) ? OAL_TRUE : OAL_FALSE)
#define HAL_BTCOEX_CHECK_SW_PREEMPT_REPLY_CTS_ON(_pst_handler) \
    ((((*(oal_uint8 *)&((_pst_handler)->st_btcoex_sw_preempt.st_sw_preempt_mode)) & BIT2) != 0) ? OAL_TRUE : OAL_FALSE)
#define HAL_BTCOEX_CHECK_SW_PREEMPT_RSP_FRAME_PS_ON(_pst_handler) \
    ((((*(oal_uint8 *)&((_pst_handler)->st_btcoex_sw_preempt.st_sw_preempt_mode)) & BIT3) != 0) ? OAL_TRUE : OAL_FALSE)
...
extern oal_void hal_to_hut_irq_isr_register(hal_oper_mode_enum_uint8 en_oper_mode,
                                            oal_void (*p_func)(oal_void));
extern oal_void hal_to_hut_irq_isr_unregister(oal_void);
#endif
extern oal_void hal_get_hal_to_dmac_device(oal_uint8 uc_chip_id, oal_uint8 uc_device_id,
                                           hal_to_dmac_device_stru **ppst_hal_device);
...
extern oal_uint32 hal_chip_get_device(oal_uint8 uc_chip_id, oal_uint8 uc_device_id,
                                      hal_to_dmac_device_stru **ppst_device_stru);
extern hal_cipher_protocol_type_enum_uint8 hal_cipher_suite_to_ctype(
    wlan_ciper_protocol_type_enum_uint8 en_cipher_suite);
extern wlan_ciper_protocol_type_enum_uint8 hal_ctype_to_cipher_suite(
    hal_cipher_protocol_type_enum_uint8 en_cipher_type);
/*****************************************************************************
  10.2 对外暴露的配置接口
*****************************************************************************/
/*****************************************************************************
...
/*
 * 函 数 名  : hal_free_rx_isr_list
 * 功能描述  : 释放/回收指定的接收中断信息链表
 * 修改历史  :
 * 1.日    期  : 2018年8月27日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_free_rx_isr_list(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_dlist_head_stru *pst_rx_isr_list,
                                                    oal_bool_enum_uint8 en_recycle)
{
...
OAL_STATIC OAL_INLINE oal_void hal_free_rx_isr_info(hal_to_dmac_device_stru *pst_device,
...
OAL_STATIC OAL_INLINE oal_void hal_tx_fill_basic_ctrl_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                           hal_tx_dscr_stru *p_tx_dscr, hal_tx_mpdu_stru *pst_mpdu)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_fill_basic_ctrl_dscr)(p_tx_dscr, pst_mpdu);
}

/* 将两个描述符连起来 */
OAL_STATIC OAL_INLINE oal_void hal_tx_ctrl_dscr_link(hal_to_dmac_device_stru *pst_hal_device,
                                                     hal_tx_dscr_stru *pst_tx_dscr_prev, hal_tx_dscr_stru *pst_tx_dscr)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_ctrl_dscr_link)(pst_tx_dscr_prev, pst_tx_dscr);
}

/* 从描述符的next获取下一个描述符地址 */
OAL_STATIC OAL_INLINE oal_void hal_get_tx_dscr_next(hal_to_dmac_device_stru *pst_hal_device,
                                                    hal_tx_dscr_stru *pst_tx_dscr, hal_tx_dscr_stru **ppst_tx_dscr_next)
{
    HAL_PUBLIC_HOOK_FUNC (_get_tx_dscr_next)(pst_tx_dscr, ppst_tx_dscr_next);
}

OAL_STATIC OAL_INLINE oal_void hal_tx_ctrl_dscr_unlink(hal_to_dmac_device_stru *pst_hal_device,
...
{
    HAL_PUBLIC_HOOK_FUNC(_tx_ucast_data_set_dscr)
    (pst_hal_device, pst_tx_dscr, pst_txop_feature, pst_txop_alg,
     pst_ppdu_feature);
}
...
OAL_STATIC OAL_INLINE oal_void hal_tx_non_ucast_data_set_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                              ...
                                                              hal_tx_ppdu_feature_stru *pst_ppdu_feature)
{
    HAL_PUBLIC_HOOK_FUNC(_tx_non_ucast_data_set_dscr)
    (pst_hal_device, pst_tx_dscr, pst_txop_feature,
     pst_txop_alg, pst_ppdu_feature);
}

OAL_STATIC OAL_INLINE oal_void hal_tx_ucast_data_set_dscr_rts_params(hal_to_dmac_device_stru *pst_device,
                                                                     hal_tx_dscr_stru *pst_tx_dscr)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_set_dscr_modify_mac_header_length(hal_to_dmac_device_stru *pst_hal_device,
                                                                        hal_tx_dscr_stru *pst_tx_dscr,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_set_dscr_seqno_sw_generate(hal_to_dmac_device_stru *pst_hal_device,
                                                                 hal_tx_dscr_stru *pst_tx_dscr,
...
OAL_STATIC OAL_INLINE oal_void hal_tx_get_size_dscr(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 us_msdu_num,
                                                    oal_uint32 *pul_dscr_one_size, oal_uint32 *pul_dscr_two_size)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_get_size_dscr)(us_msdu_num, pul_dscr_one_size, pul_dscr_two_size);
}

OAL_STATIC OAL_INLINE oal_void hal_tx_get_vap_id(hal_to_dmac_device_stru *pst_hal_device,
                                                 hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 *puc_vap_id)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_get_vap_id)(pst_tx_dscr, puc_vap_id);
}

OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_ctrl_one_param(hal_to_dmac_device_stru *pst_hal_device,
                                                              hal_tx_dscr_stru *pst_tx_dscr,
...
OAL_STATIC OAL_INLINE oal_void hal_get_target_tx_power_by_tx_dscr(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                  ...
                                                                  oal_int16 *ps_tx_pow)
{
    HAL_PUBLIC_HOOK_FUNC(_get_target_tx_power_by_tx_dscr)
    (pst_hal_vap, pst_hal_device, pst_tx_dscr,
     pst_pdet_info, uc_channel_idx, en_bandwidth, ps_tx_pow);
}
#ifdef _PRE_WLAN_FIT_BASED_REALTIME_CALI
OAL_STATIC OAL_INLINE oal_void hal_rf_cali_realtime_entrance(hal_to_dmac_vap_stru *OAL_CONST pst_hal_vap,
...
{
    HAL_PUBLIC_HOOK_FUNC(_rf_cali_realtime_entrance)
    (pst_hal_vap, pst_hal_device, pst_pdet_info, pst_user_pow,
     pst_base_dscr);
}
...
OAL_STATIC OAL_INLINE oal_void hal_config_set_dyn_cali_dscr_interval(hal_to_dmac_device_stru *pst_hal_device,
                                                                     wlan_channel_band_enum_uint8 uc_band,
...
OAL_STATIC OAL_INLINE oal_void hal_tx_set_pdet_en(hal_to_dmac_device_stru *pst_hal_device,
                                                  hal_tx_dscr_stru *pst_tx_dscr, oal_bool_enum_uint8 en_pdet_en_flag)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_set_pdet_en)(pst_hal_device, pst_tx_dscr, en_pdet_en_flag);
}

OAL_STATIC OAL_INLINE oal_void hal_tx_get_pdet_en(hal_to_dmac_device_stru *pst_hal_device,
                                                  hal_tx_dscr_stru *pst_tx_dscr, oal_bool_enum_uint8 *pen_pdet_en_flag)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_get_pdet_en)(pst_hal_device, pst_tx_dscr, pen_pdet_en_flag);
}

OAL_STATIC OAL_INLINE oal_uint32 hal_dyn_cali_vdet_val_amend(hal_to_dmac_device_stru *pst_hal_device,
                                                             hal_pdet_info_stru *pst_pdet_info)
{
...
/* 获取描述符里的发送带宽 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_bw_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                  hal_tx_dscr_stru *pst_dscr, wlan_bw_cap_enum_uint8 *pen_bw_mode)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_tx_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                                      hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 *puc_tx_count)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_get_dscr_tx_cnt)(pst_tx_dscr, puc_tx_count);
}
/*
 * 函 数 名  : hal_tx_dscr_get_rate0
 * 功能描述  : 获取tx描述符中rate0值
 * 修改历史  :
 * 1.日    期  : 2016年3月3日
 *   作    者  : z00273164
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_dscr_get_rate3(hal_to_dmac_device_stru *pst_hal_device,
                                                     hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 *puc_rate)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_seq_num(hal_to_dmac_device_stru *pst_hal_device,
                                                       hal_tx_dscr_stru *pst_tx_dscr, oal_uint16 *pus_seq_num)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_set_dscr_status(hal_to_dmac_device_stru *pst_hal_device,
                                                      hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 uc_status)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_set_dscr_status)(pst_tx_dscr, uc_status);
}

OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_chiper_type(hal_tx_dscr_stru *pst_tx_dscr,
                                                           oal_uint8 *puc_chiper_type, oal_uint8 *puc_chiper_key_id)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_status(hal_to_dmac_device_stru *pst_hal_device,
                                                      hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 *puc_status)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_send_rate_rank(hal_to_dmac_device_stru *pst_hal_device,
                                                              hal_tx_dscr_stru *pst_tx_dscr,
                                                              oal_uint8 *puc_send_rate_rank)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_ba_ssn(hal_to_dmac_device_stru *pst_hal_device,
                                                      hal_tx_dscr_stru *pst_tx_dscr, oal_uint16 *pus_ba_ssn)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_ba_bitmap(hal_to_dmac_device_stru *pst_hal_device,
                                                         hal_tx_dscr_stru *pst_tx_dscr, oal_uint32 *pul_ba_bitmap)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_put_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_tx_queue_type_enum_uint8 en_tx_queue_type,
                                               hal_tx_dscr_stru *past_tx_dscr)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_tx_q_status(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_status,
                                                   oal_uint8 uc_qnum)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_ampdu_len(hal_to_dmac_device_stru *pst_hal_device,
                                                    hal_tx_dscr_stru *pst_dscr, oal_uint32 *pul_ampdu_len)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_tx_get_protocol_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                        hal_tx_dscr_stru *pst_dscr, oal_uint8 *puc_protocol_mode)
{
    HAL_PUBLIC_HOOK_FUNC (_tx_get_protocol_mode)(pst_hal_device, pst_dscr, puc_protocol_mode);
}

/* 获取接收描述符大小 */
OAL_STATIC OAL_INLINE oal_void hal_rx_get_size_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 *pul_dscr_size)
{
    *pul_dscr_size = WLAN_RX_DSCR_SIZE;
}

/* 获取描述符信息 */
OAL_STATIC OAL_INLINE oal_void hal_rx_get_info_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 *pul_rx_dscr, hal_rx_ctl_stru *pst_rx_ctl,
                                                    hal_rx_status_stru *pst_rx_status,
                                                    hal_rx_statistic_stru *pst_rx_statistics)
{
    HAL_PUBLIC_HOOK_FUNC (_rx_get_info_dscr)(pul_rx_dscr, pst_rx_ctl, pst_rx_status, pst_rx_statistics);
}

OAL_STATIC OAL_INLINE oal_void hal_get_hal_vap(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_vap_id,
                                               hal_to_dmac_vap_stru **ppst_hal_vap)
{
    HAL_PUBLIC_HOOK_FUNC (_get_hal_vap)(pst_hal_device, uc_vap_id, ppst_hal_vap);
}

OAL_STATIC OAL_INLINE oal_void hal_rx_get_netbuffer_addr_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                              oal_uint32 *pul_rx_dscr,
                                                              oal_netbuf_stru **ppul_mac_hdr_addr)
{
    HAL_PUBLIC_HOOK_FUNC (_rx_get_netbuffer_addr_dscr)(pul_rx_dscr, ppul_mac_hdr_addr);
}

OAL_STATIC OAL_INLINE oal_void hal_rx_show_dscr_queue_info(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_rx_sync_invalid_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint32 *pul_dscr, oal_uint8 en_queue_num)
{
    HAL_PUBLIC_HOOK_FUNC (_rx_sync_invalid_dscr)(pst_hal_device, pul_dscr, en_queue_num);
}
#ifndef _PRE_LINUX_TEST
OAL_STATIC OAL_INLINE oal_void hal_rx_free_dscr_list(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reg_write(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_addr,
                                             oal_uint32 ul_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reg_write16(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_addr,
                                               oal_uint16 us_val)
{
#if defined(_PRE_PRODUCT_ID_HI110X_DEV)
...
/*
 * 函 数 名  : hal_set_sample_memory
 * 功能描述  : 准备数采所需内存，并设置相关寄存器
 * 修改历史  :
 * 1.日    期  : 2016年7月28日
 *   作    者  : dwx371754
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sample_memory(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 **ppul_addr, oal_uint32 *pul_reg_num)
{
#if defined(_PRE_PRODUCT_ID_HI110X_DEV)
...
/*
 * 函 数 名  : hal_set_pktmem_bus_access
 * 功能描述  : 释放数采申请的netbuf
 * 修改历史  :
 * 1.日    期  : 2016年7月28日
 *   作    者  : dwx371754
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_sample_state(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint16 *pus_reg_val)
{
#if defined(_PRE_PRODUCT_ID_HI110X_DEV)
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_machw_rx_buff_addr(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_uint32 hal_set_machw_rx_buff_addr_sync(hal_to_dmac_device_stru *pst_hal_device,
                                                                 oal_uint32 ul_rx_dscr,
                                                                 hal_rx_dscr_queue_id_enum_uint8 en_queue_num)
{
...
OAL_STATIC OAL_INLINE oal_void hal_get_pwr_comp_val(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 ul_tx_ratio, oal_int16 *ps_pwr_comp_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_rx_add_dscr(hal_to_dmac_device_stru *pst_hal_device,
...
/*
 * 函 数 名  : hal_flush_tx_complete_irq
 * 功能描述  : 清空tx完成中断
 * 修改历史  :
 * 1.日    期  : 2018年9月10日
 *   作    者  : l00422505
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reset_phy_machw(hal_to_dmac_device_stru *pst_hal_device,
                                                   hal_reset_hw_type_enum_uint8 en_type,
                                                   oal_uint8 sub_mod, oal_uint8 uc_reset_phy_reg,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_freq_band(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_bandwidth_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                      wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_primary_channel(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint8 uc_channel_num,
                                                       oal_uint8 uc_band,
                                                       oal_uint8 uc_channel_idx,
                                                       wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
    HAL_PUBLIC_HOOK_FUNC(_set_primary_channel)
    (pst_hal_device, uc_channel_num, uc_band, uc_channel_idx,
     en_bandwidth);
}
...
OAL_STATIC OAL_INLINE oal_void hal_add_machw_ba_lut_entry(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint8 uc_lut_index, oal_uint8 *puc_dst_addr,
                                                          oal_uint8 uc_tid,
                                                          oal_uint16 uc_seq_no, oal_uint8 uc_win_size)
{
    HAL_PUBLIC_HOOK_FUNC(_add_machw_ba_lut_entry)
    (pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_remove_machw_ba_lut_entry(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_machw_ba_params(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint8 uc_index,
                                                       oal_uint32 *pst_addr_h, oal_uint32 *pst_addr_l,
                                                       oal_uint32 *pst_ba_para)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_restore_machw_ba_params(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint8 uc_index,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint8 uc_lut_index, oal_uint8 uc_tid, oal_uint8 uc_qos_flag,
                                                       oal_uint32 ul_val_write)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_tx_sequence_num(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint8 uc_lut_index, oal_uint8 uc_tid,
                                                       oal_uint8 uc_qos_flag, oal_uint16 *pus_val_read)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reset_reg_restore(hal_to_dmac_device_stru *pst_hal_device,
                                                     hal_reset_hw_type_enum_uint8 en_type)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reset_reg_save(hal_to_dmac_device_stru *pst_hal_device,
                                                  hal_reset_hw_type_enum_uint8 en_type)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reset_reg_dma_save(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint8 *pucdmach0, oal_uint8 *pucdmach1, oal_uint8 *pucdmach2)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reset_reg_dma_restore(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint8 *pucdmach0, oal_uint8 *pucdmach1,
                                                         oal_uint8 *pucdmach2)
{
...
*****************************************************************************/
/*
 * 函 数 名  : hal_phy_update_scaling_reg
 * 功能描述  : 输入参数  : 无
 * 修改历史  :
 * 1.日    期  : 2018年4月16日
 *   作    者  : h00368777
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_radar_config_reg(hal_to_dmac_device_stru *pst_hal_device,
...
/*
 * 函 数 名  : hal_rf_get_line_control_value
 * 功能描述  : 获取线控状态的值
 * 修改历史  :
 * 1.日    期  : 2019年3月25日
 *   作    者  : r00356856
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_rf_get_line_control_value(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_mac_int_status(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_clear_mac_int_status(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_mac_error_int_status(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_clear_mac_error_int_status(hal_to_dmac_device_stru *pst_hal_device,
...
/* ERROR IRQ中断寄存器相关操作 */
OAL_STATIC OAL_INLINE oal_void hal_unmask_mac_error_init_status(hal_to_dmac_device_stru *pst_hal_device,
                                                                hal_error_state_stru *pst_status)
{
...
/* mac中断寄存器相关操作 */
OAL_STATIC OAL_INLINE oal_void hal_unmask_mac_init_status(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint32 ul_status)
{
...
OAL_STATIC OAL_INLINE oal_void hal_cali_send_func(oal_uint8 *puc_cal_data_write, oal_uint16 us_frame_len,
...
OAL_STATIC OAL_INLINE oal_void hal_cali_matrix_data_send_func(oal_uint8 *puc_cal_data_write,
                                                              oal_uint16 us_frame_len, oal_uint16 us_remain)
{
#if defined(_PRE_PRODUCT_ID_HI110X_DEV)
 ...
 */
OAL_STATIC OAL_INLINE oal_void hal_get_vap(hal_to_dmac_device_stru *pst_hal_device,
                                           wlan_vap_mode_enum_uint8 vap_mode, oal_uint8 vap_id,
                                           hal_to_dmac_vap_stru **ppst_hal_vap)
{
 ...
 */
OAL_STATIC OAL_INLINE oal_void hal_add_vap(hal_to_dmac_device_stru *pst_hal_device,
                                           wlan_vap_mode_enum_uint8 vap_mode, oal_uint8 uc_mac_vap_id,
                                           hal_to_dmac_vap_stru **ppst_hal_vap)
{
 ...
 */
OAL_STATIC OAL_INLINE oal_void hal_del_vap(hal_to_dmac_device_stru *pst_hal_device,
                                           wlan_vap_mode_enum_uint8 vap_mode, oal_uint8 vap_id)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_config_eifs_time(hal_to_dmac_device_stru *pst_hal_device,
...
/*
 * 函 数 名  : hal_register_gap_isr_hook
 * 功能描述  : 注册green ap中断上半部钩子函数
 * 修改历史  :
 * 1.日    期  : 2016年2月28日
 *   作    者  : zourong
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hal_unregister_gap_isr_hook
 * 功能描述  : 注销green ap中断上半部钩子函数
 * 修改历史  :
 * 1.日    期  : 2016年2月28日
 *   作    者  : zourong
 *   修改内容  : 新生成函数
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_one_packet_start(struct tag_hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_one_packet_get_status(struct tag_hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_mask_interrupt(struct tag_hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_unmask_interrupt(struct tag_hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 ul_offset)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_reg_info(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_addr,
                                            oal_uint32 *pul_val)
{
    HAL_PUBLIC_HOOK_FUNC (_reg_info)(pst_hal_device, ul_addr, pul_val);
}

OAL_STATIC OAL_INLINE oal_void hal_reg_info16(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_addr,
                                              oal_uint16 *pus_val)
{
#if defined(_PRE_PRODUCT_ID_HI110X_DEV)
...
OAL_STATIC OAL_INLINE oal_void hal_get_all_tx_q_status(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 *pul_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ampdu_bytes(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint32 *pul_tx_bytes, oal_uint32 *pul_rx_bytes)
{
...
OAL_STATIC OAL_INLINE oal_void hal_get_rx_err_count(hal_to_dmac_device_stru *pst_hal_device,
                                                    ...
                                                    oal_uint32 *pul_cnt6)
{
    HAL_PUBLIC_HOOK_FUNC(_get_rx_err_count)
    (pst_hal_device, pul_cnt1, pul_cnt2, pul_cnt3, pul_cnt4, pul_cnt5,
     pul_cnt6);
}
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_mac_error_msg_report(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_ce_add_key(hal_to_dmac_device_stru *pst_hal_device,
                                              hal_security_key_stru *pst_security_key, oal_uint8 *puc_addr)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_ce_del_key(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_ce_add_peer_macaddr(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint8 uc_lut_idx, oal_uint8 *puc_addr)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_ce_del_peer_macaddr(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_rx_pn(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_pn_lut_cfg_stru *pst_pn_lut_cfg)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_rx_pn(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_pn_lut_cfg_stru *pst_pn_lut_cfg)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_tx_pn(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_pn_lut_cfg_stru *pst_pn_lut_cfg)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_tx_pn(hal_to_dmac_device_stru *pst_hal_device,
                                             hal_pn_lut_cfg_stru *pst_pn_lut_cfg)
{
    HAL_PUBLIC_HOOK_FUNC (_get_tx_pn)(pst_hal_device, pst_pn_lut_cfg);
}

OAL_STATIC OAL_INLINE oal_void hal_dscr_set_iv_value(hal_tx_dscr_stru *pst_tx_dscr, oal_uint32 ul_iv_ls_word,
                                                     oal_uint32 ul_iv_ms_word)
{
    HAL_PUBLIC_HOOK_FUNC (_dscr_set_iv_value)(pst_tx_dscr, ul_iv_ls_word, ul_iv_ms_word);
}

OAL_STATIC OAL_INLINE oal_void hal_dscr_set_tx_pn_hw_bypass(hal_tx_dscr_stru *pst_tx_dscr,
                                                            oal_bool_enum_uint8 en_bypass)
{
    HAL_PUBLIC_HOOK_FUNC (_dscr_set_tx_pn_hw_bypass)(pst_tx_dscr, en_bypass);
}

OAL_STATIC OAL_INLINE oal_void hal_dscr_get_tx_pn_hw_bypass(hal_tx_dscr_stru *pst_tx_dscr,
                                                            oal_bool_enum_uint8 *pen_bypass)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_rate_80211g_table(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_void **pst_rate)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_rate_80211g_num(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 *pst_data_num)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ch_statics_period(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ch_measurement_period(hal_to_dmac_device_stru *pst_hal_device,
                                                             oal_uint8 uc_period)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ch_statics_result(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ch_measurement_result(hal_to_dmac_device_stru *pst_hal_device,
                                                             hal_ch_statics_irq_event_stru *pst_ch_statics)
{
}
OAL_STATIC OAL_INLINE oal_void hal_get_ch_measurement_result_ram(hal_to_dmac_device_stru *pst_hal_device,
                                                                 hal_ch_statics_irq_event_stru *pst_ch_statics)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_improve_ce_threshold(hal_to_dmac_device_stru *pst_hal_device,
                                                            oal_uint32 ul_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_radar_det_result(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_rts_rate_params(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_rts_rate_selection_mode(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_set_tpc_delay_reg_param(hal_to_dmac_device_stru *pst_hal_device,
                                                           ...
                                                           oal_uint32 ul_rf_reg_wr_delay1,
                                                           oal_uint32 ul_rf_reg_wr_delay2)
{
    HAL_PUBLIC_HOOK_FUNC(_set_tpc_delay_reg_param)
    (pst_hal_device, ul_phy_tx_up_down_time_reg,
...
OAL_STATIC OAL_INLINE oal_void hal_get_tpc_delay_reg_param(hal_to_dmac_device_stru *pst_hal_device,
                                                           ...
                                                           oal_uint32 *pul_rf_reg_wr_delay1,
                                                           oal_uint32 *pul_rf_reg_wr_delay2)
{
    HAL_PUBLIC_HOOK_FUNC(_get_tpc_delay_reg_param)
    (pst_hal_device, pul_phy_tx_up_down_time_reg,
...
OAL_STATIC OAL_INLINE oal_void hal_get_tpc_rf_reg_param(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint16 *pus_dac_val, oal_uint16 *pus_pa_val,
                                                        oal_uint16 *pus_lpf_val,
                                                        oal_uint16 *paus_2g_upc_val, oal_uint16 *paus_5g_upc_val,
                                                        oal_uint8 uc_chain_idx)
{
    HAL_PUBLIC_HOOK_FUNC(_get_tpc_rf_reg_param)
    (pst_hal_device, pus_dac_val, pus_pa_val, pus_lpf_val, paus_2g_upc_val, paus_5g_upc_val, uc_chain_idx);
}
...
OAL_STATIC OAL_INLINE oal_void hal_set_tpc_rf_reg_param(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint16 us_dac_val, oal_uint16 us_pa_val,
                                                        oal_uint16 us_lpf_val,
                                                        oal_uint16 *paus_2g_upc_val, oal_uint16 *paus_5g_upc_val,
                                                        oal_uint8 uc_chain_idx)
{
    HAL_PUBLIC_HOOK_FUNC(_set_tpc_rf_reg_param)
    (pst_hal_device, us_dac_val, us_pa_val, us_lpf_val, paus_2g_upc_val, paus_5g_upc_val, uc_chain_idx);
}
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_dpd_by_power(hal_tx_txop_rate_params_stru *pst_rate,
                                                    oal_uint8 uc_power_level, oal_uint32 ul_dpd_configure,
                                                    oal_uint32 ul_rate_idx)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_tpc_ctrl_reg_param(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_set_dac_lpc_pa_upc_level(oal_uint8 uc_dac_lpf_code,
                                                            ...
                                                            oal_uint8 *pauc_dac_lpf_pa_code_table,
                                                            oal_int16 *pas_upc_gain_table,
                                                            oal_int16 *pas_other_gain_table,
                                                            wlan_channel_band_enum_uint8 en_freq_band)
{
    HAL_PUBLIC_HOOK_FUNC(_set_dac_lpc_pa_upc_level)
    (uc_dac_lpf_code, pac_tpc_level_table,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_subband_index(wlan_channel_band_enum_uint8 en_band,
                                                     oal_uint8 uc_channel_num, oal_uint8 *puc_subband_idx)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_upc_data(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_band,
...
/*
 * 函 数 名  : hal_get_pow_index
 * 功能描述  : 根据发送描述符获取发送功率的index
 * 修改历史  :
 * 1.日    期  : 2018年8月24日
 *   作    者  : r00356856
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_pow_index(hal_user_pow_info_stru *pst_user_power_info,
...
/*
 * 函 数 名  : hal_set_band_spec_frame_tx_power
 * 功能描述  : 设置该band下特殊帧的发送功率
 * 修改历史  :
 * 1.日    期  : 2018年8月24日
 *   作    者  : r00356856
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_band_spec_frame_tx_power(hal_to_dmac_device_stru *pst_hal_device,
                                                                wlan_channel_band_enum_uint8 en_band,
                                                                oal_uint8 uc_chan_num,
                                                                hal_rate_tpc_code_gain_table_stru *pst_rate_tpc_table,
                                                                oal_uint8 uc_pow_level_idx)
{
    HAL_PUBLIC_HOOK_FUNC(_set_band_spec_frame_tx_power)
    (pst_hal_device, en_band, uc_chan_num, pst_rate_tpc_table,
     uc_pow_level_idx);
}

/*
 * 函 数 名  : hal_pow_updata_upc_code
 * 功能描述  : 更新UPC_CODE
 * 修改历史  :
 * 1.日    期  : 2018年8月27日
 *   作    者  : r00356856
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_pow_update_upc_code(hal_to_dmac_vap_stru *pst_hal_vap,
                                                       hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_pow_update_p2p_upc(hal_to_dmac_device_stru *pst_hal_device,
                                                      wlan_channel_band_enum_uint8 en_freq_band,
                                                      oal_uint8 uc_ch_num,
                                                      wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
...
/*
 * 函 数 名  : hal_pow_set_rf_regctl_enable
 * 功能描述  : 配置功率是否为RF控
 * 修改历史  :
 * 1.日    期  : 2018年8月24日
 *   作    者  : r00356856
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_pow_set_rf_regctl_enable(hal_to_dmac_device_stru *pst_hal_dev,
                                                            oal_bool_enum_uint8 en_rf_regctl)
{
    HAL_PUBLIC_HOOK_FUNC (_pow_set_rf_regctl_enable)(pst_hal_dev, en_rf_regctl);
}
/*
 * 函 数 名  : hal_pow_init_tx_power
 * 功能描述  : 初始化发射功率相关参数
 * 修改历史  :
 * 1.日    期  : 2018年8月24日
 *   作    者  : r00356856
...
OAL_STATIC OAL_INLINE oal_void hal_pow_get_rf_dev_base_power(hal_to_dmac_device_stru *pst_hal_device,
                                                             wlan_channel_band_enum_uint8 en_freq_band,
                                                             oal_uint8 *puc_base_power,
                                                             oal_uint8 uc_subband_idx)
{
    HAL_PUBLIC_HOOK_FUNC(_pow_get_rf_dev_base_power)
    (pst_hal_device, en_freq_band, puc_base_power,
     uc_subband_idx);
}

OAL_STATIC OAL_INLINE oal_void hal_get_rate_limit_tx_power(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint8 uc_rate_idx,
                                                           oal_uint8 uc_base_pow,
                                                           wlan_channel_band_enum_uint8 en_freq_band,
                                                           oal_uint8 *puc_rate_txpwr_limit)
{
    HAL_PUBLIC_HOOK_FUNC(_get_rate_limit_tx_power)
    (pst_hal_device, uc_rate_idx, uc_base_pow, en_freq_band,
     puc_rate_txpwr_limit);
}

OAL_STATIC OAL_INLINE oal_uint32 hal_get_center_freq_chan_num(oal_uint8 uc_chan_number,
                                                              wlan_channel_bandwidth_enum_uint8 en_bandwidth,
                                                              oal_uint8 *puc_center_freq_chn)
{
    return HAL_PUBLIC_HOOK_FUNC (_get_center_freq_chan_num)(uc_chan_number, en_bandwidth, puc_center_freq_chn);
}
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_peer_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 auc_mac_addr[], oal_uint8 uc_lut_index)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_legacy_matrix_buf_pointer(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_legacy_matrix_buf_pointer(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sta_membership_status_63_32(hal_to_dmac_device_stru *pst_hal_device,
                                                                   oal_uint32 ul_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sta_membership_status_31_0(hal_to_dmac_device_stru *pst_hal_device,
                                                                  oal_uint32 ul_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sta_user_p_63_48(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint32 ul_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sta_user_p_47_32(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint32 ul_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sta_user_p_31_16(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint32 ul_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sta_user_p_15_0(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 ul_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_vht_report_phy_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint32 ul_phy_mode)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ndp_phy_mode(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 ul_phy_mode)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ndpa_duration(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 ul_ndpa_duration)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ndp_group_id(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint32 ul_group_id)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ndp_partial_aid(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint16 us_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_phy_legacy_bf_en(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_phy_txbf_legacy_en(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint32 ul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_phy_pilot_bf_en(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 ul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ht_buffer_num(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 ul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ht_buffer_step(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ht_buffer_pointer(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 ul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_h_matrix_timeout(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint32 ul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_mu_aid_matrix_info(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint16 us_aid,
                                                          oal_uint8 *p_matrix)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_delete_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint8 uc_lut_index)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_lut_index, oal_uint16 ul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_txbf_lut_info(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_lut_index, oal_uint32 *pst_reg_value)
{
    HAL_PUBLIC_HOOK_FUNC (_get_txbf_lut_info)(pst_hal_device, uc_lut_index, pst_reg_value);
}
#endif

OAL_STATIC OAL_INLINE oal_void hal_enable_smart_antenna_gpio_set_default_antenna(
    hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value)
{
    HAL_PUBLIC_HOOK_FUNC (_enable_smart_antenna_gpio_set_default_antenna)(pst_hal_device, ul_reg_value);
}

OAL_STATIC OAL_INLINE oal_void hal_delete_smart_antenna_value(hal_to_dmac_device_stru *pst_hal_device,
                                                              oal_uint8 uc_lut_index)
{
    HAL_PUBLIC_HOOK_FUNC (_delete_smart_antenna_value)(pst_hal_device, uc_lut_index);
}

OAL_STATIC OAL_INLINE oal_void hal_set_smart_antenna_value(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint8 uc_lut_index, oal_uint16 ul_reg_value)
{
    HAL_PUBLIC_HOOK_FUNC (_set_smart_antenna_value)(pst_hal_device, uc_lut_index, ul_reg_value);
}

OAL_STATIC OAL_INLINE oal_void hal_get_smart_antenna_value(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint8 uc_lut_index, oal_uint32 *pst_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_weak_intf_rssi_th(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_int32 l_reg_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_agc_unlock_min_th(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_int32 l_tx_reg_val, oal_int32 l_rx_reg_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_nav_max_duration(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint16 us_bss_dur, oal_uint16 us_obss_dur)
{
...
OAL_STATIC OAL_INLINE oal_void hal_set_counter1_clear_ram(hal_to_dmac_device_stru *pst_hal_device)
{
    HAL_PUBLIC_HOOK_FUNC (_set_counter1_clear_ram)(pst_hal_device);
}
/*
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_txrx_frame_time(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_mac_clken(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_bool_enum_uint8 en_wctrl_enable)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_mac_statistics_data(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ed_high_th(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_int8 *l_ed_high_reg_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ed_high_th(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_int32 l_ed_high_20_reg_val, oal_int32 l_ed_high_40_reg_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_enable_sync_error_counter(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_sync_error_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint32 *ul_reg_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_soc_lpm(hal_to_dmac_device_stru *pst_hal_device,
                                               hal_lpm_soc_set_enum_uint8 en_type, oal_uint8 uc_on_off,
...
{
    HAL_PUBLIC_HOOK_FUNC(_set_psm_dtim_period)
    (pst_hal_vap, uc_dtim_period, uc_listen_intvl_to_dtim_times,
     en_receive_dtim);
}
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_txop_ps_condition1(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint8 uc_on_off)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_txop_ps_condition2(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint8 uc_on_off)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_txop_ps_partial_aid(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_wow_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_set_bitmap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_lpm_state(hal_to_dmac_device_stru *pst_hal_device,
                                                 hal_lpm_state_enum_uint8 uc_state_from,
                                                 hal_lpm_state_enum_uint8 uc_state_to, oal_void *pst_para,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_coex_ctrl(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_mac_ctrl,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_hw_version(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_hw_vsn,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_tx_dscr_field(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_data,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_rf_test_enable_al_tx(hal_to_dmac_device_stru *pst_hal_device,
                                                        hal_tx_dscr_stru *pst_tx_dscr)
{
...
/*
 * 函 数 名  : hal_al_tx_set_agc_phy_reg
 * 功能描述  : 常发设置AGC门限寄存器
 * 修改历史  :
 * 1.日    期  : 2015年12月31日
 *   作    者  : f00290085
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_al_tx_set_agc_phy_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 ul_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_rf_set_freq_skew(hal_to_dmac_device_stru *pst_hal_device, oal_uint16 us_idx,
                                                    oal_uint16 us_chn, oal_int16 as_corr_data[])
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_daq_mac_reg(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pul_addr,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_daq_phy_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint32 ul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_daq_status(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint32 *pul_reg_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_beacon_timeout_val(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint16 us_value)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_rx_filter(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_rx_filter(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_tsf_get_64bit(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint32 *pul_tsf_hi,
                                                     oal_uint32 *pul_tsf_lo)
{
    HAL_PUBLIC_HOOK_FUNC (_vap_tsf_get_64bit)(pst_hal_vap, pul_tsf_hi, pul_tsf_lo);
}
OAL_STATIC OAL_INLINE oal_void hal_vap_tsf_set_64bit(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint32 ul_tsf_hi,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_machw_prot_params(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_opmode(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_clr_opmode(hal_to_dmac_vap_stru *pst_hal_vap,
                                                  wlan_vap_mode_enum_uint8 en_vap_mode)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_machw_aifsn_all_ac(hal_to_dmac_vap_stru *pst_hal_vap,
                                                              oal_uint8 uc_bk,
                                                              oal_uint8 uc_be,
                                                              oal_uint8 uc_vi,
                                                              oal_uint8 uc_vo)
...
OAL_STATIC OAL_INLINE oal_void hal_vap_set_edca_machw_cw_wfa(hal_to_dmac_vap_stru *pst_hal_vap,
                                                             oal_uint8 uc_cwmaxmin, oal_uint8 uc_ec_type,
                                                             wlan_wme_ac_type_enum_uint8 en_wfa_lock)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_edca_machw_cw(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 uc_cwmax,
                                                         oal_uint8 uc_cwmin, oal_uint8 uc_ec_type)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_get_edca_machw_cw(hal_to_dmac_vap_stru *pst_hal_vap, oal_uint8 *puc_cwmax,
                                                         oal_uint8 *puc_cwmin, oal_uint8 uc_ec_type)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_machw_txop_limit_bkbe(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                 oal_uint16 us_be, oal_uint16 us_bk)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_get_machw_txop_limit_bkbe(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                 oal_uint16 *pus_be, oal_uint16 *pus_bk)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_machw_txop_limit_vivo(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                 oal_uint16 us_vo, oal_uint16 us_vi)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_txop_check_cca(hal_to_dmac_vap_stru *pst_hal_vap,
                                                      oal_uint8 en_txop_check_cca)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_get_machw_txop_limit_vivo(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                 oal_uint16 *pus_vo, oal_uint16 *pus_vi)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_machw_edca_bkbe_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                    oal_uint16 us_be, oal_uint16 us_bk)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_get_machw_edca_bkbe_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                    oal_uint16 *pus_be, oal_uint16 *pus_bk)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_machw_edca_vivo_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                    oal_uint16 us_vo, oal_uint16 us_vi)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_get_machw_edca_vivo_lifetime(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                    oal_uint16 *pus_vo, oal_uint16 *pus_vi)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_start_tsf(hal_to_dmac_vap_stru *pst_hal_vap,
                                                 oal_bool_enum_uint8 en_dbac_enable)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_machw_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_update_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                                            oal_uint16 us_beacon_period)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_psm_listen_interval(hal_to_dmac_vap_stru *pst_hal_vap,
                                                           oal_uint16 us_interval)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_psm_listen_interval_count(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_psm_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_get_beacon_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                                         oal_uint32 *pul_beacon_period)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_noa(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_set_ops(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_vap_enable_p2p_absent_suspend(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_sta_dtim_period(hal_to_dmac_vap_stru *pst_hal_vap,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_sta_dtim_period(hal_to_dmac_vap_stru *pst_hal_vap,
                                                       oal_uint32 *pul_dtim_period)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_pm_enable_front_end(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint8 uc_enable_paldo)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_cfg_slottime_type(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 ul_slottime_type)
{
    HAL_PUBLIC_HOOK_FUNC (_cfg_slottime_type)(pst_hal_device, ul_slottime_type);
}
/*
 * 函 数 名  : hal_set_cca_prot_th
 * 功能描述  : CCA优化下设置cca的协议门限
 * 修改历史  :
 * 1.日    期  : 2015年5月29日
 *   作    者  : heyinjun
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_cca_prot_th(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_int8 c_ed_low_th_dsss_reg_val, oal_int8 c_ed_low_th_ofdm_reg_val)
{
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1102A_DEV)
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_mwo_det_enable_mac_counter(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_btcoex_get_rf_control(oal_uint16 ul_occupied_period,
                                                         oal_uint32 *pul_wlbt_mode_sel, oal_uint16 us_wait_cnt)
{
...
OAL_STATIC OAL_INLINE oal_void hal_btcoex_post_event(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_btcoex_get_ps_service_status(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_btcoex_get_bt_sco_status(hal_to_dmac_device_stru *pst_hal_device,
                                                            oal_bool_enum_uint8 *en_sco_status)
{
    HAL_PUBLIC_HOOK_FUNC (_btcoex_get_bt_sco_status)(pst_hal_device, en_sco_status);
}
OAL_STATIC OAL_INLINE oal_void hal_btcoex_get_bt_acl_status(hal_to_dmac_device_stru *pst_hal_device,
...
#endif
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_iv_word(hal_tx_dscr_stru *pst_dscr, oal_uint32 *pul_iv_ms_word,
                                                       oal_uint32 *pul_iv_ls_word, oal_uint8 uc_chiper_type,
                                                       oal_uint8 uc_chiper_key_id)
{
    HAL_PUBLIC_HOOK_FUNC(_tx_get_dscr_iv_word)
    (pst_dscr, pul_iv_ms_word, pul_iv_ls_word, uc_chiper_type,
     uc_chiper_key_id);
}
OAL_STATIC OAL_INLINE oal_void hal_get_hw_status(hal_to_dmac_device_stru *pst_hal_device,
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
OAL_STATIC OAL_INLINE oal_void hal_dft_get_machw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint32 *pul_machw_stat, oal_uint8 us_bank_select,
                                                           oal_uint32 *pul_len)
{
    HAL_PUBLIC_HOOK_FUNC (_dft_get_machw_stat_info)(pst_hal_device, pul_machw_stat, us_bank_select, pul_len);
}
OAL_STATIC OAL_INLINE oal_void hal_dft_set_phy_stat_node(hal_to_dmac_device_stru *pst_hal_device,
                                                         oam_stats_phy_node_idx_stru *pst_phy_node_idx)
{
    HAL_PUBLIC_HOOK_FUNC (_dft_set_phy_stat_node)(pst_hal_device, pst_phy_node_idx);
}

OAL_STATIC OAL_INLINE oal_void hal_dft_get_phyhw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint32 *pul_phyhw_stat, oal_uint8 us_bank_select,
                                                           oal_uint32 *pul_len)
{
    HAL_PUBLIC_HOOK_FUNC (_dft_get_phyhw_stat_info)(pst_hal_device, pul_phyhw_stat, us_bank_select, pul_len);
}
OAL_STATIC OAL_INLINE oal_void hal_dft_get_rfhw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint32 *pul_rfhw_stat, oal_uint32 *pul_len)
{
    HAL_PUBLIC_HOOK_FUNC (_dft_get_rfhw_stat_info)(pst_hal_device, pul_rfhw_stat, pul_len);
}

OAL_STATIC OAL_INLINE oal_void hal_dft_get_sochw_stat_info(hal_to_dmac_device_stru *pst_hal_device,
                                                           oal_uint16 *pus_sochw_stat, oal_uint32 *pul_len)
{
...
/*
 * 函 数 名  : hal_check_test_value_reg
 * 功能描述  : 检查WITP_LCL_CTL_TEST_VALUE_REG寄存器
 * 修改历史  :
 * 1.日    期  : 2015年4月21日
 *   作    者  : l00222214
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_check_test_value_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_uint16 us_value, oal_uint32 *pul_result)
{
    HAL_PUBLIC_HOOK_FUNC (_check_test_value_reg)(pst_hal_device, us_value, pul_result);
}

/*
 * 函 数 名  : hal_revert_cw_signal_reg
 * 功能描述  : 1151发送单音信号
 * 修改历史  :
 * 1.日    期  : 2016年1月5日
 *   作    者  : liuming
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_revert_cw_signal_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                        wlan_channel_band_enum_uint8 en_band)
{
    HAL_PUBLIC_HOOK_FUNC (_revert_cw_signal_reg)(pst_hal_device, en_band);
}
OAL_STATIC OAL_INLINE oal_void hal_cfg_cw_signal_reg(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_get_cw_signal_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint8 uc_chain_idx, wlan_channel_band_enum_uint8 en_band)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_enable(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_sample(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_bool_enum_uint8 en_ftm_status)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_ftm_get_divider(hal_to_dmac_device_stru *pst_hal_device,
                                                   oal_uint32 *pul_divider)
{
    HAL_PUBLIC_HOOK_FUNC (_ftm_get_divider)(pst_hal_device, pul_divider);
}

/*
 * 函 数 名  : hal_set_tx_dscr_ftm_enable
 * 功能描述  : 设置tx描述符ftm标志位
 * 修改历史  :
 * 1.日    期  : 2018年7月25日
 *   作    者  : lwx500028
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_tx_dscr_ftm_enable(hal_to_dmac_device_stru *pst_hal_device,
                                                          hal_tx_dscr_stru *pst_tx_dscr,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ftm_ctrl_status(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 *pul_ftm_status)
{
    HAL_PUBLIC_HOOK_FUNC (_get_ftm_ctrl_status)(pst_hal_device, pul_ftm_status);
}
/*
 * 函 数 名  : hal_get_ftm_configure_status
 * 功能描述  : 获取ftm 配置状态
 * 修改历史  :
 * 1.日    期  : 2017年9月26日
 *   作    者  : wwx408792
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ftm_config_status(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 *pul_ftm_status)
{
    HAL_PUBLIC_HOOK_FUNC (_get_ftm_config_status)(pst_hal_device, pul_ftm_status);
}
/*
 * 函 数 名  : hal_set_ftm_ctrl_status
 * 功能描述  : 设置ftm 使能状态
 * 修改历史  :
 * 1.日    期  : 2017年9月26日
 *   作    者  : wwx408792
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_ctrl_status(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint32 ul_ftm_status)
{
    HAL_PUBLIC_HOOK_FUNC (_set_ftm_ctrl_status)(pst_hal_device, ul_ftm_status);
}
/*
 * 函 数 名  : hal_set_ftm_config_status
 * 功能描述  : 设置ftm 配置寄存器
 * 修改历史  :
 * 1.日    期  : 2017年9月26日
 *   作    者  : wwx408792
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_config_status(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint32 ul_ftm_status)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ftm_cali_rx_time(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ftm_cali_rx_intp_time(hal_to_dmac_device_stru *pst_hal_device,
                                                             oal_uint32 *pul_ftm_cali_rx_intp_time)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ftm_cali_tx_time(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_cali(hal_to_dmac_device_stru *pst_hal_device,
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_tx_cnt(hal_to_dmac_device_stru *pst_hal_device,
                                                  hal_tx_dscr_stru *pst_tx_dscr, oal_uint8 uc_ftm_tx_cnt)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_bandwidth(hal_to_dmac_device_stru *pst_hal_device,
                                                     hal_tx_dscr_stru *pst_tx_dscr, wlan_bw_cap_enum_uint8 en_band_cap)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_protocol(hal_to_dmac_device_stru *pst_hal_device,
                                                    hal_tx_dscr_stru *pst_tx_dscr,
...
/*
 * 函 数 名  : hal_get_ftm_rtp_reg_ram
 * 功能描述  : hal_get_ftm_rtp_reg后续处理
 * 修改历史  :
 * 1.日    期  : 2018年11月23日
 *   作    者  : lwx500028
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_ftm_rtp_reg_ram(hal_to_dmac_device_stru *pst_hal_device,
                                                       void **p_ftm_ext_rpt_reg, oal_uint8 uc_session_index)
{
...
OAL_STATIC OAL_INLINE oal_void hal_get_ftm_rtp_reg(hal_to_dmac_device_stru *pst_hal_device,
                                                   ...
                                                   oal_uint32 *pul_reg4)
{
    HAL_PUBLIC_HOOK_FUNC(_get_ftm_rtp_reg)
    (pst_hal_device,
     pul_reg0,
     pul_reg1,
     pul_reg2,
...
/*
 * 函 数 名  : hal_get_rpt_ftm_reg4
 * 功能描述  : 获取mac上报ftm的第4个寄存器值
 * 修改历史  :
 * 1.日    期  : 2018年11月30日
 *   作    者  : lwx500028
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hal_set_csi_ta_check
 * 功能描述  : 使能固定TA check时，只TA匹配的帧上报CSI；不使能，则只要phy上报帧就会上报。
 * 修改历史  :
 * 1.日    期  : 2017年11月13日
 *   作    者  : l00357925
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_csi_ta_check(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_bool_enum_uint8 en_check_ta,
...
/*
 * 函 数 名  : hal_set_pktmem_csi_bus_access
 * 功能描述  : 将pktmem设置为总线访问
 * 修改历史  :
 * 1.日    期  : 2017年11月1328日
 *   作    者  : l00357925
...
/*
 * 函 数 名  : hi1103_get_mac_csi_ta
 * 功能描述  : 获取CSI上报的MAC ta信息
 * 修改历史  :
 * 1.日    期  : 2017年11月13日
 *   作    者  : l00357925
 *   修改内容  : 新生成函数
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_get_phy_csi_info(hal_to_dmac_device_stru *pst_hal_device,
                                                    wlan_channel_bandwidth_enum_uint8 *pen_bandwidth,
                                                    oal_uint8 *puc_frame_type)
{
    HAL_PUBLIC_HOOK_FUNC (_get_phy_csi_info)(pst_hal_device, pen_bandwidth, puc_frame_type);
}

/*
 * 函 数 名  : hal_set_csi_memory
 * 功能描述  : CSI 数采配置
 * 修改历史  :
 * 1.日    期  : 2017年11月13日
 *   作    者  : l00357925
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_csi_memory(hal_to_dmac_device_stru *pst_hal_device,
                                                  oal_uint32 ul_start_addr, oal_uint32 ul_reg_num)
{
    HAL_PUBLIC_HOOK_FUNC (_set_csi_memory)(pst_hal_device, ul_start_addr, ul_reg_num);
}

/*
 * 函 数 名  : hal_restart_csi_sample
 * 功能描述  : 重启csi
 * 修改历史  :
 * 1.日    期  : 2018年8月23日
 *   作    者  : lwx500028
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_restart_csi_sample(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_get_csi_end_addr(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint8 **puc_csi_end_addr)
{
    HAL_PUBLIC_HOOK_FUNC (_get_csi_end_addr)(pst_hal_device, puc_csi_end_addr);
}
OAL_STATIC OAL_INLINE oal_void hal_get_pktmem_start_addr(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint8 **puc_pktmem_start_addr)
{
    HAL_PUBLIC_HOOK_FUNC (_get_pktmem_start_addr)(pst_hal_device, puc_pktmem_start_addr);
}
OAL_STATIC OAL_INLINE oal_void hal_get_pktmem_end_addr(hal_to_dmac_device_stru *pst_hal_device,
                                                       oal_uint8 **pul_pktmem_end_addr)
{
...
OAL_STATIC OAL_INLINE oal_void hal_set_cca_bimr_th(oal_uint8 c_pri_20_th, oal_uint8 c_sec_20_th,
                                                   oal_uint8 c_sec_40_th)
{
...
{
    HAL_PUBLIC_HOOK_FUNC(_tpc_select_upc_level)
    (pas_upc_gain_table, uc_upc_gain_table_len, pst_hal_vap,
     uc_start_chain);
}
...
#endif
OAL_STATIC OAL_INLINE oal_void hal_tpc_store_phy_reg_upc_lut_param(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                   hal_to_dmac_device_stru *pst_hal_device,
                                                                   oal_uint8 uc_subband_idx)
{
...
OAL_STATIC OAL_INLINE oal_void hal_get_sar_ctrl_params(wlan_channel_band_enum_uint8 en_band,
                                                       oal_uint8 uc_channel_num,
...
OAL_STATIC OAL_INLINE oal_void hal_set_pow_to_tpc_code(hal_to_dmac_vap_stru *pst_hal_vap,
                                                       hal_to_dmac_device_stru *pst_hal_dev,
                                                       wlan_channel_band_enum_uint8 en_freq_band,
                                                       oal_uint8 uc_cur_ch_num,
                                                       wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
    HAL_PUBLIC_HOOK_FUNC(_set_pow_to_tpc_code)
    (pst_hal_vap, pst_hal_dev, en_freq_band, uc_cur_ch_num,
     en_bandwidth);
}

OAL_STATIC OAL_INLINE oal_void hal_adjust_pow_cali_upc_code_by_amend(hal_to_dmac_vap_stru *pst_hal_vap,
                                                                     hal_to_dmac_device_stru *pst_hal_device,
                                                                     oal_uint8 uc_cur_ch_num)
{
...
OAL_STATIC OAL_INLINE oal_void hal_far_dis_is_need_gain_pwr(wlan_channel_band_enum_uint8 en_band,
                                                            oal_uint8 uc_channel_num,
...
OAL_STATIC OAL_INLINE oal_void hal_dyn_tbtt_offset_switch(hal_to_dmac_device_stru *pst_hal_device,
                                                          oal_uint8 uc_switch)
{
    HAL_PUBLIC_HOOK_FUNC (_dyn_tbtt_offset_switch)(pst_hal_device, uc_switch);
}
OAL_STATIC OAL_INLINE oal_void hal_dyn_set_tbtt_offset_resv(hal_to_dmac_device_stru *pst_hal_device,
                                                            oal_uint16 us_val)
{
...
/*
 * 函 数 名  : hal_set_extlna_threshold
 * 功能描述  : 设置外置LNA阈值
 * 修改历史  :
 * 1.日    期  : 2018年8月15日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_extlna_threshold(hal_to_dmac_device_stru *pst_hal_device,
                                                        oal_bool_enum_uint8 en_close_extlna)
{
    HAL_PUBLIC_HOOK_FUNC (_set_extlna_threshold)(pst_hal_device, en_close_extlna);
}

/*
 * 函 数 名  : hal_set_dyn_bypass_extlna_pm_flag
 * 功能描述  : 设置低功耗测试场景标志
 * 修改历史  :
 * 1.日    期  : 2018年8月15日
 *   作    者  : g00428180
...
/*
 * 函 数 名  : hal_set_agc_target_adjust
 * 功能描述  : 刷新agc target
 * 修改历史  :
 * 1.日    期  : 2019年5月13日
 *   作    者  : d00262548
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_set_agc_target_adjust(hal_to_dmac_device_stru *pst_hal_device,
...
/*
 * 函 数 名  : hal_set_dyn_bypass_extlna_enable
 * 功能描述  : 设置动态bypass外置LNA总开关
 * 修改历史  :
 * 1.日    期  : 2018年8月22日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hal_get_dyn_bypass_extlna_pm_flag
 * 功能描述  : 获取低功耗测试场景标志
 * 修改历史  :
 * 1.日    期  : 2018年8月15日
 *   作    者  : g00428180
...
/*
 * 函 数 名  : hal_get_dyn_bypass_extlna_enable
 * 功能描述  : 获取动态bypass外置LNA总开关
 * 修改历史  :
 * 1.日    期  : 2018年8月22日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hal_clear_user_ptk_key
 * 功能描述  : 初始化user时，清空user单播密钥信息
 * 修改历史  :
 * 1.日    期  : 2018年8月23日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void hal_clear_user_ptk_key(hal_to_dmac_device_stru *pst_hal_device,
                                                      oal_uint8 uc_lut_idx)
{
...
/*
 * 函 数 名  : hal_init_bt_env
 * 功能描述  : Initialze BT environment.
 * 修改历史  :
 * 1.日    期  : 2018年12月26日
 *   作    者  : w00420087
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hal_set_bt_freq
 * 功能描述  : Set BT frequency.
 * 修改历史  :
 * 1.日    期  : 2018年12月26日
 *   作    者  : w00420087
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hal_set_bt_upc_by_freq
 * 功能描述  : Set UPC code to BT Tx Power calirbation result by frequency.
 * 修改历史  :
 * 1.日    期  : 2018年12月26日
 *   作    者  : w00420087
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hal_print_bt_gm
 * 功能描述  : Print BT Gm calibration result.
 * 修改历史  :
 * 1.日    期  : 2019年1月8日
 *   作    者  : w00420087
 *   修改内容  : 新生成函数
...
#endif
OAL_STATIC OAL_INLINE oal_void hal_enable_tsf_tbtt(hal_to_dmac_vap_stru *pst_hal_vap,
                                                   oal_bool_enum_uint8 en_dbac_enable)
{
...
/*
 * 函 数 名  : hal_chba_set_sync_filter
 * 功能描述  : chba 同步与过滤设置
 * 修改历史  :
 * 1.日    期  : 2021年05月17日
 *   作    者  : ywx5321377
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE void hal_chba_set_sync_filter(hal_to_dmac_vap_stru *pst_hal_vap, uint8_t enable)
{
    HAL_PUBLIC_HOOK_FUNC(_chba_set_sync_filter)(pst_hal_vap, enable);
}

/*
 * 函 数 名  : hal_chba_set_tbtt_intr
 * 功能描述  : chba模式下设置tbtt中断
 * 修改历史  :
 * 1.日    期  : 2021年10月08日
 *   作    者  : ywx5321377
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE void hal_chba_set_tbtt_intr(hal_to_dmac_vap_stru *pst_hal_vap, uint8_t enable)
{
    HAL_PUBLIC_HOOK_FUNC(_chba_set_tbtt_intr)(pst_hal_vap, enable);
}
#endif
