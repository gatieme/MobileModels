...
#define WLAN_AUTH_AP_TIMEOUT                    500     /* ap auth的timeout时间。300->500 DTS2019072601201 TOTOLINK EX300V2型号中继关联02A APUT关联失败.auth时间不够 */
...
/* DTS2018112708398:SA Query改为在1秒内每隔200ms发一帧 */
