 ...
 *   2.日    期   : 2017年12月4日
 *     作    者   : w00434750
 *     修改内容   : 增加oui type作为区分不同的vendor ie.
 */
...
oal_void mac_set_cap_info_sta(oal_void *pst_vap, oal_uint8 *puc_cap_info)
{
    ...
    ***************************************************************************/
    ...
    if (mac_get_11h_test() == OAL_FALSE) {
        /* DTS2019072210921:关闭11h能力位，避免让ap误认为sta支持频谱管理功能 */
...
oal_uint32 mac_set_rsn_ie(oal_void *pst_vap, oal_uint8 *puc_pmkid, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len)
{
    ...
    *puc_ie_len = 0; /* 初始化IE 长度为0 */
    ...
    /*
     * DTS2018081400936:
     * 上层决定使用默认的组播管理帧加密方式(BIP-CMAC-128)时下发的IE中不带group mgmt suite cipher字段，
     * 此处获取的uc_group_mgmt_suite为0，不加以判断会导致组播管理帧加密字段设置错误
 */
...
/*
 *  函 数 名   : mac_set_ext_capabilities_ie_rom_cb
...
oal_void  mac_set_vht_capinfo_field(oal_void *pst_vap, oal_uint8 *puc_buffer)
{
    ...
    ***************************************************************************/
    ...
    /* DTS2018051202512: 满足认证 当user的sounding_dim为0时,使用vap的能力位 */
...
#endif
/*
 *  函 数 名   : mac_set_epigram_vht_ie
 *  功能描述   : 填充Epigram 厂商自定义ie
 *  修改历史   :
 *   1.日    期   : 2017年12月12日
 *     作    者   : duankaiyong 00194999
 *     修改内容   : 新生成函数
...
/*
 *  函 数 名   : mac_set_epigram_novht_ie
 *  功能描述   : 填充Epigram 厂商自定义ie，适配5g 20M MCS9问题
 *  修改历史   :
 *   1.日    期   : 2018年3月26日
 *     作    者   : l00357925
 *     修改内容   : 新生成函数
...
/*
 *  函 数 名   : mac_vap_set_cb_tx_user_idx
