...
/* DTS2015012001920:修改BE/BK的cwmin的大小，由4修改为3，
   DTS2015072908125 之前修改影响认证4.2.23&4.2.7&4.2.8，同频干扰由抗干扰动态edca调整算法实现,现在由3修改为4 */
...
*****************************************************************************/
/*
 * 函 数 名  : mac_vap_clear_amsdu_ampdu
 * 功能描述  : del user或add vap时去掉联合聚合标记
 * 修改历史     :
 * 1.日    期   : 2020年1月14日
 *   作    者   : h00368777
 *   修改内容   : 新生成函数
...
oal_uint32 mac_vap_del_user(mac_vap_stru *pst_vap, oal_uint16 us_user_idx)
{
    ...
    if (us_user_idx == pst_vap->us_cache_user_id) {
        ...
        /* DTS2015082603340 解决用户已删除，cache id和mac addr均为0，导致发送完成中断下半部依旧可以找到已删除的用户 */
...
/*
 * 函 数 名  : mibset_rsnaclearwpapairwisecipherimplemented
 * 功能描述  : 清除WPA加密套件
 * 修改历史  :
 * 1.日    期  : 2018年9月8日
 *   作    者  : g00428180
...
/*
 * 函 数 名  : mibset_rsnaclearwpa2pairwisecipherimplemented
 * 功能描述  : 清除RSN加密套件
 * 修改历史  :
 * 1.日    期  : 2018年9月8日
 *   作    者  : g00428180
    ...
    mac_vap_stru *pst_vap, wlan_protocol_enum_uint8 en_vap_protocol, mac_data_rate_stru *pst_rates)
{
    ...
    /* begin:DTS2015041102828 1102 在listen channel的probe respons 携带速率集有重复IE. */
    ...
    /* end:DTS2015041102828 1102 在listen channel的probe respons 携带速率集有重复IE. */
...
/*
 * 函 数 名  : mac_vap_vowifi_init
 * 功能描述  : 初始化dmac vowifi的信息
 * 修改历史  :
 * 1.日    期  : 2016年4月19日
 *   作    者  : z00273164
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : mac_vap_vowifi_exit
 * 功能描述  : 去初始化dmac vowifi的信息
 * 修改历史  :
 * 1.日    期  : 2016年4月19日
 *   作    者  : z00273164
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : mac_vap_clear_app_ie_host
 * 功能描述  : 清除保存的ie
 * 修改历史  :
 * 1.日    期  : 2015年4月28日
 *   作    者  : g00260350
...
/*
 * 函 数 名  : mac_vap_check_signal_bridge
 * 功能描述  : 检查漫游上报条件，如果打开信号桥不上报漫游
 * 修改历史  :
 * 1.日    期  : 2018年9月12日
 *   作    者  : t00422961
 *   修改内容  : 新生成函数
...
OAL_STATIC oal_void mac_init_public_mib(wlan_mib_ieee802dot11_stru *pst_mib_info, mac_vap_stru *pst_mac_vap)
{
    ...
    pst_mib_info->st_phy_erp.en_dot11ShortSlotTimeOptionActivated = OAL_TRUE;  // 11g 性能问题 DTS2015012001920
...
#ifdef _PRE_WLAN_FEATURE_TXOPPS
    if (pst_mac_vap->pst_mib_info == OAL_PTR_NULL) { /* DTS2015061707970 规避死机 */
...
/*
 * 函 数 名  : mac_vap_get_user_protection_mode
 * 功能描述  : 获取保护模式类型
 * 修改历史  :
 * 1.日    期  : 2014年1月18日
 *   作    者  : c00260463
...
/*
 * 函 数 名  : mac_protection_lsigtxop_check
...
/*
 * 函 数 名  : mac_protection_set_lsig_txop_mechanism
...
/*
 * 函 数 名  : mac_protection_set_rts_tx_param
...
oal_uint32 mac_vap_set_beacon(mac_vap_stru *pst_mac_vap, mac_beacon_param_stru *pst_beacon_param)
{
    ...
    if (pst_beacon_param->en_privacy == OAL_FALSE) {
        /* DTS2016052000621, 清除组播用户加密信息位置由vap down移动到此处。解决vap down/up后STA关联APUT失败问题。 */
...
/*
 * 函 数 名  : mac_vap_protection_autoprot_is_enabled
 * 功能描述  : 查询自动保护机制是否开启
 * 修改历史  :
 * 1.日    期  : 2014年1月18日
 *   作    者  : c00260463
...
/*
 * 函 数 名  : mac_mib_init_rsnacfg_suites
 * 功能描述  : 初始化加密相关mib
 * 修改历史  :
 * 1.日    期  : 2018年9月10日
 *   作    者  : g00428180
