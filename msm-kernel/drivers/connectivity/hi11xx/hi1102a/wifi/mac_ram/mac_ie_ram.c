 ...
 *     修改内容   : 新生成函数
 */
oal_rom_cb_result_enum_uint8  mac_ie_proc_opmode_field_cb(
...
/*
 *  函 数 名   : mac_ie_modify_vht_ie_short_gi_80
 *  功能描述   : 根据当前频段修改VHT IE中Short GI 80字段值
 *  修改历史   :
 *   1.日    期   : 2018年11月14日
 *     作    者   : g00428180
 *     修改内容   : 新生成函数
 */
oal_void mac_ie_modify_vht_ie_short_gi_80(
    mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload_addr_start, oal_uint8 *puc_payload_addr_end)
{
    /*
