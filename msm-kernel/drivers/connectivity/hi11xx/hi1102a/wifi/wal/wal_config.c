...
/*
 * 函 数 名  : wal_config_set_power_rf_ctl
 * 功能描述  : 设置功率控制模式是否为RF控
 * 修改历史  :
 * 1.日    期  : 2018年9月12日
 *   作    者  : r00356856
...
/*
 * 函 数 名  : wal_config_cfg80211_start_connect
 * 功能描述  : 输入参数  : 无
 * 修改历史  :
 * 1.日    期  : 2013年8月30日
 *   作    者  : y00184180
...
/*
 * 函 数 名  : wal_config_set_green_ap_en
 * 功能描述  : 设置green ap使能
 * 修改历史  :
 * 1.日    期  : 2016年2月21日
 *   作    者  : zourong
...
/*
 * 函 数 名  : wal_config_always_tx_num
 * 功能描述  : 广播数据包
 * 修改历史  :
 * 1.日    期  : 2018年8月14日
 *   作    者  : w00434750
...
/*
 * 函 数 名  : wal_config_rx_filter_frag
 * 功能描述  : 设置分片过滤调试命令。
 * 修改历史  :
 * 1.日    期  : 2016年2月27日
 *   作    者  : h00212953
...
/*
* 函 数 名  : wal_config_assigned_filter
* 功能描述  : 配置rx 指定数据包过滤的参数
* 修改历史      :
*  1.日    期   : 2019年10月29日
*    作    者   : x00456388
*    修改内容   : 新生成函数
...
/*
 * 函 数 名  : wal_config_interworking_switch
...
/*
 * 函 数 名  : wal_config_set_5g_high_band_max_pow_params
...
/*
 * 函 数 名  : wal_config_set_cus_base_power_params
 * 功能描述  : 设置base power发送功率参数到device
 * 修改历史  :
 * 1.日    期  : 2018年8月26日
 *   作    者  : duankaiyong
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : wal_config_set_cus_tx_power_params
...
/*
 * 函 数 名  : wal_config_force_pass_filter
 * 功能描述  : 开启/关闭帧过滤
 * 修改历史  :
 * 1.日    期  : 2018年7月5日
 *   作    者  : dwx371754
...
/*
 * 函 数 名  : wal_config_set_tx_ba_policy
 * 功能描述  : 配置建立聚合的条件
 * 修改历史  :
 * 1.日    期  : 2018年10月18日
 *   作    者  : r00356856
...
#ifdef _PRE_WLAN_FEATURE_NRCOEX
/*
 * 函数名:wal_config_set_nrcoex_params
 * 功能:传递定制化下发的参数
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函数名:wal_config_set_wifi_priority
 * 功能:配置WiFi的优先级
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函数名:wal_config_get_nrcoex_info
 * 功能:获取NRCOEX相关信息
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函 数 名  : wal_config_set_txop_switch
 * 功能描述  : 输入参数  :
 * 修改历史  :
 * 1.日    期  : 2022年5月6日
 *   作    者  : p00562874
