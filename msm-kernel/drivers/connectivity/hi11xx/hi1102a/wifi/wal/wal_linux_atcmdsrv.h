...
/*****************************************************************************
  10 函数声明
*****************************************************************************/
extern oal_uint32 hmac_get_pd_bss_expire_time(oal_void);
extern oal_void hmac_set_pd_bss_expire_time(oal_uint32 pd_bss_expire_time);
extern oal_uint32 chr_get_at_test(void);
extern void chr_set_at_test(oal_uint32 at_test);
...
extern oal_int32 wal_atcmdsrv_wifi_priv_cmd(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr,
                                            oal_int32 ul_cmd);
...
extern oal_int32 hi1102a_factory_io_test(uint8_t flowctrl_type);
extern oal_uint32 wal_hipriv_packet_check_send_event(
