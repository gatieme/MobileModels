...
enum mkeep_alive_attributes {
    ...
    /* keep last */
    MKEEP_ALIVE_ATTRIBUTE_LAST,
    MKEEP_ALIVE_ATTRIBUTE_MAX = MKEEP_ALIVE_ATTRIBUTE_LAST - 1,
};
...
enum wal_chba_conn_ntf_attributes {
    MAC_CHBA_CONN_NTF_ATTR_ID = 1,
    MAC_CHBA_CONN_NTF_ATTR_MAC_ADDR,
    MAC_CHBA_CONN_NTF_ATTR_CENTER_FREQ_20M,
    MAC_CHBA_CONN_NTF_ATTR_CENTER_FREQ_1,
    MAC_CHBA_CONN_NTF_ATTR_CENTER_FREQ_2,
    MAC_CHBA_CONN_NTF_ATTR_CENTER_BANDWIDTH,
    MAC_CHBA_CONN_NTF_ATTR_EXPIRE_TIME,
    /* keep last */
    MAC_CHBA_CONN_NTF_ATTR_LAST,
    MAC_CHBA_CONN_NTF_ATTR_MAX = MAC_CHBA_CONN_NTF_ATTR_LAST - 1,
};
#endif
enum {
