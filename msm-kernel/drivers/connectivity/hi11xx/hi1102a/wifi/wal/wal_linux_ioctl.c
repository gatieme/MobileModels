...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE) && (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
/*
    DTS2016012602459 不支持ethtool_ops 相关函数操作,需要显示定义空的结构体,
...
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
/*
 * 函 数 名  : hwifi_config_init_base_power_main
 * 功能描述  : 将定制化中的base power下发到device
 * 修改历史  :
 * 1.日    期  : 2018年9月5日
 *   作    者  : r00356856
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hwifi_config_init_5g_high_band_max_power_main
 * 功能描述  : 将定制化中的5G高band最大发送功率下发到device
 * 修改历史  :
 * 1.日    期  : 2019年3月14日
 *   作    者  : k00347307
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hwifi_config_init_tx_power_main
 * 功能描述  : 将定制化中的base power下发到device
 * 修改历史  :
 * 1.日    期  : 2018年9月5日
 *   作    者  : r00356856
...
/*
 * 函 数 名  : hwifi_config_tcp_ack_ini_param
 * 功能描述  : 从定制化ini文件中读取数据并初始化device tcp ack过滤相关全局变量
 * 修改历史  :
 * 1.日    期  : 2019年3月29日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : hwifi_config_ddr_cpu_freq_ini_param
 * 功能描述  : 从定制化ini文件中cpu和ddr绑核信息
 * 修改历史  :
 * 1.日    期  : 2019年3月29日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名 : hwifi_config_txopt_opt_ini_param
 * 功能描述 : 发送方向性能优化初始化定制化
 * 修改历史 :
 * 1.日    期 : 2019年10月8日
 *   作    者 : l00422505
...
/*
 * 函 数 名  : hwifi_config_init_tcp_ack_params
 * 功能描述  : 初始化tcp_ack_buf
 * 修改历史  :
 * 1.日    期  : 2015年10月22日
 *   作    者  : h00349274
...
/*
 * 函 数 名  : hwifi_config_init_interworking
 * 功能描述  : interworking定制化
 * 修改历史  :
 * 1.日    期  : 2019年04月13日
 *   作    者  : y00452465
 *   修改内容  : 新生成函数
...
#ifdef _PRE_WLAN_FEATURE_NRCOEX
/*
 * 函数名:hwifi_config_init_nrcoex_params_main
 * 功能:下发NR共存相关的定制化到device
 * 修改历史:
 * 1.日    期:20190929
 *   作    者:r00356856
 *   修改历史:新生成函数
...
#endif
/*
 * 函 数 名  : hwifi_config_cali_mask_enable
 * 功能描述  : 输入参数  :
 * 修改历史  :
 * 1.日    期  : 2015年10月22日
 *   作    者  : h00349274
...
#endif
/*
 * 函 数 名  : hwifi_config_init_ini_priv
 * 功能描述  : 下发私有定制化信息
 * 修改历史  :
 * 1.日    期  : 2018年5月5日
 *   作    者  : h00368777
...
/*
 * 函 数 名  : hwifi_cfg_init_line_params
 * 功能描述  : 初始化产线校准参数
 * 修改历史  :
 * 1.日    期  : 2017年12月21日
 *   作    者  : wulei
...
/*
 * 函 数 名  : hwifi_config_init_txop_switch
 * 功能描述  : txop_switch定制化
 * 修改历史  :
 * 1.日    期  : 2022年05月06日
 *   作    者  : p00562874
 ...
 * 功能描述  : 输入参数  : custom_cali_func p_fun
 * 修改历史  :
 * 1.日    期  : 2015年9月18日
 *   作    者  : t00231215
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : wal_ioctl_force_pass_filter
 * 功能描述  : hipriv命令 开启/关闭帧过滤
 * 修改历史  :
 * 1.日    期  : 2018年7月5日
 *   作    者  : dwx371754
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : wal_hipriv_set_chba_channel_seq
 * 功能描述  : 配置chba信道序列
 * 修改历史  :
 * 1.日    期  : 2022年4月26日
 *   作    者  : ywx5321377
...
/*
 * 函 数 名  : wal_vendor_priv_cmd_chba_protocol
 * 日    期  : 2021年6月29日
 * 作    者  : m00488873
 */
...
/*
 * 函 数 名  : wal_vendor_priv_append_cmd
 * 功能描述  :增加命令处理
 * 修改历史  :
 * 1.日    期  : 2019年10月28日
 *   作    者  : l00422505
...
/*
 * 函 数 名  : wal_vendor_config_filter_cmd
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年11月24日
 *   作    者  : xiaoyuren
...
/*
 * 函 数 名  : wal_hipriv_set_tx_ba_policy
 * 功能描述  : 设置建立聚合的条件
 * 修改历史  :
 * 1.日    期  : 2018年10月18日
 *   作    者  : r00356856
...
/*
 * 函 数 名  : wal_hipriv_dscr_th_opt
 * 功能描述  : 设置host侧rx描述符优化逻辑门限
 * 修改历史  :
 * 1.日    期  : 2019年2月16日
 *   作    者  : g00428180
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : wal_hipriv_tcp_ack_filter
...
oal_int32 wal_regdomain_update(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country, oal_uint8 len)
{
    ...
    ***************************************************************************/
    ...
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        ...
        /* DTS2018093000933:同步1103修改，命令下发成功，在HMAC释放内存；否则在WAL释放内存 */
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
/*
 * 函 数 名  : wal_set_random_mac_to_mib
 * 功能描述  : 输入参数  :
 * 修改历史  :
 * 1.日    期  : 2014年10月29日
 *   作    者  : c00280521
...
/*
 * 函 数 名  : wal_hipriv_set_pow_rf_ctl
 * 功能描述  : 设置功率控制模式是否为RF控
 * 修改历史  :
 * 1.日    期  : 2018年9月12日
 *   作    者  : r00356856
...
/*
 * 函 数 名  : wal_hipriv_always_tx_num
 * 功能描述  : 数据常发
 * 修改历史  :
 * 1.日    期  : 2018年8月14日
 *   作    者  : w00434750
...
/*
 * 函 数 名  : wal_hipriv_rx_filter_frag
 * 功能描述  : 设置分片过滤调试命令。1：使能分片帧过滤；0：不使能分片帧过滤
 * 修改历史  :
 * 1.日    期  : 2016年2月27日
 *   作    者  : h00212953
 *   修改内容  : 新生成函数
                                   ...
                                   en_app_ie_type_uint8 en_type)
{
    ...
    if (IS_LEGACY_VAP(pst_mac_vap) == OAL_FALSE) {
        /* DTS2017082506384 GO满规格时IE长度过大，导致死机。竟分后只提取221的IE */
...
#ifdef _PRE_WLAN_FEATURE_P2P
/*
 * 函 数 名  : wal_ioctl_set_p2p_miracast_status
 * 功能描述  : 设置miracast状态
 * 修改历史  :
 * 1.日    期  : 2019年10月21日
 *   作    者  : b00484323
...
#endif
/*
 * 函 数 名  : wal_get_reduce_sar_ctrl_params
 * 功能描述  : 获取定制中降sar的三档功率值
 * 修改历史  :
 * 1.日    期  : 2015年1月20日
 *   作    者  : wulei
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : wal_set_nbfh
 * 功能描述  : 输入参数  : oal_net_device_stru *pst_net_dev
 * 修改历史  :
 * 1.日    期  : 2019年1月19日
 *   作    者  : l00423930
 *   修改内容  : 新生成函数
...
static void wal_set_chba_mac_addr(oal_net_device_stru *net_dev)
{
    ...
    primary_mac_addr[0] &= (~0x02); /* DTS2015022502351 wlan0 MAC[0] bit1 需要设置为0 */
...
/*
* 函 数 名  : wal_config_send_event
* 功能描述  : 封装wal2host抛事件函数
* 修改历史      :
*  1.日    期   : 2019年10月29日
*    作    者   : x00456388
*    修改内容   : 新生成函数
...
/*
* 函 数 名  : wal_set_assigned_filter_enable
* 功能描述  : 根据上层策略,过滤指定报文命令下发函数
* 修改历史      :
*  1.日    期   : 2019年10月28日
*    作    者   : x0045388
*    修改内容   : 新生成函数
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
/*
 * 函 数 名  : wal_hipriv_set_pm_debug_switch
 * 功能描述  : pm debug 接口
 * 修改历史  :
 * 1.日    期  : 2017年09月07日
 *   作    者  : dwx371754
...
#ifdef _PRE_WLAN_FEATURE_TCP_ACK_BUFFER
/*
 * 函 数 名  : wal_hipriv_tcp_ack_buf_cfg
 * 功能描述  : 输入参数  : oal_net_device_stru *pst_net_dev
 * 修改历史  :
 * 1.日    期  : 2018年7月26日
 *   作    者  : y84102835
...
/*
 * 函 数 名  : wal_hipriv_mcs_set_check_enable
 * 功能描述  : 是否检查11n mcs速率集0: 不检查mcs 速率集 1: 检查mcs 速率集
 * 修改历史  :
 * 1.日    期  : 2018年8月3日
 *   作    者  : l00453963
 *   修改内容  : 新生成函数
...
/*
 * 函 数 名  : wal_hipriv_set_tx_pow_param
 * 功能描述  : 配置发送功率命令
 * 修改历史  :
 * 1.日    期  : 2016年12月23日
 *   作    者  : k00347307
...
/*
 * 函 数 名  : wal_hipriv_set_sar_level
 * 功能描述  : 触发降sar
 * 修改历史  :
 * 1.日    期  : 2018年9月10日
 *   作    者  : r00356856
...
#ifdef _PRE_WLAN_FEATURE_BTCOEX
/*
 * 函 数 名  : wal_hipriv_set_btcoex_params
 * 功能描述  : 配置共存的相关信息
 * 修改历史  :
 * 1.日    期  : 2018年11月2日
 *   作    者  : r00356856
...
#ifdef _PRE_WLAN_FEATURE_NRCOEX
/*
 * 函数名:wal_ioctl_set_wifi_priority
 * 功能:配置WiFi的优先级
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函数名:wal_ioctl_process_nrcoex_priority
 * 功能:处理上层下发的WiFi优先级命令
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
...
/*
 * 函数名:wal_ioctl_get_nrcoex_info
 * 功能:获取nrcoex相关信息并上报给上层
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
 *   修改历史:新生成函数
...
/*
 * 函数名:wal_hipriv_nrcoex_test_cmd
 * 功能:NRCOEX事件下发命令
 * 修改历史:
 * 1.日    期:20191010
 *   作    者:r00356856
