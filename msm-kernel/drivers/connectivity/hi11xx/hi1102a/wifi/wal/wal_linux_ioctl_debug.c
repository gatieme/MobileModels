...
/*
 * 函 数 名  : wal_hipriv_set_assigned_filter_switch
 * 功能描述  : 设置指定报文 filter开关 0:关闭  1:打开
 * 修改历史  :
 * 1.日    期  : 2019年10月29日
 *   作    者  : x00456388
 *   修改内容  : 新增函数
 ...
 */
    ...
    /* feature_id高8位与log_lvl拼接成st_write_msg.auc_value */
...
/*
 * 函 数 名  : wal_hipriv_set_2040_coext_switch
 * 功能描述  : 设置AP模式2040M带宽升降开关
 * 修改历史  :
 * 1.日    期  : 2019年1月17日
 *   作    者  : x00456388
 *   修改内容  : 新生成函数
...
OAL_STATIC oal_uint32 wal_hipriv_set_phy_debug_switch(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    do {
        ...
        /* 解析命令并进行EDCA参数配置 */
            ...
            /* edca_param_switch与uc_value低4位拼接成EDCA参数设置开关 */
...
OAL_STATIC oal_uint32 wal_dbb_scaling_amend_calc(oal_int8 *pc_param, mac_cfg_dbb_scaling_stru *pst_dbb_scaling)
{
    ...
    uc_offset_addr_a = (uc_offset_addr_a >> 2); /* uc_offset_addr_a右移2位 */
    uc_offset_addr_b =
       /* 判断dbb scaling对应的索引值是否小于4倍uc_offset_addr_a（uc_offset_addr_a左移2位） */
...
/*
 * 函 数 名  : wal_hipriv_hitalk_bg_listen
 * 功能描述  : 设置hitalk后台监听
 * 修改历史  :
 * 1.日    期  : 2019年1月18日
 *   作    者  : l00423930
...
OAL_STATIC oal_uint32 wal_hipriv_hitalk_bg_listen(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    ret = wal_send_cfg_event(pst_net_dev,
        WAL_MSG_TYPE_WRITE, WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_hitalk_listen_stru),
        (oal_uint8 *)&st_write_msg, OAL_FALSE, OAL_PTR_NULL);
...
/*
 * 函 数 名 : wal_hipriv_packet_check_init
 * 功能描述 : 关闭扫描,打开帧过滤,初始化包检查参数
 * 修改历史 :
 * 1.日 期  : 2019年9月17日
 * 作    者   : b00484323
 * 修改内容     : 新生成函数
...
/*
 * 函 数 名 : wal_hipriv_packet_check_deinit
 * 功能描述 : 恢复扫描,关闭帧过滤
 * 修改历史 :
 * 1.日 期  : 2019年9月17日
 * 作    者   : b00484323
...
/*
 * 函 数 名 : wal_hipriv_packet_check_send_event
 * 功能描述 : 发送特定广播帧校验收发错误
 * 修改历史 :
 * 1.日 期  : 2019年9月17日
 * 作    者   : b00484323
...
/*
 * 函 数 名 : wal_hipriv_packet_check_get_param
 * 功能描述 : 发送特定广播帧校验收发错误
 * 修改历史 :
 * 1.日 期  : 2019年9月17日
 * 作    者   : b00484323
...
/*
 * 函 数 名  : wal_hipriv_add_key_send_event
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2015年1月14日
 *   作    者  : z00273164
...
/*
 * 函 数 名  : ftm_debug_parase_iftmr_cmd
 * 功能描述  : 解析iftmr命令参数
 * 修改历史  :
 * 1.日    期  : 2017年4月10日
 *   作    者  : s00404525
...
/*
 * 函 数 名  : ftm_debug_parase_ftm_cmd
 * 功能描述  : 解析ftm命令参数
 * 修改历史  :
 * 1.日    期  : 2017年10月10日
 *   作    者  : wwx408792
...
/*
 * 函 数 名  : ftm_debug_parase_ftm_timeout_cmd
...
/*
 * 函 数 名  : ftm_debug_parase_range_req_cmd
 * 功能描述  : 解析csa命令参数
 * 修改历史  :
 * 1.日    期  : 2017年4月10日
 *   作    者  : s00404525
                                                     ...
                                                     oal_uint32 *pul_offset)
{
    ...
    *pul_offset += ul_off_set;
    oal_strtoaddr(ac_value, sizeof(ac_value),
        pst_debug_info->st_send_range_req_bit7.auc_mac, WLAN_MAC_ADDR_LEN);
    pc_param += ul_off_set;
    ul_off_set = 0;
...
/*
 * 函 数 名  : wal_hipriv_ftm_is_common_cmd
 * 功能描述  : 是否是fmt普通命令
 * 修改历史  :
 * 1.日    期  : 2019年8月21日
 *   作    者  : l00225940
...
/*
 * 函 数 名  : wal_hipriv_ftm_set_common_cmd
 * 功能描述  : 设置普通命令的参数
 * 修改历史  :
 * 1.日    期  : 2019年8月21日
 *   作    者  : l00225940
                                                    ...
                                                    mac_ftm_debug_switch_stru *pst_ftm_debug, oal_uint32 *pul_offset)
{
    ...
    *pul_offset = 0;
    ...
    if (uc_cmd_index >= 5) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_hipriv_ftm_set_common_cmd:: invalid cmd index [%d].}", uc_cmd_index);
        return OAL_FAIL;
    }
    /* 检查命令的配置值 */
...
/*
 * 函 数 名  : ftm_debug_parase_neighbor_report_req_cmd
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2019年08月16日
 *   作    者  : l00225940
...
/*
 * 函 数 名  : ftm_debug_parase_gas_init_req_cmd
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2019年08月16日
 *   作    者  : l00225940
...
/*
 * 函 数 名  : wal_hipriv_ftm_is_send_req_cmd
 * 功能描述  : 是否是fmt发送请求帧命令
 * 修改历史  :
 * 1.日    期  : 2019年12月03日
 *   作    者  : y00452465
...
OAL_STATIC oal_uint8 wal_hipriv_ftm_is_send_req_cmd(oal_int8 ac_name[], oal_uint8 *puc_cmd_index)
{
    ...
    for (uc_cmd_index = 0; uc_cmd_index < oal_array_size(g_ast_ftm_send_req_cmd);
         uc_cmd_index++) {
    ...
    if (uc_cmd_index == oal_array_size(g_ast_ftm_send_req_cmd)) {
        return OAL_FALSE;
    } else {
        *puc_cmd_index = uc_cmd_index;
        return OAL_TRUE;
...
/*
 * 函 数 名  : wal_hipriv_ftm_set_send_req_cmd
 * 功能描述  : 设置发送请求帧命令的参数
 * 修改历史  :
 * 1.日    期  : 2019年12月03日
 *   作    者  : y00452465
                                                      ...
                                                      mac_ftm_debug_switch_stru *pst_ftm_debug, oal_uint32 *pul_offset)
{
    ...
    *pul_offset = 0;
    ...
    if (uc_cmd_index >= 4) {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{wal_hipriv_ftm_set_send_req_cmd :: invalid cmd index [%d]}", uc_cmd_index);
        return OAL_FAIL;
    }
    /* 填写命令结构体 */
...
/*
 * 函 数 名  : wal_hipriv_blacklist_add
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_blacklist_del
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_blacklist_mode
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_blacklist_show
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_abl_aging
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_abl_threshold
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_abl_reset
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_isolation_mode
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_isolation_type
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_isolation_fwd
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_isolation_clear
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
/*
 * 函 数 名  : wal_hipriv_set_isolation_show
 * 功能描述  :
 * 修改历史  :
 * 1.日    期  : 2014年7月29日
 *   作    者  : chenchongbao
...
OAL_STATIC oal_uint32 wal_hipriv_roam_info(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    *((oal_bool_enum_uint8 *)(st_write_msg.auc_value)) = en_enable;
    ...
    l_ret = wal_send_cfg_event(pst_net_dev,
        WAL_MSG_TYPE_WRITE, WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_bool_enum_uint8),
        (oal_uint8 *)&st_write_msg, OAL_FALSE, OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ROAM, "{wal_hipriv_roam_enable::return err code[%d]!}\r\n", l_ret);
        return (oal_uint32)l_ret;
...
oal_uint32 wal_hipriv_dyn_cali_cfg(oal_net_device_stru *pst_net_dev, oal_int8 *puc_param)
{
    ...
    ***************************************************************************/
    ...
    l_send_event_ret = wal_send_cfg_event(pst_net_dev,
        WAL_MSG_TYPE_WRITE, WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(oal_uint32),
        (oal_uint8 *)&st_write_msg, OAL_FALSE, OAL_PTR_NULL);
...
/*
 * 函 数 名  : protocol_debug_parse_csa_cmd
 * 功能描述  : 解析csa命令参数
 * 修改历史  :
 * 1.日    期  : 2017年4月10日
 *   作    者  : s00404525
...
/*
 * 函 数 名  : wal_hipriv_show_protocol_debug_info
...
/*
 * 函 数 名  : wal_hipriv_sk_pacing_shift
 * 功能描述  : 设置 P 版本发包sk_pacing_shift 参数
 * 修改历史  :
 * 1.日    期  : 2018年7月20日
 *   作    者  : duankaiyong
 *   修改内容  : 新生成函数
...
OAL_STATIC oal_uint32 wal_hipriv_psm_flt_info(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (wal_ioctl_get_psm_info(pst_net_dev, uc_query_type, OAL_PTR_NULL) != OAL_SUCC) {
        return OAL_FAIL;
    }
    return OAL_SUCC;
}
...
/*
 * 函 数 名  : wal_hipriv_set_sae_pwe
 * 功能描述  : 设置WPA3 PWE
 */
OAL_STATIC oal_uint32 wal_hipriv_set_sae_pwe(oal_net_device_stru *net_dev, oal_int8 *param)
{
    oal_uint32 ret;
    oal_uint32 offset;
    oal_int8 cmd_name[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    oal_uint8 sae_pwe;

    /* 获取开关 sh hipriv.sh "wlan0 set_sae_pwe 0|1|2|3" */
    ret = wal_get_cmd_one_arg(param, cmd_name, OAL_SIZEOF(cmd_name), &offset);
    if (ret != OAL_SUCC) {
        return ret;
    }

    sae_pwe = (oal_uint8)oal_atoi((const oal_int8 *)cmd_name);
    if (wal_ioctl_set_sae_pwe(net_dev, sae_pwe) != OAL_SUCC) {
        return OAL_FAIL;
    }
    return OAL_SUCC;
}
...
OAL_CONST wal_hipriv_cmd_entry_stru  g_ast_hipriv_cmd_debug[] = {
...
#ifdef _PRE_WLAN_FEATURE_DFR
    /* dfr功能打桩触发接口?箂h hipriv.sh "vap0 dfr_start 0(dfr子功能:0-device异常复位 )" */
    ...
    /* 设置sae_pwe的值 */
    {"set_sae_pwe",                    wal_hipriv_set_sae_pwe},
};
