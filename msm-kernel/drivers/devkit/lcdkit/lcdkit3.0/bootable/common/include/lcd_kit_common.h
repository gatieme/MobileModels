...
enum lcd_kit_power_type {
	...
	LCD_KIT_EINK_READY,
	LCD_KIT_EINK_VSYS,
	LCD_KIT_EINK_MCU_POWER,
	LCD_KIT_EINK_RESET,
	LCD_KIT_EINK_FASTBOOT,
	LCD_KIT_EINK_CFG,
};
...
struct lcd_kit_power_desc {
	...
	struct lcd_kit_array_data lcd_eink_ready;
	struct lcd_kit_array_data lcd_eink_power_vsys;
	struct lcd_kit_array_data lcd_eink_mcu_power;
	struct lcd_kit_array_data lcd_eink_reset;
	struct lcd_kit_array_data lcd_eink_fastboot;
	struct lcd_kit_array_data lcd_eink_cfg;
};
