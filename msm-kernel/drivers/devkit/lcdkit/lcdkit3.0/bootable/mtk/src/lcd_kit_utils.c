...
static void lcd_kit_parse_power(const void *fdt, int nodeoffset)
{
	...
	lcd_kit_parse_powe_vci(fdt, nodeoffset);
	lcd_kit_parse_powe_iovcc(fdt, nodeoffset);
	lcd_kit_parse_powe_vsp(fdt, nodeoffset);
	lcd_kit_parse_powe_vsn(fdt, nodeoffset);
	lcd_kit_parse_powe_reset(fdt, nodeoffset);
	lcd_kit_parse_powe_backlight(fdt, nodeoffset);
	lcd_kit_parse_powe_te0(fdt, nodeoffset);
	lcd_kit_parse_powe_tp_reset(fdt, nodeoffset);
	lcd_kit_parse_powe_vdd(fdt, nodeoffset);
	lcd_kit_parse_powe_aod(fdt, nodeoffset);
	lcd_kit_parse_powe_poweric(fdt, nodeoffset);
}

static void lcd_kit_parse_powe_vci(const void *fdt, int nodeoffset)
{
	/* vci */
...
static void lcd_kit_parse_powe_iovcc(const void *fdt, int nodeoffset)
{
	/* iovcc */
...
static void lcd_kit_parse_powe_vsp(const void *fdt, int nodeoffset)
{
	/* vsp */
...
static void lcd_kit_parse_powe_vsn(const void *fdt, int nodeoffset)
{
	/* vsn */
...
static void lcd_kit_parse_powe_reset(const void *fdt, int nodeoffset)
{
	/* lcd reset */
...
static void lcd_kit_parse_powe_backlight(const void *fdt, int nodeoffset)
{
	/* backlight */
...
static void lcd_kit_parse_powe_te0(const void *fdt, int nodeoffset)
{
	/* TE0 */
...
static void lcd_kit_parse_powe_tp_reset(const void *fdt, int nodeoffset)
{
	/* tp reset */
...
static void lcd_kit_parse_powe_vdd(const void *fdt, int nodeoffset)
{
	/* lcd vdd */
...
static void lcd_kit_parse_powe_aod(const void *fdt, int nodeoffset)
{
...
static void lcd_kit_parse_powe_poweric(const void *fdt, int nodeoffset)
{
