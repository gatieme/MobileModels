...
sub create_lcd_effect_data_func
{
    ...
    $lcd_effect_func  = "static void lcd_kit_effect_get_data(uint8_t panel_id, struct hisi_panel_info* pinfo)\n";
    $lcd_effect_func .= "{\n";
...
sub create_hisi_panel_effect_init_mock
{
    my $panel_init;
    $panel_init  = "static uint8_t lcd_kit_get_panel_id(uint32_t product_id, char* compatible)\n";
    $panel_init .= "{\n";
