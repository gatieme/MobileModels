...
/* get pmic status */
static ssize_t get_pmic_status(struct device *dev, struct device_attribute *attr, char *buf)
{
	int ret;
...
static DEVICE_ATTR(check_pmic_status, S_IRUGO, get_pmic_status, NULL);
