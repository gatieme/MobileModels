...
#define MEMCPY_SKB_CB_LEN 96
#define MEMCPY_SKB_CB_MPTCP_LEN 128
...
#ifdef CONFIG_MPTCP
#define memcpy_skb_cb(__to, __from) \
	(memcpy((__to)->cb, (__from)->cb, MEMCPY_SKB_CB_MPTCP_LEN))
#else
#define memcpy_skb_cb(__to, __from) \
	(memcpy((__to)->cb, (__from)->cb, MEMCPY_SKB_CB_LEN))
#endif
