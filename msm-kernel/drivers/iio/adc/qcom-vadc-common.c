...
/*
* Resistance to temperature table for 10k ntc + 1k resistance for batt_therm.
*/
static const struct vadc_map_pt adcmap7_11k[] = {
	{ 196652, -40000 },
	{ 185917, -39000 },
	{ 175845, -38000 },
	{ 166391, -37000 },
...
static int qcom_vadc_scale_hw_calib_therm(
				...
				u16 adc_code, int *result_mdec);
#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
static int qcom_vadc7_scale_hw_calib_therm_30k(
				const struct vadc_prescale_ratio *prescale,
				const struct adc5_data *data,
				u16 adc_code, int *result_mdec);
#endif
...
static struct qcom_adc5_scale_type scale_adc5_fn[] = {
	...
	[SCALE_HW_CALIB_THERM_30K_PU_PM7] = {
					qcom_vadc7_scale_hw_calib_therm_30k},
#endif
				...
				u16 adc_code, int *result_mdec)
{
	...
	ret = qcom_vadc_map_voltage_temp(adcmap7_11k,
				 ARRAY_SIZE(adcmap7_11k),
				 resistance, &result);
	if (ret)
		return ret;
