#include "hostprocessing/touchscreen_interface.h"
...
#define  FP_IOC_CMD_WAKELOCK_TIMEOUT  _IO(FP_IOC_MAGIC, 24)
#define  FP_IOC_CMD_GET_LOCAL_HBM_SUPPORT   _IO(FP_IOC_MAGIC, 25)
#define  FP_IOC_CMD_SET_LOCAL_HBM_LEVEL    _IO(FP_IOC_MAGIC, 26)
#define  FP_IOC_CMD_GET_LOCAL_HBM_INTERRUPTED_BY_POWER  _IO(FP_IOC_MAGIC, 27)
#define  FP_IOC_CMD_GET_TOUCH_DURATION  _IO(FP_IOC_MAGIC, 28)
...
#define fpc_log_info(fmt, args...) pr_info("%s: " fmt, __func__, ## args)
#else
...
struct fp_data
{
	...
	struct tp_to_udfp_data udfp_data;
