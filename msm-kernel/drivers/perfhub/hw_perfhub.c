...
#ifdef CONFIG_HW_CORE_CTRL
#include <linux/hw_core_ctl.h>
#endif
#include <securec.h>
#include "../../../kernel/sched/sched.h"
#include <trace/events/sched.h>
#define CREATE_TRACE_POINTS
#include "perfhub_trace.h"

#ifndef strict_strtol
#define strict_strtol  kstrtol
#endif

#define QCOM_NR_CPUS 8
...
extern int security_task_setscheduler(struct task_struct *p);
...
again:
#ifdef CONFIG_HW_CPU_ISOLATION_STRICT
...
static ssize_t perfhub_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	if (cpumask < 0 || cpumask > ((1 << QCOM_NR_CPUS) - 1)) {
...
MODULE_DESCRIPTION("Huawei perf hub");
