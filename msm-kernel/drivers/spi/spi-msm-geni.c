...
#define SPI_AUTO_SUSPEND_DELAY	(40)
...
#define RSMC_SPI_ENB_IRQ_DELAY	500
...
static int spi_geni_probe(struct platform_device *pdev)
{
	...
	geni_mas->ipc = ipc_log_context_create(1000, dev_name(geni_mas->dev), 0);
