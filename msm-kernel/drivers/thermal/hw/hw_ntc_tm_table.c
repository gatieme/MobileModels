...
int hw_peripheral_ntc_2_temp(struct periph_tsens_tm_device_sensor *chip,
			       int *temp, int ntc)
{
	int tempdata = 0;
...
int hw_mdm_ntc_2_temp(struct hw_mdm_adc_t *mdm_sensor, int *temp, int ntc)
{
	int tempdata = 0;
...
int hw_peripheral_temp_2_ntc(struct periph_tsens_tm_device_sensor *chip,
			       int temp, u16 *ntc)
{
	if (chip->ntc_name == NULL) {
