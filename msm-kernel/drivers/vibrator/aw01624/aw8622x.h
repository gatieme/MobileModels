...
extern int aw8622x_haptic_stop(struct aw8622x *aw8622x);
extern void aw8622x_haptic_set_rtp_aei(struct aw8622x *aw8622x, bool flag);
extern void aw8622x_haptic_file_config(struct aw8622x *aw8622x, uint64_t type);
