...
#ifdef CONFIG_HW_IPV6_TCP_SYNC_COLLEC
...
const u16 cmd_map_model[CMD_NUM_MAX][MAP_ENTITY_NUM] = {
	...
	{GAME_FLOW_QOE_CMD, IP_PARA_COLLEC},
	...
	{ KERNEL_MSG_CLOSE_UDP_FLOW, BOOSTER_COMM },
	{ FG_CHANGE_UID, IP_PARA_COLLEC },
	{ KERNEL_MSG_IPV6_SYNC_UPDATE_UID, IPV6_TCP_SYNC_COLLEC},
	{ KERNEL_MSG_UPDATE_INTERFACE_INFO_IPV6, IPV6_TCP_SYNC_COLLEC},
	{ KERNEL_MSG_SCREEN_STATUS_CMD, IPV6_TCP_SYNC_COLLEC}
};
...
#ifdef CONFIG_HW_IPV6_TCP_SYNC_COLLEC
	{ IPV6_TCP_SYNC_COLLEC, hw_ipv6_tcp_sync_collec_init, "hw_ipv6_tcp_sync_collec_init" },
#endif
};
