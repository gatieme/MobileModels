...
static inline void dc_anomaly_det_work(struct work_struct *work)
{
}
...
static inline enum hrtimer_restart dc_anomaly_det_timer_func(
	struct hrtimer *timer)
{
	return HRTIMER_NORESTART;
}
...
static inline void dc_init_work(int local_mode)
{
}
