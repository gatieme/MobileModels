...
#define HWSCP_ADP_TYPE0_PORT_MASK           (BIT(1) | BIT(0))

#define HWSCP_ADP_PORT_A                    0
#define HWSCP_ADP_PORT_C                    1
...
#define HWSCP_VENDOR_ID_RICHTEK_PT          0xB100
...
#define HWSCP_PWR_CURVE_VOLT_STEP           500 /* mV */
#define HWSCP_PWR_CURVE_CUR_STEP            100 /* mA */

#define HWSCP_PC_DETECT_BIT                 BIT(1)
#define HWSCP_PC_RESULT_BIT                 BIT(0)
#define HWSCP_PC_PARA_LEVEL                 16
#define HWSCP_PC_PARA_SIZE                  2
...
#define HWSCP_IERR_A_MASK                   BIT(7)
#define HWSCP_IERR_A_SHIFT                  7
#define HWSCP_IERR_B_MASK                   (BIT(6) | BIT(5) | BIT(4) | BIT(3) | \
	BIT(2) | BIT(1) | BIT(0))
#define HWSCP_IERR_B_SHIFT                  0
#define HWSCP_IERR_BASE                     10
...
struct hwscp_dev {
	...
	struct adp_pwr_curve_para pwr_curve[HWSCP_PC_PARA_LEVEL];
	unsigned int pwr_curve_flag;
	int pwr_curve_size;
	bool fake_pwr_curve;
};
