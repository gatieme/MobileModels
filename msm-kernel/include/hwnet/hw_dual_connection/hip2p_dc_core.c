 ...
 * Description: HiGame2.0's hip2p module. It uses Dual Connection to send THE
 * same game's packet, peer terminal receives THE duplications of it from the
 * DC and drops the LATER copy.
 * Author: l00473802
 * Create: 2019-05-21
 */
