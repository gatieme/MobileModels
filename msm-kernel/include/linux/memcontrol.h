...
struct mem_cgroup {
	...
	atomic64_t hyperhold_parfile_stored_pages;
	atomic64_t hyperhold_parfile_stored_size;
	...
	atomic64_t fault_out_lat[FAULT_OUT_LAT_DIST];
	atomic64_t fault_out_lat_fg[FAULT_OUT_LAT_DIST];

	unsigned long zram_hot_lru;
	atomic64_t vma_hot_warm_size;
	atomic64_t zram_stored_hot_size;
	atomic64_t zram_stored_hot_pages;
	atomic64_t hyperhold_stored_hot_pages;
	atomic64_t hyperhold_stored_hot_size;
	atomic64_t last_active_swapout_size;

	atomic64_t hyperhold_allfaultcnt_hot;
	atomic64_t hyperhold_faultcnt_hot;
	atomic64_t hyperhold_faultcnt_hot_fg;
	...
	atomic64_t active_swapout_cnt;
	atomic64_t vma_part_swap_ratio;
	atomic_t active_swapout_type;
