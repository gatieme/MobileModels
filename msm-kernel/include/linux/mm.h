...
#define VM_ANON_HOT	0x00000001	/* VMA hot pages for hyperhold */
#endif
...
#ifdef CONFIG_HUAWEI_SWAP_ZDATA
extern int reclaim_pages_from_list(struct list_head *page_list, bool hiber, unsigned int *nr_writedblock);
#endif
...
extern void all_active_reclaim_by_task(struct task_struct *);
#endif
