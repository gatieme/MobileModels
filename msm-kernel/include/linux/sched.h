...
# define MAX_LOCK_DEPTH			48UL
	...
	unsigned int wakeup_new_task_fast;
#endif
	...
	ANDROID_VENDOR_DATA_ARRAY(1, 80);
	...
	/* cumulative_yield_time, last_yield_ts */
	ANDROID_VENDOR_DATA_ARRAY(2, 2);

	/* mm_struct *remote_mm  */
	ANDROID_VENDOR_DATA_ARRAY(3, 1);
...
#ifdef CONFIG_HW_GRADED_SCHED
extern void set_graded_nice(struct task_struct *p, long nice);
extern void set_graded_load_weight(struct task_struct *p, bool update_load);
#endif
