...
void hw_eas_sched_dest_rq(int src_cpu, const struct cpumask *cpus_ptr, struct rq **dst_rq)
{
	int i;
...
#if defined(CONFIG_HW_EAS_SCHED)
	hw_eas_sched_dest_rq(src_cpu, cpus_ptr, &dst_rq);
#else
