...
#if IS_ENABLED(CONFIG_HW_RTG_NORMALIZED_UTIL) && IS_ENABLED(CONFIG_HW_RTG)
...
int __init init_sched_rtg_debug_procfs(void)
{
...
EXPORT_SYMBOL(init_sched_rtg_debug_procfs);
#else
