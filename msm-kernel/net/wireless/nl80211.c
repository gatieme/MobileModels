...
#include <booster/wifi_para_collec.h>
#include "core.h"
#include "nl80211.h"
#include "reg.h"
#include "rdev-ops.h"
			       ...
			       const u8 *ie, size_t ie_len, bool from_ap)
{
	...
	if (nla_put_u32(msg, NL80211_ATTR_WIPHY, rdev->wiphy_idx) ||
	    ...
	    (reason &&
	     ...
	     nla_put(msg, NL80211_ATTR_MAC, ETH_ALEN, netdev->ieee80211_ptr->disconnect_bssid) ||
	    (from_ap &&
...
{
	int err;
	cfg80211_get_station_register(cfg80211_get_station);
	cfg80211_calculate_bitrate_register(cfg80211_calculate_bitrate);
