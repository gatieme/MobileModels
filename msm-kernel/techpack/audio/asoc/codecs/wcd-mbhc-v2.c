		      ...
		      bool impedance_det_en)
{
	...
	if (of_find_property(card->dev->of_node, usb_c_dt, NULL))
		ret = of_property_read_u32(card->dev->of_node, usb_c_dt, &enable_usbc_analog);

	pr_debug("%s: enable_usbc_analog: %d\n", __func__, enable_usbc_analog);
