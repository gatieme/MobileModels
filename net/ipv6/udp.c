...
#ifdef CONFIG_HONOR_XENGINE
	struct sockaddr_in6 mpflow_usin = {0};
#endif
...
#ifdef CONFIG_HONOR_XENGINE
	mpflow_usin.sin6_addr = *daddr;
	mpflow_usin.sin6_port = fl6.fl6_dport;
	mpflow_usin.sin6_family = AF_INET6;
	emcom_xengine_mpflow_ai_bind2device(sk, (struct sockaddr *)(&mpflow_usin));
#endif
	if (!fl6.flowi6_oif)
