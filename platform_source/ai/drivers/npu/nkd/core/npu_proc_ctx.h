...
struct npu_proc_ctx {
	...
	struct list_head excpt_task_set;
...
#define NPU_GET_ALL_EXEC_INFO  0
#define NPU_GET_PART_EXEC_INFO 1
...
int npu_proc_set_model_priority(struct npu_proc_ctx *proc_ctx,
	npu_model_prio_info_t model_prio_info);

int npu_proc_set_model_profiling(struct npu_proc_ctx *proc_ctx,
	npu_model_profiling_info_t model_profiling_info);

int npu_save_model_info(struct npu_proc_ctx *proc_ctx,
	npu_model_desc_t *model_desc);

int npu_proc_get_model_info(struct npu_proc_ctx *proc_ctx,
	u32 model_id, npu_model_desc_sub_t *model_desc_sub);
...
int npu_proc_get_execute_info(struct npu_proc_ctx *proc_ctx,
	struct npu_toughness_info *toughness_info);

int npu_proc_set_execute_enable(struct npu_proc_ctx *proc_ctx,
	struct npu_enable_info *enable_info);
