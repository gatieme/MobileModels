	...
	npu_rt_task_t *hwts_task)
{
	...
	if (hwts_task->u.kernel_task.stack_buff_addr == 0) {
		npu_drv_err("invalid stack_buff_addr is 0, task_id:%u\n",
			hwts_task->task_id);
		return -1;
	}
...
int verify_aiv_task(struct npu_proc_ctx *proc_ctx,
	npu_rt_task_t *hwts_task)
{
...
verify_hwts_task_func verify_hwts_task_map[] = {
	...
	/* 24           25                        26                      27 */
	NULL,           verify_aiv_task,          NULL,                   NULL,
	/* 28           29                        30                      31 */
	NULL,           NULL,                     NULL,                   NULL,
	/* 32           33                        34                      35 */
	NULL,           NULL,                     NULL,                   NULL,
