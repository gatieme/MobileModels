...
#ifdef CONFIG_HIFI_NPU_ROUTE
	{ ID_DSP_AP_NN_ROUTE_WRITE_COMPLETE, 0, rcv_nn_dsp_route_msg },
#endif
};
...
#ifdef CONFIG_HIFI_SECOS_LOAD
	dsp_load_init(g_misc_data.base_virt);
#endif
...
#ifdef CONFIG_DKMD_DKSM
	dkmd_register_client(&dsp_fb_notifier_block);
#else
...
{
#ifdef CONFIG_DKMD_DKSM
	dkmd_unregister_client(&dsp_fb_notifier_block);
#else
