...
/* ID of this CPU */
#define MAILBOX_LOCAL_CPUID MAILBOX_CPUID_RDA
#define MAILBOX_CHANNEL_NUM \
	(MAILBOX_CHANNEL_BUTT(RDA, HIFI) + MAILBOX_CHANNEL_BUTT(HIFI, RDA))
#define MAILBOX_USER_NUM (MAILBOX_USER_BUTT(HIFI, RDA, MSG))
#else
/* ID of this CPU */
