...
/* rdr modid for dsp from 0x84000000(DFX_BB_MOD_HIFI_START) to 0x84ffffff(DFX_BB_MOD_HIFI_END) */
enum rdr_audio_modid {
	RDR_AUDIO_MODID_START = DFX_BB_MOD_HIFI_START,
	RDR_AUDIO_SOC_WD_TIMEOUT_MODID,
	RDR_AUDIO_CODEC_WD_TIMEOUT_MODID,
	RDR_AUDIO_ASP_BUS_EXCEPTION_MODID,
	...
	RDR_AUDIO_MODID_END = DFX_BB_MOD_HIFI_END
};
