...
#if defined(CONFIG_PRODUCT_CDC_ACE) || defined(CONFIG_RDA_AUDIO_DRIVERS)
...
#define CMA_UNSEC_BASE_ADDR    RESERVED_FASTBOOT_CMA_PHYMEM_BASE
...
#define DSP_MUSIC_DATA_SIZE                (0x132000 + 0x32000 - 0x100000)
#define PCM_PLAY_BUFF_SIZE                 (0x200000 - 0x32000 + 0x100000)
#else
...
#else
#define DSP_SOUND_ENHANCE_BUFF_SIZE        0x0
#endif
...
#elif defined CONFIG_HIFI_MEMORY_15M
#define AP_AUDIO_WAKEUP_RINGBUFEER_SIZE    0x1000
#define AP_AUDIO_WAKEUP_CAPTURE_SIZE       0x1000
#else
#define AP_AUDIO_WAKEUP_RINGBUFEER_SIZE    0x1E000
#define AP_AUDIO_WAKEUP_CAPTURE_SIZE       0x3000
#endif
...
#define DSP_UNSEC_RESERVE_SIZE      0x41C00
#else
#define DSP_UNSEC_RESERVE_SIZE      0x46C00
#endif
#else
#ifdef CONFIG_HIFI_NPU_ROUTE
#define DSP_UNSEC_RESERVE_SIZE      0x43C00
#else
...
#ifdef CONFIG_HIFI_NPU_ROUTE
#define NN_DSP_ROUTE_INPUT_BUFFER_SIZE    0x5400
#define NN_DSP_ROUTE_OUTPUT_BUFFER_SIZE   0x5400
#else
#define NN_DSP_ROUTE_INPUT_BUFFER_SIZE    0x0
#define NN_DSP_ROUTE_OUTPUT_BUFFER_SIZE   0x0
#endif
...
#define HIFI_NN_DSP_ROUTE_INPUT_ADDR (HIFI_SOUND_ENHANCE_PARA_ADDR + DSP_SOUND_ENHANCE_BUFF_SIZE)
#define HIFI_NN_DSP_ROUTE_OUTPUT_ADDR (HIFI_NN_DSP_ROUTE_INPUT_ADDR + NN_DSP_ROUTE_INPUT_BUFFER_SIZE)
#define DSP_UNSEC_RESERVE_ADDR (HIFI_NN_DSP_ROUTE_OUTPUT_ADDR + NN_DSP_ROUTE_OUTPUT_BUFFER_SIZE)
...
/* for CDC RDA */
/* 1M */
/* |~~~PCM data~~~|~~~AP NV ~~~|~RDA&HIFI MB~|~~reserve~~~| */
/* |~~~~799.7k~~~~|~~~~100k~~~~|~~~~~64k~~~~~|~~~~~60k~~~~| */
#define HIFI_RDA_BASE_ADDR   RESERVED_RDA_HIFI_PHYMEM_BASE
#define HIFI_RDA_REGION_SIZE RESERVED_RDA_HIFI_PHYMEM_BASE_SIZE
#define HIFI_RDA_PCM_DATA_ADDR HIFI_RDA_BASE_ADDR
#define HIFI_RDA_PCM_DATA_SIZE 0xc7ec0
#define HIFI_RDA_NV_DATA_ADDR (HIFI_RDA_PCM_DATA_ADDR + HIFI_RDA_PCM_DATA_SIZE)
#define HIFI_RDA_NV_DATA_SIZE 0x19000
#define HIFI_RDA_MAILBOX_BASE_ADDR (HIFI_RDA_NV_DATA_ADDR + HIFI_RDA_NV_DATA_SIZE)
#define HIFI_RDA_MAILBOX_SIZE 0x10000
