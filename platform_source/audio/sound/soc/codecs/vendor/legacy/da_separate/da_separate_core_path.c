...
static const struct snd_kcontrol_new au_en_mixer[] = {
	SOC_DAPM_SINGLE("AU_DACL_EN",    VIR0_ADDR, REG_BIT11, 1, 0),
	SOC_DAPM_SINGLE("AU_DACR_EN",    VIR0_ADDR, REG_BIT12, 1, 0),
	SOC_DAPM_SINGLE("AU_DACUL_EN",   VIR1_ADDR, REG_BIT2, 1, 0),
	SOC_DAPM_SINGLE("AU_DAC_SPA_EN", CODEC_CLK_EN3_REG, CLASSH_CLKEN_OFFSET, 1, 0),
	SOC_DAPM_SINGLE("AU_ADCL_EN",    VIR0_ADDR, REG_BIT13, 1, 0),
	SOC_DAPM_SINGLE("AU_ADCR_EN",    VIR0_ADDR, REG_BIT14, 1, 0),
	SOC_DAPM_SINGLE("AU_ADC3_EN",    VIR0_ADDR, REG_BIT15, 1, 0),
	SOC_DAPM_SINGLE("AU_ADC_SPA_EN", VIR1_ADDR, REG_BIT1, 1, 0),
};
...
static const struct soc_enum ad_da_loopback_mux_enum =
	SOC_ENUM_SINGLE(DAC_FILTER_CTRL_REG, AU_MST_P2S_LOOPBACK_OFFSET,
...
static const struct soc_enum da_ad_loopback_mux_enum =
	SOC_ENUM_SINGLE(DAC_FILTER_CTRL_REG, AU_MST_S2P_LOOPBACK_OFFSET,
...
static const struct soc_enum adc_loopback_mux_enum =
	SOC_ENUM_SINGLE(AU_LOOPBACK_CFG_REG, ADC_LOOPBACK_OFFSET,
...
static const struct soc_enum dac_loopback_mux_enum =
	SOC_ENUM_SINGLE(AU_LOOPBACK_CFG_REG, DAC_LOOPBACK_OFFSET,
...
#define CORE_MIXER_WIDGET \
	...
	SND_SOC_DAPM_MIXER("AU_EN MIXER", CODEC_CLK_EN1_REG, AU_MST_CLKEN_OFFSET, 0, \
