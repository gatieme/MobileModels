	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		da_separate_update_bits(codec, CODEC_CLK_EN1_REG, BIT(CODEC3_L_DN_AFIFO_CLKEN_OFFSET), 0);
		da_separate_update_bits(codec, CODEC_CLK_EN1_REG, BIT(CODEC3_R_DN_AFIFO_CLKEN_OFFSET), 0);
	...
	case SND_SOC_DAPM_POST_PMD:
		...
		da_separate_update_bits(codec, CODEC_CLK_EN1_REG, BIT(CODEC3_L_DN_AFIFO_CLKEN_OFFSET), 0);
		/* disable pga */
		da_separate_update_bits(codec, CODEC_CLK_EN3_REG, BIT(CODEC3_L_DN_PGA_CLKEN_OFFSET), 0);
		da_separate_update_bits(codec, CODEC_CLK_EN3_REG, BIT(CODEC3_R_DN_PGA_CLKEN_OFFSET), 0);
		break;
	default:
