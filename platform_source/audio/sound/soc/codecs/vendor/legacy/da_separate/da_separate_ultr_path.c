/*
 * da_separate_ultr_path.c codec driver.
 *
...
#define LOG_TAG "DA_separate_ultr"
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		da_separate_update_bits(codec, DACML_FILTER_CTRL_REG,
		...
		/* au smt dac ultr enable */
		da_separate_update_bits(codec, DAC_FILTER_CTRL_REG,
			BIT(AU_MST_DAC_ULTR_EN_OFFSET), BIT(AU_MST_DAC_ULTR_EN_OFFSET));
		break;
	case SND_SOC_DAPM_PRE_PMD:
		...
		/* au smt dac ultr disable */
		da_separate_update_bits(codec, DAC_FILTER_CTRL_REG,
			BIT(AU_MST_DAC_ULTR_EN_OFFSET), 0);
		break;
	default:
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		/* hbfvd filter bypass */
		da_separate_update_bits(codec, ADC_ULTR_FILTER_CTRL_REG,
...
#define ULTR_UPLINK \
	...
	{ "ADC_ULTR MUX",              "ADC3",           "AU_EN MIXER" }, \
	{ "ADC_ULTR MUX",              "ADC2",           "AU_EN MIXER" }, \
	{ "ADC_ULTR MUX",              "ADC3",           "DA_AD_LOOP MUX" }, \
	{ "ADC_ULTR MUX",              "ADC2",           "ADCR_FILTER" }, \
	{ "ADC3 PGA",                  NULL,             "ADC_ULTR MUX" }, \
	{ "ADC_ULTR_FILTER",           NULL,             "ADC3 PGA" }, \
	{ "ULTR_UP_FIFO SWITCH",       "ENABLE",         "ADC_ULTR_FILTER" }, \
	{ "ULTR_UP_FIFO SWITCH",       NULL,             "PLL" }, \
	{ "ULTR_UP_FIFO SWITCH",       NULL,             "SIF_CLK" }, \
...
#define ULTR_SOC_DOWNLINK \
	...
	{ "ULTR_DLINK_FIFO SWITCH",    NULL,              "SIF_CLK" }, \
	{ "ULTR_DL MUX",               "ULTR_D_FIFO",     "ULTR_DLINK_FIFO SWITCH" }, \
	{ "ADC3 PGA",                  NULL,              "ADC_ULTR MUX" }, \
	{ "ULTR_DL MUX",               "ADC_ULTR",        "ADC3 PGA" }, \
	...
	{ "AU_EN MIXER",               "AU_DACUL_EN",     "DACL_ULTR_FILTER" }, \
	{ "ULTR_DLINK OUTPUT",         NULL,              "AU_EN MIXER" }, \

#define ULTR_ANALOG_DOWNLINK \
	{ "ANA_AU_EN MIXER",         "ANA_AU_ULTR_EN",   "SMT_ANA_DAC_SDATA INPUT" }, \
	{ "ANA_DAC_ULTR SWITCH",     "DAC_ULTR",         "ANA_AU_EN MIXER" }, \
...
int add_ultr(struct snd_soc_component *codec)
{
	...
	return da_separate_add_codec_resource(codec, &ultr_resource);
}
