/*
 * da_separate_voice_path.c codec driver.
 *
...
#define LOG_TAG "DA_separate_voice"
...
#define VOICE_UPLINK \
	...
	{ "VOICE_UL_FIFO SWITCH",   NULL,       "SIF_CLK" }, \
	{ "VOICE_UR_FIFO SWITCH",   NULL,       "SIF_CLK" }, \
...
int add_voice(struct snd_soc_component *codec)
{
	...
	return da_separate_add_codec_resource(codec, &voice_resource);
}
