...
#define AUIDO_PCM_SPATIAL_AUDIO_MAX_CHANNELS 16
...
static struct snd_soc_dai_driver g_audio_pcm_dai[] = {
	...
	{
		.name = "asp-pcm-spatial-audio",
		.playback = {
			.stream_name  = "asp-pcm-spatial-audio Playback",
			.channels_min = AUIDO_PCM_PB_MIN_CHANNELS,
			.channels_max = AUIDO_PCM_SPATIAL_AUDIO_MAX_CHANNELS,
			.rates        = AUIDO_PCM_PB_RATES,
			.formats      = AUIDO_PCM_PB_FORMATS
		},
	},
...
/* define the capability of playback channel for spatial audio device */
static const struct snd_pcm_hardware g_audio_pcm_hardware_spatial_audio_playback = {
	.info             = SNDRV_PCM_INFO_INTERLEAVED
		| SNDRV_PCM_INFO_NONINTERLEAVED
		| SNDRV_PCM_INFO_MMAP
		| SNDRV_PCM_INFO_MMAP_VALID
	...
	.channels_min     = AUIDO_PCM_PB_MIN_CHANNELS,
	.channels_max     = AUIDO_PCM_SPATIAL_AUDIO_MAX_CHANNELS,
	.buffer_bytes_max = PCM_DMA_BUF_SPATIAL_AUDIO_LEN,
	.period_bytes_min = AUIDO_PCM_MIN_BUFFER_SIZE,
	.period_bytes_max = PCM_DMA_BUF_SPATIAL_AUDIO_LEN,
	.periods_min      = AUIDO_PCM_MIN_PERIODS,
	.periods_max      = AUIDO_PCM_MAX_PERIODS,
	.fifo_size        = AUIDO_PCM_PB_FIFO_SIZE,
};
...
static const struct snd_pcm_hardware *g_audio_pcm_hw_info[PCM_DEVICE_TOTAL][PCM_STREAM_MAX] = {
	...
	{ &g_audio_pcm_hardware_spatial_audio_playback, NULL }, /* PCM_DEVICE_SPATIAL_AUDIO */
};
