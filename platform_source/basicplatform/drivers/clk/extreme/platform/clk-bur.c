...
static const struct gate_clock crgctrl_gate_clks[] = {
	...
	{ CLK_GATE_ODT_ACPU, "clk_odt_acpu", "clk_dmabus_div", 0x010, 0x10000000, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "clk_odt_acpu" },
	{ CLK_GATE_TCLK_ODT, "tclk_odt", "clk_sys_ini", 0, 0x0, 0,
		"clk_odt_acpu", 0, {0}, {0}, 0, 0, 0, "tclk_odt" },
	{ CLK_GATE_PFA_TFT, "clk_pfa_tft", "div_sysbus_pll", 0x000, 0x80, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "clk_pfa_tft" },
	{ CLK_GATE_PFA_TFT_PSAM, "clk_pfa_tft_psam", "div_sysbus_pll", 0x000, 0x100, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "clk_pfa_tft_psam" },
...
static const struct div_clock crgctrl_div_clks[] = {
	{ CLK_DIV_CFGBUS, "sc_div_cfgbus", "div_sysbus_pll",
		0x0EC, 0x3, 4, 1, 0, "sc_div_cfgbus" },
	{ PCLK_DIV_DBG, "pclkdiv_dbg", "clk_cssys_div",
		0x1A0, 0x6000, 4, 1, 0, "pclkdiv_dbg" },
	{ TRACKCLKIN_DIV, "clkdiv_track", "clk_cssys_div",
		0x128, 0x3000, 4, 1, 0, "clkdiv_track" },
	...
	{ CLK_DIV_TIME_STAMP, "clk_timestp_div", "clk_timestp_gt",
		0x1A0, 0x1c0, 8, 1, 0, "clk_timestp_div" },
	...
	{ CLK_DIV_SPI4, "clkdiv_spi4", "clkgt_spi4",
		0x0D0, 0xf0, 16, 1, 0, "clkdiv_spi4" },
	{ CLK_DIV_USBDP, "clk_div_usbdp", "clkgt_mmc_usbdp",
		0x710, 0xf, 16, 1, 0, "clk_div_usbdp" },
	...
	{ CLK_DIV_VDEC, "clkdiv_vdec", "clkgt_vdec",
		0x0C4, 0x3f, 64, 1, 0, "clkdiv_vdec" },
	{ CLK_DIV_VENC, "clkdiv_venc", "clkgt_venc",
		0x0C0, 0x3f00, 64, 1, 0, "clkdiv_venc" },
...
static const struct gate_clock mmc0crg_gate_clks[] = {
	...
	{ CLK_ULPI_REF, "clk_ulpi_ref", "clk_sys_ini", 0, 0x0, 0,
...
static const struct scgt_clock mmc0crg_scgt_clks[] = {
	{ CLKANDGT_USB2PHY_REF, "clkgt_usbphy_38d4m_ref", "clkin_sys",
		0x010, 1, CLK_GATE_HIWORD_MASK, "clkgt_usbphy_38d4m_ref" },
	{ CLK_MUX_USB19D2PHY, "clk_mux_usb19d2phy", "clkdiv_usb2phy_ref",
		0x010, 2, CLK_GATE_HIWORD_MASK, "clk_mux_usb19d2phy" },
};
...
static const struct div_clock media1crg_div_clks[] = {
	{ CLK_DIV_VIVOBUS, "clk_vivobus_div", "clk_vivobus_gt",
		0x074, 0x3f, 64, 1, 0, "clk_vivobus_div" },
	{ CLK_DIV_EDC0, "clk_edc0_div", "clk_edc0_gt",
		0x068, 0x3f, 64, 1, 0, "clk_edc0_div" },
	...
	{ CLK_DIV_ISPCPU, "clk_ispcpu_div", "clk_ispcpu_gt",
		0x070, 0x3f, 64, 1, 0, "clk_ispcpu_div" },
...
static const struct xfreq_clock xfreq_clks[] = {
	{ CLK_XFREQ_CLUSTER0, "cpu-cluster.0", 0, 0, 0, 0x41C, { 0x0001030A, 0x0 }, { 0x0001020A, 0x0 }, "cpu-cluster.0" },
	{ CLK_XFREQ_CLUSTER1, "cpu-cluster.1", 1, 0, 0, 0x41C, { 0x0002030A, 0x0 }, { 0x0002020A, 0x0 }, "cpu-cluster.1" },
	{ CLK_XFREQ_G3D, "clk_g3d", 2, 0, 0, 0x41C, { 0x0003030A, 0x0 }, { 0x0003020A, 0x0 }, "clk_g3d" },
	{ CLK_XFREQ_DDRC_FREQ, "clk_ddrc_freq", 3, 0, 0, 0x41C, { 0x00040309, 0x0 }, { 0x0004020A, 0x0 }, "clk_ddrc_freq" },
	{ CLK_XFREQ_DDRC_MAX, "clk_ddrc_max", 5, 1, 0x8000, 0x250, { 0x00040308, 0x0 }, { 0x0004020A, 0x0 }, "clk_ddrc_max" },
	{ CLK_XFREQ_DDRC_MIN, "clk_ddrc_min", 4, 1, 0x8000, 0x270, { 0x00040309, 0x0 }, { 0x0004020A, 0x0 }, "clk_ddrc_min" },
	{ CLK_XFREQ_L1BUS_MIN, "clk_l1bus_min", 6, 1, 0x8000, 0x230,
		{ 0x00040309, 0x0 }, { 0x0004020A, 0x0 }, "clk_l1bus_min" },
};
...
static void clk_mmc0crg_init(struct device_node *np)
{
	...
	unsigned int nr = ARRAY_SIZE(mmc0crg_scgt_clks) +
...
static void clk_sctrl_init(struct device_node *np)
{
	...
	unsigned int nr = ARRAY_SIZE(sctrl_div_clks) +
...
static void clk_pctrl_init(struct device_node *np)
{
	...
	unsigned int nr = ARRAY_SIZE(pctrl_mux_clks);
...
static void clk_media2_init(struct device_node *np)
{
	...
	unsigned int nr = ARRAY_SIZE(media2crg_gate_clks);
