...
static const struct fixed_factor_clock fixed_factor_clks[] = {
	{ CLK_DIV_PPLL2_B, "clk_div_ppll2_b", "clk_ap_ppll2", 2, 3, 0, "clk_div_ppll2_b" },
	{ CLK_GATE_PPLL2_B, "clk_ap_ppll2_b", "clk_div_ppll2_b", 1, 1, 0, "clk_ap_ppll2_b" },
	...
	{ CLK_GATE_ODT_DEFLATE, "clk_odt_deflat", "clk_odtdef_div", 1, 1, 0, "clk_odt_deflat" },
	{ ACLK_GATE_DSS, "aclk_dss", "clk_spll", 1, 3, 0, "aclk_dss" },
	{ CLK_SDIO_SYS, "clk_sdio_sys", "clk_sdio_sys_gt", 1, 6, 0, "clk_sdio_sys" },
	{ HCLK_GATE_SDIO, "hclk_sdio", "clk_div_hsdt1bus", 1, 1, 0, "hclk_sdio" },
	...
	{ CLK_MUX_ULPI, "sel_ulpi_ref", "clk_eusb_38m4", 1, 1, 0, "sel_ulpi_ref" },
	{ CLK_GATE_ULPI_REF, "clk_ulpi_ref", "clk_eusb_38m4", 1, 1, 0, "clk_ulpi_ref" },
	...
	{ CLK_GATE_ABB_USB, "clk_abb_usb", "clk_eusb_38m4", 1, 1, 0, "clk_abb_usb" },
	{ CLK_PCIE1PLL_SERDES, "clk_pcie1pll_serdes", "clk_eusb_38m4", 1, 1, 0, "clk_pcie1pll_serdes" },
...
static const struct gate_clock crgctrl_gate_clks[] = {
	...
	{ CLK_GATE_PPLL3_MEDIA, "clk_ppll3_media", "clk_ap_ppll3", 0, 0x0, ALWAYS_ON,
	...
	{ CLK_GATE_PPLL3_M2, "clk_ppll3_m2", "clk_ap_ppll3", 0, 0x0, ALWAYS_ON,
	...
	{ CLK_GATE_PFA_TFT, "clk_pfa_tft", "clk_dmabus_div", 0x0, 0x80, 0,
	...
	{ PERI_VOLT_NO_AVS_L, "peri_volt_no_avs_l", "clk_sys_ini", 0, 0x0, 0,
		NULL, 1, {0}, {0}, 0, 17, 0, "peri_volt_no_avs_l" },
};
...
static const struct fsm_pll_clock sctrl_fsm_pll_clks[] = {
...
static const struct mux_clock crgctrl_mux_clks[] = {
	...
	{ CLK_ISP_SNCLK_MUX1, "clk_mux_ispsn1", clk_isp_snclk_mux1_p,
		ARRAY_SIZE(clk_isp_snclk_mux1_p), 0x10C, 0x100, CLK_MUX_HIWORD_MASK, "clk_mux_ispsn1" },
	{ CLK_ISP_SNCLK_MUX2, "clk_mux_ispsn2", clk_isp_snclk_mux2_p,
		ARRAY_SIZE(clk_isp_snclk_mux2_p), 0x10C, 0x40, CLK_MUX_HIWORD_MASK, "clk_mux_ispsn2" },
	{ CLK_ISP_SNCLK_MUX3, "clk_mux_ispsn3", clk_isp_snclk_mux3_p,
		ARRAY_SIZE(clk_isp_snclk_mux3_p), 0x100, 0x40, CLK_MUX_HIWORD_MASK, "clk_mux_ispsn3" },
...
static const struct gate_clock hsdtctrl_gate_clks[] = {
	{ CLK_GATE_HSDT0_PCIE0_MCU, "clk_hsdt0_pcie0_mcu", "clk_hsdt_subsys_ini", 0x010, 0x20000, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "clk_hsdt0_pcie0_mcu" },
	{ CLK_GATE_HSDT0_PCIE1_MCU, "clk_hsdt0_pcie1_mcu", "clk_hsdt_subsys_ini", 0x000, 0x20000, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "clk_hsdt0_pcie1_mcu" },
	{ CLK_GATE_HSDT0_PCIE0_MCU_BUS, "clk_hsdt0_pcie0_mcu_bus", "clk_hsdt_subsys_ini", 0x010, 0x10000, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "clk_hsdt0_pcie0_mcu_bus" },
	{ CLK_GATE_HSDT0_PCIE1_MCU_BUS, "clk_hsdt0_pcie1_mcu_bus", "clk_hsdt_subsys_ini", 0x000, 0x10000, 0,
	...
	{ PCLK_GATE_PCIE_SYS, "pclk_pcie_sys", "clk_hsdt_subsys_ini", 0x010, 0x10, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "pclk_pcie_sys" },
	{ PCLK_GATE_PCIE1_SYS, "pclk_pcie1_sys", "clk_hsdt_subsys_ini", 0x000, 0x200, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "pclk_pcie1_sys" },
	{ PCLK_GATE_PCIE_PHY, "pclk_pcie_phy", "clk_hsdt_subsys_ini", 0x010, 0x8, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "pclk_pcie_phy" },
	{ PCLK_GATE_PCIE1_PHY, "pclk_pcie1_phy", "clk_hsdt_subsys_ini", 0x000, 0x100, 0,
	...
	{ CLK_GATE_PCIE1_TBU, "clk_pcie1_tbu", "clk_hsdt_subsys_ini", 0x00, 0x2000, 0,
...
static const struct div_clock hsdt1ctrl_div_clks[] = {
	{ CLK_DIV_SDIOPLL, "clkdiv_sdiopll", "clkgt_sdiopll",
		0x0B4, 0x3c, 16, 1, 0, "clkdiv_sdiopll" },
...
static const char *const clk_mux_sdio_pll_p [] = { "clk_sdio_sys", "clk_sd_peri", "clkdiv_sdiopll", "clkdiv_sdiopll" };
...
static const struct mux_clock hsdt1ctrl_mux_clks[] = {
	{ CLK_MUX_SDIO_PLL, "clk_mux_sdio_pll", clk_mux_sdio_pll_p,
		ARRAY_SIZE(clk_mux_sdio_pll_p), 0x0B4, 0x3, CLK_MUX_HIWORD_MASK, "clk_mux_sdio_pll" },
...
static const struct gate_clock hsdt1ctrl_gate_clks[] = {
	...
	{ ACLK_GATE_USB3OTG_ASYNCBRG, "aclk_asyncbrg", "clkmux_usb_dock", 0x0, 0x100, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "aclk_asyncbrg" },
	{ CLK_GATE_SDIO, "clk_sdio", "clk_mux_sdio_pll", 0x10, 0x2000000, 0,
	...
	{ CLK_GATE_HI_USB3_SUSPEND, "hi_usb3_suspend", "clk_eusb_38m4", 0x000, 0x4000, 0,
	...
	{ CLK_GATE_USBDP_AUX, "clk_usbdp_aux", "clk_eusb_38m4", 0x000, 0x800000, 0,
...
static const struct scgt_clock hsdt1ctrl_scgt_clks[] = {
	{ CLK_ANDGT_SDIOPLL, "clkgt_sdiopll", "clk_ap_sdpll",
		0x0B0, 15, CLK_GATE_HIWORD_MASK, "clkgt_sdiopll" },
	{ CLK_SDIO_SYS_GT, "clk_sdio_sys_gt", "clkdiv_usb2phy_ref",
		0xB0, 14, CLK_GATE_HIWORD_MASK, "clk_sdio_sys_gt" },
	...
	{ CLK_ANDGT_USB2PHY_REF, "clkgt_usb2phy_ref", "clk_eusb_38m4",
...
static const char * const clk_mux_ao_camera_p [] = { "clkin_sys", "clk_fll_src", "div_aobus_334M", "clk_isp_snclk1" };
static const char * const clk_mux_out0_p [] = { "sc_div_320m", "clk_fll_src", "clk_sys_ini","clk_fll_src"};
...
static const struct gate_clock sctrl_gate_clks[] = {
	...
	{ CLK_GATE_QIC_SPIDMA, "clk_qic_spidma", "clkmux_spi3", 0x9D0, 0x800, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "clk_qic_spidma" },
	...
	{ CLK_GATE_AO_TOF, "clk_ao_tof", "clkdiv_ao_camera", 0x190, 0x4000000, 0,
...
static const struct sec_gate_clock sctrl_sec_gate_clks[] = {
	{ CLK_GATE_OUT0, "clk_out0", "clkdiv_out0", { 0x900, 5 }, 0, 0, "clk_out0" },
};

static const struct gate_clock iomcu_gate_clks[] = {
	{ CLK_I2C1_GATE_IOMCU, "clk_i2c1_gt", "clk_fll_src", 0x10, 0x0, 0,
...
static const struct gate_clock media1crg_gate_clks[] = {
	...
	{ ACLK_GATE_VDEC, "aclk_vdec", "clk_spll", 0x00, 0x1, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "aclk_vdec" },
	{ ACLK_GATE_JPG, "aclk_jpg", "clk_vivobus_div", 0x000, 0x100, 0,
...
static const struct div_clock media2crg_div_clks[] = {
	...
	{ ACLK_DIV_VENC, "aclkdiv_venc", "aclkgt_venc",
		0x98, 0x3f, 64, 1, 0, "aclkdiv_venc" },
...
static const char *const aclk_mux_venc_p [] = {
		"clk_invalid", "clk_ppll2b_m2", "clk_ppll0_m2", "clk_invalid",
		"clk_ppll1_m2", "clk_invalid", "clk_invalid", "clk_invalid",
		"clk_fll_src", "clk_invalid", "clk_invalid", "clk_invalid",
		"clk_invalid", "clk_invalid", "clk_invalid", "clk_invalid"
...
static const struct mux_clock media2crg_mux_clks[] = {
	...
	{ ACLK_MUX_VENC, "aclkmux_venc", aclk_mux_venc_p,
		ARRAY_SIZE(aclk_mux_venc_p), 0x88, 0xf, CLK_MUX_HIWORD_MASK, "aclkmux_venc" },
...
static const struct gate_clock media2crg_gate_clks[] = {
	...
	{ ACLK_GATE_VENCFREQ, "aclk_vencfreq", "aclkdiv_venc", 0x00, 0x10, 0,
		NULL, 0, {0}, {0}, 0, 0, 0, "aclk_vencfreq" },
	...
	{ CLK_GATE_ISPCPUFREQ, "clk_ispcpufreq", "clk_ispcpu_div", 0x10, 0x2, 0,
...
static const struct scgt_clock media2crg_scgt_clks[] = {
	...
	{ ACLK_ANDGT_VENC, "aclkgt_venc", "aclkmux_venc",
		0xB8, 3, CLK_GATE_HIWORD_MASK, "aclkgt_venc" },
...
static const struct pmu_clock pmu_clks[] = {
	...
	{ CLK_EUSB_38M4, "clk_eusb_38m4", "clkin_sys", 0x48, 0, INVALID_HWSPINLOCK_ID, 0, "clk_eusb_38m4" },
};

static const struct dvfs_clock dvfs_clks[] = {
	{ CLK_GATE_EDC0, "clk_edc0", "clk_edc0_mem", 20, -1, 3, 1,
		{ 279000, 418000, 480000 }, { 0, 1, 2, 3 }, 480000, 1, "clk_edc0" },
	{ CLK_GATE_VDEC, "clk_vdec", "clk_vdec_mem", 21, -1, 3, 1,
		{ 209000, 335000, 480000 }, { 0, 1, 2, 3 }, 480000, 1, "clk_vdec" },
	{ CLK_GATE_VENC, "clk_venc", "clk_venc_mem", 24, -1, 3, 1,
		{ 335000, 418000, 558000 }, { 0, 1, 2, 3 }, 558000, 1, "clk_venc" },
	{ CLK_GATE_ISPFUNC, "clk_ispfunc", "clk_ispfunc_mem", 26, -1, 3, 1,
		{ 335000, 418000, 558000 }, { 0, 1, 2, 3 }, 558000, 1, "clk_ispfunc" },
	{ CLK_GATE_JPG_FUNC, "clk_jpg_func", "clk_jpg_func_mem", 36, -1, 3, 1,
		{ 335000, 418000, 480000 }, { 0, 1, 2, 3 }, 480000, 1, "clk_jpg_func" },
	{ ACLK_GATE_VENC, "aclk_venc", "aclk_venc_mem", 39, -1, 2, 1,
		{ 335000, 418000, 643000}, { 0, 1, 2 }, 418000, 1, "aclk_venc" },
};

static const struct dvfs_clock perimem_dvs_clks[] = {
	{ CLK_GATE_EDC0_MEM, "clk_edc0_mem", "clk_edc0freq", 120, -1, 1, 1,
		{ 480000 }, { 0, 2 }, 0, 0, "clk_edc0_mem" },
	{ CLK_GATE_VDEC_MEM, "clk_vdec_mem", "clk_vdecfreq", 121, -1, 1, 1,
		{ 480000 }, { 0, 2 }, 0, 0, "clk_vdec_mem" },
	{ CLK_GATE_VENC_MEM, "clk_venc_mem", "clk_vencfreq", 124, -1, 1, 1,
		{ 558000 }, { 0, 2 }, 0, 0, "clk_venc_mem" },
	{ CLK_GATE_ISPFUNC_MEM, "clk_ispfunc_mem", "clk_ispfuncfreq", 126, -1, 1, 1,
		{ 558000 }, { 0, 2 }, 0, 0, "clk_ispfunc_mem" },
	{ CLK_GATE_JPG_FUNC_MEM, "clk_jpg_func_mem", "clk_jpg_funcfreq", 136, -1, 1, 1,
		{ 480000 }, { 0, 2 }, 0, 0, "clk_jpg_func_mem" },
	{ ACLK_GATE_VENC_MEM, "aclk_venc_mem", "aclk_vencfreq", 139, -1, 1, 1,
		{ 558000 }, { 0, 2 }, 0, 0, "aclk_venc_mem" },
	{ CLK_GATE_ISPCPU, "clk_ispcpu", "clk_ispcpufreq", 125, -1, 1, 1,
		{ 964000 }, { 0, 1 }, 0, 0, "clk_ispcpu" },
};

static struct media_pll_info ppll2b_m1_info = MEDIA_PLL_INFO("clk_ppll2b_media", 643000);
...
static const struct fast_dvfs_clock fast_dvfs_clks_media1[] = {
	{ CLK_GATE_EDC0FREQ, "clk_edc0freq", { 0x60, 0x3c0, 6 }, { 0x60, 0x3f, 0 },
		...
		{ 105000, 279000, 418000, 480000, 643000 }, 4, { 1, 1, 1, 2, 0 },
		{ 0x03C00080, 0x03C00080, 0x03C00080, 0x03C00100, 0x03C00040 },  { 16, 6, 4, 3, 1 },
		{ 0x003F000F, 0x003F0005, 0x003F0003, 0x003F0002, 0x003F0000 }, SC_GATE_ON, "clk_edc0freq" },
	{ CLK_GATE_JPG_FUNCFREQ, "clk_jpg_funcfreq", { 0x68, 0x3c0, 6 }, { 0x68, 0x3f, 0 },
		{ 0x84, 2 }, { 0x0, 10 }, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{ 105000, 335000, 418000, 480000, 643000 }, 4, { 1, 1, 1, 2, 0 },
		{ 0x03C00080, 0x03C00080, 0x03C00080, 0x03C00100, 0x03C00040 },  { 16, 5, 4, 3, 1 },
		{ 0x003F000F, 0x003F0004, 0x003F0003, 0x003F0002, 0x003F0000 }, NO_ALWAYS_ON, "clk_jpg_funcfreq" },
};

static struct media_pll_info ppll2b_m2_info = MEDIA_PLL_INFO("clk_ppll2b_m2", 643000);
...
static const struct fast_dvfs_clock fast_dvfs_clks_media2[] = {
	{ CLK_GATE_ISPFUNCFREQ, "clk_ispfuncfreq", { 0x080, 0xf00, 8 }, { 0x09c, 0x3f, 0 },
		...
		{ 105000, 335000, 418000, 558000, 720000 }, 4, { 1, 1, 1, 1, 2 },
		{ 0x0F000200, 0x0F000200, 0x0F000200, 0x0F000200, 0x0F000400 }, { 16, 5, 4, 3, 2 },
		{ 0x003F000F, 0x003F0004, 0x003F0003, 0x003F0002, 0x003F0001 }, NO_ALWAYS_ON, "clk_ispfuncfreq" },
};
...
static const struct fixed_factor_clock media2_stub_clks[] = {
	...
	{ ACLK_MUX_VENC, "aclkmux_venc", "clk_sys_ini", 1, 1, 0, "aclkmux_venc" },
	{ ACLK_ANDGT_VENC, "aclkgt_venc", "clk_sys_ini", 1, 1, 0, "aclkgt_venc" },
	{ ACLK_DIV_VENC, "aclkdiv_venc", "clk_sys_ini", 1, 1, 0, "aclkdiv_venc" },
	{ ACLK_GATE_VENCFREQ, "aclk_vencfreq", "clk_sys_ini", 1, 1, 0, "aclk_vencfreq" },
...
{
	struct clock_data *clk_data = NULL;
	unsigned int nr = ARRAY_SIZE(sctrl_fsm_pll_clks) +
		ARRAY_SIZE(sctrl_scgt_clks) +
		ARRAY_SIZE(sctrl_div_clks) +
		ARRAY_SIZE(sctrl_mux_clks) +
		ARRAY_SIZE(sctrl_gate_clks) +
		ARRAY_SIZE(sctrl_sec_gate_clks);

	clk_data = clk_init(np, nr);
	if (!clk_data)
		return;

	plat_clk_register_fsm_pll(sctrl_fsm_pll_clks,
		ARRAY_SIZE(sctrl_fsm_pll_clks), clk_data);
	...
	plat_clk_register_sec_gate(sctrl_sec_gate_clks,
		ARRAY_SIZE(sctrl_sec_gate_clks), clk_data);
}
...
{
	struct clock_data *clk_data = NULL;
	unsigned int nr = ARRAY_SIZE(iomcu_gate_clks);
...
static void clk_dvfs_init(struct device_node *np)
{
	...
	unsigned int nr = ARRAY_SIZE(perimem_dvs_clks) +
						ARRAY_SIZE(dvfs_clks);

	clk_dvfs_data = clk_init(np, nr);
	if (!clk_dvfs_data)
		return;

	plat_clk_register_dvfs_clk(perimem_dvs_clks,
		ARRAY_SIZE(perimem_dvs_clks), clk_dvfs_data);
