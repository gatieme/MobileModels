...
#ifdef CONFIG_PERI_DMA_PM_RUNTIME
/* Milliseconds */
#define PERI_DMA_AUTOSUSPEND_DELAY 1000
#endif
...
#if defined(CONFIG_PERI_DMA_NO_CCI)
	...
	struct platform_device *op)
{
	...
	pm_runtime_set_autosuspend_delay(
		d->slave.dev, PERI_DMA_AUTOSUSPEND_DELAY);
...
#endif /* CONFIG_PERI_DMA_PM_RUNTIME */
