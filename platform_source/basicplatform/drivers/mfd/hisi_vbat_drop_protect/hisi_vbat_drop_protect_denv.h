...
#ifndef __HISI_VBAT_DROP_PROTECT_DENV_H
#define __HISI_VBAT_DROP_PROTECT_DENV_H
...
#define PMIC_VSYS_DROP_IRQ_MASK_REG	PMIC_IRQ_MASK_19_ADDR(0)
...
#define GPU_VOL_DROP_EN_ADDR(base) ((base) + (0x454))
...
#define GPU_VOL_DROP_EN_BIT BIT(14)
...
#define GPU_VOL_DROP_EN_STAT_ADDR(base) ((base) + (0x45C))
...
#define GPU_VOL_DROP_EN_STAT_BIT BIT(10)
#endif
#endif
