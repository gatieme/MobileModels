...
/* Common capabilities of zodiac SoC */
...
unsigned int hs_timing_config[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
...
static unsigned int hs_timing_config_aries_cs
...
static unsigned int hs_timing_config_libra
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_libra_c50
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_libra_c60
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_cancer_cs
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_capricorn
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_taurus_cs
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_taurus_cs2
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_pisces
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_leo
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
...
static unsigned int hs_timing_config_aquarius
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
		...
		{
			/* SD */
			{ 3200000,    7, 6, 0, 15, 15, 400000 },     /* 0: LEGACY 400k */
			{ 120000000, 4, 3, 0, 0, 0, 24000000 },   /* 1: MMC_HS */
			{ 240000000, 4, 3, 0, 0, 0, 48000000 },   /* 2: SD_HS */
			{ 120000000, 4, 3, 0, 9, 9, 24000000 },   /* 3: SDR12 */
			{ 240000000, 4, 3, 0, 0, 0, 48000000 },   /* 4: SDR25 */
			{ 480000000, 4, 3, 0, 5, 0, 96000000 },   /* 5: SDR50 */
			{ 960000000, 4, 3, 3, 9, 0, 192000000 },  /* 6: SDR104 */
		...
		},
		{
			...
			{0},                                       /* 1: MMC_HS */
			{0},                                       /* 2: SD_HS */
			{ 120000000, 4, 3, 0, 9, 9, 25000000 },    /* 3: SDR12 */
			{ 240000000, 4, 3, 0, 0, 0, 48000000 },    /* 4: SDR25 */
			{ 480000000, 4, 3, 2, 8, 0, 96000000 },    /* 5: SDR50 */
			{ 1622016000, 7, 5, 6, 15, 0, 203000000 }, /* 6: SDR104 */
			{0},                                       /* 7: DDR50 */
			{0},                                       /* 8: DDR52 */
			{0},                                       /* 9: HS200 */
...
static unsigned int hs_timing_config_sagittarius
	[][TUNING_INIT_TIMING_MODE][TUNING_INIT_CONFIG_NUM] = {
		/* bus_clk, div, drv_phase, sam_dly, sam_phase_max, sam_phase_min, input_clk */
		{
			/* MMC */
		...
		{
			/* SD */
			{ 3200000,   7, 8, 0, 15, 15, 400000 },     /* 0: LEGACY 400k */
			{ 120000000, 4, 3, 0, 2, 2, 24000000 },   /* 1: MMC_HS */
			{ 240000000, 4, 3, 0, 1, 1, 48000000 },   /* 2: SD_HS */
			{ 120000000, 4, 3, 0, 9, 9, 24000000 },   /* 3: SDR12 */
			{ 240000000, 4, 3, 0, 1, 1, 48000000 },   /* 4: SDR25 */
			{ 480000000, 4, 3, 2, 9, 0, 96000000 },   /* 5: SDR50 */
			{ 960000000, 4, 3, 3, 9, 0, 192000000 },  /* 6: SDR104 */
			{0},                                      /* 7: DDR50 */
			{0},                                      /* 8: DDR52 */
			{ 960000000, 4, 3, 3, 9, 0, 192000000 },  /* 9: HS200 */
		},
		{
			...
			{ 120000000, 4, 3, 0, 9, 9, 25000000 },    /* 3: SDR12 */
			{ 240000000, 4, 3, 0, 0, 0, 48000000 },    /* 4: SDR25 */
			{ 480000000, 4, 2, 2, 9, 0, 96000000 },    /* 5: SDR50 */
			{ 1622016000, 7, 6, 6, 15, 0, 203000000 }, /* 6: SDR104 */
			{0},                                       /* 7: DDR50 */
			{0},                                       /* 8: DDR52 */
			{0},                                       /* 9: HS200 */
		}
