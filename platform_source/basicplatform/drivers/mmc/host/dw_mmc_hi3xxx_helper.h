...
#define DW_MMC_TUNING_MOVE_RIGHT 2
#define DW_MMC_TUNING_MOVE_LEFT (-2)
...
static unsigned int hs_timing_config_aries_cs_sd_ppll3[TUNING_INIT_CONFIG_NUM] = {
	1200000000, 6, 4, 3, 13, 0, 171000000
};
static unsigned int hs_timing_config_aries_cs_sdio_ppll3[TUNING_INIT_CONFIG_NUM] = {
	1200000000, 6, 4, 3, 13, 0, 171000000
};
static unsigned int hs_timing_config_cancer_cs_sd_ppll2[TUNING_INIT_CONFIG_NUM] = {
	960000000, 4, 4, 2, 9, 0, 192000000
};
static unsigned int hs_timing_config_cancer_cs_sdio_ppll2[TUNING_INIT_CONFIG_NUM] = {
	960000000, 4, 4, 2, 9, 0, 192000000
};
static unsigned int hs_timing_config_libra_sd_ppll2[TUNING_INIT_CONFIG_NUM] = {
	960000000, 4, 3, 2, 9, 0, 192000000
};
static unsigned int hs_timing_config_libra_sdio_ppll2[TUNING_INIT_CONFIG_NUM] = {
	960000000, 4, 3, 2, 9, 0, 192000000
};
static unsigned int hs_timing_config_taurus_sd_ppll2[TUNING_INIT_CONFIG_NUM] = {
	960000000, 4, 2, 3, 9, 0, 192000000
};
static unsigned int hs_timing_config_taurus_sdio_ppll2[TUNING_INIT_CONFIG_NUM] = {
	1572000000, 7, 7, 6, 15, 0, 196500000
};
static unsigned int hs_timing_960_clock_source_capricorn[TUNING_INIT_CONFIG_NUM] = {
	960000000, 4, 3, 2, 9, 0, 192000000
};
#else
...
static unsigned int hs_timing_1920_clock_source_capricorn[TUNING_INIT_CONFIG_NUM] = {
