...
#include <platform_include/basicplatform/linux/rdr_dfx_core.h>
...
#endif
#if (NR_CPUS == 9)
#include "rdr_dfx_ap_hook_ratio_nine_core.h"
#elif (NR_CPUS == 12)
#include "rdr_dfx_ap_hook_ratio_twelve_core.h"
#elif (NR_CPUS == 20)
#include "rdr_dfx_ap_hook_ratio_twenty_core.h"
#else
#include "rdr_dfx_ap_hook_ratio_eight_core.h"
#endif
...
#define CONSOLE_RAMOOPS     "/proc/rdr/pstore/console-ramoops"
#define PMSG_RAMOOPS        "/proc/rdr/pstore/pmsg-ramoops-0"
...
#define SRC_DUMPEND  "/proc/rdr/memory/dump_end"
...
#define DFX_HOOK_CPU_NUMBERS (NR_CPUS < 8 ? 8: NR_CPUS)
#define PERCPU_TOTAL_RATIO (2 * DFX_HOOK_CPU_NUMBERS)
...
#else
static inline void dfx_ap_set_reset_keypoint(u32 value)
{
	unused(value);
	return;
}
