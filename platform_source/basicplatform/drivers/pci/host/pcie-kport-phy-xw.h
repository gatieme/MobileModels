...
#ifndef _PCIE_KPORT_PHY_XW_H
#define _PCIE_KPORT_PHY_XW_H
...
#define PHY_PCS_STATUS_ADDR	(0xC00 + 0x200)
...
#define PHY_DFE_MANUAL_MASK				0xFFFF
#define PHY_DFE_CTRL_MASK				0xFF03FFFF
...
#define PHY_RX0_LDO_SEL		(0x1u << 12)
...
#define PHY3_POWERON_TIMEOUT		2000
...
/* XW GEN3 related */
#define XW_PHY3_OFFSETK_NUMS        8
#define XW_PHY3_PCS_INT                 0x004
#define XW_PHY3_BYPASS_ASYN_PWR_ACK		0x140
#define XW_PHY3_REFCLK_FROM_PAD			0x30C
#define XW_PHY3_PCS_POWER_STATUS_ADDR   0xD80
#define XW_PHY3_PCLK_SHARE_INT_SET      0x400
#define XW_PHY3_PCLK_LANE_INT_SET       0xC00
#define XW_PHY3_PLLVCOK_CTRL			0x70C
#define XW_PHY_RG_BG_VREF_SEL_ADDR      0x730
#define XW_PHY3_PLLBANDCTRLG3           0x744
#define XW_PHY3_PLLBANDCTRLG2           0x740
#define XW_PHY3_TERMKCTRL               0x710
#define XW_PHY3_DCCK_RES                0xE0C
#define XW_PHY3_TX_V48_CALI_VAL         0xE30
#define XW_PHY3_OFFSETK_G1_2_SEL0       0xEB0
#define XW_PHY3_OFFSETK_G1_2_EQ         0xEA8
#define XW_PHY3_OFFSETK_G3_SEL0         0xE88
#define XW_PHY3_OFFSETK_G3_EQ           0xE80
#define XW_PHY3_PIPE_LOCAL              0xD88
#define XW_PHY3_RXGSACTRL2_ADDR         0xE28
#define XW_PHY3_RXOFSTUPDTCTRL_ADDR     (0xC00 + 0x210)
#define XW_PHY3_RXEQACTRL2              (0xC00 + 0x254)
#define XW_PHY3_RXLOSCTRL               (0x800 + 0x214)

#define XW_PHY3_VCOK5G_DONE_CLEAR_BIT	(0x1 << 3)
#define XW_PHY3_VCOK8G_DONE_CLEAR_BIT	(0x1 << 1)
#define XW_PHY3_CLE_EQOFSTK_DONE_BIT	(0x1 << 27)
#define XW_PHY3_CLE_SAOFSTK_DONE_BIT	(0x1 << 28)
#define XW_PHY3_CLE_GSOFSTK_DONE_BIT	(0x1 << 29)
