...
struct pcie_phy_ops {
	...
	void (*phy3_digital_gather_init)(struct pcie_phy *phy);
	void (*phy3_digital_gather_trigger)(struct pcie_phy *phy);
	void (*phy3_digital_gather_dump)(struct pcie_phy *phy);
#endif
};
...
int32_t pcie_phy_bind(uint32_t rc_id, struct pcie_phy *phy,
...
#else
static inline int32_t pcie_phy_bind(uint32_t rc_id, struct pcie_phy *phy,
		struct pcie_phy_ops *phy_ops)
{
	return -1;
}
