 ...
 *
 * Description: 6526 charger driver
 *
...
#include <securec.h>
#ifdef CONFIG_HUAWEI_CHARGER_AP
#include <platform_include/basicplatform/linux/power/platform/charger/hisi_charger_scp.h>
#include <huawei_platform/power/direct_charger/direct_charger.h>
#include <huawei_platform/usb/switch/switch_ap/switch_chip.h>
#endif
#include <soc_schargerV600_interface.h>
#include "hisi_hi6526_v510_regs.h"
#include "../scharger_dynamic_cv.h"
#ifdef CONFIG_HISI_UFCS_DRV
#include "../hisi_ufcs/hisi_ufcs_drv.h"
#endif
...
#define scharger_err(fmt, args...) pr_err("[hisi_scharger]" fmt, ## args)
#define scharger_evt(fmt, args...) pr_warn("[hisi_scharger]" fmt, ## args)
#define scharger_inf(fmt, args...) pr_info("[hisi_scharger]" fmt, ## args)
#define scharger_dbg(fmt, args...) pr_debug("[hisi_scharger]" fmt, ## args)
...
#define CHG_UFCS_IRQ_ADDR                   (0x3A7)
...
#define PAGE_UFCS_PAGE0_NUM                 (0x3F + 1)
...
#define DC_REGULATOR_IBUS_MAX               5600 /* 5600mA */
...
#define R_UOHM_1K                            1000
#define R_UOHM_2K                            2000
#define R_UOHM_5K                            5000
#define R_UOHM_10K                           10000

#define R_UOHM_DEFAULT                      R_UOHM_2K /* resisitance uohm */

#define TRIM_A_MIN                          0
#define TRIM_A_MAX                          2

#define CV_TRIM_STEP_8MV      8
#define CV_TRIM_PROTECT_58MV  58
