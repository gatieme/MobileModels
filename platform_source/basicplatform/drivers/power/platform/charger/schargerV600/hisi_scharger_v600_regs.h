...
#define CHIP_VERSION_V200               0x0002
#define CHIP_VERSION_V510               0x1005
#define CHIP_VERSION_V511               0x1105
...
#define CHG_FAST_ICHG_STEP_160          160
#define CHG_FAST_ICHG_00MA              0

#define CHG_FAST_ICHG_100MA             100
#define CHG_FAST_ICHG_160MA             160
...
#define CHG_FAST_ICHG_3040MA            3040
#define CHG_FAST_ICHG_3200MA            3200
#define CHG_FAST_ICHG_MAX               3200
#define CHG_FAST_ICHG_640MA             640
...
#define CHG_IBAT_OCP_REG                (SOC_SCHARGER_DC_TOP_CFG_REG_6_ADDR(0))
#define CHG_IBAT_OCP_SHIFT              (0x5)
#define CHG_IBAT_OCP_MSK                (0x20)
...
#define CHG_FCP_MODE2_REG                (SOC_SCHARGER_FCP_MODE2_SET_ADDR(0))
#define CHG_FCP_MODE2_SET_MSK            (0x03)
...
#define CHG_FCP_MODE_MSK                (1 << SOC_SCHARGER_FCP_CTRL_fcp_mode_START)
...
#define CHG_ANTI_REVERBST_RESET_SHIFT   3
#define CHG_ANTI_REVERBST_RESET_MASK    (1 << CHG_ANTI_REVERBST_RESET_SHIFT)
