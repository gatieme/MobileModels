...
#elif defined(CONFIG_SCSI_UFS_VIRTUALIZ_AGENT)
#define UFS_RPMB_BLOCK_DEVICE_NAME "/dev/0:0:0:196"
#else
...
extern long blk_scsi_kern_ioctl(unsigned int fd, unsigned long arg,
