...
#define SSP_MIS(r) ((r) + 0x024) /* after mask interrupt status register */
#define SSP_ICR(r) ((r) + 0x028) /* interrupt clear register */
#define SSP_DMA_CTRL(r)  ((r) + 0x030) /* interrupt clear register */
#define SSP_SDMA_ADDR_H_R(r) ((r) + 0x034) /* rx buffer addr high */
#define SSP_SDMA_ADDR_L_R(r) ((r) + 0x038) /* rx buffer addr low */
#define SSP_SDMA_ADDR_H_W(r) ((r) + 0x03C) /* tx buffer addr high */
#define SSP_SDMA_ADDR_L_W(r) ((r) + 0x040) /* tx buffer addr low */
#define SSP_DMA_CMD_START(r) ((r) + 0x054) /* exclusive dma enable */
#define INTR_SPI_DMA_MASK(r) ((r) + 0x058) /* exclusive dma irq mask */
#define INTR_SPI_DMA_CLR(r) ((r) + 0x05C) /* exclusive dma irq clr */
#define INTR_SPI_DMA_RAW(r) ((r) + 0x060) /* exclusive dma irq row */
#define INTR_SPI_DMA(r) ((r) + 0x064)     /* exclusive dma irq */

#define SSP_VER(r) ((r) + 0xFE0) /* version register */
...
#define SSP_FIFOCR_MASK_TXINT_V600 (0x7U << 3)
#define SSP_FIFOCR_MASK_RXINT_V600 (0x7U << 9)
...
/* SPI_DMA_CTRL */
#define DMA_ENBALE_APB          (0x1U << 21)
#define DMA_SDMA_MODE           0
#define DMA_ADMA_MODE           (0x1U << 20)

/* SPI_DMA_CMD_START */
#define DMA_CMD_START           (0x1U << 0)

/*
 * exclusive dma interrupt bit(0x58~0x64)
 */
/* exclusive dma transfer complete */
#define INT_DMA_COMPLETE    (0x1U << 12)
/* read addr miss align */
#define INT_DMA_RD_DESCR_ADDR_ERR   (0x1U << 9)
/* write addr miss align */
#define INT_DMA_WR_DESCR_ADDR_ERR   (0x1U << 6)
/* dma read response error */
#define INT_DMA_RD_RRESP_ERR   (0x1U << 5)
/* dma write response error */
#define INT_DMA_WR_BRESP_ERR   (0x1U << 3)
/* dma rx fifo overflow */
#define INT_DMA_RX_OVERFLOW   (0x1U << 2)
/* dma rx fifo underflow */
#define INT_DMA_RX_UNDERFLOW  (0x1U << 1)
/* dma tx fifo overflow */
#define INT_DMA_TX_OVERFLOW  (0x1U << 0)

#define EXCLUSIVE_DMA_ALL_INT 0x1FFF
/*
 * Message State
...
#define DEFAULT_SSP_REG_IMSC_V600  0xFFU
#define DISABLE_ALL_INTERRUPTS DEFAULT_SSP_REG_IMSC
#define DISABLE_ALL_INTERRUPTS_V600 DEFAULT_SSP_REG_IMSC_V600
#define ENABLE_ALL_INTERRUPTS 0x0U

#define CLEAR_ALL_INTERRUPTS  0x3
#define CLEAR_ALL_INTERRUPTS_V600  0xFF
#define SPI_32BITS_MASK  (0xffffffff)
...
#define DEFAULT_SSP_REG_FIFOCR_V600                    \
	(GEN_MASK_BITS(SSP_TX_64_OR_MORE_EMPTY_LOC, SSP_FIFOCR_MASK_TXDMA, 0) |   \
	GEN_MASK_BITS(SSP_TX_64_OR_MORE_EMPTY_LOC, SSP_FIFOCR_MASK_TXINT_V600, 3) | \
	GEN_MASK_BITS(SSP_RX_16_OR_MORE_ELEM, SSP_FIFOCR_MASK_RXDMA, 6) |     \
	GEN_MASK_BITS(SSP_RX_16_OR_MORE_ELEM, SSP_FIFOCR_MASK_RXINT_V600, 9))

#define SPI_V600_CONTROLLER_NO_DMA_VERSION (0x2600)
#define SPI_V600_CONTROLLER_DMA_VERSION (0x2610)
#define SPI_V600_CONTROLLER_CHECK(value) (((value) == SPI_V600_CONTROLLER_NO_DMA_VERSION) || \
	((value) == SPI_V600_CONTROLLER_DMA_VERSION))
