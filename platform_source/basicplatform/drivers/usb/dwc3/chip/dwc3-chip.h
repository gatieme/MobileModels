...
#define PORTSC_OFFSET		0x108
#define REG_MEM_SIZE		0x1000
#define PORT_NUM		2
...
struct usb_s3_wakeup {
	bool usb_support_s3_wakeup;
	int irq;
	bool usb_do_wakeup_flag;
...
struct chip_dwc3_device {
	...
	u32 vdp_src_disable;
	struct usb_s3_wakeup usb_wakeup;
...
struct usb_controller {
	...
	struct chip_usb_reg_cfg *irq_enable;
	struct chip_usb_reg_cfg *irq_clr;
};
