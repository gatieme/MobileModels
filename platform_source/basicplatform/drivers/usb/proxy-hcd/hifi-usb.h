...
struct hifi_usb_proxy {
	...
	bool multi_port_qos_enable;
	struct chip_usb_reg_cfg **multi_port_qos_set;
	int multi_port_qos_set_num;
	struct chip_usb_reg_cfg **multi_port_qos_reset;
	int multi_port_qos_reset_num;
