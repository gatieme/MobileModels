...
typedef struct __pd_port {
	...
	bool curr_rever_flag;
	bool prev_rever_flag;
	int state_transfer_path;
	int prev_path;
	bool first_attach;
	bool pd_curr_unattach;
	bool called_by_timeout;
