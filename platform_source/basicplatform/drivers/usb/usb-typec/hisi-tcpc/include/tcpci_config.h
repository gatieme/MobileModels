...
#ifndef _TCPC_CONFIG_H
#define _TCPC_CONFIG_H
...
#define CONFIG_USB_PD_UVDM_TOUT	120
#endif

#define CONFIG_HISI_TCPC_QUIRK_V100
#define CONFIG_WORKAROUND_FF_CONER_CHIP_BIST_MODE_ERROR
#define CONFIG_HISI_TCPC_SINK_PRS_QUIRK
#define CONFIG_HISI_TCPC_VBUS_IRQ_ASSIST
