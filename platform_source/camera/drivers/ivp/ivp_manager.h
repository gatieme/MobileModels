...
int ivp_init_reg_res(struct platform_device *plat_devp, struct ivp_device *pdev);
int ivp_setup_irq(struct platform_device *plat_devp, struct ivp_device *ivp_devp);
