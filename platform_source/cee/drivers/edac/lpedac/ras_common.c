			  ...
			  int inst_nr, int block_nr, const char *msg)
{
	...
	bbox_diaginfo_record(irq_data->dmd_id[block_nr], NULL,
			     "CE instance: %s block %s errxstatus=0x%llx, errxmisc0=0x%llx, errxmisc1=0x%llx",
			     instance->name, block ? block->name : "N/A",
			  ...
			  int inst_nr, int block_nr, const char *msg)
{
	...
	bbox_diaginfo_record(ECC_DE, NULL,
			     "DE instance: %s block %s errxstatus=0x%llx, errxmisc0=0x%llx, errxmisc1=0x%llx",
			     instance->name, block ? block->name : "N/A",
			     err_data->errstatus, err_data->errmisc0, err_data->errmisc1);
}
			  ...
			  int inst_nr, int block_nr, const char *msg)
{
	...
	bbox_diaginfo_record(irq_data->dmd_id[block_nr + instance->nr_blocks], NULL,
			     "UE instance: %s block %s errxstatus=0x%llx, errxmisc0=0x%llx, errxmisc1=0x%llx",
			     instance->name, block ? block->name : "N/A",
			     err_data->errstatus, err_data->errmisc0, err_data->errmisc1);
