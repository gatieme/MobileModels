...
static struct rdr_exception_info_s cpu_edac_einfo[] = {
	...
	DEFINE_CPU_EDAC_EINFO(CPU9_CE)
	DEFINE_CPU_EDAC_EINFO(CPU9_UE)
	DEFINE_CPU_EDAC_EINFO(CPU10_CE)
	DEFINE_CPU_EDAC_EINFO(CPU10_UE)
	DEFINE_CPU_EDAC_EINFO(CPU11_CE)
	DEFINE_CPU_EDAC_EINFO(CPU11_UE)
