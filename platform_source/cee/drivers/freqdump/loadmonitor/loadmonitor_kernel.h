...
#define DPM_IOCTL_DDR_AP_VOTE_NUM	_IOR(BDAT_IOC_MAGIC, 0x2c, unsigned int)
#define DPM_IOCTL_DDR_AP_VOTE_DATA	_IOWR(BDAT_IOC_MAGIC, 0x2d, struct dubai_transmit_t)
...
extern unsigned int g_dpm_period;
#endif
