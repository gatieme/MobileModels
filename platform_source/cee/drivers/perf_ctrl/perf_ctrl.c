...
#include <linux/of.h>
#include <platform_include/cee/linux/perf_ctrl.h>
...
static perf_ctrl_func g_func_array[PERF_CTRL_MAX_NR] = {
	...
	perf_ctrl_set_task_l3c_part,
	perf_ctrl_get_hvgr_gpu_fence,
	perf_ctrl_get_hvgr_gpu_buffer_size,
	perf_ctrl_set_task_cpu_hwp,
	perf_ctrl_set_task_no_smt,
	perf_ctrl_get_tid_name,
	perf_ctrl_get_cgroup_name,
	init_render_rthread_global,
	get_render_rthread_glo,
	destroy_render_rthread_glo,
	perf_ctrl_set_frame_vip_prio,
	perf_ctrl_get_task_pid,
	perf_ctrl_set_task_userspace_throttle,
	perf_ctrl_set_heca_config,
...
#ifdef CONFIG_COMPAT
static long perf_ctrl_compact_ioctl(struct file *file,
				    unsigned int cmd, unsigned long arg)
{
	return perf_ctrl_ioctl(file, cmd, (unsigned long)(compat_ptr(arg)));
}
#endif
...
static const struct file_operations perf_ctrl_fops = {
	.owner = THIS_MODULE,
#ifdef CONFIG_COMPAT
	.compat_ioctl = perf_ctrl_compact_ioctl,
#endif
