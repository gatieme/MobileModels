...
static int slamtest_set_irq_mode(msg_req_slamtest_request_t *req, schedule_cmdlst_link_t *cmd_link_entry,
...
static void slamtest_pyramid_param_config(msg_req_slamtest_request_t *slamtest_request,
		slam_config_table_t *slamtest_cfg_tab)
{
...
static void slamtest_gsblur_coeff_config(msg_req_slamtest_request_t *slamtest_request,
		slam_config_table_t *slamtest_cfg_tab)
{
...
static void slamtest_threshold_param_config(msg_req_slamtest_request_t *slamtest_request,
		slam_config_table_t *slamtest_cfg_tab)
{
...
static void slamtest_nms_win_param_config(msg_req_slamtest_request_t *slamtest_request,
		slam_config_table_t *slamtest_cfg_tab)
{
...
static void slamtest_pattern_param_config(msg_req_slamtest_request_t *slamtest_request,
		slam_config_table_t *slamtest_cfg_tab)
{
	unsigned int i = 0;
	...
	if (slamtest_request->basic_cfg.brief_en == 1 || slamtest_request->basic_cfg.freak_en == 1) {
		for (i = 0; i < SLAM_PATTERN_NUM; i++) {
			temp_pattern_param.u32 = 0;
			temp_pattern_param.bits.pattern_y1 = (unsigned int)slamtest_request->pattern_cfg[i].pattern_y1;
			temp_pattern_param.bits.pattern_x1 = (unsigned int)slamtest_request->pattern_cfg[i].pattern_x1;
			temp_pattern_param.bits.pattern_y0 = (unsigned int)slamtest_request->pattern_cfg[i].pattern_y0;
			temp_pattern_param.bits.pattern_x0 = (unsigned int)slamtest_request->pattern_cfg[i].pattern_x0;
			slamtest_cfg_tab->pattern_param.to_use = 1;
			slamtest_cfg_tab->pattern_param.pattern_param[i] = temp_pattern_param.u32;
			pr_info("pattern_param 0x%x \n", slamtest_cfg_tab->pattern_param.pattern_param[i]);
		}
	} else {
...
static void slamtest_update_request_cfg_tab(msg_req_slamtest_request_t *slamtest_request,
		slam_config_table_t *slamtest_cfg_tab)
{
	pr_info("[%s] +\n", __func__);
...
static void slamtest_update_cmdlst_cfg_tab(cfg_tab_cmdlst_t *slamtest_cmdlst_cfg_tab,
		cmdlst_para_t *slamtest_cmdlst_para, cmd_buf_t *slamtest_cmd_buf)
{
	pr_info("[%s] +\n", __func__);
...
int slamtest_request_handler(msg_req_slamtest_request_t *slamtest_request)
{
	...
	slam_config_table_t *slamtest_cfg_tab = (slam_config_table_t *)(uintptr_t)va;
	...
	cfg_tab_cvdr_t *slam_cvdr_test_cfg_tab = (cfg_tab_cvdr_t *)(uintptr_t)va;
	...
	cmdlst_para_t *slam_cmdlst_test_para = (cmdlst_para_t *)(uintptr_t)va;
