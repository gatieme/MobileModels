...
struct s_cmdlst_regs_type {
	union u_cmdlst_id            		cmdlst_id                         ; /* 0x0 */
	union u_cmdlst_version       		cmdlst_version                    ; /* 0x4 */
	unsigned int                 		reserved_0[6]                     ; /* 0x8~0x1c */
	union u_cmdlst_cfg           		cmdlst_cfg                        ; /* 0x20 */
	unsigned int                 		reserved_1[7]                     ; /* 0x24~0x3c */
	union u_cmdlst_debug_0       		cmdlst_debug_0                    ; /* 0x40 */
	union u_cmdlst_debug_1       		cmdlst_debug_1                    ; /* 0x44 */
	union u_cmdlst_debug_2       		cmdlst_debug_2                    ; /* 0x48 */
	union u_cmdlst_debug_3       		cmdlst_debug_3                    ; /* 0x4c */
	union u_cmdlst_debug_4       		cmdlst_debug_4                    ; /* 0x50 */
	union u_cmdlst_vcd_trace     		cmdlst_vcd_trace                  ; /* 0x54 */
	unsigned int                 		reserved_2[10]                     ; /* 0x58~0x7c */
	union u_cmdlst_ch_cfg        		cmdlst_ch_cfg[449]                ; /* 0x80~0x780 */
	union u_cmdlst_sw_ch_mngr    		cmdlst_sw_ch_mngr[449]            ; /* 0x84~0x784 */
	union u_cmdlst_sw_cvdr_rd_addr   	cmdlst_sw_cvdr_rd_addr[449]   ; /* 0x88~0x788 */
	union u_cmdlst_sw_cvdr_rd_data_0   	cmdlst_sw_cvdr_rd_data_0[449] ; /* 0x8c~0x78c */
	union u_cmdlst_sw_cvdr_rd_data_1   	cmdlst_sw_cvdr_rd_data_1[449] ; /* 0x90~0x790 */
	union u_cmdlst_sw_cvdr_rd_data_2   	cmdlst_sw_cvdr_rd_data_2[449] ; /* 0x94~0x794 */
	union u_cmdlst_sw_cvdr_rd_data_3   	cmdlst_sw_cvdr_rd_data_3[449] ; /* 0x98~0x798 */
	union u_cmdlst_sw_branch     		cmdlst_sw_branch[449]             ; /* 0xa0~0x7a0 */
	union u_cmdlst_last_exec_rd_data_3  cmdlst_last_exec_rd_data_3[449] ; /* 0xa4~0x7a4 */
	union u_cmdlst_hw_ch_mngr    		cmdlst_hw_ch_mngr[449]            ; /* 0xbc~0x7bc */
	union u_cmdlst_hw_cvdr_rd_addr   	cmdlst_hw_cvdr_rd_addr[449]   ; /* 0xc0~0x7c0 */
	union u_cmdlst_hw_cvdr_rd_data_0   	cmdlst_hw_cvdr_rd_data_0[449] ; /* 0xc4~0x7c4 */
	union u_cmdlst_hw_cvdr_rd_data_1   	cmdlst_hw_cvdr_rd_data_1[449] ; /* 0xc8~0x7c8 */
	union u_cmdlst_hw_cvdr_rd_data_2   	cmdlst_hw_cvdr_rd_data_2[449] ; /* 0xcc~0x7cc */
	union u_cmdlst_hw_cvdr_rd_data_3   	cmdlst_hw_cvdr_rd_data_3[449] ; /* 0xd0~0x7d0 */
	union u_cmdlst_channel_debug   		cmdlst_channel_debug[449]       ; /* 0xe0~0x7e0 */
};
