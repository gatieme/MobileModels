...
#define CMDLST_SW_CVDR_RD_ADDR_0_REG      0x88  /* CVDR Video port read address to write the configuration data */
#define CMDLST_SW_CVDR_RD_ADDR_1_REG      0x108 /* CVDR Video port read address to write the configuration data */
#define CMDLST_SW_CVDR_RD_ADDR_2_REG      0x188 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_3_REG      0x208 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_4_REG      0x288 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_5_REG      0x308 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_6_REG      0x388 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_7_REG      0x408 /* CVDR Video port read address to write the configuration data */
#define CMDLST_SW_CVDR_RD_ADDR_8_REG      0x488 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_9_REG      0x508 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_10_REG     0x588 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_11_REG     0x608 /* CVDR Video port read address to write the configuration data */
#define CMDLST_SW_CVDR_RD_ADDR_12_REG     0x688 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_13_REG     0x708 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_SW_CVDR_RD_ADDR_14_REG     0x788 /* CVDR Video port read address to write the configuration data  */
...
#define CMDLST_HW_CH_MNGR_0_REG           0xBC  /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_1_REG           0x13C /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_2_REG           0x1BC /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_3_REG           0x23C /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_4_REG           0x2BC /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_5_REG           0x33C /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_6_REG           0x3BC /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_7_REG           0x43C /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_8_REG           0x4BC /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_9_REG           0x53C /* Allows to control the priority of the channel by HW command */
#define CMDLST_HW_CH_MNGR_10_REG          0x5BC /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_11_REG          0x63C /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_12_REG          0x6BC /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_13_REG          0x73C /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CH_MNGR_14_REG          0x7BC /* Allows to control the priority of the channel by HW command  */
#define CMDLST_HW_CVDR_RD_ADDR_0_REG      0xC0  /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_1_REG      0x140 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_2_REG      0x1C0 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_3_REG      0x240 /* CVDR Video port read address to write the configuration data */
#define CMDLST_HW_CVDR_RD_ADDR_4_REG      0x2C0 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_5_REG      0x340 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_6_REG      0x3C0 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_7_REG      0x440 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_8_REG      0x4C0 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_9_REG      0x540 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_10_REG     0x5C0 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_11_REG     0x640 /* CVDR Video port read address to write the configuration data */
#define CMDLST_HW_CVDR_RD_ADDR_12_REG     0x6C0 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_13_REG     0x740 /* CVDR Video port read address to write the configuration data  */
#define CMDLST_HW_CVDR_RD_ADDR_14_REG     0x7C0 /* CVDR Video port read address to write the configuration data */
