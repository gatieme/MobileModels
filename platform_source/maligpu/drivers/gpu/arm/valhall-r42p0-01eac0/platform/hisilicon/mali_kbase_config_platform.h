...
#define POWER_MODEL_CALLBACKS ((uintptr_t)&gpu_model_ops)
#endif
...
#elif defined (CONFIG_MALI_TRYM) || defined (CONFIG_MALI_BORR) || \
	defined (CONFIG_MALI_NATT) || defined (CONFIG_MALI_ODIN) || defined (CONFIG_MALI_ODIN_LEX) || defined (CONFIG_MALI_ODIN_NAP)
#define SYS_REG_PMCTRL_BASE_ADDR           0xFFF01000
#define SYS_REG_PERICRG_BASE_ADDR          0xFFF05000
...
#define SYS_REG_PERRIPCR_BASE_ADDR         0xFEC3A000
#endif
#endif
#elif defined (CONFIG_MALI_VALE)
#define SYS_REG_PMCTRL_BASE_ADDR           0xFFB01000
#define SYS_REG_PERICRG_BASE_ADDR          0xFFB05000
#define SYS_REG_PERICTRL_BASE_ADDR         0xEE58E000
#define SYS_REG_SYSCTRL_BASE_ADDR          0xFF717000
#else
...
#define SYS_REG_PCTRL_REMAP_SIZE                 0x2000
#else
#define SYS_REG_PCTRL_REMAP_SIZE                 SYS_REG_REMAP_SIZE
#endif

#define DPM_PCR_REMAP_SIZE                 0x4000
#ifdef CONFIG_GPU_DPM_PCR
#ifdef CONFIG_MALI_BORR
#define PERRI_PCR_REMAP_SIZE               0x100
#endif
#endif
...
#define G3D_MEM_AUTO_SD_ENABLE             0x2
#elif defined (CONFIG_MALI_ODIN) || defined (CONFIG_MALI_ODIN_LEX) || defined (CONFIG_MALI_ODIN_NAP)
/* bit[4:0]:Configuration 1 indicates that G3D enters DSLP mode */
#define G3D_MEM_DSLP_ENABLE                0x1F
#define G3D_MEM_DSLP_DISABLE               0xFFFFFFE0
#define G3D_MEM_AUTO_SD_ENABLE             0x2
...
#define PERI_STAT_FPGA_GPU_EXIST_MASK      0x1
	...
	defined (CONFIG_MALI_ODIN) || defined (CONFIG_MALI_ODIN_NAP)
#define PERI_STAT_FPGA_GPU_EXIST           0xBC
#define PERI_STAT_FPGA_GPU_EXIST_MASK      0x20
#elif defined (CONFIG_MALI_VALE)
/* vale check fpga gpu exist in fastboot stage,
 * only check dts prorerty:fpga-gpu-exist in kernel */
#else
#define PERI_STAT_FPGA_GPU_EXIST           0xBC
#define PERI_STAT_FPGA_GPU_EXIST_MASK      0x1
#endif
...
#elif defined (CONFIG_MALI_NORR_PHX) || defined (CONFIG_MALI_GONDUL) || defined (CONFIG_MALI_TRYM) || defined (CONFIG_MALI_NATT) || defined (CONFIG_MALI_ODIN) || defined (CONFIG_MALI_ODIN_NAP)
