 ...
 * Input Value:
 *    type: Whitelist, baseline, or dynamic metrics
...
#else
static inline int send_eima_data(int type, const struct m_list_msg *mlist_msg)
{
	return 0;
}

static inline char *get_hash_error_file_path(void)
{
	return NULL;
}
